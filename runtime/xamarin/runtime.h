...
void			xamarin_bridge_set_pending_exception (MonoException *exception);
...
void			xamarin_process_nsexception_using_mode (NSException *ns_exception, bool throwManagedAsDefault, GCHandle *output_exception = NULL);
...
void			xamarin_mono_object_release_unsafe (MonoObject *mobj);
#else
// Nothing to do here.
