...
namespace AppKit {
	...
	public unsafe partial class NSTableViewRowAction : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRowActionWithStyle_Title_Handler_X = "rowActionWithStyle:title:handler:";
		static readonly NativeHandle selRowActionWithStyle_Title_Handler_XHandle = Selector.GetHandle ("rowActionWithStyle:title:handler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSTableViewRowAction");
		...
		/// <summary>Creates a new <see cref="NSTableViewRowAction" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public NSTableViewRowAction () : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSTableViewRowAction (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSTableViewRowAction (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static NSTableViewRowAction FromStyle (NSTableViewRowActionStyle style, string title, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V26))]global::System.Action<NSTableViewRowAction, nint> handler)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			if (title is null)
			...
			using var block_handler = Trampolines.SDActionArity2V26.CreateBlock (handler);
			BlockLiteral *block_ptr_handler = &block_handler;
			NSTableViewRowAction? ret;
			ret =  Runtime.GetNSObject<NSTableViewRowAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_NativeHandle_NativeHandle (class_ptr, selRowActionWithStyle_Title_Handler_XHandle, (IntPtr) (long) style, nstitle, (IntPtr) block_ptr_handler), false)!;
		...
		public virtual NSTableViewRowActionStyle Style {
			...
			get {
				global::AppKit.NSApplication.EnsureUIThread ();
				NSTableViewRowActionStyle ret;
				if (IsDirectBinding) {
					ret = (NSTableViewRowActionStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selStyleXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSTableViewRowActionStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selStyleXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
