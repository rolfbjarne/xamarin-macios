...
namespace AVFoundation {
	...
	public unsafe partial class AVFragmentedAsset : AVUrlAsset, IAVFragmentMinding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selFragmentedAssetWithURL_Options_X = "fragmentedAssetWithURL:options:";
		static readonly NativeHandle selFragmentedAssetWithURL_Options_XHandle = Selector.GetHandle ("fragmentedAssetWithURL:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selIsAssociatedWithFragmentMinderX = "isAssociatedWithFragmentMinder";
		static readonly NativeHandle selIsAssociatedWithFragmentMinderXHandle = Selector.GetHandle ("isAssociatedWithFragmentMinder");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		protected AVFragmentedAsset (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal AVFragmentedAsset (NativeHandle handle) : base (handle)
		{
		}
		...
		public static AVFragmentedAsset FromUrl (NSUrl url, NSDictionary<NSString, NSObject>? options)
		{
			var url__handle__ = url!.GetNonNullHandle (nameof (url));
			var options__handle__ = options.GetHandle ();
			AVFragmentedAsset? ret;
			ret =  Runtime.GetNSObject<AVFragmentedAsset> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, selFragmentedAssetWithURL_Options_XHandle, url__handle__, options__handle__), false)!;
			GC.KeepAlive (url);
			GC.KeepAlive (options);
			return ret!;
		}
		...
		public virtual bool IsAssociatedWithFragmentMinder ()
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selIsAssociatedWithFragmentMinderXHandle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selIsAssociatedWithFragmentMinderXHandle);
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual AVFragmentedAssetTrack[] Tracks {
			[Export ("tracks")]
			get {
				AVFragmentedAssetTrack[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<AVFragmentedAssetTrack>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selTracksXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<AVFragmentedAssetTrack>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selTracksXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
