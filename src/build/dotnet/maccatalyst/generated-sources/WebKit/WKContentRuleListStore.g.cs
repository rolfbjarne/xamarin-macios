...
namespace WebKit {
	...
	public unsafe partial class WKContentRuleListStore : NSObject {
		...
		public unsafe virtual void CompileContentRuleList (string identifier, string encodedContentRuleList, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V172))]global::System.Action<WKContentRuleList, NSError> completionHandler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					...
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("compileContentRuleListForIdentifier:encodedContentRuleList:completionHandler:"), nsidentifier, nsencodedContentRuleList, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		...
		public static WKContentRuleListStore FromUrl (NSUrl url)
		{
			...
			ret =  Runtime.GetNSObject<WKContentRuleListStore> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("storeWithURL:"), url__handle__), false)!;
			GC.KeepAlive (url);
			return ret!;
		}
		...
		public unsafe virtual void GetAvailableContentRuleListIdentifiers ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V3))]global::System.Action<string[]> callback)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("getAvailableContentRuleListIdentifiers:"), (IntPtr) block_ptr_callback);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("getAvailableContentRuleListIdentifiers:"), (IntPtr) block_ptr_callback);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public unsafe virtual void LookUpContentRuleList (string identifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V172))]global::System.Action<WKContentRuleList, NSError> completionHandler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("lookUpContentRuleListForIdentifier:completionHandler:"), nsidentifier, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nsidentifier);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RemoveContentRuleList (string identifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> completionHandler)
		{
			if (identifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (identifier));
			if (completionHandler is null)
			...
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("removeContentRuleListForIdentifier:completionHandler:"), nsidentifier, (IntPtr) block_ptr_completionHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("removeContentRuleListForIdentifier:completionHandler:"), nsidentifier, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nsidentifier);
		...
		public static WKContentRuleListStore DefaultStore {
			...
			get {
				WKContentRuleListStore? ret;
				ret =  Runtime.GetNSObject<WKContentRuleListStore> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("defaultStore")), false)!;
				return ret!;
			}
		}
