...
#nullable enable
namespace CoreImage {
	/// <summary>An abstract class that is the base for convolution filters.</summary><remarks><para>Convolution filters generate a pixel value by summing the pixel values in a neighborhood (the size of the neighborhood may be 3x3, 5x5, or 9 pixels horizontally or vertically) and then by adding a bias. To maintain brightness, the sum of values in the convolution kernel must sum to 1.0.</para></remarks>
	public abstract partial class CIConvolutionCore : CIFilter {
		...
		protected internal CIConvolutionCore (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIConvolutionCore (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIConvolutionCore (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIConvolutionCore" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public  CIConvolutionCore (string name) : base (CreateFilter (name))
		{
		}
		...
		/// <summary>Gets or sets the weights for the convolution.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>Gets or sets the bias of the convolution.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public float Bias {
			get {
