...
namespace VideoToolbox {
	...
	public partial class VTCompressionProperties : DictionaryContainer {
		...
		public int? RecommendedParallelizationLimit {
			get {
				return  GetInt32Value (VTCompressionPropertyKey.RecommendedParallelizationLimit!);
			}
		}
		...
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("maccatalyst")]
		public nint? SuggestedLookAheadFrameCount {
			get {
				return  GetNIntValue (VTCompressionPropertyKey.SuggestedLookAheadFrameCount!);
			}
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("macos15.0")]
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("maccatalyst")]
		public VTQPModulationLevel? SpatialAdaptiveQPLevel {
			get {
				return (VTQPModulationLevel?) GetInt32Value (VTCompressionPropertyKey.SpatialAdaptiveQPLevel!);
			}
		}
