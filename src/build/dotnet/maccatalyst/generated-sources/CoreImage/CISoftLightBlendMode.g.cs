...
#nullable enable
namespace CoreImage {
	/// <summary>The CISoftLightBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 
	/// // Construct the SoftLight filter
	...
	/// var output = softLightBlend.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/SoftLightBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CISoftLightBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CISoftLightBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISoftLightBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISoftLightBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISoftLightBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
