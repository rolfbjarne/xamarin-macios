...
#nullable enable
namespace SceneKit {
	/// <summary>Provides additional drawing passes, each of which applies a shader.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/SceneKit/Reference/SCNTechnique_Class/index.html">Apple documentation for <c>SCNTechnique</c></related>
	[Register("SCNTechnique", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class SCNTechnique : NSObject, INSCoding, INSCopying, INSSecureCoding, ISCNAnimatable {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("SCNTechnique");
		...
		public SCNTechnique (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected SCNTechnique (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal SCNTechnique (NativeHandle handle) : base (handle)
		{
		}
		...
		public static SCNTechnique? Create (NSDictionary dictionary)
		{
			...
			SCNTechnique? ret;
			ret =  Runtime.GetNSObject<SCNTechnique> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("techniqueWithDictionary:"), dictionary__handle__), false)!;
		...
		public static SCNTechnique? Create (SCNTechnique[] techniques)
		{
			if (techniques is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (techniques));
			using var nsa_techniques = NSArray.FromNSObjects (techniques);
			SCNTechnique ret;
			ret =  Runtime.GetNSObject<SCNTechnique> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("techniqueBySequencingTechniques:"), nsa_techniques.Handle), false)!;
			return ret;
		}
