...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITransitionFilter" /> that performs a cross-dissolve.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/dissolve_transition.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIDissolveTransition : CITransitionFilter {
		/// <summary>Creates a new <see cref="CIDissolveTransition" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIDissolveTransition (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDissolveTransition (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDissolveTransition (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
