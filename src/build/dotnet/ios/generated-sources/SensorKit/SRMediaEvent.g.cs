...
namespace SensorKit {
	...
	public unsafe partial class SRMediaEvent : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		/// <summary>Creates a new <see cref="SRMediaEvent" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual SRMediaEventType EventType {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (SensorKit.SRMediaEventType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("eventType"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
