...
namespace Foundation {
	...
	public unsafe partial class NSDateIntervalFormatter : NSFormatter {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSDateIntervalFormatter");
		...
		/// <summary>Creates a new <see cref="NSDateIntervalFormatter" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public NSDateIntervalFormatter () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		public NSDateIntervalFormatter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSDateIntervalFormatter (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSDateIntervalFormatter (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual string StringFromDate (NSDate fromDate, NSDate toDate)
		{
			...
			string? ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("stringFromDate:toDate:"), fromDate__handle__, toDate__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("stringFromDate:toDate:"), fromDate__handle__, toDate__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual string? ToString (NSDateInterval dateInterval)
		{
			...
			string? ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("stringFromDateInterval:"), dateInterval__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("stringFromDateInterval:"), dateInterval__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual NSDateIntervalFormatterStyle DateStyle {
			[Export ("dateStyle")]
			get {
				NSDateIntervalFormatterStyle ret;
				if (IsDirectBinding) {
					ret = (NSDateIntervalFormatterStyle) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("dateStyle"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSDateIntervalFormatterStyle) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("dateStyle"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual string DateTemplate {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("dateTemplate")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("dateTemplate")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setDateTemplate:"), nsvalue);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setDateTemplate:"), nsvalue);
						GC.KeepAlive (this);
					}
				}
		...
		public virtual NSDateIntervalFormatterStyle TimeStyle {
			...
			get {
				NSDateIntervalFormatterStyle ret;
				if (IsDirectBinding) {
					ret = (NSDateIntervalFormatterStyle) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("timeStyle"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSDateIntervalFormatterStyle) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("timeStyle"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
