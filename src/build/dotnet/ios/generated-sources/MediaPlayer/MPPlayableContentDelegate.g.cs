...
namespace MediaPlayer {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "InitiatePlaybackOfContentItem", Selector = "playableContentManager:initiatePlaybackOfContentItemAtIndexPath:completionHandler:", ParameterType = new Type [] { typeof (MPPlayableContentManager), typeof (NSIndexPath), typeof (global::System.Action<NSError>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V0) })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "InitializePlaybackQueue", Selector = "playableContentManager:initializePlaybackQueueWithCompletionHandler:", ParameterType = new Type [] { typeof (MPPlayableContentManager), typeof (global::System.Action<NSError>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V0) })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "InitializePlaybackQueue", Selector = "playableContentManager:initializePlaybackQueueWithContentItems:completionHandler:", ParameterType = new Type [] { typeof (MPPlayableContentManager), typeof (MPContentItem[]), typeof (global::System.Action<NSError>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V0) })]
	public partial interface IMPPlayableContentDelegate : INativeObject, IDisposable
	{
		...
		public unsafe virtual void InitiatePlaybackOfContentItem (MPPlayableContentManager contentManager, NSIndexPath indexPath, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _InitiatePlaybackOfContentItem (IMPPlayableContentDelegate This, MPPlayableContentManager contentManager, NSIndexPath indexPath, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void InitializePlaybackQueue (MPPlayableContentManager contentManager, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _InitializePlaybackQueue (IMPPlayableContentDelegate This, MPPlayableContentManager contentManager, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			var contentManager__handle__ = contentManager!.GetNonNullHandle (nameof (contentManager));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void InitializePlaybackQueue (MPPlayableContentManager contentManager, MPContentItem[]? contentItems, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _InitializePlaybackQueue (IMPPlayableContentDelegate This, MPPlayableContentManager contentManager, MPContentItem[]? contentItems, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			var contentManager__handle__ = contentManager!.GetNonNullHandle (nameof (contentManager));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
	...
	public unsafe static partial class MPPlayableContentDelegate_Extensions {
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void InitiatePlaybackOfContentItem (this IMPPlayableContentDelegate This, MPPlayableContentManager contentManager, NSIndexPath indexPath, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			var contentManager__handle__ = contentManager!.GetNonNullHandle (nameof (contentManager));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
			if (completionHandler is null)
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void InitializePlaybackQueue (this IMPPlayableContentDelegate This, MPPlayableContentManager contentManager, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			var contentManager__handle__ = contentManager!.GetNonNullHandle (nameof (contentManager));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void InitializePlaybackQueue (this IMPPlayableContentDelegate This, MPPlayableContentManager contentManager, MPContentItem[]? contentItems, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			var contentManager__handle__ = contentManager!.GetNonNullHandle (nameof (contentManager));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
...
namespace MediaPlayer {
	/// <summary>Delegate object providing methods for external media players to send playback commands to the app.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/MediaPlayer/Reference/MPPlayableContentDelegate_Ref/index.html">Apple documentation for <c>MPPlayableContentDelegate</c></related>
	[Protocol()]
	[Register("Microsoft_iOS__MediaPlayer_MPPlayableContentDelegate", false)]
	[Model]
	[UnsupportedOSPlatform ("macos")]
	[UnsupportedOSPlatform ("tvos")]
	[SupportedOSPlatform ("maccatalyst")]
