...
namespace CoreImage {
	...
	public partial class CILinearDodgeBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CILinearDodgeBlendMode" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CILinearDodgeBlendMode () : base ("CILinearDodgeBlendMode")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CILinearDodgeBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILinearDodgeBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILinearDodgeBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
