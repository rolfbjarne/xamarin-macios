...
namespace Foundation {
	...
	public unsafe partial class NSUrlProtectionSpace : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDistinguishedNamesX = "distinguishedNames";
		static readonly NativeHandle selDistinguishedNamesXHandle = Selector.GetHandle ("distinguishedNames");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithHost_Port_Protocol_Realm_AuthenticationMethod_X = "initWithHost:port:protocol:realm:authenticationMethod:";
		static readonly NativeHandle selInitWithHost_Port_Protocol_Realm_AuthenticationMethod_XHandle = Selector.GetHandle ("initWithHost:port:protocol:realm:authenticationMethod:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithProxyHost_Port_Type_Realm_AuthenticationMethod_X = "initWithProxyHost:port:type:realm:authenticationMethod:";
		static readonly NativeHandle selInitWithProxyHost_Port_Type_Realm_AuthenticationMethod_XHandle = Selector.GetHandle ("initWithProxyHost:port:type:realm:authenticationMethod:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selProxyTypeX = "proxyType";
		static readonly NativeHandle selProxyTypeXHandle = Selector.GetHandle ("proxyType");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRealmX = "realm";
		static readonly NativeHandle selRealmXHandle = Selector.GetHandle ("realm");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selReceivesCredentialSecurelyX = "receivesCredentialSecurely";
		static readonly NativeHandle selReceivesCredentialSecurelyXHandle = Selector.GetHandle ("receivesCredentialSecurely");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		internal virtual nint _Init (string host, nint port, string? protocol, string? realm, string? authenticationMethod)
		{
			...
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_IntPtr_NativeHandle_NativeHandle_NativeHandle (this.Handle, selInitWithHost_Port_Protocol_Realm_AuthenticationMethod_XHandle, nshost, port, nsprotocol, nsrealm, nsauthenticationMethod);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_IntPtr_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selInitWithHost_Port_Protocol_Realm_AuthenticationMethod_XHandle, nshost, port, nsprotocol, nsrealm, nsauthenticationMethod);
					GC.KeepAlive (this);
				}
			}
		...
		internal virtual nint _InitWithProxy (string host, nint port, string? type, string? realm, string? authenticationMethod)
		{
			...
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_IntPtr_NativeHandle_NativeHandle_NativeHandle (this.Handle, selInitWithProxyHost_Port_Type_Realm_AuthenticationMethod_XHandle, nshost, port, nstype, nsrealm, nsauthenticationMethod);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_IntPtr_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selInitWithProxyHost_Port_Type_Realm_AuthenticationMethod_XHandle, nshost, port, nstype, nsrealm, nsauthenticationMethod);
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nshost);
		...
		public virtual string AuthenticationMethod {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selAuthenticationMethodXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selAuthenticationMethodXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual NSData[] DistinguishedNames {
			...
			get {
				NSData[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<NSData>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selDistinguishedNamesXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<NSData>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selDistinguishedNamesXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual string ProxyType {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selProxyTypeXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selProxyTypeXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual bool ReceivesCredentialSecurely {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selReceivesCredentialSecurelyXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selReceivesCredentialSecurelyXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		internal virtual nint ServerTrust {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selServerTrustXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selServerTrustXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
