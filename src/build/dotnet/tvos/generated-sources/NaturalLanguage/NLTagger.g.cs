...
namespace NaturalLanguage {
	...
	public unsafe partial class NLTagger : NSObject {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void RequestAssets (NSString language, NSString tagScheme, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V82))]global::System.Action<NLTaggerAssetsResult, NSError> completionHandler)
		{
			var language__handle__ = language!.GetNonNullHandle (nameof (language));
			var tagScheme__handle__ = tagScheme!.GetNonNullHandle (nameof (tagScheme));
