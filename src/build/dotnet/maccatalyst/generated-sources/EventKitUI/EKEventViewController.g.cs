...
namespace EventKitUI {
	/// <summary>UIViewController used to display the details of a calendar event.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/EventKitUI/Reference/EKEventViewControllerClassRef/index.html">Apple documentation for <c>EKEventViewController</c></related>
	[Register("EKEventViewController", true)]
	public unsafe partial class EKEventViewController : global::UIKit.UIViewController {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("EKEventViewController");
		...
		/// <summary>Creates a new <see cref="EKEventViewController" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public EKEventViewController () : base (NSObjectFlag.Empty)
		{
		...
		public EKEventViewController (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected EKEventViewController (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal EKEventViewController (NativeHandle handle) : base (handle)
		{
		}

		/// <param name="nibName"><para>To be added.</para><para tool="nullallowed">This parameter can be <see langword="null" />.</para></param><param name="bundle"><para>To be added.</para><para tool="nullallowed">This parameter can be <see langword="null" />.</para></param><summary>Creates a new <see cref="T:EventKitUI.EKEventViewController" /> from the specified Nib name in the specified <paramref name="bundle" />.</summary><remarks>To be added.</remarks>
		[Export ("initWithNibName:bundle:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public EKEventViewController (string? nibName, NSBundle? bundle)
		...
		/// <summary>Gets or sets a Boolean value that controls whether the event can be viewed in the day preview.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual bool AllowsCalendarPreview {
			...
			get {
				...
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("allowsCalendarPreview"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("allowsCalendarPreview"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
			}
			[Export ("setAllowsCalendarPreview:")]
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_bool (this.Handle, Selector.GetHandle ("setAllowsCalendarPreview:"), value ? (byte) 1 : (byte) 0);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, Selector.GetHandle ("setAllowsCalendarPreview:"), value ? (byte) 1 : (byte) 0);
						GC.KeepAlive (this);
					}
				}
			}
		}
		/// <summary>Gets or sets a Boolean value that controls whether the user can edit the event.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>An instance of the EventKitUI.IEKEventViewDelegate model class which acts as the class delegate.</summary><value>The instance of the EventKitUI.IEKEventViewDelegate model class</value><remarks><para>The delegate instance assigned to this object will be used to handle events or provide data on demand to this class.</para><para>When setting the Delegate or WeakDelegate values events will be delivered to the specified instance instead of being delivered to the C#-style events</para><para>This is the strongly typed version of the object, developers should use the WeakDelegate property instead if they want to merely assign a class derived from NSObject that has been decorated with [Export] attributes.</para></remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public IEKEventViewDelegate Delegate {
			get {
				return (WeakDelegate as IEKEventViewDelegate)!;
			}
			set {
		...
		/// <summary>Gets or sets the calendar event to display.</summary><value><para>(More documentation for this node is coming)</para><para tool="nullallowed">This value can be <see langword="null" />.</para></value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			get { return typeof (_EKEventViewDelegate); }
		}
		internal virtual _EKEventViewDelegate CreateInternalEventDelegateType ()
		{
			return (_EKEventViewDelegate)(new _EKEventViewDelegate());
		}
		internal _EKEventViewDelegate EnsureEKEventViewDelegate ()
		{
			if (WeakDelegate is not null)
				UIApplication.EnsureEventAndDelegateAreNotMismatched (WeakDelegate, GetInternalEventDelegateType);
			var del = Delegate as _EKEventViewDelegate;
			if (del is null){
				del = (_EKEventViewDelegate)CreateInternalEventDelegateType ();
				Delegate = (IEKEventViewDelegate)del;
			}
			return del;
		}
		#pragma warning disable 672
		[Register]
		internal class _EKEventViewDelegate : NSObject, IEKEventViewDelegate { 
			public _EKEventViewDelegate () { IsDirectBinding = false; }
			[DynamicDependency (DynamicallyAccessedMemberTypes.PublicMethods, typeof (_EKEventViewDelegate))]
			static _EKEventViewDelegate ()
			{
				GC.KeepAlive (null);
			}
			internal EventHandler<EKEventViewEventArgs>? completed;
			...
			public void Completed (EventKitUI.EKEventViewController controller, EventKitUI.EKEventViewAction action)
			{
				...
				if (handler is not null){
					var args = new EKEventViewEventArgs (action);
		...
		public event EventHandler<EKEventViewEventArgs> Completed {
			add { EnsureEKEventViewDelegate ()!.completed += value; }
			remove { EnsureEKEventViewDelegate ()!.completed -= value; }
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	...
	public partial class EKEventViewEventArgs : EventArgs {
		/// <summary>Create a new instance of the <see cref="EKEventViewEventArgs" /> with the specified event data.</summary>
		...
		public EventKitUI.EKEventViewAction Action { get; set; }
	}
}
