...
namespace Intents {
	...
	public unsafe partial class INObject : NSObject, IINSpeakable, INSCoding, INSCopying, INSSecureCoding {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithIdentifier:displayString:pronunciationHint:"), nsidentifier, nsdisplayString, nspronunciationHint), "initWithIdentifier:displayString:pronunciationHint:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithIdentifier:displayString:pronunciationHint:"), nsidentifier, nsdisplayString, nspronunciationHint), "initWithIdentifier:displayString:pronunciationHint:");
					GC.KeepAlive (this);
				}
			}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			var nsdisplayString = CFString.CreateNative (displayString);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithIdentifier:displayString:"), nsidentifier, nsdisplayString), "initWithIdentifier:displayString:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithIdentifier:displayString:"), nsidentifier, nsdisplayString), "initWithIdentifier:displayString:");
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nsidentifier);
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithIdentifier:displayString:subtitleString:displayImage:"), nsidentifier, nsdisplayString, nssubtitleString, displayImage__handle__), "initWithIdentifier:displayString:subtitleString:displayImage:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
			...
			: base (NSObjectFlag.Empty)
		{
			...
			var nssubtitleString = CFString.CreateNative (subtitleString);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithIdentifier:displayString:pronunciationHint:subtitleString:displayImage:"), nsidentifier, nsdisplayString, nspronunciationHint, nssubtitleString, displayImage__handle__), "initWithIdentifier:displayString:pronunciationHint:subtitleString:displayImage:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
		...
		public INSpeakableString[]? GetAlternativeSpeakableMatches ()
		{
			...
			ret = CFArray.ArrayFromHandle<INSpeakableString>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("alternativeSpeakableMatches")), false)!;
			return ret;
		}
		...
		public virtual void SetAlternativeSpeakableMatches (INSpeakableString[]? alternativeSpeakableMatches)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setAlternativeSpeakableMatches:"), nsa_alternativeSpeakableMatches.GetHandle ());
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setAlternativeSpeakableMatches:"), nsa_alternativeSpeakableMatches.GetHandle ());
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual INImage? DisplayImage {
			...
			get {
				INImage? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<INImage> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("displayImage")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<INImage> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("displayImage")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setDisplayImage:"), value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setDisplayImage:"), value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
		...
		public virtual string DisplayString {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("displayString")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("displayString")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual string? SubtitleString {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("subtitleString")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("subtitleString")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setSubtitleString:"), nsvalue);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setSubtitleString:"), nsvalue);
						GC.KeepAlive (this);
					}
				}
