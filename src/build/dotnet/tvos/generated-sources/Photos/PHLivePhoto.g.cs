...
namespace Photos {
	...
	public unsafe partial class PHLivePhoto : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static int RequestLivePhoto (NSUrl[] fileUrls, global::UIKit.UIImage? image, CGSize targetSize, PHImageContentMode contentMode, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V87))]global::System.Action<PHLivePhoto, NSDictionary> resultHandler)
		{
			if (fileUrls is null)
			...
			using var block_resultHandler = Trampolines.SDActionArity2V87.CreateBlock (resultHandler);
