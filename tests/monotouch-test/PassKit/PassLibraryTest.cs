...
namespace MonoTouchFixtures.PassKit {
	...
	public class PassLibraryTest {
		...
		public void Defaults ()
		{
			...
			ClassicAssert.NotNull (passes, "GetPasses - if this assert fails for you locally, please investigate! See https://github.com/xamarin/maccore/issues/2598.");
			...
			ClassicAssert.Null (library.GetPass (String.Empty, String.Empty), "GetPass");

			using (var pass = PassTest.GetBoardingPass ()) {
				ClassicAssert.False (library.Contains (pass), "Contains");
				ClassicAssert.False (library.Replace (pass), "Replace");
				library.Remove (pass);
			}
		}
