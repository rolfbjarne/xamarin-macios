...
namespace Microsoft.DotNet.XHarness.iOS.Shared.TestImporter.Templates {
	...
	public interface ITemplatedProject {
		...
		/// <returns></returns>
		GeneratedProjects GenerateTestProjectsAsync (IEnumerable<(string Name, string [] Assemblies, string ExtraArgs, double TimeoutMultiplier)> projects, Platform platform);
	}
}
