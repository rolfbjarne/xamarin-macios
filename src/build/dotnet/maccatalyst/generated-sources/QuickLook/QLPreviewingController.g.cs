...
namespace QuickLook {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "PreparePreviewOfSearchableItem", Selector = "preparePreviewOfSearchableItemWithIdentifier:queryString:completionHandler:", ParameterType = new Type [] { typeof (string), typeof (string), typeof (global::System.Action<NSError>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V20) })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "PreparePreviewOfFile", Selector = "preparePreviewOfFileAtURL:completionHandler:", ParameterType = new Type [] { typeof (NSUrl), typeof (global::System.Action<NSError>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V20) })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ProvidePreview", Selector = "providePreviewForFileRequest:completionHandler:", ParameterType = new Type [] { typeof (QLFilePreviewRequest), typeof (global::System.Action<global::QuickLook.QLPreviewReply, NSError>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity2V140) })]
	public partial interface IQLPreviewingController : INativeObject, IDisposable
	{
		...
		public unsafe virtual void PreparePreviewOfSearchableItem (string identifier, string? queryString, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> handler)
		{
			_PreparePreviewOfSearchableItem (this, identifier, queryString, handler);
		}
		/// <param name="identifier">To be added.</param><param name="queryString">To be added.</param><param name="handler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _PreparePreviewOfSearchableItem (IQLPreviewingController This, string identifier, string? queryString, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> handler)
		{
			...
			using var block_handler = Trampolines.SDActionArity1V20.CreateBlock (handler);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void PreparePreviewOfFile (NSUrl url, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> handler)
		{
			_PreparePreviewOfFile (this, url, handler);
		}
		/// <param name="url">To be added.</param><param name="handler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _PreparePreviewOfFile (IQLPreviewingController This, NSUrl url, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
		...
		[UnsupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ProvidePreview (QLFilePreviewRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V140))]global::System.Action<QLPreviewReply, NSError> handler)
		{
		...
		[UnsupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _ProvidePreview (IQLPreviewingController This, QLFilePreviewRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V140))]global::System.Action<QLPreviewReply, NSError> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
	...
	public unsafe static partial class QLPreviewingController_Extensions {
		/// <param name="identifier">To be added.</param><param name="queryString">To be added.</param><param name="handler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void PreparePreviewOfSearchableItem (this IQLPreviewingController This, string identifier, string? queryString, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (identifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (identifier));
		...
		/// <param name="url">To be added.</param><param name="handler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void PreparePreviewOfFile (this IQLPreviewingController This, NSUrl url, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var url__handle__ = url!.GetNonNullHandle (nameof (url));
			if (handler is null)
		...
		[UnsupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void ProvidePreview (this IQLPreviewingController This, QLFilePreviewRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V140))]global::System.Action<QLPreviewReply, NSError> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var request__handle__ = request!.GetNonNullHandle (nameof (request));
			if (handler is null)
