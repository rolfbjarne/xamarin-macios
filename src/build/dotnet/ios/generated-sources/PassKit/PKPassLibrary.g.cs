...
namespace PassKit {
	...
	public unsafe partial class PKPassLibrary : NSObject {
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ActivatePaymentPass (PKPaymentPass paymentPass, NSData activationData, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V0))]global::System.Action<bool, NSError>? completion)
		{
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ActivatePaymentPass (PKPaymentPass paymentPass, string activationCode, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V0))]global::System.Action<bool, NSError>? completion)
		{
			var paymentPass__handle__ = paymentPass!.GetNonNullHandle (nameof (paymentPass));
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ActivateSecureElementPass (PKSecureElementPass secureElementPass, NSData activationData, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V0))]global::System.Action<bool, NSError>? completion)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void AddPasses (PKPass[] passes, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V232))]global::System.Action<PKPassLibraryAddPassesStatus>? completion)
		{
			if (passes is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (passes));
			using var nsa_passes = NSArray.FromNSObjects (passes);
			using var block_completion = Trampolines.SDActionArity1V232.CreateNullableBlock (completion);
			BlockLiteral *block_ptr_completion = null;
			if (completion is not null)
				block_ptr_completion = &block_completion;
			if (IsDirectBinding) {
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetEncryptedServiceProviderData (PKSecureElementPass secureElementPass, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V110))]global::System.Action<NSDictionary, NSError> completion)
		{
			var secureElementPass__handle__ = secureElementPass!.GetNonNullHandle (nameof (secureElementPass));
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RequestAuthorization (PKPassLibraryCapability capability, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V233))]global::System.Action<PKPassLibraryAuthorizationStatus> completion)
		{
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
			using var block_completion = Trampolines.SDActionArity1V233.CreateBlock (completion);
			BlockLiteral *block_ptr_completion = &block_completion;
			if (IsDirectBinding) {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static nuint RequestAutomaticPassPresentationSuppression ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V234))]global::System.Action<PKAutomaticPassPresentationSuppressionResult> responseHandler)
		{
			if (responseHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (responseHandler));
			using var block_responseHandler = Trampolines.SDActionArity1V234.CreateBlock (responseHandler);
