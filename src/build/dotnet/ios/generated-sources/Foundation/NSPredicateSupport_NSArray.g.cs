...
namespace Foundation {
	...
	public unsafe static partial class NSPredicateSupport_NSArray  {
		...
		public static NSArray FilterUsingPredicate (this NSArray This, NSArray array)
		{
			...
			NSArray? ret;
			ret =  Runtime.GetNSObject<NSArray> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("filteredArrayUsingPredicate:"), array__handle__), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (array);
			return ret!;
		}
