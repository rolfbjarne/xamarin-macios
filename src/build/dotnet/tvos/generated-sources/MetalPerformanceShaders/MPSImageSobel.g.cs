...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSImageSobel : MPSUnaryImageKernel {
		...
		internal virtual nint InitWithDevice (global::Metal.IMTLDevice device, nint transform)
		{
			...
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_IntPtr (this.Handle, Selector.GetHandle ("initWithDevice:linearGrayColorTransform:"), device__handle__, transform);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_IntPtr (&__objc_super__, Selector.GetHandle ("initWithDevice:linearGrayColorTransform:"), device__handle__, transform);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
