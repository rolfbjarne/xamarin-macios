...
namespace Foundation {
	...
	public unsafe partial class NSNotification : NSObject, INSCoding, INSCopying {
		...
		public static NSNotification FromName (string name, NSObject? obj)
		{
			...
			NSNotification? ret;
			ret =  Runtime.GetNSObject<NSNotification> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("notificationWithName:object:"), nsname, obj__handle__), false)!;
			GC.KeepAlive (obj);
		...
		public static NSNotification FromName (string name, NSObject? obj, NSDictionary? userInfo)
		{
			...
			var nsname = CFString.CreateNative (name);
			NSNotification? ret;
			ret =  Runtime.GetNSObject<NSNotification> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("notificationWithName:object:userInfo:"), nsname, obj__handle__, userInfo__handle__), false)!;
			GC.KeepAlive (obj);
		...
		public virtual NSObject? Object {
			...
			get {
				NSObject? ret;
				if (IsDirectBinding) {
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("object")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("object")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
