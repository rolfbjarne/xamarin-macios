...
#nullable enable
namespace CoreImage {
	/// <summary>Subtracts the background image pixels from those in the <see cref="P:CoreImage.CIBlendFilter.InputImage" />.</summary>
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public partial class CISubtractBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CISubtractBlendMode" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CISubtractBlendMode () : base ("CISubtractBlendMode")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISubtractBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISubtractBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISubtractBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
