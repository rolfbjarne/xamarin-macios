...
namespace AVFoundation {
	...
	public unsafe partial class AVMovie : AVAsset, INSCopying, INSMutableCopying {
		...
		public static AVMovie FromData (NSData data, NSDictionary<NSString, NSObject>? options)
		{
			...
			var options__handle__ = options.GetHandle ();
			AVMovie? ret;
			ret =  Runtime.GetNSObject<AVMovie> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("movieWithData:options:"), data__handle__, options__handle__), false)!;
			GC.KeepAlive (data);
			GC.KeepAlive (options);
			return ret!;
		}
		...
		public static AVMovie FromUrl (NSUrl URL, NSDictionary<NSString, NSObject>? options)
		{
			...
			var options__handle__ = options.GetHandle ();
			AVMovie? ret;
			ret =  Runtime.GetNSObject<AVMovie> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("movieWithURL:options:"), URL__handle__, options__handle__), false)!;
			GC.KeepAlive (URL);
			GC.KeepAlive (options);
			return ret!;
		}
		...
		public virtual bool CanContainMovieFragments {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("canContainMovieFragments"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("canContainMovieFragments"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual bool ContainsMovieFragments {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("containsMovieFragments"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("containsMovieFragments"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public static string[] MovieTypes {
			...
			get {
				string[] ret;
				ret = CFArray.StringArrayFromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("movieTypes")), false)!;
				return ret;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual AVMovieTrack[] Tracks {
			...
			get {
				AVMovieTrack[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<AVMovieTrack>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("tracks")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<AVMovieTrack>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("tracks")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
