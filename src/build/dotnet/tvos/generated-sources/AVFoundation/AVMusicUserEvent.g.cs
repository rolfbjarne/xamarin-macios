...
namespace AVFoundation {
	...
	public unsafe partial class AVMusicUserEvent : AVMusicEvent {
		...
		/// <summary>Creates a new <see cref="AVMusicUserEvent" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual uint SizeInBytes {
			...
			get {
				uint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UInt32_objc_msgSend (this.Handle, Selector.GetHandle ("sizeInBytes"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UInt32_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("sizeInBytes"));
						GC.KeepAlive (this);
					}
				}
				return ret;
