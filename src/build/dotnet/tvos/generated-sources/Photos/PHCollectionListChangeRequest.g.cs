...
namespace Photos {
	...
	public unsafe partial class PHCollectionListChangeRequest : PHChangeRequest {
		...
		public virtual void AddChildCollections (PHCollection[] collections)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("addChildCollections:"), nsa_collections.Handle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("addChildCollections:"), nsa_collections.Handle);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public static PHCollectionListChangeRequest? ChangeRequest (PHCollectionList collectionList)
		{
			...
			ret =  Runtime.GetNSObject<PHCollectionListChangeRequest> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("changeRequestForCollectionList:"), collectionList__handle__), false)!;
		...
		public static PHCollectionListChangeRequest? ChangeRequest (PHCollectionList collectionList, PHFetchResult childCollections)
		{
			...
			PHCollectionListChangeRequest? ret;
			ret =  Runtime.GetNSObject<PHCollectionListChangeRequest> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("changeRequestForCollectionList:childCollections:"), collectionList__handle__, childCollections__handle__), false)!;
			GC.KeepAlive (collectionList);
		...
		public static PHCollectionListChangeRequest? ChangeRequestForTopLevelCollectionList (PHFetchResult childCollections)
		{
			var childCollections__handle__ = childCollections!.GetNonNullHandle (nameof (childCollections));
			PHCollectionListChangeRequest? ret;
			ret =  Runtime.GetNSObject<PHCollectionListChangeRequest> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("changeRequestForTopLevelCollectionListUserCollections:"), childCollections__handle__), false)!;
			GC.KeepAlive (childCollections);
			return ret!;
		}
		...
		public static PHCollectionListChangeRequest CreateAssetCollection (string title)
		{
			...
			PHCollectionListChangeRequest? ret;
			ret =  Runtime.GetNSObject<PHCollectionListChangeRequest> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("creationRequestForCollectionListWithTitle:"), nstitle), false)!;
		...
		public static void DeleteCollectionLists (PHCollectionList[] collectionLists)
		{
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("deleteCollectionLists:"), nsa_collectionLists.Handle);
		}
		...
		public virtual void InsertChildCollections (PHCollection[] collections, NSIndexSet indexes)
		{
			...
			using var nsa_collections = NSArray.FromNSObjects (collections);
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("insertChildCollections:atIndexes:"), nsa_collections.Handle, indexes__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("insertChildCollections:atIndexes:"), nsa_collections.Handle, indexes__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void MoveChildCollections (NSIndexSet indexes, nuint toIndex)
		{
			var indexes__handle__ = indexes!.GetNonNullHandle (nameof (indexes));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_UIntPtr (this.Handle, Selector.GetHandle ("moveChildCollectionsAtIndexes:toIndex:"), indexes__handle__, toIndex);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_UIntPtr (&__objc_super__, Selector.GetHandle ("moveChildCollectionsAtIndexes:toIndex:"), indexes__handle__, toIndex);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (indexes);
		...
		public virtual void RemoveChildCollections (PHCollection[] collections)
		{
			...
			using var nsa_collections = NSArray.FromNSObjects (collections);
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("removeChildCollections:"), nsa_collections.Handle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("removeChildCollections:"), nsa_collections.Handle);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void RemoveChildCollections (NSIndexSet indexes)
		{
			var indexes__handle__ = indexes!.GetNonNullHandle (nameof (indexes));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("removeChildCollectionsAtIndexes:"), indexes__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("removeChildCollectionsAtIndexes:"), indexes__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (indexes);
		...
		public virtual void ReplaceChildCollection (NSIndexSet indexes, PHCollection[] collections)
		{
			...
			using var nsa_collections = NSArray.FromNSObjects (collections);
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("replaceChildCollectionsAtIndexes:withChildCollections:"), indexes__handle__, nsa_collections.Handle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("replaceChildCollectionsAtIndexes:withChildCollections:"), indexes__handle__, nsa_collections.Handle);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (indexes);
		...
		public virtual PHObjectPlaceholder PlaceholderForCreatedCollectionList {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<PHObjectPlaceholder> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("placeholderForCreatedCollectionList")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<PHObjectPlaceholder> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("placeholderForCreatedCollectionList")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
