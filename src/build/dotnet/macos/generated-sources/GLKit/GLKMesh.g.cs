...
namespace GLKit {
	...
	public unsafe partial class GLKMesh : NSObject {
		...
		const string selInitWithMesh_Error_X = "initWithMesh:error:";
		static readonly NativeHandle selInitWithMesh_Error_XHandle = Selector.GetHandle ("initWithMesh:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNameX = "name";
		static readonly NativeHandle selNameXHandle = Selector.GetHandle ("name");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNewMeshesFromAsset_SourceMeshes_Error_X = "newMeshesFromAsset:sourceMeshes:error:";
		static readonly NativeHandle selNewMeshesFromAsset_SourceMeshes_Error_XHandle = Selector.GetHandle ("newMeshesFromAsset:sourceMeshes:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (this.Handle, selInitWithMesh_Error_XHandle, mesh__handle__, &errorValue), "initWithMesh:error:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_ref_NativeHandle (&__objc_super__, selInitWithMesh_Error_XHandle, mesh__handle__, &errorValue), "initWithMesh:error:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (mesh);
		...
		internal unsafe static GLKMesh[]? FromAsset (global::ModelIO.MDLAsset asset, out NSArray? sourceMeshes, out NSError? error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			GLKMesh[]? ret;
			ret = CFArray.ArrayFromHandle<GLKMesh>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle_ref_NativeHandle (class_ptr, selNewMeshesFromAsset_SourceMeshes_Error_XHandle, asset__handle__, &sourceMeshesValue, &errorValue), true)!;
			GC.KeepAlive (asset);
		...
		public virtual GLKSubmesh[] Submeshes {
			...
			get {
				GLKSubmesh[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<GLKSubmesh>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selSubmeshesXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<GLKSubmesh>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selSubmeshesXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual GLKMeshBuffer[] VertexBuffers {
			...
			get {
				GLKMeshBuffer[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<GLKMeshBuffer>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selVertexBuffersXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<GLKMeshBuffer>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selVertexBuffersXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
