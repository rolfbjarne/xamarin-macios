...
namespace CoreImage {
	...
	public partial class CIDiscBlur : CIFilter, ICIDiscBlurProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIDiscBlur" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIDiscBlur () : base ("CIDiscBlur")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIDiscBlur (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDiscBlur (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDiscBlur (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIDiscBlurProtocol protocol members 
