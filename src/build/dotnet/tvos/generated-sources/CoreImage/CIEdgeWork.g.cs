...
namespace CoreImage {
	...
	public partial class CIEdgeWork : CIFilter, ICIEdgeWorkProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIEdgeWork" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIEdgeWork () : base ("CIEdgeWork")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIEdgeWork (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIEdgeWork (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIEdgeWork (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIEdgeWorkProtocol protocol members 
