...
namespace Vision {
	...
	[Register("VNDetectFaceRectanglesRequest", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class VNDetectFaceRectanglesRequest : VNImageBasedRequest {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("VNDetectFaceRectanglesRequest");
		...
		protected VNDetectFaceRectanglesRequest (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal VNDetectFaceRectanglesRequest (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe VNDetectFaceRectanglesRequest ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDVNRequestCompletionHandler))]VNRequestCompletionHandler? completionHandler)
		...
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos")]
		public static VNDetectFaceRectanglesRequestRevision CurrentRevision {
			[Export ("currentRevision")]
			get {
				VNDetectFaceRectanglesRequestRevision ret;
				ret = (Vision.VNDetectFaceRectanglesRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (class_ptr, selCurrentRevisionXHandle);
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos")]
		public static VNDetectFaceRectanglesRequestRevision DefaultRevision {
			[Export ("defaultRevision")]
			get {
				VNDetectFaceRectanglesRequestRevision ret;
				ret = (Vision.VNDetectFaceRectanglesRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (class_ptr, selDefaultRevisionXHandle);
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos")]
		public virtual VNDetectFaceRectanglesRequestRevision Revision {
			[Export ("revision")]
			get {
				VNDetectFaceRectanglesRequestRevision ret;
				if (IsDirectBinding) {
					ret = (Vision.VNDetectFaceRectanglesRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selRevisionXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (Vision.VNDetectFaceRectanglesRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selRevisionXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos")]
		public static VNDetectFaceRectanglesRequestRevision[] SupportedRevisions {
			get {
				return (GetSupportedVersions<VNDetectFaceRectanglesRequestRevision> (WeakSupportedRevisions) as VNDetectFaceRectanglesRequestRevision[])!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[SupportedOSPlatform ("maccatalyst")]
