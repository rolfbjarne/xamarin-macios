...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIDistortionFilter" /> that creates a bump at the specified center point.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/XamarinCheck.png" alt="Logo on a checkered background" /></para><para>
	/// Produces the following output:
	/// </para><para><img href="~/xml/CoreImage/_images/bump_distortion.png" alt="Result of applying the filter." /></para></remarks>
	public partial class CIBumpDistortion : CIDistortionFilter, ICIBumpDistortionProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIBumpDistortion" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIBumpDistortion () : base ("CIBumpDistortion")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBumpDistortion (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBumpDistortion (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBumpDistortion (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIBumpDistortionProtocol protocol members 
		...
		/// <summary>Gets or sets the level of the bump distortion.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public float Scale {
			[Export ("scale")]
			get {
