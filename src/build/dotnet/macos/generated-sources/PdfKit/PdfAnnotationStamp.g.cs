...
namespace PdfKit {
	...
	public unsafe partial class PdfAnnotationStamp : PdfAnnotation {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("PDFAnnotationStamp");
		...
		/// <summary>Creates a new <see cref="PdfAnnotationStamp" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public PdfAnnotationStamp () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		public PdfAnnotationStamp (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected PdfAnnotationStamp (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal PdfAnnotationStamp (NativeHandle handle) : base (handle)
		{
		}
