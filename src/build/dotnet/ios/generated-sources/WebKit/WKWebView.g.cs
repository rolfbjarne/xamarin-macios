...
namespace WebKit {
	...
	public unsafe partial class WKWebView : global::UIKit.UIView {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CallAsyncJavaScript (string functionBody, NSDictionary<NSString, NSObject>? arguments, WKFrameInfo? frame, WKContentWorld contentWorld, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V85))]global::System.Action<NSObject, NSError>? completionHandler)
		{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CreatePdf (WKPdfConfiguration? pdfConfiguration, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V19))]global::System.Action<NSData, NSError> completionHandler)
		{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CreateWebArchive ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V19))]global::System.Action<NSData, NSError> completionHandler)
		{
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity2V19.CreateBlock (completionHandler);
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void EvaluateJavaScript (string javaScriptString, WKFrameInfo? frame, WKContentWorld contentWorld, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V85))]global::System.Action<NSObject, NSError>? completionHandler)
		{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void Find (string @string, WKFindConfiguration? configuration, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V289))]global::System.Action<WKFindResult> completionHandler)
		{
			if (@string is null)
			...
			using var block_completionHandler = Trampolines.SDActionArity1V289.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RequestMediaPlaybackState ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V290))]global::System.Action<WKMediaPlaybackState> completionHandler)
		{
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity1V290.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ResumeDownload (NSData resumeData, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V291))]global::System.Action<WKDownload> completionHandler)
		{
			var resumeData__handle__ = resumeData!.GetNonNullHandle (nameof (resumeData));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity1V291.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void StartDownload (NSUrlRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V291))]global::System.Action<WKDownload> completionHandler)
		{
			var request__handle__ = request!.GetNonNullHandle (nameof (request));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void TakeSnapshot (WKSnapshotConfiguration? snapshotConfiguration, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V185))]global::System.Action<global::UIKit.UIImage, NSError> completionHandler)
		{
			var snapshotConfiguration__handle__ = snapshotConfiguration.GetHandle ();
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity2V185.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
		...
		public virtual global::UIKit.UIConversationContext ConversationContext {
			[Export ("conversationContext", ArgumentSemantic.Retain)]
			get {
				global::UIKit.UIConversationContext? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<global::UIKit.UIConversationContext> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("conversationContext")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<global::UIKit.UIConversationContext> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("conversationContext")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
