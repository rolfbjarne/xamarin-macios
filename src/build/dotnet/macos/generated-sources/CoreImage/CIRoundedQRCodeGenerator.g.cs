...
namespace CoreImage {
	...
	public partial class CIRoundedQRCodeGenerator : CIFilter, ICIRoundedQRCodeGeneratorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIRoundedQRCodeGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIRoundedQRCodeGenerator () : base ("CIRoundedQRCodeGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIRoundedQRCodeGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIRoundedQRCodeGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIRoundedQRCodeGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIRoundedQRCodeGeneratorProtocol protocol members 
		[SupportedOSPlatform ("ios26.0")]
		[SupportedOSPlatform ("macos26.0")]
		[SupportedOSPlatform ("tvos26.0")]
		[SupportedOSPlatform ("maccatalyst26.0")]
		...
		[SupportedOSPlatform ("maccatalyst26.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public IntPtr RoundedMarkers {
			[Export ("roundedMarkers")]
			get {
				return GetNInt ("inputRoundedMarkers");
			}
			[Export ("setRoundedMarkers:")]
			set {
				SetNInt ("inputRoundedMarkers", value);
			}
		}
		[SupportedOSPlatform ("ios26.0")]
		[SupportedOSPlatform ("macos26.0")]
		...
		public bool RoundedData {
			[Export ("roundedData")]
			get {
				return GetBool ("inputRoundedData");
			}
			[Export ("setRoundedData:")]
			set {
				SetBool ("inputRoundedData", value);
			}
		}
		[SupportedOSPlatform ("ios26.0")]
		[SupportedOSPlatform ("macos26.0")]
		...
		public float CenterSpaceSize {
			...
			get {
				return GetFloat ("inputCenterSpaceSize");
			}
			[Export ("setCenterSpaceSize:")]
			set {
				SetFloat ("inputCenterSpaceSize", value);
			}
		}
		[SupportedOSPlatform ("ios26.0")]
		[SupportedOSPlatform ("macos26.0")]
