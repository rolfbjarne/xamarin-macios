...
namespace MetalFX {
	...
	/// <summary>This interface represents the Objective-C protocol <c>MTL4FXTemporalScaler</c>.</summary>
	/// <remarks>
	...
	[Protocol (Name = "MTL4FXTemporalScaler", WrapperType = typeof (MTL4FXTemporalScalerWrapper), BackwardsCompatibleCodeGeneration = false)]
	...
	public partial interface IMTL4FXTemporalScaler : INativeObject, IDisposable, 
		MetalFX.IMTLFXFrameInterpolatableScaler
		, MetalFX.IMTLFXTemporalScalerBase
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _Encode (IMTL4FXTemporalScaler This, global::Metal.IMTL4CommandBuffer commandBuffer)
		{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (MTL4FXTemporalScalerWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static IMTL4FXTemporalScaler ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class MTL4FXTemporalScalerWrapper : BaseWrapper, IMTL4FXTemporalScaler {
		public MTL4FXTemporalScalerWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (MTL4FXTemporalScalerWrapper))]
		static MTL4FXTemporalScalerWrapper ()
		{
			GC.KeepAlive (null);
		}
		[Export ("encodeToCommandBuffer:")]
