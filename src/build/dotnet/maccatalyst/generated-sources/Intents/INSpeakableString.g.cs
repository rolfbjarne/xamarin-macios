...
namespace Intents {
	...
	public unsafe partial class INSpeakableString : NSObject, IINSpeakable, INSCoding, INSCopying, INSSecureCoding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("INSpeakableString");
		...
		public INSpeakableString (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected INSpeakableString (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal INSpeakableString (NativeHandle handle) : base (handle)
		{
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (spokenPhrase is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (spokenPhrase));
			var nsidentifier = CFString.CreateNative (identifier);
			var nsspokenPhrase = CFString.CreateNative (spokenPhrase);
			var nspronunciationHint = CFString.CreateNative (pronunciationHint);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithVocabularyIdentifier:spokenPhrase:pronunciationHint:"), nsidentifier, nsspokenPhrase, nspronunciationHint), "initWithVocabularyIdentifier:spokenPhrase:pronunciationHint:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithVocabularyIdentifier:spokenPhrase:pronunciationHint:"), nsidentifier, nsspokenPhrase, nspronunciationHint), "initWithVocabularyIdentifier:spokenPhrase:pronunciationHint:");
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nsidentifier);
			CFString.ReleaseNative (nsspokenPhrase);
			...
			: base (NSObjectFlag.Empty)
		{
			...
			var nsspokenPhrase = CFString.CreateNative (spokenPhrase);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("initWithSpokenPhrase:"), nsspokenPhrase), "initWithSpokenPhrase:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithSpokenPhrase:"), nsspokenPhrase), "initWithSpokenPhrase:");
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nsspokenPhrase);
