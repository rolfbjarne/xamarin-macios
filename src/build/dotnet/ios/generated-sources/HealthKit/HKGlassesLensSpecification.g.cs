	...
	public unsafe partial class HKGlassesLensSpecification : HKLensSpecification, INSCoding, INSCopying, INSSecureCoding {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithSphere:cylinder:axis:addPower:vertexDistance:prism:farPupillaryDistance:nearPupillaryDistance:"), sphere__handle__, cylinder__handle__, axis__handle__, addPower__handle__, vertexDistance__handle__, prism__handle__, farPupillaryDistance__handle__, nearPupillaryDistance__handle__), "initWithSphere:cylinder:axis:addPower:vertexDistance:prism:farPupillaryDistance:nearPupillaryDistance:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (sphere);
			GC.KeepAlive (cylinder);
			GC.KeepAlive (axis);
			GC.KeepAlive (addPower);
			GC.KeepAlive (vertexDistance);
			GC.KeepAlive (prism);
			GC.KeepAlive (farPupillaryDistance);
			GC.KeepAlive (nearPupillaryDistance);
		}
		...
		public virtual HKQuantity? FarPupillaryDistance {
			...
			get {
				HKQuantity? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("farPupillaryDistance")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("farPupillaryDistance")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual HKQuantity? NearPupillaryDistance {
			...
			get {
				HKQuantity? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("nearPupillaryDistance")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("nearPupillaryDistance")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual HKVisionPrism? Prism {
			...
			get {
				HKVisionPrism? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKVisionPrism> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("prism")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKVisionPrism> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("prism")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual HKQuantity? VertexDistance {
			...
			get {
				HKQuantity? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("vertexDistance")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("vertexDistance")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
