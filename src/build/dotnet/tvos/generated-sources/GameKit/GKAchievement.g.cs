...
namespace GameKit {
	...
	public unsafe partial class GKAchievement : NSObject, INSCoding, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void ReportAchievements (GKAchievement[] achievements, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V10))]global::System.Action<NSError>? completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void ReportAchievements (GKAchievement[] achievements, GKChallenge[] challenges, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V10))]global::System.Action<NSError>? completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (achievements is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (achievements));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void ResetAchivements ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V10))]global::System.Action<NSError>? completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			using var block_completionHandler = Trampolines.SDActionArity1V10.CreateNullableBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = null;
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void SelectChallengeablePlayers (GKPlayer[] players, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V57))]global::System.Action<GKPlayer[], NSError>? completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (players is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (players));
