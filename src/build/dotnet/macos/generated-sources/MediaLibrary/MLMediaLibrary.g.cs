...
namespace MediaLibrary {
	...
	public unsafe partial class MLMediaLibrary : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selMediaSourcesX = "mediaSources";
		static readonly NativeHandle selMediaSourcesXHandle = Selector.GetHandle ("mediaSources");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MLMediaLibrary");
		...
		protected MLMediaLibrary (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MLMediaLibrary (NativeHandle handle) : base (handle)
		{
		}

		/// <param name="options">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		...
		public virtual NSDictionary<NSString, MLMediaSource>? MediaSources {
			...
			get {
				NSDictionary<NSString, MLMediaSource>? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDictionary<NSString, MLMediaSource>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selMediaSourcesXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDictionary<NSString, MLMediaSource>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selMediaSourcesXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
