...
namespace CoreImage {
	...
	public partial class CIZoomBlur : CIFilter, ICIZoomBlurProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIZoomBlur" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIZoomBlur () : base ("CIZoomBlur")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIZoomBlur (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIZoomBlur (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIZoomBlur (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIZoomBlurProtocol protocol members 
