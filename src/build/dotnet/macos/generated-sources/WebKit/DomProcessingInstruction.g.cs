...
namespace WebKit {
	...
	public unsafe partial class DomProcessingInstruction : DomCharacterData {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("DOMProcessingInstruction");
		...
		protected DomProcessingInstruction (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal DomProcessingInstruction (NativeHandle handle) : base (handle)
		{
		}
