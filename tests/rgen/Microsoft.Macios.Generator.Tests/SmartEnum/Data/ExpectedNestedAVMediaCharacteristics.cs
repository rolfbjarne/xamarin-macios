...
public partial class OuterClass
{
	...
	{
		/// <summary>
		/// Extension methods for the <see cref="NestedAVMediaCharacteristicsExtensions" /> enumeration.
		/// </summary>
		...
		static partial class NestedAVMediaCharacteristicsExtensions
		{
			...
			public static NSString? GetConstant (this NestedAVMediaCharacteristics self)
			{
			...
			/// <summary>
			/// Retrieves the <see cref="NestedAVMediaCharacteristicsExtensions" /> value named by <paramref name="constant" />.
			/// </summary>
			/// <param name="constant">The name of the constant to retrieve.</param>
			public static NestedAVMediaCharacteristics GetValue (NSString constant)
			{
				if (constant is null)
					throw new ArgumentNullException (nameof (constant));
				if (constant.IsEqualTo (AVMediaCharacteristicVisual))
					return NestedAVMediaCharacteristics.Visual;
				if (constant.IsEqualTo (AVMediaCharacteristicAudible))
					return NestedAVMediaCharacteristics.Audible;
				if (constant.IsEqualTo (AVMediaCharacteristicLegible))
					return NestedAVMediaCharacteristics.Legible;
				if (constant.IsEqualTo (AVMediaCharacteristicFrameBased))
					return NestedAVMediaCharacteristics.FrameBased;
				if (constant.IsEqualTo (AVMediaCharacteristicUsesWideGamutColorSpace))
					return NestedAVMediaCharacteristics.UsesWideGamutColorSpace;
				if (constant.IsEqualTo (AVMediaCharacteristicIsMainProgramContent))
					return NestedAVMediaCharacteristics.IsMainProgramContent;
				if (constant.IsEqualTo (AVMediaCharacteristicIsAuxiliaryContent))
					return NestedAVMediaCharacteristics.IsAuxiliaryContent;
				if (constant.IsEqualTo (AVMediaCharacteristicContainsOnlyForcedSubtitles))
					return NestedAVMediaCharacteristics.ContainsOnlyForcedSubtitles;
				if (constant.IsEqualTo (AVMediaCharacteristicTranscribesSpokenDialogForAccessibility))
					return NestedAVMediaCharacteristics.TranscribesSpokenDialogForAccessibility;
				if (constant.IsEqualTo (AVMediaCharacteristicDescribesMusicAndSoundForAccessibility))
					return NestedAVMediaCharacteristics.DescribesMusicAndSoundForAccessibility;
				if (constant.IsEqualTo (AVMediaCharacteristicDescribesVideoForAccessibility))
					return NestedAVMediaCharacteristics.DescribesVideoForAccessibility;
				if (constant.IsEqualTo (AVMediaCharacteristicLanguageTranslation))
					return NestedAVMediaCharacteristics.LanguageTranslation;
				if (constant.IsEqualTo (AVMediaCharacteristicDubbedTranslation))
					return NestedAVMediaCharacteristics.DubbedTranslation;
				if (constant.IsEqualTo (AVMediaCharacteristicVoiceOverTranslation))
					return NestedAVMediaCharacteristics.VoiceOverTranslation;
				if (constant.IsEqualTo (AVMediaCharacteristicIsOriginalContent))
					return NestedAVMediaCharacteristics.IsOriginalContent;
				if (constant.IsEqualTo (AVMediaCharacteristicContainsHDRVideo))
					return NestedAVMediaCharacteristics.ContainsHdrVideo;
				if (constant.IsEqualTo (AVMediaCharacteristicContainsAlphaChannel))
					return NestedAVMediaCharacteristics.ContainsAlphaChannel;
				throw new NotSupportedException ($"The constant {constant} has no associated enum value on this platform.");
			}

			/// <summary>
			/// Retrieves the <see cref="NestedAVMediaCharacteristicsExtensions" /> value represented by the backing field value in <paramref name="handle" />.
			/// </summary>
			/// <param name="handle">The native handle with the name of the constant to retrieve.</param>
			public static NestedAVMediaCharacteristics GetValue (global::ObjCRuntime.NativeHandle handle)
			{
			...
			/// </summary>
			/// <param name="handle">The native handle with the name of the constant to retrieve.</param>
			public static NestedAVMediaCharacteristics? GetNullableValue (global::ObjCRuntime.NativeHandle handle)
			{
				using var str = Runtime.GetNSObject<NSString> (handle);
				if (str is null)
					return null;
			...
			/// <summary>
			/// Converts an array of <see cref="NestedAVMediaCharacteristicsExtensions" /> enum values into an array of their corresponding constants.
			/// </summary>
			/// <param name="values">The array of enum values to convert.</param>
			internal static NSString?[]? ToConstantArray (this NestedAVMediaCharacteristics[]? values)
			{
				if (values is null)
					return null;
			...
			internal static NestedAVMediaCharacteristics[]? ToEnumArray (this NSString[]? values)
			{
				if (values is null)
					return null;
				var rv = new global::System.Collections.Generic.List<NestedAVMediaCharacteristics> ();
				for (var i = 0; i < values.Length; i++) {
					var value = values [i];
