...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that reduces color of the image producing a vintage look.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CIPhotoEffectFade filter with the input image
	...
	/// var output = photo_effect_fade.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/photo_effect_fade.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIPhotoEffectFade : CIPhotoEffect {
		/// <summary>Creates a new <see cref="CIPhotoEffectFade" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPhotoEffectFade () : base ("CIPhotoEffectFade")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPhotoEffectFade (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPhotoEffectFade (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPhotoEffectFade (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
