		...
		public virtual bool IsLateNightModeEnabled {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isLateNightModeEnabled"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual bool IsSoundCheckEnabled {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isSoundCheckEnabled"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
