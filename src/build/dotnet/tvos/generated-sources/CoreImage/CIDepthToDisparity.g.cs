...
namespace CoreImage {
	...
	public partial class CIDepthToDisparity : CIDepthDisparityConverter, ICIDepthToDisparityProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIDepthToDisparity" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIDepthToDisparity () : base ("CIDepthToDisparity")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIDepthToDisparity (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDepthToDisparity (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDepthToDisparity (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIDepthToDisparityProtocol protocol members 
