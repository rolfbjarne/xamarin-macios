...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CISmoothLinearGradient</c>.</summary>
	/// <remarks>
	...
	public partial interface ICISmoothLinearGradientProtocol : INativeObject, IDisposable, 
		CoreImage.ICIFilterProtocol
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CISmoothLinearGradientProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICISmoothLinearGradientProtocol ()
		{
			GC.KeepAlive (null);
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CGPoint _GetInputPoint0 (ICISmoothLinearGradientProtocol This)
		{
			CGPoint ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputPoint0 (ICISmoothLinearGradientProtocol This, CGPoint value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CGPoint _GetInputPoint1 (ICISmoothLinearGradientProtocol This)
		{
			CGPoint ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputPoint1 (ICISmoothLinearGradientProtocol This, CGPoint value)
		{
			global::ObjCRuntime.Messaging.void_objc_msgSend_CGPoint (This.Handle, Selector.GetHandle ("setPoint1:"), value);
			GC.KeepAlive (This);
		}
		/// <summary>The color associated with <see cref="CISmoothLinearGradient.InputPoint0" />.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[global::Foundation.RequiredMember]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CIColor _GetColor0 (ICISmoothLinearGradientProtocol This)
		{
			CIColor ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetColor0 (ICISmoothLinearGradientProtocol This, CIColor value)
		{
		...
		/// <summary>The color associated with <see cref="CISmoothLinearGradient.InputPoint1" /></summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[global::Foundation.RequiredMember]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CIColor _GetColor1 (ICISmoothLinearGradientProtocol This)
		{
			CIColor ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetColor1 (ICISmoothLinearGradientProtocol This, CIColor value)
		{
			var value__handle__ = value!.GetNonNullHandle (nameof (value));
	...
	internal unsafe sealed class CISmoothLinearGradientProtocolWrapper : BaseWrapper, ICISmoothLinearGradientProtocol {
		public CISmoothLinearGradientProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CISmoothLinearGradientProtocolWrapper))]
		static CISmoothLinearGradientProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>The point associated with <see cref="CISmoothLinearGradient.Color0" /></summary>
