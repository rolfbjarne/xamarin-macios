...
namespace MonoTouchFixtures.ObjCRuntime {
	...
	public class TrampolineTest {
		...
		public static bool IsArm64_32 {
			get {
#if __WATCHOS__
				return Runtime.Arch == Arch.DEVICE && Runtime.CpuArchitecture == "arm64_32";
#else
				return false;
#endif
			}
		...
		public static bool IsArmv7k {
			get {
#if __WATCHOS__
				return Runtime.Arch == Arch.DEVICE && Runtime.CpuArchitecture == "armv7k";
#else
				return false;
#endif
			}
		...
		public void FloatingPointStretTrampolineTest ()
		{
			...
			if (IsArm64 || IsArmv7k || IsArm64_32) {
