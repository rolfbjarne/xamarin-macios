...
//			}
		...
		[Test]
		public void ___RefOutTest_CFBundle ()
		{
		...
		[Test]
		public void ___RefOutTest_INSCoding ()
		{
			IntPtr refValue = IntPtr.Zero;
			IntPtr outValue = IntPtr.Zero;
		...
		[Test]
		public void ___RefOutTest_NSObject ()
		{
			IntPtr refValue = IntPtr.Zero;
			IntPtr outValue = IntPtr.Zero;
		...
		[Test]
		public void ___RefOutTest_NSValue ()
		{
			IntPtr refValue = IntPtr.Zero;
			IntPtr outValue = IntPtr.Zero;
		...
		[Test]
		public void ___RefOutTest_String ()
		{
			IntPtr refValue = IntPtr.Zero;
			IntPtr outValue = IntPtr.Zero;
		...
		[Test]
		public void ___RefOutTest_Class ()
		{
			IntPtr refValue = IntPtr.Zero;
			IntPtr outValue = IntPtr.Zero;
			...
			using (var obj = new RefOutParametersSubclass ()) {
				...
				outObj = dummyObj; // set to non-null
				test (action << 8, ref refObj, out outObj);
				Assert.AreEqual (Class.GetHandle ("AppDelegate"), refObj.Handle, "Class-3M-ref");
				Assert.AreEqual (Class.GetHandle ("AppDelegate"), outObj.Handle, "Class-3M-out");
				...
				Assert.AreEqual (Class.GetHandle ("AppDelegate"), refValue, "Class-3DM-ref");
				Assert.AreEqual (Class.GetHandle ("AppDelegate"), outValue, "Class-3DM-out");
		...
		[Test]
		public unsafe void ___RefOutTest_ClassArray ()
		{
			IntPtr refValue = IntPtr.Zero;
			IntPtr outValue = IntPtr.Zero;
		...
		class RefOutParametersSubclass : BI1064.RefOutParameters
		{
			...
			public override void TestClass (int action, ref Class refValue, out Class outValue)
			{
				...
				case 2: // verify that refValue points to something
					...
					break;
				case 3: // set both parameteres to the same value
					var obj = new Class (typeof (AppDelegate));
					refValue = obj;
					outValue = obj;
					break;
				case 4: // set both parameteres to different values
