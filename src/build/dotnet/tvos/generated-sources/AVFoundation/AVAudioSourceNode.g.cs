	...
	public unsafe partial class AVAudioSourceNode : AVAudioNode, IAVAudio3DMixing, IAVAudioMixing, IAVAudioStereoMixing {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					...
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithRenderBlock:"), (IntPtr) block_ptr_renderHandler), "initWithRenderBlock:");
					GC.KeepAlive (this);
				}
			}
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithFormat:renderBlock:"), format__handle__, (IntPtr) block_ptr_renderHandler), "initWithFormat:renderBlock:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (format);
