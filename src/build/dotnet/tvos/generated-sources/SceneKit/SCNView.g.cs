...
namespace SceneKit {
	...
	public unsafe partial class SCNView : global::UIKit.UIView, ISCNSceneRenderer, ISCNTechniqueSupport {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void Prepare (NSObject[] objects, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<bool>? completionHandler)
		{
			if (objects is null)
		...
		public virtual nint Context {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("context"));
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		[UnsupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("ios12.0", "Please use Metal instead of OpenGL API.")]
		[ObsoletedOSPlatform ("tvos12.0", "Please use Metal instead of OpenGL API.")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Please use Metal instead of OpenGL API.")]
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("tvos")]
		public virtual global::OpenGLES.EAGLContext? EAGLContext {
			[Export ("eaglContext", ArgumentSemantic.Retain)]
			get {
				global::OpenGLES.EAGLContext? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<global::OpenGLES.EAGLContext> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("eaglContext")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<global::OpenGLES.EAGLContext> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("eaglContext")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			}
			[Export ("setEaglContext:", ArgumentSemantic.Retain)]
			set {
				var value__handle__ = value.GetHandle ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setEaglContext:"), value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setEaglContext:"), value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
