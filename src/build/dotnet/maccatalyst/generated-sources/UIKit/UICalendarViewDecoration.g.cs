...
namespace UIKit {
	...
	public unsafe partial class UICalendarViewDecoration : NSObject {
		...
		/// <summary>Creates a new <see cref="UICalendarViewDecoration" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_IntPtr (&__objc_super__, Selector.GetHandle ("initWithImage:color:size:"), image__handle__, color__handle__, (IntPtr) (long) size), "initWithImage:color:size:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (image);
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithCustomViewProvider:"), (IntPtr) block_ptr_customViewProvider), "initWithCustomViewProvider:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		public static UICalendarViewDecoration Create (UIColor? color, UICalendarViewDecorationSize size)
		{
			...
			ret =  Runtime.GetNSObject<UICalendarViewDecoration> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_IntPtr (class_ptr, Selector.GetHandle ("decorationWithColor:size:"), color__handle__, (IntPtr) (long) size), false)!;
			GC.KeepAlive (color);
			return ret!;
		}
		...
		public static UICalendarViewDecoration Create (UIImage? image)
		{
			...
			var image__handle__ = image.GetHandle ();
			UICalendarViewDecoration? ret;
			ret =  Runtime.GetNSObject<UICalendarViewDecoration> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("decorationWithImage:"), image__handle__), false)!;
			GC.KeepAlive (image);
			return ret!;
		}
		...
		public static UICalendarViewDecoration Create (UIImage? image, UIColor? color, UICalendarViewDecorationSize size)
		{
			...
			var color__handle__ = color.GetHandle ();
			UICalendarViewDecoration? ret;
			ret =  Runtime.GetNSObject<UICalendarViewDecoration> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_IntPtr (class_ptr, Selector.GetHandle ("decorationWithImage:color:size:"), image__handle__, color__handle__, (IntPtr) (long) size), false)!;
			GC.KeepAlive (image);
			GC.KeepAlive (color);
			return ret!;
		}
		...
		public unsafe static UICalendarViewDecoration Create ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity1V6))]global::System.Func<UIView> customViewProvider)
		{
			...
			BlockLiteral *block_ptr_customViewProvider = &block_customViewProvider;
			UICalendarViewDecoration ret;
			ret =  Runtime.GetNSObject<UICalendarViewDecoration> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("decorationWithCustomViewProvider:"), (IntPtr) block_ptr_customViewProvider), false)!;
			return ret;
		}
