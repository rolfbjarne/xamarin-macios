...
#nullable enable
namespace CoreImage {
	/// <summary>The CIHueAdjust CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/HueAdjust.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIHueAdjust : CIFilter, ICIHueAdjustProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIHueAdjust" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIHueAdjust () : base ("CIHueAdjust")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIHueAdjust (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIHueAdjust (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIHueAdjust (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIHueAdjustProtocol protocol members 
