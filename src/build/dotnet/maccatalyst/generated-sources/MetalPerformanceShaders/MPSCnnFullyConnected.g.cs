...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSCnnFullyConnected : MPSCnnConvolution {
		...
		internal virtual nint InitWithDevice (global::Metal.IMTLDevice device, MPSCnnConvolutionDescriptor fullyConnectedDescriptor, nint kernelWeights, nint biasTerms, MPSCnnConvolutionFlags flags)
		{
			...
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_NativeHandle_IntPtr_IntPtr_UIntPtr (this.Handle, Selector.GetHandle ("initWithDevice:convolutionDescriptor:kernelWeights:biasTerms:flags:"), device__handle__, fullyConnectedDescriptor__handle__, kernelWeights, biasTerms, (UIntPtr) (ulong) flags);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_NativeHandle_IntPtr_IntPtr_UIntPtr (&__objc_super__, Selector.GetHandle ("initWithDevice:convolutionDescriptor:kernelWeights:biasTerms:flags:"), device__handle__, fullyConnectedDescriptor__handle__, kernelWeights, biasTerms, (UIntPtr) (ulong) flags);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
