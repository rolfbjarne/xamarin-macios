...
namespace MetalFX {
	...
	/// <summary>This interface represents the Objective-C protocol <c>MTLFXFrameInterpolator</c>.</summary>
	/// <remarks>
	...
	[Protocol (Name = "MTLFXFrameInterpolator", WrapperType = typeof (MTLFXFrameInterpolatorWrapper), BackwardsCompatibleCodeGeneration = false)]
	...
	public partial interface IMTLFXFrameInterpolator : INativeObject, IDisposable, 
		MetalFX.IMTLFXFrameInterpolatorBase
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _Encode (IMTLFXFrameInterpolator This, global::Metal.IMTLCommandBuffer commandBuffer)
		{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (MTLFXFrameInterpolatorWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static IMTLFXFrameInterpolator ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class MTLFXFrameInterpolatorWrapper : BaseWrapper, IMTLFXFrameInterpolator {
		public MTLFXFrameInterpolatorWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (MTLFXFrameInterpolatorWrapper))]
		static MTLFXFrameInterpolatorWrapper ()
		{
			GC.KeepAlive (null);
		}
		[Export ("encodeToCommandBuffer:")]
