...
namespace AppKit {
	...
	public unsafe partial class NSStepperTouchBarItem : NSTouchBarItem {
		...
		public static NSStepperTouchBarItem Create (NSTouchBarItemIdentifier identifier, NSFormatter formatter)
		{
			...
			ret =  Runtime.GetNSObject<NSStepperTouchBarItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_int_NativeHandle (class_ptr, Selector.GetHandle ("stepperTouchBarItemWithIdentifier:formatter:"), (int)identifier, formatter__handle__), false)!;
			GC.KeepAlive (formatter);
			return ret!;
		}
		[Export ("stepperTouchBarItemWithIdentifier:drawingHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static NSStepperTouchBarItem Create (NSTouchBarItemIdentifier identifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V24))]global::System.Action<CGRect, double> drawingHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (drawingHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (drawingHandler));
			using var block_drawingHandler = Trampolines.SDActionArity2V24.CreateBlock (drawingHandler);
			BlockLiteral *block_ptr_drawingHandler = &block_drawingHandler;
			NSStepperTouchBarItem ret;
			ret =  Runtime.GetNSObject<NSStepperTouchBarItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_int_NativeHandle (class_ptr, Selector.GetHandle ("stepperTouchBarItemWithIdentifier:drawingHandler:"), (int)identifier, (IntPtr) block_ptr_drawingHandler), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual double Increment {
			...
			get {
				...
				double ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.Double_objc_msgSend (this.Handle, Selector.GetHandle ("increment"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.Double_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("increment"));
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_Double (this.Handle, Selector.GetHandle ("setIncrement:"), value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_Double (&__objc_super__, Selector.GetHandle ("setIncrement:"), value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual double MaxValue {
			...
			get {
				...
				double ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.Double_objc_msgSend (this.Handle, Selector.GetHandle ("maxValue"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.Double_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("maxValue"));
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_Double (this.Handle, Selector.GetHandle ("setMaxValue:"), value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_Double (&__objc_super__, Selector.GetHandle ("setMaxValue:"), value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual double MinValue {
			...
			get {
				...
				double ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.Double_objc_msgSend (this.Handle, Selector.GetHandle ("minValue"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.Double_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("minValue"));
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_Double (this.Handle, Selector.GetHandle ("setMinValue:"), value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_Double (&__objc_super__, Selector.GetHandle ("setMinValue:"), value);
						GC.KeepAlive (this);
					}
				}
			}
