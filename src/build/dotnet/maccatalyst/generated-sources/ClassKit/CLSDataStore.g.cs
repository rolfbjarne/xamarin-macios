...
namespace ClassKit {
	...
	public unsafe partial class CLSDataStore : NSObject {
		...
		public unsafe virtual void CheckIsAssignedDocument (NSUrl documentUrl, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDCLSDataStoreCheckAssignedDocumentCompletionHandler))]CLSDataStoreCheckAssignedDocumentCompletionHandler completion)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("checkIsAssignedDocument:completion:"), documentUrl__handle__, (IntPtr) block_ptr_completion);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("checkIsAssignedDocument:completion:"), documentUrl__handle__, (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void CompleteAllAssignedActivitiesMatching (string[] contextPath)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("completeAllAssignedActivitiesMatching:"), nsa_contextPath.Handle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("completeAllAssignedActivitiesMatching:"), nsa_contextPath.Handle);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public unsafe virtual void FetchActivity (NSUrl url, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V34))]global::System.Action<CLSActivity, NSError> completion)
		{
			...
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
			using var block_completion = Trampolines.SDActionArity2V34.CreateBlock (completion);
			BlockLiteral *block_ptr_completion = &block_completion;
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("fetchActivityForURL:completion:"), url__handle__, (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (url);
		...
		public unsafe virtual void FindContextsMatching (NSPredicate predicate, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V35))]global::System.Action<CLSContext[], NSError> completion)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("contextsMatchingPredicate:completion:"), predicate__handle__, (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual void FindContextsMatching (string[] identifierPath, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V35))]global::System.Action<CLSContext[], NSError> completion)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("contextsMatchingIdentifierPath:completion:"), nsa_identifierPath.Handle, (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void Remove (CLSContext context)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("removeContext:"), context__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("removeContext:"), context__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void Save ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError>? completion)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("saveWithCompletion:"), (IntPtr) block_ptr_completion);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("saveWithCompletion:"), (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual CLSContext? ActiveContext {
			...
			get {
				CLSContext? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<CLSContext> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("activeContext")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<CLSContext> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("activeContext")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual CLSContext MainAppContext {
			...
			get {
				CLSContext? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<CLSContext> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("mainAppContext")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<CLSContext> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("mainAppContext")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual CLSActivity? RunningActivity {
			...
			get {
				CLSActivity? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<CLSActivity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("runningActivity")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<CLSActivity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("runningActivity")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public static CLSDataStore Shared {
			...
			get {
				CLSDataStore? ret;
				ret =  Runtime.GetNSObject<CLSDataStore> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("shared")), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
