...
namespace Accessibility {
	...
	public unsafe partial class AXMathExpressionIdentifier : AXMathExpression {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithContent_XHandle, nscontent), "initWithContent:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithContent_XHandle, nscontent), "initWithContent:");
					GC.KeepAlive (this);
				}
			}
