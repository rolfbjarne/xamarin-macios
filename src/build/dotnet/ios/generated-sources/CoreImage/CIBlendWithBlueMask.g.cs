...
namespace CoreImage {
	...
	public partial class CIBlendWithBlueMask : CIBlendWithMask {
		/// <summary>Creates a new <see cref="CIBlendWithBlueMask" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIBlendWithBlueMask () : base ("CIBlendWithBlueMask")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBlendWithBlueMask (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBlendWithBlueMask (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBlendWithBlueMask (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
