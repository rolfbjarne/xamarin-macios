...
#nullable enable
namespace UIKit {
	/// <summary>An enumeration whose values specify the prominence of the <see cref="T:UIKit.UISearchBar" />.</summary><remarks>To be added.</remarks><altmember cref="P:UIKit.UISearchBar.SearchBarStyle" />
