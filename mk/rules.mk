...
## iosmac (ios on macOS / UIKitForMac)

.libs/iosmac/%$(1).x86_64.o: %.m $(EXTRA_DEPENDENCIES) | .libs/iosmac
	$$(call Q_2,OBJC,  [iosmac]) $(SIMULATOR_CC) $(IOSMAC_OBJC_CFLAGS) $$(EXTRA_DEFINES) $(COMMON_I) -g $(2) -c $$< -o $$@

.libs/iosmac/%$(1).x86_64.o: %.c $(EXTRA_DEPENDENCIES) | .libs/iosmac
	$$(call Q_2,CC,    [iosmac]) $(SIMULATOR_CC) $(IOSMAC_CFLAGS)      $$(EXTRA_DEFINES) $(COMMON_I) -g $(2) -c $$< -o $$@

.libs/iosmac/%$(1).x86_64.o: %.s $(EXTRA_DEPENDENCIES) | .libs/iosmac
	$$(call Q_2,ASM,   [iosmac]) $(SIMULATOR_CC) $(IOSMAC_CFLAGS)                        $(COMMON_I) -g $(2) -c $$< -o $$@

.libs/iosmac/%$(1).x86_64.dylib: | .libs/iosmac
	$$(call Q_2,LD,    [iosmac]) $(SIMULATOR_CC) $(IOSMAC_CFLAGS)      $$(EXTRA_FLAGS) -dynamiclib -o $$@ $$^ -L$(IOS_DESTDIR)$(XAMARIN_UIKITFORMAC_SDK)/usr/lib -fapplication-extension
