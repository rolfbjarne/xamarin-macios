...
namespace HealthKit {
	...
	public unsafe partial class HKVisionPrescription : HKSample, INSCoding, INSCopying, INSSecureCoding {
		...
		public static HKVisionPrescription GetPrescription (HKVisionPrescriptionType type, NSDate dateIssued, NSDate? expirationDate, HKDevice? device, NSDictionary<NSString, NSObject>? metadata)
		{
			...
			ret =  Runtime.GetNSObject<HKVisionPrescription> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr_NativeHandle_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("prescriptionWithType:dateIssued:expirationDate:device:metadata:"), (UIntPtr) (ulong) type, dateIssued__handle__, expirationDate__handle__, device__handle__, metadata__handle__), false)!;
		...
		public virtual NSDate DateIssued {
			...
			get {
				NSDate? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("dateIssued")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("dateIssued")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual HKVisionPrescriptionType PrescriptionType {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (HealthKit.HKVisionPrescriptionType) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("prescriptionType"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
