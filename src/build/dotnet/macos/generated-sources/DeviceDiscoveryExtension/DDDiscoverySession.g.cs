...
namespace DeviceDiscoveryExtension {
	...
	public unsafe partial class DDDiscoverySession : NSObject {
		...
		const string selReportEvent_X = "reportEvent:";
		static readonly NativeHandle selReportEvent_XHandle = Selector.GetHandle ("reportEvent:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>Creates a new <see cref="DDDiscoverySession" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual void ReportEvent (DDDeviceEvent inEvent)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selReportEvent_XHandle, inEvent__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selReportEvent_XHandle, inEvent__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (inEvent);
		}
