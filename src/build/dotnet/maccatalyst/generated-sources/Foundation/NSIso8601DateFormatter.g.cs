...
namespace Foundation {
	...
	public unsafe partial class NSIso8601DateFormatter : NSFormatter, INSCoding, INSSecureCoding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSISO8601DateFormatter");
		...
		/// <summary>Creates a new <see cref="NSIso8601DateFormatter" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[DesignatedInitializer]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public NSIso8601DateFormatter () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		public NSIso8601DateFormatter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSIso8601DateFormatter (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSIso8601DateFormatter (NativeHandle handle) : base (handle)
		{
		}
		...
		public static string Format (NSDate date, NSTimeZone timeZone, NSIso8601DateFormatOptions formatOptions)
		{
			...
			string? ret;
			ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_UIntPtr (class_ptr, Selector.GetHandle ("stringFromDate:timeZone:formatOptions:"), date__handle__, timeZone__handle__, (UIntPtr) (ulong) formatOptions), false)!;
			GC.KeepAlive (date);
		...
		public virtual NSDate? ToDate (string @string)
		{
			...
			NSDate? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("dateFromString:"), nsstring), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("dateFromString:"), nsstring), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual NSIso8601DateFormatOptions FormatOptions {
			...
			get {
				NSIso8601DateFormatOptions ret;
				if (IsDirectBinding) {
					ret = (NSIso8601DateFormatOptions) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("formatOptions"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSIso8601DateFormatOptions) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("formatOptions"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, Selector.GetHandle ("setFormatOptions:"), (UIntPtr) (ulong) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, Selector.GetHandle ("setFormatOptions:"), (UIntPtr) (ulong) value);
						GC.KeepAlive (this);
					}
				}
			}
