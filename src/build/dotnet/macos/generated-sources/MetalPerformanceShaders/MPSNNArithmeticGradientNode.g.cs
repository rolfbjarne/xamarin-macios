...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSNNArithmeticGradientNode : MPSNNGradientFilterNode {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selBiasX = "bias";
		static readonly NativeHandle selBiasXHandle = Selector.GetHandle ("bias");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithGradientImages_ForwardFilter_IsSecondarySourceFilter_X = "initWithGradientImages:forwardFilter:isSecondarySourceFilter:";
		static readonly NativeHandle selInitWithGradientImages_ForwardFilter_IsSecondarySourceFilter_XHandle = Selector.GetHandle ("initWithGradientImages:forwardFilter:isSecondarySourceFilter:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithSourceGradient_SourceImage_GradientState_IsSecondarySourceFilter_X = "initWithSourceGradient:sourceImage:gradientState:isSecondarySourceFilter:";
		static readonly NativeHandle selInitWithSourceGradient_SourceImage_GradientState_IsSecondarySourceFilter_XHandle = Selector.GetHandle ("initWithSourceGradient:sourceImage:gradientState:isSecondarySourceFilter:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNodeWithSourceGradient_SourceImage_GradientState_IsSecondarySourceFilter_X = "nodeWithSourceGradient:sourceImage:gradientState:isSecondarySourceFilter:";
		static readonly NativeHandle selNodeWithSourceGradient_SourceImage_GradientState_IsSecondarySourceFilter_XHandle = Selector.GetHandle ("nodeWithSourceGradient:sourceImage:gradientState:isSecondarySourceFilter:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSNNArithmeticGradientNode");
		...
		protected MPSNNArithmeticGradientNode (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSNNArithmeticGradientNode (NativeHandle handle) : base (handle)
		{
		}

		/// <param name="sourceGradient">To be added.</param><param name="sourceImage">To be added.</param><param name="gradientState">To be added.</param><param name="isSecondarySourceFilter">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_bool (this.Handle, selInitWithSourceGradient_SourceImage_GradientState_IsSecondarySourceFilter_XHandle, sourceGradient__handle__, sourceImage__handle__, gradientState__handle__, isSecondarySourceFilter ? (byte) 1 : (byte) 0), "initWithSourceGradient:sourceImage:gradientState:isSecondarySourceFilter:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_bool (&__objc_super__, selInitWithSourceGradient_SourceImage_GradientState_IsSecondarySourceFilter_XHandle, sourceGradient__handle__, sourceImage__handle__, gradientState__handle__, isSecondarySourceFilter ? (byte) 1 : (byte) 0), "initWithSourceGradient:sourceImage:gradientState:isSecondarySourceFilter:");
					GC.KeepAlive (this);
				}
			}
		...
		/// <param name="gradientImages">To be added.</param><param name="filter">To be added.</param><param name="isSecondarySourceFilter">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_bool (this.Handle, selInitWithGradientImages_ForwardFilter_IsSecondarySourceFilter_XHandle, nsa_gradientImages.Handle, filter__handle__, isSecondarySourceFilter ? (byte) 1 : (byte) 0), "initWithGradientImages:forwardFilter:isSecondarySourceFilter:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_bool (&__objc_super__, selInitWithGradientImages_ForwardFilter_IsSecondarySourceFilter_XHandle, nsa_gradientImages.Handle, filter__handle__, isSecondarySourceFilter ? (byte) 1 : (byte) 0), "initWithGradientImages:forwardFilter:isSecondarySourceFilter:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (filter);
		}
		/// <param name="sourceGradient">To be added.</param><param name="sourceImage">To be added.</param><param name="gradientState">To be added.</param><param name="isSecondarySourceFilter">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		...
		public static MPSNNArithmeticGradientNode Create (MPSNNImageNode sourceGradient, MPSNNImageNode sourceImage, MPSNNBinaryGradientStateNode gradientState, bool isSecondarySourceFilter)
		{
			...
			var sourceImage__handle__ = sourceImage!.GetNonNullHandle (nameof (sourceImage));
			var gradientState__handle__ = gradientState!.GetNonNullHandle (nameof (gradientState));
			MPSNNArithmeticGradientNode? ret;
			ret =  Runtime.GetNSObject<MPSNNArithmeticGradientNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_bool (class_ptr, selNodeWithSourceGradient_SourceImage_GradientState_IsSecondarySourceFilter_XHandle, sourceGradient__handle__, sourceImage__handle__, gradientState__handle__, isSecondarySourceFilter ? (byte) 1 : (byte) 0), false)!;
			GC.KeepAlive (sourceGradient);
			GC.KeepAlive (sourceImage);
			GC.KeepAlive (gradientState);
			return ret!;
