...
#nullable enable
namespace AppKit {
	[Register("NSTrackingSeparatorToolbarItem", true)]
	[UnsupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
	public unsafe partial class NSTrackingSeparatorToolbarItem : NSToolbarItem {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDividerIndexX = "dividerIndex";
		static readonly NativeHandle selDividerIndexXHandle = Selector.GetHandle ("dividerIndex");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetDividerIndex_X = "setDividerIndex:";
		static readonly NativeHandle selSetDividerIndex_XHandle = Selector.GetHandle ("setDividerIndex:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTrackingSeparatorToolbarItemWithIdentifier_SplitView_DividerIndex_X = "trackingSeparatorToolbarItemWithIdentifier:splitView:dividerIndex:";
		static readonly NativeHandle selTrackingSeparatorToolbarItemWithIdentifier_SplitView_DividerIndex_XHandle = Selector.GetHandle ("trackingSeparatorToolbarItemWithIdentifier:splitView:dividerIndex:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSTrackingSeparatorToolbarItem");
		...
		protected NSTrackingSeparatorToolbarItem (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSTrackingSeparatorToolbarItem (NativeHandle handle) : base (handle)
		{
		}
		...
		public static NSTrackingSeparatorToolbarItem GetTrackingSeparatorToolbar (string identifier, NSSplitView splitView, nint dividerIndex)
		{
			...
			NSTrackingSeparatorToolbarItem? ret;
			ret =  Runtime.GetNSObject<NSTrackingSeparatorToolbarItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_IntPtr (class_ptr, selTrackingSeparatorToolbarItemWithIdentifier_SplitView_DividerIndex_XHandle, nsidentifier, splitView__handle__, dividerIndex), false)!;
			GC.KeepAlive (splitView);
			CFString.ReleaseNative (nsidentifier);
			return ret!;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual nint DividerIndex {
			[Export ("dividerIndex")]
			get {
				global::AppKit.NSApplication.EnsureUIThread ();
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selDividerIndexXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selDividerIndexXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			}
			[Export ("setDividerIndex:")]
			set {
				global::AppKit.NSApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr (this.Handle, selSetDividerIndex_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, selSetDividerIndex_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
