...
namespace MapKit {
	...
	public unsafe partial class MKPolyline : MKMultiPoint, IMKGeoJsonObject, IMKOverlay {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPolylineWithCoordinates_Count_X = "polylineWithCoordinates:count:";
		static readonly NativeHandle selPolylineWithCoordinates_Count_XHandle = Selector.GetHandle ("polylineWithCoordinates:count:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPolylineWithPoints_Count_X = "polylineWithPoints:count:";
		static readonly NativeHandle selPolylineWithPoints_Count_XHandle = Selector.GetHandle ("polylineWithPoints:count:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MKPolyline");
		...
		/// <summary>Creates a new <see cref="MKPolyline" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public MKPolyline () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected MKPolyline (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MKPolyline (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static MKPolyline _FromCoordinates (nint coords, nint count)
		{
			MKPolyline ret;
			ret =  Runtime.GetNSObject<MKPolyline> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (class_ptr, selPolylineWithCoordinates_Count_XHandle, coords, count), false)!;
			return ret;
		}
		[Export ("polylineWithPoints:count:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static MKPolyline _FromPoints (nint points, nint count)
		{
			MKPolyline ret;
			ret =  Runtime.GetNSObject<MKPolyline> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (class_ptr, selPolylineWithPoints_Count_XHandle, points, count), false)!;
			return ret;
		}
