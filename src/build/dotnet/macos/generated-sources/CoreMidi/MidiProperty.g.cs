...
namespace CoreMidi {
	...
	static internal partial class MidiPropertyExtensions {
		static IntPtr[] values = new IntPtr [51];
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("maccatalyst")]
		...
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		[Field ("kMIDIPropertyFactoryPatchNameFile", "CoreMidi")]
		internal unsafe static IntPtr kMIDIPropertyFactoryPatchNameFile {
			get {
				fixed (IntPtr *storage = &values [16])
					return Dlfcn.CachePointer (Libraries.CoreMidi.Handle, "kMIDIPropertyFactoryPatchNameFile", storage);
			}
		}
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		[Field ("kMIDIPropertyUserPatchNameFile", "CoreMidi")]
		internal unsafe static IntPtr kMIDIPropertyUserPatchNameFile {
			get {
				fixed (IntPtr *storage = &values [17])
					return Dlfcn.CachePointer (Libraries.CoreMidi.Handle, "kMIDIPropertyUserPatchNameFile", storage);
			}
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios")]
		...
		public static NSString? GetConstant (this MidiProperty self)
		{
			...
			case 15: // MidiProperty.DriverOwner
				...
				break;
			case 16: // MidiProperty.FactoryPatchNameFile
				ptr = kMIDIPropertyFactoryPatchNameFile;
				break;
			case 17: // MidiProperty.UserPatchNameFile
				ptr = kMIDIPropertyUserPatchNameFile;
				break;
		...
		public static MidiProperty GetValue (NSString constant)
		{
			...
			if (constant.IsEqualTo (kMIDIPropertyFactoryPatchNameFile))
				return MidiProperty.FactoryPatchNameFile;
			if (constant.IsEqualTo (kMIDIPropertyUserPatchNameFile))
				return MidiProperty.UserPatchNameFile;
