...
namespace CoreImage {
	...
	public abstract partial class CIPhotoEffect : CIFilter, ICIPhotoEffectProtocol, ICIFilterProtocol {
		...
		protected internal CIPhotoEffect (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPhotoEffect (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPhotoEffect (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIPhotoEffect" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public  CIPhotoEffect (string name) : base (CreateFilter (name))
		{
		}
		// CIPhotoEffectProtocol protocol members 
