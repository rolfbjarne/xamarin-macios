...
namespace AVFoundation {
	...
	public unsafe partial class AVAssetDownloadTask : NSUrlSessionTask {
		...
		const string selURLAssetX = "URLAsset";
		static readonly NativeHandle selURLAssetXHandle = Selector.GetHandle ("URLAsset");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual AVUrlAsset UrlAsset {
			...
			get {
				AVUrlAsset? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<AVUrlAsset> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selURLAssetXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<AVUrlAsset> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selURLAssetXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
