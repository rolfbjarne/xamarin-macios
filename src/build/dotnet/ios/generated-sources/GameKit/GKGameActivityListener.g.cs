...
namespace GameKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WantsToPlayGameActivity", Selector = "player:wantsToPlayGameActivity:completionHandler:", ParameterType = new Type [] { typeof (GameKit.GKPlayer), typeof (GameKit.GKGameActivity), typeof (global::System.Action<bool>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V4) })]
	public partial interface IGKGameActivityListener : INativeObject, IDisposable
	{
		...
		public unsafe virtual void WantsToPlayGameActivity (GKPlayer player, GKGameActivity activity, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V4))]global::System.Action<bool> completionHandler)
		{
			_WantsToPlayGameActivity (this, player, activity, completionHandler);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _WantsToPlayGameActivity (IGKGameActivityListener This, GKPlayer player, GKGameActivity activity, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V4))]global::System.Action<bool> completionHandler)
		{
