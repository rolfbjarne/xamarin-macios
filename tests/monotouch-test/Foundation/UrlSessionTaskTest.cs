	...
	public class UrlSessionTaskTest {
		...
		public void Properties ()
		{
			...
			using (var task = NSUrlSession.SharedSession.CreateDownloadTask (ur)) {
				...
				ClassicAssert.NotNull (task.CurrentRequest, "currentRequest");
				ClassicAssert.Null (task.Error, "error");
				ClassicAssert.NotNull (task.OriginalRequest, "originalRequest");
				ClassicAssert.Null (task.Response, "response");
				Assert.That (task.State, Is.EqualTo (NSUrlSessionTaskState.Suspended), "state");
				ClassicAssert.Null (task.TaskDescription, "taskDescription");
				...
				if (TestRuntime.CheckXcodeVersion (9, 0)) {
					ClassicAssert.Null (task.EarliestBeginDate, "earliestBeginDate");
					...
					ClassicAssert.NotNull (task.Progress, "progress");
				}
			}
		}
		...
		public void NSUrlSessionDownloadTaskTest ()
		{
			...
			using (var ur = new NSUrlRequest ()) {
				...
				ClassicAssert.IsNotNull (task, "task should not be null");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionDownloadTask), task, "task should be an instance of NSUrlSessionDownloadTask");
			}

			using (var ur = new NSUrlRequest ()) {
				NSUrlSessionDownloadTask task = null;
				Assert.DoesNotThrow (() => task = NSUrlSession.SharedSession.CreateDownloadTask (ur, null), "Should not throw InvalidCastException 2");
				ClassicAssert.IsNotNull (task, "task should not be null 2");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionDownloadTask), task, "task should be an instance of NSUrlSessionDownloadTask 2");
			}
			...
			using (var ur = new NSUrl (NetworkResources.MicrosoftUrl)) {
				...
				ClassicAssert.IsNotNull (task, "task should not be null 3");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionDownloadTask), task, "task should be an instance of NSUrlSessionDownloadTask 3");
			}

			using (var ur = new NSUrl (NetworkResources.MicrosoftUrl)) {
				NSUrlSessionDownloadTask task = null;
				Assert.DoesNotThrow (() => task = NSUrlSession.SharedSession.CreateDownloadTask (ur, null), "Should not throw InvalidCastException 4");
				ClassicAssert.IsNotNull (task, "task should not be null 4");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionDownloadTask), task, "task should be an instance of NSUrlSessionDownloadTask 4");
			}
		}
		...
		public void NSUrlSessionDataTaskTest ()
		{
			...
			using (var ur = new NSUrlRequest ()) {
				...
				ClassicAssert.IsNotNull (task, "task should not be null");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionDataTask), task, "task should be an instance of NSUrlSessionDataTask");
			}
			...
			using (var ur = new NSUrlRequest ()) {
				...
				ClassicAssert.IsNotNull (task, "task should not be null 2");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionDataTask), task, "task should be an instance of NSUrlSessionDataTask 2");
			}
			...
			using (var ur = new NSUrl (NetworkResources.MicrosoftUrl)) {
				...
				ClassicAssert.IsNotNull (task, "task should not be null 3");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionDataTask), task, "task should be an instance of NSUrlSessionDataTask 3");
			}
			...
			using (var ur = new NSUrl (NetworkResources.MicrosoftUrl)) {
				...
				ClassicAssert.IsNotNull (task, "task should not be null 4");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionDataTask), task, "task should be an instance of NSUrlSessionDataTask 4");
			}
		}
		...
		public void NSUrlSessionUploadTaskTest ()
		{
			...
			using (var ur = new NSUrlRequest ()) {
				...
				ClassicAssert.IsNotNull (task, "task should not be null");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionUploadTask), task, "task should be an instance of NSUrlSessionUploadTask");
			}
			...
			using (var ur = new NSUrlRequest ()) {
				...
				ClassicAssert.IsNotNull (task, "task should not be null 2");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionUploadTask), task, "task should be an instance of NSUrlSessionUploadTask 2");
			}
			...
			using (var url = new NSUrl (NetworkResources.MicrosoftUrl)) {
				...
				ClassicAssert.IsNotNull (task, "task should not be null 3");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionUploadTask), task, "task should be an instance of NSUrlSessionUploadTask 3");
			}
			...
			using (var url = new NSUrl (NetworkResources.MicrosoftUrl)) {
				...
				ClassicAssert.IsNotNull (task, "task should not be null 4");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionUploadTask), task, "task should be an instance of NSUrlSessionUploadTask 4");
			}
			...
			using (var data = NSData.FromString ("Hola")) {
				...
				ClassicAssert.IsNotNull (task, "task should not be null 5");
				ClassicAssert.IsInstanceOf (typeof (NSUrlSessionUploadTask), task, "task should be an instance of NSUrlSessionUploadTask 5");
			}
		}
	}
}
