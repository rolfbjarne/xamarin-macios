...
namespace MetalPerformanceShaders {
	...
	interface MPSNNGraph : NSCopying, NSSecureCoding {
		...
		NativeHandle Constructor (IMTLDevice device, MPSNNImageNode [] resultImages, [NullAllowed] IntPtr areResultsNeeded);
	...
	interface MPSImageCanny {
		...
		// FIXME: implement manual code
		[Export ("colorTransform")]
		[Internal]
		/* const float* = array of three floats */
		IntPtr _ColorTransform { get; }
