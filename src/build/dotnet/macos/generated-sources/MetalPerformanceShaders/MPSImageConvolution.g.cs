...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSImageConvolution : MPSUnaryImageKernel {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_UIntPtr_UIntPtr_IntPtr (this.Handle, selInitWithDevice_KernelWidth_KernelHeight_Weights_XHandle, device__handle__, kernelWidth, kernelHeight, kernelWeights), "initWithDevice:kernelWidth:kernelHeight:weights:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_UIntPtr_UIntPtr_IntPtr (&__objc_super__, selInitWithDevice_KernelWidth_KernelHeight_Weights_XHandle, device__handle__, kernelWidth, kernelHeight, kernelWeights), "initWithDevice:kernelWidth:kernelHeight:weights:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
