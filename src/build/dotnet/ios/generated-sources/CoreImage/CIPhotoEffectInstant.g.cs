...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that that distorts colors in a style reminiscent of instant film.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CIPhotoEffectInstant filter with the input image
	...
	/// var output = photo_effect_instant.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/photo_effect_instant.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIPhotoEffectInstant : CIPhotoEffect {
		/// <summary>Creates a new <see cref="CIPhotoEffectInstant" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPhotoEffectInstant () : base ("CIPhotoEffectInstant")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPhotoEffectInstant (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPhotoEffectInstant (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPhotoEffectInstant (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
