...
namespace Intents {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "HandleShareFocusStatus", Selector = "handleShareFocusStatus:completion:", ParameterType = new Type [] { typeof (Intents.INShareFocusStatusIntent), typeof (global::System.Action<global::Intents.INShareFocusStatusIntentResponse>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V202) })]
	...
	public partial interface IINShareFocusStatusIntentHandling : INativeObject, IDisposable
	{
		...
		public unsafe virtual void HandleShareFocusStatus (INShareFocusStatusIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V202))]global::System.Action<INShareFocusStatusIntentResponse> completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _HandleShareFocusStatus (IINShareFocusStatusIntentHandling This, INShareFocusStatusIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V202))]global::System.Action<INShareFocusStatusIntentResponse> completion)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ConfirmShareFocusStatus (INShareFocusStatusIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V202))]global::System.Action<INShareFocusStatusIntentResponse> completion)
		{
			_ConfirmShareFocusStatus (this, intent, completion);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _ConfirmShareFocusStatus (IINShareFocusStatusIntentHandling This, INShareFocusStatusIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V202))]global::System.Action<INShareFocusStatusIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
	...
	public unsafe static partial class INShareFocusStatusIntentHandling_Extensions {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void ConfirmShareFocusStatus (this IINShareFocusStatusIntentHandling This, INShareFocusStatusIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V202))]global::System.Action<INShareFocusStatusIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
	...
	internal unsafe sealed class INShareFocusStatusIntentHandlingWrapper : BaseWrapper, IINShareFocusStatusIntentHandling {
		...
		[Export ("handleShareFocusStatus:completion:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void HandleShareFocusStatus (INShareFocusStatusIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V202))]global::System.Action<INShareFocusStatusIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
