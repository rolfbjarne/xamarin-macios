...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSRnnMatrixInferenceLayer : MPSKernel {
		...
		public virtual MPSRnnMatrixInferenceLayer Copy (NSZone? zone, global::Metal.IMTLDevice? device)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<MPSRnnMatrixInferenceLayer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("copyWithZone:device:"), zone__handle__, device__handle__), true)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<MPSRnnMatrixInferenceLayer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("copyWithZone:device:"), zone__handle__, device__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (zone);
		...
		public virtual void EncodeBidirectionalSequence (global::Metal.IMTLCommandBuffer commandBuffer, MPSMatrix[] sourceSequence, MPSMatrix[] destinationForwardMatrices, MPSMatrix[]? destinationBackwardMatrices)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("encodeBidirectionalSequenceToCommandBuffer:sourceSequence:destinationForwardMatrices:destinationBackwardMatrices:"), commandBuffer__handle__, nsa_sourceSequence.Handle, nsa_destinationForwardMatrices.Handle, nsa_destinationBackwardMatrices.GetHandle ());
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
		...
		public virtual void EncodeSequence (global::Metal.IMTLCommandBuffer commandBuffer, MPSMatrix[] sourceMatrices, MPSMatrix[] destinationMatrices, MPSRnnRecurrentMatrixState? recurrentInputState, NSMutableArray<MPSRnnRecurrentMatrixState>? recurrentOutputStates)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("encodeSequenceToCommandBuffer:sourceMatrices:destinationMatrices:recurrentInputState:recurrentOutputStates:"), commandBuffer__handle__, nsa_sourceMatrices.Handle, nsa_destinationMatrices.Handle, recurrentInputState__handle__, recurrentOutputStates__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("encodeSequenceToCommandBuffer:sourceMatrices:destinationMatrices:recurrentInputState:recurrentOutputStates:"), commandBuffer__handle__, nsa_sourceMatrices.Handle, nsa_destinationMatrices.Handle, recurrentInputState__handle__, recurrentOutputStates__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
		...
		public virtual void EncodeSequence (global::Metal.IMTLCommandBuffer commandBuffer, MPSMatrix[] sourceMatrices, nint sourceOffsets, MPSMatrix[] destinationMatrices, nint destinationOffsets, MPSRnnRecurrentMatrixState? recurrentInputState, NSMutableArray<MPSRnnRecurrentMatrixState>? recurrentOutputStates)
		{
			...
			using var nsa_destinationMatrices = NSArray.FromNSObjects (destinationMatrices);
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_IntPtr_NativeHandle_IntPtr_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("encodeSequenceToCommandBuffer:sourceMatrices:sourceOffsets:destinationMatrices:destinationOffsets:recurrentInputState:recurrentOutputStates:"), commandBuffer__handle__, nsa_sourceMatrices.Handle, sourceOffsets, nsa_destinationMatrices.Handle, destinationOffsets, recurrentInputState__handle__, recurrentOutputStates__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_IntPtr_NativeHandle_IntPtr_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("encodeSequenceToCommandBuffer:sourceMatrices:sourceOffsets:destinationMatrices:destinationOffsets:recurrentInputState:recurrentOutputStates:"), commandBuffer__handle__, nsa_sourceMatrices.Handle, sourceOffsets, nsa_destinationMatrices.Handle, destinationOffsets, recurrentInputState__handle__, recurrentOutputStates__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
