...
namespace MetalPerformanceShadersGraph {
	public unsafe static partial class MPSGraph_MPSGraphScatterAlongAxisOps  {
		...
		const string selScatterAlongAxis_WithDataTensor_UpdatesTensor_IndicesTensor_Mode_Name_X = "scatterAlongAxis:withDataTensor:updatesTensor:indicesTensor:mode:name:";
		static readonly NativeHandle selScatterAlongAxis_WithDataTensor_UpdatesTensor_IndicesTensor_Mode_Name_XHandle = Selector.GetHandle ("scatterAlongAxis:withDataTensor:updatesTensor:indicesTensor:mode:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selScatterAlongAxis_WithUpdatesTensor_IndicesTensor_Shape_Mode_Name_X = "scatterAlongAxis:withUpdatesTensor:indicesTensor:shape:mode:name:";
		static readonly NativeHandle selScatterAlongAxis_WithUpdatesTensor_IndicesTensor_Shape_Mode_Name_XHandle = Selector.GetHandle ("scatterAlongAxis:withUpdatesTensor:indicesTensor:shape:mode:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selScatterAlongAxisTensor_WithDataTensor_UpdatesTensor_IndicesTensor_Mode_Name_X = "scatterAlongAxisTensor:withDataTensor:updatesTensor:indicesTensor:mode:name:";
		static readonly NativeHandle selScatterAlongAxisTensor_WithDataTensor_UpdatesTensor_IndicesTensor_Mode_Name_XHandle = Selector.GetHandle ("scatterAlongAxisTensor:withDataTensor:updatesTensor:indicesTensor:mode:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selScatterAlongAxisTensor_WithUpdatesTensor_IndicesTensor_Shape_Mode_Name_X = "scatterAlongAxisTensor:withUpdatesTensor:indicesTensor:shape:mode:name:";
		static readonly NativeHandle selScatterAlongAxisTensor_WithUpdatesTensor_IndicesTensor_Shape_Mode_Name_XHandle = Selector.GetHandle ("scatterAlongAxisTensor:withUpdatesTensor:indicesTensor:shape:mode:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MPSGraphTensor ScatterAlongAxis (this MPSGraph This, MPSGraphTensor axisTensor, MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, [BindAs (typeof (int[]), OriginalType = typeof (NSNumber[]))] int[] shape, MPSGraphScatterMode mode, string? name)
		{
			...
			var nsname = CFString.CreateNative (name);
			MPSGraphTensor? ret;
			ret =  Runtime.GetNSObject<MPSGraphTensor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_IntPtr_NativeHandle (This.Handle, selScatterAlongAxisTensor_WithUpdatesTensor_IndicesTensor_Shape_Mode_Name_XHandle, axisTensor__handle__, updatesTensor__handle__, indicesTensor__handle__, nsb_shape.GetHandle (), (IntPtr) (long) mode, nsname), false)!;
			GC.KeepAlive (This);
		...
		public static MPSGraphTensor ScatterAlongAxis (this MPSGraph This, nint axis, MPSGraphTensor dataTensor, MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, MPSGraphScatterMode mode, string? name)
		{
			...
			var nsname = CFString.CreateNative (name);
			MPSGraphTensor? ret;
			ret =  Runtime.GetNSObject<MPSGraphTensor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_NativeHandle_NativeHandle_NativeHandle_IntPtr_NativeHandle (This.Handle, selScatterAlongAxis_WithDataTensor_UpdatesTensor_IndicesTensor_Mode_Name_XHandle, axis, dataTensor__handle__, updatesTensor__handle__, indicesTensor__handle__, (IntPtr) (long) mode, nsname), false)!;
			GC.KeepAlive (This);
		...
		public static MPSGraphTensor ScatterAlongAxis (this MPSGraph This, MPSGraphTensor axisTensor, MPSGraphTensor dataTensor, MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, MPSGraphScatterMode mode, string? name)
		{
			...
			var nsname = CFString.CreateNative (name);
			MPSGraphTensor? ret;
			ret =  Runtime.GetNSObject<MPSGraphTensor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_IntPtr_NativeHandle (This.Handle, selScatterAlongAxisTensor_WithDataTensor_UpdatesTensor_IndicesTensor_Mode_Name_XHandle, axisTensor__handle__, dataTensor__handle__, updatesTensor__handle__, indicesTensor__handle__, (IntPtr) (long) mode, nsname), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (axisTensor);
			GC.KeepAlive (dataTensor);
			GC.KeepAlive (updatesTensor);
