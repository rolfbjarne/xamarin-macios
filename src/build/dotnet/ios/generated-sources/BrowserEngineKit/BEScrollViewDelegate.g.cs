...
namespace BrowserEngineKit {
		...
		UIKit.IUIScrollViewDelegate
	{
		...
		public unsafe virtual void HandleScrollUpdate (BEScrollView scrollView, BEScrollViewScrollUpdate scrollUpdate, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V4))]global::System.Action<bool> completion)
		{
			_HandleScrollUpdate (this, scrollView, scrollUpdate, completion);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _HandleScrollUpdate (IBEScrollViewDelegate This, BEScrollView scrollView, BEScrollViewScrollUpdate scrollUpdate, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V4))]global::System.Action<bool> completion)
		{
...
namespace BrowserEngineKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_iOS__BrowserEngineKit_BEScrollViewDelegate", false)]
	[Model]
	[SupportedOSPlatform ("tvos17.4")]
	[UnsupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("ios17.4")]
