...
namespace SpriteKit {
	...
	public unsafe partial class SKVideoNode : SKNode {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("initWithAVPlayer:"), player__handle__), "initWithAVPlayer:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithAVPlayer:"), player__handle__), "initWithAVPlayer:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (player);
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("initWithFileNamed:"), nsvideoFile), "initWithFileNamed:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithFileNamed:"), nsvideoFile), "initWithFileNamed:");
					GC.KeepAlive (this);
				}
			}
		...
		public static SKVideoNode FromFile (string videoFile)
		{
			...
			var nsvideoFile = CFString.CreateNative (videoFile);
			SKVideoNode? ret;
			ret =  Runtime.GetNSObject<SKVideoNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("videoNodeWithFileNamed:"), nsvideoFile), false)!;
			CFString.ReleaseNative (nsvideoFile);
			return ret!;
		}
		...
		public static SKVideoNode FromPlayer (global::AVFoundation.AVPlayer player)
		{
			var player__handle__ = player!.GetNonNullHandle (nameof (player));
			SKVideoNode? ret;
			ret =  Runtime.GetNSObject<SKVideoNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("videoNodeWithAVPlayer:"), player__handle__), false)!;
			GC.KeepAlive (player);
			return ret!;
		}
		...
		public static SKVideoNode FromUrl (NSUrl videoUrl)
		{
			...
			SKVideoNode? ret;
			ret =  Runtime.GetNSObject<SKVideoNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("videoNodeWithURL:"), videoUrl__handle__), false)!;
