...
namespace AppKit {
	...
	public unsafe partial class NSGridRow : NSObject, INSCoding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selBottomPaddingX = "bottomPadding";
		static readonly NativeHandle selBottomPaddingXHandle = Selector.GetHandle ("bottomPadding");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGridViewX = "gridView";
		static readonly NativeHandle selGridViewXHandle = Selector.GetHandle ("gridView");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selMergeCellsInRange_X = "mergeCellsInRange:";
		static readonly NativeHandle selMergeCellsInRange_XHandle = Selector.GetHandle ("mergeCellsInRange:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNumberOfCellsX = "numberOfCells";
		static readonly NativeHandle selNumberOfCellsXHandle = Selector.GetHandle ("numberOfCells");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetBottomPadding_X = "setBottomPadding:";
		static readonly NativeHandle selSetBottomPadding_XHandle = Selector.GetHandle ("setBottomPadding:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetTopPadding_X = "setTopPadding:";
		static readonly NativeHandle selSetTopPadding_XHandle = Selector.GetHandle ("setTopPadding:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTopPaddingX = "topPadding";
		static readonly NativeHandle selTopPaddingXHandle = Selector.GetHandle ("topPadding");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selYPlacementX = "yPlacement";
		static readonly NativeHandle selYPlacementXHandle = Selector.GetHandle ("yPlacement");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSGridRow");
		...
		public NSGridRow (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSGridRow (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSGridRow (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual NSGridCell GetCell (nint index)
		{
			...
			NSGridCell ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSGridCell> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr (this.Handle, selCellAtIndex_XHandle, index), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSGridCell> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr (&__objc_super__, selCellAtIndex_XHandle, index), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual void MergeCells (NSRange range)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NSRange (this.Handle, selMergeCellsInRange_XHandle, range);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NSRange (&__objc_super__, selMergeCellsInRange_XHandle, range);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual nfloat BottomPadding {
			...
			get {
				...
				nfloat ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend (this.Handle, selBottomPaddingXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSendSuper (&__objc_super__, selBottomPaddingXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				global::AppKit.NSApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_nfloat (this.Handle, selSetBottomPadding_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_nfloat (&__objc_super__, selSetBottomPadding_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual nint CellCount {
			...
			get {
				...
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selNumberOfCellsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selNumberOfCellsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual NSGridView? GridView {
			...
			get {
				...
				NSGridView? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSGridView> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selGridViewXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSGridView> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selGridViewXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				MarkDirty ();
		...
		public virtual nfloat TopPadding {
			...
			get {
				...
				nfloat ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend (this.Handle, selTopPaddingXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSendSuper (&__objc_super__, selTopPaddingXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				global::AppKit.NSApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_nfloat (this.Handle, selSetTopPadding_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_nfloat (&__objc_super__, selSetTopPadding_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
