...
namespace CoreImage {
	...
	public partial class CIGuidedFilter : CIFilter {
		/// <summary>Creates a new <see cref="CIGuidedFilter" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIGuidedFilter () : base ("CIGuidedFilter")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIGuidedFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIGuidedFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIGuidedFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
