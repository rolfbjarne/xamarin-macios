...
namespace MLCompute {
	...
	public unsafe partial class MLCReshapeLayer : MLCLayer {
		...
		const string selLayerWithShape_X = "layerWithShape:";
		static readonly NativeHandle selLayerWithShape_XHandle = Selector.GetHandle ("layerWithShape:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MLCReshapeLayer? Create ([BindAs (typeof (nint[]), OriginalType = typeof (NSNumber[]))] nint[] shape)
		{
			...
			MLCReshapeLayer ret;
			ret =  Runtime.GetNSObject<MLCReshapeLayer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selLayerWithShape_XHandle, nsb_shape.GetHandle ()), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
