...
namespace MapKit {
	...
	public unsafe partial class MKClusterAnnotation : NSObject, IMKAnnotation {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithMemberAnnotations_X = "initWithMemberAnnotations:";
		static readonly NativeHandle selInitWithMemberAnnotations_XHandle = Selector.GetHandle ("initWithMemberAnnotations:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selMemberAnnotationsX = "memberAnnotations";
		static readonly NativeHandle selMemberAnnotationsXHandle = Selector.GetHandle ("memberAnnotations");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithMemberAnnotations_XHandle, nsa_memberAnnotations.Handle), "initWithMemberAnnotations:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithMemberAnnotations_XHandle, nsa_memberAnnotations.Handle), "initWithMemberAnnotations:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual IMKAnnotation[] MemberAnnotations {
			...
			get {
				IMKAnnotation[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<IMKAnnotation>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selMemberAnnotationsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<IMKAnnotation>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selMemberAnnotationsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
