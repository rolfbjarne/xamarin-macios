...
namespace UIKit {
	...
	public unsafe partial class UIPageViewController : UIViewController, INSCoding {
		...
		internal class _UIPageViewControllerDelegate : NSObject, IUIPageViewControllerDelegate { 
			...
			internal Func<UIPageViewController,UIInterfaceOrientation>? getPreferredInterfaceOrientationForPresentation;
			[Export ("pageViewControllerPreferredInterfaceOrientationForPresentation:")]
			public UIInterfaceOrientation GetPreferredInterfaceOrientationForPresentation (UIPageViewController pageViewController)
			{
			...
			internal UIPageViewSpineLocationCallback? getSpineLocation;
			...
			{
				var handler = getSpineLocation;
				if (handler is not null)
					return handler (pageViewController, orientation);
				return UIKit.UIPageViewControllerSpineLocation.Mid!;
			}
			internal Func<UIPageViewController,UIInterfaceOrientationMask>? supportedInterfaceOrientations;
			[Export ("pageViewControllerSupportedInterfaceOrientations:")]
			public UIInterfaceOrientationMask SupportedInterfaceOrientations (UIPageViewController pageViewController)
			{
		...
		public Func<UIPageViewController,UIInterfaceOrientation>? GetPreferredInterfaceOrientationForPresentation {
			get { return EnsureUIPageViewControllerDelegate ()!.getPreferredInterfaceOrientationForPresentation; }
			set { EnsureUIPageViewControllerDelegate ()!.getPreferredInterfaceOrientationForPresentation = value; }
		}
		/// <summary>Delegate invoked by the object to get a value.</summary>
		/// <value>To be added.</value>
		/// <remarks>Developers assign a function, delegate or anonymous method to this property to return a value to the object.   If developers assign a value to this property, it this will reset the value for the WeakDelegate property to an internal handler that maps delegates to events.</remarks>
		public UIPageViewSpineLocationCallback? GetSpineLocation {
			get { return EnsureUIPageViewControllerDelegate ()!.getSpineLocation; }
			set { EnsureUIPageViewControllerDelegate ()!.getSpineLocation = value; }
		}
		/// <summary>Delegate invoked by the object to get a value.</summary>
		/// <value>To be added.</value>
		/// <remarks>Developers assign a function, delegate or anonymous method to this property to return a value to the object.   If developers assign a value to this property, it this will reset the value for the WeakDelegate property to an internal handler that maps delegates to events.</remarks>
		public Func<UIPageViewController,UIInterfaceOrientationMask>? SupportedInterfaceOrientations {
			get { return EnsureUIPageViewControllerDelegate ()!.supportedInterfaceOrientations; }
			set { EnsureUIPageViewControllerDelegate ()!.supportedInterfaceOrientations = value; }
		}
		/// <summary>Event raised by the object.</summary>
		/// <remarks>If developers do not assign a value to this event, this will reset the value for the WeakDelegate property to an internal handler that maps delegates to events.</remarks>
