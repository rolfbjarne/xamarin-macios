 ...
 *    If an extension is sharing code with the main app, then the assemblies will be located in the container app's root directory.
...
xamarin_locate_assembly_resource (const char *assembly_name, const char *culture, const char *resource, char *path, int pathlen)
{
	...
	// Then in the container app's root directory.
