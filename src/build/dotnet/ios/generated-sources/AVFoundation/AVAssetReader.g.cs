...
namespace AVFoundation {
	...
	public unsafe partial class AVAssetReader : NSObject {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (this.Handle, Selector.GetHandle ("initWithAsset:error:"), asset__handle__, &errorValue), "initWithAsset:error:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithAsset:error:"), asset__handle__, &errorValue), "initWithAsset:error:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (asset);
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend (this.Handle, Selector.GetHandle ("cancelReading"));
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("cancelReading"));
					GC.KeepAlive (this);
				}
			}
		}
		...
		public unsafe static AVAssetReader? FromAsset (AVAsset asset, out NSError error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			AVAssetReader? ret;
			ret =  Runtime.GetNSObject<AVAssetReader> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (class_ptr, Selector.GetHandle ("assetReaderWithAsset:error:"), asset__handle__, &errorValue), false)!;
			GC.KeepAlive (asset);
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		}
		...
		public virtual bool StartReading ()
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("startReading"));
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("startReading"));
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public virtual AVAssetReaderOutput[] Outputs {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<AVAssetReaderOutput>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("outputs")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<AVAssetReaderOutput>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("outputs")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual AVAssetReaderStatus Status {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (AVAssetReaderStatus) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("status"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (AVAssetReaderStatus) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("status"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
