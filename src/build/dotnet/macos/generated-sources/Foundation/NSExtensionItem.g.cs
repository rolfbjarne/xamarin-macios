...
namespace Foundation {
	...
	public unsafe partial class NSExtensionItem : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAttributedContentTextX = "attributedContentText";
		static readonly NativeHandle selAttributedContentTextXHandle = Selector.GetHandle ("attributedContentText");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetAttributedContentText_X = "setAttributedContentText:";
		static readonly NativeHandle selSetAttributedContentText_XHandle = Selector.GetHandle ("setAttributedContentText:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSExtensionItem");
		...
		/// <summary>Creates a new <see cref="NSExtensionItem" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public NSExtensionItem () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		public NSExtensionItem (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSExtensionItem (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSExtensionItem (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual NSItemProvider[]? Attachments {
			...
			get {
				NSItemProvider[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<NSItemProvider>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selAttachmentsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<NSItemProvider>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selAttachmentsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetAttachments_XHandle, nsa_value.GetHandle ());
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetAttachments_XHandle, nsa_value.GetHandle ());
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual NSAttributedString? AttributedContentText {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSAttributedString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selAttributedContentTextXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSAttributedString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selAttributedContentTextXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetAttributedContentText_XHandle, value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetAttributedContentText_XHandle, value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _AttachmentsKey;
		/// <summary>Represents the value associated with the constant NSExtensionItemAttachmentsKey</summary><value></value><remarks>To be added.</remarks>
		[Field ("NSExtensionItemAttachmentsKey",  "Foundation")]
		public static NSString AttachmentsKey {
			get {
				if (_AttachmentsKey is null)
					_AttachmentsKey = Dlfcn.GetStringConstant (Libraries.Foundation.Handle, "NSExtensionItemAttachmentsKey")!;
				return _AttachmentsKey;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _AttributedContentTextKey;
		/// <summary>Represents the value associated with the constant NSExtensionItemAttributedContentTextKey</summary><value></value><remarks>To be added.</remarks>
		[Field ("NSExtensionItemAttributedContentTextKey",  "Foundation")]
		public static NSString AttributedContentTextKey {
			get {
				if (_AttributedContentTextKey is null)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _AttributedTitleKey;
		/// <summary>Represents the value associated with the constant NSExtensionItemAttributedTitleKey</summary><value></value><remarks>To be added.</remarks>
		[Field ("NSExtensionItemAttributedTitleKey",  "Foundation")]
		public static NSString AttributedTitleKey {
			get {
				if (_AttributedTitleKey is null)
