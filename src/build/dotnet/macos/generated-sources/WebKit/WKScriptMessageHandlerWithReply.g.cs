...
namespace WebKit {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidReceiveScriptMessage", Selector = "userContentController:didReceiveScriptMessage:replyHandler:", ParameterType = new Type [] { typeof (WebKit.WKUserContentController), typeof (WebKit.WKScriptMessage), typeof (global::System.Action<NSObject, NSString>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity2V154) })]
	public partial interface IWKScriptMessageHandlerWithReply : INativeObject, IDisposable
	{
		...
		public unsafe virtual void DidReceiveScriptMessage (WKUserContentController userContentController, WKScriptMessage message, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V154))]global::System.Action<NSObject, NSString> replyHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _DidReceiveScriptMessage (IWKScriptMessageHandlerWithReply This, WKUserContentController userContentController, WKScriptMessage message, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V154))]global::System.Action<NSObject, NSString> replyHandler)
		{
			...
			using var block_replyHandler = Trampolines.SDActionArity2V154.CreateBlock (replyHandler);
	...
	internal unsafe sealed class WKScriptMessageHandlerWithReplyWrapper : BaseWrapper, IWKScriptMessageHandlerWithReply {
		...
		[Export ("userContentController:didReceiveScriptMessage:replyHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void DidReceiveScriptMessage (WKUserContentController userContentController, WKScriptMessage message, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V154))]global::System.Action<NSObject, NSString> replyHandler)
		{
			var userContentController__handle__ = userContentController!.GetNonNullHandle (nameof (userContentController));
			var message__handle__ = message!.GetNonNullHandle (nameof (message));
			if (replyHandler is null)
