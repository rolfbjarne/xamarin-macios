...
#nullable enable
namespace CoreImage {
	/// <summary>Changes colors based on an input gradient image's mapping.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/color_map.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIColorMap : CIFilter, ICIColorMapProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorMap" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorMap (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorMap (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorMap (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIColorMapProtocol protocol members 
