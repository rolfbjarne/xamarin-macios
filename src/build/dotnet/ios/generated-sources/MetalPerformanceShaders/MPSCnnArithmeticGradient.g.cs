	...
	public unsafe partial class MPSCnnArithmeticGradient : MPSCnnGradientKernel {
		...
		public virtual bool IsSecondarySourceFilter {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("isSecondarySourceFilter"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isSecondarySourceFilter"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
