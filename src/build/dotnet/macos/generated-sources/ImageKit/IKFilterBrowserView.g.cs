...
namespace ImageKit {
	...
	public unsafe partial class IKFilterBrowserView : global::AppKit.NSView {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetPreviewState_X = "setPreviewState:";
		static readonly NativeHandle selSetPreviewState_XHandle = Selector.GetHandle ("setPreviewState:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("IKFilterBrowserView");
		...
		/// <summary>Creates a new <see cref="IKFilterBrowserView" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public IKFilterBrowserView () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		public IKFilterBrowserView (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected IKFilterBrowserView (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal IKFilterBrowserView (NativeHandle handle) : base (handle)
		{
		}
		...
		/// <param name="showPreview">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[Export ("setPreviewState:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void SetPreviewState (bool showPreview)
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_bool (this.Handle, selSetPreviewState_XHandle, showPreview ? (byte) 1 : (byte) 0);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, selSetPreviewState_XHandle, showPreview ? (byte) 1 : (byte) 0);
					GC.KeepAlive (this);
				}
			}
		}
