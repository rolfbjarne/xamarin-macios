...
namespace AppKit {
	...
	public unsafe partial class NSPrintPanel : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDefaultButtonTitleX = "defaultButtonTitle";
		static readonly NativeHandle selDefaultButtonTitleXHandle = Selector.GetHandle ("defaultButtonTitle");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selHelpAnchorX = "helpAnchor";
		static readonly NativeHandle selHelpAnchorXHandle = Selector.GetHandle ("helpAnchor");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selJobStyleHintX = "jobStyleHint";
		static readonly NativeHandle selJobStyleHintXHandle = Selector.GetHandle ("jobStyleHint");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetDefaultButtonTitle_X = "setDefaultButtonTitle:";
		static readonly NativeHandle selSetDefaultButtonTitle_XHandle = Selector.GetHandle ("setDefaultButtonTitle:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetJobStyleHint_X = "setJobStyleHint:";
		static readonly NativeHandle selSetJobStyleHint_XHandle = Selector.GetHandle ("setJobStyleHint:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetOptions_X = "setOptions:";
		static readonly NativeHandle selSetOptions_XHandle = Selector.GetHandle ("setOptions:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSPrintPanel");
		...
		/// <summary>Creates a new <see cref="NSPrintPanel" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public NSPrintPanel () : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSPrintPanel (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSPrintPanel (NativeHandle handle) : base (handle)
		{
		}
		...
		[UnsupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void BeginSheet (NSPrintInfo printInfo, NSWindow parentWindow, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V19))]global::System.Action<NSPrintPanelResult>? handler)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			var printInfo__handle__ = printInfo!.GetNonNullHandle (nameof (printInfo));
			var parentWindow__handle__ = parentWindow!.GetNonNullHandle (nameof (parentWindow));
			using var block_handler = Trampolines.SDActionArity1V19.CreateNullableBlock (handler);
		...
		[UnsupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual Task<NSPrintPanelResult> BeginSheetAsync (NSPrintInfo printInfo, NSWindow parentWindow)
		{
			var tcs = new TaskCompletionSource<NSPrintPanelResult> ();
		...
		public virtual string DefaultButtonTitle {
			...
			get {
				...
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selDefaultButtonTitleXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selDefaultButtonTitleXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetDefaultButtonTitle_XHandle, nsvalue);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetDefaultButtonTitle_XHandle, nsvalue);
						GC.KeepAlive (this);
					}
				}
		...
		public virtual string JobStyleHint {
			...
			get {
				...
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selJobStyleHintXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selJobStyleHintXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				...
				var nsvalue = CFString.CreateNative (value);
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetJobStyleHint_XHandle, nsvalue);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetJobStyleHint_XHandle, nsvalue);
						GC.KeepAlive (this);
					}
				}
				CFString.ReleaseNative (nsvalue);
		...
		public virtual NSPrintPanelOptions Options {
			...
			get {
				global::AppKit.NSApplication.EnsureUIThread ();
				NSPrintPanelOptions ret;
				if (IsDirectBinding) {
					ret = (NSPrintPanelOptions) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selOptionsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSPrintPanelOptions) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selOptionsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				global::AppKit.NSApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr (this.Handle, selSetOptions_XHandle, (IntPtr) (long) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, selSetOptions_XHandle, (IntPtr) (long) value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public static NSPrintPanel PrintPanel {
			...
			get {
				global::AppKit.NSApplication.EnsureUIThread ();
				NSPrintPanel? ret;
				ret =  Runtime.GetNSObject<NSPrintPanel> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selPrintPanelXHandle), false)!;
				return ret!;
			}
		}
	} /* class NSPrintPanel */
