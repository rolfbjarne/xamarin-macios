...
namespace NetworkExtension {
	...
	/// <summary>Extension methods for the <see cref="global::NetworkExtension.NEFilterManagerError" /> enumeration.</summary>
	/// <remarks>
	///   <para>The extension method for the <see cref="global::NetworkExtension.NEFilterManagerError" /> enumeration can be used to fetch the error domain associated with these error codes.</para>
	/// </remarks>
	[UnsupportedOSPlatform ("tvos")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	...
	static public partial class NEFilterManagerErrorExtensions {
		[Field ("NEFilterErrorDomain", "NetworkExtension")]
		static NSString? _domain;
		/// <summary>Returns the error domain associated with the NetworkExtension.NEFilterManagerError value</summary>
