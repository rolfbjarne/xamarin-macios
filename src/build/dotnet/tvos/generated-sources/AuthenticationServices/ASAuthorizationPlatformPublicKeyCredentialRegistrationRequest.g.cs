...
namespace AuthenticationServices {
	...
	public unsafe partial class ASAuthorizationPlatformPublicKeyCredentialRegistrationRequest : ASAuthorizationRequest, IASAuthorizationPublicKeyCredentialRegistrationRequest, INSCoding, INSCopying, INSSecureCoding {
		...
		static readonly NativeHandle class_ptr = Class.GetHandle ("ASAuthorizationPlatformPublicKeyCredentialRegistrationRequest");
		...
		public ASAuthorizationPlatformPublicKeyCredentialRegistrationRequest (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected ASAuthorizationPlatformPublicKeyCredentialRegistrationRequest (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal ASAuthorizationPlatformPublicKeyCredentialRegistrationRequest (NativeHandle handle) : base (handle)
		{
		}
