...
namespace MapKit {
	...
	public unsafe partial class MKZoomControl : global::AppKit.NSView {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selZoomControlWithMapView_X = "zoomControlWithMapView:";
		static readonly NativeHandle selZoomControlWithMapView_XHandle = Selector.GetHandle ("zoomControlWithMapView:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MKZoomControl Create (MKMapView? mapView)
		{
			...
			MKZoomControl? ret;
			ret =  Runtime.GetNSObject<MKZoomControl> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selZoomControlWithMapView_XHandle, mapView__handle__), false)!;
