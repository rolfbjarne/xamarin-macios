...
namespace MLCompute {
	...
	public unsafe partial class MLCLossDescriptor : NSObject, INSCopying {
		...
		public static MLCLossDescriptor Create (MLCLossType lossType, MLCReductionType reductionType)
		{
			...
			ret =  Runtime.GetNSObject<MLCLossDescriptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_int_int (class_ptr, Selector.GetHandle ("descriptorWithType:reductionType:"), (int)lossType, (int)reductionType), false)!;
			return ret;
		}
		...
		{
			MLCLossDescriptor ret;
			ret =  Runtime.GetNSObject<MLCLossDescriptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_int_int_float (class_ptr, Selector.GetHandle ("descriptorWithType:reductionType:weight:"), (int)lossType, (int)reductionType, weight), false)!;
			return ret;
		}
		...
		{
			MLCLossDescriptor ret;
			ret =  Runtime.GetNSObject<MLCLossDescriptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_int_int_float_float_UIntPtr (class_ptr, Selector.GetHandle ("descriptorWithType:reductionType:weight:labelSmoothing:classCount:"), (int)lossType, (int)reductionType, weight, labelSmoothing, classCount), false)!;
			return ret;
		}
		...
		{
			MLCLossDescriptor ret;
			ret =  Runtime.GetNSObject<MLCLossDescriptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_int_int_float_float_UIntPtr_float_float (class_ptr, Selector.GetHandle ("descriptorWithType:reductionType:weight:labelSmoothing:classCount:epsilon:delta:"), (int)lossType, (int)reductionType, weight, labelSmoothing, classCount, epsilon, delta), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual nuint ClassCount {
			...
			get {
				nuint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("classCount"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("classCount"));
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual MLCLossType LossType {
			...
			get {
				MLCLossType ret;
				if (IsDirectBinding) {
					ret = (MLCLossType) global::ObjCRuntime.Messaging.int_objc_msgSend (this.Handle, Selector.GetHandle ("lossType"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MLCLossType) global::ObjCRuntime.Messaging.int_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("lossType"));
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual MLCReductionType ReductionType {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (MLCReductionType) global::ObjCRuntime.Messaging.int_objc_msgSend (this.Handle, Selector.GetHandle ("reductionType"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MLCReductionType) global::ObjCRuntime.Messaging.int_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("reductionType"));
						GC.KeepAlive (this);
					}
				}
				return ret;
