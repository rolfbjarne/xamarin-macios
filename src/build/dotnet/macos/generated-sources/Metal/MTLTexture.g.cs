...
namespace Metal {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "CreateRemoteTexture", Selector = "newRemoteTextureViewForDevice:", ReturnType = typeof (IMTLTexture), ParameterType = new Type [] { typeof (IMTLDevice) }, ParameterByRef = new bool [] { false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = true, IsStatic = false, Name = "FirstMipmapInTail", Selector = "firstMipmapInTail", PropertyType = typeof (UIntPtr), GetterSelector = "firstMipmapInTail", ArgumentSemantic = ArgumentSemantic.None)]
	[ProtocolMember (IsRequired = false, IsProperty = true, IsStatic = false, Name = "TailSizeInBytes", Selector = "tailSizeInBytes", PropertyType = typeof (UIntPtr), GetterSelector = "tailSizeInBytes", ArgumentSemantic = ArgumentSemantic.None)]
	[ProtocolMember (IsRequired = false, IsProperty = true, IsStatic = false, Name = "IsSparse", Selector = "isSparse", PropertyType = typeof (bool), GetterSelector = "isSparse", ArgumentSemantic = ArgumentSemantic.None)]
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "RemoteStorageTexture", Selector = "remoteStorageTexture", PropertyType = typeof (IMTLTexture), GetterSelector = "remoteStorageTexture", ArgumentSemantic = ArgumentSemantic.None)]
		...
		, Metal.IMTLResource
	{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static IMTLTexture? _CreateRemoteTexture (IMTLTexture This, IMTLDevice device)
		{
		...
		[DynamicDependencyAttribute ("CreateRemoteTexture(Metal.IMTLDevice)")]
		...
		[DynamicDependencyAttribute ("RemoteStorageTexture")]
		...
		[SupportedOSPlatform ("macos")]
		[global::Foundation.RequiredMember]
		public virtual IMTLTexture? RemoteStorageTexture {
			[Export ("remoteStorageTexture")]
			get {
				return _GetRemoteStorageTexture (this);
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static IMTLTexture _GetRemoteStorageTexture (IMTLTexture This)
		{
			IMTLTexture ret;
			ret =  Runtime.GetINativeObject<IMTLTexture> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (This.Handle, Selector.GetHandle ("remoteStorageTexture")), false)!;
			GC.KeepAlive (This);
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	...
	internal unsafe sealed class MTLTextureWrapper : BaseWrapper, IMTLTexture {
		...
		[return: ReleaseAttribute ()]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public IMTLTexture? CreateRemoteTexture (IMTLDevice device)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
			IMTLTexture? ret;
			ret =  Runtime.GetINativeObject<IMTLTexture> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("newRemoteTextureViewForDevice:"), device__handle__), true)!;
		...
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		public IMTLTexture? RemoteStorageTexture {
			[Export ("remoteStorageTexture")]
			get {
				IMTLTexture ret;
				ret =  Runtime.GetINativeObject<IMTLTexture> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("remoteStorageTexture")), false)!;
