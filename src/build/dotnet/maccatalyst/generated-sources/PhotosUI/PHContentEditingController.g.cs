...
namespace PhotosUI {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "StartContentEditing", Selector = "startContentEditingWithInput:placeholderImage:", ParameterType = new Type [] { typeof (PHContentEditingInput), typeof (UIImage) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "FinishContentEditing", Selector = "finishContentEditingWithCompletionHandler:", ParameterType = new Type [] { typeof (global::System.Action<global::Photos.PHContentEditingOutput>) }, ParameterByRef = new bool [] { false }, ParameterBlockProxy = new Type? [] { typeof (ObjCRuntime.Trampolines.NIDActionArity1V231) })]
	...
	public partial interface IPHContentEditingController : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void StartContentEditing (global::Photos.PHContentEditingInput contentEditingInput, global::UIKit.UIImage placeholderImage)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="contentEditingInput">To be added.</param><param name="placeholderImage">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _StartContentEditing (IPHContentEditingController This, global::Photos.PHContentEditingInput contentEditingInput, global::UIKit.UIImage placeholderImage)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void FinishContentEditing ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V231))]global::System.Action<global::Photos.PHContentEditingOutput> completionHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="completionHandler">To be added. This parameter can be <see langword="null" />.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _FinishContentEditing (IPHContentEditingController This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V231))]global::System.Action<global::Photos.PHContentEditingOutput> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity1V231.CreateBlock (completionHandler);
		...
		[DynamicDependencyAttribute ("StartContentEditing(Photos.PHContentEditingInput,UIKit.UIImage)")]
	...
	internal unsafe sealed class PHContentEditingControllerWrapper : BaseWrapper, IPHContentEditingController {
		...
		[Export ("startContentEditingWithInput:placeholderImage:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public void StartContentEditing (global::Photos.PHContentEditingInput contentEditingInput, global::UIKit.UIImage placeholderImage)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var contentEditingInput__handle__ = contentEditingInput!.GetNonNullHandle (nameof (contentEditingInput));
			var placeholderImage__handle__ = placeholderImage!.GetNonNullHandle (nameof (placeholderImage));
		...
		[Export ("finishContentEditingWithCompletionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void FinishContentEditing ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V231))]global::System.Action<global::Photos.PHContentEditingOutput> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
