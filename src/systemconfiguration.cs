...
namespace SystemConfiguration {
	...
	/// <summary>Deprecated: Use <see cref="NetworkExtension.NEHotspotHelper" /> instead. A class that encapsulates the Captive Network system component, which is responsible for detecting networks that require user interaction prior to providing Internet access.</summary>
	[Static]
