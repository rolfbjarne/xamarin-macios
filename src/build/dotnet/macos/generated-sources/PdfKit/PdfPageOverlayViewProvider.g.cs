...
namespace PdfKit {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "GetOverlayView", Selector = "pdfView:overlayViewForPage:", ReturnType = typeof (NSView), ParameterType = new Type [] { typeof (PdfKit.PdfView), typeof (PdfKit.PdfPage) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillDisplayOverlayView", Selector = "pdfView:willDisplayOverlayView:forPage:", ParameterType = new Type [] { typeof (PdfKit.PdfView), typeof (NSView), typeof (PdfKit.PdfPage) }, ParameterByRef = new bool [] { false, false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillEndDisplayingOverlayView", Selector = "pdfView:willEndDisplayingOverlayView:forPage:", ParameterType = new Type [] { typeof (PdfKit.PdfView), typeof (NSView), typeof (PdfKit.PdfPage) }, ParameterByRef = new bool [] { false, false, false })]
	public partial interface IPdfPageOverlayViewProvider : INativeObject, IDisposable
	{
		...
		public virtual global::AppKit.NSView? GetOverlayView (PdfView view, PdfPage page)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static global::AppKit.NSView? _GetOverlayView (IPdfPageOverlayViewProvider This, PdfView view, PdfPage page)
		{
			var view__handle__ = view!.GetNonNullHandle (nameof (view));
			var page__handle__ = page!.GetNonNullHandle (nameof (page));
			global::AppKit.NSView? ret;
			ret =  Runtime.GetNSObject<global::AppKit.NSView> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("pdfView:overlayViewForPage:"), view__handle__, page__handle__), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (view);
			GC.KeepAlive (page);
			return ret!;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void WillDisplayOverlayView (PdfView pdfView, global::AppKit.NSView overlayView, PdfPage page)
		{
			_WillDisplayOverlayView (this, pdfView, overlayView, page);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _WillDisplayOverlayView (IPdfPageOverlayViewProvider This, PdfView pdfView, global::AppKit.NSView overlayView, PdfPage page)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void WillEndDisplayingOverlayView (PdfView pdfView, global::AppKit.NSView overlayView, PdfPage page)
		{
			_WillEndDisplayingOverlayView (this, pdfView, overlayView, page);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _WillEndDisplayingOverlayView (IPdfPageOverlayViewProvider This, PdfView pdfView, global::AppKit.NSView overlayView, PdfPage page)
		{
			var pdfView__handle__ = pdfView!.GetNonNullHandle (nameof (pdfView));
			var overlayView__handle__ = overlayView!.GetNonNullHandle (nameof (overlayView));
			var page__handle__ = page!.GetNonNullHandle (nameof (page));
		...
		[DynamicDependencyAttribute ("WillDisplayOverlayView(PdfKit.PdfView,AppKit.NSView,PdfKit.PdfPage)")]
		[DynamicDependencyAttribute ("WillEndDisplayingOverlayView(PdfKit.PdfView,AppKit.NSView,PdfKit.PdfPage)")]
	...
	public unsafe static partial class PdfPageOverlayViewProvider_Extensions {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void WillDisplayOverlayView (this IPdfPageOverlayViewProvider This, PdfView pdfView, global::AppKit.NSView overlayView, PdfPage page)
		{
			var pdfView__handle__ = pdfView!.GetNonNullHandle (nameof (pdfView));
			var overlayView__handle__ = overlayView!.GetNonNullHandle (nameof (overlayView));
			var page__handle__ = page!.GetNonNullHandle (nameof (page));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void WillEndDisplayingOverlayView (this IPdfPageOverlayViewProvider This, PdfView pdfView, global::AppKit.NSView overlayView, PdfPage page)
		{
			var pdfView__handle__ = pdfView!.GetNonNullHandle (nameof (pdfView));
			var overlayView__handle__ = overlayView!.GetNonNullHandle (nameof (overlayView));
			var page__handle__ = page!.GetNonNullHandle (nameof (page));
	...
	internal unsafe sealed class PdfPageOverlayViewProviderWrapper : BaseWrapper, IPdfPageOverlayViewProvider {
		...
		[Export ("pdfView:overlayViewForPage:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public global::AppKit.NSView? GetOverlayView (PdfView view, PdfPage page)
		{
			var view__handle__ = view!.GetNonNullHandle (nameof (view));
			var page__handle__ = page!.GetNonNullHandle (nameof (page));
			global::AppKit.NSView? ret;
