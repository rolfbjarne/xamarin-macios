...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSNNDefaultPadding : NSObject, IMPSNNPadding, INSCoding, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInverseX = "inverse";
		static readonly NativeHandle selInverseXHandle = Selector.GetHandle ("inverse");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selLabelX = "label";
		static readonly NativeHandle selLabelXHandle = Selector.GetHandle ("label");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPaddingForTensorflowAveragePoolingX = "paddingForTensorflowAveragePooling";
		static readonly NativeHandle selPaddingForTensorflowAveragePoolingXHandle = Selector.GetHandle ("paddingForTensorflowAveragePooling");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPaddingForTensorflowAveragePoolingValidOnlyX = "paddingForTensorflowAveragePoolingValidOnly";
		static readonly NativeHandle selPaddingForTensorflowAveragePoolingValidOnlyXHandle = Selector.GetHandle ("paddingForTensorflowAveragePoolingValidOnly");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPaddingMethodX = "paddingMethod";
		static readonly NativeHandle selPaddingMethodXHandle = Selector.GetHandle ("paddingMethod");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPaddingWithMethod_X = "paddingWithMethod:";
		static readonly NativeHandle selPaddingWithMethod_XHandle = Selector.GetHandle ("paddingWithMethod:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSNNDefaultPadding");
		...
		public MPSNNDefaultPadding (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected MPSNNDefaultPadding (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSNNDefaultPadding (NativeHandle handle) : base (handle)
		{
		}

		/// <param name="method">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[Export ("paddingWithMethod:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static MPSNNDefaultPadding Create (MPSNNPaddingMethod method)
		{
			MPSNNDefaultPadding ret;
			ret =  Runtime.GetNSObject<MPSNNDefaultPadding> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr (class_ptr, selPaddingWithMethod_XHandle, (UIntPtr) (ulong) method), false)!;
			return ret;
		}
		...
		{
			MPSNNDefaultPadding ret;
			ret =  Runtime.GetNSObject<MPSNNDefaultPadding> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selPaddingForTensorflowAveragePoolingXHandle), false)!;
			return ret;
		}
		/// <summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		...
		{
			MPSNNDefaultPadding ret;
			ret =  Runtime.GetNSObject<MPSNNDefaultPadding> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selPaddingForTensorflowAveragePoolingValidOnlyXHandle), false)!;
			return ret;
		}
		...
		public virtual IMPSNNPadding? GetInverse ()
		{
			IMPSNNPadding ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetINativeObject<IMPSNNPadding> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selInverseXHandle), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMPSNNPadding> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selInverseXHandle), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual MPSNNPaddingMethod PaddingMethod {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (MetalPerformanceShaders.MPSNNPaddingMethod) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selPaddingMethodXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MetalPerformanceShaders.MPSNNPaddingMethod) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selPaddingMethodXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
