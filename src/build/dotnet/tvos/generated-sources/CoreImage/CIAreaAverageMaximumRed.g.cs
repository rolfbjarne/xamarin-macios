...
namespace CoreImage {
	...
	public partial class CIAreaAverageMaximumRed : CIFilter, ICIAreaAverageMaximumRedProtocol, ICIAreaReductionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIAreaAverageMaximumRed" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIAreaAverageMaximumRed () : base ("CIAreaAverageMaximumRed")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAreaAverageMaximumRed (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAreaAverageMaximumRed (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAreaAverageMaximumRed (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIAreaAverageMaximumRedProtocol protocol members 
