...
#nullable enable
namespace CoreImage {
	/// <summary>Replaces image colors with the bright colors from the background image.</summary><remarks><para>
	/// If the <see cref="P:CoreImage.CIBlendFilter.BackgroundImage" /> pixel is more than half of the maximum brightness,
	/// that pixel is substituted for the pixel in the <see cref="P:CoreImage.CIBlendFilter.InputImage" />. Also, even if the background
	/// pixel is less than 50% brightness, it will be substituted if the image pixel is lighter than the background pixel.
	/// </para><para>This filter can be used to make an image look as if it were drawn with powder pastels.</para></remarks>
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public partial class CIPinLightBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIPinLightBlendMode" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPinLightBlendMode () : base ("CIPinLightBlendMode")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPinLightBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPinLightBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPinLightBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
