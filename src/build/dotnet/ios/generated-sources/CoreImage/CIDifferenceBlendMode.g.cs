...
#nullable enable
namespace CoreImage {
	/// <summary>The CIDifferenceBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/DifferenceBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIDifferenceBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIDifferenceBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIDifferenceBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDifferenceBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDifferenceBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
