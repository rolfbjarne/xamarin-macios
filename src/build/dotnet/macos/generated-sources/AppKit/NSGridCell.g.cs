...
namespace AppKit {
	...
	public unsafe partial class NSGridCell : NSObject, INSCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCustomPlacementConstraintsX = "customPlacementConstraints";
		static readonly NativeHandle selCustomPlacementConstraintsXHandle = Selector.GetHandle ("customPlacementConstraints");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEmptyContentViewX = "emptyContentView";
		static readonly NativeHandle selEmptyContentViewXHandle = Selector.GetHandle ("emptyContentView");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetCustomPlacementConstraints_X = "setCustomPlacementConstraints:";
		static readonly NativeHandle selSetCustomPlacementConstraints_XHandle = Selector.GetHandle ("setCustomPlacementConstraints:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSGridCell");
		...
		public NSGridCell (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSGridCell (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSGridCell (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual NSGridColumn? Column {
			...
			get {
				...
				NSGridColumn? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSGridColumn> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selColumnXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSGridColumn> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selColumnXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				MarkDirty ();
		...
		public virtual NSLayoutConstraint[] CustomPlacementConstraints {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<NSLayoutConstraint>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selCustomPlacementConstraintsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<NSLayoutConstraint>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selCustomPlacementConstraintsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetCustomPlacementConstraints_XHandle, nsa_value.Handle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetCustomPlacementConstraints_XHandle, nsa_value.Handle);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public static NSView EmptyContentView {
			...
			get {
				global::AppKit.NSApplication.EnsureUIThread ();
				NSView? ret;
				ret =  Runtime.GetNSObject<NSView> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selEmptyContentViewXHandle), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual NSGridRow? Row {
			...
			get {
				...
				NSGridRow? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSGridRow> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selRowXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSGridRow> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selRowXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				MarkDirty ();
