...
namespace AuthenticationServices {
	...
	[NoWatch, NoTV, Mac (14, 4), NoiOS, NoMacCatalyst]
	[Flags]
	[Native]
	...
	interface ASWebAuthenticationSession {
		...
		[Deprecated (PlatformName.WatchOS, 10, 4, message: "Use the 'ASWebAuthenticationSessionCallback' overload instead.")]
	...
	interface ASAuthorizationPlatformPublicKeyCredentialAssertion : ASAuthorizationPublicKeyCredentialAssertion {
		...
		[NoWatch, NoTV, Mac (15, 0), iOS (18, 0), MacCatalyst (18, 0)]
		[Export ("prf"), NullAllowed]
		ASAuthorizationPublicKeyCredentialPrfAssertionOutput Prf { get; set; }
	}
	...
	interface ASAuthorizationProviderExtensionRegistrationHandler {
		...
		ASAuthorizationProviderExtensionEncryptionAlgorithm [] SupportedDeviceEncryptionAlgorithms {
			[Wrap ("WeakSupportedDeviceSigningAlgorithms.ToASAuthorizationProviderExtensionEncryptionAlgorithmArray ()!")]
			get;
		}
		...
		ASAuthorizationProviderExtensionSigningAlgorithm [] SupportedUserSecureEnclaveKeySigningAlgorithms {
			[Wrap ("WeakSupportedDeviceSigningAlgorithms.ToASAuthorizationProviderExtensionSigningAlgorithmArray ()!")]
			get;
		}
	...
	[NoWatch, NoTV, iOS (17, 4), MacCatalyst (16, 4), Mac (13, 3)]
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	...
	delegate void ASSettingsHelperRequestCredentialProviderExtensionEnablementCallback (bool appWasEnabledForAutofill);
	...
	interface ASSettingsHelper {
		...
		[Async]
		[Static]
		[Export ("requestCredentialProviderExtensionEnablementWithCompletionHandler:")]
		void RequestCredentialProviderExtensionEnablement (ASSettingsHelperRequestCredentialProviderExtensionEnablementCallback completioHandler);
	}
	...
	interface ASPasskeyRegistrationCredential : ASAuthorizationCredential {
		...
		ASPasskeyRegistrationCredentialExtensionOutput ExtensionOutput { get; }
	}
	...
	interface ASPasskeyAssertionCredential : ASAuthorizationCredential {
		...
		[NoWatch, NoTV, Mac (15, 0), iOS (18, 0), MacCatalyst (18, 0)]
		[Export ("extensionOutput", ArgumentSemantic.Copy), NullAllowed]
		ASPasskeyAssertionCredentialExtensionOutput ExtensionOutput { get; }
	}
	...
	[NoWatch, NoTV, iOS (17, 4), MacCatalyst (17, 0), Mac (14, 0)]
	[BaseType (typeof (NSObject))]
	[DisableDefaultCtor]
	...
	interface ASAuthorizationPublicKeyCredentialPrfAssertionInput {
		[Export ("initWithInputValues:inputValues:")]
