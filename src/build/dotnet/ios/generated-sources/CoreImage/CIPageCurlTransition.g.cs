...
namespace CoreImage {
	...
	public partial class CIPageCurlTransition : CITransitionFilter, ICIPageCurlTransitionProtocol, ICITransitionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIPageCurlTransition" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPageCurlTransition (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPageCurlTransition (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPageCurlTransition (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIPageCurlTransitionProtocol protocol members 
