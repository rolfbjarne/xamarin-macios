...
namespace MapKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "RegionWillChange", Selector = "mapView:regionWillChangeAnimated:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (bool) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "RegionChanged", Selector = "mapView:regionDidChangeAnimated:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (bool) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillStartLoadingMap", Selector = "mapViewWillStartLoadingMap:", ParameterType = new Type [] { typeof (MapKit.MKMapView) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "MapLoaded", Selector = "mapViewDidFinishLoadingMap:", ParameterType = new Type [] { typeof (MapKit.MKMapView) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "LoadingMapFailed", Selector = "mapViewDidFailLoadingMap:withError:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (NSError) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "GetViewForAnnotation", Selector = "mapView:viewForAnnotation:", ReturnType = typeof (MapKit.MKAnnotationView), ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (MapKit.IMKAnnotation) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidAddAnnotationViews", Selector = "mapView:didAddAnnotationViews:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (MapKit.MKAnnotationView[]) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ChangedDragState", Selector = "mapView:annotationView:didChangeDragState:fromOldState:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (MapKit.MKAnnotationView), typeof (MapKit.MKAnnotationViewDragState), typeof (MapKit.MKAnnotationViewDragState) }, ParameterByRef = new bool [] { false, false, false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidSelectAnnotationView", Selector = "mapView:didSelectAnnotationView:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (MapKit.MKAnnotationView) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidFailToLocateUser", Selector = "mapView:didFailToLocateUserWithError:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (NSError) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidDeselectAnnotationView", Selector = "mapView:didDeselectAnnotationView:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (MapKit.MKAnnotationView) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillStartLocatingUser", Selector = "mapViewWillStartLocatingUser:", ParameterType = new Type [] { typeof (MapKit.MKMapView) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidStopLocatingUser", Selector = "mapViewDidStopLocatingUser:", ParameterType = new Type [] { typeof (MapKit.MKMapView) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidUpdateUserLocation", Selector = "mapView:didUpdateUserLocation:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (MapKit.MKUserLocation) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidChangeUserTrackingMode", Selector = "mapView:didChangeUserTrackingMode:animated:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (MapKit.MKUserTrackingMode), typeof (bool) }, ParameterByRef = new bool [] { false, false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "OverlayRenderer", Selector = "mapView:rendererForOverlay:", ReturnType = typeof (MapKit.MKOverlayRenderer), ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (MapKit.IMKOverlay) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidAddOverlayRenderers", Selector = "mapView:didAddOverlayRenderers:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (MapKit.MKOverlayRenderer[]) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillStartRenderingMap", Selector = "mapViewWillStartRenderingMap:", ParameterType = new Type [] { typeof (MapKit.MKMapView) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidFinishRenderingMap", Selector = "mapViewDidFinishRenderingMap:fullyRendered:", ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (bool) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "CreateClusterAnnotation", Selector = "mapView:clusterAnnotationForMemberAnnotations:", ReturnType = typeof (MapKit.MKClusterAnnotation), ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (MapKit.IMKAnnotation[]) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidChangeVisibleRegion", Selector = "mapViewDidChangeVisibleRegion:", ParameterType = new Type [] { typeof (MapKit.MKMapView) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "GetSelectionAccessory", Selector = "mapView:selectionAccessoryForAnnotation:", ReturnType = typeof (MapKit.MKSelectionAccessory), ParameterType = new Type [] { typeof (MapKit.MKMapView), typeof (MapKit.IMKAnnotation) }, ParameterByRef = new bool [] { false, false })]
...
namespace MapKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__MapKit_MKMapViewDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
