...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that maps color intensity from a linear gamma curve to the sRGB color space.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/linear2Srgb_tone_curve.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CILinearToSRGBToneCurve : CIFilter, ICILinearToSrgbToneCurveProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CILinearToSRGBToneCurve" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CILinearToSRGBToneCurve () : base ("CILinearToSRGBToneCurve")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CILinearToSRGBToneCurve (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILinearToSRGBToneCurve (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILinearToSRGBToneCurve (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CILinearToSrgbToneCurveProtocol protocol members 
