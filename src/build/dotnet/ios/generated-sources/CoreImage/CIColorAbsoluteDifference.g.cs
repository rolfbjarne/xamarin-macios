...
namespace CoreImage {
	...
	public partial class CIColorAbsoluteDifference : CIFilter, ICIColorAbsoluteDifferenceProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorAbsoluteDifference" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorAbsoluteDifference (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorAbsoluteDifference (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorAbsoluteDifference (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
