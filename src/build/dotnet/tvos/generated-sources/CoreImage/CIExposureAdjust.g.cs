...
#nullable enable
namespace CoreImage {
	/// <summary>The CIExposureAdjust CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/ExposureAdjust.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIExposureAdjust : CIFilter, ICIExposureAdjustProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIExposureAdjust" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIExposureAdjust () : base ("CIExposureAdjust")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIExposureAdjust (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIExposureAdjust (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIExposureAdjust (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIExposureAdjustProtocol protocol members 
