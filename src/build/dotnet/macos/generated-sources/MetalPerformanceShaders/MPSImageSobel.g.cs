...
namespace MetalPerformanceShaders {
	/// <summary>Filter that detects edges by using a Sobel filter.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/MetalPerformanceShaders/Reference/MPSImageSobel_ClassReference/index.html">Apple documentation for <c>MPSImageSobel</c></related>
	[Register("MPSImageSobel", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class MPSImageSobel : MPSUnaryImageKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithDevice_LinearGrayColorTransform_X = "initWithDevice:linearGrayColorTransform:";
		static readonly NativeHandle selInitWithDevice_LinearGrayColorTransform_XHandle = Selector.GetHandle ("initWithDevice:linearGrayColorTransform:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSImageSobel");
		...
		public MPSImageSobel (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected MPSImageSobel (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSImageSobel (NativeHandle handle) : base (handle)
		{
		}
		...
		[DesignatedInitializer]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSImageSobel (NSCoder aDecoder, global::Metal.IMTLDevice device)
		...
		/// <param name="device">The device on which the filter will run.</param><summary>Constructs a new <c>MPSImageSobel</c> with the specified values.</summary><remarks>To be added.</remarks>
		[Export ("initWithDevice:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSImageSobel (global::Metal.IMTLDevice device)
			: base (NSObjectFlag.Empty)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal virtual nint InitWithDevice (global::Metal.IMTLDevice device, nint transform)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_IntPtr (this.Handle, selInitWithDevice_LinearGrayColorTransform_XHandle, device__handle__, transform);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_IntPtr (&__objc_super__, selInitWithDevice_LinearGrayColorTransform_XHandle, device__handle__, transform);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal virtual nint _ColorTransform {
