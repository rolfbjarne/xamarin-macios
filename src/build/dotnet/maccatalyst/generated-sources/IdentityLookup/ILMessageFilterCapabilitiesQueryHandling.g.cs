...
namespace IdentityLookup {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "HandleQueryRequest", Selector = "handleCapabilitiesQueryRequest:context:completion:", ParameterType = new Type [] { typeof (IdentityLookup.ILMessageFilterCapabilitiesQueryRequest), typeof (IdentityLookup.ILMessageFilterExtensionContext), typeof (global::System.Action<global::IdentityLookup.ILMessageFilterCapabilitiesQueryResponse>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V63) })]
	public partial interface IILMessageFilterCapabilitiesQueryHandling : INativeObject, IDisposable
	{
		...
		public unsafe virtual void HandleQueryRequest (ILMessageFilterCapabilitiesQueryRequest capabilitiesQueryRequest, ILMessageFilterExtensionContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V63))]global::System.Action<ILMessageFilterCapabilitiesQueryResponse> completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _HandleQueryRequest (IILMessageFilterCapabilitiesQueryHandling This, ILMessageFilterCapabilitiesQueryRequest capabilitiesQueryRequest, ILMessageFilterExtensionContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V63))]global::System.Action<ILMessageFilterCapabilitiesQueryResponse> completion)
		{
	...
	internal unsafe sealed class ILMessageFilterCapabilitiesQueryHandlingWrapper : BaseWrapper, IILMessageFilterCapabilitiesQueryHandling {
		...
		[Export ("handleCapabilitiesQueryRequest:context:completion:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void HandleQueryRequest (ILMessageFilterCapabilitiesQueryRequest capabilitiesQueryRequest, ILMessageFilterExtensionContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V63))]global::System.Action<ILMessageFilterCapabilitiesQueryResponse> completion)
		{
			var capabilitiesQueryRequest__handle__ = capabilitiesQueryRequest!.GetNonNullHandle (nameof (capabilitiesQueryRequest));
			var context__handle__ = context!.GetNonNullHandle (nameof (context));
			if (completion is null)
