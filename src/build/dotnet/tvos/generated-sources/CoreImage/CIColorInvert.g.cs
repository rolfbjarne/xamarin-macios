...
#nullable enable
namespace CoreImage {
	/// <summary>The CIColorInvert CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/ColorInvert.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIColorInvert : CIFilter, ICIColorInvertProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorInvert" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIColorInvert () : base ("CIColorInvert")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorInvert (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorInvert (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorInvert (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIColorInvertProtocol protocol members 
