...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIScreenFilter" /> that filters via a hatched halftone pattern.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/hatched_screen.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIHatchedScreen : CIScreenFilter, ICIHatchedScreenProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIHatchedScreen" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIHatchedScreen (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIHatchedScreen (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIHatchedScreen (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIHatchedScreenProtocol protocol members 
