...
namespace GameKit {
	...
	public unsafe partial class GKLeaderboardEntry : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selFormattedScoreX = "formattedScore";
		static readonly NativeHandle selFormattedScoreXHandle = Selector.GetHandle ("formattedScore");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public unsafe virtual global::AppKit.NSViewController ChallengeComposeControllerWithMessage (string? message, GKPlayer[]? players, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGKChallengeComposeHandler2))]GKChallengeComposeHandler2? completionHandler)
		{
			...
			global::AppKit.NSViewController? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<global::AppKit.NSViewController> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, selChallengeComposeControllerWithMessage_Players_Completion_XHandle, nsmessage, nsa_players.GetHandle (), (IntPtr) block_ptr_completionHandler), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
		...
		public virtual string FormattedScore {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selFormattedScoreXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selFormattedScoreXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
