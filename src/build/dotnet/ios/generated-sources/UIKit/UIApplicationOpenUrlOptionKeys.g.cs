...
namespace UIKit {
	...
	internal unsafe static partial class UIApplicationOpenUrlOptionKeys  {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _OpenExternalUrlOptionsEventAttributionKey;
		/// <summary>Represents the value associated with the constant 'UIApplicationOpenExternalURLOptionsEventAttributionKey'.</summary>
		[Field ("UIApplicationOpenExternalURLOptionsEventAttributionKey",  "UIKit")]
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios14.5")]
		[SupportedOSPlatform ("maccatalyst")]
		public static NSString OpenExternalUrlOptionsEventAttributionKey {
			[UnsupportedOSPlatform ("tvos")]
			[SupportedOSPlatform ("ios14.5")]
			[SupportedOSPlatform ("maccatalyst")]
			get {
				if (_OpenExternalUrlOptionsEventAttributionKey is null)
					_OpenExternalUrlOptionsEventAttributionKey = Dlfcn.GetStringConstant (Libraries.UIKit.Handle, "UIApplicationOpenExternalURLOptionsEventAttributionKey")!;
				return _OpenExternalUrlOptionsEventAttributionKey;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _OpenUrlOptionsEventAttributionKey;
		/// <summary>Represents the value associated with the constant 'UIApplicationOpenURLOptionsEventAttributionKey'.</summary>
		[Field ("UIApplicationOpenURLOptionsEventAttributionKey",  "UIKit")]
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios14.5")]
		[SupportedOSPlatform ("maccatalyst")]
		public static NSString OpenUrlOptionsEventAttributionKey {
			[UnsupportedOSPlatform ("tvos")]
			[SupportedOSPlatform ("ios14.5")]
			[SupportedOSPlatform ("maccatalyst")]
			get {
				if (_OpenUrlOptionsEventAttributionKey is null)
					_OpenUrlOptionsEventAttributionKey = Dlfcn.GetStringConstant (Libraries.UIKit.Handle, "UIApplicationOpenURLOptionsEventAttributionKey")!;
				return _OpenUrlOptionsEventAttributionKey;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
