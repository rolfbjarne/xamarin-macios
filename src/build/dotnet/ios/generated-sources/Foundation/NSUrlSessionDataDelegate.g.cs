...
namespace Foundation {
		...
		Foundation.INSUrlSessionTaskDelegate
	{
		...
		public unsafe virtual void DidReceiveResponse (NSUrlSession session, NSUrlSessionDataTask dataTask, NSUrlResponse response, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V69))]global::System.Action<NSUrlSessionResponseDisposition> completionHandler)
		{
			_DidReceiveResponse (this, session, dataTask, response, completionHandler);
		}
		/// <param name="session">To be added.</param><param name="dataTask">To be added.</param><param name="response">To be added.</param><param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _DidReceiveResponse (INSUrlSessionDataDelegate This, NSUrlSession session, NSUrlSessionDataTask dataTask, NSUrlResponse response, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V69))]global::System.Action<NSUrlSessionResponseDisposition> completionHandler)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void WillCacheResponse (NSUrlSession session, NSUrlSessionDataTask dataTask, NSCachedUrlResponse proposedResponse, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V67))]global::System.Action<NSCachedUrlResponse> completionHandler)
		{
			_WillCacheResponse (this, session, dataTask, proposedResponse, completionHandler);
		}
		/// <param name="session">To be added.</param><param name="dataTask">To be added.</param><param name="proposedResponse">To be added.</param><param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _WillCacheResponse (INSUrlSessionDataDelegate This, NSUrlSession session, NSUrlSessionDataTask dataTask, NSCachedUrlResponse proposedResponse, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V67))]global::System.Action<NSCachedUrlResponse> completionHandler)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			var dataTask__handle__ = dataTask!.GetNonNullHandle (nameof (dataTask));
	...
	public unsafe static partial class NSUrlSessionDataDelegate_Extensions {
		/// <param name="session">To be added.</param><param name="dataTask">To be added.</param><param name="response">To be added.</param><param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void DidReceiveResponse (this INSUrlSessionDataDelegate This, NSUrlSession session, NSUrlSessionDataTask dataTask, NSUrlResponse response, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V69))]global::System.Action<NSUrlSessionResponseDisposition> completionHandler)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			var dataTask__handle__ = dataTask!.GetNonNullHandle (nameof (dataTask));
			var response__handle__ = response!.GetNonNullHandle (nameof (response));
		...
		/// <param name="session">To be added.</param><param name="dataTask">To be added.</param><param name="proposedResponse">To be added.</param><param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void WillCacheResponse (this INSUrlSessionDataDelegate This, NSUrlSession session, NSUrlSessionDataTask dataTask, NSCachedUrlResponse proposedResponse, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V67))]global::System.Action<NSCachedUrlResponse> completionHandler)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			var dataTask__handle__ = dataTask!.GetNonNullHandle (nameof (dataTask));
			var proposedResponse__handle__ = proposedResponse!.GetNonNullHandle (nameof (proposedResponse));
...
namespace Foundation {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_iOS__Foundation_NSUrlSessionDataDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
