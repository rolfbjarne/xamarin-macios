...
namespace AVFoundation {
	...
	public unsafe partial class AVCaptureAudioChannel : NSObject {
		...
		const string selAveragePowerLevelX = "averagePowerLevel";
		static readonly NativeHandle selAveragePowerLevelXHandle = Selector.GetHandle ("averagePowerLevel");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selIsEnabledX = "isEnabled";
		static readonly NativeHandle selIsEnabledXHandle = Selector.GetHandle ("isEnabled");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPeakHoldLevelX = "peakHoldLevel";
		static readonly NativeHandle selPeakHoldLevelXHandle = Selector.GetHandle ("peakHoldLevel");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual float AveragePowerLevel {
			...
			get {
				float ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.float_objc_msgSend (this.Handle, selAveragePowerLevelXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.float_objc_msgSendSuper (&__objc_super__, selAveragePowerLevelXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual float PeakHoldLevel {
			...
			get {
				float ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.float_objc_msgSend (this.Handle, selPeakHoldLevelXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.float_objc_msgSendSuper (&__objc_super__, selPeakHoldLevelXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
