...
namespace MetalPerformanceShaders {
	/// <summary>Transforms an image so that its histogram matches a desired histogram.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/MetalPerformanceShaders/Reference/MPSImageHistogramSpecification_ClassReference/index.html">Apple documentation for <c>MPSImageHistogramSpecification</c></related>
	[Register("MPSImageHistogramSpecification", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class MPSImageHistogramSpecification : MPSUnaryImageKernel {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeTransformToCommandBuffer_SourceTexture_SourceHistogram_SourceHistogramOffset_DesiredHistogram_DesiredHistogramOffset_X = "encodeTransformToCommandBuffer:sourceTexture:sourceHistogram:sourceHistogramOffset:desiredHistogram:desiredHistogramOffset:";
		static readonly NativeHandle selEncodeTransformToCommandBuffer_SourceTexture_SourceHistogram_SourceHistogramOffset_DesiredHistogram_DesiredHistogramOffset_XHandle = Selector.GetHandle ("encodeTransformToCommandBuffer:sourceTexture:sourceHistogram:sourceHistogramOffset:desiredHistogram:desiredHistogramOffset:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSImageHistogramSpecification");
		...
		public MPSImageHistogramSpecification (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected MPSImageHistogramSpecification (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSImageHistogramSpecification (NativeHandle handle) : base (handle)
		{
		}

		/// <param name="device">The device on which the histogram specification will be run.</param><param name="histogramInfo">The histogram format.</param><summary>Creates a new <c>MPSImageHistogramSpecification</c> for the specified <paramref name="device" /> and <paramref name="histogramInfo" />.</summary><remarks>To be added.</remarks>
		...
		[DesignatedInitializer]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSImageHistogramSpecification (NSCoder aDecoder, global::Metal.IMTLDevice device)
			: base (NSObjectFlag.Empty)
		{
		...
		/// <param name="commandBuffer">To be added.</param><param name="source">To be added.</param><param name="sourceHistogram">To be added.</param><param name="sourceHistogramOffset">To be added.</param><param name="desiredHistogram">To be added.</param><param name="desiredHistogramOffset">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void EncodeTransformToCommandBuffer (global::Metal.IMTLCommandBuffer commandBuffer, global::Metal.IMTLTexture source, global::Metal.IMTLBuffer sourceHistogram, nuint sourceHistogramOffset, global::Metal.IMTLBuffer desiredHistogram, nuint desiredHistogramOffset)
		{
			...
			var sourceHistogram__handle__ = sourceHistogram!.GetNonNullHandle (nameof (sourceHistogram));
			var desiredHistogram__handle__ = desiredHistogram!.GetNonNullHandle (nameof (desiredHistogram));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_UIntPtr_NativeHandle_UIntPtr (this.Handle, selEncodeTransformToCommandBuffer_SourceTexture_SourceHistogram_SourceHistogramOffset_DesiredHistogram_DesiredHistogramOffset_XHandle, commandBuffer__handle__, source__handle__, sourceHistogram__handle__, sourceHistogramOffset, desiredHistogram__handle__, desiredHistogramOffset);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_UIntPtr_NativeHandle_UIntPtr (&__objc_super__, selEncodeTransformToCommandBuffer_SourceTexture_SourceHistogram_SourceHistogramOffset_DesiredHistogram_DesiredHistogramOffset_XHandle, commandBuffer__handle__, source__handle__, sourceHistogram__handle__, sourceHistogramOffset, desiredHistogram__handle__, desiredHistogramOffset);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
			GC.KeepAlive (source);
			GC.KeepAlive (sourceHistogram);
			GC.KeepAlive (desiredHistogram);
		}
		/// <summary>Gets the configuration of the current and desired histograms.</summary><value>The configuration of the current and desired histograms.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
