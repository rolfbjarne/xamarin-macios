...
namespace Xamarin.MacDev.Tasks {
	...
	public class ACToolTaskTests : TestBase {
		...
		public void DefaultAppIcons (ApplePlatform platform)
		{
			...
			ClassicAssert.IsNotNull (actool.PartialAppManifest, "PartialAppManifest");
			...
			ClassicAssert.AreEqual (0, appIconsManifest.Count, $"Partial plist contents: {actool.PartialAppManifest?.ItemSpec}");
			var expectedXml =
				"""
...
""";
		...
		public void InexistentAppIcon (ApplePlatform platform)
		{
			...
			ClassicAssert.AreEqual (expectedErrorMessage, Engine.Logger.ErrorEvents [0].Message, "Error message");
		}
		...
		public void BothAlternateAndMainIcon (ApplePlatform platform)
		{
			...
			ExecuteTask (actool, 1);
			ClassicAssert.AreEqual ($"The image resource '{actool.AppIcon}' is specified as both 'AppIcon' and 'AlternateAppIcon'.", Engine.Logger.ErrorEvents [0].Message, "Error message");
		}
		...
		public void XSAppIconAssetsAndAppIcon (ApplePlatform platform)
		{
			...
			ExecuteTask (actool, 1);
			ClassicAssert.AreEqual ("Can't specify both 'XSAppIconAssets' in the Info.plist and 'AppIcon' in the project file. Please select one or the other.", Engine.Logger.ErrorEvents [0].Message, "Error message");
		}
	}
}
