...
namespace Xamarin.Mac.Tests {
	...
	public class NSViewTests {
		...
		public void NSViewShouldAddGestureRecognizer ()
		{
			...
			Assert.That (view.GestureRecognizers.Length == length + 1, Is.True, "NSViewShouldAddGestureRecognizer - Failed to add recognizer, count didn't change.");
		}
		...
		public void NSViewShouldRemoveGestureRecognizer ()
		{
			...
			Assert.That (view.GestureRecognizers.Length != 0, Is.True, "NSViewShouldRemoveGestureRecognizer - Failed to add gesture recognizer");

			view.RemoveGestureRecognizer (recognizer);

			Assert.That (view.GestureRecognizers.Length == 0, Is.True, "NSViewShouldRemoveGestureRecognizer - Failed to remove gesture recognizer");
		}
		...
		public void NSViewShouldChangeGestureRecognizers ()
		{
			...
			Assert.That (view.GestureRecognizers == recognizers, Is.False);
		}
