...
namespace NearbyInteraction {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidUpdateDlTdoaMeasurements", Selector = "session:didUpdateDLTDOAMeasurements:", ParameterType = new Type [] { typeof (NearbyInteraction.NISession), typeof (NearbyInteraction.NIDlTdoaMeasurement[]) }, ParameterByRef = new bool [] { false, false })]
	public partial interface INISessionDelegate : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void DidUpdateDlTdoaMeasurements (NISession session, NIDlTdoaMeasurement[] measurements)
		{
			_DidUpdateDlTdoaMeasurements (this, session, measurements);
		}
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[UnsupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("ios26.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _DidUpdateDlTdoaMeasurements (INISessionDelegate This, NISession session, NIDlTdoaMeasurement[] measurements)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			if (measurements is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (measurements));
			using var nsa_measurements = NSArray.FromNSObjects (measurements);
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("session:didUpdateDLTDOAMeasurements:"), session__handle__, nsa_measurements.Handle);
			GC.KeepAlive (This);
			GC.KeepAlive (session);
		}
		...
		[DynamicDependencyAttribute ("DidUpdateDlTdoaMeasurements(NearbyInteraction.NISession,NearbyInteraction.NIDlTdoaMeasurement[])")]
	...
	public unsafe static partial class NISessionDelegate_Extensions {
		...
		[SupportedOSPlatform ("ios26.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void DidUpdateDlTdoaMeasurements (this INISessionDelegate This, NISession session, NIDlTdoaMeasurement[] measurements)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			if (measurements is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (measurements));
...
namespace NearbyInteraction {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_iOS__NearbyInteraction_NISessionDelegate", false)]
	[Model]
	[UnsupportedOSPlatform ("tvos")]
	[UnsupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("ios14.0")]
