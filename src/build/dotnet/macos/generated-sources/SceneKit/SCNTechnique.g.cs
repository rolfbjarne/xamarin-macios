...
namespace SceneKit {
	...
	public unsafe partial class SCNTechnique : NSObject, INSCoding, INSCopying, INSSecureCoding, ISCNAnimatable {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTechniqueBySequencingTechniques_X = "techniqueBySequencingTechniques:";
		static readonly NativeHandle selTechniqueBySequencingTechniques_XHandle = Selector.GetHandle ("techniqueBySequencingTechniques:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTechniqueWithDictionary_X = "techniqueWithDictionary:";
		static readonly NativeHandle selTechniqueWithDictionary_XHandle = Selector.GetHandle ("techniqueWithDictionary:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static SCNTechnique? Create (NSDictionary dictionary)
		{
			...
			SCNTechnique? ret;
			ret =  Runtime.GetNSObject<SCNTechnique> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selTechniqueWithDictionary_XHandle, dictionary__handle__), false)!;
		...
		public static SCNTechnique? Create (SCNTechnique[] techniques)
		{
			...
			SCNTechnique ret;
			ret =  Runtime.GetNSObject<SCNTechnique> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selTechniqueBySequencingTechniques_XHandle, nsa_techniques.Handle), false)!;
			return ret;
		}
		...
		internal virtual NSObject? _GetObject (NSObject key)
		{
			...
			NSObject? ret;
			if (IsDirectBinding) {
				ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selObjectForKeyedSubscript_XHandle, key__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selObjectForKeyedSubscript_XHandle, key__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (key);
