...
namespace AppKit {
	...
	/// <summary>This interface represents the Objective-C protocol <c>NSAccessibilityButton</c>.</summary>
	/// <remarks>
	...
	public partial interface INSAccessibilityButton : INativeObject, IDisposable, 
		AppKit.INSAccessibilityElementProtocol
	{
		...
		/// <summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static bool _AccessibilityPerformPress (INSAccessibilityButton This)
		{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSAccessibilityButtonWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static INSAccessibilityButton ()
		{
			GC.KeepAlive (null);
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static string _GetAccessibilityLabel (INSAccessibilityButton This)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			string ret;
	...
	internal unsafe sealed class NSAccessibilityButtonWrapper : BaseWrapper, INSAccessibilityButton {
		public NSAccessibilityButtonWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSAccessibilityButtonWrapper))]
		static NSAccessibilityButtonWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
