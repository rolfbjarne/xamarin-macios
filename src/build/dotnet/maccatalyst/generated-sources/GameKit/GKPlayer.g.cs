...
namespace GameKit {
	...
	public unsafe partial class GKPlayer : GKBasePlayer, INSCoding, INSSecureCoding {
		...
		public static GKPlayer GetAnonymousGuestPlayer (string guestIdentifier)
		{
			...
			GKPlayer? ret;
			ret =  Runtime.GetNSObject<GKPlayer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("anonymousGuestPlayerWithIdentifier:"), nsguestIdentifier), false)!;
		...
		public unsafe virtual void LoadPhoto (GKPhotoSize size, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGKPlayerPhotoLoaded))]GKPlayerPhotoLoaded? onCompleted)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr_NativeHandle (this.Handle, Selector.GetHandle ("loadPhotoForSize:withCompletionHandler:"), (IntPtr) (long) size, (IntPtr) block_ptr_onCompleted);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr_NativeHandle (&__objc_super__, Selector.GetHandle ("loadPhotoForSize:withCompletionHandler:"), (IntPtr) (long) size, (IntPtr) block_ptr_onCompleted);
					GC.KeepAlive (this);
				}
			}
		}
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual Task<global::UIKit.UIImage> LoadPhotoAsync (GKPhotoSize size)
		{
		...
		public unsafe static void LoadPlayersForIdentifiers (string[] identifiers, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGKPlayersHandler))]GKPlayersHandler? completionHandler)
		{
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("loadPlayersForIdentifiers:withCompletionHandler:"), nsa_identifiers.Handle, (IntPtr) block_ptr_completionHandler);
		}
		...
		public virtual string Alias {
			...
			get {
				...
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("alias")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("alias")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual string GamePlayerId {
			...
			get {
				...
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("gamePlayerID")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("gamePlayerID")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual string? GuestIdentifier {
			...
			get {
				...
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("guestIdentifier")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("guestIdentifier")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual bool IsFriend {
			...
			get {
				...
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("isFriend"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isFriend"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual bool IsInvitable {
			...
			get {
				...
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("isInvitable"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isInvitable"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual bool ScopedIdsArePersistent {
			...
			get {
				...
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("scopedIDsArePersistent"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("scopedIDsArePersistent"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual string TeamPlayerId {
			...
			get {
				...
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("teamPlayerID")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("teamPlayerID")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
