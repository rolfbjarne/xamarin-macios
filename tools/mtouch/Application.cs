	...
	public partial class Application
	{
		...
		void DetectCodeSharing ()
		{
			...
			foreach (var appex in AppExtensions) {
				...
				// I18N values must be identical (since this causes the set of linked assemblies to change).
				if (I18n != appex.I18n) {
					Driver.Log (2, "The extension '{0}' has different I18N values (extension: {1}, main app: {2}), and can therefore not share native code with the main app.", appex.Name, appex,I18n, I18n);
					continue;
				}
