...
namespace UIKit {
	...
	public unsafe partial class NSTextTab : NSObject, INSCoding, INSCopying, INSSecureCoding {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_nfloat_NativeHandle (this.Handle, Selector.GetHandle ("initWithTextAlignment:location:options:"), (IntPtr) (long) alignment, location, options__handle__), "initWithTextAlignment:location:options:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr_nfloat_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithTextAlignment:location:options:"), (IntPtr) (long) alignment, location, options__handle__), "initWithTextAlignment:location:options:");
					GC.KeepAlive (this);
				}
			}
