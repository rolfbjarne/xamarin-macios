...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CITransitionFilter</c>.</summary>
	/// <remarks>
	...
	public partial interface ICITransitionFilterProtocol : INativeObject, IDisposable, 
		CoreImage.ICIFilterProtocol
	{
		[DynamicDependencyAttribute ("InputImage")]
		[DynamicDependencyAttribute ("TargetImage")]
		[DynamicDependencyAttribute ("Time")]
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CITransitionFilterProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICITransitionFilterProtocol ()
		{
			GC.KeepAlive (null);
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CIImage _GetInputImage (ICITransitionFilterProtocol This)
		{
			CIImage ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputImage (ICITransitionFilterProtocol This, CIImage? value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[global::Foundation.RequiredMember]
		public virtual CIImage? TargetImage {
			[Export ("targetImage", ArgumentSemantic.Retain)]
			get {
				return _GetTargetImage (this);
			}
			[Export ("setTargetImage:", ArgumentSemantic.Retain)]
			set {
				_SetTargetImage (this, value);
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CIImage _GetTargetImage (ICITransitionFilterProtocol This)
		{
			CIImage ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetTargetImage (ICITransitionFilterProtocol This, CIImage? value)
		{
			var value__handle__ = value.GetHandle ();
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static float _GetTime (ICITransitionFilterProtocol This)
		{
			float ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetTime (ICITransitionFilterProtocol This, float value)
		{
	...
	internal unsafe sealed class CITransitionFilterProtocolWrapper : BaseWrapper, ICITransitionFilterProtocol {
		public CITransitionFilterProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CITransitionFilterProtocolWrapper))]
		static CITransitionFilterProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets or sets an image to filter.</summary>
