...
namespace GameKit {
	...
	public unsafe partial class GKInvite : NSObject {
		...
		const string selInviterX = "inviter";
		static readonly NativeHandle selInviterXHandle = Selector.GetHandle ("inviter");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[ObsoletedOSPlatform ("ios8.0", "Use 'Sender' instead.")]
		[ObsoletedOSPlatform ("macos10.10", "Use 'Sender' instead.")]
		[SupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'Sender' instead.")]
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos")]
		public virtual string Inviter {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selInviterXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selInviterXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual GKPlayer Sender {
			...
			get {
				GKPlayer? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<GKPlayer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selSenderXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<GKPlayer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selSenderXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
