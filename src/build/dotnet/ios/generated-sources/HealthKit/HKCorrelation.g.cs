...
namespace HealthKit {
	...
	public unsafe partial class HKCorrelation : HKSample, INSCoding, INSSecureCoding {
		...
		public static HKCorrelation Create (HKCorrelationType correlationType, NSDate startDate, NSDate endDate, NSSet objects)
		{
			...
			var objects__handle__ = objects!.GetNonNullHandle (nameof (objects));
			HKCorrelation? ret;
			ret =  Runtime.GetNSObject<HKCorrelation> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("correlationWithType:startDate:endDate:objects:"), correlationType__handle__, startDate__handle__, endDate__handle__, objects__handle__), false)!;
			GC.KeepAlive (correlationType);
			GC.KeepAlive (startDate);
			GC.KeepAlive (endDate);
			GC.KeepAlive (objects);
		...
		public virtual NSSet GetObjects (HKObjectType objectType)
		{
			...
			NSSet? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSSet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("objectsForType:"), objectType__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSSet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("objectsForType:"), objectType__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual HKCorrelationType CorrelationType {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKCorrelationType> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("correlationType")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKCorrelationType> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("correlationType")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual NSSet Objects {
			...
			get {
				NSSet? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSSet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("objects")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSSet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("objects")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
