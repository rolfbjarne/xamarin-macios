...
namespace UserNotifications {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillPresentNotification", Selector = "userNotificationCenter:willPresentNotification:withCompletionHandler:", ParameterType = new Type [] { typeof (UserNotifications.UNUserNotificationCenter), typeof (UserNotifications.UNNotification), typeof (global::System.Action<global::UserNotifications.UNNotificationPresentationOptions>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V90) })]
	public partial interface IUNUserNotificationCenterDelegate : INativeObject, IDisposable
	{
		...
		public unsafe virtual void WillPresentNotification (UNUserNotificationCenter center, UNNotification notification, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V90))]global::System.Action<UNNotificationPresentationOptions> completionHandler)
		{
			_WillPresentNotification (this, center, notification, completionHandler);
		}
		/// <param name="center">The notification center that received the response.</param><param name="notification">To be added.</param><param name="completionHandler">An action that takes no arguments and returns no value.</param><summary>Called to deliver a notification to an application that is running in the foreground.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _WillPresentNotification (IUNUserNotificationCenterDelegate This, UNUserNotificationCenter center, UNNotification notification, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V90))]global::System.Action<UNNotificationPresentationOptions> completionHandler)
		{
			...
			using var block_completionHandler = Trampolines.SDActionArity1V90.CreateBlock (completionHandler);
	...
	public unsafe static partial class UNUserNotificationCenterDelegate_Extensions {
		/// <param name="center">The notification center that received the response.</param><param name="notification">To be added.</param><param name="completionHandler">An action that takes no arguments and returns no value.</param><summary>Called to deliver a notification to an application that is running in the foreground.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void WillPresentNotification (this IUNUserNotificationCenterDelegate This, UNUserNotificationCenter center, UNNotification notification, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V90))]global::System.Action<UNNotificationPresentationOptions> completionHandler)
		{
			var center__handle__ = center!.GetNonNullHandle (nameof (center));
			var notification__handle__ = notification!.GetNonNullHandle (nameof (notification));
			if (completionHandler is null)
...
namespace UserNotifications {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_tvOS__UserNotifications_UNUserNotificationCenterDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
