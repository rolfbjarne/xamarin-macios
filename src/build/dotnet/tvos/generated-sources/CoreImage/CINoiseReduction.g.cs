...
namespace CoreImage {
	...
	public partial class CINoiseReduction : CIFilter, ICINoiseReductionProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CINoiseReduction" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CINoiseReduction () : base ("CINoiseReduction")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CINoiseReduction (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CINoiseReduction (NSObjectFlag t) : base (t)
		{
		}
		...
		public CINoiseReduction (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CINoiseReductionProtocol protocol members 
		...
		public float NoiseLevel {
			[Export ("noiseLevel")]
			get {
				return GetFloat ("inputNoiseLevel");
			}
			[Export ("setNoiseLevel:")]
			set {
				SetFloat ("inputNoiseLevel", value);
			}
		}
