...
namespace CoreImage {
	...
	public partial class CIMorphologyRectangleMaximum : CIMorphologyRectangle, ICIMorphologyRectangleMaximumProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIMorphologyRectangleMaximum" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIMorphologyRectangleMaximum () : base ("CIMorphologyRectangleMaximum")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMorphologyRectangleMaximum (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMorphologyRectangleMaximum (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMorphologyRectangleMaximum (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIMorphologyRectangleMaximumProtocol protocol members 
