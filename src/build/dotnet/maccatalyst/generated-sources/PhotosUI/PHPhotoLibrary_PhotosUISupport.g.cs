...
namespace PhotosUI {
	...
	public unsafe static partial class PHPhotoLibrary_PhotosUISupport  {
		...
		[UnsupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void PresentLimitedLibraryPicker (this global::Photos.PHPhotoLibrary This, global::UIKit.UIViewController controller, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V3))]global::System.Action<string[]> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var controller__handle__ = controller!.GetNonNullHandle (nameof (controller));
