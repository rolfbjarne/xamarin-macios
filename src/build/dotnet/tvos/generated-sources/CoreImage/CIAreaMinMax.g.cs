...
namespace CoreImage {
	...
	public partial class CIAreaMinMax : CIReductionFilter, ICIAreaReductionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIAreaMinMax" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIAreaMinMax () : base ("CIAreaMinMax")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAreaMinMax (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAreaMinMax (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAreaMinMax (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIImage? OutputImageMps {
			get {
				return (ValueForKey ("outputImageMPS") as CIImage)!;
			}
		}
