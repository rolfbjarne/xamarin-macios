...
#nullable enable
namespace CoreImage {
	/// <summary>Generates a solid color.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// ]]></code></example><para><img href="~/xml/CoreImage/_images/CoreImage.CIConstantColorGenerator.png" alt="Result of applying the filter." /></para></remarks>
	public partial class CIConstantColorGenerator : CIFilter {
		/// <summary>Creates a new <see cref="CIConstantColorGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIConstantColorGenerator () : base ("CIConstantColorGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIConstantColorGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIConstantColorGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIConstantColorGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Gets or sets the color to use.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
