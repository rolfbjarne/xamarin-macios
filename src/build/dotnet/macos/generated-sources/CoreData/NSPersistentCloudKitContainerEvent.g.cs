...
namespace CoreData {
	...
	public unsafe partial class NSPersistentCloudKitContainerEvent : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selStoreIdentifierX = "storeIdentifier";
		static readonly NativeHandle selStoreIdentifierXHandle = Selector.GetHandle ("storeIdentifier");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSucceededX = "succeeded";
		static readonly NativeHandle selSucceededXHandle = Selector.GetHandle ("succeeded");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual string StoreIdentifier {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selStoreIdentifierXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selStoreIdentifierXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual bool Succeeded {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selSucceededXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selSucceededXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual NSPersistentCloudKitContainerEventType Type {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (CoreData.NSPersistentCloudKitContainerEventType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selTypeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (CoreData.NSPersistentCloudKitContainerEventType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selTypeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
