...
namespace AVFoundation {
	...
	public unsafe partial class AVAssetWriterInputPixelBufferAdaptor : NSObject {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAppendPixelBuffer_WithPresentationTime_X = "appendPixelBuffer:withPresentationTime:";
		static readonly NativeHandle selAppendPixelBuffer_WithPresentationTime_XHandle = Selector.GetHandle ("appendPixelBuffer:withPresentationTime:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAssetWriterInputPixelBufferAdaptorWithAssetWriterInput_SourcePixelBufferAttributes_X = "assetWriterInputPixelBufferAdaptorWithAssetWriterInput:sourcePixelBufferAttributes:";
		static readonly NativeHandle selAssetWriterInputPixelBufferAdaptorWithAssetWriterInput_SourcePixelBufferAttributes_XHandle = Selector.GetHandle ("assetWriterInputPixelBufferAdaptorWithAssetWriterInput:sourcePixelBufferAttributes:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("AVAssetWriterInputPixelBufferAdaptor");
		...
		protected AVAssetWriterInputPixelBufferAdaptor (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal AVAssetWriterInputPixelBufferAdaptor (NativeHandle handle) : base (handle)
		{
		}
		...
		/// <param name="input">To be added.</param><param name="attributes">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public AVAssetWriterInputPixelBufferAdaptor (AVAssetWriterInput input, global::CoreVideo.CVPixelBufferAttributes? attributes)
			: this (input, attributes.GetDictionary ())
		{
		}
		[Export ("appendPixelBuffer:withPresentationTime:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual bool AppendPixelBufferWithPresentationTime (global::CoreVideo.CVPixelBuffer pixelBuffer, global::CoreMedia.CMTime presentationTime)
		{
			var pixelBuffer__handle__ = pixelBuffer!.GetNonNullHandle (nameof (pixelBuffer));
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_CMTime (this.Handle, selAppendPixelBuffer_WithPresentationTime_XHandle, pixelBuffer__handle__, presentationTime);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle_CMTime (&__objc_super__, selAppendPixelBuffer_WithPresentationTime_XHandle, pixelBuffer__handle__, presentationTime);
					GC.KeepAlive (this);
				}
			}
		...
		/// <param name="input">To be added.</param><param name="attributes">To be added.</param><summary>Factory method to create an <see cref="T:AVFoundation.AVAssetWriterInputPixelBufferAdaptor" /> with the specified s<paramref name="input" /> and <paramref name="attributes" />.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static AVAssetWriterInputPixelBufferAdaptor Create (AVAssetWriterInput input, global::CoreVideo.CVPixelBufferAttributes? attributes)
		{
		...
		public static AVAssetWriterInputPixelBufferAdaptor FromInput (AVAssetWriterInput input, NSDictionary? sourcePixelBufferAttributes)
		{
			var input__handle__ = input!.GetNonNullHandle (nameof (input));
			var sourcePixelBufferAttributes__handle__ = sourcePixelBufferAttributes.GetHandle ();
			AVAssetWriterInputPixelBufferAdaptor? ret;
			ret =  Runtime.GetNSObject<AVAssetWriterInputPixelBufferAdaptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, selAssetWriterInputPixelBufferAdaptorWithAssetWriterInput_SourcePixelBufferAttributes_XHandle, input__handle__, sourcePixelBufferAttributes__handle__), false)!;
			GC.KeepAlive (input);
			GC.KeepAlive (sourcePixelBufferAttributes);
			return ret!;
		}
		...
		/// <summary>The <see cref="T:CoreVideo.CVPixelBufferAttributes" /> of the pixel buffers in the <see cref="P:AVFoundation.AVAssetWriterInputPixelBufferAdaptor.PixelBufferPool" />.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public global::CoreVideo.CVPixelBufferAttributes Attributes {
			get {
				var src = SourcePixelBufferAttributes is not null ? new NSMutableDictionary (SourcePixelBufferAttributes) : null;
