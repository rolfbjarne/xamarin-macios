...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIFilter" /> that applies a perspective transform and then tiles the result.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/perspective_tile.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIPerspectiveTile : CIFilter, ICIPerspectiveTileProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIPerspectiveTile" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPerspectiveTile (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPerspectiveTile (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPerspectiveTile (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIPerspectiveTileProtocol protocol members 
