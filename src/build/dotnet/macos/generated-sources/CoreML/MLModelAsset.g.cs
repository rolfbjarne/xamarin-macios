...
namespace CoreML {
	...
	public unsafe partial class MLModelAsset : NSObject {
		...
		public unsafe static MLModelAsset? Create (NSData specificationData, out NSError? error)
		{
			...
			MLModelAsset? ret;
			ret =  Runtime.GetNSObject<MLModelAsset> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (class_ptr, selModelAssetWithSpecificationData_Error_XHandle, specificationData__handle__, &errorValue), false)!;
		...
		public unsafe static MLModelAsset? Create (NSUrl compiledModelUrl, out NSError? error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			MLModelAsset? ret;
			ret =  Runtime.GetNSObject<MLModelAsset> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (class_ptr, selModelAssetWithURL_Error_XHandle, compiledModelUrl__handle__, &errorValue), false)!;
		...
		public unsafe static MLModelAsset? Create (NSData specificationData, NSDictionary<NSUrl, NSData> blobMapping, out NSError? error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			MLModelAsset? ret;
			ret =  Runtime.GetNSObject<MLModelAsset> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (class_ptr, selModelAssetWithSpecificationData_BlobMapping_Error_XHandle, specificationData__handle__, blobMapping__handle__, &errorValue), false)!;
			GC.KeepAlive (specificationData);
		...
		public unsafe virtual void GetFunctionNames ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMLModelAssetGetFunctionNamesCompletionHandler))]MLModelAssetGetFunctionNamesCompletionHandler handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					...
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selFunctionNamesWithCompletionHandler_XHandle, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public unsafe virtual void GetModelDescription ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMLModelAssetGetModelDescriptionCompletionHandler))]MLModelAssetGetModelDescriptionCompletionHandler handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selModelDescriptionWithCompletionHandler_XHandle, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public unsafe virtual void GetModelDescription (string functionName, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMLModelAssetGetModelDescriptionCompletionHandler))]MLModelAssetGetModelDescriptionCompletionHandler handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selModelDescriptionOfFunctionNamed_CompletionHandler_XHandle, nsfunctionName, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
