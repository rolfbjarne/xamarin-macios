...
namespace AVFoundation {
	...
	public unsafe partial class AVMetadataItem : NSObject, INSCopying, INSMutableCopying {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static AVMetadataItem GetMetadataItem (AVMetadataItem metadataItem, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V5))]global::System.Action<AVMetadataItemValueRequest> handler)
		{
			var metadataItem__handle__ = metadataItem!.GetNonNullHandle (nameof (metadataItem));
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity1V5.CreateBlock (handler);
