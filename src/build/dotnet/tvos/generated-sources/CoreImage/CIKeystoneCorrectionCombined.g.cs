...
namespace CoreImage {
	...
	public partial class CIKeystoneCorrectionCombined : CIKeystoneCorrection, ICIKeystoneCorrectionCombinedProtocol, ICIFourCoordinateGeometryFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIKeystoneCorrectionCombined" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIKeystoneCorrectionCombined () : base ("CIKeystoneCorrectionCombined")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIKeystoneCorrectionCombined (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIKeystoneCorrectionCombined (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIKeystoneCorrectionCombined (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIKeystoneCorrectionCombinedProtocol protocol members 
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos13.0")]
		[SupportedOSPlatform ("maccatalyst")]
