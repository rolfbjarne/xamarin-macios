...
#nullable enable
namespace SceneKit {
	/// <summary>Allows a set of modifications to be applied atomically.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/SceneKit/Reference/SCNTransaction_Class/index.html">Apple documentation for <c>SCNTransaction</c></related>
	[Register("SCNTransaction", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class SCNTransaction : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("SCNTransaction");
		...
		/// <summary>Creates a new <see cref="SCNTransaction" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public SCNTransaction () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected SCNTransaction (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal SCNTransaction (NativeHandle handle) : base (handle)
		{
		}
		...
		/// <param name="completion"><para>To be added.</para><para tool="nullallowed">This parameter can be <see langword="null" />.</para></param><summary>To be added.</summary><remarks>To be added.</remarks>
		[Export ("setCompletionBlock:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void SetCompletionBlock ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAction))]global::System.Action? completion)
		{
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (class_ptr, selSetCompletionBlock_XHandle, (IntPtr) block_ptr_completion);
		}
		[Export ("setValue:forKey:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void SetValueForKey (NSObject? value, NSString key)
		{
			var value__handle__ = value.GetHandle ();
			var key__handle__ = key!.GetNonNullHandle (nameof (key));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (class_ptr, selSetValue_ForKey_XHandle, value__handle__, key__handle__);
			GC.KeepAlive (value);
			GC.KeepAlive (key);
		}
		[Export ("unlock")]
		...
		public virtual NSObject ValueForKey (NSString key)
		{
			...
			NSObject? ret;
			if (IsDirectBinding) {
				ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selValueForKey_XHandle, key__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selValueForKey_XHandle, key__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (key);
		...
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos")]
		public static global::CoreAnimation.CAMediaTimingFunction? AnimationTimingFunction {
			[Export ("animationTimingFunction")]
			get {
				global::CoreAnimation.CAMediaTimingFunction? ret;
				ret =  Runtime.GetNSObject<global::CoreAnimation.CAMediaTimingFunction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selAnimationTimingFunctionXHandle), false)!;
				return ret!;
			}
