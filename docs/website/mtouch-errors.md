...
### <a name="MT2106"/>MT2106: Could not optimize the call to BlockLiteral.SetupBlock in * at offset * because *.

The linker reports this warning when it can't optimize a call to BlockLiteral.SetupBlock.

The message will point to the method that calls BlockLiteral.SetupBlock, and
