...
namespace CoreImage {
	...
	public partial class CIEdgePreserveUpsampleFilter : CIFilter, ICIEdgePreserveUpsampleProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIEdgePreserveUpsampleFilter" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIEdgePreserveUpsampleFilter () : base ("CIEdgePreserveUpsampleFilter")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIEdgePreserveUpsampleFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIEdgePreserveUpsampleFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIEdgePreserveUpsampleFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIEdgePreserveUpsampleProtocol protocol members 
