...
namespace CoreImage {
	...
	public partial class CILinearBurnBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CILinearBurnBlendMode" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CILinearBurnBlendMode () : base ("CILinearBurnBlendMode")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CILinearBurnBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILinearBurnBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILinearBurnBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
