	...
	public unsafe partial class HKContactsLensSpecification : HKLensSpecification, INSCoding, INSCopying, INSSecureCoding {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithSphere:cylinder:axis:addPower:baseCurve:diameter:"), sphere__handle__, cylinder__handle__, axis__handle__, addPower__handle__, baseCurve__handle__, diameter__handle__), "initWithSphere:cylinder:axis:addPower:baseCurve:diameter:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (sphere);
			...
			GC.KeepAlive (baseCurve);
			GC.KeepAlive (diameter);
		}
		...
		public virtual HKQuantity? BaseCurve {
			...
			get {
				HKQuantity? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("baseCurve")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("baseCurve")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual HKQuantity? Diameter {
			...
			get {
				HKQuantity? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("diameter")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("diameter")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
