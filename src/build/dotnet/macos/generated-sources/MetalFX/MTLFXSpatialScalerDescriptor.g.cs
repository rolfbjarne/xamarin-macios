...
namespace MetalFX {
	...
	public unsafe partial class MTLFXSpatialScalerDescriptor : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNewSpatialScalerWithDevice_Compiler_X = "newSpatialScalerWithDevice:compiler:";
		static readonly NativeHandle selNewSpatialScalerWithDevice_Compiler_XHandle = Selector.GetHandle ("newSpatialScalerWithDevice:compiler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual IMTLFXSpatialScaler? Create (global::Metal.IMTLDevice device)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMTLFXSpatialScaler> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selNewSpatialScalerWithDevice_XHandle, device__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual IMTL4FXSpatialScaler? Create (global::Metal.IMTLDevice device, global::Metal.IMTL4Compiler compiler)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetINativeObject<IMTL4FXSpatialScaler> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selNewSpatialScalerWithDevice_Compiler_XHandle, device__handle__, compiler__handle__), true)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMTL4FXSpatialScaler> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selNewSpatialScalerWithDevice_Compiler_XHandle, device__handle__, compiler__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual MTLFXSpatialScalerColorProcessingMode ColorProcessingMode {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MetalFX.MTLFXSpatialScalerColorProcessingMode) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selColorProcessingModeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, selSetColorProcessingMode_XHandle, (IntPtr) (long) value);
						GC.KeepAlive (this);
					}
				}
			}
