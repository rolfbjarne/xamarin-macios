...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITileFilter" /> that rotates the image in 60-degree increments.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/sixfold_rotated_tile.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CISixfoldRotatedTile : CITileFilter, ICISixfoldRotatedTileProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CISixfoldRotatedTile" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISixfoldRotatedTile (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISixfoldRotatedTile (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISixfoldRotatedTile (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CISixfoldRotatedTileProtocol protocol members 
