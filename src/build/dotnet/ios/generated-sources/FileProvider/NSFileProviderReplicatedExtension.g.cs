...
namespace FileProvider {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "GetItem", Selector = "itemForIdentifier:request:completionHandler:", ReturnType = typeof (NSProgress), ParameterType = new Type [] { typeof (string), typeof (NSFileProviderRequest), typeof (global::System.Action<global::FileProvider.INSFileProviderItem, NSError>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity2V78) })]
		...
		FileProvider.INSFileProviderEnumerating
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual NSProgress GetItem (string identifier, NSFileProviderRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V78))]global::System.Action<INSFileProviderItem, NSError> completionHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static NSProgress _GetItem (INSFileProviderReplicatedExtension This, string identifier, NSFileProviderRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V78))]global::System.Action<INSFileProviderItem, NSError> completionHandler)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual NSProgress DeleteItem (string identifier, NSFileProviderItemVersion version, NSFileProviderDeleteItemOptions options, NSFileProviderRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static NSProgress _DeleteItem (INSFileProviderReplicatedExtension This, string identifier, NSFileProviderItemVersion version, NSFileProviderDeleteItemOptions options, NSFileProviderRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			if (identifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (identifier));
			var version__handle__ = version!.GetNonNullHandle (nameof (version));
	...
	internal unsafe sealed class NSFileProviderReplicatedExtensionWrapper : BaseWrapper, INSFileProviderReplicatedExtension {
		...
		[Export ("itemForIdentifier:request:completionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe NSProgress GetItem (string identifier, NSFileProviderRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V78))]global::System.Action<INSFileProviderItem, NSError> completionHandler)
		{
			if (identifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (identifier));
			var request__handle__ = request!.GetNonNullHandle (nameof (request));
		...
		[Export ("deleteItemWithIdentifier:baseVersion:options:request:completionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe NSProgress DeleteItem (string identifier, NSFileProviderItemVersion version, NSFileProviderDeleteItemOptions options, NSFileProviderRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			if (identifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (identifier));
			var version__handle__ = version!.GetNonNullHandle (nameof (version));
