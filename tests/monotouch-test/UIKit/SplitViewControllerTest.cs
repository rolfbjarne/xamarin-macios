	...
	public class SplitViewControllerTest {
		...
		public void Defaults ()
		{
			...
			using (UISplitViewController svc = new UISplitViewController ()) {
				...
				ClassicAssert.AreSame (v1, svc.ViewControllers [0], "vc0");
				ClassicAssert.AreSame (v2, svc.ViewControllers [1], "vc1");

				if (!TestRuntime.CheckXcodeVersion (26, 0)) {
					Assert.That (svc.ChildViewControllers.Length, Is.AtLeast (2), "cvc.Length");
					ClassicAssert.AreSame (v1, svc.ChildViewControllers [0], "cvc0");
					ClassicAssert.AreSame (v2, svc.ChildViewControllers [1], "cvc1");
				}
			}
		}
		...
		public void PresentsWithGesture ()
		{
			...
			using (UISplitViewController svc = new UISplitViewController ()) {
				ClassicAssert.True (svc.PresentsWithGesture, "PresentsWithGesture/default");
			}
		}
	}
}
