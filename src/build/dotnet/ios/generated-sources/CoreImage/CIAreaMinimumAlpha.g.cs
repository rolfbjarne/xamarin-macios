...
namespace CoreImage {
	...
	public partial class CIAreaMinimumAlpha : CIReductionFilter, ICIAreaReductionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIAreaMinimumAlpha" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIAreaMinimumAlpha () : base ("CIAreaMinimumAlpha")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAreaMinimumAlpha (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAreaMinimumAlpha (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAreaMinimumAlpha (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
