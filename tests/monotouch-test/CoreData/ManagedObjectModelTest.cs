...
namespace MonoTouchFixtures.CoreData {
	...
	public class ManagedObjectModelTest {
		...
		void Default (NSManagedObjectModel moc)
		{
			...
			ClassicAssert.Null (moc.LocalizationDictionary, "LocalizationDictionary");
		...
		public void IsConfiguration_Null ()
		{
			using (var moc = new NSManagedObjectModel ()) {
				ClassicAssert.IsFalse (moc.IsConfigurationCompatibleWithStoreMetadata (null, new NSDictionary ()), "IsConfiguration");
				Default (moc);
			}
		}
	}
