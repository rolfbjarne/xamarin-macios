...
namespace Foundation {
	...
	public unsafe partial class NSUserActivity : NSObject, INSItemProviderReading, INSItemProviderWriting {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetContinuationStreams ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity3V6))]global::System.Action<NSInputStream, NSOutputStream, NSError> completionHandler)
		{
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity3V6.CreateBlock (completionHandler);
