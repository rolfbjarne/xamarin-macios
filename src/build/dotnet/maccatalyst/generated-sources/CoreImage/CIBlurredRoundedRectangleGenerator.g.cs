...
namespace CoreImage {
	...
	public partial class CIBlurredRoundedRectangleGenerator : CIFilter, ICIBlurredRoundedRectangleGeneratorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIBlurredRoundedRectangleGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIBlurredRoundedRectangleGenerator () : base ("CIBlurredRoundedRectangleGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBlurredRoundedRectangleGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBlurredRoundedRectangleGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBlurredRoundedRectangleGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIBlurredRoundedRectangleGeneratorProtocol protocol members 
		[SupportedOSPlatform ("ios26.0")]
		[SupportedOSPlatform ("macos26.0")]
		[SupportedOSPlatform ("tvos26.0")]
		[SupportedOSPlatform ("maccatalyst26.0")]
		...
		public float Smoothness {
			[Export ("smoothness")]
			get {
				return GetFloat ("inputSmoothness");
			}
			[Export ("setSmoothness:")]
			set {
				SetFloat ("inputSmoothness", value);
			}
		}
		[SupportedOSPlatform ("ios26.0")]
		[SupportedOSPlatform ("macos26.0")]
		...
		public float Sigma {
			[Export ("sigma")]
			get {
				return GetFloat ("inputSigma");
			}
			[Export ("setSigma:")]
			set {
				SetFloat ("inputSigma", value);
			}
		}
		[SupportedOSPlatform ("ios26.0")]
		[SupportedOSPlatform ("macos26.0")]
