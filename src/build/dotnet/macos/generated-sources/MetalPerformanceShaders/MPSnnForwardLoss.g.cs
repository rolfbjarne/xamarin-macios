...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSnnForwardLoss : MPSCnnKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeBatchToCommandBuffer_SourceImages_Labels_Weights_DestinationStates_DestinationImages_X = "encodeBatchToCommandBuffer:sourceImages:labels:weights:destinationStates:destinationImages:";
		static readonly NativeHandle selEncodeBatchToCommandBuffer_SourceImages_Labels_Weights_DestinationStates_DestinationImages_XHandle = Selector.GetHandle ("encodeBatchToCommandBuffer:sourceImages:labels:weights:destinationStates:destinationImages:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeBatchToCommandBuffer_SourceImages_Labels_Weights_DestinationStates_DestinationStateIsTemporary_X = "encodeBatchToCommandBuffer:sourceImages:labels:weights:destinationStates:destinationStateIsTemporary:";
		static readonly NativeHandle selEncodeBatchToCommandBuffer_SourceImages_Labels_Weights_DestinationStates_DestinationStateIsTemporary_XHandle = Selector.GetHandle ("encodeBatchToCommandBuffer:sourceImages:labels:weights:destinationStates:destinationStateIsTemporary:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual void Encode (global::Metal.IMTLCommandBuffer commandBuffer, MPSImage[] sourceImages, MPSImage[] labels, MPSImage[]? weights, MPSState[]? destinationStates, MPSImage[] destinationImages)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeBatchToCommandBuffer_SourceImages_Labels_Weights_DestinationStates_DestinationImages_XHandle, commandBuffer__handle__, nsa_sourceImages.Handle, nsa_labels.Handle, nsa_weights.GetHandle (), nsa_destinationStates.GetHandle (), nsa_destinationImages.Handle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeBatchToCommandBuffer_SourceImages_Labels_Weights_DestinationStates_DestinationImages_XHandle, commandBuffer__handle__, nsa_sourceImages.Handle, nsa_labels.Handle, nsa_weights.GetHandle (), nsa_destinationStates.GetHandle (), nsa_destinationImages.Handle);
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual MPSImage[] Encode (global::Metal.IMTLCommandBuffer commandBuffer, MPSImage[] sourceImages, MPSImage[] labels, MPSImage[]? weights, out MPSState[]? outStates, bool isTemporary)
		{
			...
			MPSImage[]? ret;
			if (IsDirectBinding) {
				ret = CFArray.ArrayFromHandle<MPSImage>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_ref_NativeHandle_bool (this.Handle, selEncodeBatchToCommandBuffer_SourceImages_Labels_Weights_DestinationStates_DestinationStateIsTemporary_XHandle, commandBuffer__handle__, nsa_sourceImages.Handle, nsa_labels.Handle, nsa_weights.GetHandle (), &outStatesValue, isTemporary ? (byte) 1 : (byte) 0), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFArray.ArrayFromHandle<MPSImage>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_ref_NativeHandle_bool (&__objc_super__, selEncodeBatchToCommandBuffer_SourceImages_Labels_Weights_DestinationStates_DestinationStateIsTemporary_XHandle, commandBuffer__handle__, nsa_sourceImages.Handle, nsa_labels.Handle, nsa_weights.GetHandle (), &outStatesValue, isTemporary ? (byte) 1 : (byte) 0), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
