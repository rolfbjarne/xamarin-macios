...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSMatrixNeuron : MPSMatrixUnaryKernel {
		...
		public virtual void EncodeToCommandBuffer (global::Metal.IMTLCommandBuffer commandBuffer, MPSMatrix inputMatrix, MPSVector? biasVector, MPSMatrix resultMatrix)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("encodeToCommandBuffer:inputMatrix:biasVector:resultMatrix:"), commandBuffer__handle__, inputMatrix__handle__, biasVector__handle__, resultMatrix__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("encodeToCommandBuffer:inputMatrix:biasVector:resultMatrix:"), commandBuffer__handle__, inputMatrix__handle__, biasVector__handle__, resultMatrix__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void SetNeuronToPReLU (NSData parametersA)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setNeuronToPReLUWithParametersA:"), parametersA__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setNeuronToPReLUWithParametersA:"), parametersA__handle__);
					GC.KeepAlive (this);
				}
			}
