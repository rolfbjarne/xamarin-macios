	...
	public class StatusCodeErrorTest {
		...
		public void InvalidStatusCode ()
		{
			...
			if (TestRuntime.CheckXcodeVersion (13, 0, 0)) {
				ClassicAssert.NotNull (s, "MinValue null");
				ClassicAssert.True (s.StartsWith ("Unknown error:"), "MinValue value");
			} else {
				ClassicAssert.Null (s, "MinValue");
			}
		}
	}
}
