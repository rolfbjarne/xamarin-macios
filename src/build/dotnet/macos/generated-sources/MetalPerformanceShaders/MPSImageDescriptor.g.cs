...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSImageDescriptor : NSObject, INSCopying {
		...
		const string selChannelFormatX = "channelFormat";
		static readonly NativeHandle selChannelFormatXHandle = Selector.GetHandle ("channelFormat");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selImageDescriptorWithChannelFormat_Width_Height_FeatureChannels_X = "imageDescriptorWithChannelFormat:width:height:featureChannels:";
		static readonly NativeHandle selImageDescriptorWithChannelFormat_Width_Height_FeatureChannels_XHandle = Selector.GetHandle ("imageDescriptorWithChannelFormat:width:height:featureChannels:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selImageDescriptorWithChannelFormat_Width_Height_FeatureChannels_NumberOfImages_Usage_X = "imageDescriptorWithChannelFormat:width:height:featureChannels:numberOfImages:usage:";
		static readonly NativeHandle selImageDescriptorWithChannelFormat_Width_Height_FeatureChannels_NumberOfImages_Usage_XHandle = Selector.GetHandle ("imageDescriptorWithChannelFormat:width:height:featureChannels:numberOfImages:usage:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetChannelFormat_X = "setChannelFormat:";
		static readonly NativeHandle selSetChannelFormat_XHandle = Selector.GetHandle ("setChannelFormat:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetFeatureChannels_X = "setFeatureChannels:";
		static readonly NativeHandle selSetFeatureChannels_XHandle = Selector.GetHandle ("setFeatureChannels:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetHeight_X = "setHeight:";
		static readonly NativeHandle selSetHeight_XHandle = Selector.GetHandle ("setHeight:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetNumberOfImages_X = "setNumberOfImages:";
		static readonly NativeHandle selSetNumberOfImages_XHandle = Selector.GetHandle ("setNumberOfImages:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MPSImageDescriptor GetImageDescriptor (MPSImageFeatureChannelFormat channelFormat, nuint width, nuint height, nuint featureChannels)
		{
			...
			ret =  Runtime.GetNSObject<MPSImageDescriptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr_UIntPtr_UIntPtr_UIntPtr (class_ptr, selImageDescriptorWithChannelFormat_Width_Height_FeatureChannels_XHandle, (UIntPtr) (ulong) channelFormat, width, height, featureChannels), false)!;
			return ret;
		}
		...
		{
			MPSImageDescriptor ret;
			ret =  Runtime.GetNSObject<MPSImageDescriptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr (class_ptr, selImageDescriptorWithChannelFormat_Width_Height_FeatureChannels_NumberOfImages_Usage_XHandle, (UIntPtr) (ulong) channelFormat, width, height, featureChannels, numberOfImages, (UIntPtr) (ulong) usage), false)!;
			return ret;
		}
		...
		public virtual MPSImageFeatureChannelFormat ChannelFormat {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (MetalPerformanceShaders.MPSImageFeatureChannelFormat) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selChannelFormatXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MetalPerformanceShaders.MPSImageFeatureChannelFormat) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selChannelFormatXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selSetChannelFormat_XHandle, (UIntPtr) (ulong) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selSetChannelFormat_XHandle, (UIntPtr) (ulong) value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual nuint FeatureChannels {
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selSetFeatureChannels_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selSetFeatureChannels_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual nuint NumberOfImages {
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selSetNumberOfImages_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selSetNumberOfImages_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
