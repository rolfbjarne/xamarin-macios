...
namespace AppKit {
	...
	public unsafe partial class NSSliderAccessory : NSObject, INSCoding {
		...
		public static NSSliderAccessory CreateAccessory (NSImage image)
		{
			...
			ret =  Runtime.GetNSObject<NSSliderAccessory> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("accessoryWithImage:"), image__handle__), false)!;
			GC.KeepAlive (image);
			return ret!;
		}
		...
		public virtual NSSliderAccessoryBehavior Behavior {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSSliderAccessoryBehavior> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("behavior")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSSliderAccessoryBehavior> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("behavior")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
