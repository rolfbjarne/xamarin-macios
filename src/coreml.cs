...
namespace CoreML {
	...
	public enum MLModelError : long {
		...
		CustomLayer = 4,
		/// <summary>Gets the error domain for Core ML errors.</summary>
		CustomModel = 5,
		Update = 6,
		Parameters = 7,
	...
	public enum MLComputeUnits : long {
		/// <summary>The model computed the output values.</summary>
		CpuOnly = 0,
		/// <summary>The model is ready for prediction requests.</summary>
		CpuAndGpu = 1,
		/// <summary>The model is not yet ready.</summary>
		All = 2,
	...
	interface MLDictionaryFeatureProvider : MLFeatureProvider, NSSecureCoding {
		...
		/// <param name="dictionary">The feature values dictionary.</param>
	...
	interface MLFeatureDescription : NSCopying, NSSecureCoding {
		...
		/// <returns>A new feature value instance.</returns>
	...
	interface MLFeatureValue : NSCopying, NSSecureCoding {
		...
		/// <returns>A new model description instance.</returns>
		[Static]
	...
	interface MLModel {
		...
		/// <param name="url">The URL to the compiled model.</param>
		/// <param name="configuration">The model configuration.</param>
		/// <param name="error">On return, contains any error that occurred.</param>
		/// <summary>Creates a model from a compiled model URL with the specified configuration.</summary>
		/// <returns>A new model instance, or <see langword="null" /> on failure.</returns>
		[MacCatalyst (13, 1)]
		[Static]
		...
		/// <param name="inputBatch">The batch of inputs.</param>
		/// <param name="options">The prediction options.</param>
		/// <param name="error">On return, contains any error that occurred.</param>
		...
		/// <returns>An array of prediction results.</returns>
		[MacCatalyst (13, 1)]
	...
	interface MLMultiArray : NSSecureCoding {
		...
		/// <param name="shape">The shape of the multi-array.</param>
		/// <param name="dataType">The data type of the multi-array elements.</param>
		/// <param name="error">On return, contains any error that occurred.</param>
		...
		/// <param name="dataPointer">A pointer to the multi-array data.</param>
		/// <param name="shape">The shape of the multi-array.</param>
		/// <param name="dataType">The data type of the multi-array elements.</param>
		/// <param name="strides">The strides for each dimension.</param>
		/// <param name="deallocator">The block to call to deallocate the data.</param>
		/// <param name="error">On return, contains any error that occurred.</param>
		...
		/// <returns>A new multi-array constraint.</returns>
	...
	interface MLCustomLayer {
		...
		/// <returns><see langword="true" /> if the weights were loaded; otherwise, <see langword="false" />.</returns>
		
		[Abstract]
		[Export ("setWeightData:error:")]
		bool SetWeightData (NSData [] weights, [NullAllowed] out NSError error);

		/// <param name="inputShapes">The input shapes to predict for.</param>
		/// <param name="error">On return, contains any error that occurred.</param>
		/// <summary>Retrieves the output data shape, as an array of numbers describing the dimensions of the output tensor.</summary>
		/// <returns>An array of output backing configurations.</returns>
		...
		/// <param name="inputs">The input multi-arrays.</param>
		/// <param name="outputs">The output multi-arrays.</param>
		/// <param name="error">On return, contains any error that occurred.</param>
		...
		/// <param name="commandBuffer">The Metal command buffer to use.</param>
		/// <param name="inputs">The input multi-arrays.</param>
		/// <param name="outputs">The output multi-arrays.</param>
		/// <param name="error">On return, contains any error that occurred.</param>
	...
	interface MLArrayBatchProvider : MLBatchProvider {
		...
		/// <param name="array">The array of feature values.</param>
		/// <summary>Creates a sequence from an array of feature values.</summary>
		
		[Export ("initWithFeatureProviderArray:")]
		NativeHandle Constructor (IMLFeatureProvider [] array);

		/// <param name="dictionary">The dictionary representation of the sequence.</param>
		/// <param name="error">On return, contains any error that occurred.</param>
		/// <summary>Creates a sequence from a dictionary representation.</summary>
	...
	interface MLBatchProvider {
		...
		/// <param name="index">The index of the feature value.</param>
		/// <summary>Gets the <see cref="CoreML.IMLFeatureProvider" /> at <paramref name="index" /> for the current batch.</summary>
		/// <returns>The feature value at the specified index.</returns>
	...
	interface MLCustomModel {
		...
		// [Abstract]
		/// <param name="modelDescription">The description of the model.</param>
		/// <param name="parameters">The model parameters.</param>
		/// <param name="error">On return, contains any error that occurred.</param>
		/// <summary>Creates a custom model with the specified description and parameters.</summary>
		...
		/// <param name="inputFeatures">The input feature values.</param>
		/// <param name="options">The prediction options.</param>
		/// <param name="error">On return, contains any error that occurred.</param>
	...
	interface MLSequence : NSSecureCoding {
		...
		/// <param name="type">The parameter key type.</param>
		...
		/// <returns>A new parameter key instance.</returns>
		[Static]
		[Export ("emptySequenceWithType:")]
		MLSequence CreateEmpty (MLFeatureType type);

		/// <param name="stringValues">The allowed string values.</param>
		...
		/// <param name="int64Values">The allowed Int64 values.</param>
	...
	interface MLModelConfiguration : NSCopying, NSSecureCoding {
		...
		/// <summary>Gets or sets the GPU eager mode threshold.</summary>
