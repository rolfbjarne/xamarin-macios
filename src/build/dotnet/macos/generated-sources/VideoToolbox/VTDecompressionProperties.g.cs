...
namespace VideoToolbox {
	...
	public partial class VTDecompressionProperties : DictionaryContainer {
		...
		[SupportedOSPlatform ("macos15.0")]
		public bool? DecoderProducesRawOutput {
			get {
				return  GetBoolValue (VTDecompressionPropertyKey.DecoderProducesRawOutput!);
			}
		}
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos15.0")]
		public bool? RequestRawWOutput {
			get {
				return  GetBoolValue (VTDecompressionPropertyKey.RequestRawWOutput!);
			}
		}
		[SupportedOSPlatform ("ios17.0")]
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("macos14.0")]
		[SupportedOSPlatform ("maccatalyst17.0")]
		public NSNumber[]? RequestedMvHevcVideoLayerIds {
			get {
				return GetArray<NSNumber> (VTDecompressionPropertyKey.RequestedMvHevcVideoLayerIds!);
			}
		}
#endif
	}
