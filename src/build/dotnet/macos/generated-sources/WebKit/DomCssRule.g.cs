...
namespace WebKit {
	...
	public unsafe partial class DomCssRule : DomObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("DOMCSSRule");
		...
		protected DomCssRule (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal DomCssRule (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual DomCssStyleSheet ParentStyleSheet {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<DomCssStyleSheet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selParentStyleSheetXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<DomCssStyleSheet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selParentStyleSheetXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual DomCssRuleType Type {
			...
			get {
				DomCssRuleType ret;
				if (IsDirectBinding) {
					ret = (DomCssRuleType) global::ObjCRuntime.Messaging.UInt16_objc_msgSend (this.Handle, selTypeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (DomCssRuleType) global::ObjCRuntime.Messaging.UInt16_objc_msgSendSuper (&__objc_super__, selTypeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
