...
namespace MonoTouchFixtures.HealthKit {
	...
	public class HKHealthStoreTest {
		...
		public void GetBiologicalSexNullReturnTest ()
		{
			...
			ClassicAssert.IsNull (ret, "GetBiologicalSex should return a null value if biological sex is not set.");
		}
		...
		public void GetBloodTypeNullReturnTest ()
		{
			...
			ClassicAssert.IsNull (ret, "GetBloodType should return a null value if blood type is not set.");
		}
	}
}
#endif // HAS_HEALTHKIT
