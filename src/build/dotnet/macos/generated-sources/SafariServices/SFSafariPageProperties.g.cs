...
namespace SafariServices {
	...
	public unsafe partial class SFSafariPageProperties : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selUsesPrivateBrowsingX = "usesPrivateBrowsing";
		static readonly NativeHandle selUsesPrivateBrowsingXHandle = Selector.GetHandle ("usesPrivateBrowsing");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("SFSafariPageProperties");
		...
		/// <summary>Creates a new <see cref="SFSafariPageProperties" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public SFSafariPageProperties () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected SFSafariPageProperties (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal SFSafariPageProperties (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual bool UsesPrivateBrowsing {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selUsesPrivateBrowsingXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selUsesPrivateBrowsingXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
