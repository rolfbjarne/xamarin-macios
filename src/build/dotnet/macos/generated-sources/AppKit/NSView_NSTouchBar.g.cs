...
namespace AppKit {
	...
	public unsafe static partial class NSView_NSTouchBar  {
		...
		/// <param name="This">The instance on which this method operates.</param><param name="touchTypes">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[Export ("setAllowedTouchTypes:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void SetAllowedTouchTypes (this NSView This, NSTouchTypeMask touchTypes)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (This.Handle, selSetAllowedTouchTypes_XHandle, (UIntPtr) (ulong) touchTypes);
			GC.KeepAlive (This);
		}
	} /* class NSView_NSTouchBar */
}
