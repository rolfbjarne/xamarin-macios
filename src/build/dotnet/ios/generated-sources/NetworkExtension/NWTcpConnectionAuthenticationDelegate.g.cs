...
namespace NetworkExtension {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ProvideIdentity", Selector = "provideIdentityForConnection:completionHandler:", ParameterType = new Type [] { typeof (NWTcpConnection), typeof (global::System.Action<global::Security.SecIdentity, NSArray>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity2V142) })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "EvaluateTrust", Selector = "evaluateTrustForConnection:peerCertificateChain:completionHandler:", ParameterType = new Type [] { typeof (NWTcpConnection), typeof (NSArray), typeof (global::System.Action<global::Security.SecTrust>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V226) })]
	public partial interface INWTcpConnectionAuthenticationDelegate : INativeObject, IDisposable
	{
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ProvideIdentity (NWTcpConnection connection, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V142))]global::System.Action<global::Security.SecIdentity, NSArray> completion)
		{
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _ProvideIdentity (INWTcpConnectionAuthenticationDelegate This, NWTcpConnection connection, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V142))]global::System.Action<global::Security.SecIdentity, NSArray> completion)
		{
			var connection__handle__ = connection!.GetNonNullHandle (nameof (connection));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
			using var block_completion = Trampolines.SDActionArity2V142.CreateBlock (completion);
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void EvaluateTrust (NWTcpConnection connection, NSArray peerCertificateChain, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V226))]global::System.Action<global::Security.SecTrust> completion)
		{
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _EvaluateTrust (INWTcpConnectionAuthenticationDelegate This, NWTcpConnection connection, NSArray peerCertificateChain, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V226))]global::System.Action<global::Security.SecTrust> completion)
		{
			var connection__handle__ = connection!.GetNonNullHandle (nameof (connection));
			var peerCertificateChain__handle__ = peerCertificateChain!.GetNonNullHandle (nameof (peerCertificateChain));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
			using var block_completion = Trampolines.SDActionArity1V226.CreateBlock (completion);
			BlockLiteral *block_ptr_completion = &block_completion;
	...
	public unsafe static partial class NWTcpConnectionAuthenticationDelegate_Extensions {
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void ProvideIdentity (this INWTcpConnectionAuthenticationDelegate This, NWTcpConnection connection, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V142))]global::System.Action<global::Security.SecIdentity, NSArray> completion)
		{
			var connection__handle__ = connection!.GetNonNullHandle (nameof (connection));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void EvaluateTrust (this INWTcpConnectionAuthenticationDelegate This, NWTcpConnection connection, NSArray peerCertificateChain, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V226))]global::System.Action<global::Security.SecTrust> completion)
		{
			var connection__handle__ = connection!.GetNonNullHandle (nameof (connection));
			var peerCertificateChain__handle__ = peerCertificateChain!.GetNonNullHandle (nameof (peerCertificateChain));
			if (completion is null)
...
namespace NetworkExtension {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_iOS__NetworkExtension_NWTcpConnectionAuthenticationDelegate", false)]
	[Model]
	[ObsoletedOSPlatform ("ios18.0", "Use 'Security.SecProtocolOptions' instead.")]
	[ObsoletedOSPlatform ("maccatalyst18.0", "Use 'Security.SecProtocolOptions' instead.")]
	[ObsoletedOSPlatform ("macos15.0", "Use 'Security.SecProtocolOptions' instead.")]
