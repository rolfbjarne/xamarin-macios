...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that adjusts tone response in sRGB color space and then maps it to a linear gamma curve.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CISRGBToneCurveToLinear filter with the input image
	/// var srgb_tone_curve2linear = new CISRGBToneCurveToLinear () {
	/// 	Image = flower
	/// };
	/// 
	/// // Get the altered image from the filter
	/// var output = srgb_tone_curve2linear.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/srgb_tone_curve2linear.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CISRGBToneCurveToLinear : CIFilter, ICISrgbToneCurveToLinearProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CISRGBToneCurveToLinear" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CISRGBToneCurveToLinear () : base ("CISRGBToneCurveToLinear")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISRGBToneCurveToLinear (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISRGBToneCurveToLinear (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISRGBToneCurveToLinear (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CISrgbToneCurveToLinearProtocol protocol members 
