...
#nullable enable
namespace MapKit {
	[Register("MKReverseGeocodingRequest", true)]
	[SupportedOSPlatform ("tvos26.0")]
	[SupportedOSPlatform ("macos26.0")]
	[SupportedOSPlatform ("ios26.0")]
	[SupportedOSPlatform ("maccatalyst26.0")]
	public unsafe partial class MKReverseGeocodingRequest : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MKReverseGeocodingRequest");
		...
		protected MKReverseGeocodingRequest (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MKReverseGeocodingRequest (NativeHandle handle) : base (handle)
		{
		}

		[Export ("initWithLocation:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MKReverseGeocodingRequest (global::CoreLocation.CLLocation location)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetMapItems ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMKReverseGeocodingRequestGetMapItemsCompletionHandler))]MKReverseGeocodingRequestGetMapItemsCompletionHandler completionHandler)
		{
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDMKReverseGeocodingRequestGetMapItemsCompletionHandler.CreateBlock (completionHandler);
