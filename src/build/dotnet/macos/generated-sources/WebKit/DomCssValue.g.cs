...
namespace WebKit {
	...
	public unsafe partial class DomCssValue : DomObject {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCssTextX = "cssText";
		static readonly NativeHandle selCssTextXHandle = Selector.GetHandle ("cssText");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCssValueTypeX = "cssValueType";
		static readonly NativeHandle selCssValueTypeXHandle = Selector.GetHandle ("cssValueType");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetCssText_X = "setCssText:";
		static readonly NativeHandle selSetCssText_XHandle = Selector.GetHandle ("setCssText:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("DOMCSSValue");
		...
		protected DomCssValue (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal DomCssValue (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual DomCssValueType Type {
			...
			get {
				DomCssValueType ret;
				if (IsDirectBinding) {
					ret = (DomCssValueType) global::ObjCRuntime.Messaging.UInt16_objc_msgSend (this.Handle, selCssValueTypeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (DomCssValueType) global::ObjCRuntime.Messaging.UInt16_objc_msgSendSuper (&__objc_super__, selCssValueTypeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
