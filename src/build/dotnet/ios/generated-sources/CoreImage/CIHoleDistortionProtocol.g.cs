...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIHoleDistortion</c>.</summary>
	/// <remarks>
	...
	public partial interface ICIHoleDistortionProtocol : INativeObject, IDisposable, 
		CoreImage.ICIFilterProtocol
	{
		[DynamicDependencyAttribute ("InputCenter")]
		[DynamicDependencyAttribute ("InputImage")]
		[DynamicDependencyAttribute ("Radius")]
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIHoleDistortionProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICIHoleDistortionProtocol ()
		{
			GC.KeepAlive (null);
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CIImage _GetInputImage (ICIHoleDistortionProtocol This)
		{
			CIImage ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputImage (ICIHoleDistortionProtocol This, CIImage? value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CGPoint _GetInputCenter (ICIHoleDistortionProtocol This)
		{
			CGPoint ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputCenter (ICIHoleDistortionProtocol This, CGPoint value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static float _GetRadius (ICIHoleDistortionProtocol This)
		{
			float ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetRadius (ICIHoleDistortionProtocol This, float value)
		{
	...
	internal unsafe sealed class CIHoleDistortionProtocolWrapper : BaseWrapper, ICIHoleDistortionProtocol {
		public CIHoleDistortionProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIHoleDistortionProtocolWrapper))]
		static CIHoleDistortionProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets or sets an image to filter.</summary>
