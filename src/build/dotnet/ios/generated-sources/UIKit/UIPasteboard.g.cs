...
namespace UIKit {
	...
	public unsafe partial class UIPasteboard : NSObject {
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DetectPatterns (NSSet<NSString> patterns, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V172))]global::System.Action<NSSet<NSString>, NSError> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DetectPatterns (NSSet<NSString> patterns, NSIndexSet? itemSet, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V173))]global::System.Action<NSSet<NSString>[], NSError> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var patterns__handle__ = patterns!.GetNonNullHandle (nameof (patterns));
			var itemSet__handle__ = itemSet.GetHandle ();
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DetectValues (NSSet<NSString> patterns, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V174))]global::System.Action<NSDictionary<NSString, NSObject>, NSError> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var patterns__handle__ = patterns!.GetNonNullHandle (nameof (patterns));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity2V174.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DetectValues (NSSet<NSString> patterns, NSIndexSet? itemSet, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V175))]global::System.Action<NSDictionary<NSString, NSObject>[], NSError> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var patterns__handle__ = patterns!.GetNonNullHandle (nameof (patterns));
			var itemSet__handle__ = itemSet.GetHandle ();
