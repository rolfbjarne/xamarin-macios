...
namespace AuthenticationServices {
	...
	/// <summary>This interface represents the Objective-C protocol <c>ASAuthorizationPublicKeyCredentialDescriptor</c>.</summary>
	/// <remarks>
		...
		, Foundation.INSSecureCoding
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (ASAuthorizationPublicKeyCredentialDescriptorWrapper))]
	...
	internal unsafe sealed class ASAuthorizationPublicKeyCredentialDescriptorWrapper : BaseWrapper, IASAuthorizationPublicKeyCredentialDescriptor {
		public ASAuthorizationPublicKeyCredentialDescriptorWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (ASAuthorizationPublicKeyCredentialDescriptorWrapper))]
		static ASAuthorizationPublicKeyCredentialDescriptorWrapper ()
		{
			GC.KeepAlive (null);
		}
