...
namespace CryptoTokenKit {
	...
	/// <summary>This interface represents the Objective-C protocol <c>TKTokenDelegate</c>.</summary>
	/// <remarks>
	...
	public partial interface ITKTokenDelegate : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static TKTokenSession? _CreateSession (ITKTokenDelegate This, TKToken token, out NSError? error)
		{
			var token__handle__ = token!.GetNonNullHandle (nameof (token));
			NativeHandle errorValue = IntPtr.Zero;
			TKTokenSession? ret;
			ret =  Runtime.GetNSObject<TKTokenSession> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (This.Handle, Selector.GetHandle ("token:createSessionWithError:"), token__handle__, &errorValue), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (token);
		...
		{
			_TerminateSession (this, token, session);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _TerminateSession (ITKTokenDelegate This, TKToken token, TKTokenSession session)
		{
			var token__handle__ = token!.GetNonNullHandle (nameof (token));
		...
		[DynamicDependencyAttribute ("CreateSession(CryptoTokenKit.TKToken,Foundation.NSError@)")]
		[DynamicDependencyAttribute ("TerminateSession(CryptoTokenKit.TKToken,CryptoTokenKit.TKTokenSession)")]
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (TKTokenDelegateWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ITKTokenDelegate ()
		{
			GC.KeepAlive (null);
		}
	}
	...
	internal unsafe sealed class TKTokenDelegateWrapper : BaseWrapper, ITKTokenDelegate {
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (TKTokenDelegateWrapper))]
		static TKTokenDelegateWrapper ()
		{
			GC.KeepAlive (null);
		}
		[Export ("token:createSessionWithError:")]
...
namespace CryptoTokenKit {
	/// <summary>
	///   <para>This is a class that implements the interface <see cref="ITKTokenDelegate" /> (for the protocol <c>TKTokenDelegate</c>).</para>
	///   <para>Subclass this class to easily create a type that implements the protocol.</para>
	///   <para>An alternative is to create a subclass of <see cref="NSObject" /> and then implemented the interface <see cref="ITKTokenDelegate" />.</para>
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__CryptoTokenKit_TKTokenDelegate", false)]
	[Model]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("maccatalyst")]
