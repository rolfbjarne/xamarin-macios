...
namespace UIKit {
	...
	public unsafe partial class UIPasteControlConfiguration : NSObject, INSCoding, INSSecureCoding {
		...
		/// <summary>Creates a new <see cref="UIPasteControlConfiguration" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual UIPasteControlDisplayMode DisplayMode {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (UIPasteControlDisplayMode) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("displayMode"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
			}
			[Export ("setDisplayMode:", ArgumentSemantic.Assign)]
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
