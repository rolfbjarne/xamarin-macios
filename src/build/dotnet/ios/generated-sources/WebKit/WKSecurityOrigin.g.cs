...
#nullable enable
namespace WebKit {
	/// <summary>Describes the hostname, protocol, and port number for a security origin.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/WebKit/Reference/WKSecurityOrigin_Class_Ref/index.html">Apple documentation for <c>WKSecurityOrigin</c></related>
	[Register("WKSecurityOrigin", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	public unsafe partial class WKSecurityOrigin : NSObject {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("WKSecurityOrigin");
		...
		protected WKSecurityOrigin (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal WKSecurityOrigin (NativeHandle handle) : base (handle)
		{
		}
