...
namespace CoreImage {
	...
	public partial class CIColorThreshold : CIFilter, ICIColorThresholdProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorThreshold" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorThreshold (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorThreshold (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorThreshold (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
