...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CICheckerboardGenerator</c>.</summary>
	/// <remarks>
	...
	[Protocol (Name = "CICheckerboardGenerator", WrapperType = typeof (CICheckerboardGeneratorProtocolWrapper))]
		...
		CoreImage.ICIFilterProtocol
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CICheckerboardGeneratorProtocolWrapper))]
	...
	internal unsafe sealed class CICheckerboardGeneratorProtocolWrapper : BaseWrapper, ICICheckerboardGeneratorProtocol {
		public CICheckerboardGeneratorProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CICheckerboardGeneratorProtocolWrapper))]
		static CICheckerboardGeneratorProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets or sets the center of the checkerboard pattern.</summary>
