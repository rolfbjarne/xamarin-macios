...
namespace CoreSpotlight {
	...
	delegate void CSSearchabkeIndexEndIndexHandler ([NullAllowed] NSError error);
	...
	interface CSSearchableIndex_CSOptionalBatchingExtension {
		...
		void EndIndexBatch ([NullAllowed] NSData expectedClientState, NSData newClientState, [NullAllowed] CSSearchabkeIndexEndIndexHandler completionHandler);
	}
	...
	interface CSUserQuery {
		...
		[Mac (15, 0), iOS (18, 0), MacCatalyst (18, 0)]
		[Export ("userEngagedWithSuggestion:visibleItems:userInteractionType:")]
