...
namespace AVFoundation {
	...
	public unsafe partial class AVCaptureOutput : NSObject {
		...
		const string selConnectionWithMediaType_X = "connectionWithMediaType:";
		static readonly NativeHandle selConnectionWithMediaType_XHandle = Selector.GetHandle ("connectionWithMediaType:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTransformedMetadataObjectForMetadataObject_Connection_X = "transformedMetadataObjectForMetadataObject:connection:";
		static readonly NativeHandle selTransformedMetadataObjectForMetadataObject_Connection_XHandle = Selector.GetHandle ("transformedMetadataObjectForMetadataObject:connection:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual AVCaptureConnection? ConnectionFromMediaType (NSString avMediaType)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<AVCaptureConnection> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selConnectionWithMediaType_XHandle, avMediaType__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<AVCaptureConnection> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selConnectionWithMediaType_XHandle, avMediaType__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual CGRect GetMetadataOutputRectOfInterestForRect (CGRect rectInOutputCoordinates)
		{
			...
			if (IsDirectBinding) {
				if (global::ObjCRuntime.Runtime.IsARM64CallingConvention) {
					ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSend_CGRect (this.Handle, selMetadataOutputRectOfInterestForRect_XHandle, rectInOutputCoordinates);
				} else {
					ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSend_stret_CGRect (this.Handle, selMetadataOutputRectOfInterestForRect_XHandle, rectInOutputCoordinates);
				}
			} else {
				if (global::ObjCRuntime.Runtime.IsARM64CallingConvention) {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSendSuper_CGRect (&__objc_super__, selMetadataOutputRectOfInterestForRect_XHandle, rectInOutputCoordinates);
						GC.KeepAlive (this);
					}
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSendSuper_stret_CGRect (&__objc_super__, selMetadataOutputRectOfInterestForRect_XHandle, rectInOutputCoordinates);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual AVMetadataObject? GetTransformedMetadataObject (AVMetadataObject metadataObject, AVCaptureConnection connection)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<AVMetadataObject> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selTransformedMetadataObjectForMetadataObject_Connection_XHandle, metadataObject__handle__, connection__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<AVMetadataObject> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selTransformedMetadataObjectForMetadataObject_Connection_XHandle, metadataObject__handle__, connection__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
