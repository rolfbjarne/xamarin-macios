...
#nullable enable
namespace CoreImage {
	/// <summary>The CIMultiplyBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 
	/// // Construct the MultiplyBlend filter
	...
	/// var output = multiBlend.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/MultiplyBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIMultiplyBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIMultiplyBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMultiplyBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMultiplyBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMultiplyBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
