...
namespace Photos {
	...
	public unsafe partial class PHPersistentChangeFetchResult : NSObject {
		...
		public unsafe virtual void EnumerateChanges ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDPHPersistentChangeFetchResultEnumerator))]PHPersistentChangeFetchResultEnumerator block)
		{
			...
			using var block_block = Trampolines.SDPHPersistentChangeFetchResultEnumerator.CreateBlock (block);
			...
			if (IsDirectBinding) {
				...
				unsafe {
					...
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("enumerateChangesWithBlock:"), (IntPtr) block_ptr_block);
					GC.KeepAlive (this);
				}
			}
		}
