...
namespace CoreImage {
	...
	public partial class CIRowAverage : CIFilter, ICIRowAverageProtocol, ICIAreaReductionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIRowAverage" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIRowAverage () : base ("CIRowAverage")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIRowAverage (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIRowAverage (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIRowAverage (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
