...
namespace BackgroundAssets {
	...
	public unsafe partial class BADownload : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		const string selCopyAsNonEssentialX = "copyAsNonEssential";
		static readonly NativeHandle selCopyAsNonEssentialXHandle = Selector.GetHandle ("copyAsNonEssential");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selIsEssentialX = "isEssential";
		static readonly NativeHandle selIsEssentialXHandle = Selector.GetHandle ("isEssential");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual BADownload CopyAsNonEssential ()
		{
			BADownload? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<BADownload> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selCopyAsNonEssentialXHandle), true)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<BADownload> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selCopyAsNonEssentialXHandle), true)!;
					GC.KeepAlive (this);
				}
			}
			return ret!;
		...
		public virtual bool IsEssential {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selIsEssentialXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selIsEssentialXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual BADownloadState State {
			...
			get {
				BADownloadState ret;
				if (IsDirectBinding) {
					ret = (BackgroundAssets.BADownloadState) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selStateXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (BackgroundAssets.BADownloadState) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selStateXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
