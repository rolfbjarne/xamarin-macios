	...
	public unsafe partial class INHangUpCallIntentResponse : INIntentResponse {
		...
		public virtual INHangUpCallIntentResponseCode Code {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (Intents.INHangUpCallIntentResponseCode) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selCodeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (Intents.INHangUpCallIntentResponseCode) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selCodeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
