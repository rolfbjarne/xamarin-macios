...
namespace MetalPerformanceShadersGraph {
	...
	public unsafe static partial class MPSGraph_CallOp  {
		...
		const string selCallSymbolName_InputTensors_OutputTypes_Name_X = "callSymbolName:inputTensors:outputTypes:name:";
		static readonly NativeHandle selCallSymbolName_InputTensors_OutputTypes_Name_XHandle = Selector.GetHandle ("callSymbolName:inputTensors:outputTypes:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MPSGraphTensor[] Call (this MPSGraph This, string symbolName, MPSGraphTensor[] inputTensors, MPSGraphType[] outputTypes, string? name)
		{
			...
			MPSGraphTensor[]? ret;
			ret = CFArray.ArrayFromHandle<MPSGraphTensor>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (This.Handle, selCallSymbolName_InputTensors_OutputTypes_Name_XHandle, nssymbolName, nsa_inputTensors.Handle, nsa_outputTypes.Handle, nsname), false)!;
			GC.KeepAlive (This);
