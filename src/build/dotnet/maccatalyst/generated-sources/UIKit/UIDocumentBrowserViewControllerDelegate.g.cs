...
namespace UIKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidRequestDocumentCreation", Selector = "documentBrowser:didRequestDocumentCreationWithHandler:", ParameterType = new Type [] { typeof (UIDocumentBrowserViewController), typeof (global::System.Action<NSUrl, global::UIKit.UIDocumentBrowserImportMode>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity2V164) })]
	...
	public partial interface IUIDocumentBrowserViewControllerDelegate : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DidRequestDocumentCreation (UIDocumentBrowserViewController controller, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V164))]global::System.Action<NSUrl, UIDocumentBrowserImportMode> importHandler)
		{
			_DidRequestDocumentCreation (this, controller, importHandler);
		}
		/// <param name="controller">The controller that made the request.</param><param name="importHandler">The handler to run after the document is created.</param><summary>Developers may implement this method to respond to a request to create a new document.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _DidRequestDocumentCreation (IUIDocumentBrowserViewControllerDelegate This, UIDocumentBrowserViewController controller, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V164))]global::System.Action<NSUrl, UIDocumentBrowserImportMode> importHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var controller__handle__ = controller!.GetNonNullHandle (nameof (controller));
			if (importHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (importHandler));
			using var block_importHandler = Trampolines.SDActionArity2V164.CreateBlock (importHandler);
	...
	public unsafe static partial class UIDocumentBrowserViewControllerDelegate_Extensions {
		...
		/// <param name="controller">The controller that made the request.</param><param name="importHandler">The handler to run after the document is created.</param><summary>Developers may implement this method to respond to a request to create a new document.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void DidRequestDocumentCreation (this IUIDocumentBrowserViewControllerDelegate This, UIDocumentBrowserViewController controller, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V164))]global::System.Action<NSUrl, UIDocumentBrowserImportMode> importHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var controller__handle__ = controller!.GetNonNullHandle (nameof (controller));
			if (importHandler is null)
...
namespace UIKit {
	/// <summary>Handles user interactions with a document browser.</summary>
	[Protocol()]
	[Register("Microsoft_MacCatalyst__UIKit_UIDocumentBrowserViewControllerDelegate", false)]
	[Model]
	[UnsupportedOSPlatform ("tvos")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
