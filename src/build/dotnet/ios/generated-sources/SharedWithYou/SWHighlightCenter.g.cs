...
namespace SharedWithYou {
	...
	public unsafe partial class SWHighlightCenter : NSObject {
		...
		[SupportedOSPlatform ("macos13.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetCollaborationHighlight (NSUrl url, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V157))]global::System.Action<SWCollaborationHighlight, NSError> completionHandler)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetHighlight (NSUrl urL, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V158))]global::System.Action<SWHighlight, NSError> completionHandler)
		{
			var urL__handle__ = urL!.GetNonNullHandle (nameof (urL));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity2V158.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
		...
		[SupportedOSPlatform ("macos13.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetSignedIdentityProof (SWCollaborationHighlight collaborationHighlight, NSData data, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V159))]global::System.Action<global::SharedWithYouCore.SWSignedPersonIdentityProof, NSError> completionHandler)
		{
