...
namespace CoreML {
	...
	public unsafe partial class MLModel : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void CompileModel (NSUrl modelUrl, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V59))]global::System.Action<NSUrl, NSError> handler)
		{
			var modelUrl__handle__ = modelUrl!.GetNonNullHandle (nameof (modelUrl));
			if (handler is null)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetPrediction (IMLFeatureProvider input, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V60))]global::System.Action<IMLFeatureProvider, NSError> completionHandler)
		{
			var input__handle__ = input!.GetNonNullHandle (nameof (input));
		...
		[SupportedOSPlatform ("maccatalyst17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetPrediction (IMLFeatureProvider input, MLPredictionOptions options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V60))]global::System.Action<IMLFeatureProvider, NSError> completionHandler)
		{
			var input__handle__ = input!.GetNonNullHandle (nameof (input));
			var options__handle__ = options!.GetNonNullHandle (nameof (options));
			if (completionHandler is null)
