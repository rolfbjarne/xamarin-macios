...
namespace CloudKit {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "SyncEngine", Selector = "syncEngine:handleEvent:", ParameterType = new Type [] { typeof (CKSyncEngine), typeof (CKSyncEngineEvent) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "SyncEngine", Selector = "syncEngine:nextRecordZoneChangeBatchForContext:", ReturnType = typeof (CKSyncEngineRecordZoneChangeBatch), ParameterType = new Type [] { typeof (CKSyncEngine), typeof (CKSyncEngineSendChangesContext) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "SyncEngine", Selector = "syncEngine:nextFetchChangesOptionsForContext:", ReturnType = typeof (CKSyncEngineFetchChangesOptions), ParameterType = new Type [] { typeof (CKSyncEngine), typeof (CKSyncEngineFetchChangesContext) }, ParameterByRef = new bool [] { false, false })]
...
namespace CloudKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_MacCatalyst__CloudKit_CKSyncEngineDelegate", false)]
	[Model]
	[SupportedOSPlatform ("tvos17.0")]
	[SupportedOSPlatform ("macos14.0")]
	[SupportedOSPlatform ("ios17.0")]
