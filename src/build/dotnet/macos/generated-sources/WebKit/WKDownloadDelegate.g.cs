...
namespace WebKit {
	...
	public partial interface IWKDownloadDelegate : INativeObject, IDisposable
	{
		...
		public unsafe virtual void DecideDestination (WKDownload download, NSUrlResponse response, string suggestedFilename, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V49))]global::System.Action<NSUrl> completionHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _DecideDestination (IWKDownloadDelegate This, WKDownload download, NSUrlResponse response, string suggestedFilename, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V49))]global::System.Action<NSUrl> completionHandler)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void WillPerformHttpRedirection (WKDownload download, NSHttpUrlResponse response, NSUrlRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V127))]global::System.Action<WKDownloadRedirectPolicy> decisionHandler)
		{
			_WillPerformHttpRedirection (this, download, response, request, decisionHandler);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _WillPerformHttpRedirection (IWKDownloadDelegate This, WKDownload download, NSHttpUrlResponse response, NSUrlRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V127))]global::System.Action<WKDownloadRedirectPolicy> decisionHandler)
		{
			var download__handle__ = download!.GetNonNullHandle (nameof (download));
			var response__handle__ = response!.GetNonNullHandle (nameof (response));
	...
	public unsafe static partial class WKDownloadDelegate_Extensions {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void WillPerformHttpRedirection (this IWKDownloadDelegate This, WKDownload download, NSHttpUrlResponse response, NSUrlRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V127))]global::System.Action<WKDownloadRedirectPolicy> decisionHandler)
		{
			var download__handle__ = download!.GetNonNullHandle (nameof (download));
			var response__handle__ = response!.GetNonNullHandle (nameof (response));
			var request__handle__ = request!.GetNonNullHandle (nameof (request));
	...
	internal unsafe sealed class WKDownloadDelegateWrapper : BaseWrapper, IWKDownloadDelegate {
		...
		[Export ("download:decideDestinationUsingResponse:suggestedFilename:completionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void DecideDestination (WKDownload download, NSUrlResponse response, string suggestedFilename, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V49))]global::System.Action<NSUrl> completionHandler)
		{
			var download__handle__ = download!.GetNonNullHandle (nameof (download));
			var response__handle__ = response!.GetNonNullHandle (nameof (response));
			if (suggestedFilename is null)
...
namespace WebKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__WebKit_WKDownloadDelegate", false)]
	[Model]
	[SupportedOSPlatform ("ios14.5")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
