...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSCnnConvolutionNode : MPSNNFilterNode, IMPSNNTrainableNode {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithSource:weights:"), sourceNode__handle__, weights__handle__), "initWithSource:weights:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithSource:weights:"), sourceNode__handle__, weights__handle__), "initWithSource:weights:");
					GC.KeepAlive (this);
				}
			}
		...
		public static MPSCnnConvolutionNode Create (MPSNNImageNode sourceNode, IMPSCnnConvolutionDataSource weights)
		{
			...
			ret =  Runtime.GetNSObject<MPSCnnConvolutionNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("nodeWithSource:weights:"), sourceNode__handle__, weights__handle__), false)!;
			GC.KeepAlive (sourceNode);
			GC.KeepAlive (weights);
			return ret!;
		}
		...
		public virtual MPSNNConvolutionAccumulatorPrecisionOption AccumulatorPrecision {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (MetalPerformanceShaders.MPSNNConvolutionAccumulatorPrecisionOption) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("accumulatorPrecision"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MetalPerformanceShaders.MPSNNConvolutionAccumulatorPrecisionOption) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("accumulatorPrecision"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, Selector.GetHandle ("setAccumulatorPrecision:"), (UIntPtr) (ulong) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, Selector.GetHandle ("setAccumulatorPrecision:"), (UIntPtr) (ulong) value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual MPSCnnConvolutionGradientStateNode? ConvolutionGradientState {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<MPSCnnConvolutionGradientStateNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("convolutionGradientState")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<MPSCnnConvolutionGradientStateNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("convolutionGradientState")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
