	...
	public class SecureTransportTest {
		...
		public void StreamDefaults ()
		{
			using (var ssl = new SslContext (SslProtocolSide.Client, SslConnectionType.Stream)) {
				...
				ClassicAssert.Null (ssl.Connection, "Connection");
				...
				ClassicAssert.Null (ssl.PeerId, "PeerId");
				...
				ClassicAssert.Null (ssl.PeerTrust, "PeerTrust");
				...
				// ClassicAssert.Null (ssl.GetDistinguishedNames<string> (), "GetDistinguishedNames");
