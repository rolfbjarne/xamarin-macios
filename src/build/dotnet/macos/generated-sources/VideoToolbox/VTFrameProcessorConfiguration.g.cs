...
namespace VideoToolbox {
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = true, Name = "ProcessorSupported", Selector = "processorSupported", PropertyType = typeof (bool), GetterSelector = "processorSupported", ArgumentSemantic = ArgumentSemantic.None)]
	...
	public partial interface IVTFrameProcessorConfiguration : INativeObject, IDisposable
	{
		...
		[global::Foundation.RequiredMember]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static bool GetProcessorSupported<T> () where T: NSObject, IVTFrameProcessorConfiguration
		{
			var class_ptr = Class.GetHandle (typeof (T));
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (class_ptr, Selector.GetHandle ("processorSupported"));
			return ret != 0;
		}
		[global::Foundation.OptionalMember]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
