...
#nullable enable
namespace CoreImage {
	/// <summary>The CIWhitePointAdjust CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create a CIImage from a file.
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Construct the WhitePointAdjust filter
	...
	/// var output = whitePointAdjust.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/WhitePointAdjust.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIWhitePointAdjust : CIFilter, ICIWhitePointAdjustProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIWhitePointAdjust" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIWhitePointAdjust () : base ("CIWhitePointAdjust")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIWhitePointAdjust (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIWhitePointAdjust (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIWhitePointAdjust (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIWhitePointAdjustProtocol protocol members 
