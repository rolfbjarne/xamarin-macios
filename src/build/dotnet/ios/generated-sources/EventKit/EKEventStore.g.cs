...
namespace EventKit {
	...
	public unsafe partial class EKEventStore : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual nint FetchReminders (NSPredicate predicate, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V59))]global::System.Action<EKReminder[]> completion)
		{
			var predicate__handle__ = predicate!.GetNonNullHandle (nameof (predicate));
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RequestAccess (EKEntityType entityType, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V0))]global::System.Action<bool, NSError> completionHandler)
		{
