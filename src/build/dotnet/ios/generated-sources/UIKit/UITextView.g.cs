...
namespace UIKit {
	...
	public unsafe partial class UITextView : UIScrollView, INSCoding, IUIContentSizeCategoryAdjusting, IUIKeyInput, IUILetterformAwareAdjusting, IUIPasteConfigurationSupporting, IUITextDraggable, IUITextDroppable, IUITextInput, IUITextInputTraits, IUITextPasteConfigurationSupporting {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void InsertInputSuggestion (UIInputSuggestion inputSuggestion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var inputSuggestion__handle__ = inputSuggestion!.GetNonNullHandle (nameof (inputSuggestion));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("insertInputSuggestion:"), inputSuggestion__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("insertInputSuggestion:"), inputSuggestion__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("ios18.0")]
		public virtual UITextFormattingViewControllerConfiguration? TextFormattingConfiguration {
			[Export ("textFormattingConfiguration", ArgumentSemantic.Copy)]
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				UITextFormattingViewControllerConfiguration? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<UITextFormattingViewControllerConfiguration> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("textFormattingConfiguration")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<UITextFormattingViewControllerConfiguration> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("textFormattingConfiguration")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			}
			[Export ("setTextFormattingConfiguration:", ArgumentSemantic.Copy)]
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				var value__handle__ = value.GetHandle ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setTextFormattingConfiguration:"), value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setTextFormattingConfiguration:"), value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
		...
		internal class _UITextViewDelegate : _UIScrollViewDelegate, IUITextViewDelegate { 
			...
			internal EventHandler<UITextViewTextFormattingViewControllerEventArgs>? didBeginFormatting;
			...
			{
				var handler = didBeginFormatting;
				if (handler is not null){
					var args = new UITextViewTextFormattingViewControllerEventArgs (viewController);
					handler (textView, args);
				}
			}
			internal EventHandler<UITextViewTextFormattingViewControllerEventArgs>? didEndFormatting;
			...
			internal EventHandler<UITextViewTextFormattingViewControllerEventArgs>? willBeginFormatting;
			...
			{
				var handler = willBeginFormatting;
				if (handler is not null){
					var args = new UITextViewTextFormattingViewControllerEventArgs (viewController);
					handler (textView, args);
				}
			}
			internal EventHandler<UITextViewTextFormattingViewControllerEventArgs>? willEndFormatting;
		...
		public event EventHandler<UITextViewTextFormattingViewControllerEventArgs> DidBeginFormatting {
			add { EnsureUITextViewDelegate ()!.didBeginFormatting += value; }
			remove { EnsureUITextViewDelegate ()!.didBeginFormatting -= value; }
		}
		public event EventHandler<UITextViewTextFormattingViewControllerEventArgs> DidEndFormatting {
			add { EnsureUITextViewDelegate ()!.didEndFormatting += value; }
			remove { EnsureUITextViewDelegate ()!.didEndFormatting -= value; }
		}
		...
		public event EventHandler<UITextViewTextFormattingViewControllerEventArgs> WillBeginFormatting {
			add { EnsureUITextViewDelegate ()!.willBeginFormatting += value; }
			remove { EnsureUITextViewDelegate ()!.willBeginFormatting -= value; }
		}
		public event EventHandler<UITextViewTextFormattingViewControllerEventArgs> WillEndFormatting {
			add { EnsureUITextViewDelegate ()!.willEndFormatting += value; }
			remove { EnsureUITextViewDelegate ()!.willEndFormatting -= value; }
		}
	...
	public partial class UITextViewTextFormattingViewControllerEventArgs : EventArgs {
		/// <summary>Create a new instance of the <see cref="UITextViewTextFormattingViewControllerEventArgs" /> with the specified event data.</summary>
