...
namespace CoreImage {
	...
	public partial class CIToneMapHeadroom : CIFilter, ICIToneMapHeadroomProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIToneMapHeadroom" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIToneMapHeadroom () : base ("CIToneMapHeadroom")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIToneMapHeadroom (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIToneMapHeadroom (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIToneMapHeadroom (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIToneMapHeadroomProtocol protocol members 
		...
		public float SourceHeadroom {
			...
			get {
				return GetFloat ("inputSourceHeadroom");
			}
			[Export ("setSourceHeadroom:")]
			set {
				SetFloat ("inputSourceHeadroom", value);
			}
		}
		[SupportedOSPlatform ("ios18.0")]
		[SupportedOSPlatform ("macos15.0")]
		...
		public float TargetHeadroom {
			...
			get {
				return GetFloat ("inputTargetHeadroom");
			}
			[Export ("setTargetHeadroom:")]
			set {
				SetFloat ("inputTargetHeadroom", value);
			}
		}
