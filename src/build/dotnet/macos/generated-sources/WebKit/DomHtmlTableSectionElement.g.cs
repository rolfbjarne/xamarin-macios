...
namespace WebKit {
	...
	public unsafe partial class DomHtmlTableSectionElement : DomHtmlElement {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("DOMHTMLTableSectionElement");
		...
		protected DomHtmlTableSectionElement (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal DomHtmlTableSectionElement (NativeHandle handle) : base (handle)
		{
		}
