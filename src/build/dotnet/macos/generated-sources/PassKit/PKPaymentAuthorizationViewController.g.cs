...
namespace PassKit {
	...
	public unsafe partial class PKPaymentAuthorizationViewController : global::AppKit.NSViewController {
		...
		public static bool CanMakePaymentsUsingNetworks (NSString[] paymentNetworks)
		{
			...
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (class_ptr, selCanMakePaymentsUsingNetworks_XHandle, nsa_paymentNetworks.Handle);
			return ret != 0;
		}
