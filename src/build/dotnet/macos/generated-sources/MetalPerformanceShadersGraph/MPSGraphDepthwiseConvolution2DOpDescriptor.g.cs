...
namespace MetalPerformanceShadersGraph {
	...
	public unsafe partial class MPSGraphDepthwiseConvolution2DOpDescriptor : MPSGraphObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDescriptorWithDataLayout_WeightsLayout_X = "descriptorWithDataLayout:weightsLayout:";
		static readonly NativeHandle selDescriptorWithDataLayout_WeightsLayout_XHandle = Selector.GetHandle ("descriptorWithDataLayout:weightsLayout:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDescriptorWithStrideInX_StrideInY_DilationRateInX_DilationRateInY_PaddingLeft_PaddingRight_PaddingTop_PaddingBottom_PaddingStyle_DataLayout_WeightsLayout_X = "descriptorWithStrideInX:strideInY:dilationRateInX:dilationRateInY:paddingLeft:paddingRight:paddingTop:paddingBottom:paddingStyle:dataLayout:weightsLayout:";
		static readonly NativeHandle selDescriptorWithStrideInX_StrideInY_DilationRateInX_DilationRateInY_PaddingLeft_PaddingRight_PaddingTop_PaddingBottom_PaddingStyle_DataLayout_WeightsLayout_XHandle = Selector.GetHandle ("descriptorWithStrideInX:strideInY:dilationRateInX:dilationRateInY:paddingLeft:paddingRight:paddingTop:paddingBottom:paddingStyle:dataLayout:weightsLayout:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MPSGraphDepthwiseConvolution2DOpDescriptor? Create (nuint strideInX, nuint strideInY, nuint dilationRateInX, nuint dilationRateInY, nuint paddingLeft, nuint paddingRight, nuint paddingTop, nuint paddingBottom, MPSGraphPaddingStyle paddingStyle, MPSGraphTensorNamedDataLayout dataLayout, MPSGraphTensorNamedDataLayout weightsLayout)
		{
			...
			ret =  Runtime.GetNSObject<MPSGraphDepthwiseConvolution2DOpDescriptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr (class_ptr, selDescriptorWithStrideInX_StrideInY_DilationRateInX_DilationRateInY_PaddingLeft_PaddingRight_PaddingTop_PaddingBottom_PaddingStyle_DataLayout_WeightsLayout_XHandle, strideInX, strideInY, dilationRateInX, dilationRateInY, paddingLeft, paddingRight, paddingTop, paddingBottom, (UIntPtr) (ulong) paddingStyle, (UIntPtr) (ulong) dataLayout, (UIntPtr) (ulong) weightsLayout), false)!;
			return ret;
		}
		...
		{
			MPSGraphDepthwiseConvolution2DOpDescriptor ret;
			ret =  Runtime.GetNSObject<MPSGraphDepthwiseConvolution2DOpDescriptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr_UIntPtr (class_ptr, selDescriptorWithDataLayout_WeightsLayout_XHandle, (UIntPtr) (ulong) dataLayout, (UIntPtr) (ulong) weightsLayout), false)!;
			return ret;
		}
