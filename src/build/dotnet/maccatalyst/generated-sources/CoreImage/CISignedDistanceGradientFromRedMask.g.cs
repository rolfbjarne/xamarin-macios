...
namespace CoreImage {
	...
	public partial class CISignedDistanceGradientFromRedMask : CIFilter, ICISignedDistanceGradientFromRedMaskProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CISignedDistanceGradientFromRedMask" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CISignedDistanceGradientFromRedMask () : base ("CISignedDistanceGradientFromRedMask")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISignedDistanceGradientFromRedMask (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISignedDistanceGradientFromRedMask (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISignedDistanceGradientFromRedMask (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CISignedDistanceGradientFromRedMaskProtocol protocol members 
		...
		public float MaximumDistance {
			...
			get {
				return GetFloat ("inputMaximumDistance");
			}
			[Export ("setMaximumDistance:")]
			set {
				SetFloat ("inputMaximumDistance", value);
			}
		}
