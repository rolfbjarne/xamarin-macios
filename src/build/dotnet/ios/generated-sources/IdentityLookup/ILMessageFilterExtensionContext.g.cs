...
namespace IdentityLookup {
	...
	public unsafe partial class ILMessageFilterExtensionContext : NSExtensionContext {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("ILMessageFilterExtensionContext");
		...
		protected ILMessageFilterExtensionContext (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal ILMessageFilterExtensionContext (NativeHandle handle) : base (handle)
		{
		}

		[Export ("deferQueryRequestToNetworkWithCompletion:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DeferQueryRequestToNetwork ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V121))]global::System.Action<ILNetworkResponse, NSError> completion)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					...
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("deferQueryRequestToNetworkWithCompletion:"), (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
		}
		...
		///         </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual Task<ILNetworkResponse> DeferQueryRequestToNetworkAsync ()
		{
			var tcs = new TaskCompletionSource<ILNetworkResponse> ();
			DeferQueryRequestToNetwork((arg1_, arg2_) => {
