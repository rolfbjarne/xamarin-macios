...
namespace WebKit {
	...
	public unsafe partial class DomHtmlOptGroupElement : DomHtmlElement {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("DOMHTMLOptGroupElement");
		...
		protected DomHtmlOptGroupElement (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal DomHtmlOptGroupElement (NativeHandle handle) : base (handle)
		{
		}
