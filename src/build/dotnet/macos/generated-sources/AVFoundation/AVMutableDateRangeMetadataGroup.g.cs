...
namespace AVFoundation {
	...
	public unsafe partial class AVMutableDateRangeMetadataGroup : AVDateRangeMetadataGroup {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetItems_X = "setItems:";
		static readonly NativeHandle selSetItems_XHandle = Selector.GetHandle ("setItems:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public override AVMetadataItem[] Items {
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetItems_XHandle, nsa_value.Handle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetItems_XHandle, nsa_value.Handle);
						GC.KeepAlive (this);
					}
				}
			}
