...
namespace UIKit {
	...
	public unsafe partial class NSTextAttachment : NSObject, INSCoding, INSSecureCoding, INSTextAttachmentContainer, INSTextAttachmentLayout, IUIAccessibilityContentSizeCategoryImageAdjusting {
		...
		/// <summary>Creates a new <see cref="T:UIKit.NSTextAttachment" /> with the specified <paramref name="contentData" />.</summary><param name="contentData"><para>To be added.</para><para tool="nullallowed">This parameter can be <see langword="null" />.</para></param><param name="uti"><para>To be added.</para><para tool="nullallowed">This parameter can be <see langword="null" />.</para></param><remarks>To be added.</remarks>
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithData:ofType:"), contentData__handle__, nsuti), "initWithData:ofType:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithData:ofType:"), contentData__handle__, nsuti), "initWithData:ofType:");
					GC.KeepAlive (this);
				}
			}
		...
		public static NSTextAttachment Create (UIImage image)
		{
			...
			ret =  Runtime.GetNSObject<NSTextAttachment> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("textAttachmentWithImage:"), image__handle__), false)!;
			GC.KeepAlive (image);
			return ret!;
		}
		...
		public virtual CGRect GetAttachmentBounds (NSTextContainer? textContainer, CGRect proposedLineFragment, CGPoint glyphPosition, nuint characterIndex)
		{
			...
			if (IsDirectBinding) {
				...
				if (global::ObjCRuntime.Runtime.IsARM64CallingConvention) {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSendSuper_NativeHandle_CGRect_CGPoint_UIntPtr (&__objc_super__, Selector.GetHandle ("attachmentBoundsForTextContainer:proposedLineFragment:glyphPosition:characterIndex:"), textContainer__handle__, proposedLineFragment, glyphPosition, characterIndex);
						GC.KeepAlive (this);
					}
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSendSuper_stret_NativeHandle_CGRect_CGPoint_UIntPtr (&__objc_super__, Selector.GetHandle ("attachmentBoundsForTextContainer:proposedLineFragment:glyphPosition:characterIndex:"), textContainer__handle__, proposedLineFragment, glyphPosition, characterIndex);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual UIImage? GetImageForBounds (CGRect bounds, NSTextContainer? textContainer, nuint characterIndex)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<UIImage> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_CGRect_NativeHandle_UIntPtr (&__objc_super__, Selector.GetHandle ("imageForBounds:textContainer:characterIndex:"), bounds, textContainer__handle__, characterIndex), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (textContainer);
		...
		public virtual UIImage? GetImageForBounds (CGRect bounds, NSDictionary<NSString, NSObject> attributes, INSTextLocation location, NSTextContainer? textContainer)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<UIImage> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_CGRect_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("imageForBounds:attributes:location:textContainer:"), bounds, attributes__handle__, location__handle__, textContainer__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (attributes);
		...
		public static Class? GetTextAttachmentViewProviderClass (string fileType)
		{
			...
			Class? ret;
			ret = Runtime.GetINativeObject<global::ObjCRuntime.Class> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("textAttachmentViewProviderClassForFileType:"), nsfileType), false)!;
		...
		public virtual NSTextAttachmentViewProvider? GetViewProvider (UIView? parentView, INSTextLocation location, NSTextContainer? textContainer)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSTextAttachmentViewProvider> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("viewProviderForParentView:location:textContainer:"), parentView__handle__, location__handle__, textContainer__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public static void RegisterViewProviderClass (Class textAttachmentViewProviderClass, string fileType)
		{
			...
			if (fileType is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (fileType));
			var nsfileType = CFString.CreateNative (fileType);
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("registerTextAttachmentViewProviderClass:forFileType:"), textAttachmentViewProviderClass.Handle, nsfileType);
		...
		public virtual bool AllowsTextAttachmentView {
			...
			get {
				...
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("allowsTextAttachmentView"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("allowsTextAttachmentView"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
			...
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_bool (this.Handle, Selector.GetHandle ("setAllowsTextAttachmentView:"), value ? (byte) 1 : (byte) 0);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, Selector.GetHandle ("setAllowsTextAttachmentView:"), value ? (byte) 1 : (byte) 0);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual NSData? Contents {
			...
			get {
				...
				NSData? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("contents")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("contents")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual string? FileType {
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setFileType:"), nsvalue);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setFileType:"), nsvalue);
						GC.KeepAlive (this);
					}
				}
		...
		public virtual NSFileWrapper? FileWrapper {
			...
			get {
				...
				NSFileWrapper? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSFileWrapper> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("fileWrapper")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSFileWrapper> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("fileWrapper")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				var value__handle__ = value.GetHandle ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setFileWrapper:"), value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setFileWrapper:"), value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
		...
		public virtual nfloat LineLayoutPadding {
			...
			get {
				...
				nfloat ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend (this.Handle, Selector.GetHandle ("lineLayoutPadding"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("lineLayoutPadding"));
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_nfloat (this.Handle, Selector.GetHandle ("setLineLayoutPadding:"), value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_nfloat (&__objc_super__, Selector.GetHandle ("setLineLayoutPadding:"), value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual bool UsesTextAttachmentView {
			...
			get {
				...
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("usesTextAttachmentView"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("usesTextAttachmentView"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
