...
namespace AVFoundation {
	...
	public unsafe partial class AVAssetReaderTrackOutput : AVAssetReaderOutput {
		...
		const string selAssetReaderTrackOutputWithTrack_OutputSettings_X = "assetReaderTrackOutputWithTrack:outputSettings:";
		static readonly NativeHandle selAssetReaderTrackOutputWithTrack_OutputSettings_XHandle = Selector.GetHandle ("assetReaderTrackOutputWithTrack:outputSettings:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithTrack_OutputSettings_X = "initWithTrack:outputSettings:";
		static readonly NativeHandle selInitWithTrack_OutputSettings_XHandle = Selector.GetHandle ("initWithTrack:outputSettings:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTrackX = "track";
		static readonly NativeHandle selTrackXHandle = Selector.GetHandle ("track");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selInitWithTrack_OutputSettings_XHandle, track__handle__, outputSettings__handle__), "initWithTrack:outputSettings:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selInitWithTrack_OutputSettings_XHandle, track__handle__, outputSettings__handle__), "initWithTrack:outputSettings:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (track);
		...
		internal static AVAssetReaderTrackOutput FromTrack (AVAssetTrack track, NSDictionary? outputSettings)
		{
			...
			ret =  Runtime.GetNSObject<AVAssetReaderTrackOutput> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, selAssetReaderTrackOutputWithTrack_OutputSettings_XHandle, track__handle__, outputSettings__handle__), false)!;
			GC.KeepAlive (track);
			GC.KeepAlive (outputSettings);
			return ret!;
		}
		...
		public virtual AVAssetTrack Track {
			...
			get {
				AVAssetTrack? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<AVAssetTrack> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selTrackXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<AVAssetTrack> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selTrackXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
