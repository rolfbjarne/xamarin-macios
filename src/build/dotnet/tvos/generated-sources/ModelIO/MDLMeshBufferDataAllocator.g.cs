	...
	public unsafe partial class MDLMeshBufferDataAllocator : NSObject, IMDLMeshBufferAllocator {
		...
		public virtual IMDLMeshBuffer CreateBuffer (nuint length, MDLMeshBufferType type)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMDLMeshBuffer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_UIntPtr_UIntPtr (&__objc_super__, Selector.GetHandle ("newBuffer:type:"), length, (UIntPtr) (ulong) type), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual IMDLMeshBuffer CreateBuffer (NSData data, MDLMeshBufferType type)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMDLMeshBuffer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_UIntPtr (&__objc_super__, Selector.GetHandle ("newBufferWithData:type:"), data__handle__, (UIntPtr) (ulong) type), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (data);
		...
		public virtual IMDLMeshBuffer? CreateBuffer (IMDLMeshBufferZone? zone, nuint length, MDLMeshBufferType type)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMDLMeshBuffer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_UIntPtr_UIntPtr (&__objc_super__, Selector.GetHandle ("newBufferFromZone:length:type:"), zone__handle__, length, (UIntPtr) (ulong) type), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (zone);
		...
		public virtual IMDLMeshBuffer? CreateBuffer (IMDLMeshBufferZone? zone, NSData data, MDLMeshBufferType type)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMDLMeshBuffer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_UIntPtr (&__objc_super__, Selector.GetHandle ("newBufferFromZone:data:type:"), zone__handle__, data__handle__, (UIntPtr) (ulong) type), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (zone);
		...
		public virtual IMDLMeshBufferZone CreateZone (nuint capacity)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMDLMeshBufferZone> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_UIntPtr (&__objc_super__, Selector.GetHandle ("newZone:"), capacity), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual IMDLMeshBufferZone CreateZone (NSNumber[] sizes, NSNumber[] types)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMDLMeshBufferZone> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("newZoneForBuffersWithSize:andType:"), nsa_sizes.Handle, nsa_types.Handle), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
