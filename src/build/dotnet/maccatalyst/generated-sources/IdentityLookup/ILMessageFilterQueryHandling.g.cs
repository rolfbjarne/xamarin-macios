...
namespace IdentityLookup {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "HandleQueryRequest", Selector = "handleQueryRequest:context:completion:", ParameterType = new Type [] { typeof (IdentityLookup.ILMessageFilterQueryRequest), typeof (IdentityLookup.ILMessageFilterExtensionContext), typeof (global::System.Action<global::IdentityLookup.ILMessageFilterQueryResponse>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V64) })]
	public partial interface IILMessageFilterQueryHandling : INativeObject, IDisposable
	{
		...
		public unsafe virtual void HandleQueryRequest (ILMessageFilterQueryRequest queryRequest, ILMessageFilterExtensionContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V64))]global::System.Action<ILMessageFilterQueryResponse> completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="queryRequest">The query for the message.</param><param name="context">The app extension context for deferring requests.</param><param name="completion">A handler that is run after the operation completes.</param><summary>Evaluates the specified request in the provided context, and runs a handler when the operation is complete.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _HandleQueryRequest (IILMessageFilterQueryHandling This, ILMessageFilterQueryRequest queryRequest, ILMessageFilterExtensionContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V64))]global::System.Action<ILMessageFilterQueryResponse> completion)
		{
	...
	internal unsafe sealed class ILMessageFilterQueryHandlingWrapper : BaseWrapper, IILMessageFilterQueryHandling {
		...
		[Export ("handleQueryRequest:context:completion:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void HandleQueryRequest (ILMessageFilterQueryRequest queryRequest, ILMessageFilterExtensionContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V64))]global::System.Action<ILMessageFilterQueryResponse> completion)
		{
			var queryRequest__handle__ = queryRequest!.GetNonNullHandle (nameof (queryRequest));
			var context__handle__ = context!.GetNonNullHandle (nameof (context));
			if (completion is null)
