...
namespace StoreKit {
	...
	public unsafe partial class SKRequest : NSObject {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("SKRequest");
		...
		/// <summary>Creates a new <see cref="SKRequest" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public SKRequest () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected SKRequest (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal SKRequest (NativeHandle handle) : base (handle)
		{
		}
		...
		/// <summary>An instance of the StoreKit.ISKRequestDelegate model class which acts as the class delegate.</summary><value>The instance of the StoreKit.ISKRequestDelegate model class</value><remarks><para>The delegate instance assigned to this object will be used to handle events or provide data on demand to this class.</para><para>When setting the Delegate or WeakDelegate values events will be delivered to the specified instance instead of being delivered to the C#-style events</para><para>This is the strongly typed version of the object, developers should use the WeakDelegate property instead if they want to merely assign a class derived from NSObject that has been decorated with [Export] attributes.</para></remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			get { return typeof (_SKRequestDelegate); }
		}
		internal virtual _SKRequestDelegate CreateInternalEventDelegateType ()
		{
			return (_SKRequestDelegate)(new _SKRequestDelegate());
		}
		internal _SKRequestDelegate EnsureSKRequestDelegate ()
		{
			...
			var del = Delegate as _SKRequestDelegate;
			if (del is null){
				del = (_SKRequestDelegate)CreateInternalEventDelegateType ();
				Delegate = (ISKRequestDelegate)del;
			}
			return del;
		}
		#pragma warning disable 672
		[Register]
		internal class _SKRequestDelegate : NSObject, ISKRequestDelegate { 
			public _SKRequestDelegate () { IsDirectBinding = false; }
			[DynamicDependency (DynamicallyAccessedMemberTypes.PublicMethods, typeof (_SKRequestDelegate))]
			static _SKRequestDelegate ()
			{
				GC.KeepAlive (null);
			}
			internal EventHandler<SKRequestErrorEventArgs>? requestFailed;
			[Export ("request:didFailWithError:")]
			public void RequestFailed (StoreKit.SKRequest request, NSError error)
			{
				var handler = requestFailed;
				if (handler is not null){
					var args = new SKRequestErrorEventArgs (error);
					handler (request, args);
				}
			}
			internal EventHandler? requestFinished;
			[Export ("requestDidFinish:")]
			public void RequestFinished (StoreKit.SKRequest request)
			{
				var handler = requestFinished;
				if (handler is not null){
					handler (request, EventArgs.Empty);
				}
			}
		}
		...
		public event EventHandler<SKRequestErrorEventArgs> RequestFailed {
			add { EnsureSKRequestDelegate ()!.requestFailed += value; }
			remove { EnsureSKRequestDelegate ()!.requestFailed -= value; }
		}
		/// <summary>Event raised by the object.</summary>
		/// <remarks>If developers do not assign a value to this event, this will reset the value for the WeakDelegate property to an internal handler that maps delegates to events.</remarks>
		public event EventHandler RequestFinished {
			add { EnsureSKRequestDelegate ()!.requestFinished += value; }
			remove { EnsureSKRequestDelegate ()!.requestFinished -= value; }
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	...
	public partial class SKRequestErrorEventArgs : EventArgs {
		/// <summary>Create a new instance of the <see cref="SKRequestErrorEventArgs" /> with the specified event data.</summary>
