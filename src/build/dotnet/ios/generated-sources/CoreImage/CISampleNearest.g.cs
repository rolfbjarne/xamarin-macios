...
namespace CoreImage {
	...
	public partial class CISampleNearest : CIFilter {
		/// <summary>Creates a new <see cref="CISampleNearest" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CISampleNearest () : base ("CISampleNearest")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISampleNearest (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISampleNearest (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISampleNearest (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
