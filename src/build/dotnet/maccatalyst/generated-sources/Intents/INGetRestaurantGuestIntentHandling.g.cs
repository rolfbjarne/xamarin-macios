...
namespace Intents {
	...
	public partial interface IINGetRestaurantGuestIntentHandling : INativeObject, IDisposable
	{
		...
		public unsafe virtual void HandleRestaurantGuest (INGetRestaurantGuestIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V113))]global::System.Action<INGetRestaurantGuestIntentResponse> completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="intent">Specifies the user's intention.</param><param name="completion">Completion method that must be called by the override.</param><summary>Developers must override this method and invoke the <see cref="T:System.Action`1" /> with an <see cref="T:Intents.INGetRestaurantGuestIntentResponse" /> appropriate to the <see cref="T:Intents.INGetRestaurantGuestIntent" /> <paramref name="intent" />.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _HandleRestaurantGuest (IINGetRestaurantGuestIntentHandling This, INGetRestaurantGuestIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V113))]global::System.Action<INGetRestaurantGuestIntentResponse> completion)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void Confirm (INGetRestaurantGuestIntent guestIntent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V113))]global::System.Action<INGetRestaurantGuestIntentResponse> completion)
		{
			_Confirm (this, guestIntent, completion);
		}
		/// <param name="guestIntent">To be added.</param><param name="completion">To be added.</param><summary>Developers may override this method to customize the confirmation of a guest for a restaurant reservation.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _Confirm (IINGetRestaurantGuestIntentHandling This, INGetRestaurantGuestIntent guestIntent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V113))]global::System.Action<INGetRestaurantGuestIntentResponse> completion)
		{
	...
	public unsafe static partial class INGetRestaurantGuestIntentHandling_Extensions {
		/// <param name="guestIntent">To be added.</param><param name="completion">To be added.</param><summary>Developers may override this method to customize the confirmation of a guest for a restaurant reservation.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void Confirm (this IINGetRestaurantGuestIntentHandling This, INGetRestaurantGuestIntent guestIntent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V113))]global::System.Action<INGetRestaurantGuestIntentResponse> completion)
		{
			var guestIntent__handle__ = guestIntent!.GetNonNullHandle (nameof (guestIntent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
	...
	internal unsafe sealed class INGetRestaurantGuestIntentHandlingWrapper : BaseWrapper, IINGetRestaurantGuestIntentHandling {
		...
		[Export ("handleGetRestaurantGuest:completion:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void HandleRestaurantGuest (INGetRestaurantGuestIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V113))]global::System.Action<INGetRestaurantGuestIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
