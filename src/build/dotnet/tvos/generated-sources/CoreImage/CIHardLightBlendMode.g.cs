...
#nullable enable
namespace CoreImage {
	/// <summary>The CIHardLightBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/HardLight.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIHardLightBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIHardLightBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIHardLightBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIHardLightBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIHardLightBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
