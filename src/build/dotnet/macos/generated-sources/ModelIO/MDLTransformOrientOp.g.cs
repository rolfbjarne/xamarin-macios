	...
	public unsafe partial class MDLTransformOrientOp : NSObject, IMDLTransformOp {
		...
		public virtual MDLAnimatedQuaternion AnimatedValue {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<MDLAnimatedQuaternion> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selAnimatedValueXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<MDLAnimatedQuaternion> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selAnimatedValueXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
