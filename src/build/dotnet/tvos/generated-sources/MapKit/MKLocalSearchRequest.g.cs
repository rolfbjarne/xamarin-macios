	...
	public unsafe partial class MKLocalSearchRequest : NSObject, INSCopying {
		...
		public virtual MKLocalSearchResultType ResultTypes {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (MapKit.MKLocalSearchResultType) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("resultTypes"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MapKit.MKLocalSearchResultType) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("resultTypes"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
