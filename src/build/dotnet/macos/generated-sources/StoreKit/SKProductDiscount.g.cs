...
namespace StoreKit {
	...
	public unsafe partial class SKProductDiscount : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNumberOfPeriodsX = "numberOfPeriods";
		static readonly NativeHandle selNumberOfPeriodsXHandle = Selector.GetHandle ("numberOfPeriods");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPaymentModeX = "paymentMode";
		static readonly NativeHandle selPaymentModeXHandle = Selector.GetHandle ("paymentMode");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("SKProductDiscount");
		...
		/// <summary>Creates a new <see cref="SKProductDiscount" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public SKProductDiscount () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected SKProductDiscount (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal SKProductDiscount (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual nuint NumberOfPeriods {
			...
			get {
				nuint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selNumberOfPeriodsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selNumberOfPeriodsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual SKProductDiscountPaymentMode PaymentMode {
			[Export ("paymentMode")]
			get {
				SKProductDiscountPaymentMode ret;
				if (IsDirectBinding) {
					ret = (StoreKit.SKProductDiscountPaymentMode) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selPaymentModeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (StoreKit.SKProductDiscountPaymentMode) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selPaymentModeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual SKProductDiscountType Type {
			[Export ("type")]
			get {
				SKProductDiscountType ret;
				if (IsDirectBinding) {
					ret = (StoreKit.SKProductDiscountType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selTypeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (StoreKit.SKProductDiscountType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selTypeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
