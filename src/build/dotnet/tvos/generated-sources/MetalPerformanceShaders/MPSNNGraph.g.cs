...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSNNGraph : MPSKernel, INSCoding, INSCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual MPSImage Execute (MPSImage[] sourceImages, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V80))]global::System.Action<MPSImage, NSError> handler)
		{
			if (sourceImages is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (sourceImages));
			if (handler is null)
			...
			using var nsa_sourceImages = NSArray.FromNSObjects (sourceImages);
			using var block_handler = Trampolines.SDActionArity2V80.CreateBlock (handler);
