...
namespace MediaPlayer {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "GetContentItem", Selector = "contentItemForIdentifier:completionHandler:", ParameterType = new Type [] { typeof (string), typeof (global::System.Action<global::MediaPlayer.MPContentItem, NSError>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity2V130) })]
	public partial interface IMPPlayableContentDataSource : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void BeginLoadingChildItems (NSIndexPath indexPath, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			_BeginLoadingChildItems (this, indexPath, completionHandler);
		}
		/// <param name="indexPath">To be added.</param><param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _BeginLoadingChildItems (IMPPlayableContentDataSource This, NSIndexPath indexPath, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetContentItem (string identifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V130))]global::System.Action<MPContentItem, NSError> completionHandler)
		{
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _GetContentItem (IMPPlayableContentDataSource This, string identifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V130))]global::System.Action<MPContentItem, NSError> completionHandler)
		{
	...
	public unsafe static partial class MPPlayableContentDataSource_Extensions {
		/// <param name="indexPath">To be added.</param><param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void BeginLoadingChildItems (this IMPPlayableContentDataSource This, NSIndexPath indexPath, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void GetContentItem (this IMPPlayableContentDataSource This, string identifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V130))]global::System.Action<MPContentItem, NSError> completionHandler)
		{
			if (identifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (identifier));
			if (completionHandler is null)
...
namespace MediaPlayer {
	/// <summary>Provides media metadata information to external media players.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/MediaPlayer/Reference/MPPlayableContentDataSource_Ref/index.html">Apple documentation for <c>MPPlayableContentDataSource</c></related>
	[Protocol()]
	[Register("Microsoft_iOS__MediaPlayer_MPPlayableContentDataSource", false)]
	[Model]
	[UnsupportedOSPlatform ("macos")]
	[UnsupportedOSPlatform ("tvos")]
	[SupportedOSPlatform ("maccatalyst")]
