	...
	public unsafe partial class MDLTransformMatrixOp : NSObject, IMDLTransformOp {
		...
		public virtual MDLAnimatedMatrix4x4 AnimatedValue {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<MDLAnimatedMatrix4x4> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selAnimatedValueXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<MDLAnimatedMatrix4x4> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selAnimatedValueXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
