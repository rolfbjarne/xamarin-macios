...
namespace Introspection {
	...
	public abstract class ApiCtorInitTest : ApiBaseTest {
		...
		public void DefaultCtorAllowed ()
		{
			...
			ClassicAssert.AreEqual (0, Errors, "{0} potential errors found in {1} default ctor validated{2}", Errors, n, Errors == 0 ? string.Empty : ":\n" + ErrorData.ToString () + "\n");
		}
		...
		public void DesignatedInitializer ()
		{
			...
			ClassicAssert.AreEqual (0, Errors, "{0} potential errors found in {1} designated initializer validated", Errors, n);
		}
		...
		public void ShouldNotExposeDefaultCtorTest ()
		{
			...
			ClassicAssert.AreEqual (0, Errors, $"{Errors} potential errors found in {n} BaseType empty ctor validated: \n{ErrorData}\n{(genObjCTestCode ? $"\n\n{objCCode}\n" : string.Empty)}");
		}
		...
		public void ARAnchorCopyingCtorTest ()
		{
			...
			ClassicAssert.AreEqual (0, Errors, "{0} potential errors found when validating if subclasses of 'ARAnchor' re-expose 'IARAnchorCopying' constructor", Errors);
		}
#endif
	}
}
