...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITileFilter" /> that applies 12-way reflected symmetry.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CITwelvefoldReflectedTile filter with the input image
	/// var twelvefold_reflected_tile = new CITwelvefoldReflectedTile () {
	/// 	Image = flower
	/// };
	/// 
	/// // Get the altered image from the filter
	/// var output = new CICrop {
	/// 	Image = twelvefold_reflected_tile.OutputImage,
	...
	/// </para><para><img href="~/xml/CoreImage/_images/twelvefold_reflected_tile.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CITwelvefoldReflectedTile : CITileFilter, ICITwelvefoldReflectedTileProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CITwelvefoldReflectedTile" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CITwelvefoldReflectedTile (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CITwelvefoldReflectedTile (NSObjectFlag t) : base (t)
		{
		}
		...
		public CITwelvefoldReflectedTile (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CITwelvefoldReflectedTileProtocol protocol members 
