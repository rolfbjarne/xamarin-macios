		...
		public unsafe virtual void GetMultiArrayForState (string stateName, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMLStateGetMultiArrayForStateHandler))]MLStateGetMultiArrayForStateHandler handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					...
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selGetMultiArrayForStateNamed_Handler_XHandle, nsstateName, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
