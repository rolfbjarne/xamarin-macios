...
namespace CoreImage {
	...
	public partial class CIDroste : CIFilter, ICIDrosteProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIDroste" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIDroste () : base ("CIDroste")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIDroste (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDroste (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDroste (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		public CGPoint InputInsetPoint0 {
			...
			get {
				return GetPoint ("inputInsetPoint0");
			}
		...
		public CGPoint InputInsetPoint1 {
			...
			get {
				return GetPoint ("inputInsetPoint1");
			}
