	...
	public unsafe partial class AVSpeechSynthesisProviderAudioUnit : global::AudioUnit.AUAudioUnit {
		...
		public virtual void CancelSpeechRequest ()
		{
			if (IsDirectBinding) {
				...
				unsafe {
					...
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("cancelSpeechRequest"));
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void SynthesizeSpeechRequest (AVSpeechSynthesisProviderRequest speechRequest)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("synthesizeSpeechRequest:"), speechRequest__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		internal unsafe virtual NativeHandle _InitWithComponentDescription (global::AudioUnit.AudioComponentDescription componentDescription, global::AudioUnit.AudioComponentInstantiationOptions options, out NSError? outError)
		{
			...
			NativeHandle ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_AudioComponentDescription_UInt32_ref_NativeHandle (this.Handle, Selector.GetHandle ("initWithComponentDescription:options:error:"), componentDescription, (UInt32)options, &outErrorValue);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_AudioComponentDescription_UInt32_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithComponentDescription:options:error:"), componentDescription, (UInt32)options, &outErrorValue);
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual AVSpeechSynthesisProviderOutputBlock? SpeechSynthesisOutputMetadataBlock {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("speechSynthesisOutputMetadataBlock"));
						GC.KeepAlive (this);
					}
				}
			...
			set {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setSpeechSynthesisOutputMetadataBlock:"), (IntPtr) block_ptr_value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual AVSpeechSynthesisProviderVoice[] SpeechVoices {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<AVSpeechSynthesisProviderVoice>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("speechVoices")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<AVSpeechSynthesisProviderVoice>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("speechVoices")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setSpeechVoices:"), nsa_value.Handle);
						GC.KeepAlive (this);
					}
				}
			}
