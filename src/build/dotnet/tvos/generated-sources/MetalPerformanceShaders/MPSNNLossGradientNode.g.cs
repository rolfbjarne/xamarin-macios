...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSNNLossGradientNode : MPSNNGradientFilterNode {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_bool (this.Handle, Selector.GetHandle ("initWithSources:gradientState:lossDescriptor:isLabelsGradientFilter:"), nsa_sourceNodes.Handle, gradientState__handle__, descriptor__handle__, isLabelsGradientFilter ? (byte) 1 : (byte) 0), "initWithSources:gradientState:lossDescriptor:isLabelsGradientFilter:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_bool (&__objc_super__, Selector.GetHandle ("initWithSources:gradientState:lossDescriptor:isLabelsGradientFilter:"), nsa_sourceNodes.Handle, gradientState__handle__, descriptor__handle__, isLabelsGradientFilter ? (byte) 1 : (byte) 0), "initWithSources:gradientState:lossDescriptor:isLabelsGradientFilter:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (gradientState);
		...
		public static MPSNNLossGradientNode Create (MPSNNImageNode[] sourceNodes, MPSNNGradientStateNode? gradientState, MPSCnnLossDescriptor descriptor, bool isLabelsGradientFilter)
		{
			...
			using var nsa_sourceNodes = NSArray.FromNSObjects (sourceNodes);
			MPSNNLossGradientNode? ret;
			ret =  Runtime.GetNSObject<MPSNNLossGradientNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_bool (class_ptr, Selector.GetHandle ("nodeWithSources:gradientState:lossDescriptor:isLabelsGradientFilter:"), nsa_sourceNodes.Handle, gradientState__handle__, descriptor__handle__, isLabelsGradientFilter ? (byte) 1 : (byte) 0), false)!;
			GC.KeepAlive (gradientState);
			GC.KeepAlive (descriptor);
			return ret!;
		}
		...
		public virtual bool IsLabelsGradientFilter {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("isLabelsGradientFilter"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isLabelsGradientFilter"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
