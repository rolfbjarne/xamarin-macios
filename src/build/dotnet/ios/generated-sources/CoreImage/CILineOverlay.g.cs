...
namespace CoreImage {
	...
	public partial class CILineOverlay : CIFilter, ICILineOverlayProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CILineOverlay" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CILineOverlay () : base ("CILineOverlay")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CILineOverlay (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILineOverlay (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILineOverlay (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CILineOverlayProtocol protocol members 
