...
#nullable enable
namespace CoreImage {
	/// <summary>The CIColorBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/ColorBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIColorBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIColorBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
