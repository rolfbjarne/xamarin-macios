...
namespace PdfKit {
	...
	public unsafe partial class PdfThumbnailView : global::UIKit.UIView, INSCoding {
		...
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("tvos18.2")]
		public virtual PdfThumbnailLayoutMode LayoutMode {
			[Export ("layoutMode")]
			get {
				PdfThumbnailLayoutMode ret;
				if (IsDirectBinding) {
					ret = (PdfKit.PdfThumbnailLayoutMode) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("layoutMode"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (PdfKit.PdfThumbnailLayoutMode) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("layoutMode"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("setLayoutMode:"), (IntPtr) (long) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("setLayoutMode:"), (IntPtr) (long) value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual PdfView? PdfView {
			...
			get {
				PdfView? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<PdfView> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("PDFView")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<PdfView> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("PDFView")), false)!;
						GC.KeepAlive (this);
					}
				}
				MarkDirty ();
			...
			set {
				var value__handle__ = value.GetHandle ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setPDFView:"), value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setPDFView:"), value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
		...
		public virtual PdfPage[]? SelectedPages {
			...
			get {
				PdfPage[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<PdfPage>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("selectedPages")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<PdfPage>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("selectedPages")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual CGSize ThumbnailSize {
			...
			get {
				CGSize ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.CGSize_objc_msgSend (this.Handle, Selector.GetHandle ("thumbnailSize"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.CGSize_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("thumbnailSize"));
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_CGSize (this.Handle, Selector.GetHandle ("setThumbnailSize:"), value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_CGSize (&__objc_super__, Selector.GetHandle ("setThumbnailSize:"), value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		/// <summary>Appearance class for objects of type <see cref="global::PdfKit.PdfThumbnailView" />.</summary>
		/// <remarks>
		///     <para>This appearance class is a strongly typed subclass of UIAppearance that is intended to be used with objects of class <see cref="global::PdfKit.PdfThumbnailView" />.</para>
		///     <para>You can obtain an instance to this class by either accessing the static <see cref="global::PdfKit.PdfThumbnailView.Appearance" /> property or by calling <see cref="global::PdfKit.PdfThumbnailView.AppearanceWhenContainedIn(System.Type[])" /> to get a UIAppearance that is context sensitive.</para>
		/// </remarks>
		public partial class PdfThumbnailViewAppearance : global::UIKit.UIView.UIViewAppearance {
			protected internal PdfThumbnailViewAppearance (IntPtr handle) : base (handle) {}
		}
		/// <summary>Strongly-typed property that returns the UIAppearance class for this class.</summary>
		/// <remarks>
		///   <para>Setting any appearance properties on this instance will affect the appearance of all instances of <see cref="global::PdfKit.PdfThumbnailView" />.</para>
		///   <para>If developers want to control the appearance of subclasses of <see cref="global::PdfKit.PdfThumbnailView" />, they should use the <see cref="global::PdfKit.PdfThumbnailView.GetAppearance&lt;T&gt;(UIKit.UITraitCollection,System.Type[])" /> method.</para>
		/// </remarks>
		public static new PdfThumbnailViewAppearance Appearance {
			get { return new PdfThumbnailViewAppearance (global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (class_ptr, ObjCRuntime.Selector.GetHandle ("appearance"))); }
		}
		/// <summary>Obtains the appearance proxy <see cref="global::PdfKit.PdfThumbnailView.PdfThumbnailViewAppearance" /> for the subclass of <see cref="global::PdfKit.PdfThumbnailView" />.</summary>
		/// <typeparam name="T">The type for which the <see cref="global::UIKit.UIAppearance" /> proxy must be returned.  This is a subclass of <see cref="global::PdfKit.PdfThumbnailView" />.</typeparam>
		/// <returns>
		///   <para>An appearance proxy object for the specified type.</para>
		/// </returns>
		/// <remarks>
		///   <para>Setting any appearance properties on the returned object will affect the appearance of all classes and subclasses of the type parameter.</para>
		///   <para>Unlike the <see cref="global::PdfKit.PdfThumbnailView.Appearance" /> property, or the <see cref="global::PdfKit.PdfThumbnailView.AppearanceWhenContainedIn(System.Type[])" /> method which only work on instances of this particular class, the proxies returned by this method can be used to change the style of subclasses.</para>
		///   <para>The following example shows how this method works:</para>
		///   <example>
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTheme = PdfThumbnailView.GetAppearance<MyPdfThumbnailViewSubclass> ();
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
		/// </remarks>
		public static new PdfThumbnailViewAppearance GetAppearance<T> () where T: PdfThumbnailView {
			return new PdfThumbnailViewAppearance (global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (Class.GetHandle (typeof (T)), ObjCRuntime.Selector.GetHandle ("appearance")));
		}
		...
		/// <remarks>
		///   <para>The returned object represents the <see cref="global::UIKit.UIAppearance" /> proxy where developers can set appearance properties for instances of <see cref="global::PdfKit.PdfThumbnailView" /> when those instances are contained in the hierarchy specified by the <paramref name="containers" /> parameter.</para>
		///   <para>If developers want to control the appearance of subclasses of <see cref="global::PdfKit.PdfThumbnailView" />, they should use the <see cref="global::PdfKit.PdfThumbnailView.GetAppearance&lt;T&gt;(UIKit.UITraitCollection,System.Type[])" /> method.</para>
		///   <para>The following example shows how this method works:</para>
		///   <example>
		///     <code lang="csharp lang-csharp"><![CDATA[
		...
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
		/// </remarks>
		public static new PdfThumbnailViewAppearance AppearanceWhenContainedIn (params Type [] containers)
		{
			return new PdfThumbnailViewAppearance (UIAppearance.GetAppearance (class_ptr, containers));
		}
		/// <summary>Obtains the appearance proxy <see cref="global::PdfKit.PdfThumbnailView.PdfThumbnailViewAppearance" /> for <see cref="global::PdfKit.PdfThumbnailView" />.</summary>
		...
		///var myTheme = PdfThumbnailView.GetAppearance (myTraits);
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>If developers want to control the appearance of subclasses of <see cref="global::PdfKit.PdfThumbnailView" />, they should use the <see cref="global::PdfKit.PdfThumbnailView.GetAppearance&lt;T&gt;(UIKit.UITraitCollection)" /> method.</para>
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
		/// </remarks>
		public static new PdfThumbnailViewAppearance GetAppearance (UITraitCollection traits) {
			return new PdfThumbnailViewAppearance (UIAppearance.GetAppearance (class_ptr, traits));
		}
		/// <summary>Obtains the appearance proxy <see cref="global::PdfKit.PdfThumbnailView.PdfThumbnailViewAppearance" /> for <see cref="global::PdfKit.PdfThumbnailView" />.</summary>
		/// <param name="traits">Trait collection to match.</param>
		...
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTraits = new UITraitCollection ();
		///var myTheme = PdfThumbnailView.GetAppearance (myTraits, typeof (UINavigationBar), typeof (UIPopoverController));
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>If developers want to control the appearance of subclasses of <see cref="global::PdfKit.PdfThumbnailView" />, they should use the <see cref="global::PdfKit.PdfThumbnailView.GetAppearance&lt;T&gt;(UIKit.UITraitCollection,System.Type[])" /> method.</para>
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
		/// </remarks>
		public static new PdfThumbnailViewAppearance GetAppearance (UITraitCollection traits, params Type [] containers) {
			return new PdfThumbnailViewAppearance (UIAppearance.GetAppearance (class_ptr, traits, containers));
		}
		/// <summary>Obtains the appearance proxy <see cref="global::PdfKit.PdfThumbnailView.PdfThumbnailViewAppearance" /> for the subclass of <see cref="global::PdfKit.PdfThumbnailView" />.</summary>
		/// <typeparam name="T">The type for which the <see cref="global::UIKit.UIAppearance" /> proxy must be returned.  This is a subclass of <see cref="global::PdfKit.PdfThumbnailView" />.</typeparam>
		/// <param name="traits">Trait collection to match.</param>
		...
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTraits = new UITraitCollection ();
		///var myTheme = PdfThumbnailView.GetAppearance<MyPdfThumbnailViewSubclass> (myTraits);
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
		/// </remarks>
		public static new PdfThumbnailViewAppearance GetAppearance<T> (UITraitCollection traits) where T: PdfThumbnailView {
			return new PdfThumbnailViewAppearance (UIAppearance.GetAppearance (Class.GetHandle (typeof (T)), traits));
		}
		/// <summary>Obtains the appearance proxy <see cref="global::PdfKit.PdfThumbnailView.PdfThumbnailViewAppearance" /> for the subclass of <see cref="global::PdfKit.PdfThumbnailView" />.</summary>
		/// <typeparam name="T">The type for which the <see cref="global::UIKit.UIAppearance" /> proxy must be returned.  This is a subclass of <see cref="global::PdfKit.PdfThumbnailView" />.</typeparam>
		/// <param name="traits">Trait collection to match.</param>
		...
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTraits = new UITraitCollection ();
		///var myTheme = PdfThumbnailView.GetAppearance<MyPdfThumbnailViewSubclass> (myTraits, typeof (UINavigationBar), typeof (UIPopoverController));
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
		/// </remarks>
		public static new PdfThumbnailViewAppearance GetAppearance<T> (UITraitCollection traits, params Type [] containers) where T: PdfThumbnailView{
			return new PdfThumbnailViewAppearance (UIAppearance.GetAppearance (Class.GetHandle (typeof (T)), containers));
		}
		//
		// Notifications
		//
