...
#nullable enable
namespace CoreImage {
	/// <summary>The CITemperatureAndTint CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/TemperatureTint.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CITemperatureAndTint : CIFilter, ICITemperatureAndTintProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CITemperatureAndTint" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CITemperatureAndTint () : base ("CITemperatureAndTint")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CITemperatureAndTint (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CITemperatureAndTint (NSObjectFlag t) : base (t)
		{
		}
		...
		public CITemperatureAndTint (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CITemperatureAndTintProtocol protocol members 
