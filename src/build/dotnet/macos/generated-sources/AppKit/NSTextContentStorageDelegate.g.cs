...
namespace AppKit {
		...
		AppKit.INSTextContentManagerDelegate
	{
		...
		[DynamicDependencyAttribute ("GetTextParagraph(AppKit.NSTextContentStorage,Foundation.NSRange)")]
...
namespace AppKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__AppKit_NSTextContentStorageDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
	[UnsupportedOSPlatform ("tvos")]
