...
namespace MLCompute {
	...
	public unsafe partial class MLCInferenceGraph : MLCGraph {
		...
		const string selAddInputs_X = "addInputs:";
		static readonly NativeHandle selAddInputs_XHandle = Selector.GetHandle ("addInputs:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selExecuteWithInputsData_BatchSize_Options_CompletionHandler_X = "executeWithInputsData:batchSize:options:completionHandler:";
		static readonly NativeHandle selExecuteWithInputsData_BatchSize_Options_CompletionHandler_XHandle = Selector.GetHandle ("executeWithInputsData:batchSize:options:completionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selExecuteWithInputsData_OutputsData_BatchSize_Options_CompletionHandler_X = "executeWithInputsData:outputsData:batchSize:options:completionHandler:";
		static readonly NativeHandle selExecuteWithInputsData_OutputsData_BatchSize_Options_CompletionHandler_XHandle = Selector.GetHandle ("executeWithInputsData:outputsData:batchSize:options:completionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGraphWithGraphObjects_X = "graphWithGraphObjects:";
		static readonly NativeHandle selGraphWithGraphObjects_XHandle = Selector.GetHandle ("graphWithGraphObjects:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual bool AddInputs (NSDictionary<NSString, MLCTensor> inputs)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (this.Handle, selAddInputs_XHandle, inputs__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, selAddInputs_XHandle, inputs__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (inputs);
		...
		public static MLCInferenceGraph Create (MLCGraph[] graphObjects)
		{
			...
			ret =  Runtime.GetNSObject<MLCInferenceGraph> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selGraphWithGraphObjects_XHandle, nsa_graphObjects.Handle), false)!;
			return ret;
		}
		...
		public unsafe virtual bool Execute (NSDictionary<NSString, MLCTensorData> inputsData, nuint batchSize, MLCExecutionOptions options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMLCGraphCompletionHandler))]MLCGraphCompletionHandler? completionHandler)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_UIntPtr_UInt64_NativeHandle (this.Handle, selExecuteWithInputsData_BatchSize_Options_CompletionHandler_XHandle, inputsData__handle__, batchSize, (UInt64)options, (IntPtr) block_ptr_completionHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle_UIntPtr_UInt64_NativeHandle (&__objc_super__, selExecuteWithInputsData_BatchSize_Options_CompletionHandler_XHandle, inputsData__handle__, batchSize, (UInt64)options, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual bool Execute (NSDictionary<NSString, MLCTensorData> inputsData, NSDictionary<NSString, MLCTensorData>? outputsData, nuint batchSize, MLCExecutionOptions options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMLCGraphCompletionHandler))]MLCGraphCompletionHandler? completionHandler)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle_UIntPtr_UInt64_NativeHandle (this.Handle, selExecuteWithInputsData_OutputsData_BatchSize_Options_CompletionHandler_XHandle, inputsData__handle__, outputsData__handle__, batchSize, (UInt64)options, (IntPtr) block_ptr_completionHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle_NativeHandle_UIntPtr_UInt64_NativeHandle (&__objc_super__, selExecuteWithInputsData_OutputsData_BatchSize_Options_CompletionHandler_XHandle, inputsData__handle__, outputsData__handle__, batchSize, (UInt64)options, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (inputsData);
