...
namespace Xharness {
	...
	public class BCLTestImportTargetFactory {
		...
		List<(string Name, string Path, bool XUnit, string ExtraArgs, List<Platform> Platforms, string Failure, double TimeoutMultiplier, Task GenerationCompleted)> GenerateAlliOSTestProjectsAsync ()
		{
			...
			foreach (var platform in new [] { Platform.iOS, Platform.TvOS, Platform.WatchOS }) {
				var generated = GenerateTestProjectsAsync (GetProjectDefinitions (commoniOSTestProjects, platform), platform);
		...
		public List<(string Name, string Path, bool XUnit, string ExtraArgs, List<Platform> Platforms, string Failure, double TimeoutMultiplier, Task GenerationCompleted)> GenerateAlliOSTestProjects () => GenerateAlliOSTestProjectsAsync ();

		public GeneratedProjects GenerateAllMacTestProjectsAsync (Platform platform) => GenerateTestProjectsAsync (GetProjectDefinitions (macTestProjects, platform), platform);

		public GeneratedProjects GenerateAllMacTestProjects (Platform platform) => GenerateAllMacTestProjectsAsync (platform);
