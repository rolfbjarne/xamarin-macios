...
function check_dotnet ()
{
	...
	DOTNET_FILENAME="dotnet-sdk-$DOTNET_VERSION-osx-x64.pkg"
	DOTNET_URL="https://dotnetcli.azureedge.net/dotnet/Sdk/$DOTNET_FILENAME"
	...
	curl -L "$DOTNET_URL" -o "$PROVISION_DOWNLOAD_DIR/$DOTNET_FILENAME"
