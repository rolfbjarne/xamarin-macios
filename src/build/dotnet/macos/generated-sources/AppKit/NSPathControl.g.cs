...
namespace AppKit {
	...
	public unsafe partial class NSPathControl : NSControl {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selClickedPathItemX = "clickedPathItem";
		static readonly NativeHandle selClickedPathItemXHandle = Selector.GetHandle ("clickedPathItem");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPathItemsX = "pathItems";
		static readonly NativeHandle selPathItemsXHandle = Selector.GetHandle ("pathItems");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetPathItems_X = "setPathItems:";
		static readonly NativeHandle selSetPathItems_XHandle = Selector.GetHandle ("setPathItems:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSPathControl");
		...
		/// <summary>Creates a new <see cref="NSPathControl" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public NSPathControl () : base (NSObjectFlag.Empty)
		{
		...
		public NSPathControl (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSPathControl (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSPathControl (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual void SetDraggingSource (NSDragOperation operationMask, bool isLocal)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr_bool (this.Handle, selSetDraggingSourceOperationMask_ForLocal_XHandle, (UIntPtr) (ulong) operationMask, isLocal ? (byte) 1 : (byte) 0);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr_bool (&__objc_super__, selSetDraggingSourceOperationMask_ForLocal_XHandle, (UIntPtr) (ulong) operationMask, isLocal ? (byte) 1 : (byte) 0);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual NSString[] AllowedTypes {
			...
			get {
				...
				NSString[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<NSString>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selAllowedTypesXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<NSString>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selAllowedTypesXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[ObsoletedOSPlatform ("macos10.10", "Please use ClickedPathItem instead.")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		...
		public virtual NSPathControlItem ClickedPathItem {
			...
			get {
				global::AppKit.NSApplication.EnsureUIThread ();
				NSPathControlItem? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSPathControlItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selClickedPathItemXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSPathControlItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selClickedPathItemXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[ObsoletedOSPlatform ("macos10.10", "Please use PathItems instead.")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		...
		public virtual NSPathControlItem[] PathItems {
			...
			get {
				...
				NSPathControlItem[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<NSPathControlItem>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selPathItemsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<NSPathControlItem>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selPathItemsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				using var nsa_value = NSArray.FromNSObjects (value);
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetPathItems_XHandle, nsa_value.Handle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetPathItems_XHandle, nsa_value.Handle);
						GC.KeepAlive (this);
					}
				}
			}
