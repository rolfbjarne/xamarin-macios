...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSImageScale : MPSUnaryImageKernel {
		...
		internal virtual nint _GetScaleTransform ()
		{
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("scaleTransform"));
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("scaleTransform"));
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("setScaleTransform:"), value);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("setScaleTransform:"), value);
					GC.KeepAlive (this);
				}
			}
		}
