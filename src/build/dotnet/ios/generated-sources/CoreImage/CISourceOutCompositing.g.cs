...
#nullable enable
namespace CoreImage {
	/// <summary>The CISourceOutCompositing CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 
	/// // Construct the SourceOutComposite filter        
	...
	/// var output = sourceOutComposite.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/SourceOut.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CISourceOutCompositing : CICompositingFilter {
		/// <summary>Creates a new <see cref="CISourceOutCompositing" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISourceOutCompositing (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISourceOutCompositing (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISourceOutCompositing (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
