...
namespace UIKit {
	...
	public unsafe partial class NSTextTab : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		[DesignatedInitializer]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public NSTextTab (UITextAlignment alignment, nfloat location, NSDictionary options)
			: base (NSObjectFlag.Empty)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var options__handle__ = options!.GetNonNullHandle (nameof (options));
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_nfloat_NativeHandle (this.Handle, Selector.GetHandle ("initWithTextAlignment:location:options:"), (IntPtr) UITextAlignmentExtensions.ToNative (alignment), location, options__handle__), "initWithTextAlignment:location:options:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr_nfloat_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithTextAlignment:location:options:"), (IntPtr) UITextAlignmentExtensions.ToNative (alignment), location, options__handle__), "initWithTextAlignment:location:options:");
					GC.KeepAlive (this);
				}
			}
		...
		public static NSCharacterSet GetColumnTerminators (NSLocale? locale)
		{
			...
			NSCharacterSet? ret;
			ret =  Runtime.GetNSObject<NSCharacterSet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("columnTerminatorsForLocale:"), locale__handle__), false)!;
			GC.KeepAlive (locale);
			return ret!;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual nfloat Location {
			...
			get {
				...
				nfloat ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend (this.Handle, Selector.GetHandle ("location"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("location"));
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		[Field ("NSTabColumnTerminatorsAttributeName",  "UIKit")]
		public static NSString ColumnTerminatorsAttributeName {
			get {
				if (_ColumnTerminatorsAttributeName is null)
					_ColumnTerminatorsAttributeName = Dlfcn.GetStringConstant (Libraries.UIKit.Handle, "NSTabColumnTerminatorsAttributeName")!;
