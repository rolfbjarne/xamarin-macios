...
namespace UIKit {
	...
	public unsafe partial class UIViewController : UIResponder, INSCoding, INSExtensionRequestHandling, IUIAppearanceContainer, IUIContentContainer, IUIFocusEnvironment, IUITraitChangeObservable, IUITraitEnvironment {
		...
		[SupportedOSPlatform ("ios")]
		public virtual UISearchDisplayController SearchDisplayController {
			[Export ("searchDisplayController", ArgumentSemantic.Retain)]
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				UISearchDisplayController? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<UISearchDisplayController> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("searchDisplayController")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<UISearchDisplayController> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("searchDisplayController")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
