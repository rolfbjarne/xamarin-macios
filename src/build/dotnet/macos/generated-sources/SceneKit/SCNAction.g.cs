...
namespace SceneKit {
	...
	public unsafe partial class SCNAction : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selFadeOpacityBy_Duration_X = "fadeOpacityBy:duration:";
		static readonly NativeHandle selFadeOpacityBy_Duration_XHandle = Selector.GetHandle ("fadeOpacityBy:duration:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selFadeOpacityTo_Duration_X = "fadeOpacityTo:duration:";
		static readonly NativeHandle selFadeOpacityTo_Duration_XHandle = Selector.GetHandle ("fadeOpacityTo:duration:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selJavaScriptActionWithScript_Duration_X = "javaScriptActionWithScript:duration:";
		static readonly NativeHandle selJavaScriptActionWithScript_Duration_XHandle = Selector.GetHandle ("javaScriptActionWithScript:duration:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selMoveByX_Y_Z_Duration_X = "moveByX:y:z:duration:";
		static readonly NativeHandle selMoveByX_Y_Z_Duration_XHandle = Selector.GetHandle ("moveByX:y:z:duration:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPlayAudioSource_WaitForCompletion_X = "playAudioSource:waitForCompletion:";
		static readonly NativeHandle selPlayAudioSource_WaitForCompletion_XHandle = Selector.GetHandle ("playAudioSource:waitForCompletion:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRotateByAngle_AroundAxis_Duration_X = "rotateByAngle:aroundAxis:duration:";
		static readonly NativeHandle selRotateByAngle_AroundAxis_Duration_XHandle = Selector.GetHandle ("rotateByAngle:aroundAxis:duration:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRotateByX_Y_Z_Duration_X = "rotateByX:y:z:duration:";
		static readonly NativeHandle selRotateByX_Y_Z_Duration_XHandle = Selector.GetHandle ("rotateByX:y:z:duration:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRotateToAxisAngle_Duration_X = "rotateToAxisAngle:duration:";
		static readonly NativeHandle selRotateToAxisAngle_Duration_XHandle = Selector.GetHandle ("rotateToAxisAngle:duration:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRotateToX_Y_Z_Duration_X = "rotateToX:y:z:duration:";
		static readonly NativeHandle selRotateToX_Y_Z_Duration_XHandle = Selector.GetHandle ("rotateToX:y:z:duration:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRotateToX_Y_Z_Duration_ShortestUnitArc_X = "rotateToX:y:z:duration:shortestUnitArc:";
		static readonly NativeHandle selRotateToX_Y_Z_Duration_ShortestUnitArc_XHandle = Selector.GetHandle ("rotateToX:y:z:duration:shortestUnitArc:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public unsafe static SCNAction CustomAction (double seconds, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDSCNActionNodeWithElapsedTimeHandler))]SCNActionNodeWithElapsedTimeHandler handler)
		{
			...
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_Double_NativeHandle (class_ptr, selCustomActionWithDuration_ActionBlock_XHandle, seconds, (IntPtr) block_ptr_handler), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_Double (class_ptr, selFadeInWithDuration_XHandle, durationInSeconds), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_nfloat_Double (class_ptr, selFadeOpacityBy_Duration_XHandle, factor, durationInSeconds), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_nfloat_Double (class_ptr, selFadeOpacityTo_Duration_XHandle, opacity, durationInSeconds), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_Double (class_ptr, selFadeOutWithDuration_XHandle, durationInSeconds), false)!;
			return ret;
		}
		...
		public static SCNAction FromJavascript (string script, double seconds)
		{
			...
			SCNAction? ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_Double (class_ptr, selJavaScriptActionWithScript_Duration_XHandle, nsscript, seconds), false)!;
		...
		public static SCNAction Group (SCNAction[] actions)
		{
			...
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selGroup_XHandle, nsa_actions.Handle), false)!;
			return ret;
		}
		[Export ("hide")]
		[SupportedOSPlatform ("maccatalyst")]
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selHideXHandle), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_nfloat_nfloat_nfloat_Double (class_ptr, selMoveByX_Y_Z_Duration_XHandle, deltaX, deltaY, deltaZ, durationInSeconds), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_SCNVector3_Double (class_ptr, selMoveBy_Duration_XHandle, delta, durationInSeconds), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_SCNVector3_Double (class_ptr, selMoveTo_Duration_XHandle, location, durationInSeconds), false)!;
			return ret;
		}
		...
		public static SCNAction PlayAudioSource (SCNAudioSource source, bool wait)
		{
			...
			SCNAction? ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_bool (class_ptr, selPlayAudioSource_WaitForCompletion_XHandle, source__handle__, wait ? (byte) 1 : (byte) 0), false)!;
			GC.KeepAlive (source);
			return ret!;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selRemoveFromParentNodeXHandle), false)!;
			return ret;
		}
		...
		public static SCNAction RepeatAction (SCNAction action, nuint count)
		{
			...
			SCNAction? ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_UIntPtr (class_ptr, selRepeatAction_Count_XHandle, action__handle__, count), false)!;
			GC.KeepAlive (action);
			return ret!;
		}
		...
		public static SCNAction RepeatActionForever (SCNAction action)
		{
			var action__handle__ = action!.GetNonNullHandle (nameof (action));
			SCNAction? ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selRepeatActionForever_XHandle, action__handle__), false)!;
			GC.KeepAlive (action);
			return ret!;
		}
		...
		public virtual SCNAction ReversedAction ()
		{
			SCNAction ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selReversedActionXHandle), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selReversedActionXHandle), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_nfloat_nfloat_nfloat_Double (class_ptr, selRotateByX_Y_Z_Duration_XHandle, xAngle, yAngle, zAngle, durationInSeconds), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_nfloat_SCNVector3_Double (class_ptr, selRotateByAngle_AroundAxis_Duration_XHandle, angle, axis, durationInSeconds), false)!;
			return ret;
		}
		/// <param name="xAngle">To be added.</param><param name="yAngle">To be added.</param><param name="zAngle">To be added.</param><param name="durationInSeconds">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_nfloat_nfloat_nfloat_Double (class_ptr, selRotateToX_Y_Z_Duration_XHandle, xAngle, yAngle, zAngle, durationInSeconds), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_nfloat_nfloat_nfloat_Double_bool (class_ptr, selRotateToX_Y_Z_Duration_ShortestUnitArc_XHandle, xAngle, yAngle, zAngle, durationInSeconds, shortestUnitArc ? (byte) 1 : (byte) 0), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_SCNVector4_Double (class_ptr, selRotateToAxisAngle_Duration_XHandle, axisAngle, durationInSeconds), false)!;
			return ret;
		}
		[Export ("runBlock:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static SCNAction Run ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V117))]global::System.Action<SCNNode> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity1V117.CreateBlock (handler);
			BlockLiteral *block_ptr_handler = &block_handler;
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selRunBlock_XHandle, (IntPtr) block_ptr_handler), false)!;
			return ret;
		}
		[Export ("runBlock:queue:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static SCNAction Run ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V117))]global::System.Action<SCNNode> handler, global::CoreFoundation.DispatchQueue queue)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			...
			BlockLiteral *block_ptr_handler = &block_handler;
			SCNAction? ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, selRunBlock_Queue_XHandle, (IntPtr) block_ptr_handler, queue.Handle), false)!;
			GC.KeepAlive (queue);
			return ret!;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_nfloat_Double (class_ptr, selScaleBy_Duration_XHandle, scale, durationInSeconds), false)!;
			return ret;
		}
		/// <param name="scale">To be added.</param><param name="durationInSeconds">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_nfloat_Double (class_ptr, selScaleTo_Duration_XHandle, scale, durationInSeconds), false)!;
			return ret;
		}
		[Export ("sequence:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static SCNAction Sequence (SCNAction[] actions)
		{
			...
			using var nsa_actions = NSArray.FromNSObjects (actions);
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selSequence_XHandle, nsa_actions.Handle), false)!;
			return ret;
		}
		[Export ("unhide")]
		[SupportedOSPlatform ("maccatalyst")]
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selUnhideXHandle), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_Double (class_ptr, selWaitForDuration_XHandle, durationInSeconds), false)!;
			return ret;
		}
		...
		{
			SCNAction ret;
			ret =  Runtime.GetNSObject<SCNAction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_Double_Double (class_ptr, selWaitForDuration_WithRange_XHandle, durationInSeconds, durationRange), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public unsafe virtual global::System.Func<float, float>? TimingFunction {
			[return: DelegateProxy (typeof (ObjCRuntime.Trampolines.SDFuncArity2V10))]
			...
			get {
				...
				return global::ObjCRuntime.Trampolines.NIDFuncArity2V10.Create (ret)!;
			}
			[param: BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity2V10))]
			[Export ("setTimingFunction:", ArgumentSemantic.Assign)]
			set {
				using var block_value = Trampolines.SDFuncArity2V10.CreateNullableBlock (value);
		...
		public virtual SCNActionTimingMode TimingMode {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (SCNActionTimingMode) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selTimingModeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (SCNActionTimingMode) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selTimingModeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
