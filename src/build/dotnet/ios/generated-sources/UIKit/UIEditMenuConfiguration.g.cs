...
namespace UIKit {
	...
	public unsafe partial class UIEditMenuConfiguration : NSObject {
		...
		public static UIEditMenuConfiguration Create (INSCopying? identifier, CGPoint sourcePoint)
		{
			...
			UIEditMenuConfiguration? ret;
			ret =  Runtime.GetNSObject<UIEditMenuConfiguration> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_CGPoint (class_ptr, Selector.GetHandle ("configurationWithIdentifier:sourcePoint:"), identifier__handle__, sourcePoint), false)!;
		...
		public virtual UIEditMenuArrowDirection PreferredArrowDirection {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (UIEditMenuArrowDirection) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("preferredArrowDirection"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
			}
			[Export ("setPreferredArrowDirection:", ArgumentSemantic.Assign)]
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("setPreferredArrowDirection:"), (IntPtr) (long) value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual CGPoint SourcePoint {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.CGPoint_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("sourcePoint"));
						GC.KeepAlive (this);
					}
				}
				return ret;
