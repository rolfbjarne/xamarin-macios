	...
	public unsafe partial class MKMapFeatureAnnotation : NSObject, IMKAnnotation {
		...
		public virtual MKMapFeatureType FeatureType {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MKMapFeatureType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("featureType"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual MKIconStyle? IconStyle {
			...
			get {
				...
				MKIconStyle? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<MKIconStyle> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("iconStyle")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<MKIconStyle> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("iconStyle")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual global::MapKit.MKPointOfInterestCategory PointOfInterestCategory {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = global::MapKit.MKPointOfInterestCategoryExtensions.GetValue (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("pointOfInterestCategory")));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::MapKit.MKPointOfInterestCategoryExtensions.GetValue (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("pointOfInterestCategory")));
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		///
		/// // listening
		/// notification = MKMapFeatureAnnotation.Notifications.ObserveCalloutInfoDidChange ((sender, args) => {
		...
		/// void Callback (object sender, MKMapFeatureAnnotation.NSNotificationEventArgs args)
		/// {
		///     // Access strongly typed args
		///     Console.WriteLine ("Notification: {0}", args.Notification);
		/// }
		...
		/// void Setup ()
		/// {
		///     notification = MKMapFeatureAnnotation.Notifications.ObserveCalloutInfoDidChange (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		///     MKMapFeatureAnnotation.CalloutInfoDidChangeNotification, (notification) => { Console.WriteLine ("Received the notification CalloutInfoDidChange", notification); }
		/// );
		///
		/// // Method style
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (MKMapFeatureAnnotation.CalloutInfoDidChangeNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		[Field ("MKAnnotationCalloutInfoDidChangeNotification",  "MapKit")]
		[Advice ("Use MKMapFeatureAnnotation.Notifications.ObserveCalloutInfoDidChange helper method instead.")]
		...
		// Notifications
		//
		/// <summary>Notifications posted by the <see cref="global::MapKit.MKMapFeatureAnnotation" /> class.</summary>
		/// <remarks>
		///    <para>This class contains various helper methods that allow developers to observe events posted in the notification hub (<see cref="Foundation.NSNotificationCenter" />).</para>
		///    <para>The methods defined in this class post events that invoke the provided method or lambda with a <see cref="Foundation.NSNotificationEventArgs" /> parameter, which contains strongly typed properties for the notification arguments.</para>
		/// </remarks>
		public static partial class Notifications {
			/// <summary>Strongly typed notification for the <see cref="global::MapKit.MKMapFeatureAnnotation.CalloutInfoDidChangeNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::MapKit.MKMapFeatureAnnotation.CalloutInfoDidChangeNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = MKMapFeatureAnnotation.Notifications.ObserveCalloutInfoDidChange ((notification) => {
			...
			/// var token = MKMapFeatureAnnotation.Notifications.ObserveCalloutInfoDidChange (objectToObserve, (notification) => {
