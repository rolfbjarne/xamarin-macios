...
namespace AVFoundation {
	...
	public unsafe partial class AVCaption : NSObject, INSCoding, INSCopying, INSMutableCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selBackgroundColorAtIndex_Range_X = "backgroundColorAtIndex:range:";
		static readonly NativeHandle selBackgroundColorAtIndex_Range_XHandle = Selector.GetHandle ("backgroundColorAtIndex:range:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCopyWithZone_X = "copyWithZone:";
		static readonly NativeHandle selCopyWithZone_XHandle = Selector.GetHandle ("copyWithZone:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDecorationAtIndex_Range_X = "decorationAtIndex:range:";
		static readonly NativeHandle selDecorationAtIndex_Range_XHandle = Selector.GetHandle ("decorationAtIndex:range:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeWithCoder_X = "encodeWithCoder:";
		static readonly NativeHandle selEncodeWithCoder_XHandle = Selector.GetHandle ("encodeWithCoder:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selFontStyleAtIndex_Range_X = "fontStyleAtIndex:range:";
		static readonly NativeHandle selFontStyleAtIndex_Range_XHandle = Selector.GetHandle ("fontStyleAtIndex:range:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selFontWeightAtIndex_Range_X = "fontWeightAtIndex:range:";
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRubyAtIndex_Range_X = "rubyAtIndex:range:";
		static readonly NativeHandle selRubyAtIndex_Range_XHandle = Selector.GetHandle ("rubyAtIndex:range:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextColorAtIndex_Range_X = "textColorAtIndex:range:";
		static readonly NativeHandle selTextColorAtIndex_Range_XHandle = Selector.GetHandle ("textColorAtIndex:range:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextCombineAtIndex_Range_X = "textCombineAtIndex:range:";
		static readonly NativeHandle selTextCombineAtIndex_Range_XHandle = Selector.GetHandle ("textCombineAtIndex:range:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public unsafe virtual CGColor? GetBackgroundColor (nint index, out NSRange outRange)
		{
			...
			CGColor ret;
			if (IsDirectBinding) {
				ret = Runtime.GetINativeObject<global::CoreGraphics.CGColor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_out_NSRange (this.Handle, selBackgroundColorAtIndex_Range_XHandle, index, outRange__pointer), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = Runtime.GetINativeObject<global::CoreGraphics.CGColor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr_out_NSRange (&__objc_super__, selBackgroundColorAtIndex_Range_XHandle, index, outRange__pointer), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public unsafe virtual AVCaptionDecoration GetDecoration (nint index, out NSRange outRange)
		{
			...
			if (IsDirectBinding) {
				ret = (AVCaptionDecoration) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend_IntPtr_out_NSRange (this.Handle, selDecorationAtIndex_Range_XHandle, index, outRange__pointer);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = (AVCaptionDecoration) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper_IntPtr_out_NSRange (&__objc_super__, selDecorationAtIndex_Range_XHandle, index, outRange__pointer);
					GC.KeepAlive (this);
				}
			}
			return ret!;
		...
		public unsafe virtual AVCaptionFontStyle GetFontStyle (nint index, out NSRange outRange)
		{
			...
			if (IsDirectBinding) {
				ret = (AVCaptionFontStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_IntPtr_out_NSRange (this.Handle, selFontStyleAtIndex_Range_XHandle, index, outRange__pointer);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = (AVCaptionFontStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_IntPtr_out_NSRange (&__objc_super__, selFontStyleAtIndex_Range_XHandle, index, outRange__pointer);
					GC.KeepAlive (this);
				}
			}
			return ret!;
		...
		public unsafe virtual AVCaptionFontWeight GetFontWeight (nint index, out NSRange outRange)
		{
			...
			if (IsDirectBinding) {
				ret = (AVCaptionFontWeight) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_IntPtr_out_NSRange (this.Handle, selFontWeightAtIndex_Range_XHandle, index, outRange__pointer);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = (AVCaptionFontWeight) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_IntPtr_out_NSRange (&__objc_super__, selFontWeightAtIndex_Range_XHandle, index, outRange__pointer);
					GC.KeepAlive (this);
				}
			}
			return ret!;
		...
		public unsafe virtual AVCaptionRuby? GetRuby (nint index, out NSRange outRange)
		{
			...
			AVCaptionRuby ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<AVCaptionRuby> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_out_NSRange (this.Handle, selRubyAtIndex_Range_XHandle, index, outRange__pointer), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<AVCaptionRuby> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr_out_NSRange (&__objc_super__, selRubyAtIndex_Range_XHandle, index, outRange__pointer), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public unsafe virtual CGColor? GetTextColor (nint index, out NSRange outRange)
		{
			...
			CGColor ret;
			if (IsDirectBinding) {
				ret = Runtime.GetINativeObject<global::CoreGraphics.CGColor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_out_NSRange (this.Handle, selTextColorAtIndex_Range_XHandle, index, outRange__pointer), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = Runtime.GetINativeObject<global::CoreGraphics.CGColor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr_out_NSRange (&__objc_super__, selTextColorAtIndex_Range_XHandle, index, outRange__pointer), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public unsafe virtual AVCaptionTextCombine GetTextCombine (nint index, out NSRange outRange)
		{
			...
			if (IsDirectBinding) {
				ret = (AVCaptionTextCombine) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_IntPtr_out_NSRange (this.Handle, selTextCombineAtIndex_Range_XHandle, index, outRange__pointer);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = (AVCaptionTextCombine) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_IntPtr_out_NSRange (&__objc_super__, selTextCombineAtIndex_Range_XHandle, index, outRange__pointer);
					GC.KeepAlive (this);
				}
			}
			return ret!;
