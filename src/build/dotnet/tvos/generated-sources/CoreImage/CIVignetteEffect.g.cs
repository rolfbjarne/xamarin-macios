...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that modifies the brightness of the outside of an image.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CIVignetteEffect filter with the input image
	...
	/// var output = vignette_effect.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/vignette_effect.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIVignetteEffect : CIFilter, ICIVignetteEffectProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIVignetteEffect" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIVignetteEffect () : base ("CIVignetteEffect")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIVignetteEffect (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIVignetteEffect (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIVignetteEffect (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIVignetteEffectProtocol protocol members 
		...
		public float Falloff {
			[Export ("falloff")]
			get {
				return GetFloat ("inputFalloff");
			}
			[Export ("setFalloff:")]
			set {
				SetFloat ("inputFalloff", value);
			}
		}
