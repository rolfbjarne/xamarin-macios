...
namespace VideoToolbox {
	...
	public unsafe partial class VTLowLatencySuperResolutionScalerConfiguration : NSObject, IVTFrameProcessorConfiguration {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithFrameWidth_FrameHeight_ScaleFactor_X = "initWithFrameWidth:frameHeight:scaleFactor:";
		static readonly NativeHandle selInitWithFrameWidth_FrameHeight_ScaleFactor_XHandle = Selector.GetHandle ("initWithFrameWidth:frameHeight:scaleFactor:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSupportedScaleFactorsForFrameWidth_FrameHeight_X = "supportedScaleFactorsForFrameWidth:frameHeight:";
		static readonly NativeHandle selSupportedScaleFactorsForFrameWidth_FrameHeight_XHandle = Selector.GetHandle ("supportedScaleFactorsForFrameWidth:frameHeight:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr_float (this.Handle, selInitWithFrameWidth_FrameHeight_ScaleFactor_XHandle, frameWidth, frameHeight, scaleFactor), "initWithFrameWidth:frameHeight:scaleFactor:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr_IntPtr_float (&__objc_super__, selInitWithFrameWidth_FrameHeight_ScaleFactor_XHandle, frameWidth, frameHeight, scaleFactor), "initWithFrameWidth:frameHeight:scaleFactor:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		{
			nint[] ret;
			ret = NSArray.ArrayFromHandleFunc <nint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (class_ptr, selSupportedScaleFactorsForFrameWidth_FrameHeight_XHandle, frameWidth, frameHeight), NSNumber.ToNInt, false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[SupportedOSPlatform ("ios26.0")]
