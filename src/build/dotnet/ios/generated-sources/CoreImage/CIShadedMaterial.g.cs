...
namespace CoreImage {
	...
	public partial class CIShadedMaterial : CIFilter, ICIShadedMaterialProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIShadedMaterial" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIShadedMaterial () : base ("CIShadedMaterial")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIShadedMaterial (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIShadedMaterial (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIShadedMaterial (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIShadedMaterialProtocol protocol members 
		...
		/// <summary>Gets or sets the height field to use for shading.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos13.0")]
		[SupportedOSPlatform ("maccatalyst")]
		...
		/// <summary>Gets or sets a multiplier for the height field.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos13.0")]
		[SupportedOSPlatform ("maccatalyst")]
