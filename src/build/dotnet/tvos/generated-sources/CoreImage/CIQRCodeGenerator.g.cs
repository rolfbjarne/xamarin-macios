...
#nullable enable
namespace CoreImage {
	/// <summary>Generates a QR code.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/qr_code_generator.png" alt="Result of applying the filter." /></para></remarks>
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public partial class CIQRCodeGenerator : CICodeGenerator, ICIQRCodeGeneratorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIQRCodeGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIQRCodeGenerator () : base ("CIQRCodeGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIQRCodeGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIQRCodeGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIQRCodeGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIQRCodeGeneratorProtocol protocol members 
