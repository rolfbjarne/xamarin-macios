...
namespace CoreImage {
	...
	public partial class CIGlassLozenge : CIFilter, ICIGlassLozengeProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIGlassLozenge" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIGlassLozenge () : base ("CIGlassLozenge")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIGlassLozenge (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIGlassLozenge (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIGlassLozenge (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
