...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIFilter" /> that creates a grayscale image from the minimum component of the RGB values.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/minimum_component.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIMinimumComponent : CIFilter, ICIMinimumComponentProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIMinimumComponent" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMinimumComponent (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMinimumComponent (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMinimumComponent (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIMinimumComponentProtocol protocol members 
