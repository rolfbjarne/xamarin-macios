...
namespace BundledResources {
	...
	public class ResourcesTest {
		...
		public void Bundled ()
		{
			...
			ClassicAssert.True (File.Exists (Path.Combine (dir, "basn3p08.png")), "file-basn3p08.png");
			ClassicAssert.True (File.Exists (Path.Combine (dir, "basn3p08_with_loc.png")), "file-basn3p08_with_loc.png");
			ClassicAssert.True (File.Exists (Path.Combine (dir, "xamvideotest.mp4")), "xamvideotest.mp4");
