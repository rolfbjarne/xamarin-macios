...
namespace MapKit {
	...
	public unsafe partial class MKLocalPointsOfInterestRequest : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithCenterCoordinate_Radius_X = "initWithCenterCoordinate:radius:";
		static readonly NativeHandle selInitWithCenterCoordinate_Radius_XHandle = Selector.GetHandle ("initWithCenterCoordinate:radius:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithCoordinateRegion_X = "initWithCoordinateRegion:";
		static readonly NativeHandle selInitWithCoordinateRegion_XHandle = Selector.GetHandle ("initWithCoordinateRegion:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_CLLocationCoordinate2D_Double (this.Handle, selInitWithCenterCoordinate_Radius_XHandle, centerCoordinate, radius), "initWithCenterCoordinate:radius:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_CLLocationCoordinate2D_Double (&__objc_super__, selInitWithCenterCoordinate_Radius_XHandle, centerCoordinate, radius), "initWithCenterCoordinate:radius:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		{
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_MKCoordinateRegion (this.Handle, selInitWithCoordinateRegion_XHandle, region), "initWithCoordinateRegion:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_MKCoordinateRegion (&__objc_super__, selInitWithCoordinateRegion_XHandle, region), "initWithCoordinateRegion:");
					GC.KeepAlive (this);
				}
			}
		}
