...
namespace Photos {
	...
	public unsafe partial class PHPhotoLibrary : NSObject {
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void RequestAuthorization ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V230))]global::System.Action<PHAuthorizationStatus> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity1V230.CreateBlock (handler);
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void RequestAuthorization (PHAccessLevel accessLevel, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V230))]global::System.Action<PHAuthorizationStatus> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity1V230.CreateBlock (handler);
