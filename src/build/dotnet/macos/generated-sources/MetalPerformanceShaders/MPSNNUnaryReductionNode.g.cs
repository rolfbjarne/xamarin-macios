...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSNNUnaryReductionNode : MPSNNFilterNode {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSNNUnaryReductionNode");
		...
		protected MPSNNUnaryReductionNode (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSNNUnaryReductionNode (NativeHandle handle) : base (handle)
		{
		}
		...
		{
			var sourceNode__handle__ = sourceNode!.GetNonNullHandle (nameof (sourceNode));
			MPSNNUnaryReductionNode? ret;
			ret =  Runtime.GetNSObject<MPSNNUnaryReductionNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selNodeWithSource_XHandle, sourceNode__handle__), false)!;
			GC.KeepAlive (sourceNode);
			return ret!;
		}
