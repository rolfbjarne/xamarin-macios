	...
	public unsafe partial class MTL4AccelerationStructureTriangleGeometryDescriptor : MTL4AccelerationStructureGeometryDescriptor {
		...
		public virtual MTL4BufferRange VertexBuffer {
			...
			get {
				MTL4BufferRange ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.MTL4BufferRange_objc_msgSend (this.Handle, selVertexBufferXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.MTL4BufferRange_objc_msgSendSuper (&__objc_super__, selVertexBufferXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_MTL4BufferRange (this.Handle, selSetVertexBuffer_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_MTL4BufferRange (&__objc_super__, selSetVertexBuffer_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
