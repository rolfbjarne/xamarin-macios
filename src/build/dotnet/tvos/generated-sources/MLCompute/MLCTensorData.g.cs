...
namespace MLCompute {
	...
	public unsafe partial class MLCTensorData : NSObject {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static MLCTensorData CreateFromBytesNoCopy (nint bytes, nuint length, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V51))]global::System.Action<nint, nuint> deallocator)
		{
			if (deallocator is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (deallocator));
			using var block_deallocator = Trampolines.SDActionArity2V51.CreateBlock (deallocator);
