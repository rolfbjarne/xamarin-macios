...
#pragma warning restore 0414
		...
		public static int RunCommand (string path, string args, Dictionary<string, string> env = null, StringBuilder output = null, bool suppressPrintOnErrors = false)
		{
			return ProcessHelper.Run (path, args, env, output, verbose > 0, !suppressPrintOnErrors);
		}

		public static Task<int> RunCommandAsync (string path, string args, Dictionary<string, string> env = null, StringBuilder output = null, bool suppressPrintOnErrors = false)
		{
