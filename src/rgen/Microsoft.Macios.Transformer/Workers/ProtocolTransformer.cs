...
class ProtocolTransformer (string destinationDirectory) : ITransformer<(string Path, Binding Binding)> {

	readonly static ILogger logger = Log.ForContext<ProtocolTransformer> ();
