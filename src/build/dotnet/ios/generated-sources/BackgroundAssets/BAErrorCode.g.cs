...
namespace BackgroundAssets {
	...
	/// <summary>Extension methods for the <see cref="global::BackgroundAssets.BAErrorCode" /> enumeration.</summary>
	/// <remarks>
	///   <para>The extension method for the <see cref="global::BackgroundAssets.BAErrorCode" /> enumeration can be used to fetch the error domain associated with these error codes.</para>
	/// </remarks>
	[SupportedOSPlatform ("tvos18.4")]
	[SupportedOSPlatform ("macos14.0")]
	[SupportedOSPlatform ("ios17.0")]
	...
	static public partial class BAErrorCodeExtensions {
		[Field ("BAErrorDomain", "BackgroundAssets")]
		static NSString? _domain;
		/// <summary>Returns the error domain associated with the BackgroundAssets.BAErrorCode value</summary>
		/// <param name="self">The enumeration value</param>
		/// <remarks>
		///   <para>See the <see cref="global::Foundation.NSError" /> for information on how to use the error domains when reporting errors.</para>
		/// </remarks>
		public static NSString? GetDomain (this BAErrorCode self)
		{
			if (_domain is null)
				_domain = Dlfcn.GetStringConstant (Libraries.BackgroundAssets.Handle, "BAErrorDomain");
			return _domain;
		}
	}
}
