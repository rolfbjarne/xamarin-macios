...
namespace CoreVideo {
	public unsafe partial class CVPixelFormatKeys  {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _OpenGlesCompatibility;
		/// <summary>Represents the value associated with the constant 'kCVPixelFormatOpenGLESCompatibility'.</summary>
		[Field ("kCVPixelFormatOpenGLESCompatibility",  "CoreVideo")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[UnsupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("tvos")]
		public static NSString OpenGlesCompatibility {
			[UnsupportedOSPlatform ("maccatalyst")]
			[UnsupportedOSPlatform ("macos")]
			[SupportedOSPlatform ("ios")]
			[SupportedOSPlatform ("tvos")]
			get {
				if (_OpenGlesCompatibility is null)
					_OpenGlesCompatibility = Dlfcn.GetStringConstant (Libraries.CoreVideo.Handle, "kCVPixelFormatOpenGLESCompatibility")!;
				return _OpenGlesCompatibility;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
