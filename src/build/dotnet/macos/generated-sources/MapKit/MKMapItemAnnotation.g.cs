...
#nullable enable
namespace MapKit {
	[Register("MKMapItemAnnotation", true)]
	[SupportedOSPlatform ("tvos18.0")]
	[SupportedOSPlatform ("macos15.0")]
	[SupportedOSPlatform ("ios18.0")]
	[SupportedOSPlatform ("maccatalyst18.0")]
	public unsafe partial class MKMapItemAnnotation : NSObject, IMKAnnotation {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MKMapItemAnnotation");
		...
		protected MKMapItemAnnotation (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MKMapItemAnnotation (NativeHandle handle) : base (handle)
		{
		}
		...
		///
		/// // listening
		/// notification = MKMapItemAnnotation.Notifications.ObserveCalloutInfoDidChange ((sender, args) => {
		...
		/// void Callback (object sender, MKMapItemAnnotation.NSNotificationEventArgs args)
		/// {
		///     // Access strongly typed args
		///     Console.WriteLine ("Notification: {0}", args.Notification);
		/// }
		...
		/// void Setup ()
		/// {
		///     notification = MKMapItemAnnotation.Notifications.ObserveCalloutInfoDidChange (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		///     MKMapItemAnnotation.CalloutInfoDidChangeNotification, (notification) => { Console.WriteLine ("Received the notification CalloutInfoDidChange", notification); }
		/// );
		///
		/// // Method style
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (MKMapItemAnnotation.CalloutInfoDidChangeNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		[Field ("MKAnnotationCalloutInfoDidChangeNotification",  "MapKit")]
		[Advice ("Use MKMapItemAnnotation.Notifications.ObserveCalloutInfoDidChange helper method instead.")]
		...
		// Notifications
		//
		/// <summary>Notifications posted by the <see cref="global::MapKit.MKMapItemAnnotation" /> class.</summary>
		/// <remarks>
		///    <para>This class contains various helper methods that allow developers to observe events posted in the notification hub (<see cref="Foundation.NSNotificationCenter" />).</para>
		///    <para>The methods defined in this class post events that invoke the provided method or lambda with a <see cref="Foundation.NSNotificationEventArgs" /> parameter, which contains strongly typed properties for the notification arguments.</para>
		/// </remarks>
		public static partial class Notifications {
			/// <summary>Strongly typed notification for the <see cref="global::MapKit.MKMapItemAnnotation.CalloutInfoDidChangeNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::MapKit.MKMapItemAnnotation.CalloutInfoDidChangeNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = MKMapItemAnnotation.Notifications.ObserveCalloutInfoDidChange ((notification) => {
			...
			/// var token = MKMapItemAnnotation.Notifications.ObserveCalloutInfoDidChange (objectToObserve, (notification) => {
