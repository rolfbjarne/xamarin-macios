...
namespace Xamarin.Tests {
	...
	public class TestEngine
	{
		...
		public ProjectItem? GetGlobalProperty (string name)
		{
			if (Properties.TryGetValue (name, out var value))
				return new ProjectItem { EvaluatedValue = value };
			return null;
		}
		...
		public TestEngine Logger => this;
		public TestEngine ProjectCollection => this;
		...
		public string? GetPropertyValue (string name)
		{
			...
			return props.LastOrDefault ()?.Value;
		}
