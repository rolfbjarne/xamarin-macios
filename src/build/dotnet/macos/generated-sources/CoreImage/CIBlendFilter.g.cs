...
namespace CoreImage {
	...
	public abstract partial class CIBlendFilter : CIFilter {
		...
		protected CIBlendFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBlendFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBlendFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIBlendFilter" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected  CIBlendFilter (string name) : base (CreateFilter (name))
		{
		}
