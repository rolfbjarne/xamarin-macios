...
namespace ClassKit {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "UpdateDescendants", Selector = "updateDescendantsOfContext:completion:", ParameterType = new Type [] { typeof (ClassKit.CLSContext), typeof (global::System.Action<NSError>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V16) })]
	public partial interface ICLSContextProvider : INativeObject, IDisposable
	{
		...
		public unsafe virtual void UpdateDescendants (CLSContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V16))]global::System.Action<NSError> completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="context">To be added.</param><param name="completion">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _UpdateDescendants (ICLSContextProvider This, CLSContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V16))]global::System.Action<NSError> completion)
		{
	...
	internal unsafe sealed class CLSContextProviderWrapper : BaseWrapper, ICLSContextProvider {
		...
		[Export ("updateDescendantsOfContext:completion:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void UpdateDescendants (CLSContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V16))]global::System.Action<NSError> completion)
		{
			var context__handle__ = context!.GetNonNullHandle (nameof (context));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
