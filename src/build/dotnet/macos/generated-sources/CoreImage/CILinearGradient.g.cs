...
#nullable enable
namespace CoreImage {
	/// <summary>A gradient that fades one color linearly into another.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/LinearGradient.png" alt="Result of applying the filter." /></para></remarks>
	public partial class CILinearGradient : CIFilter, ICILinearGradientProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CILinearGradient" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CILinearGradient () : base ("CILinearGradient")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CILinearGradient (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILinearGradient (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILinearGradient (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CILinearGradient" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public  CILinearGradient (string name) : base (CreateFilter (name))
		{
		}
		// CILinearGradientProtocol protocol members 
