...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIKeystoneCorrectionVertical</c>.</summary>
	/// <remarks>
	...
	public partial interface ICIKeystoneCorrectionVerticalProtocol : INativeObject, IDisposable, 
		CoreImage.ICIFilterProtocol
		, CoreImage.ICIFourCoordinateGeometryFilterProtocol
	{
		[DynamicDependencyAttribute ("FocalLength")]
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIKeystoneCorrectionVerticalProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICIKeystoneCorrectionVerticalProtocol ()
		{
			GC.KeepAlive (null);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static float _GetFocalLength (ICIKeystoneCorrectionVerticalProtocol This)
		{
			float ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetFocalLength (ICIKeystoneCorrectionVerticalProtocol This, float value)
		{
	...
	internal unsafe sealed class CIKeystoneCorrectionVerticalProtocolWrapper : BaseWrapper, ICIKeystoneCorrectionVerticalProtocol {
		public CIKeystoneCorrectionVerticalProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIKeystoneCorrectionVerticalProtocolWrapper))]
		static CIKeystoneCorrectionVerticalProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
