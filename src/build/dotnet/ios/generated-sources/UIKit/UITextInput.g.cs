...
namespace UIKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "InsertInputSuggestion", Selector = "insertInputSuggestion:", ParameterType = new Type [] { typeof (UIInputSuggestion) }, ParameterByRef = new bool [] { false })]
		...
		, UIKit.IUITextInputTraits
	{
		...
		{
			_InsertInputSuggestion (this, inputSuggestion);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios18.4")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _InsertInputSuggestion (IUITextInput This, UIInputSuggestion inputSuggestion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
		...
		[DynamicDependencyAttribute ("InsertInputSuggestion(UIKit.UIInputSuggestion)")]
	...
	public unsafe static partial class UITextInput_Extensions {
		...
		[UnsupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void InsertInputSuggestion (this IUITextInput This, UIInputSuggestion inputSuggestion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var inputSuggestion__handle__ = inputSuggestion!.GetNonNullHandle (nameof (inputSuggestion));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("insertInputSuggestion:"), inputSuggestion__handle__);
