...
namespace Metal {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "Synchronize", Selector = "synchronizeTexture:slice:level:", ParameterType = new Type [] { typeof (IMTLTexture), typeof (UIntPtr), typeof (UIntPtr) }, ParameterByRef = new bool [] { false, false, false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "GetTextureAccessCounters", Selector = "getTextureAccessCounters:region:mipLevel:slice:resetCounters:countersBuffer:countersBufferOffset:", ParameterType = new Type [] { typeof (IMTLTexture), typeof (MTLRegion), typeof (UIntPtr), typeof (UIntPtr), typeof (bool), typeof (IMTLBuffer), typeof (UIntPtr) }, ParameterByRef = new bool [] { false, false, false, false, false, false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ResetTextureAccessCounters", Selector = "resetTextureAccessCounters:region:mipLevel:slice:", ParameterType = new Type [] { typeof (IMTLTexture), typeof (MTLRegion), typeof (UIntPtr), typeof (UIntPtr) }, ParameterByRef = new bool [] { false, false, false, false })]
		...
		Metal.IMTLCommandEncoder
	{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _Synchronize (IMTLBlitCommandEncoder This, IMTLResource resource)
		{
			var resource__handle__ = resource!.GetNonNullHandle (nameof (resource));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("synchronizeResource:"), resource__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (resource);
		}
		/// <param name="texture">To be added.</param><param name="slice">To be added.</param><param name="level">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[global::Foundation.RequiredMember]
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _Synchronize (IMTLBlitCommandEncoder This, IMTLTexture texture, nuint slice, nuint level)
		{
			var texture__handle__ = texture!.GetNonNullHandle (nameof (texture));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_UIntPtr_UIntPtr (This.Handle, Selector.GetHandle ("synchronizeTexture:slice:level:"), texture__handle__, slice, level);
			GC.KeepAlive (This);
		...
		{
			_GetTextureAccessCounters (this, texture, region, mipLevel, slice, resetCounters, countersBuffer, countersBufferOffset);
		}
		[SupportedOSPlatform ("tvos16.0")]
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("maccatalyst")]
		...
		{
			_ResetTextureAccessCounters (this, texture, region, mipLevel, slice);
		}
		[SupportedOSPlatform ("tvos16.0")]
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("maccatalyst")]
		...
		[DynamicDependencyAttribute ("Synchronize(Metal.IMTLResource)")]
		[DynamicDependencyAttribute ("Synchronize(Metal.IMTLTexture,System.UIntPtr,System.UIntPtr)")]
