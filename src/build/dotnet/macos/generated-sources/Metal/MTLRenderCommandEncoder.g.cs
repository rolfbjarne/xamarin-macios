...
namespace Metal {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "TextureBarrier", Selector = "textureBarrier")]
		...
		Metal.IMTLCommandEncoder
	{
		...
		[ObsoletedOSPlatform ("macos10.14", "Use 'MemoryBarrier (MTLBarrierScope, MTLRenderStages, MTLRenderStages)' instead.")]
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _TextureBarrier (IMTLRenderCommandEncoder This)
		{
			global::ObjCRuntime.Messaging.void_objc_msgSend (This.Handle, Selector.GetHandle ("textureBarrier"));
			GC.KeepAlive (This);
		}
		...
		[DynamicDependencyAttribute ("TextureBarrier()")]
