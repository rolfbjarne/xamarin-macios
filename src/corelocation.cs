...
namespace CoreLocation {
	...
	/// <remarks>The CLLocation class stores location data generated by the system and can be used to compute the distance between two locations.</remarks>
	...
	partial interface CLLocation : NSSecureCoding, NSCopying, CKRecordValue {
		...
		/// <remarks>Altitude, accuracies, and timestamp are stored in the resulting object.</remarks>
		[Export ("initWithLatitude:longitude:")]
		NativeHandle Constructor (double latitude, double longitude);

		/// <param name="coordinate">The geographical coordinate.</param>
		/// <param name="altitude">The altitude in meters.</param>
		/// <param name="hAccuracy">The horizontal accuracy in meters.</param>
		/// <param name="vAccuracy">The vertical accuracy in meters.</param>
		/// <param name="timestamp">The time the location was determined.</param>
		/// <summary>Constructor that allows the app developer to specify the accuracy and time.</summary>
		/// <remarks>A negative accuracy value indicates the coordinate or altitude is invalid.</remarks>
		...
		/// <param name="location">The location to measure the distance to.</param>
		...
		/// <param name="hAccuracy">The horizontal accuracy in meters.</param>
		/// <param name="vAccuracy">The vertical accuracy in meters.</param>
		/// <param name="course">The course (direction of travel) in degrees relative to true north.</param>
		...
		/// <remarks>Speed and course information can be included in the resulting location object.</remarks>
...
#if !XAMCORE_5_0
		/// <summary>Gets the location accuracy constant for best navigation accuracy.</summary>
		...
		/// <summary>Gets the location accuracy constant for best accuracy.</summary>
		[Field ("kCLLocationAccuracyBest")]
		double AccuracyBest { get; }

		/// <summary>Gets the location accuracy constant for nearest ten meters.</summary>
		[Field ("kCLLocationAccuracyNearestTenMeters")]
		double AccuracyNearestTenMeters { get; }

		/// <summary>Gets the location accuracy constant for hundred meters.</summary>
		[Field ("kCLLocationAccuracyHundredMeters")]
		double AccuracyHundredMeters { get; }

		/// <summary>Gets the location accuracy constant for one kilometer.</summary>
		[Field ("kCLLocationAccuracyKilometer")]
		double AccuracyKilometer { get; }

		/// <summary>Gets the location accuracy constant for three kilometers.</summary>
		...
		/// <summary>Gets the floor of the building in which the user is located.</summary>
		[MacCatalyst (13, 1)]
	...
	/// <remarks>Use the Level property to determine the floor of the building.</remarks>
	...
	partial interface CLFloor : NSSecureCoding, NSCopying {
		/// <summary>Gets the logical floor of the building.</summary>
		[Export ("level")]
		nint Level { get; }
	}
	...
	partial interface CLLocationManager {
		...
		/// <param name="region">The region to stop monitoring.</param>
		...
		/// <param name="region">The beacon region to stop ranging.</param>
		...
		/// <summary>Gets or sets whether the status bar location indicator is shown when using background location updates.</summary>
		[NoTV]
		[MacCatalyst (13, 1)]
	...
	partial interface CLLocationManagerDelegate {
		...
		/// <param name="oldLocation">The previously reported location.</param>
		...
		/// <param name="region">The region that failed to be monitored.</param>
		...
		/// <param name="region">The region that started being monitored.</param>
		...
		/// <param name="manager">The <see cref="CoreLocation.CLLocationManager" /> for which <c>this</c> is the delegate object.</param>
		/// <param name="region">The beacon region being ranged.</param>
		/// <param name="error">The error that caused ranging to fail.</param>
		///         <summary>
		...
		/// <param name="manager">The location manager that generated the visit event.</param>
		/// <param name="visit">The visit object containing arrival and departure information.</param>
		/// <summary>Called when the user visits a location.</summary>
		[NoTV]
		[MacCatalyst (13, 1)]
		...
		/// <param name="manager">The <see cref="CoreLocation.CLLocationManager" /> for which <c>this</c> is the delegate object.</param>
		/// <param name="locations">The array of location objects representing the new locations.</param>
	...
	/// <remarks>Use constants from this class for distance filtering and maximum distance values.</remarks>
	[Static]
	...
	partial interface CLRegion : NSSecureCoding, NSCopying {
		...
		/// <remarks>This constructor is deprecated. Use CLCircularRegion instead.</remarks>
		[NoTV]
		[Deprecated (PlatformName.iOS, 7, 0, message: "Use 'CLCircularRegion' instead.")]
		[Deprecated (PlatformName.MacOSX, 10, 10, message: "Use 'CLCircularRegion' instead.")]
		[MacCatalyst (13, 1)]
	...
	interface CLPlacemark : NSSecureCoding, NSCopying {
		...
		/// <summary>Gets the postal address representation of the placemark.</summary>
		///         <value>
	...
	/// <remarks>Use CLCircularGeographicCondition for new development on newer platforms.</remarks>
	...
	partial interface CLCircularRegion {
		...
		/// <remarks>The center and radius define the boundary of the circular region.</remarks>
		...
		/// <returns><see langword="true" /> if the coordinate is inside the region; otherwise, <see langword="false" />.</returns>
		[Export ("containsCoordinate:")]
	...
	interface CLGeocoder {
		...
		[Async (XmlDocs = """
			...
			<summary>Reverse geocodes a location asynchronously.</summary>
			<returns>
			...
			<remarks>The returned placemarks contain address information for the specified coordinates.</remarks>
			""")]
		void ReverseGeocodeLocation (CLLocation location, CLGeocodeCompletionHandler completionHandler);

		/// <param name="location">The location to reverse geocode.</param>
		///         <param name="locale">
		///           <para>The preferred locale for results.</para>
		///           <para tool="nullallowed">This parameter can be <see langword="null" />.</para>
		///         </param>
		///         <param name="completionHandler">The handler to call with results.</param>
		///         <summary>Reverse geocodes a location using the preferred locale.</summary>
		[Deprecated (PlatformName.iOS, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		[Deprecated (PlatformName.MacCatalyst, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		[Deprecated (PlatformName.TvOS, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		[Deprecated (PlatformName.MacOSX, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		...
		[Async (XmlDocs = """
			<param name="location">The location to reverse geocode.</param>
			<param name="locale">The preferred locale for results.</param>
			<summary>Reverse geocodes a location asynchronously with the specified locale.</summary>
			<returns>A task representing the asynchronous reverse geocoding operation.</returns>
			<remarks>Results are formatted using the specified locale.</remarks>
			""")]
		...
		[Async (XmlDocs = """
			...
			<remarks>The returned task contains geocoded address results.</remarks>
			""")]
		...
		[Async (XmlDocs = """
			<param name="addressString">The address string to geocode.</param>
			<summary>Geocodes the specified address string asynchronously.</summary>
			<returns>
			          <para>A task that represents the asynchronous GeocodeAddress operation.   The value of the TResult parameter is a <see cref="CoreLocation.CLGeocodeCompletionHandler" />.</para>
			        </returns>
			<remarks>
		...
		///         </param>
		///         <param name="completionHandler">The handler to call with results.</param>
		///         <summary>Geocodes an address string with region and locale preferences.</summary>
		[Deprecated (PlatformName.iOS, 26, 0, "Use 'MKGeocodingRequest' instead.")]
		[Deprecated (PlatformName.MacCatalyst, 26, 0, "Use 'MKGeocodingRequest' instead.")]
		[Deprecated (PlatformName.TvOS, 26, 0, "Use 'MKGeocodingRequest' instead.")]
		[Deprecated (PlatformName.MacOSX, 26, 0, "Use 'MKGeocodingRequest' instead.")]
		...
		[Async (XmlDocs = """
			...
			<param name="region">The region to limit results to.</param>
			<param name="locale">The preferred locale for results.</param>
			<summary>Geocodes an address string asynchronously with region and locale preferences.</summary>
			<returns>A task representing the asynchronous geocoding operation.</returns>
			<remarks>Region and locale help prioritize and format results.</remarks>
			""")]
		...
		/// <param name="postalAddress">The postal address to geocode.</param>
		///         <param name="completionHandler">The handler to call with results.</param>
		///         <summary>Geocodes a postal address.</summary>
		[Deprecated (PlatformName.iOS, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		[Deprecated (PlatformName.MacCatalyst, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		[Deprecated (PlatformName.TvOS, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		[Deprecated (PlatformName.MacOSX, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		...
		[Async (XmlDocs = """
			<param name="postalAddress">The postal address to geocode.</param>
			<summary>Geocodes a postal address asynchronously.</summary>
			<returns>
			...
			<remarks>
			          ...
			          <para>The GeocodePostalAddressAsync method is suitable to be used with C# async by returning control to the caller with a Task representing the operation.</para>
			        </remarks>
			""")]
		...
		///         </param>
		///         <param name="completionHandler">The handler to call with results.</param>
		///         <summary>Geocodes a postal address with locale preference.</summary>
		[Deprecated (PlatformName.iOS, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		[Deprecated (PlatformName.MacCatalyst, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		[Deprecated (PlatformName.TvOS, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		[Deprecated (PlatformName.MacOSX, 26, 0, "Use 'MKReverseGeocodingRequest' instead.")]
		...
		[Async (XmlDocs = """
			<param name="postalAddress">The postal address to geocode.</param>
			<param name="locale">The preferred locale for results.</param>
			<summary>Geocodes a postal address asynchronously with the specified locale.</summary>
			<returns>A task representing the asynchronous geocoding operation.</returns>
			<remarks>Results are formatted using the specified locale.</remarks>
			""")]
	...
	interface CLVisit : NSSecureCoding, NSCopying {
		...
		/// <summary>Gets the date when the user arrived at the location.</summary>
		[Export ("arrivalDate", ArgumentSemantic.Copy)]
		NSDate ArrivalDate { get; }

		/// <summary>Gets the date when the user departed from the location.</summary>
		[Export ("departureDate", ArgumentSemantic.Copy)]
		NSDate DepartureDate { get; }

		/// <summary>Gets the geographical coordinate of the visited location.</summary>
		[Export ("coordinate")]
		CLLocationCoordinate2D Coordinate { get; }

		/// <summary>Gets the horizontal accuracy of the visited location in meters.</summary>
		[Export ("horizontalAccuracy")]
		double HorizontalAccuracy { get; }
	}
