...
#nullable enable
namespace CoreImage {
	/// <summary>The CIVibrance CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create a CIImage from a file.
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Construct the Vibrance Filter
	...
	/// var output = vibrance.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/Vibrance.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIVibrance : CIFilter, ICIVibranceProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIVibrance" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIVibrance () : base ("CIVibrance")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIVibrance (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIVibrance (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIVibrance (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIVibranceProtocol protocol members 
