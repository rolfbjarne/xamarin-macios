...
namespace MapKit {
	...
	public unsafe partial class MKLocalSearch : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithPointsOfInterestRequest_X = "initWithPointsOfInterestRequest:";
		static readonly NativeHandle selInitWithPointsOfInterestRequest_XHandle = Selector.GetHandle ("initWithPointsOfInterestRequest:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			var request__handle__ = request!.GetNonNullHandle (nameof (request));
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithPointsOfInterestRequest_XHandle, request__handle__), "initWithPointsOfInterestRequest:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithPointsOfInterestRequest_XHandle, request__handle__), "initWithPointsOfInterestRequest:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (request);
