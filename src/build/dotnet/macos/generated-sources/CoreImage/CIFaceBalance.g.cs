...
namespace CoreImage {
	...
	public partial class CIFaceBalance : CIFilter {
		...
		protected internal CIFaceBalance (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIFaceBalance (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIFaceBalance (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
