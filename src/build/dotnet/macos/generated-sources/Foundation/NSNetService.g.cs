...
namespace Foundation {
	...
	public unsafe partial class NSNetService : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDataFromTXTRecordDictionary_X = "dataFromTXTRecordDictionary:";
		static readonly NativeHandle selDataFromTXTRecordDictionary_XHandle = Selector.GetHandle ("dataFromTXTRecordDictionary:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDelegateX = "delegate";
		static readonly NativeHandle selDelegateXHandle = Selector.GetHandle ("delegate");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDictionaryFromTXTRecordData_X = "dictionaryFromTXTRecordData:";
		static readonly NativeHandle selDictionaryFromTXTRecordData_XHandle = Selector.GetHandle ("dictionaryFromTXTRecordData:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDomainX = "domain";
		static readonly NativeHandle selDomainXHandle = Selector.GetHandle ("domain");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGetInputStream_OutputStream_X = "getInputStream:outputStream:";
		static readonly NativeHandle selGetInputStream_OutputStream_XHandle = Selector.GetHandle ("getInputStream:outputStream:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithDomain_Type_Name_X = "initWithDomain:type:name:";
		static readonly NativeHandle selInitWithDomain_Type_Name_XHandle = Selector.GetHandle ("initWithDomain:type:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithDomain_Type_Name_Port_X = "initWithDomain:type:name:port:";
		static readonly NativeHandle selInitWithDomain_Type_Name_Port_XHandle = Selector.GetHandle ("initWithDomain:type:name:port:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPublishWithOptions_X = "publishWithOptions:";
		static readonly NativeHandle selPublishWithOptions_XHandle = Selector.GetHandle ("publishWithOptions:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selResolveX = "resolve";
		static readonly NativeHandle selResolveXHandle = Selector.GetHandle ("resolve");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selResolveWithTimeout_X = "resolveWithTimeout:";
		static readonly NativeHandle selResolveWithTimeout_XHandle = Selector.GetHandle ("resolveWithTimeout:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selStartMonitoringX = "startMonitoring";
		static readonly NativeHandle selStartMonitoringXHandle = Selector.GetHandle ("startMonitoring");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selStopX = "stop";
		static readonly NativeHandle selStopXHandle = Selector.GetHandle ("stop");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selStopMonitoringX = "stopMonitoring";
		static readonly NativeHandle selStopMonitoringXHandle = Selector.GetHandle ("stopMonitoring");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_int (this.Handle, selInitWithDomain_Type_Name_Port_XHandle, nsdomain, nstype, nsname, port), "initWithDomain:type:name:port:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_int (&__objc_super__, selInitWithDomain_Type_Name_Port_XHandle, nsdomain, nstype, nsname, port), "initWithDomain:type:name:port:");
					GC.KeepAlive (this);
				}
			}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			var nsname = CFString.CreateNative (name);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, selInitWithDomain_Type_Name_XHandle, nsdomain, nstype, nsname), "initWithDomain:type:name:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selInitWithDomain_Type_Name_XHandle, nsdomain, nstype, nsname), "initWithDomain:type:name:");
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nsdomain);
		...
		public static NSData DataFromTxtRecord (NSDictionary dictionary)
		{
			...
			NSData? ret;
			ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selDataFromTXTRecordDictionary_XHandle, dictionary__handle__), false)!;
		...
		public static NSDictionary DictionaryFromTxtRecord (NSData data)
		{
			...
			NSDictionary? ret;
			ret =  Runtime.GetNSObject<NSDictionary> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selDictionaryFromTXTRecordData_XHandle, data__handle__), false)!;
			GC.KeepAlive (data);
			return ret!;
		}
		...
		public unsafe virtual bool GetStreams (out NSInputStream inputStream, out NSOutputStream outputStream)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_ref_NativeHandle_ref_NativeHandle (this.Handle, selGetInputStream_OutputStream_XHandle, &inputStreamValue, &outputStreamValue);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_ref_NativeHandle_ref_NativeHandle (&__objc_super__, selGetInputStream_OutputStream_XHandle, &inputStreamValue, &outputStreamValue);
					GC.KeepAlive (this);
				}
			}
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selPublishWithOptions_XHandle, (UIntPtr) (ulong) options);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selPublishWithOptions_XHandle, (UIntPtr) (ulong) options);
					GC.KeepAlive (this);
				}
			}
		}
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend (this.Handle, selResolveXHandle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, selResolveXHandle);
					GC.KeepAlive (this);
				}
			}
		}
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_Double (this.Handle, selResolveWithTimeout_XHandle, timeOut);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_Double (&__objc_super__, selResolveWithTimeout_XHandle, timeOut);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual bool SetTxtRecordData (NSData? data)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (this.Handle, selSetTXTRecordData_XHandle, data__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetTXTRecordData_XHandle, data__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (data);
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend (this.Handle, selStartMonitoringXHandle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, selStartMonitoringXHandle);
					GC.KeepAlive (this);
				}
			}
		}
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend (this.Handle, selStopMonitoringXHandle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, selStopMonitoringXHandle);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual NSData[]? Addresses {
			...
			get {
				NSData[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<NSData>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selAddressesXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<NSData>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selAddressesXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
