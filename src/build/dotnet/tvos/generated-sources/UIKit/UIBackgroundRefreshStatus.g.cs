...
#nullable enable
namespace UIKit {
	/// <summary>An enumeration whose values reflect the status of a background refresh. Available from <see cref="P:UIKit.UIApplication.BackgroundRefreshStatus" />.</summary><remarks>To be added.</remarks>
