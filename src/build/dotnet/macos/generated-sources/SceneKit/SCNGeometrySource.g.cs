...
namespace SceneKit {
	...
	public unsafe partial class SCNGeometrySource : NSObject, INSCoding, INSSecureCoding {
		...
		const string selBytesPerComponentX = "bytesPerComponent";
		static readonly NativeHandle selBytesPerComponentXHandle = Selector.GetHandle ("bytesPerComponent");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selComponentsPerVectorX = "componentsPerVector";
		static readonly NativeHandle selComponentsPerVectorXHandle = Selector.GetHandle ("componentsPerVector");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDataX = "data";
		static readonly NativeHandle selDataXHandle = Selector.GetHandle ("data");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDataOffsetX = "dataOffset";
		static readonly NativeHandle selDataOffsetXHandle = Selector.GetHandle ("dataOffset");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDataStrideX = "dataStride";
		static readonly NativeHandle selDataStrideXHandle = Selector.GetHandle ("dataStride");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeWithCoder_X = "encodeWithCoder:";
		static readonly NativeHandle selEncodeWithCoder_XHandle = Selector.GetHandle ("encodeWithCoder:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selFloatComponentsX = "floatComponents";
		static readonly NativeHandle selFloatComponentsXHandle = Selector.GetHandle ("floatComponents");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGeometrySourceWithBuffer_VertexFormat_Semantic_VertexCount_DataOffset_DataStride_X = "geometrySourceWithBuffer:vertexFormat:semantic:vertexCount:dataOffset:dataStride:";
		static readonly NativeHandle selGeometrySourceWithBuffer_VertexFormat_Semantic_VertexCount_DataOffset_DataStride_XHandle = Selector.GetHandle ("geometrySourceWithBuffer:vertexFormat:semantic:vertexCount:dataOffset:dataStride:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGeometrySourceWithData_Semantic_VectorCount_FloatComponents_ComponentsPerVector_BytesPerComponent_DataOffset_DataStride_X = "geometrySourceWithData:semantic:vectorCount:floatComponents:componentsPerVector:bytesPerComponent:dataOffset:dataStride:";
		static readonly NativeHandle selGeometrySourceWithData_Semantic_VectorCount_FloatComponents_ComponentsPerVector_BytesPerComponent_DataOffset_DataStride_XHandle = Selector.GetHandle ("geometrySourceWithData:semantic:vectorCount:floatComponents:componentsPerVector:bytesPerComponent:dataOffset:dataStride:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGeometrySourceWithNormals_Count_X = "geometrySourceWithNormals:count:";
		static readonly NativeHandle selGeometrySourceWithNormals_Count_XHandle = Selector.GetHandle ("geometrySourceWithNormals:count:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGeometrySourceWithTextureCoordinates_Count_X = "geometrySourceWithTextureCoordinates:count:";
		static readonly NativeHandle selGeometrySourceWithTextureCoordinates_Count_XHandle = Selector.GetHandle ("geometrySourceWithTextureCoordinates:count:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGeometrySourceWithVertices_Count_X = "geometrySourceWithVertices:count:";
		static readonly NativeHandle selGeometrySourceWithVertices_Count_XHandle = Selector.GetHandle ("geometrySourceWithVertices:count:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selVectorCountX = "vectorCount";
		static readonly NativeHandle selVectorCountXHandle = Selector.GetHandle ("vectorCount");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			SCNGeometrySource ret;
			ret =  Runtime.GetNSObject<SCNGeometrySource> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (class_ptr, selGeometrySourceWithNormals_Count_XHandle, normals, count), false)!;
			return ret;
		}
		...
		{
			SCNGeometrySource ret;
			ret =  Runtime.GetNSObject<SCNGeometrySource> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (class_ptr, selGeometrySourceWithTextureCoordinates_Count_XHandle, texcoords, count), false)!;
			return ret;
		}
		...
		{
			SCNGeometrySource ret;
			ret =  Runtime.GetNSObject<SCNGeometrySource> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (class_ptr, selGeometrySourceWithVertices_Count_XHandle, vertices, count), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual nint BytesPerComponent {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selBytesPerComponentXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selBytesPerComponentXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual nint ComponentsPerVector {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selComponentsPerVectorXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selComponentsPerVectorXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual nint DataOffset {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selDataOffsetXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selDataOffsetXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual nint DataStride {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selDataStrideXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selDataStrideXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual bool FloatComponents {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selFloatComponentsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selFloatComponentsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual NSString Semantic {
			...
			get {
				NSString? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selSemanticXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selSemanticXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual nint VectorCount {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selVectorCountXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selVectorCountXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
