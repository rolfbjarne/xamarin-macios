...
namespace MapKit {
	...
	public unsafe partial class MKLookAroundSceneRequest : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGetSceneWithCompletionHandler_X = "getSceneWithCompletionHandler:";
		static readonly NativeHandle selGetSceneWithCompletionHandler_XHandle = Selector.GetHandle ("getSceneWithCompletionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithMapItem_X = "initWithMapItem:";
		static readonly NativeHandle selInitWithMapItem_XHandle = Selector.GetHandle ("initWithMapItem:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithMapItem_XHandle, mapItem__handle__), "initWithMapItem:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithMapItem_XHandle, mapItem__handle__), "initWithMapItem:");
					GC.KeepAlive (this);
				}
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetScene ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V109))]global::System.Action<MKLookAroundScene, NSError> completionHandler)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selGetSceneWithCompletionHandler_XHandle, (IntPtr) block_ptr_completionHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selGetSceneWithCompletionHandler_XHandle, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual MKMapItem? MapItem {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<MKMapItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selMapItemXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
