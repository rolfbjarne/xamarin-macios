...
namespace CoreImage {
	...
	public partial class CINinePartStretched : CIFilter, ICINinePartStretchedProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CINinePartStretched" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CINinePartStretched () : base ("CINinePartStretched")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CINinePartStretched (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CINinePartStretched (NSObjectFlag t) : base (t)
		{
		}
		...
		public CINinePartStretched (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		public CGPoint InputBreakpoint0 {
			...
			get {
				return GetPoint ("inputBreakpoint0");
			}
		...
		public CGPoint InputBreakpoint1 {
			...
			get {
				return GetPoint ("inputBreakpoint1");
			}
		...
		public CGPoint InputGrowAmount {
			...
			get {
				return GetPoint ("inputGrowAmount");
			}
