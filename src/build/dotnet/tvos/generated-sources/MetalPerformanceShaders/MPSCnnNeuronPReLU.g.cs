...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSCnnNeuronPReLU : MPSCnnNeuron {
		...
		internal nint InitWithDevice (global::Metal.IMTLDevice device, nint a, nuint count)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
			nint ret;
			ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_IntPtr_UIntPtr (this.Handle, Selector.GetHandle ("initWithDevice:a:count:"), device__handle__, a, count);
			GC.KeepAlive (device);
			return ret!;
		}
