...
#nullable enable
namespace CoreImage {
	/// <summary>Reduces the number of levels for each color component.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/color_posterize.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIColorPosterize : CIFilter, ICIColorPosterizeProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorPosterize" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorPosterize (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorPosterize (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorPosterize (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIColorPosterizeProtocol protocol members 
