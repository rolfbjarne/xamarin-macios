...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIFilter" /> that creates a kaleidoscopic effect.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/triangle_kaleidoscope.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CITriangleKaleidoscope : CIFilter, ICITriangleKaleidoscopeProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CITriangleKaleidoscope" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CITriangleKaleidoscope (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CITriangleKaleidoscope (NSObjectFlag t) : base (t)
		{
		}
		...
		public CITriangleKaleidoscope (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CITriangleKaleidoscopeProtocol protocol members 
