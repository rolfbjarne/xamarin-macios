...
namespace SharedWithYou {
	...
	/// <summary>This interface represents the Objective-C protocol <c>SWHighlightCenterDelegate</c>.</summary>
	/// <remarks>
	...
	public partial interface ISWHighlightCenterDelegate : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _HighlightsDidChange (ISWHighlightCenterDelegate This, SWHighlightCenter highlightCenter)
		{
			...
			GC.KeepAlive (This);
			GC.KeepAlive (highlightCenter);
		}
		[DynamicDependencyAttribute ("HighlightsDidChange(SharedWithYou.SWHighlightCenter)")]
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (SWHighlightCenterDelegateWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ISWHighlightCenterDelegate ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class SWHighlightCenterDelegateWrapper : BaseWrapper, ISWHighlightCenterDelegate {
		public SWHighlightCenterDelegateWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (SWHighlightCenterDelegateWrapper))]
		static SWHighlightCenterDelegateWrapper ()
		{
			GC.KeepAlive (null);
		}
		[Export ("highlightCenterHighlightsDidChange:")]
...
namespace SharedWithYou {
	/// <summary>
	///   <para>This is a class that implements the interface <see cref="ISWHighlightCenterDelegate" /> (for the protocol <c>SWHighlightCenterDelegate</c>).</para>
	///   <para>Subclass this class to easily create a type that implements the protocol.</para>
	///   <para>An alternative is to create a subclass of <see cref="NSObject" /> and then implemented the interface <see cref="ISWHighlightCenterDelegate" />.</para>
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__SharedWithYou_SWHighlightCenterDelegate", false)]
	[Model]
	[SupportedOSPlatform ("tvos16.0")]
	[SupportedOSPlatform ("macos13.0")]
	[SupportedOSPlatform ("ios16.0")]
	...
	public unsafe abstract partial class SWHighlightCenterDelegate : NSObject, ISWHighlightCenterDelegate {
		/// <summary>Creates a new <see cref="SWHighlightCenterDelegate" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
