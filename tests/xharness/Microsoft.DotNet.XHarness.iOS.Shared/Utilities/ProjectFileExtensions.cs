...
namespace Microsoft.DotNet.XHarness.iOS.Shared.Utilities {
	public static class ProjectFileExtensions {
		...
		public static void SetXamarinImport (this XmlDocument csproj, string value)
		{
			var import = GetXamarinImport (csproj);
		...
		public static string GetXamarinImport (this XmlDocument csproj)
		{
