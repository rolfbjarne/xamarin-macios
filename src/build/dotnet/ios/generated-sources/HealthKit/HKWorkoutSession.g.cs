...
namespace HealthKit {
	...
	public unsafe partial class HKWorkoutSession : NSObject, INSCoding, INSSecureCoding {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (this.Handle, Selector.GetHandle ("initWithHealthStore:configuration:error:"), healthStore__handle__, workoutConfiguration__handle__, &errorValue), "initWithHealthStore:configuration:error:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithHealthStore:configuration:error:"), healthStore__handle__, workoutConfiguration__handle__, &errorValue), "initWithHealthStore:configuration:error:");
					GC.KeepAlive (this);
				}
			}
		...
		[SupportedOSPlatform ("ios17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void SendDataToRemoteWorkoutSession (NSData data, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V0))]global::System.Action<bool, NSError> completion)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("sendDataToRemoteWorkoutSession:completion:"), data__handle__, (IntPtr) block_ptr_completion);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("sendDataToRemoteWorkoutSession:completion:"), data__handle__, (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (data);
		...
		[SupportedOSPlatform ("ios17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual Task<Tuple<bool,NSError>> SendDataToRemoteWorkoutSessionAsync (NSData data)
		{
			var tcs = new TaskCompletionSource<Tuple<bool,NSError>> ();
			SendDataToRemoteWorkoutSession(data, (arg1_, arg2_) => {
		...
		public virtual HKLiveWorkoutBuilder AssociatedWorkoutBuilder {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKLiveWorkoutBuilder> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("associatedWorkoutBuilder")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKLiveWorkoutBuilder> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("associatedWorkoutBuilder")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
