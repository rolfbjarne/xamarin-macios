...
#nullable enable
namespace CoreImage {
	/// <summary>The CILuminosityBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/LuminosityBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CILuminosityBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CILuminosityBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CILuminosityBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILuminosityBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILuminosityBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
