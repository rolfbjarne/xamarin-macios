...
namespace CoreHaptics {
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "CompletionHandler", Selector = "completionHandler", PropertyType = typeof (global::System.Action<NSError>), GetterSelector = "completionHandler", SetterSelector = "setCompletionHandler:", ArgumentSemantic = ArgumentSemantic.Assign, ParameterBlockProxy = new Type [] { typeof (ObjCRuntime.Trampolines.NIDActionArity1V20) }, ReturnTypeDelegateProxy = typeof (ObjCRuntime.Trampolines.SDActionArity1V20))]
		...
		CoreHaptics.ICHHapticPatternPlayer
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _SetCompletionHandler (ICHHapticAdvancedPatternPlayer This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> value)
		{
			if (value is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (value));
			using var block_value = Trampolines.SDActionArity1V20.CreateBlock (value);
