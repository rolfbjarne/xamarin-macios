...
namespace MonoTouchFixtures.Foundation {
	...
	public class NSOperatingSystemVersionTest {
		...
		{
			ClassicAssert.AreEqual (sample.v1 == sample.v2, sample.res, $"{sample.v1}=={sample.v2}");
			ClassicAssert.AreEqual (sample.v2 == sample.v1, sample.res, $"{sample.v2}=={sample.v1}");
			ClassicAssert.AreNotEqual (sample.v1 != sample.v2, sample.res, $"{sample.v1}!={sample.v2}");
		}
		...
		public void NSVersionObject ((Object obj, bool res) sample)
		{
			...
			ClassicAssert.AreEqual (v1.Equals (sample.obj), sample.res);
		}
		...
		{
			NSOperatingSystemVersion v1 = new NSOperatingSystemVersion ((nint) 1, (nint) 2, (nint) 3);
			ClassicAssert.AreEqual (v1.CompareTo (sample.obj), sample.result);
		}
		...
		public void NSVersionHashCode (NSOperatingSystemVersion version)
			=> ClassicAssert.AreEqual (version.GetHashCode (), version.GetHashCode ());
		...
		public void NSVersionToString ((NSOperatingSystemVersion version, string versionStr) sample)
			=> ClassicAssert.AreEqual (sample.version.ToString (), sample.versionStr);
		...
		public void NSVersionCompare ((NSOperatingSystemVersion v1, NSOperatingSystemVersion v2, int res) sample)
			=> ClassicAssert.AreEqual (sample.v1.CompareTo (sample.v2), sample.res);
