...
namespace AVFoundation {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidFinishProcessingPhoto", Selector = "captureOutput:didFinishProcessingPhotoSampleBuffer:previewPhotoSampleBuffer:resolvedSettings:bracketSettings:error:", ParameterType = new Type [] { typeof (AVCapturePhotoOutput), typeof (CMSampleBuffer), typeof (CMSampleBuffer), typeof (AVCaptureResolvedPhotoSettings), typeof (AVCaptureBracketedStillImageSettings), typeof (NSError) }, ParameterByRef = new bool [] { false, false, false, false, false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidFinishProcessingRawPhoto", Selector = "captureOutput:didFinishProcessingRawPhotoSampleBuffer:previewPhotoSampleBuffer:resolvedSettings:bracketSettings:error:", ParameterType = new Type [] { typeof (AVCapturePhotoOutput), typeof (CMSampleBuffer), typeof (CMSampleBuffer), typeof (AVCaptureResolvedPhotoSettings), typeof (AVCaptureBracketedStillImageSettings), typeof (NSError) }, ParameterByRef = new bool [] { false, false, false, false, false, false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidFinishCapturingDeferredPhotoProxy", Selector = "captureOutput:didFinishCapturingDeferredPhotoProxy:error:", ParameterType = new Type [] { typeof (AVCapturePhotoOutput), typeof (AVCaptureDeferredPhotoProxy), typeof (NSError) }, ParameterByRef = new bool [] { false, false, false })]
	public partial interface IAVCapturePhotoCaptureDelegate : INativeObject, IDisposable
	{
		...
		/// <param name="captureOutput">To be added.</param><param name="photoSampleBuffer"><para>To be added.</para><para tool="nullallowed">This parameter can be <see langword="null" />.</para></param><param name="previewPhotoSampleBuffer"><para>To be added.</para><para tool="nullallowed">This parameter can be <see langword="null" />.</para></param><param name="resolvedSettings">To be added.</param><param name="bracketSettings"><para>To be added.</para><para tool="nullallowed">This parameter can be <see langword="null" />.</para></param><param name="error"><para>To be added.</para><para tool="nullallowed">This parameter can be <see langword="null" />.</para></param><summary>Developers should not use this deprecated method. Developers should use the 'DidFinishProcessingPhoto' overload accepting a 'AVCapturePhoto' instead.</summary><remarks>To be added.</remarks>
		[global::Foundation.OptionalMember]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void DidFinishCapturingDeferredPhotoProxy (AVCapturePhotoOutput output, AVCaptureDeferredPhotoProxy? deferredPhotoProxy, NSError? error)
		{
			_DidFinishCapturingDeferredPhotoProxy (this, output, deferredPhotoProxy, error);
		}
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[UnsupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("ios17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _DidFinishCapturingDeferredPhotoProxy (IAVCapturePhotoCaptureDelegate This, AVCapturePhotoOutput output, AVCaptureDeferredPhotoProxy? deferredPhotoProxy, NSError? error)
		{
			var output__handle__ = output!.GetNonNullHandle (nameof (output));
			var deferredPhotoProxy__handle__ = deferredPhotoProxy.GetHandle ();
			var error__handle__ = error.GetHandle ();
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("captureOutput:didFinishCapturingDeferredPhotoProxy:error:"), output__handle__, deferredPhotoProxy__handle__, error__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (output);
			GC.KeepAlive (deferredPhotoProxy);
			GC.KeepAlive (error);
		}
		...
		[DynamicDependencyAttribute ("DidFinishCapturingDeferredPhotoProxy(AVFoundation.AVCapturePhotoOutput,AVFoundation.AVCaptureDeferredPhotoProxy,Foundation.NSError)")]
	...
	public unsafe static partial class AVCapturePhotoCaptureDelegate_Extensions {
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void DidFinishProcessingPhoto (this IAVCapturePhotoCaptureDelegate This, AVCapturePhotoOutput captureOutput, global::CoreMedia.CMSampleBuffer? photoSampleBuffer, global::CoreMedia.CMSampleBuffer? previewPhotoSampleBuffer, AVCaptureResolvedPhotoSettings resolvedSettings, AVCaptureBracketedStillImageSettings? bracketSettings, NSError? error)
		{
			var captureOutput__handle__ = captureOutput!.GetNonNullHandle (nameof (captureOutput));
			var photoSampleBuffer__handle__ = photoSampleBuffer.GetHandle ();
			var previewPhotoSampleBuffer__handle__ = previewPhotoSampleBuffer.GetHandle ();
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void DidFinishProcessingRawPhoto (this IAVCapturePhotoCaptureDelegate This, AVCapturePhotoOutput captureOutput, global::CoreMedia.CMSampleBuffer? rawSampleBuffer, global::CoreMedia.CMSampleBuffer? previewPhotoSampleBuffer, AVCaptureResolvedPhotoSettings resolvedSettings, AVCaptureBracketedStillImageSettings? bracketSettings, NSError? error)
		{
			var captureOutput__handle__ = captureOutput!.GetNonNullHandle (nameof (captureOutput));
			var rawSampleBuffer__handle__ = rawSampleBuffer.GetHandle ();
			var previewPhotoSampleBuffer__handle__ = previewPhotoSampleBuffer.GetHandle ();
		...
		[SupportedOSPlatform ("ios17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void DidFinishCapturingDeferredPhotoProxy (this IAVCapturePhotoCaptureDelegate This, AVCapturePhotoOutput output, AVCaptureDeferredPhotoProxy? deferredPhotoProxy, NSError? error)
		{
			var output__handle__ = output!.GetNonNullHandle (nameof (output));
			var deferredPhotoProxy__handle__ = deferredPhotoProxy.GetHandle ();
			var error__handle__ = error.GetHandle ();
