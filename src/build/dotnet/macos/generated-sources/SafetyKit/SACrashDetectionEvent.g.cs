	...
	public unsafe partial class SACrashDetectionEvent : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		public virtual SACrashDetectionEventResponse Response {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (SafetyKit.SACrashDetectionEventResponse) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selResponseXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (SafetyKit.SACrashDetectionEventResponse) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selResponseXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
