...
namespace AVFoundation {
	...
	public unsafe partial class AVDateRangeMetadataGroup : AVMetadataGroup, INSCopying, INSMutableCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithItems_StartDate_EndDate_X = "initWithItems:startDate:endDate:";
		static readonly NativeHandle selInitWithItems_StartDate_EndDate_XHandle = Selector.GetHandle ("initWithItems:startDate:endDate:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("AVDateRangeMetadataGroup");
		...
		/// <summary>Creates a new <see cref="AVDateRangeMetadataGroup" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public AVDateRangeMetadataGroup () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected AVDateRangeMetadataGroup (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal AVDateRangeMetadataGroup (NativeHandle handle) : base (handle)
		{
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, selInitWithItems_StartDate_EndDate_XHandle, nsa_items.Handle, startDate__handle__, endDate__handle__), "initWithItems:startDate:endDate:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selInitWithItems_StartDate_EndDate_XHandle, nsa_items.Handle, startDate__handle__, endDate__handle__), "initWithItems:startDate:endDate:");
					GC.KeepAlive (this);
				}
			}
		...
		public virtual AVMetadataItem[] Items {
			...
			get {
				AVMetadataItem[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<AVMetadataItem>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selItemsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<AVMetadataItem>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selItemsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
