...
namespace MetalPerformanceShadersGraph {
	...
	public unsafe static partial class MPSGraph_MPSGraphLinearAlgebraOps  {
		...
		const string selBandPartWithTensor_NumLower_NumUpper_Name_X = "bandPartWithTensor:numLower:numUpper:name:";
		static readonly NativeHandle selBandPartWithTensor_NumLower_NumUpper_Name_XHandle = Selector.GetHandle ("bandPartWithTensor:numLower:numUpper:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selBandPartWithTensor_NumLowerTensor_NumUpperTensor_Name_X = "bandPartWithTensor:numLowerTensor:numUpperTensor:name:";
		static readonly NativeHandle selBandPartWithTensor_NumLowerTensor_NumUpperTensor_Name_XHandle = Selector.GetHandle ("bandPartWithTensor:numLowerTensor:numUpperTensor:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MPSGraphTensor BandPart (this MPSGraph This, MPSGraphTensor inputTensor, nint numLower, nint numUpper, string? name)
		{
			...
			MPSGraphTensor? ret;
			ret =  Runtime.GetNSObject<MPSGraphTensor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_IntPtr_IntPtr_NativeHandle (This.Handle, selBandPartWithTensor_NumLower_NumUpper_Name_XHandle, inputTensor__handle__, numLower, numUpper, nsname), false)!;
			GC.KeepAlive (This);
		...
		public static MPSGraphTensor BandPart (this MPSGraph This, MPSGraphTensor inputTensor, MPSGraphTensor numLowerTensor, MPSGraphTensor numUpperTensor, string? name)
		{
			...
			var nsname = CFString.CreateNative (name);
			MPSGraphTensor? ret;
			ret =  Runtime.GetNSObject<MPSGraphTensor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (This.Handle, selBandPartWithTensor_NumLowerTensor_NumUpperTensor_Name_XHandle, inputTensor__handle__, numLowerTensor__handle__, numUpperTensor__handle__, nsname), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (inputTensor);
