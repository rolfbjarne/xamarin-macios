...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that performs a custom 3x3 matrix convolution.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/convolution_3X3.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIConvolution3X3 : CIConvolutionCore {
		/// <summary>Creates a new <see cref="CIConvolution3X3" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIConvolution3X3 () : base ("CIConvolution3X3")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIConvolution3X3 (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIConvolution3X3 (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIConvolution3X3 (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
