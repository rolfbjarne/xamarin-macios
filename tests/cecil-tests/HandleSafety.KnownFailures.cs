...
namespace Cecil.Tests {
	public partial class HandleSafetyTest {
		static HashSet<string> knownFailuresHandleSafety = new HashSet<string> {
			...
			"Foundation.DictionaryContainer.GetArray`1 (Foundation.NSString, System.Func`2<ObjCRuntime.NativeHandle, T>)",
			"Foundation.DictionaryContainer.GetArray`1 (Foundation.NSString)",
			...
			"Foundation.NSItemProvider/<>c__1`1.<LoadObjectAsync>b__1_0`0 (System.Threading.Tasks.Task`1<Foundation.INSItemProviderReading>)",
			"Foundation.NSItemProvider/<>c__2`1.<LoadObjectAsync>b__2_0`0 (System.Threading.Tasks.Task`1<Foundation.INSItemProviderReading>)",
			"Foundation.NSItemProvider/<>c__3`1.<LoadObjectAsync>b__3_0`0 (System.Threading.Tasks.Task`1<Foundation.INSItemProviderReading>)",
