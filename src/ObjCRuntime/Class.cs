...
#pragma warning restore CS8618
		...
		{
			return FindClassWithComputedToken (type, out is_custom_type);
		}

		// Find the given managed type in the tables generated by the static registrar.
		unsafe static IntPtr FindClassWithComputedToken (Type type, out bool is_custom_type)
		{
		...
		// Find the given managed type in the tables generated by the static registrar.
		unsafe static IntPtr FindClassWithMetadataToken (Type type, out bool is_custom_type)
		{
			var map = Runtime.options->RegistrationMap;
		...
		static bool TryMapRuntimeTypeHandleToToken (RuntimeTypeHandle runtimetypehandle, out uint token)
		{
