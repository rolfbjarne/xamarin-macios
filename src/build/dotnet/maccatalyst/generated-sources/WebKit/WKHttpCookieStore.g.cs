...
namespace WebKit {
	...
	public unsafe partial class WKHttpCookieStore : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetAllCookies ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V47))]global::System.Action<NSHttpCookie[]> completionHandler)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetCookiePolicy ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V267))]global::System.Action<WKCookiePolicy> completionHandler)
		{
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity1V267.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
