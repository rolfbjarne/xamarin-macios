...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITileFilter" /> that translates and smears the source image.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/glide_reflected_tile.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIGlideReflectedTile : CITileFilter, ICIGlideReflectedTileProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIGlideReflectedTile" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIGlideReflectedTile () : base ("CIGlideReflectedTile")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIGlideReflectedTile (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIGlideReflectedTile (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIGlideReflectedTile (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIGlideReflectedTileProtocol protocol members 
