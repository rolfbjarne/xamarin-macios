...
namespace CoreImage {
	...
	public partial class CIAccordionFoldTransition : CIFilter, ICIAccordionFoldTransitionProtocol, ICITransitionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIAccordionFoldTransition" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIAccordionFoldTransition () : base ("CIAccordionFoldTransition")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAccordionFoldTransition (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAccordionFoldTransition (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAccordionFoldTransition (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIAccordionFoldTransitionProtocol protocol members 
