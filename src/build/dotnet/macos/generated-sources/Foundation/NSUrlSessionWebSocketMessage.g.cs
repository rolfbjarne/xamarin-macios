	...
	public unsafe partial class NSUrlSessionWebSocketMessage : NSObject {
		...
		public virtual NSUrlSessionWebSocketMessageType Type {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (NSUrlSessionWebSocketMessageType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selTypeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSUrlSessionWebSocketMessageType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selTypeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
