...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSImageHistogram : MPSKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_SourceTexture_Histogram_HistogramOffset_X = "encodeToCommandBuffer:sourceTexture:histogram:histogramOffset:";
		static readonly NativeHandle selEncodeToCommandBuffer_SourceTexture_Histogram_HistogramOffset_XHandle = Selector.GetHandle ("encodeToCommandBuffer:sourceTexture:histogram:histogramOffset:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selMinPixelThresholdValueX = "minPixelThresholdValue";
		static readonly NativeHandle selMinPixelThresholdValueXHandle = Selector.GetHandle ("minPixelThresholdValue");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetMinPixelThresholdValue_X = "setMinPixelThresholdValue:";
		static readonly NativeHandle selSetMinPixelThresholdValue_XHandle = Selector.GetHandle ("setMinPixelThresholdValue:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual void EncodeToCommandBuffer (global::Metal.IMTLCommandBuffer commandBuffer, global::Metal.IMTLTexture source, global::Metal.IMTLBuffer histogram, nuint histogramOffset)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_UIntPtr (this.Handle, selEncodeToCommandBuffer_SourceTexture_Histogram_HistogramOffset_XHandle, commandBuffer__handle__, source__handle__, histogram__handle__, histogramOffset);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_UIntPtr (&__objc_super__, selEncodeToCommandBuffer_SourceTexture_Histogram_HistogramOffset_XHandle, commandBuffer__handle__, source__handle__, histogram__handle__, histogramOffset);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual global::System.Numerics.Vector4 MinPixelThresholdValue {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.xamarin_simd__Vector4_objc_msgSend (this.Handle, selMinPixelThresholdValueXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.xamarin_simd__Vector4_objc_msgSendSuper (&__objc_super__, selMinPixelThresholdValueXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.xamarin_simd__void_objc_msgSend_Vector4 (this.Handle, selSetMinPixelThresholdValue_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.xamarin_simd__void_objc_msgSendSuper_Vector4 (&__objc_super__, selSetMinPixelThresholdValue_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
