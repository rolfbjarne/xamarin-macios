...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSCnnSpatialNormalizationGradientNode : MPSNNGradientFilterNode {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithSourceGradient_SourceImage_GradientState_KernelSize_X = "initWithSourceGradient:sourceImage:gradientState:kernelSize:";
		static readonly NativeHandle selInitWithSourceGradient_SourceImage_GradientState_KernelSize_XHandle = Selector.GetHandle ("initWithSourceGradient:sourceImage:gradientState:kernelSize:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNodeWithSourceGradient_SourceImage_GradientState_KernelSize_X = "nodeWithSourceGradient:sourceImage:gradientState:kernelSize:";
		static readonly NativeHandle selNodeWithSourceGradient_SourceImage_GradientState_KernelSize_XHandle = Selector.GetHandle ("nodeWithSourceGradient:sourceImage:gradientState:kernelSize:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSCNNSpatialNormalizationGradientNode");
		...
		protected MPSCnnSpatialNormalizationGradientNode (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSCnnSpatialNormalizationGradientNode (NativeHandle handle) : base (handle)
		{
		}

		/// <param name="sourceGradient">To be added.</param><param name="sourceImage">To be added.</param><param name="gradientState">To be added.</param><param name="kernelSize">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		...
		/// <param name="sourceGradient">To be added.</param><param name="sourceImage">To be added.</param><param name="gradientState">To be added.</param><param name="kernelSize">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		...
		public static MPSCnnSpatialNormalizationGradientNode Create (MPSNNImageNode sourceGradient, MPSNNImageNode sourceImage, MPSNNGradientStateNode gradientState, nuint kernelSize)
		{
			...
			var sourceImage__handle__ = sourceImage!.GetNonNullHandle (nameof (sourceImage));
			var gradientState__handle__ = gradientState!.GetNonNullHandle (nameof (gradientState));
			MPSCnnSpatialNormalizationGradientNode? ret;
			ret =  Runtime.GetNSObject<MPSCnnSpatialNormalizationGradientNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_UIntPtr (class_ptr, selNodeWithSourceGradient_SourceImage_GradientState_KernelSize_XHandle, sourceGradient__handle__, sourceImage__handle__, gradientState__handle__, kernelSize), false)!;
			GC.KeepAlive (sourceGradient);
			GC.KeepAlive (sourceImage);
			GC.KeepAlive (gradientState);
			return ret!;
