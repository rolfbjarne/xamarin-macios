...
namespace UIKit {
	...
	public unsafe partial class UIContextMenuInteraction : NSObject, IUIInteraction {
		...
		[SupportedOSPlatform ("tvos17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void UpdateVisibleMenu ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity2V10))]global::System.Func<UIMenu, UIMenu> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDFuncArity2V10.CreateBlock (handler);
