...
namespace AuthenticationServices {
	...
	public unsafe partial class ASAccountAuthenticationModificationUpgradePasswordToStrongPasswordRequest : ASAccountAuthenticationModificationRequest {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("ASAccountAuthenticationModificationUpgradePasswordToStrongPasswordRequest");
		...
		protected ASAccountAuthenticationModificationUpgradePasswordToStrongPasswordRequest (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal ASAccountAuthenticationModificationUpgradePasswordToStrongPasswordRequest (NativeHandle handle) : base (handle)
		{
		}

		[Export ("initWithUser:serviceIdentifier:userInfo:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public ASAccountAuthenticationModificationUpgradePasswordToStrongPasswordRequest (string user, ASCredentialServiceIdentifier serviceIdentifier, NSDictionary? userInfo)
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithUser:serviceIdentifier:userInfo:"), nsuser, serviceIdentifier__handle__, userInfo__handle__), "initWithUser:serviceIdentifier:userInfo:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithUser:serviceIdentifier:userInfo:"), nsuser, serviceIdentifier__handle__, userInfo__handle__), "initWithUser:serviceIdentifier:userInfo:");
					GC.KeepAlive (this);
				}
			}
