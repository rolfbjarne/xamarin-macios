		...
		public void ContentHeadroom ()
		{
			...
			Assert.Multiple (() => {
				...
				if (TestRuntime.CheckXcodeVersion (26, 0)) {
					Assert.That (copy.CalculatedContentHeadroom, Is.Not.EqualTo (0.0f), "CalculatedContentHeadroom B");
					Assert.That (copy.ContentAverageLightLevel, Is.Not.EqualTo (0.0f), "ContentAverageLightLevel B");
					...
					Assert.That (copy2.CalculatedContentHeadroom, Is.Not.EqualTo (0.0f), "CalculatedContentHeadroom C");
					...
					Assert.That (copy3.CalculatedContentHeadroom, Is.Not.EqualTo (0.0f), "CalculatedContentHeadroom C");
					Assert.That (copy3.ContentAverageLightLevel, Is.Not.EqualTo (0.0f), "ContentAverageLightLevel C");
					Assert.That (copy3.CalculatedContentAverageLightLevel, Is.Not.EqualTo (0.0f), "CalculatedContentAverageLightLevel C");
				}
			});
		}
	}
