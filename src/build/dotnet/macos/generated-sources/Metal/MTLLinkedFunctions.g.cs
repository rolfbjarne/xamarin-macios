...
namespace Metal {
	...
	public unsafe partial class MTLLinkedFunctions : NSObject, INSCopying {
		...
		const string selBinaryFunctionsX = "binaryFunctions";
		static readonly NativeHandle selBinaryFunctionsXHandle = Selector.GetHandle ("binaryFunctions");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCopyWithZone_X = "copyWithZone:";
		static readonly NativeHandle selCopyWithZone_XHandle = Selector.GetHandle ("copyWithZone:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selFunctionsX = "functions";
		static readonly NativeHandle selFunctionsXHandle = Selector.GetHandle ("functions");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPrivateFunctionsX = "privateFunctions";
		static readonly NativeHandle selPrivateFunctionsXHandle = Selector.GetHandle ("privateFunctions");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetBinaryFunctions_X = "setBinaryFunctions:";
		static readonly NativeHandle selSetBinaryFunctions_XHandle = Selector.GetHandle ("setBinaryFunctions:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetFunctions_X = "setFunctions:";
		static readonly NativeHandle selSetFunctions_XHandle = Selector.GetHandle ("setFunctions:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetPrivateFunctions_X = "setPrivateFunctions:";
		static readonly NativeHandle selSetPrivateFunctions_XHandle = Selector.GetHandle ("setPrivateFunctions:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MTLLinkedFunctions Create ()
		{
			...
			ret =  Runtime.GetNSObject<MTLLinkedFunctions> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selLinkedFunctionsXHandle), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual IMTLFunction[]? BinaryFunctions {
			...
			get {
				IMTLFunction[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<IMTLFunction>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selBinaryFunctionsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<IMTLFunction>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selBinaryFunctionsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetBinaryFunctions_XHandle, nsa_value.GetHandle ());
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetBinaryFunctions_XHandle, nsa_value.GetHandle ());
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual IMTLFunction[]? Functions {
			...
			get {
				IMTLFunction[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<IMTLFunction>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selFunctionsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<IMTLFunction>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selFunctionsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				using var nsa_value = value is null ? null : NSArray.FromNSObjects (value);
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetFunctions_XHandle, nsa_value.GetHandle ());
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetFunctions_XHandle, nsa_value.GetHandle ());
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual NSDictionary<NSString, NSArray<IMTLFunction>>? Groups {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDictionary<NSString, NSArray<IMTLFunction>>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selGroupsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDictionary<NSString, NSArray<IMTLFunction>>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selGroupsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual IMTLFunction[]? PrivateFunctions {
			...
			get {
				IMTLFunction[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<IMTLFunction>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selPrivateFunctionsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<IMTLFunction>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selPrivateFunctionsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				using var nsa_value = value is null ? null : NSArray.FromNSObjects (value);
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetPrivateFunctions_XHandle, nsa_value.GetHandle ());
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetPrivateFunctions_XHandle, nsa_value.GetHandle ());
						GC.KeepAlive (this);
					}
				}
			}
