...
namespace CoreImage {
	...
	public abstract partial class CIDistortionFilter : CIFilter {
		...
		protected CIDistortionFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDistortionFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDistortionFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIDistortionFilter" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected  CIDistortionFilter (string name) : base (CreateFilter (name))
		{
		}
		...
		/// <summary>Gets or sets the radius of the effect.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public float Radius {
			get {
