...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIKeystoneCorrectionCombined</c>.</summary>
	/// <remarks>
	...
	public partial interface ICIKeystoneCorrectionCombinedProtocol : INativeObject, IDisposable, 
		CoreImage.ICIFilterProtocol
		, CoreImage.ICIFourCoordinateGeometryFilterProtocol
	{
		[DynamicDependencyAttribute ("FocalLength")]
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIKeystoneCorrectionCombinedProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICIKeystoneCorrectionCombinedProtocol ()
		{
			GC.KeepAlive (null);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static float _GetFocalLength (ICIKeystoneCorrectionCombinedProtocol This)
		{
			float ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetFocalLength (ICIKeystoneCorrectionCombinedProtocol This, float value)
		{
	...
	internal unsafe sealed class CIKeystoneCorrectionCombinedProtocolWrapper : BaseWrapper, ICIKeystoneCorrectionCombinedProtocol {
		public CIKeystoneCorrectionCombinedProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIKeystoneCorrectionCombinedProtocolWrapper))]
		static CIKeystoneCorrectionCombinedProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
