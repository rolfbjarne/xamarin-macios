...
namespace MetalFX {
	...
	/// <summary>This interface represents the Objective-C protocol <c>MTLFXTemporalDenoisedScaler</c>.</summary>
	/// <remarks>
	...
	[Protocol (Name = "MTLFXTemporalDenoisedScaler", WrapperType = typeof (MTLFXTemporalDenoisedScalerWrapper), BackwardsCompatibleCodeGeneration = false)]
	...
	public partial interface IMTLFXTemporalDenoisedScaler : INativeObject, IDisposable, 
		...
		, MetalFX.IMTLFXTemporalDenoisedScalerBase
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _Encode (IMTLFXTemporalDenoisedScaler This, global::Metal.IMTLCommandBuffer commandBuffer)
		{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (MTLFXTemporalDenoisedScalerWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static IMTLFXTemporalDenoisedScaler ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class MTLFXTemporalDenoisedScalerWrapper : BaseWrapper, IMTLFXTemporalDenoisedScaler {
		public MTLFXTemporalDenoisedScalerWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (MTLFXTemporalDenoisedScalerWrapper))]
		static MTLFXTemporalDenoisedScalerWrapper ()
		{
			GC.KeepAlive (null);
		}
		[Export ("encodeToCommandBuffer:")]
