	...
	public unsafe partial class TKTokenSession : NSObject {
		...
		public virtual TKToken Token {
			...
			get {
				TKToken? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<TKToken> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("token")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<TKToken> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("token")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
