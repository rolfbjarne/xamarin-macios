...
namespace MapKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillUpdateScene", Selector = "lookAroundViewControllerWillUpdateScene:", ParameterType = new Type [] { typeof (MapKit.MKLookAroundViewController) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidUpdateScene", Selector = "lookAroundViewControllerDidUpdateScene:", ParameterType = new Type [] { typeof (MapKit.MKLookAroundViewController) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillPresentFullScreen", Selector = "lookAroundViewControllerWillPresentFullScreen:", ParameterType = new Type [] { typeof (MapKit.MKLookAroundViewController) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidPresentFullScreen", Selector = "lookAroundViewControllerDidPresentFullScreen:", ParameterType = new Type [] { typeof (MapKit.MKLookAroundViewController) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillDismissFullScreen", Selector = "lookAroundViewControllerWillDismissFullScreen:", ParameterType = new Type [] { typeof (MapKit.MKLookAroundViewController) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidDismissFullScreen", Selector = "lookAroundViewControllerDidDismissFullScreen:", ParameterType = new Type [] { typeof (MapKit.MKLookAroundViewController) }, ParameterByRef = new bool [] { false })]
...
namespace MapKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__MapKit_MKLookAroundViewControllerDelegate", false)]
	[Model]
	[SupportedOSPlatform ("macos13.0")]
	[SupportedOSPlatform ("ios16.0")]
	[SupportedOSPlatform ("maccatalyst16.0")]
