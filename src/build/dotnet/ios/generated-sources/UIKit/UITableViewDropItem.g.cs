...
namespace UIKit {
	...
	[Protocol (Name = "UITableViewDropItem", WrapperType = typeof (UITableViewDropItemWrapper))]
	...
	public partial interface IUITableViewDropItem : INativeObject, IDisposable
	{
		[DynamicDependencyAttribute ("DragItem")]
		[DynamicDependencyAttribute ("PreviewSize")]
		[DynamicDependencyAttribute ("SourceIndexPath")]
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (UITableViewDropItemWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static IUITableViewDropItem ()
		{
			GC.KeepAlive (null);
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static UIDragItem _GetDragItem (IUITableViewDropItem This)
		{
		...
		/// <summary>Gets the source index path for the item if it is being dragged from another location in the table view.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[global::Foundation.RequiredMember]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static NSIndexPath _GetSourceIndexPath (IUITableViewDropItem This)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			NSIndexPath ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CGSize _GetPreviewSize (IUITableViewDropItem This)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			CGSize ret;
	...
	internal unsafe sealed class UITableViewDropItemWrapper : BaseWrapper, IUITableViewDropItem {
		public UITableViewDropItemWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (UITableViewDropItemWrapper))]
		static UITableViewDropItemWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets the drag item.</summary><value>To be added.</value><remarks>To be added.</remarks>
