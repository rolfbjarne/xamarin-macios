...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSCnnBatchNormalizationStatistics : MPSCnnKernel {
		...
		const string selEncodeBatchToCommandBuffer_SourceImages_BatchNormalizationState_X = "encodeBatchToCommandBuffer:sourceImages:batchNormalizationState:";
		static readonly NativeHandle selEncodeBatchToCommandBuffer_SourceImages_BatchNormalizationState_XHandle = Selector.GetHandle ("encodeBatchToCommandBuffer:sourceImages:batchNormalizationState:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual void EncodeBatch (global::Metal.IMTLCommandBuffer commandBuffer, NSArray<MPSImage> sourceImages, MPSCnnBatchNormalizationState batchNormalizationState)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeBatchToCommandBuffer_SourceImages_BatchNormalizationState_XHandle, commandBuffer__handle__, sourceImages__handle__, batchNormalizationState__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeBatchToCommandBuffer_SourceImages_BatchNormalizationState_XHandle, commandBuffer__handle__, sourceImages__handle__, batchNormalizationState__handle__);
					GC.KeepAlive (this);
				}
			}
