...
namespace CryptoTokenKit {
	...
	public unsafe partial class TKTokenKeychainCertificate : TKTokenKeychainItem {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			using var nsb_certificateRef = global::Security.SecKeyAlgorithmExtensions.GetConstant (certificateRef);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selInitWithCertificate_ObjectID_XHandle, nsb_certificateRef.GetHandle (), objectId__handle__), "initWithCertificate:objectID:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selInitWithCertificate_ObjectID_XHandle, nsb_certificateRef.GetHandle (), objectId__handle__), "initWithCertificate:objectID:");
					GC.KeepAlive (this);
				}
			}
