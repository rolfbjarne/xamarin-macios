...
namespace AppKit {
	...
	public unsafe partial class NSButtonTouchBarItem : NSTouchBarItem {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selButtonTouchBarItemWithIdentifier_Image_Target_Action_X = "buttonTouchBarItemWithIdentifier:image:target:action:";
		static readonly NativeHandle selButtonTouchBarItemWithIdentifier_Image_Target_Action_XHandle = Selector.GetHandle ("buttonTouchBarItemWithIdentifier:image:target:action:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selButtonTouchBarItemWithIdentifier_Title_Image_Target_Action_X = "buttonTouchBarItemWithIdentifier:title:image:target:action:";
		static readonly NativeHandle selButtonTouchBarItemWithIdentifier_Title_Image_Target_Action_XHandle = Selector.GetHandle ("buttonTouchBarItemWithIdentifier:title:image:target:action:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selButtonTouchBarItemWithIdentifier_Title_Target_Action_X = "buttonTouchBarItemWithIdentifier:title:target:action:";
		static readonly NativeHandle selButtonTouchBarItemWithIdentifier_Title_Target_Action_XHandle = Selector.GetHandle ("buttonTouchBarItemWithIdentifier:title:target:action:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSButtonTouchBarItem");
		...
		public NSButtonTouchBarItem (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSButtonTouchBarItem (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSButtonTouchBarItem (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static NSButtonTouchBarItem Create ([BindAs (typeof (NSTouchBarItemIdentifier), OriginalType = typeof (NSString))] global::AppKit.NSTouchBarItemIdentifier identifier, string title, NSObject? target, Selector? action)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			if (title is null)
			...
			using var nsb_identifier = global::AppKit.NSTouchBarItemIdentifierExtensions.GetConstant (identifier);
			var nstitle = CFString.CreateNative (title);
			NSButtonTouchBarItem? ret;
			ret =  Runtime.GetNSObject<NSButtonTouchBarItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (class_ptr, selButtonTouchBarItemWithIdentifier_Title_Target_Action_XHandle, nsb_identifier.GetHandle (), nstitle, target__handle__, action__handle__), false)!;
			GC.KeepAlive (target);
			GC.KeepAlive (action);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static NSButtonTouchBarItem Create ([BindAs (typeof (NSTouchBarItemIdentifier), OriginalType = typeof (NSString))] global::AppKit.NSTouchBarItemIdentifier identifier, NSImage image, NSObject? target, Selector? action)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			...
			using var nsb_identifier = global::AppKit.NSTouchBarItemIdentifierExtensions.GetConstant (identifier);
			NSButtonTouchBarItem? ret;
			ret =  Runtime.GetNSObject<NSButtonTouchBarItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (class_ptr, selButtonTouchBarItemWithIdentifier_Image_Target_Action_XHandle, nsb_identifier.GetHandle (), image__handle__, target__handle__, action__handle__), false)!;
			GC.KeepAlive (image);
			GC.KeepAlive (target);
			GC.KeepAlive (action);
			return ret!;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static NSButtonTouchBarItem Create ([BindAs (typeof (NSTouchBarItemIdentifier), OriginalType = typeof (NSString))] global::AppKit.NSTouchBarItemIdentifier identifier, string title, NSImage image, NSObject? target, Selector? action)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			if (title is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (title));
			...
			var nstitle = CFString.CreateNative (title);
			NSButtonTouchBarItem? ret;
			ret =  Runtime.GetNSObject<NSButtonTouchBarItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (class_ptr, selButtonTouchBarItemWithIdentifier_Title_Image_Target_Action_XHandle, nsb_identifier.GetHandle (), nstitle, image__handle__, target__handle__, action__handle__), false)!;
			GC.KeepAlive (image);
			GC.KeepAlive (target);
			GC.KeepAlive (action);
			CFString.ReleaseNative (nstitle);
