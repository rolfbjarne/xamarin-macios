...
namespace AppKit {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "GetImageForBounds", Selector = "imageForBounds:attributes:location:textContainer:", ReturnType = typeof (NSImage), ParameterType = new Type [] { typeof (CGRect), typeof (global::Foundation.NSDictionary<NSString, NSObject>), typeof (INSTextLocation), typeof (NSTextContainer) }, ParameterByRef = new bool [] { false, false, false, false })]
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "GetViewProvider", Selector = "viewProviderForParentView:location:textContainer:", ReturnType = typeof (NSTextAttachmentViewProvider), ParameterType = new Type [] { typeof (NSView), typeof (INSTextLocation), typeof (NSTextContainer) }, ParameterByRef = new bool [] { false, false, false })]
	public partial interface INSTextAttachmentLayout : INativeObject, IDisposable
	{
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static NSImage? _GetImageForBounds (INSTextAttachmentLayout This, CGRect bounds, NSDictionary<NSString, NSObject> attributes, INSTextLocation location, NSTextContainer? textContainer)
		{
			...
			NSImage? ret;
			ret =  Runtime.GetNSObject<NSImage> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_CGRect_NativeHandle_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("imageForBounds:attributes:location:textContainer:"), bounds, attributes__handle__, location__handle__, textContainer__handle__), false)!;
			GC.KeepAlive (This);
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static NSTextAttachmentViewProvider? _GetViewProvider (INSTextAttachmentLayout This, NSView? parentView, INSTextLocation location, NSTextContainer? textContainer)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
		...
		[DynamicDependencyAttribute ("GetAttachmentBounds(Foundation.NSDictionary{Foundation.NSString,Foundation.NSObject},AppKit.INSTextLocation,AppKit.NSTextContainer,CoreGraphics.CGRect,CoreGraphics.CGPoint)")]
		[DynamicDependencyAttribute ("GetImageForBounds(CoreGraphics.CGRect,Foundation.NSDictionary{Foundation.NSString,Foundation.NSObject},AppKit.INSTextLocation,AppKit.NSTextContainer)")]
		[DynamicDependencyAttribute ("GetViewProvider(AppKit.NSView,AppKit.INSTextLocation,AppKit.NSTextContainer)")]
	...
	internal unsafe sealed class NSTextAttachmentLayoutWrapper : BaseWrapper, INSTextAttachmentLayout {
		...
		[Export ("imageForBounds:attributes:location:textContainer:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public NSImage? GetImageForBounds (CGRect bounds, NSDictionary<NSString, NSObject> attributes, INSTextLocation location, NSTextContainer? textContainer)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			var attributes__handle__ = attributes!.GetNonNullHandle (nameof (attributes));
			var location__handle__ = location!.GetNonNullHandle (nameof (location));
		...
		[Export ("viewProviderForParentView:location:textContainer:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public NSTextAttachmentViewProvider? GetViewProvider (NSView? parentView, INSTextLocation location, NSTextContainer? textContainer)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			var parentView__handle__ = parentView.GetHandle ();
			var location__handle__ = location!.GetNonNullHandle (nameof (location));
