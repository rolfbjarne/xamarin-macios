...
namespace MetalPerformanceShadersGraph {
	...
	public unsafe partial class MPSGraphShapedType : MPSGraphType {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithShape_DataType_X = "initWithShape:dataType:";
		static readonly NativeHandle selInitWithShape_DataType_XHandle = Selector.GetHandle ("initWithShape:dataType:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selIsEqualTo_X = "isEqualTo:";
		static readonly NativeHandle selIsEqualTo_XHandle = Selector.GetHandle ("isEqualTo:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_UInt32 (this.Handle, selInitWithShape_DataType_XHandle, nsb_shape.GetHandle (), (UInt32)dataType), "initWithShape:dataType:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_UInt32 (&__objc_super__, selInitWithShape_DataType_XHandle, nsb_shape.GetHandle (), (UInt32)dataType), "initWithShape:dataType:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual bool IsEqualTo (MPSGraphShapedType? @object)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (this.Handle, selIsEqualTo_XHandle, @object__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, selIsEqualTo_XHandle, @object__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (@object);
		...
		public virtual int[]? Shape {
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetShape_XHandle, nsb_Shape.GetHandle ());
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetShape_XHandle, nsb_Shape.GetHandle ());
						GC.KeepAlive (this);
					}
				}
				nsb_Shape?.Dispose ();
