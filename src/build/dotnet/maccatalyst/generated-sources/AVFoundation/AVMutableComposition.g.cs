...
namespace AVFoundation {
	...
	public unsafe partial class AVMutableComposition : AVComposition {
		...
		public virtual AVMutableCompositionTrack? AddMutableTrack (string mediaType, int preferredTrackId)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<AVMutableCompositionTrack> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_int (this.Handle, Selector.GetHandle ("addMutableTrackWithMediaType:preferredTrackID:"), nsmediaType, preferredTrackId), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<AVMutableCompositionTrack> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_int (&__objc_super__, Selector.GetHandle ("addMutableTrackWithMediaType:preferredTrackID:"), nsmediaType, preferredTrackId), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual global::Cinematic.CNCompositionInfo AddTracks (global::Cinematic.CNAssetInfo assetInfo, int preferredStartingTrackID)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<global::Cinematic.CNCompositionInfo> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_int (this.Handle, Selector.GetHandle ("addTracksForCinematicAssetInfo:preferredStartingTrackID:"), assetInfo__handle__, preferredStartingTrackID), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<global::Cinematic.CNCompositionInfo> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_int (&__objc_super__, Selector.GetHandle ("addTracksForCinematicAssetInfo:preferredStartingTrackID:"), assetInfo__handle__, preferredStartingTrackID), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public static AVMutableComposition Create ()
		{
			...
			ret =  Runtime.GetNSObject<AVMutableComposition> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("composition")), false)!;
			return ret;
		}
		...
		public virtual AVMutableCompositionTrack? CreateMutableTrack (AVAssetTrack referenceTrack)
		{
			...
			AVMutableCompositionTrack? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<AVMutableCompositionTrack> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("mutableTrackCompatibleWithTrack:"), referenceTrack__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<AVMutableCompositionTrack> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("mutableTrackCompatibleWithTrack:"), referenceTrack__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public static AVMutableComposition FromOptions (NSDictionary<NSString, NSObject>? urlAssetInitializationOptions)
		{
			...
			AVMutableComposition? ret;
			ret =  Runtime.GetNSObject<AVMutableComposition> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("compositionWithURLAssetInitializationOptions:"), urlAssetInitializationOptions__handle__), false)!;
		...
		public unsafe virtual bool Insert (global::CoreMedia.CMTimeRange insertTimeRange, AVAsset sourceAsset, global::CoreMedia.CMTime atTime, out NSError error)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_CMTimeRange_NativeHandle_CMTime_ref_NativeHandle (this.Handle, Selector.GetHandle ("insertTimeRange:ofAsset:atTime:error:"), insertTimeRange, sourceAsset__handle__, atTime, &errorValue);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_CMTimeRange_NativeHandle_CMTime_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("insertTimeRange:ofAsset:atTime:error:"), insertTimeRange, sourceAsset__handle__, atTime, &errorValue);
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual void Insert (global::CoreMedia.CMTimeRange timeRange, AVAsset asset, global::CoreMedia.CMTime startTime, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAVMutableCompositionInsertHandler))]AVMutableCompositionInsertHandler completionHandler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_CMTimeRange_NativeHandle_CMTime_NativeHandle (&__objc_super__, Selector.GetHandle ("insertTimeRange:ofAsset:atTime:completionHandler:"), timeRange, asset__handle__, startTime, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (asset);
		...
		public virtual void RemoveTrack (AVCompositionTrack track)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("removeTrack:"), track__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (track);
