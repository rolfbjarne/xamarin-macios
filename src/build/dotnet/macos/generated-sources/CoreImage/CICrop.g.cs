...
#nullable enable
namespace CoreImage {
	/// <summary>The CICrop CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/Crop.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CICrop : CIFilter {
		/// <summary>Creates a new <see cref="CICrop" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CICrop () : base ("CICrop")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CICrop (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CICrop (NSObjectFlag t) : base (t)
		{
		}
		...
		public CICrop (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Gets or sets the region that will remain after the image is cropped.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
