...
namespace WebKit {
	...
	public unsafe partial class DomCssPageRule : DomCssRule {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("DOMCSSPageRule");
		...
		protected DomCssPageRule (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal DomCssPageRule (NativeHandle handle) : base (handle)
		{
		}
