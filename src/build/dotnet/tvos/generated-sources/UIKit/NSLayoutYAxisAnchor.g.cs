...
#nullable enable
namespace UIKit {
	/// <summary>An <see cref="T:UIKit.NSLayoutAnchor`1" /> whose methods create vertical <see cref="T:UIKit.NSLayoutConstraint" /> objects.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/AppKit/Reference/NSLayoutYAxisAnchor/index.html">Apple documentation for <c>NSLayoutYAxisAnchor</c></related>
	[Register("NSLayoutYAxisAnchor", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class NSLayoutYAxisAnchor : NSLayoutAnchor<NSLayoutYAxisAnchor> {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSLayoutYAxisAnchor");
		...
		public NSLayoutYAxisAnchor (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSLayoutYAxisAnchor (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSLayoutYAxisAnchor (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual NSLayoutConstraint ConstraintEqualToSystemSpacingBelowAnchor (NSLayoutYAxisAnchor anchor, nfloat multiplier)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSLayoutConstraint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_nfloat (this.Handle, Selector.GetHandle ("constraintEqualToSystemSpacingBelowAnchor:multiplier:"), anchor__handle__, multiplier), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSLayoutConstraint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_nfloat (&__objc_super__, Selector.GetHandle ("constraintEqualToSystemSpacingBelowAnchor:multiplier:"), anchor__handle__, multiplier), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (anchor);
		...
		public virtual NSLayoutConstraint ConstraintGreaterThanOrEqualToSystemSpacingBelowAnchor (NSLayoutYAxisAnchor anchor, nfloat multiplier)
		{
			...
			NSLayoutConstraint? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSLayoutConstraint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_nfloat (this.Handle, Selector.GetHandle ("constraintGreaterThanOrEqualToSystemSpacingBelowAnchor:multiplier:"), anchor__handle__, multiplier), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSLayoutConstraint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_nfloat (&__objc_super__, Selector.GetHandle ("constraintGreaterThanOrEqualToSystemSpacingBelowAnchor:multiplier:"), anchor__handle__, multiplier), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (anchor);
		...
		public virtual NSLayoutConstraint ConstraintLessThanOrEqualToSystemSpacingBelowAnchor (NSLayoutYAxisAnchor anchor, nfloat multiplier)
		{
			...
			NSLayoutConstraint? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSLayoutConstraint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_nfloat (this.Handle, Selector.GetHandle ("constraintLessThanOrEqualToSystemSpacingBelowAnchor:multiplier:"), anchor__handle__, multiplier), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSLayoutConstraint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_nfloat (&__objc_super__, Selector.GetHandle ("constraintLessThanOrEqualToSystemSpacingBelowAnchor:multiplier:"), anchor__handle__, multiplier), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (anchor);
