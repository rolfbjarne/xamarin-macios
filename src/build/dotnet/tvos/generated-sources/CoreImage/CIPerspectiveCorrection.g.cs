...
namespace CoreImage {
	...
	public partial class CIPerspectiveCorrection : CIPerspectiveTransform, ICIPerspectiveCorrectionProtocol, ICIFourCoordinateGeometryFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIPerspectiveCorrection" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPerspectiveCorrection () : base ("CIPerspectiveCorrection")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPerspectiveCorrection (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPerspectiveCorrection (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPerspectiveCorrection (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIPerspectiveCorrectionProtocol protocol members 
