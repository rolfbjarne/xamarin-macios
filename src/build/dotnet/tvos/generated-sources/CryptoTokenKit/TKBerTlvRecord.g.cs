	...
	public unsafe partial class TKBerTlvRecord : TKTlvRecord {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_UInt64_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithTag:value:"), tag, value__handle__), "initWithTag:value:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (value);
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_UInt64_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithTag:records:"), tag, nsa_records.Handle), "initWithTag:records:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		{
			NSData ret;
			ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UInt64 (class_ptr, Selector.GetHandle ("dataForTag:"), tag), false)!;
			return ret;
		}
