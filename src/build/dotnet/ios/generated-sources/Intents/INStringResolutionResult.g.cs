...
namespace Intents {
	...
	public unsafe partial class INStringResolutionResult : INIntentResolutionResult {
		...
		public static INStringResolutionResult GetConfirmationRequired (string? stringToConfirm)
		{
			...
			ret =  Runtime.GetNSObject<INStringResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("confirmationRequiredWithStringToConfirm:"), nsstringToConfirm), false)!;
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INStringResolutionResult GetConfirmationRequired (NSObject itemToConfirm, nint reason)
		{
			var itemToConfirm__handle__ = itemToConfirm!.GetNonNullHandle (nameof (itemToConfirm));
			INStringResolutionResult? ret;
			ret =  Runtime.GetNSObject<INStringResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_IntPtr (class_ptr, Selector.GetHandle ("confirmationRequiredWithItemToConfirm:forReason:"), itemToConfirm__handle__, reason), false)!;
		...
		public static INStringResolutionResult GetDisambiguation (string[] stringsToDisambiguate)
		{
			...
			INStringResolutionResult ret;
			ret =  Runtime.GetNSObject<INStringResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("disambiguationWithStringsToDisambiguate:"), nsa_stringsToDisambiguate.Handle), false)!;
			return ret;
		}
		...
		public static INStringResolutionResult GetSuccess (string resolvedString)
		{
			...
			INStringResolutionResult? ret;
			ret =  Runtime.GetNSObject<INStringResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("successWithResolvedString:"), nsresolvedString), false)!;
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INStringResolutionResult GetUnsupported (nint reason)
		{
			INStringResolutionResult ret;
			ret =  Runtime.GetNSObject<INStringResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("unsupportedWithReason:"), reason), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INStringResolutionResult NeedsValue {
			...
			get {
				INStringResolutionResult? ret;
				ret =  Runtime.GetNSObject<INStringResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("needsValue")), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INStringResolutionResult NotRequired {
			...
			get {
				INStringResolutionResult? ret;
				ret =  Runtime.GetNSObject<INStringResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("notRequired")), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INStringResolutionResult Unsupported {
			...
			get {
				INStringResolutionResult? ret;
				ret =  Runtime.GetNSObject<INStringResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("unsupported")), false)!;
				return ret!;
			}
		}
