...
namespace MonoTouchFixtures.AuthenticationServices {
	...
	public class PublicPrivateKeyAuthenticationTests {
		...
		public void GetAllSupportedPublicKeyCredentialDescriptorTransports ()
		{
			...
			ClassicAssert.IsNotNull (PublicPrivateKeyAuthentication.GetAllSupportedPublicKeyCredentialDescriptorTransports (), "The transports should not be null");
			...
			ClassicAssert.LessOrEqual (usbCounter, 1, "There were multiple usb transports found. Add any new transports to GetAllSupportedPublicKeyCredentialDescriptorTransports inside src/AuthenticationServices/PublicPrivateKeyAuthentication.cs");
		}
	}
}
#endif
