...
namespace Metal {
	...
	public unsafe partial class MTL4PipelineStageDynamicLinkingDescriptor : NSObject, INSCopying {
		...
		const string selBinaryLinkedFunctionsX = "binaryLinkedFunctions";
		static readonly NativeHandle selBinaryLinkedFunctionsXHandle = Selector.GetHandle ("binaryLinkedFunctions");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetBinaryLinkedFunctions_X = "setBinaryLinkedFunctions:";
		static readonly NativeHandle selSetBinaryLinkedFunctions_XHandle = Selector.GetHandle ("setBinaryLinkedFunctions:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual IMTL4BinaryFunction[]? BinaryLinkedFunctions {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<IMTL4BinaryFunction>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selBinaryLinkedFunctionsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<IMTL4BinaryFunction>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selBinaryLinkedFunctionsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetBinaryLinkedFunctions_XHandle, nsa_value.GetHandle ());
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetBinaryLinkedFunctions_XHandle, nsa_value.GetHandle ());
						GC.KeepAlive (this);
					}
				}
			}
