...
namespace Metal {
	...
	public unsafe partial class MTLAccelerationStructureMotionTriangleGeometryDescriptor : MTLAccelerationStructureGeometryDescriptor {
		...
		public static MTLAccelerationStructureMotionTriangleGeometryDescriptor Create ()
		{
			...
			ret =  Runtime.GetNSObject<MTLAccelerationStructureMotionTriangleGeometryDescriptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selDescriptorXHandle), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual MTLMotionKeyframeData[] VertexBuffers {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<MTLMotionKeyframeData>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selVertexBuffersXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<MTLMotionKeyframeData>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selVertexBuffersXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
