...
namespace MapKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidUpdateResults", Selector = "completerDidUpdateResults:", ParameterType = new Type [] { typeof (MapKit.MKLocalSearchCompleter) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidFail", Selector = "completer:didFailWithError:", ParameterType = new Type [] { typeof (MapKit.MKLocalSearchCompleter), typeof (NSError) }, ParameterByRef = new bool [] { false, false })]
...
namespace MapKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__MapKit_MKLocalSearchCompleterDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
