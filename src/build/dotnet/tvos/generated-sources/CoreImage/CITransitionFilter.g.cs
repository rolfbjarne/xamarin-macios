...
namespace CoreImage {
	...
	public abstract partial class CITransitionFilter : CIFilter, ICITransitionFilterProtocol, ICIFilterProtocol {
		...
		protected CITransitionFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CITransitionFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CITransitionFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CITransitionFilter" /> with the specified name.</summary>
