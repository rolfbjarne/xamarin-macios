...
#nullable enable
namespace UIKit {
	/// <summary>An enumeration of values used by the <see cref="P:UIKit.UICollectionViewFlowLayout.ScrollDirection" /> property.</summary><remarks>To be added.</remarks><altmember cref="P:UIKit.UICollectionViewFlowLayout.ScrollDirection" />
