...
namespace CoreImage {
	...
	public partial class CIColumnAverage : CIReductionFilter, ICIColumnAverageProtocol, ICIAreaReductionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColumnAverage" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIColumnAverage () : base ("CIColumnAverage")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColumnAverage (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColumnAverage (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColumnAverage (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
