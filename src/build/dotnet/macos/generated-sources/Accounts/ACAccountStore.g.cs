...
namespace Accounts {
	...
	public unsafe partial class ACAccountStore : NSObject {
		...
		const string selAccountTypeWithAccountTypeIdentifier_X = "accountTypeWithAccountTypeIdentifier:";
		static readonly NativeHandle selAccountTypeWithAccountTypeIdentifier_XHandle = Selector.GetHandle ("accountTypeWithAccountTypeIdentifier:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAccountWithIdentifier_X = "accountWithIdentifier:";
		static readonly NativeHandle selAccountWithIdentifier_XHandle = Selector.GetHandle ("accountWithIdentifier:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAccountsX = "accounts";
		static readonly NativeHandle selAccountsXHandle = Selector.GetHandle ("accounts");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAccountsWithAccountType_X = "accountsWithAccountType:";
		static readonly NativeHandle selAccountsWithAccountType_XHandle = Selector.GetHandle ("accountsWithAccountType:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRemoveAccount_WithCompletionHandler_X = "removeAccount:withCompletionHandler:";
		static readonly NativeHandle selRemoveAccount_WithCompletionHandler_XHandle = Selector.GetHandle ("removeAccount:withCompletionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRenewCredentialsForAccount_Completion_X = "renewCredentialsForAccount:completion:";
		static readonly NativeHandle selRenewCredentialsForAccount_Completion_XHandle = Selector.GetHandle ("renewCredentialsForAccount:completion:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRequestAccessToAccountsWithType_Options_Completion_X = "requestAccessToAccountsWithType:options:completion:";
		static readonly NativeHandle selRequestAccessToAccountsWithType_Options_Completion_XHandle = Selector.GetHandle ("requestAccessToAccountsWithType:options:completion:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSaveAccount_WithCompletionHandler_X = "saveAccount:withCompletionHandler:";
		static readonly NativeHandle selSaveAccount_WithCompletionHandler_XHandle = Selector.GetHandle ("saveAccount:withCompletionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual ACAccount FindAccount (string identifier)
		{
			...
			ACAccount? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<ACAccount> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selAccountWithIdentifier_XHandle, nsidentifier), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<ACAccount> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selAccountWithIdentifier_XHandle, nsidentifier), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual ACAccountType FindAccountType (string typeIdentifier)
		{
			...
			ACAccountType? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<ACAccountType> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selAccountTypeWithAccountTypeIdentifier_XHandle, nstypeIdentifier), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<ACAccountType> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selAccountTypeWithAccountTypeIdentifier_XHandle, nstypeIdentifier), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual ACAccount[] FindAccounts (ACAccountType accountType)
		{
			...
			ACAccount[]? ret;
			if (IsDirectBinding) {
				ret = CFArray.ArrayFromHandle<ACAccount>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selAccountsWithAccountType_XHandle, accountType__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFArray.ArrayFromHandle<ACAccount>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selAccountsWithAccountType_XHandle, accountType__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual void RemoveAccount (ACAccount account, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDACAccountStoreRemoveCompletionHandler))]ACAccountStoreRemoveCompletionHandler completionHandler)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selRemoveAccount_WithCompletionHandler_XHandle, account__handle__, (IntPtr) block_ptr_completionHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selRemoveAccount_WithCompletionHandler_XHandle, account__handle__, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RenewCredentials (ACAccount account, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V22))]global::System.Action<ACAccountCredentialRenewResult, NSError> completionHandler)
		{
			var account__handle__ = account!.GetNonNullHandle (nameof (account));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			...
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selRenewCredentialsForAccount_Completion_XHandle, account__handle__, (IntPtr) block_ptr_completionHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selRenewCredentialsForAccount_Completion_XHandle, account__handle__, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (account);
		...
		protected unsafe virtual void RequestAccess (ACAccountType accountType, NSDictionary? options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDACRequestCompletionHandler))]ACRequestCompletionHandler completion)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, selRequestAccessToAccountsWithType_Options_Completion_XHandle, accountType__handle__, options__handle__, (IntPtr) block_ptr_completion);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selRequestAccessToAccountsWithType_Options_Completion_XHandle, accountType__handle__, options__handle__, (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (accountType);
		...
		public unsafe virtual void SaveAccount (ACAccount account, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDACAccountStoreSaveCompletionHandler))]ACAccountStoreSaveCompletionHandler completionHandler)
		{
			...
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selSaveAccount_WithCompletionHandler_XHandle, account__handle__, (IntPtr) block_ptr_completionHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selSaveAccount_WithCompletionHandler_XHandle, account__handle__, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (account);
		...
		public virtual ACAccount[] Accounts {
			...
			get {
				ACAccount[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<ACAccount>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selAccountsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<ACAccount>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selAccountsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				MarkDirty ();
