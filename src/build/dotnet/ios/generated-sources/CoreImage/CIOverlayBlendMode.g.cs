...
#nullable enable
namespace CoreImage {
	/// <summary>The CIOverlayBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 
	/// // Construct the OverlayBlend filter
	...
	/// var output = overlayBlend.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/OverlayBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIOverlayBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIOverlayBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIOverlayBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIOverlayBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIOverlayBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
