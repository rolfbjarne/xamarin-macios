...
#nullable enable
namespace Vision {
	[Register("VNGeneratePersonSegmentationRequest", true)]
	[SupportedOSPlatform ("tvos15.0")]
	[SupportedOSPlatform ("ios15.0")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
	public unsafe partial class VNGeneratePersonSegmentationRequest : VNStatefulRequest {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selQualityLevelX = "qualityLevel";
		static readonly NativeHandle selQualityLevelXHandle = Selector.GetHandle ("qualityLevel");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>Creates a new <see cref="VNGeneratePersonSegmentationRequest" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public VNGeneratePersonSegmentationRequest () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected VNGeneratePersonSegmentationRequest (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal VNGeneratePersonSegmentationRequest (NativeHandle handle) : base (handle)
		{
		}

		[Export ("initWithCompletionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe VNGeneratePersonSegmentationRequest ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDVNRequestCompletionHandler))]VNRequestCompletionHandler? completionHandler)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe VNGeneratePersonSegmentationRequest (global::CoreMedia.CMTime frameAnalysisSpacing, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDVNRequestCompletionHandler))]VNRequestCompletionHandler? completionHandler)
			: base (NSObjectFlag.Empty)
		{
			using var block_completionHandler = Trampolines.SDVNRequestCompletionHandler.CreateNullableBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = null;
		...
		{
			VNGeneratePersonSegmentationRequest? ret;
			ret =  Runtime.GetNSObject<VNGeneratePersonSegmentationRequest> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selNewXHandle), true)!;
			return ret!;
		}
		...
		public unsafe virtual global::CoreVideo.CVPixelFormatType[]? GetSupportedOutputPixelFormats (out NSError error)
		{
			...
			if (IsDirectBinding) {
				ret = NSArray.ArrayFromHandleFunc <global::CoreVideo.CVPixelFormatType> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_ref_NativeHandle (this.Handle, selSupportedOutputPixelFormatsAndReturnError_XHandle, &errorValue), ptr => (global::CoreVideo.CVPixelFormatType) NSNumber.ToUInt32 (ptr), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = NSArray.ArrayFromHandleFunc <global::CoreVideo.CVPixelFormatType> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_ref_NativeHandle (&__objc_super__, selSupportedOutputPixelFormatsAndReturnError_XHandle, &errorValue), ptr => (global::CoreVideo.CVPixelFormatType) NSNumber.ToUInt32 (ptr), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual uint OutputPixelFormat {
			...
			get {
				uint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UInt32_objc_msgSend (this.Handle, selOutputPixelFormatXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UInt32_objc_msgSendSuper (&__objc_super__, selOutputPixelFormatXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UInt32 (this.Handle, selSetOutputPixelFormat_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UInt32 (&__objc_super__, selSetOutputPixelFormat_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual VNGeneratePersonSegmentationRequestQualityLevel QualityLevel {
			[Export ("qualityLevel", ArgumentSemantic.Assign)]
			get {
				VNGeneratePersonSegmentationRequestQualityLevel ret;
				if (IsDirectBinding) {
					ret = (Vision.VNGeneratePersonSegmentationRequestQualityLevel) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selQualityLevelXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (Vision.VNGeneratePersonSegmentationRequestQualityLevel) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selQualityLevelXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
			}
			[Export ("setQualityLevel:", ArgumentSemantic.Assign)]
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selSetQualityLevel_XHandle, (UIntPtr) (ulong) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selSetQualityLevel_XHandle, (UIntPtr) (ulong) value);
						GC.KeepAlive (this);
					}
				}
			}
