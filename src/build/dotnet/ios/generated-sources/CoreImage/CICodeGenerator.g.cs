...
namespace CoreImage {
	...
	public abstract partial class CICodeGenerator : CIFilter {
		...
		protected internal CICodeGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CICodeGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CICodeGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CICodeGenerator" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public  CICodeGenerator (string name) : base (CreateFilter (name))
		{
		}
		/// <summary>Gets or sets the message to encode.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
