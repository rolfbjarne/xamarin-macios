...
namespace CoreImage {
	...
	public unsafe static partial class CIContext_ImageRepresentation  {
		...
		const string selHEIF10RepresentationOfImage_ColorSpace_Options_Error_X = "HEIF10RepresentationOfImage:colorSpace:options:error:";
		static readonly NativeHandle selHEIF10RepresentationOfImage_ColorSpace_Options_Error_XHandle = Selector.GetHandle ("HEIF10RepresentationOfImage:colorSpace:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selHEIFRepresentationOfImage_Format_ColorSpace_Options_X = "HEIFRepresentationOfImage:format:colorSpace:options:";
		static readonly NativeHandle selHEIFRepresentationOfImage_Format_ColorSpace_Options_XHandle = Selector.GetHandle ("HEIFRepresentationOfImage:format:colorSpace:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selJPEGRepresentationOfImage_ColorSpace_Options_X = "JPEGRepresentationOfImage:colorSpace:options:";
		static readonly NativeHandle selJPEGRepresentationOfImage_ColorSpace_Options_XHandle = Selector.GetHandle ("JPEGRepresentationOfImage:colorSpace:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPNGRepresentationOfImage_Format_ColorSpace_Options_X = "PNGRepresentationOfImage:format:colorSpace:options:";
		static readonly NativeHandle selPNGRepresentationOfImage_Format_ColorSpace_Options_XHandle = Selector.GetHandle ("PNGRepresentationOfImage:format:colorSpace:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTIFFRepresentationOfImage_Format_ColorSpace_Options_X = "TIFFRepresentationOfImage:format:colorSpace:options:";
		static readonly NativeHandle selTIFFRepresentationOfImage_Format_ColorSpace_Options_XHandle = Selector.GetHandle ("TIFFRepresentationOfImage:format:colorSpace:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selWriteHEIF10RepresentationOfImage_ToURL_ColorSpace_Options_Error_X = "writeHEIF10RepresentationOfImage:toURL:colorSpace:options:error:";
		static readonly NativeHandle selWriteHEIF10RepresentationOfImage_ToURL_ColorSpace_Options_Error_XHandle = Selector.GetHandle ("writeHEIF10RepresentationOfImage:toURL:colorSpace:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selWriteHEIFRepresentationOfImage_ToURL_Format_ColorSpace_Options_Error_X = "writeHEIFRepresentationOfImage:toURL:format:colorSpace:options:error:";
		static readonly NativeHandle selWriteHEIFRepresentationOfImage_ToURL_Format_ColorSpace_Options_Error_XHandle = Selector.GetHandle ("writeHEIFRepresentationOfImage:toURL:format:colorSpace:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selWriteJPEGRepresentationOfImage_ToURL_ColorSpace_Options_Error_X = "writeJPEGRepresentationOfImage:toURL:colorSpace:options:error:";
		static readonly NativeHandle selWriteJPEGRepresentationOfImage_ToURL_ColorSpace_Options_Error_XHandle = Selector.GetHandle ("writeJPEGRepresentationOfImage:toURL:colorSpace:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selWritePNGRepresentationOfImage_ToURL_Format_ColorSpace_Options_Error_X = "writePNGRepresentationOfImage:toURL:format:colorSpace:options:error:";
		static readonly NativeHandle selWritePNGRepresentationOfImage_ToURL_Format_ColorSpace_Options_Error_XHandle = Selector.GetHandle ("writePNGRepresentationOfImage:toURL:format:colorSpace:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selWriteTIFFRepresentationOfImage_ToURL_Format_ColorSpace_Options_Error_X = "writeTIFFRepresentationOfImage:toURL:format:colorSpace:options:error:";
		static readonly NativeHandle selWriteTIFFRepresentationOfImage_ToURL_Format_ColorSpace_Options_Error_XHandle = Selector.GetHandle ("writeTIFFRepresentationOfImage:toURL:format:colorSpace:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public unsafe static NSData? GetHeif10Representation (this CIContext This, CIImage image, CGColorSpace colorSpace, NSDictionary options, out NSError? error)
		{
			...
			NSData? ret;
			ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_ref_NativeHandle (This.Handle, selHEIF10RepresentationOfImage_ColorSpace_Options_Error_XHandle, image__handle__, colorSpace.Handle, options__handle__, &errorValue), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (image);
		...
		public static NSData? GetHeifRepresentation (this CIContext This, CIImage image, CIFormat format, CGColorSpace colorSpace, NSDictionary options)
		{
			...
			var options__handle__ = options!.GetNonNullHandle (nameof (options));
			NSData? ret;
			ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_int_NativeHandle_NativeHandle (This.Handle, selHEIFRepresentationOfImage_Format_ColorSpace_Options_XHandle, image__handle__, (int)format, colorSpace.Handle, options__handle__), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (image);
			GC.KeepAlive (colorSpace);
			GC.KeepAlive (options);
		...
		public static NSData? GetJpegRepresentation (this CIContext This, CIImage image, CGColorSpace colorSpace, NSDictionary options)
		{
			...
			var options__handle__ = options!.GetNonNullHandle (nameof (options));
			NSData? ret;
			ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (This.Handle, selJPEGRepresentationOfImage_ColorSpace_Options_XHandle, image__handle__, colorSpace.Handle, options__handle__), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (image);
			GC.KeepAlive (colorSpace);
			GC.KeepAlive (options);
		...
		public static NSData? GetPngRepresentation (this CIContext This, CIImage image, CIFormat format, CGColorSpace colorSpace, NSDictionary options)
		{
			...
			var options__handle__ = options!.GetNonNullHandle (nameof (options));
			NSData? ret;
			ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_int_NativeHandle_NativeHandle (This.Handle, selPNGRepresentationOfImage_Format_ColorSpace_Options_XHandle, image__handle__, (int)format, colorSpace.Handle, options__handle__), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (image);
			GC.KeepAlive (colorSpace);
			GC.KeepAlive (options);
		...
		public static NSData? GetTiffRepresentation (this CIContext This, CIImage image, CIFormat format, CGColorSpace colorSpace, NSDictionary options)
		{
			...
			var options__handle__ = options!.GetNonNullHandle (nameof (options));
			NSData? ret;
			ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_int_NativeHandle_NativeHandle (This.Handle, selTIFFRepresentationOfImage_Format_ColorSpace_Options_XHandle, image__handle__, (int)format, colorSpace.Handle, options__handle__), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (image);
			GC.KeepAlive (colorSpace);
			GC.KeepAlive (options);
		...
		public unsafe static bool WriteHeif10Representation (this CIContext This, CIImage image, NSUrl url, CGColorSpace colorSpace, NSDictionary options, out NSError? error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_ref_NativeHandle (This.Handle, selWriteHEIF10RepresentationOfImage_ToURL_ColorSpace_Options_Error_XHandle, image__handle__, url__handle__, colorSpace.Handle, options__handle__, &errorValue);
			GC.KeepAlive (This);
			GC.KeepAlive (image);
			GC.KeepAlive (url);
			GC.KeepAlive (colorSpace);
		...
		public unsafe static bool WriteHeifRepresentation (this CIContext This, CIImage image, NSUrl url, CIFormat format, CGColorSpace colorSpace, NSDictionary options, out NSError? error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle_int_NativeHandle_NativeHandle_ref_NativeHandle (This.Handle, selWriteHEIFRepresentationOfImage_ToURL_Format_ColorSpace_Options_Error_XHandle, image__handle__, url__handle__, (int)format, colorSpace.Handle, options__handle__, &errorValue);
			GC.KeepAlive (This);
			GC.KeepAlive (image);
			GC.KeepAlive (url);
			GC.KeepAlive (colorSpace);
		...
		public unsafe static bool WriteJpegRepresentation (this CIContext This, CIImage image, NSUrl url, CGColorSpace colorSpace, NSDictionary options, out NSError? error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_ref_NativeHandle (This.Handle, selWriteJPEGRepresentationOfImage_ToURL_ColorSpace_Options_Error_XHandle, image__handle__, url__handle__, colorSpace.Handle, options__handle__, &errorValue);
			GC.KeepAlive (This);
			GC.KeepAlive (image);
			GC.KeepAlive (url);
			GC.KeepAlive (colorSpace);
		...
		public unsafe static bool WritePngRepresentation (this CIContext This, CIImage image, NSUrl url, CIFormat format, CGColorSpace colorSpace, NSDictionary options, out NSError? error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle_int_NativeHandle_NativeHandle_ref_NativeHandle (This.Handle, selWritePNGRepresentationOfImage_ToURL_Format_ColorSpace_Options_Error_XHandle, image__handle__, url__handle__, (int)format, colorSpace.Handle, options__handle__, &errorValue);
			GC.KeepAlive (This);
			GC.KeepAlive (image);
			GC.KeepAlive (url);
			GC.KeepAlive (colorSpace);
		...
		public unsafe static bool WriteTiffRepresentation (this CIContext This, CIImage image, NSUrl url, CIFormat format, CGColorSpace colorSpace, NSDictionary options, out NSError error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle_int_NativeHandle_NativeHandle_ref_NativeHandle (This.Handle, selWriteTIFFRepresentationOfImage_ToURL_Format_ColorSpace_Options_Error_XHandle, image__handle__, url__handle__, (int)format, colorSpace.Handle, options__handle__, &errorValue);
			GC.KeepAlive (This);
			GC.KeepAlive (image);
			GC.KeepAlive (url);
			GC.KeepAlive (colorSpace);
