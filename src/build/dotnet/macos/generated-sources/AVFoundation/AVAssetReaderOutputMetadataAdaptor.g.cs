...
namespace AVFoundation {
	...
	public unsafe partial class AVAssetReaderOutputMetadataAdaptor : NSObject {
		...
		const string selAssetReaderOutputMetadataAdaptorWithAssetReaderTrackOutput_X = "assetReaderOutputMetadataAdaptorWithAssetReaderTrackOutput:";
		static readonly NativeHandle selAssetReaderOutputMetadataAdaptorWithAssetReaderTrackOutput_XHandle = Selector.GetHandle ("assetReaderOutputMetadataAdaptorWithAssetReaderTrackOutput:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNextTimedMetadataGroupX = "nextTimedMetadataGroup";
		static readonly NativeHandle selNextTimedMetadataGroupXHandle = Selector.GetHandle ("nextTimedMetadataGroup");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static AVAssetReaderOutputMetadataAdaptor Create (AVAssetReaderTrackOutput trackOutput)
		{
			...
			ret =  Runtime.GetNSObject<AVAssetReaderOutputMetadataAdaptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selAssetReaderOutputMetadataAdaptorWithAssetReaderTrackOutput_XHandle, trackOutput__handle__), false)!;
			GC.KeepAlive (trackOutput);
			return ret!;
		}
		...
		public virtual AVTimedMetadataGroup? NextTimedMetadataGroup ()
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<AVTimedMetadataGroup> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selNextTimedMetadataGroupXHandle), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<AVTimedMetadataGroup> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selNextTimedMetadataGroupXHandle), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
