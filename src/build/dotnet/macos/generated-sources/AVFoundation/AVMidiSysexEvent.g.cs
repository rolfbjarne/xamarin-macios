...
namespace AVFoundation {
	...
	public unsafe partial class AVMidiSysexEvent : AVMusicEvent {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSizeInBytesX = "sizeInBytes";
		static readonly NativeHandle selSizeInBytesXHandle = Selector.GetHandle ("sizeInBytes");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual uint SizeInBytes {
			...
			get {
				uint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UInt32_objc_msgSend (this.Handle, selSizeInBytesXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UInt32_objc_msgSendSuper (&__objc_super__, selSizeInBytesXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
