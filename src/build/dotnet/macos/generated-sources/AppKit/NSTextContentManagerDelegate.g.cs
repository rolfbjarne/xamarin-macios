...
namespace AppKit {
	...
	public partial interface INSTextContentManagerDelegate : INativeObject, IDisposable
	{
		...
		[DynamicDependencyAttribute ("GetTextContentManager(AppKit.NSTextContentManager,AppKit.INSTextLocation)")]
		[DynamicDependencyAttribute ("ShouldEnumerateTextElement(AppKit.NSTextContentManager,AppKit.NSTextElement,AppKit.NSTextContentManagerEnumerationOptions)")]
...
namespace AppKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__AppKit_NSTextContentManagerDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
	[UnsupportedOSPlatform ("tvos")]
