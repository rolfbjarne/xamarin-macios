...
namespace AuthenticationServices {
	...
	public unsafe partial class ASAuthorizationWebBrowserPublicKeyCredentialManager : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetPlatformCredentials (string relyingParty, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V17))]global::System.Action<ASAuthorizationWebBrowserPlatformPublicKeyCredential[]> completionHandler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("platformCredentialsForRelyingParty:completionHandler:"), nsrelyingParty, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RequestAuthorization ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V18))]global::System.Action<ASAuthorizationWebBrowserPublicKeyCredentialManagerAuthorizationState> completionHandler)
		{
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("requestAuthorizationForPublicKeyCredentials:"), (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual ASAuthorizationWebBrowserPublicKeyCredentialManagerAuthorizationState AuthorizationStateForPlatformCredentials {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (AuthenticationServices.ASAuthorizationWebBrowserPublicKeyCredentialManagerAuthorizationState) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("authorizationStateForPlatformCredentials"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public static bool IsDeviceConfiguredForPasskeys {
			...
			get {
				byte ret;
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (class_ptr, Selector.GetHandle ("isDeviceConfiguredForPasskeys"));
				return ret != 0;
			}
		}
