...
namespace AVKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "RestoreUserInterfaceForPictureInPicture", Selector = "pictureInPictureController:restoreUserInterfaceForPictureInPictureStopWithCompletionHandler:", ParameterType = new Type [] { typeof (AVKit.AVPictureInPictureController), typeof (global::System.Action<bool>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V0) })]
	public partial interface IAVPictureInPictureControllerDelegate : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RestoreUserInterfaceForPictureInPicture (AVPictureInPictureController pictureInPictureController, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<bool> completionHandler)
		{
			_RestoreUserInterfaceForPictureInPicture (this, pictureInPictureController, completionHandler);
		}
		/// <param name="pictureInPictureController">To be added.</param><param name="completionHandler">To be added.</param><summary>Picture In Picture playback is about to stop. Called to give the app the opportunity to provide a playback user interface by passing <see langword="true" /> to <paramref name="completionHandler" />.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _RestoreUserInterfaceForPictureInPicture (IAVPictureInPictureControllerDelegate This, AVPictureInPictureController pictureInPictureController, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<bool> completionHandler)
		{
			var pictureInPictureController__handle__ = pictureInPictureController!.GetNonNullHandle (nameof (pictureInPictureController));
	...
	public unsafe static partial class AVPictureInPictureControllerDelegate_Extensions {
		...
		/// <param name="pictureInPictureController">To be added.</param><param name="completionHandler">To be added.</param><summary>Picture In Picture playback is about to stop. Called to give the app the opportunity to provide a playback user interface by passing <see langword="true" /> to <paramref name="completionHandler" />.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void RestoreUserInterfaceForPictureInPicture (this IAVPictureInPictureControllerDelegate This, AVPictureInPictureController pictureInPictureController, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<bool> completionHandler)
		{
			var pictureInPictureController__handle__ = pictureInPictureController!.GetNonNullHandle (nameof (pictureInPictureController));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
...
namespace AVKit {
	/// <summary>Delegate object providing methods for the application's <see cref="T:AVKit.AVPictureInPictureController" /> at the start and stop of picture-in-picture video playback.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/AVKit/Reference/AVPictureInPictureControllerDelegate_Protocol/index.html">Apple documentation for <c>AVPictureInPictureControllerDelegate</c></related>
	[Protocol()]
	[Register("Microsoft_tvOS__AVKit_AVPictureInPictureControllerDelegate", false)]
	[Model]
	[SupportedOSPlatform ("tvos14.0")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
