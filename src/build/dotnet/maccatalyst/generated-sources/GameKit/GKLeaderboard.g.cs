...
namespace GameKit {
	...
	public unsafe partial class GKLeaderboard : NSObject {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void SetDefaultLeaderboard (string? leaderboardIdentifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError>? notificationHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var nsleaderboardIdentifier = CFString.CreateNative (leaderboardIdentifier);
			using var block_notificationHandler = Trampolines.SDActionArity1V20.CreateNullableBlock (notificationHandler);
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void SubmitScore (nint score, nuint context, GKPlayer player, string[] leaderboardIds, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void SubmitScore (nint score, nuint context, GKPlayer player, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var player__handle__ = player!.GetNonNullHandle (nameof (player));
			if (completionHandler is null)
