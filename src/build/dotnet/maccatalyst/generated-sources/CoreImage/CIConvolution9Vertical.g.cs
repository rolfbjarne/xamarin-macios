...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that performs a vertical convolution of 9 elements.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/convolution_9_vertical.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIConvolution9Vertical : CIConvolutionCore {
		/// <summary>Creates a new <see cref="CIConvolution9Vertical" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIConvolution9Vertical () : base ("CIConvolution9Vertical")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIConvolution9Vertical (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIConvolution9Vertical (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIConvolution9Vertical (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
