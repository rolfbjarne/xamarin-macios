...
#nullable enable
namespace CoreImage {
	/// <summary>Applies a Gaussian blur.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/clouds.jpg" alt="Photograph of clouds and sunbeams." /></para><para>
	/// Produces the following output:
	/// </para><para><img href="~/xml/CoreImage/_images/gaussian_blur.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIGaussianBlur : CIFilter, ICIGaussianBlurProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIGaussianBlur" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIGaussianBlur (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIGaussianBlur (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIGaussianBlur (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIGaussianBlurProtocol protocol members 
