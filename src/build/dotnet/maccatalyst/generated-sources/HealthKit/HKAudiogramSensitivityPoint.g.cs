...
namespace HealthKit {
	...
	public unsafe partial class HKAudiogramSensitivityPoint : NSObject, INSCoding, INSSecureCoding {
		...
		public unsafe static HKAudiogramSensitivityPoint? GetSensitivityPoint (HKQuantity frequency, HKQuantity? leftEarSensitivity, HKQuantity? rightEarSensitivity, out NSError? error)
		{
			...
			ret =  Runtime.GetNSObject<HKAudiogramSensitivityPoint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_ref_NativeHandle (class_ptr, Selector.GetHandle ("sensitivityPointWithFrequency:leftEarSensitivity:rightEarSensitivity:error:"), frequency__handle__, leftEarSensitivity__handle__, rightEarSensitivity__handle__, &errorValue), false)!;
		...
		public unsafe static HKAudiogramSensitivityPoint? GetSensitivityPoint (HKQuantity frequency, HKAudiogramSensitivityTest[] tests, out NSError? error)
		{
			...
			HKAudiogramSensitivityPoint? ret;
			ret =  Runtime.GetNSObject<HKAudiogramSensitivityPoint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (class_ptr, Selector.GetHandle ("sensitivityPointWithFrequency:tests:error:"), frequency__handle__, nsa_tests.Handle, &errorValue), false)!;
			GC.KeepAlive (frequency);
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		}
		...
		public virtual HKQuantity Frequency {
			...
			get {
				HKQuantity? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("frequency")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("frequency")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual HKQuantity? LeftEarSensitivity {
			...
			get {
				HKQuantity? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("leftEarSensitivity")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("leftEarSensitivity")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual HKQuantity? RightEarSensitivity {
			...
			get {
				HKQuantity? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("rightEarSensitivity")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKQuantity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("rightEarSensitivity")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual HKAudiogramSensitivityTest[] Tests {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<HKAudiogramSensitivityTest>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("tests")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<HKAudiogramSensitivityTest>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("tests")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
