...
namespace Foundation {
	...
	public unsafe partial class NSError : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		public static NSError GetFileProviderError (global::FileProvider.INSFileProviderItem existingItem)
		{
			...
			NSError? ret;
			ret =  Runtime.GetNSObject<NSError> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("fileProviderErrorForCollisionWithItem:"), existingItem__handle__), false)!;
		...
		public static NSError GetFileProviderError (string nonExistentItemIdentifier)
		{
			...
			NSError? ret;
			ret =  Runtime.GetNSObject<NSError> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("fileProviderErrorForNonExistentItemWithIdentifier:"), nsnonExistentItemIdentifier), false)!;
		...
		public static NSError GetFileProviderErrorForRejectedDeletion (global::FileProvider.INSFileProviderItem updatedVersion)
		{
			...
			NSError? ret;
			ret =  Runtime.GetNSObject<NSError> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("fileProviderErrorForRejectedDeletionOfItem:"), updatedVersion__handle__), false)!;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _CarPlayErrorDomain;
		/// <summary>Represents the value associated with the constant 'CarPlayErrorDomain'.</summary>
		[Field ("CarPlayErrorDomain",  "CarPlay")]
		[UnsupportedOSPlatform ("macos")]
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("maccatalyst")]
		public static NSString CarPlayErrorDomain {
			[UnsupportedOSPlatform ("macos")]
			[UnsupportedOSPlatform ("tvos")]
			[SupportedOSPlatform ("ios")]
			[UnsupportedOSPlatform ("maccatalyst")]
			get {
				if (_CarPlayErrorDomain is null)
					_CarPlayErrorDomain = Dlfcn.GetStringConstant (Libraries.CarPlay.Handle, "CarPlayErrorDomain")!;
				return _CarPlayErrorDomain;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _UIApplicationCategoryDefaultRetryAvailabilityDateErrorKey;
		/// <summary>Represents the value associated with the constant 'UIApplicationCategoryDefaultRetryAvailabilityDateErrorKey'.</summary>
		[Field ("UIApplicationCategoryDefaultRetryAvailabilityDateErrorKey",  "UIKit")]
		[SupportedOSPlatform ("ios18.2")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("macos")]
		public static NSString UIApplicationCategoryDefaultRetryAvailabilityDateErrorKey {
			[SupportedOSPlatform ("ios18.2")]
			[UnsupportedOSPlatform ("maccatalyst")]
			[UnsupportedOSPlatform ("tvos")]
			[UnsupportedOSPlatform ("macos")]
			get {
				if (_UIApplicationCategoryDefaultRetryAvailabilityDateErrorKey is null)
					_UIApplicationCategoryDefaultRetryAvailabilityDateErrorKey = Dlfcn.GetStringConstant (Libraries.UIKit.Handle, "UIApplicationCategoryDefaultRetryAvailabilityDateErrorKey")!;
				return _UIApplicationCategoryDefaultRetryAvailabilityDateErrorKey;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _UIApplicationCategoryDefaultStatusLastProvidedDateErrorKey;
		/// <summary>Represents the value associated with the constant 'UIApplicationCategoryDefaultStatusLastProvidedDateErrorKey'.</summary>
		[Field ("UIApplicationCategoryDefaultStatusLastProvidedDateErrorKey",  "UIKit")]
		[SupportedOSPlatform ("ios18.2")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("macos")]
		public static NSString UIApplicationCategoryDefaultStatusLastProvidedDateErrorKey {
			[SupportedOSPlatform ("ios18.2")]
			[UnsupportedOSPlatform ("maccatalyst")]
			[UnsupportedOSPlatform ("tvos")]
			[UnsupportedOSPlatform ("macos")]
			get {
				if (_UIApplicationCategoryDefaultStatusLastProvidedDateErrorKey is null)
					_UIApplicationCategoryDefaultStatusLastProvidedDateErrorKey = Dlfcn.GetStringConstant (Libraries.UIKit.Handle, "UIApplicationCategoryDefaultStatusLastProvidedDateErrorKey")!;
				return _UIApplicationCategoryDefaultStatusLastProvidedDateErrorKey;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
