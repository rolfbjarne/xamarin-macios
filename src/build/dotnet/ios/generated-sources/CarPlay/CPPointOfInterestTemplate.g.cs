...
#nullable enable
namespace CarPlay {
	[Register("CPPointOfInterestTemplate", true)]
	[UnsupportedOSPlatform ("tvos")]
	[UnsupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("ios14.0")]
	public unsafe partial class CPPointOfInterestTemplate : CPTemplate, ICPBarButtonProviding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("CPPointOfInterestTemplate");
		...
		public CPPointOfInterestTemplate (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected CPPointOfInterestTemplate (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CPPointOfInterestTemplate (NativeHandle handle) : base (handle)
		{
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (pointsOfInterest is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (pointsOfInterest));
			var nstitle = CFString.CreateNative (title);
			using var nsa_pointsOfInterest = NSArray.FromNSObjects (pointsOfInterest);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_IntPtr (this.Handle, Selector.GetHandle ("initWithTitle:pointsOfInterest:selectedIndex:"), nstitle, nsa_pointsOfInterest.Handle, selectedIndex), "initWithTitle:pointsOfInterest:selectedIndex:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_IntPtr (&__objc_super__, Selector.GetHandle ("initWithTitle:pointsOfInterest:selectedIndex:"), nstitle, nsa_pointsOfInterest.Handle, selectedIndex), "initWithTitle:pointsOfInterest:selectedIndex:");
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void SetPointsOfInterest (CPPointOfInterest[] pointsOfInterest, nint selectedIndex)
		{
			...
			using var nsa_pointsOfInterest = NSArray.FromNSObjects (pointsOfInterest);
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_IntPtr (this.Handle, Selector.GetHandle ("setPointsOfInterest:selectedIndex:"), nsa_pointsOfInterest.Handle, selectedIndex);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_IntPtr (&__objc_super__, Selector.GetHandle ("setPointsOfInterest:selectedIndex:"), nsa_pointsOfInterest.Handle, selectedIndex);
					GC.KeepAlive (this);
				}
			}
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public ICPPointOfInterestTemplateDelegate? PointOfInterestDelegate {
			get {
				return (WeakPointOfInterestDelegate as ICPPointOfInterestTemplateDelegate)!;
			}
			set {
				var rvalue = value as NSObject;
				if (!(value is null) && rvalue is null)
					throw new ArgumentException ("The object passed of type " + value.GetType () + " does not derive from NSObject");
				WeakPointOfInterestDelegate = rvalue;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual CPPointOfInterest[] PointsOfInterest {
			[Export ("pointsOfInterest")]
			get {
				CPPointOfInterest[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<CPPointOfInterest>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("pointsOfInterest")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<CPPointOfInterest>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("pointsOfInterest")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		object? __mt_WeakPointOfInterestDelegate_var;
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSObject? WeakPointOfInterestDelegate {
			[Export ("pointOfInterestDelegate", ArgumentSemantic.Weak)]
			get {
				NSObject? ret;
				if (IsDirectBinding) {
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("pointOfInterestDelegate")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("pointOfInterestDelegate")), false)!;
						GC.KeepAlive (this);
					}
				}
				MarkDirty ();
				__mt_WeakPointOfInterestDelegate_var = ret;
				return ret!;
			}
			[Export ("setPointOfInterestDelegate:", ArgumentSemantic.Weak)]
			set {
				var value__handle__ = value.GetHandle ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setPointOfInterestDelegate:"), value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setPointOfInterestDelegate:"), value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
				MarkDirty ();
				__mt_WeakPointOfInterestDelegate_var = value;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected override void Dispose (bool disposing)
		{
			...
			if (Handle == IntPtr.Zero) {
				__mt_WeakPointOfInterestDelegate_var = null;
			}
		}
