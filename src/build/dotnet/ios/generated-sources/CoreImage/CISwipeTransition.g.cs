...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITransitionFilter" /> that swipes from one image to the other.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 
	/// // Create a CISwipeTransition filter with the input image
	...
	/// var output = swipe_transition.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/swipe_transition.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CISwipeTransition : CITransitionFilter {
		/// <summary>Creates a new <see cref="CISwipeTransition" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISwipeTransition (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISwipeTransition (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISwipeTransition (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Gets or sets the color of the swipe boundary.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>Gets or sets the width of the swipe boundary.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public float Width {
			get {
		...
		/// <summary>Gets or sets the opacity of the swipe.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>Gets or sets the angle of the swipe.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public float Angle {
			get {
		...
		/// <summary>Gets or sets the extent of the image to transform.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
