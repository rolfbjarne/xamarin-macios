...
namespace SearchKit
{
	...
	public class SKDocument : NativeObject
	{
		...
		public SKDocument (NSUrl url)
			: base (SKDocumentCreateWithURL (ThrowHelper.ThrowArgumentNullExceptionIfNeeded (url, nameof (url)).Handle), true, true)
		{
		}
	...
	public class SKIndex : NonRefcountedNativeObject
	{
		[DllImport (Constants.SearchKitLibrary)]
