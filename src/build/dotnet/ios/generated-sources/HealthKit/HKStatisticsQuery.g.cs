...
#nullable enable
namespace HealthKit {
	/// <summary>An <see cref="T:HealthKit.HKQuery" /> that can calculate basic statistics (such as the sum and mean) on its constituent data.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/HealthKit/Reference/HKStatisticsQuery_Class/index.html">Apple documentation for <c>HKStatisticsQuery</c></related>
	...
	public unsafe partial class HKStatisticsQuery : HKQuery {
		...
		static readonly NativeHandle class_ptr = Class.GetHandle ("HKStatisticsQuery");
		...
		protected HKStatisticsQuery (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal HKStatisticsQuery (NativeHandle handle) : base (handle)
		{
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			using var block_handler = Trampolines.SDHKStatisticsQueryHandler.CreateBlock (handler);
			BlockLiteral *block_ptr_handler = &block_handler;
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_UIntPtr_NativeHandle (this.Handle, Selector.GetHandle ("initWithQuantityType:quantitySamplePredicate:options:completionHandler:"), quantityType__handle__, quantitySamplePredicate__handle__, (UIntPtr) (ulong) options, (IntPtr) block_ptr_handler), "initWithQuantityType:quantitySamplePredicate:options:completionHandler:");
			} else {
				unsafe {
