...
#nullable enable
namespace CoreImage {
	/// <summary>The CIColorDodgeBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/ColorDodgeBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIColorDodgeBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIColorDodgeBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorDodgeBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorDodgeBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorDodgeBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
