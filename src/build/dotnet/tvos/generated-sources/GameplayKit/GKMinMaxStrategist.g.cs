...
namespace GameplayKit {
	...
	public unsafe partial class GKMinMaxStrategist : NSObject, IGKStrategist {
		...
		public virtual IGKGameModelUpdate? GetBestMove (IGKGameModelPlayer player)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetINativeObject<IGKGameModelUpdate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("bestMoveForPlayer:"), player__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IGKGameModelUpdate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("bestMoveForPlayer:"), player__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (player);
		...
		public virtual IGKGameModelUpdate GetBestMoveForActivePlayer ()
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IGKGameModelUpdate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("bestMoveForActivePlayer")), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual IGKGameModelUpdate? GetRandomMove (IGKGameModelPlayer player, nint numMovesToConsider)
		{
			...
			IGKGameModelUpdate? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetINativeObject<IGKGameModelUpdate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_IntPtr (this.Handle, Selector.GetHandle ("randomMoveForPlayer:fromNumberOfBestMoves:"), player__handle__, numMovesToConsider), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IGKGameModelUpdate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_IntPtr (&__objc_super__, Selector.GetHandle ("randomMoveForPlayer:fromNumberOfBestMoves:"), player__handle__, numMovesToConsider), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (player);
		...
		public virtual IGKGameModel? GameModel {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetINativeObject<IGKGameModel> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("gameModel")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setGameModel:"), value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
		...
		public virtual nint MaxLookAheadDepth {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("maxLookAheadDepth"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("maxLookAheadDepth"));
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("setMaxLookAheadDepth:"), value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("setMaxLookAheadDepth:"), value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual IGKRandom? RandomSource {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetINativeObject<IGKRandom> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("randomSource")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
