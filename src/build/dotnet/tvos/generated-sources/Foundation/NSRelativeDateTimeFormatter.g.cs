...
namespace Foundation {
	...
	public unsafe partial class NSRelativeDateTimeFormatter : NSFormatter {
		...
		public virtual string GetLocalizedString (NSDateComponents dateComponents)
		{
			...
			string? ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("localizedStringFromDateComponents:"), dateComponents__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("localizedStringFromDateComponents:"), dateComponents__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual string GetLocalizedString (double timeInterval)
		{
			string ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_Double (this.Handle, Selector.GetHandle ("localizedStringFromTimeInterval:"), timeInterval), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_Double (&__objc_super__, Selector.GetHandle ("localizedStringFromTimeInterval:"), timeInterval), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual string GetLocalizedString (NSDate date, NSDate referenceDate)
		{
			...
			string? ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("localizedStringForDate:relativeToDate:"), date__handle__, referenceDate__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("localizedStringForDate:relativeToDate:"), date__handle__, referenceDate__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (date);
		...
		public virtual NSRelativeDateTimeFormatterStyle DateTimeStyle {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (NSRelativeDateTimeFormatterStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("dateTimeStyle"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSRelativeDateTimeFormatterStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("dateTimeStyle"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("setDateTimeStyle:"), (IntPtr) (long) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("setDateTimeStyle:"), (IntPtr) (long) value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual NSRelativeDateTimeFormatterUnitsStyle UnitsStyle {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (NSRelativeDateTimeFormatterUnitsStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("unitsStyle"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSRelativeDateTimeFormatterUnitsStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("unitsStyle"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
