...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIBoxBlur</c>.</summary>
	/// <remarks>
	...
	[Protocol (Name = "CIBoxBlur", WrapperType = typeof (CIBoxBlurProtocolWrapper))]
		...
		CoreImage.ICIFilterProtocol
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIBoxBlurProtocolWrapper))]
	...
	internal unsafe sealed class CIBoxBlurProtocolWrapper : BaseWrapper, ICIBoxBlurProtocol {
		public CIBoxBlurProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIBoxBlurProtocolWrapper))]
		static CIBoxBlurProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets or sets an image to filter.</summary>
