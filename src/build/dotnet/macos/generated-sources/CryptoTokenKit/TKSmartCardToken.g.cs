...
namespace CryptoTokenKit {
	...
	public unsafe partial class TKSmartCardToken : TKToken {
		...
		const string selAIDX = "AID";
		static readonly NativeHandle selAIDXHandle = Selector.GetHandle ("AID");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithSmartCard_AID_InstanceID_TokenDriver_X = "initWithSmartCard:AID:instanceID:tokenDriver:";
		static readonly NativeHandle selInitWithSmartCard_AID_InstanceID_TokenDriver_XHandle = Selector.GetHandle ("initWithSmartCard:AID:instanceID:tokenDriver:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selInitWithSmartCard_AID_InstanceID_TokenDriver_XHandle, smartCard__handle__, aid__handle__, nsinstanceId, tokenDriver__handle__), "initWithSmartCard:AID:instanceID:tokenDriver:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selInitWithSmartCard_AID_InstanceID_TokenDriver_XHandle, smartCard__handle__, aid__handle__, nsinstanceId, tokenDriver__handle__), "initWithSmartCard:AID:instanceID:tokenDriver:");
					GC.KeepAlive (this);
				}
			}
		...
		public virtual NSData? Aid {
			...
			get {
				NSData? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selAIDXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selAIDXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
