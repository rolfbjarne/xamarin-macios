...
namespace Xharness.Targets {
	public class WatchOSTarget : iOSTarget {
		...
		void CreateWatchOSExtensionProject ()
		{
			...
			var rootDirectory = Path.GetFullPath (HarnessConfiguration.RootDirectory);
			var original_info_plist_include = OriginalInfoPListInclude.Replace ("$(RootTestsDirectory)", rootDirectory);
