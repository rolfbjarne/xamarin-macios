...
";
		...
		void SetProjectPath ()
		{
			switch (ProjectType) {
			case ProjectType.iOSApp:
				TemplateDirectory = Path.Combine (Configuration.SourceRoot, "tests", "templates", "iOSApp");
				break;
			case ProjectType.TodayExtension:
				TemplateDirectory = Path.Combine (Configuration.SourceRoot, "tests", "templates", "TodayExtension");
				break;
			case ProjectType.WatchKit2App:
				TemplateDirectory = Path.Combine (Configuration.SourceRoot, "tests", "templates", "WatchApp");
				break;
			case ProjectType.tvOSApp:
				TemplateDirectory = Path.Combine (Configuration.SourceRoot, "tests", "templates", "tvOSApp");
				break;
			case ProjectType.WatchKit2Extension:
				TemplateDirectory = Path.Combine (Configuration.SourceRoot, "tests", "templates", "WatchExtension");
				break;
			default:
