...
namespace CoreImage {
	...
	public partial class CIBlurredRectangleGenerator : CIFilter, ICIBlurredRectangleGeneratorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIBlurredRectangleGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIBlurredRectangleGenerator () : base ("CIBlurredRectangleGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBlurredRectangleGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBlurredRectangleGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBlurredRectangleGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIBlurredRectangleGeneratorProtocol protocol members 
		[SupportedOSPlatform ("ios17.0")]
		[SupportedOSPlatform ("macos14.0")]
		[SupportedOSPlatform ("tvos17.0")]
		[SupportedOSPlatform ("maccatalyst17.0")]
