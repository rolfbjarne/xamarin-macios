...
namespace HealthKit {
	...
	public unsafe partial class HKWorkoutRouteBuilder : HKSeriesBuilder {
		...
		public HKWorkoutRouteBuilder (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithHealthStore:device:"), healthStore__handle__, device__handle__), "initWithHealthStore:device:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithHealthStore:device:"), healthStore__handle__, device__handle__), "initWithHealthStore:device:");
					GC.KeepAlive (this);
				}
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected unsafe virtual void FinishRoute (HKWorkout workout, NSDictionary? metadata, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V112))]global::System.Action<HKWorkoutRoute, NSError> completion)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("finishRouteWithWorkout:metadata:completion:"), workout__handle__, metadata__handle__, (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual void InsertRouteData (global::CoreLocation.CLLocation[] routeData, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V0))]global::System.Action<bool, NSError> completion)
		{
			...
			BlockLiteral *block_ptr_completion = &block_completion;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("insertRouteData:completion:"), nsa_routeData.Handle, (IntPtr) block_ptr_completion);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("insertRouteData:completion:"), nsa_routeData.Handle, (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
		}
