...
namespace WebKit {
	...
	public unsafe partial class DomHtmlMarqueeElement : DomHtmlElement {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("DOMHTMLMarqueeElement");
		...
		protected DomHtmlMarqueeElement (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal DomHtmlMarqueeElement (NativeHandle handle) : base (handle)
		{
		}
