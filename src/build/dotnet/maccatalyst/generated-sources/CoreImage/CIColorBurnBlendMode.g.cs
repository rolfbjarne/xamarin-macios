...
#nullable enable
namespace CoreImage {
	/// <summary>The CIColorBurnBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 		</para><para><img href="~/xml/CoreImage/_images/ColorBurnBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// 		</para></remarks>
	public partial class CIColorBurnBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIColorBurnBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorBurnBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorBurnBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorBurnBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
