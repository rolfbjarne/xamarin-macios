...
namespace MetalFX {
	...
	public unsafe partial class MTLFXFrameInterpolatorDescriptor : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNewFrameInterpolatorWithDevice_X = "newFrameInterpolatorWithDevice:";
		static readonly NativeHandle selNewFrameInterpolatorWithDevice_XHandle = Selector.GetHandle ("newFrameInterpolatorWithDevice:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNewFrameInterpolatorWithDevice_Compiler_X = "newFrameInterpolatorWithDevice:compiler:";
		static readonly NativeHandle selNewFrameInterpolatorWithDevice_Compiler_XHandle = Selector.GetHandle ("newFrameInterpolatorWithDevice:compiler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selScalerX = "scaler";
		static readonly NativeHandle selScalerXHandle = Selector.GetHandle ("scaler");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetScaler_X = "setScaler:";
		static readonly NativeHandle selSetScaler_XHandle = Selector.GetHandle ("setScaler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetUITextureFormat_X = "setUITextureFormat:";
		static readonly NativeHandle selSetUITextureFormat_XHandle = Selector.GetHandle ("setUITextureFormat:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selUiTextureFormatX = "uiTextureFormat";
		static readonly NativeHandle selUiTextureFormatXHandle = Selector.GetHandle ("uiTextureFormat");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual IMTLFXFrameInterpolator? Create (global::Metal.IMTLDevice device)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetINativeObject<IMTLFXFrameInterpolator> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selNewFrameInterpolatorWithDevice_XHandle, device__handle__), true)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMTLFXFrameInterpolator> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selNewFrameInterpolatorWithDevice_XHandle, device__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual IMTL4FXFrameInterpolator? Create (global::Metal.IMTLDevice device, global::Metal.IMTL4Compiler compiler)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetINativeObject<IMTL4FXFrameInterpolator> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selNewFrameInterpolatorWithDevice_Compiler_XHandle, device__handle__, compiler__handle__), true)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMTL4FXFrameInterpolator> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selNewFrameInterpolatorWithDevice_Compiler_XHandle, device__handle__, compiler__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual IMTLFXFrameInterpolatableScaler? Scaler {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetINativeObject<IMTLFXFrameInterpolatableScaler> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selScalerXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetINativeObject<IMTLFXFrameInterpolatableScaler> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selScalerXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetScaler_XHandle, value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetScaler_XHandle, value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
		...
		public virtual global::Metal.MTLPixelFormat UITextureFormat {
			...
			get {
				global::Metal.MTLPixelFormat ret;
				if (IsDirectBinding) {
					ret = (MTLPixelFormat) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selUiTextureFormatXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MTLPixelFormat) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selUiTextureFormatXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selSetUITextureFormat_XHandle, (UIntPtr) (ulong) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selSetUITextureFormat_XHandle, (UIntPtr) (ulong) value);
						GC.KeepAlive (this);
					}
				}
			}
