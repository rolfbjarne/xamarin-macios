...
namespace AVFoundation {
	...
	public unsafe partial class AVMediaSelectionOption : NSObject, INSCopying {
		...
		const string selAssociatedMediaSelectionOptionInMediaSelectionGroup_X = "associatedMediaSelectionOptionInMediaSelectionGroup:";
		static readonly NativeHandle selAssociatedMediaSelectionOptionInMediaSelectionGroup_XHandle = Selector.GetHandle ("associatedMediaSelectionOptionInMediaSelectionGroup:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDisplayNameWithLocale_X = "displayNameWithLocale:";
		static readonly NativeHandle selDisplayNameWithLocale_XHandle = Selector.GetHandle ("displayNameWithLocale:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPropertyListX = "propertyList";
		static readonly NativeHandle selPropertyListXHandle = Selector.GetHandle ("propertyList");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual AVMediaSelectionOption? AssociatedMediaSelectionOptionInMediaSelectionGroup (AVMediaSelectionGroup mediaSelectionGroup)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<AVMediaSelectionOption> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selAssociatedMediaSelectionOptionInMediaSelectionGroup_XHandle, mediaSelectionGroup__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<AVMediaSelectionOption> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selAssociatedMediaSelectionOptionInMediaSelectionGroup_XHandle, mediaSelectionGroup__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual string GetDisplayName (NSLocale locale)
		{
			...
			string? ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selDisplayNameWithLocale_XHandle, locale__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selDisplayNameWithLocale_XHandle, locale__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (locale);
		...
		public virtual NSNumber[] MediaSubTypes {
			...
			get {
				NSNumber[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<NSNumber>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selMediaSubTypesXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<NSNumber>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selMediaSubTypesXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual NSObject PropertyList {
			...
			get {
				NSObject? ret;
				if (IsDirectBinding) {
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selPropertyListXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selPropertyListXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
