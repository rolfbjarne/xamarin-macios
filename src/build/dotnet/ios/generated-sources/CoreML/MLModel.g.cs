...
namespace CoreML {
	...
	public unsafe partial class MLModel : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void CompileModel (NSUrl modelUrl, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V61))]global::System.Action<NSUrl, NSError> handler)
		{
			var modelUrl__handle__ = modelUrl!.GetNonNullHandle (nameof (modelUrl));
			if (handler is null)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetPrediction (IMLFeatureProvider input, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V62))]global::System.Action<IMLFeatureProvider, NSError> completionHandler)
		{
			var input__handle__ = input!.GetNonNullHandle (nameof (input));
		...
		[SupportedOSPlatform ("maccatalyst17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetPrediction (IMLFeatureProvider input, MLPredictionOptions options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V62))]global::System.Action<IMLFeatureProvider, NSError> completionHandler)
		{
			var input__handle__ = input!.GetNonNullHandle (nameof (input));
			var options__handle__ = options!.GetNonNullHandle (nameof (options));
			if (completionHandler is null)
		...
		[SupportedOSPlatform ("maccatalyst16.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void Load (MLModelAsset asset, MLModelConfiguration configuration, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V63))]global::System.Action<MLModel, NSError> handler)
		{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void LoadContents (NSUrl url, MLModelConfiguration configuration, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V63))]global::System.Action<MLModel, NSError> handler)
		{
			var url__handle__ = url!.GetNonNullHandle (nameof (url));
			var configuration__handle__ = configuration!.GetNonNullHandle (nameof (configuration));
			if (handler is null)
