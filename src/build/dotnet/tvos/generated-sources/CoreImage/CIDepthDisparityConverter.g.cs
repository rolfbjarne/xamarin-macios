...
namespace CoreImage {
	...
	public abstract partial class CIDepthDisparityConverter : CIFilter {
		...
		protected internal CIDepthDisparityConverter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDepthDisparityConverter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDepthDisparityConverter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIDepthDisparityConverter" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected  CIDepthDisparityConverter (string name) : base (CreateFilter (name))
		{
		}
	}
}
