...
namespace UIKit {
	...
	public unsafe static partial class UIStringAttributeKey  {
		...
		/// <summary>Represents the value associated with the constant 'UITextItemTagAttributeName'.</summary>
		[Field ("UITextItemTagAttributeName",  "UIKit")]
		...
		public static NSString Name {
			...
			get {
				if (_Name is null)
					_Name = Dlfcn.GetStringConstant (Libraries.UIKit.Handle, "UITextItemTagAttributeName")!;
				return _Name;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[Field ("NSWritingToolsExclusionAttributeName",  "UIKit")]
		[UnsupportedOSPlatform ("tvos")]
		...
		public static NSString WritingToolsExclusion {
			...
			get {
				if (_WritingToolsExclusion is null)
					_WritingToolsExclusion = Dlfcn.GetStringConstant (Libraries.UIKit.Handle, "NSWritingToolsExclusionAttributeName")!;
