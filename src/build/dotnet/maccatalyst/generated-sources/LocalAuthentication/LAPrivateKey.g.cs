...
namespace LocalAuthentication {
	...
	public unsafe partial class LAPrivateKey : NSObject {
		...
		public virtual bool CanDecrypt (global::Security.SecKeyAlgorithm algorithm)
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_int (this.Handle, Selector.GetHandle ("canDecryptUsingSecKeyAlgorithm:"), (int)algorithm);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_int (&__objc_super__, Selector.GetHandle ("canDecryptUsingSecKeyAlgorithm:"), (int)algorithm);
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public virtual bool CanExchangeKeys (global::Security.SecKeyAlgorithm algorithm)
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_int (this.Handle, Selector.GetHandle ("canExchangeKeysUsingSecKeyAlgorithm:"), (int)algorithm);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_int (&__objc_super__, Selector.GetHandle ("canExchangeKeysUsingSecKeyAlgorithm:"), (int)algorithm);
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public virtual bool CanSign (global::Security.SecKeyAlgorithm algorithm)
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_int (this.Handle, Selector.GetHandle ("canSignUsingSecKeyAlgorithm:"), (int)algorithm);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_int (&__objc_super__, Selector.GetHandle ("canSignUsingSecKeyAlgorithm:"), (int)algorithm);
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public unsafe virtual void Decrypt (NSData data, global::Security.SecKeyAlgorithm algorithm, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDLAPrivateKeyCompletionHandler))]LAPrivateKeyCompletionHandler handler)
		{
			...
			using var block_handler = Trampolines.SDLAPrivateKeyCompletionHandler.CreateBlock (handler);
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_int_NativeHandle (&__objc_super__, Selector.GetHandle ("decryptData:secKeyAlgorithm:completion:"), data__handle__, (int)algorithm, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (data);
		...
		public unsafe virtual void ExchangeKeys (NSData publicKey, global::Security.SecKeyAlgorithm algorithm, NSDictionary parameters, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDLAPrivateKeyCompletionHandler))]LAPrivateKeyCompletionHandler handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_int_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("exchangeKeysWithPublicKey:secKeyAlgorithm:secKeyParameters:completion:"), publicKey__handle__, (int)algorithm, parameters__handle__, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual void Sign (NSData data, global::Security.SecKeyAlgorithm algorithm, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDLAPrivateKeyCompletionHandler))]LAPrivateKeyCompletionHandler handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_int_NativeHandle (&__objc_super__, Selector.GetHandle ("signData:secKeyAlgorithm:completion:"), data__handle__, (int)algorithm, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (data);
		...
		public virtual LAPublicKey PublicKey {
			...
			get {
				LAPublicKey? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<LAPublicKey> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("publicKey")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<LAPublicKey> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("publicKey")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
