...
namespace MonoTouchFixtures.PassKit {
	...
	public class PKPaymentSummaryItemTest {
		...
		public void CheckDefaultNulls ()
		{
			...
			ClassicAssert.IsNull (ps.Amount, "'PKPaymentSummaryItem.Amount' is not returning null by default.");
			ClassicAssert.IsNull (ps.Label, "'PKPaymentSummaryItem.Label' is not returning null by default.");
