...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSImageNormalizedHistogram : MPSKernel {
		...
		public virtual void Encode (global::Metal.IMTLCommandBuffer commandBuffer, global::Metal.IMTLTexture source, global::Metal.IMTLTexture minmaxTexture, global::Metal.IMTLBuffer histogram, nuint histogramOffset)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_UIntPtr (this.Handle, Selector.GetHandle ("encodeToCommandBuffer:sourceTexture:minmaxTexture:histogram:histogramOffset:"), commandBuffer__handle__, source__handle__, minmaxTexture__handle__, histogram__handle__, histogramOffset);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_UIntPtr (&__objc_super__, Selector.GetHandle ("encodeToCommandBuffer:sourceTexture:minmaxTexture:histogram:histogramOffset:"), commandBuffer__handle__, source__handle__, minmaxTexture__handle__, histogram__handle__, histogramOffset);
					GC.KeepAlive (this);
				}
			}
