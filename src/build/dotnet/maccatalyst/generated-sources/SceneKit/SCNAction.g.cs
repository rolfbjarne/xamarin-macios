...
namespace SceneKit {
	...
	public unsafe partial class SCNAction : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		[Export ("runBlock:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static SCNAction Run ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V232))]global::System.Action<SCNNode> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity1V232.CreateBlock (handler);
			BlockLiteral *block_ptr_handler = &block_handler;
			SCNAction ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static SCNAction Run ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V232))]global::System.Action<SCNNode> handler, global::CoreFoundation.DispatchQueue queue)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
