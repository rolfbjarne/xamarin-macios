...
namespace Intents {
	...
	public unsafe partial class INSpeakableString : NSObject, IINSpeakable, INSCoding, INSCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithSpokenPhrase_X = "initWithSpokenPhrase:";
		static readonly NativeHandle selInitWithSpokenPhrase_XHandle = Selector.GetHandle ("initWithSpokenPhrase:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithVocabularyIdentifier_SpokenPhrase_PronunciationHint_X = "initWithVocabularyIdentifier:spokenPhrase:pronunciationHint:";
		static readonly NativeHandle selInitWithVocabularyIdentifier_SpokenPhrase_PronunciationHint_XHandle = Selector.GetHandle ("initWithVocabularyIdentifier:spokenPhrase:pronunciationHint:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, selInitWithVocabularyIdentifier_SpokenPhrase_PronunciationHint_XHandle, nsidentifier, nsspokenPhrase, nspronunciationHint), "initWithVocabularyIdentifier:spokenPhrase:pronunciationHint:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selInitWithVocabularyIdentifier_SpokenPhrase_PronunciationHint_XHandle, nsidentifier, nsspokenPhrase, nspronunciationHint), "initWithVocabularyIdentifier:spokenPhrase:pronunciationHint:");
					GC.KeepAlive (this);
				}
			}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			var nsspokenPhrase = CFString.CreateNative (spokenPhrase);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithSpokenPhrase_XHandle, nsspokenPhrase), "initWithSpokenPhrase:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithSpokenPhrase_XHandle, nsspokenPhrase), "initWithSpokenPhrase:");
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nsspokenPhrase);
