...
namespace SceneKit {
	...
	public unsafe partial class SCNRenderer : NSObject, ISCNSceneRenderer, ISCNTechniqueSupport {
		...
		public static SCNRenderer FromContext (nint context, NSDictionary? options)
		{
			...
			SCNRenderer? ret;
			ret =  Runtime.GetNSObject<SCNRenderer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_NativeHandle (class_ptr, Selector.GetHandle ("rendererWithContext:options:"), context, options__handle__), false)!;
