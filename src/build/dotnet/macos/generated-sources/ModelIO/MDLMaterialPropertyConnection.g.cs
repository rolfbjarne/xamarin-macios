...
namespace ModelIO {
	...
	public unsafe partial class MDLMaterialPropertyConnection : NSObject, IMDLNamed {
		...
		const string selInitWithOutput_Input_X = "initWithOutput:input:";
		static readonly NativeHandle selInitWithOutput_Input_XHandle = Selector.GetHandle ("initWithOutput:input:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selInitWithOutput_Input_XHandle, output__handle__, input__handle__), "initWithOutput:input:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selInitWithOutput_Input_XHandle, output__handle__, input__handle__), "initWithOutput:input:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (output);
		...
		public virtual MDLMaterialProperty? Input {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<MDLMaterialProperty> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selInputXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<MDLMaterialProperty> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selInputXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				MarkDirty ();
		...
		public virtual MDLMaterialProperty? Output {
			...
			get {
				MDLMaterialProperty? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<MDLMaterialProperty> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selOutputXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<MDLMaterialProperty> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selOutputXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				MarkDirty ();
