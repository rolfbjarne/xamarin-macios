...
namespace AVFoundation {
	...
	public unsafe partial class AVSampleBufferGeneratorBatch : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void MakeDataReady ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAVSampleBufferGeneratorBatchMakeReadyCallback))]AVSampleBufferGeneratorBatchMakeReadyCallback completionHandler)
		{
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDAVSampleBufferGeneratorBatchMakeReadyCallback.CreateBlock (completionHandler);
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("makeDataReadyWithCompletionHandler:"), (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		}
