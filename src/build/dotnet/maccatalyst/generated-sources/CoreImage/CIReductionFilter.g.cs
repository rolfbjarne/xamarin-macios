...
namespace CoreImage {
	...
	public abstract partial class CIReductionFilter : CIFilter {
		...
		protected internal CIReductionFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIReductionFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIReductionFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIReductionFilter" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected  CIReductionFilter (string name) : base (CreateFilter (name))
		{
		}
