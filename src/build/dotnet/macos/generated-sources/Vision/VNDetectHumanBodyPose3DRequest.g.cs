...
namespace Vision {
	...
	public unsafe partial class VNDetectHumanBodyPose3DRequest : VNStatefulRequest {
		...
		public unsafe virtual global::Vision.VNHumanBodyPose3DObservationJointName[]? GetSupportedJointNames (out NSError? error)
		{
			...
			if (IsDirectBinding) {
				ret = NSArray.ArrayFromHandleFunc <global::Vision.VNHumanBodyPose3DObservationJointName> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_ref_NativeHandle (this.Handle, selSupportedJointNamesAndReturnError_XHandle, &errorValue), global::Vision.VNHumanBodyPose3DObservationJointNameExtensions.GetValue , false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = NSArray.ArrayFromHandleFunc <global::Vision.VNHumanBodyPose3DObservationJointName> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_ref_NativeHandle (&__objc_super__, selSupportedJointNamesAndReturnError_XHandle, &errorValue), global::Vision.VNHumanBodyPose3DObservationJointNameExtensions.GetValue , false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual global::Vision.VNHumanBodyPose3DObservationJointsGroupName[]? GetSupportedJointsGroupNames (out NSError? error)
		{
			...
			if (IsDirectBinding) {
				ret = NSArray.ArrayFromHandleFunc <global::Vision.VNHumanBodyPose3DObservationJointsGroupName> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_ref_NativeHandle (this.Handle, selSupportedJointsGroupNamesAndReturnError_XHandle, &errorValue), global::Vision.VNHumanBodyPose3DObservationJointsGroupNameExtensions.GetValue , false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = NSArray.ArrayFromHandleFunc <global::Vision.VNHumanBodyPose3DObservationJointsGroupName> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_ref_NativeHandle (&__objc_super__, selSupportedJointsGroupNamesAndReturnError_XHandle, &errorValue), global::Vision.VNHumanBodyPose3DObservationJointsGroupNameExtensions.GetValue , false)!;
					GC.KeepAlive (this);
				}
			}
			error = Runtime.GetNSObject<NSError> (errorValue)!;
		...
		public static VNDetectHumanBodyPose3DRequestRevision CurrentRevision {
			...
			get {
				...
				ret = (Vision.VNDetectHumanBodyPose3DRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (class_ptr, selCurrentRevisionXHandle);
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static VNDetectHumanBodyPose3DRequestRevision DefaultRevision {
			...
			get {
				VNDetectHumanBodyPose3DRequestRevision ret;
				ret = (Vision.VNDetectHumanBodyPose3DRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (class_ptr, selDefaultRevisionXHandle);
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual VNHumanBodyPose3DObservation[]? Results {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<VNHumanBodyPose3DObservation>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selResultsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<VNHumanBodyPose3DObservation>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selResultsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual VNDetectHumanBodyPose3DRequestRevision Revision {
			...
			get {
				VNDetectHumanBodyPose3DRequestRevision ret;
				if (IsDirectBinding) {
					ret = (Vision.VNDetectHumanBodyPose3DRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selRevisionXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (Vision.VNDetectHumanBodyPose3DRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selRevisionXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
