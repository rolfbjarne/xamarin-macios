...
namespace CoreSpotlight {
	...
	public unsafe partial class CSImportExtension : NSObject, INSExtensionRequestHandling {
		...
		public unsafe virtual bool Update (CSSearchableItemAttributeSet attributes, NSUrl contentUrl, out NSError? error)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (this.Handle, Selector.GetHandle ("updateAttributes:forFileAtURL:error:"), attributes__handle__, contentUrl__handle__, &errorValue);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle_NativeHandle_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("updateAttributes:forFileAtURL:error:"), attributes__handle__, contentUrl__handle__, &errorValue);
					GC.KeepAlive (this);
				}
			}
