...
namespace WebKit {
	...
	public unsafe partial class DomHtmlLabelElement : DomHtmlElement {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("DOMHTMLLabelElement");
		...
		protected DomHtmlLabelElement (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal DomHtmlLabelElement (NativeHandle handle) : base (handle)
		{
		}
