...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIBlendFilter" /> that divides the color values of its <see cref="P:CoreImage.CIBlendFilter.InputImage" /> and <see cref="P:CoreImage.CIBlendFilter.BackgroundImage" />.</summary>
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public partial class CIDivideBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIDivideBlendMode" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIDivideBlendMode () : base ("CIDivideBlendMode")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIDivideBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDivideBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDivideBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
