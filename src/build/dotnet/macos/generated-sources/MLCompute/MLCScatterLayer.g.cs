...
namespace MLCompute {
	...
	public unsafe partial class MLCScatterLayer : MLCLayer {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selLayerWithDimension_ReductionType_X = "layerWithDimension:reductionType:";
		static readonly NativeHandle selLayerWithDimension_ReductionType_XHandle = Selector.GetHandle ("layerWithDimension:reductionType:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			MLCScatterLayer ret;
			ret =  Runtime.GetNSObject<MLCScatterLayer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr_int (class_ptr, selLayerWithDimension_ReductionType_XHandle, dimension, (int)reductionType), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
