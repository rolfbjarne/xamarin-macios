...
namespace MapKit {
	...
	public unsafe partial class MKMapSnapshotter : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selStartWithQueue_CompletionHandler_X = "startWithQueue:completionHandler:";
		static readonly NativeHandle selStartWithQueue_CompletionHandler_XHandle = Selector.GetHandle ("startWithQueue:completionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public unsafe virtual void Start (global::CoreFoundation.DispatchQueue queue, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMKMapSnapshotCompletionHandler))]MKMapSnapshotCompletionHandler completionHandler)
		{
			...
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selStartWithQueue_CompletionHandler_XHandle, queue.Handle, (IntPtr) block_ptr_completionHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selStartWithQueue_CompletionHandler_XHandle, queue.Handle, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (queue);
