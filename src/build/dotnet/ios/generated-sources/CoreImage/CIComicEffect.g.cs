...
namespace CoreImage {
	...
	public partial class CIComicEffect : CIFilter, ICIComicEffectProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIComicEffect" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIComicEffect () : base ("CIComicEffect")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIComicEffect (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIComicEffect (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIComicEffect (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIComicEffectProtocol protocol members 
