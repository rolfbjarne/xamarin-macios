	...
	public unsafe partial class NSPurgeableData : NSMutableData, INSCoding, INSCopying, INSDiscardableContent, INSMutableCopying, INSSecureCoding {
		...
		public virtual bool BeginContentAccess ()
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("beginContentAccess"));
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public virtual void DiscardContentIfPossible ()
		{
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("discardContentIfPossible"));
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void EndContentAccess ()
		{
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("endContentAccess"));
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual bool IsContentDiscarded {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isContentDiscarded"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
