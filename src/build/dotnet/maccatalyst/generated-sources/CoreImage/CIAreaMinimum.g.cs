...
namespace CoreImage {
	...
	public partial class CIAreaMinimum : CIReductionFilter, ICIAreaReductionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIAreaMinimum" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIAreaMinimum () : base ("CIAreaMinimum")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAreaMinimum (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAreaMinimum (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAreaMinimum (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
