...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSMatrixDecompositionLU : MPSMatrixUnaryKernel {
		...
		public virtual void EncodeToCommandBuffer (global::Metal.IMTLCommandBuffer commandBuffer, MPSMatrix sourceMatrix, MPSMatrix resultMatrix, MPSMatrix pivotIndices, global::Metal.IMTLBuffer? status)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("encodeToCommandBuffer:sourceMatrix:resultMatrix:pivotIndices:status:"), commandBuffer__handle__, sourceMatrix__handle__, resultMatrix__handle__, pivotIndices__handle__, status__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("encodeToCommandBuffer:sourceMatrix:resultMatrix:pivotIndices:status:"), commandBuffer__handle__, sourceMatrix__handle__, resultMatrix__handle__, pivotIndices__handle__, status__handle__);
					GC.KeepAlive (this);
				}
			}
