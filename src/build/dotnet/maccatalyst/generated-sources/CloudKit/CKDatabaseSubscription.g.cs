...
namespace CloudKit {
	...
	public unsafe partial class CKDatabaseSubscription : CKSubscription, INSCoding, INSCopying, INSSecureCoding {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("initWithSubscriptionID:"), nssubscriptionID), "initWithSubscriptionID:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithSubscriptionID:"), nssubscriptionID), "initWithSubscriptionID:");
					GC.KeepAlive (this);
				}
			}
