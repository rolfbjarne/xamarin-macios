...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIScreenFilter" /> that simulates a halftone made of lines.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/line_screen.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CILineScreen : CIScreenFilter, ICILineScreenProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CILineScreen" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CILineScreen (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILineScreen (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILineScreen (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CILineScreenProtocol protocol members 
