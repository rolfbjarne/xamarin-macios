...
#nullable enable
namespace CoreImage {
	/// <summary>The CIGammaAdjust CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/GammaAdjust.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIGammaAdjust : CIFilter, ICIGammaAdjustProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIGammaAdjust" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIGammaAdjust () : base ("CIGammaAdjust")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIGammaAdjust (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIGammaAdjust (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIGammaAdjust (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIGammaAdjustProtocol protocol members 
