...
namespace AuthenticationServices {
	...
	/// <summary>This interface represents the Objective-C protocol <c>ASPublicKeyCredential</c>.</summary>
	/// <remarks>
	...
	public partial interface IASPublicKeyCredential : INativeObject, IDisposable, 
		...
		, Foundation.INSSecureCoding
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (ASPublicKeyCredentialWrapper))]
	...
	internal unsafe sealed class ASPublicKeyCredentialWrapper : BaseWrapper, IASPublicKeyCredential {
		public ASPublicKeyCredentialWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (ASPublicKeyCredentialWrapper))]
		static ASPublicKeyCredentialWrapper ()
		{
			GC.KeepAlive (null);
		}
