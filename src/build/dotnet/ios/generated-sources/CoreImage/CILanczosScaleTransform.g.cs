...
#nullable enable
namespace CoreImage {
	/// <summary>A scaling transform that uses Lanczos resampling.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/lanczos_scale_transform.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CILanczosScaleTransform : CIFilter, ICILanczosScaleTransformProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CILanczosScaleTransform" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CILanczosScaleTransform (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILanczosScaleTransform (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILanczosScaleTransform (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CILanczosScaleTransformProtocol protocol members 
