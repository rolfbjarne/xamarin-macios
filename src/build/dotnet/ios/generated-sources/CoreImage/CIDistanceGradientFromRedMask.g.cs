...
namespace CoreImage {
	...
	public partial class CIDistanceGradientFromRedMask : CIFilter, ICIDistanceGradientFromRedMaskProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIDistanceGradientFromRedMask" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIDistanceGradientFromRedMask () : base ("CIDistanceGradientFromRedMask")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIDistanceGradientFromRedMask (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDistanceGradientFromRedMask (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDistanceGradientFromRedMask (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIDistanceGradientFromRedMaskProtocol protocol members 
		...
		public int MaximumDistance {
			...
			get {
				return GetInt ("inputMaximumDistance");
			}
			[Export ("setMaximumDistance:")]
			set {
				SetInt ("inputMaximumDistance", value);
			}
		}
