...
namespace CoreNFC {
		...
		, Foundation.INSSecureCoding
	{
		...
		public unsafe virtual void SendMiFareCommand (NSData command, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V16))]global::System.Action<NSData, NSError> completionHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _SendMiFareCommand (INFCMiFareTag This, NSData command, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V16))]global::System.Action<NSData, NSError> completionHandler)
		{
	...
	internal unsafe sealed class NFCMiFareTagWrapper : BaseWrapper, INFCMiFareTag {
		...
		[Export ("sendMiFareCommand:completionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void SendMiFareCommand (NSData command, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V16))]global::System.Action<NSData, NSError> completionHandler)
		{
			var command__handle__ = command!.GetNonNullHandle (nameof (command));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
