...
namespace CoreLocation {
	...
	public unsafe partial class CLBeacon : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAccuracyX = "accuracy";
		static readonly NativeHandle selAccuracyXHandle = Selector.GetHandle ("accuracy");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual double Accuracy {
			...
			get {
				double ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.Double_objc_msgSend (this.Handle, selAccuracyXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.Double_objc_msgSendSuper (&__objc_super__, selAccuracyXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual CLProximity Proximity {
			...
			get {
				CLProximity ret;
				if (IsDirectBinding) {
					ret = (CLProximity) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selProximityXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (CLProximity) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selProximityXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual nint Rssi {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selRssiXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selRssiXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
