...
public class CoreImageFilterTransformer (string destinationDirectory) : ITransformer<(string Path, string SymbolName)> {

	readonly static ILogger logger = Log.ForContext<CoreImageFilterTransformer> ();
