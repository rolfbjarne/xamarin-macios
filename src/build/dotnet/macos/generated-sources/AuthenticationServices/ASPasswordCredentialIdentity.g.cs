...
namespace AuthenticationServices {
	...
	public unsafe partial class ASPasswordCredentialIdentity : NSObject, IASCredentialIdentity, INSCoding, INSCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selIdentityWithServiceIdentifier_User_RecordIdentifier_X = "identityWithServiceIdentifier:user:recordIdentifier:";
		static readonly NativeHandle selIdentityWithServiceIdentifier_User_RecordIdentifier_XHandle = Selector.GetHandle ("identityWithServiceIdentifier:user:recordIdentifier:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithCoder_X = "initWithCoder:";
		static readonly NativeHandle selInitWithCoder_XHandle = Selector.GetHandle ("initWithCoder:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithServiceIdentifier_User_RecordIdentifier_X = "initWithServiceIdentifier:user:recordIdentifier:";
		static readonly NativeHandle selInitWithServiceIdentifier_User_RecordIdentifier_XHandle = Selector.GetHandle ("initWithServiceIdentifier:user:recordIdentifier:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, selInitWithServiceIdentifier_User_RecordIdentifier_XHandle, serviceIdentifier__handle__, nsuser, nsrecordIdentifier), "initWithServiceIdentifier:user:recordIdentifier:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selInitWithServiceIdentifier_User_RecordIdentifier_XHandle, serviceIdentifier__handle__, nsuser, nsrecordIdentifier), "initWithServiceIdentifier:user:recordIdentifier:");
					GC.KeepAlive (this);
				}
			}
		...
		public static ASPasswordCredentialIdentity Create (ASCredentialServiceIdentifier serviceIdentifier, string user, string? recordIdentifier)
		{
			...
			ret =  Runtime.GetNSObject<ASPasswordCredentialIdentity> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (class_ptr, selIdentityWithServiceIdentifier_User_RecordIdentifier_XHandle, serviceIdentifier__handle__, nsuser, nsrecordIdentifier), false)!;
			GC.KeepAlive (serviceIdentifier);
			CFString.ReleaseNative (nsuser);
			CFString.ReleaseNative (nsrecordIdentifier);
			return ret!;
