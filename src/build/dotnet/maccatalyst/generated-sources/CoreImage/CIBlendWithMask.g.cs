...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIBlendFilter" /> that uses a grayscale mask to blends its foreground and background images.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/clouds.jpg" alt="Photograph of clouds and sunbeams." /></para><para><img href="~/xml/CoreImage/_images/flower.png" alt="Photograph of a sunflower." /></para><para><img href="~/xml/CoreImage/_images/Xamarin.png" alt="Result of applying the filter." /></para><para>
	/// Produces the following output:
	/// </para><para><img href="~/xml/CoreImage/_images/blend_with_mask.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIBlendWithMask : CIBlendFilter, ICIBlendWithMaskProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIBlendWithMask" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBlendWithMask (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBlendWithMask (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBlendWithMask (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIBlendWithMask" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public  CIBlendWithMask (string name) : base (CreateFilter (name))
		{
		}
		// CIBlendWithMaskProtocol protocol members 
