...
#nullable enable
namespace CoreImage {
	/// <summary>The CIMinimumCompositing CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/MinimumComposite.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIMinimumCompositing : CICompositingFilter {
		/// <summary>Creates a new <see cref="CIMinimumCompositing" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMinimumCompositing (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMinimumCompositing (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMinimumCompositing (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
