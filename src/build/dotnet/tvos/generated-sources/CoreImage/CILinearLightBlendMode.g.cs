...
namespace CoreImage {
	...
	public partial class CILinearLightBlendMode : CIFilter, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CILinearLightBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CILinearLightBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILinearLightBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILinearLightBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
