...
namespace AppKit {
	...
	public unsafe partial class NSTableHeaderView : NSView, INSViewToolTipOwner {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDraggedColumnX = "draggedColumn";
		static readonly NativeHandle selDraggedColumnXHandle = Selector.GetHandle ("draggedColumn");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDraggedDistanceX = "draggedDistance";
		static readonly NativeHandle selDraggedDistanceXHandle = Selector.GetHandle ("draggedDistance");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selHeaderRectOfColumn_X = "headerRectOfColumn:";
		static readonly NativeHandle selHeaderRectOfColumn_XHandle = Selector.GetHandle ("headerRectOfColumn:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selResizedColumnX = "resizedColumn";
		static readonly NativeHandle selResizedColumnXHandle = Selector.GetHandle ("resizedColumn");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSTableHeaderView");
		...
		/// <summary>Creates a new <see cref="NSTableHeaderView" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public NSTableHeaderView () : base (NSObjectFlag.Empty)
		{
		...
		public NSTableHeaderView (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSTableHeaderView (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSTableHeaderView (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual CGRect GetHeaderRect (nint column)
		{
			...
			if (IsDirectBinding) {
				if (global::ObjCRuntime.Runtime.IsARM64CallingConvention) {
					ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSend_IntPtr (this.Handle, selHeaderRectOfColumn_XHandle, column);
				} else {
					ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSend_stret_IntPtr (this.Handle, selHeaderRectOfColumn_XHandle, column);
				}
			} else {
				if (global::ObjCRuntime.Runtime.IsARM64CallingConvention) {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSendSuper_IntPtr (&__objc_super__, selHeaderRectOfColumn_XHandle, column);
						GC.KeepAlive (this);
					}
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSendSuper_stret_IntPtr (&__objc_super__, selHeaderRectOfColumn_XHandle, column);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual nint DraggedColumn {
			...
			get {
				...
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selDraggedColumnXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selDraggedColumnXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual nfloat DraggedDistance {
			...
			get {
				...
				nfloat ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend (this.Handle, selDraggedDistanceXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSendSuper (&__objc_super__, selDraggedDistanceXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual nint ResizedColumn {
			...
			get {
				...
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selResizedColumnXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selResizedColumnXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
