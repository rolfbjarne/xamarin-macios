...
namespace Photos {
	...
	public unsafe partial class PHAssetResourceRequestOptions : NSObject, INSCopying {
		...
		public unsafe virtual global::System.Action<double>? ProgressHandler {
			[return: DelegateProxy (typeof (ObjCRuntime.Trampolines.SDActionArity1V102))]
			...
			get {
				...
				return global::ObjCRuntime.Trampolines.NIDActionArity1V102.Create (ret)!;
			}
			[param: BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V102))]
			[Export ("setProgressHandler:", ArgumentSemantic.Copy)]
			set {
				using var block_value = Trampolines.SDActionArity1V102.CreateNullableBlock (value);
