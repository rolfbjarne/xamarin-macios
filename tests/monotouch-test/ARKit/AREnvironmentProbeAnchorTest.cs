...
namespace MonoTouchFixtures.ARKit {
	...
	public class AREnvironmentProbeAnchorTest {
		...
		public void MarshallingTest ()
		{
			...
			ClassicAssert.AreEqual (MatrixFloat4x4.Identity, probeAnchor.Transform, "Transform");
			...
			if ((Runtime.Arch == Arch.DEVICE) || !TestRuntime.CheckXcodeVersion (12, 0) || TestRuntime.CheckXcodeVersion (14, 0))
				ClassicAssert.AreEqual (new VectorFloat3 (1, 1, 1), probeAnchor.Extent, "Extent");
		}
		...
		public void MarshallingTest2 ()
		{
			...
			ClassicAssert.AreEqual (MatrixFloat4x4.Identity, probeAnchorWithName.Transform, "Transform");
			// broken since Xcode 12 on simulator (only), fixed in simulator in Xcode 14
			if ((Runtime.Arch == Arch.DEVICE) || !TestRuntime.CheckXcodeVersion (12, 0) || TestRuntime.CheckXcodeVersion (14, 0))
				ClassicAssert.AreEqual (new VectorFloat3 (1, 1, 1), probeAnchorWithName.Extent, "Extent");
		}
	}
}
