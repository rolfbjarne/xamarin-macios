...
namespace HomeKit {
	...
	public unsafe partial class HMAccessorySetupManager : NSObject {
		...
		/// <summary>Creates a new <see cref="HMAccessorySetupManager" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[UnsupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void PerformAccessorySetup (HMAccessorySetupRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V113))]global::System.Action<HMAccessorySetupResult, NSError> completion)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("performAccessorySetupUsingRequest:completionHandler:"), request__handle__, (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
