...
#nullable enable
namespace CoreImage {
	/// <summary>The CISourceAtopCompositing CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 
	/// // Construct teh SourceAtopComposite filter
	...
	/// var output = sourceAtopComposite.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/SourceAtop.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CISourceAtopCompositing : CICompositingFilter {
		/// <summary>Creates a new <see cref="CISourceAtopCompositing" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISourceAtopCompositing (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISourceAtopCompositing (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISourceAtopCompositing (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
