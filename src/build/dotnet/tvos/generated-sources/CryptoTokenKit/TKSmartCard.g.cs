...
namespace CryptoTokenKit {
	...
	public unsafe partial class TKSmartCard : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void BeginSession ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V12))]global::System.Action<bool, NSError> reply)
		{
			if (reply is null)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void TransmitRequest (NSData request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V14))]global::System.Action<NSData, NSError> reply)
		{
			var request__handle__ = request!.GetNonNullHandle (nameof (request));
			if (reply is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (reply));
			using var block_reply = Trampolines.SDActionArity2V14.CreateBlock (reply);
			BlockLiteral *block_ptr_reply = &block_reply;
			if (IsDirectBinding) {
