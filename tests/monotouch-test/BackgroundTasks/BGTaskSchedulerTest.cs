...
namespace MonoTouchFixtures.BackgroundTasks {
	...
	public class BGTaskSchedulerTest {
		...
		public void SubmitTaskRequestTest ()
		{
			...
			ClassicAssert.True (registered, "Task was not registered.");
			...
			ClassicAssert.IsNull (error, $"Error submiting request {error}");
			LaunchBGTask ();
			autoResetEvent.WaitOne (300);
			ClassicAssert.True (taskWasCalled, "Called task.");
		}
	}
}
#endif
