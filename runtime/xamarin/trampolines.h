...
typedef MonoObject *	(*xamarin_id_to_managed_func) (id value, void *ptr);
typedef id				(*xamarin_managed_to_id_func) (MonoObject *value);
...
MonoArray * xamarin_convert_nsarray_to_managed_with_func (NSArray *array, MonoClass *managedType, xamarin_id_to_managed_func convert, guint32 *exception_gchandle);

// Returns a pointer to the value type, which must be freed using xamarin_free.
void *xamarin_nsnumber_to_bool   (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_sbyte  (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_byte   (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_short  (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_ushort (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_int    (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_uint   (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_long   (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_ulong  (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_nint   (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_nuint  (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_float  (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_double (NSNumber *number, void *ptr);
void *xamarin_nsnumber_to_nfloat (NSNumber *number, void *ptr);

// Returns a pointer to the value type, which must be freed using xamarin_free
void *xamarin_nsvalue_to_nsrange                (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_cgaffinetransform      (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_cgpoint                (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_cgrect                 (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_cgsize                 (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_cgvector               (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_catransform3d          (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_cllocationcoordinate2d (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_cmtime                 (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_cmtimemapping          (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_cmtimerange            (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_mkcoordinatespan       (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_scnmatrix4             (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_scnvector3             (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_scnvector4             (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_uiedgeinsets           (NSValue *value, void *ptr);
void *xamarin_nsvalue_to_uioffset               (NSValue *value, void *ptr);

id xamarin_bool_to_nsnumber   (MonoObject *value);
id xamarin_sbyte_to_nsnumber  (MonoObject *value);
id xamarin_byte_to_nsnumber   (MonoObject *value);
id xamarin_short_to_nsnumber  (MonoObject *value);
id xamarin_ushort_to_nsnumber (MonoObject *value);
id xamarin_int_to_nsnumber    (MonoObject *value);
id xamarin_uint_to_nsnumber   (MonoObject *value);
id xamarin_long_to_nsnumber   (MonoObject *value);
id xamarin_ulong_to_nsnumber  (MonoObject *value);
id xamarin_nint_to_nsnumber   (MonoObject *value);
id xamarin_nuint_to_nsnumber  (MonoObject *value);
id xamarin_float_to_nsnumber  (MonoObject *value);
id xamarin_double_to_nsnumber (MonoObject *value);
id xamarin_nfloat_to_nsnumber (MonoObject *value);
id xamarin_nfloat_to_nsnumber (MonoObject *value);

id xamarin_nsrange_to_nsvalue                (MonoObject *value);
id xamarin_cgaffinetransform_to_nsvalue      (MonoObject *value);
id xamarin_cgpoint_to_nsvalue                (MonoObject *value);
id xamarin_cgrect_to_nsvalue                 (MonoObject *value);
id xamarin_cgsize_to_nsvalue                 (MonoObject *value);
id xamarin_cgvector_to_nsvalue               (MonoObject *value);
id xamarin_catransform3d_to_nsvalue          (MonoObject *value);
id xamarin_cllocationcoordinate2d_to_nsvalue (MonoObject *value);
id xamarin_cmtime_to_nsvalue                 (MonoObject *value);
id xamarin_cmtimemapping_to_nsvalue          (MonoObject *value);
id xamarin_cmtimerange_to_nsvalue            (MonoObject *value);
id xamarin_mkcoordinatespan_to_nsvalue       (MonoObject *value);
id xamarin_scnmatrix4_to_nsvalue             (MonoObject *value);
id xamarin_scnvector3_to_nsvalue             (MonoObject *value);
id xamarin_scnvector4_to_nsvalue             (MonoObject *value);
id xamarin_uiedgeinsets_to_nsvalue           (MonoObject *value);
id xamarin_uioffset_to_nsvalue               (MonoObject *value);
