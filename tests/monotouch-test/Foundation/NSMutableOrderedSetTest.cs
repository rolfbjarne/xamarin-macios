	...
	public class NSMutableOrderedSetTest {
		...
		public void OperatorEqualTest ()
		{
			...
			using (var oSet2 = new NSMutableOrderedSet (str1, str2, str3)) {
				ClassicAssert.IsTrue (oSet == oSet2, "NSMutableOrderedSetTest == must be true");
				ClassicAssert.IsTrue (oSet.Equals (oSet2), "NSMutableOrderedSetTest Equals must be true");
			}
		}
		...
		public void OperatorDifferentTest ()
		{
			...
			using (var oSet2 = new NSMutableOrderedSet (str3, str2, str1)) {
				ClassicAssert.IsTrue (oSet != oSet2, "NSMutableOrderedSetTest != must be true");
				ClassicAssert.IsFalse (oSet.Equals (oSet2), "NSMutableOrderedSetTest Equals must be false");
			}
		}
