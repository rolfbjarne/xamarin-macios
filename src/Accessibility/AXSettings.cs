...
namespace Accessibility {
	...
	public static class AXSettings {
		...
		[SupportedOSPlatform ("macos15.0")]
		[SupportedOSPlatform ("tvos18.0")]
		public static void OpenSettingsFeature (AXSettingsFeature feature, Action<NSError?> completionHandler)
		{
			delegate* unmanaged<IntPtr, IntPtr> trampoline = &OpenSettingsFeatureCompletionHandler;
