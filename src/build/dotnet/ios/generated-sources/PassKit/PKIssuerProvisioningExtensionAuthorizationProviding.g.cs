...
namespace PassKit {
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "CompletionHandler", Selector = "completionHandler", PropertyType = typeof (global::System.Action<global::PassKit.PKIssuerProvisioningExtensionAuthorizationResult>), GetterSelector = "completionHandler", SetterSelector = "setCompletionHandler:", ArgumentSemantic = ArgumentSemantic.Copy, ParameterBlockProxy = new Type [] { typeof (ObjCRuntime.Trampolines.NIDActionArity1V229) }, ReturnTypeDelegateProxy = typeof (ObjCRuntime.Trampolines.SDActionArity1V229))]
	public partial interface IPKIssuerProvisioningExtensionAuthorizationProviding : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _SetCompletionHandler (IPKIssuerProvisioningExtensionAuthorizationProviding This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V229))]global::System.Action<PKIssuerProvisioningExtensionAuthorizationResult>? value)
		{
