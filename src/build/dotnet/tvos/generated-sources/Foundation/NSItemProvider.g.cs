...
namespace Foundation {
	...
	public unsafe partial class NSItemProvider : NSObject, INSCopying {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual NSProgress LoadDataRepresentation (string typeIdentifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V14))]global::System.Action<NSData, NSError> completionHandler)
		{
			if (typeIdentifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (typeIdentifier));
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual NSProgress LoadFileRepresentation (string typeIdentifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V45))]global::System.Action<NSUrl, NSError> completionHandler)
		{
			if (typeIdentifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (typeIdentifier));
			if (completionHandler is null)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void LoadItem (string typeIdentifier, NSDictionary? options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V52))]global::System.Action<NSObject, NSError>? completionHandler)
		{
			if (typeIdentifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (typeIdentifier));
			var options__handle__ = options.GetHandle ();
			var nstypeIdentifier = CFString.CreateNative (typeIdentifier);
			using var block_completionHandler = Trampolines.SDActionArity2V52.CreateNullableBlock (completionHandler);
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual NSProgress LoadObject (Class aClass, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V53))]global::System.Action<INSItemProviderReading, NSError> completionHandler)
		{
			var aClass__handle__ = aClass!.GetNonNullHandle (nameof (aClass));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void LoadPreviewImage (NSDictionary options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V52))]global::System.Action<NSObject, NSError> completionHandler)
		{
