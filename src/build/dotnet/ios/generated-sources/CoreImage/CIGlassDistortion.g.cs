...
namespace CoreImage {
	...
	public partial class CIGlassDistortion : CIFilter, ICIGlassDistortionProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIGlassDistortion" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIGlassDistortion () : base ("CIGlassDistortion")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIGlassDistortion (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIGlassDistortion (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIGlassDistortion (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		public CIImage? Texture {
			...
			get {
				return (ValueForKey ("inputTextureImage") as CIImage)!;
			}
			[Export ("setTextureImage:", ArgumentSemantic.Retain)]
			set {
				SetValue ("inputTextureImage", value);
			}
		}
