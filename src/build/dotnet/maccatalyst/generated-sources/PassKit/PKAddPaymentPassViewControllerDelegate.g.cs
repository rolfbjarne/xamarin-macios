...
namespace PassKit {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "GenerateRequestWithCertificateChain", Selector = "addPaymentPassViewController:generateRequestWithCertificateChain:nonce:nonceSignature:completionHandler:", ParameterType = new Type [] { typeof (PassKit.PKAddPaymentPassViewController), typeof (NSData[]), typeof (NSData), typeof (NSData), typeof (global::System.Action<global::PassKit.PKAddPaymentPassRequest>) }, ParameterByRef = new bool [] { false, false, false, false, false }, ParameterBlockProxy = new Type? [] { null, null, null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V212) })]
	...
	public partial interface IPKAddPaymentPassViewControllerDelegate : INativeObject, IDisposable
	{
		...
		public unsafe virtual void GenerateRequestWithCertificateChain (PKAddPaymentPassViewController controller, NSData[] certificates, NSData nonce, NSData nonceSignature, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V212))]global::System.Action<PKAddPaymentPassRequest> handler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="controller">To be added.</param><param name="certificates">To be added.</param><param name="nonce">To be added.</param><param name="nonceSignature">To be added.</param><param name="handler">To be added.</param><summary>Called to create an "add payment" request.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _GenerateRequestWithCertificateChain (IPKAddPaymentPassViewControllerDelegate This, PKAddPaymentPassViewController controller, NSData[] certificates, NSData nonce, NSData nonceSignature, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V212))]global::System.Action<PKAddPaymentPassRequest> handler)
		{
			...
			using var block_handler = Trampolines.SDActionArity1V212.CreateBlock (handler);
	...
	internal unsafe sealed class PKAddPaymentPassViewControllerDelegateWrapper : BaseWrapper, IPKAddPaymentPassViewControllerDelegate {
		...
		[Export ("addPaymentPassViewController:generateRequestWithCertificateChain:nonce:nonceSignature:completionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void GenerateRequestWithCertificateChain (PKAddPaymentPassViewController controller, NSData[] certificates, NSData nonce, NSData nonceSignature, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V212))]global::System.Action<PKAddPaymentPassRequest> handler)
		{
			var controller__handle__ = controller!.GetNonNullHandle (nameof (controller));
			if (certificates is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (certificates));
...
namespace PassKit {
	/// <summary>Delegate object for <see cref="T:PassKit.PKAddPaymentPassViewController" /> whose members are called when prompting for an add payment request and when an <see cref="T:PassKit.PKAddPaymentPassRequest" /> has failed.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/PassKit/Reference/PKAddPaymentPassViewControllerDelegate_Protocol/index.html">Apple documentation for <c>PKAddPaymentPassViewControllerDelegate</c></related>
	[Protocol()]
	[Register("Microsoft_MacCatalyst__PassKit_PKAddPaymentPassViewControllerDelegate", false)]
	[Model]
	[UnsupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
