...
namespace Foundation {
	...
	public unsafe partial class NSCharacterSet : NSObject, INSCoding, INSCopying, INSMutableCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selBitmapRepresentationX = "bitmapRepresentation";
		static readonly NativeHandle selBitmapRepresentationXHandle = Selector.GetHandle ("bitmapRepresentation");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCharacterIsMember_X = "characterIsMember:";
		static readonly NativeHandle selCharacterIsMember_XHandle = Selector.GetHandle ("characterIsMember:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selHasMemberInPlane_X = "hasMemberInPlane:";
		static readonly NativeHandle selHasMemberInPlane_XHandle = Selector.GetHandle ("hasMemberInPlane:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInvertedSetX = "invertedSet";
		static readonly NativeHandle selInvertedSetXHandle = Selector.GetHandle ("invertedSet");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selIsSupersetOfSet_X = "isSupersetOfSet:";
		static readonly NativeHandle selIsSupersetOfSet_XHandle = Selector.GetHandle ("isSupersetOfSet:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selLongCharacterIsMember_X = "longCharacterIsMember:";
		static readonly NativeHandle selLongCharacterIsMember_XHandle = Selector.GetHandle ("longCharacterIsMember:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual bool Contains (char aCharacter)
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_char (this.Handle, selCharacterIsMember_XHandle, aCharacter);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_char (&__objc_super__, selCharacterIsMember_XHandle, aCharacter);
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public virtual bool Contains (uint theLongChar)
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_UInt32 (this.Handle, selLongCharacterIsMember_XHandle, theLongChar);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_UInt32 (&__objc_super__, selLongCharacterIsMember_XHandle, theLongChar);
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public virtual NSData GetBitmapRepresentation ()
		{
			NSData ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selBitmapRepresentationXHandle), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selBitmapRepresentationXHandle), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual bool HasMemberInPlane (byte thePlane)
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_byte (this.Handle, selHasMemberInPlane_XHandle, thePlane);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_byte (&__objc_super__, selHasMemberInPlane_XHandle, thePlane);
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public virtual bool IsSupersetOf (NSCharacterSet theOtherSet)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (this.Handle, selIsSupersetOfSet_XHandle, theOtherSet__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, selIsSupersetOfSet_XHandle, theOtherSet__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual NSCharacterSet InvertedSet {
			...
			get {
				NSCharacterSet? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSCharacterSet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selInvertedSetXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSCharacterSet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selInvertedSetXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
