...
namespace MetalPerformanceShadersGraph {
	...
	public unsafe static partial class MPSGraph_ScatterNDOps  {
		...
		const string selScatterNDWithDataTensor_UpdatesTensor_IndicesTensor_BatchDimensions_Mode_Name_X = "scatterNDWithDataTensor:updatesTensor:indicesTensor:batchDimensions:mode:name:";
		static readonly NativeHandle selScatterNDWithDataTensor_UpdatesTensor_IndicesTensor_BatchDimensions_Mode_Name_XHandle = Selector.GetHandle ("scatterNDWithDataTensor:updatesTensor:indicesTensor:batchDimensions:mode:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selScatterNDWithUpdatesTensor_IndicesTensor_Shape_BatchDimensions_Mode_Name_X = "scatterNDWithUpdatesTensor:indicesTensor:shape:batchDimensions:mode:name:";
		static readonly NativeHandle selScatterNDWithUpdatesTensor_IndicesTensor_Shape_BatchDimensions_Mode_Name_XHandle = Selector.GetHandle ("scatterNDWithUpdatesTensor:indicesTensor:shape:batchDimensions:mode:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selScatterNDWithUpdatesTensor_IndicesTensor_Shape_BatchDimensions_Name_X = "scatterNDWithUpdatesTensor:indicesTensor:shape:batchDimensions:name:";
		static readonly NativeHandle selScatterNDWithUpdatesTensor_IndicesTensor_Shape_BatchDimensions_Name_XHandle = Selector.GetHandle ("scatterNDWithUpdatesTensor:indicesTensor:shape:batchDimensions:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MPSGraphTensor ScatterND (this MPSGraph This, MPSGraphTensor dataTensor, MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, nuint batchDimensions, MPSGraphScatterMode mode, string? name)
		{
			...
			var nsname = CFString.CreateNative (name);
			MPSGraphTensor? ret;
			ret =  Runtime.GetNSObject<MPSGraphTensor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_UIntPtr_IntPtr_NativeHandle (This.Handle, selScatterNDWithDataTensor_UpdatesTensor_IndicesTensor_BatchDimensions_Mode_Name_XHandle, dataTensor__handle__, updatesTensor__handle__, indicesTensor__handle__, batchDimensions, (IntPtr) (long) mode, nsname), false)!;
			GC.KeepAlive (This);
