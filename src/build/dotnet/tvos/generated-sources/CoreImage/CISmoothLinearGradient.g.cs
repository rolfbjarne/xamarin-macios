...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that produces a gradient along a linear axis between two endpoints.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/smoothLinear_gradient.png" alt="Result of applying the filter." /></para></remarks>
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public partial class CISmoothLinearGradient : CILinearGradient, ICISmoothLinearGradientProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CISmoothLinearGradient" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CISmoothLinearGradient () : base ("CISmoothLinearGradient")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISmoothLinearGradient (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISmoothLinearGradient (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISmoothLinearGradient (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CISmoothLinearGradientProtocol protocol members 
