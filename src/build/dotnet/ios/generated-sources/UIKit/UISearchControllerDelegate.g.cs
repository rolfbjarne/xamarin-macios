...
namespace UIKit {
	...
	public partial interface IUISearchControllerDelegate : INativeObject, IDisposable
	{
		...
		{
			_WillChangeToSearchBarPlacement (this, searchController, newPlacement);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios16.0")]
		[SupportedOSPlatform ("maccatalyst16.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _WillChangeToSearchBarPlacement (IUISearchControllerDelegate This, UISearchController searchController, UINavigationItemSearchBarPlacement newPlacement)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var searchController__handle__ = searchController!.GetNonNullHandle (nameof (searchController));
		...
		{
			_DidChangeFromSearchBarPlacement (this, searchController, previousPlacement);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios16.0")]
		[SupportedOSPlatform ("maccatalyst16.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _DidChangeFromSearchBarPlacement (IUISearchControllerDelegate This, UISearchController searchController, UINavigationItemSearchBarPlacement previousPlacement)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var searchController__handle__ = searchController!.GetNonNullHandle (nameof (searchController));
		...
		[DynamicDependencyAttribute ("DidChangeFromSearchBarPlacement(UIKit.UISearchController,UIKit.UINavigationItemSearchBarPlacement)")]
		...
		[DynamicDependencyAttribute ("WillChangeToSearchBarPlacement(UIKit.UISearchController,UIKit.UINavigationItemSearchBarPlacement)")]
...
namespace UIKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_iOS__UIKit_UISearchControllerDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("tvos")]
