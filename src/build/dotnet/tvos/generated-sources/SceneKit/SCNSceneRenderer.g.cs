...
namespace SceneKit {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "Prepare", Selector = "prepareObjects:withCompletionHandler:", ParameterType = new Type [] { typeof (NSObject[]), typeof (global::System.Action<bool>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V0) })]
	...
	public partial interface ISCNSceneRenderer : INativeObject, IDisposable
	{
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static bool _Prepare (ISCNSceneRenderer This, NSObject obj, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity1V4))]global::System.Func<bool>? abortHandler)
		{
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _Prepare (ISCNSceneRenderer This, NSObject[] objects, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<bool>? completionHandler)
		{
			if (objects is null)
	...
	internal unsafe sealed class SCNSceneRendererWrapper : BaseWrapper, ISCNSceneRenderer {
		...
		[Export ("prepareObjects:withCompletionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void Prepare (NSObject[] objects, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<bool>? completionHandler)
		{
			if (objects is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (objects));
			using var nsa_objects = NSArray.FromNSObjects (objects);
...
namespace SceneKit {
	/// <summary>Implementation class of the <see cref="T:SceneKit.ISCNSceneRenderer" /> interface.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/SceneKit/Reference/SCNSceneRenderer_Protocol/index.html">Apple documentation for <c>SCNSceneRenderer</c></related>
	[Protocol()]
	[Register("Microsoft_tvOS__SceneKit_SCNSceneRenderer", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
