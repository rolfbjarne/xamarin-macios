...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIBumpDistortion</c>.</summary>
	/// <remarks>
		...
		CoreImage.ICIFilterProtocol
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIBumpDistortionProtocolWrapper))]
	...
	internal unsafe sealed class CIBumpDistortionProtocolWrapper : BaseWrapper, ICIBumpDistortionProtocol {
		public CIBumpDistortionProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIBumpDistortionProtocolWrapper))]
		static CIBumpDistortionProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets or sets an image to filter.</summary>
