	...
	public unsafe partial class INExtension : NSObject, IINIntentHandlerProviding {
		...
		public virtual NSObject? GetHandler (INIntent intent)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("handlerForIntent:"), intent__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (intent);
