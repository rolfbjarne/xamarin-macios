...
#nullable enable
namespace CoreImage {
	/// <summary>The CIHighlightShadowAdjust CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/HiLightShadow.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIHighlightShadowAdjust : CIFilter, ICIHighlightShadowAdjustProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIHighlightShadowAdjust" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIHighlightShadowAdjust () : base ("CIHighlightShadowAdjust")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIHighlightShadowAdjust (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIHighlightShadowAdjust (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIHighlightShadowAdjust (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIHighlightShadowAdjustProtocol protocol members 
