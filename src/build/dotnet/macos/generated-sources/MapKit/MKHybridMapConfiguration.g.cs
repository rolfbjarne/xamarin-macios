...
namespace MapKit {
	...
	public unsafe partial class MKHybridMapConfiguration : MKMapConfiguration {
		...
		const string selInitWithElevationStyle_X = "initWithElevationStyle:";
		static readonly NativeHandle selInitWithElevationStyle_XHandle = Selector.GetHandle ("initWithElevationStyle:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>Creates a new <see cref="MKHybridMapConfiguration" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr (this.Handle, selInitWithElevationStyle_XHandle, (IntPtr) (long) elevationStyle), "initWithElevationStyle:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr (&__objc_super__, selInitWithElevationStyle_XHandle, (IntPtr) (long) elevationStyle), "initWithElevationStyle:");
					GC.KeepAlive (this);
				}
			}
		}
