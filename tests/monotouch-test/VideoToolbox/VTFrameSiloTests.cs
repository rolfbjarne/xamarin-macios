	...
	public class VTFrameSiloTests {
		...
		public void FrameSiloCreateTest ()
		{
			...
			using (var silo = VTFrameSilo.Create ()) {
				ClassicAssert.IsNotNull (silo, "Silo should not be null");
			}
		}
		...
		public void SetTimeRangesTest ()
		{
			...
			using (var silo = VTFrameSilo.Create ()) {
				...
				ClassicAssert.IsTrue (result == VTStatus.FrameSiloInvalidTimeRange, "SetTimeRangesForNextPass");
			}
		}
		...
		public void ForEachTest ()
		{
			...
			using (var silo = VTFrameSilo.Create ()) {
				...
				ClassicAssert.IsTrue (result == VTStatus.Ok, "VTFrameSilo ForEach");
