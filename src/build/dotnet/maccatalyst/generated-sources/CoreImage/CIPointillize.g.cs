...
namespace CoreImage {
	...
	public partial class CIPointillize : CIFilter, ICIPointillizeProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIPointillize" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPointillize () : base ("CIPointillize")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPointillize (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPointillize (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPointillize (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIPointillizeProtocol protocol members 
