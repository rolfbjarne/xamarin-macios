...
namespace Intents {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "HandleSendRideFeedback", Selector = "handleSendRideFeedback:completion:", ParameterType = new Type [] { typeof (Intents.INSendRideFeedbackIntent), typeof (global::System.Action<global::Intents.INSendRideFeedbackIntentResponse>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V170) })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "Confirm", Selector = "confirmSendRideFeedback:completion:", ParameterType = new Type [] { typeof (Intents.INSendRideFeedbackIntent), typeof (global::System.Action<global::Intents.INSendRideFeedbackIntentResponse>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V170) })]
	public partial interface IINSendRideFeedbackIntentHandling : INativeObject, IDisposable
	{
		...
		public unsafe virtual void HandleSendRideFeedback (INSendRideFeedbackIntent sendRideFeedbackintent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V170))]global::System.Action<INSendRideFeedbackIntentResponse> completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="sendRideFeedbackintent">Specifies the user's intention.</param><param name="completion">Completion method that must be called by the override.</param><summary>Developers must override this method and invoke the <see cref="T:System.Action`1" /> with an <see cref="T:Intents.INSendRideFeedbackIntentResponse" /> appropriate to the <see cref="T:Intents.INSendRideFeedbackIntent" /> <paramref name="sendRideFeedbackintent" />.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _HandleSendRideFeedback (IINSendRideFeedbackIntentHandling This, INSendRideFeedbackIntent sendRideFeedbackintent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V170))]global::System.Action<INSendRideFeedbackIntentResponse> completion)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void Confirm (INSendRideFeedbackIntent sendRideFeedbackIntent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V170))]global::System.Action<INSendRideFeedbackIntentResponse> completion)
		{
			_Confirm (this, sendRideFeedbackIntent, completion);
		}
		/// <param name="sendRideFeedbackIntent">To be added.</param><param name="completion">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _Confirm (IINSendRideFeedbackIntentHandling This, INSendRideFeedbackIntent sendRideFeedbackIntent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V170))]global::System.Action<INSendRideFeedbackIntentResponse> completion)
		{
			var sendRideFeedbackIntent__handle__ = sendRideFeedbackIntent!.GetNonNullHandle (nameof (sendRideFeedbackIntent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
	...
	public unsafe static partial class INSendRideFeedbackIntentHandling_Extensions {
		/// <param name="sendRideFeedbackIntent">To be added.</param><param name="completion">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void Confirm (this IINSendRideFeedbackIntentHandling This, INSendRideFeedbackIntent sendRideFeedbackIntent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V170))]global::System.Action<INSendRideFeedbackIntentResponse> completion)
		{
			var sendRideFeedbackIntent__handle__ = sendRideFeedbackIntent!.GetNonNullHandle (nameof (sendRideFeedbackIntent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
