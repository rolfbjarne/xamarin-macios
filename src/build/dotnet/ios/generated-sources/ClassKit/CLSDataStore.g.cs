...
namespace ClassKit {
	...
	public unsafe partial class CLSDataStore : NSObject {
		...
		public unsafe virtual void FetchActivity (NSUrl url, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V36))]global::System.Action<CLSActivity, NSError> completion)
		{
			...
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
			using var block_completion = Trampolines.SDActionArity2V36.CreateBlock (completion);
			BlockLiteral *block_ptr_completion = &block_completion;
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void Save ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError>? completion)
		{
