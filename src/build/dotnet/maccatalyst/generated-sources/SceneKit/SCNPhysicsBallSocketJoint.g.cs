...
namespace SceneKit {
	...
	public unsafe partial class SCNPhysicsBallSocketJoint : SCNPhysicsBehavior {
		...
		public static SCNPhysicsBallSocketJoint Create (SCNPhysicsBody bodyA, SCNVector3 anchorA, SCNPhysicsBody bodyB, SCNVector3 anchorB)
		{
			...
			ret =  Runtime.GetNSObject<SCNPhysicsBallSocketJoint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_SCNVector3_NativeHandle_SCNVector3 (class_ptr, Selector.GetHandle ("jointWithBodyA:anchorA:bodyB:anchorB:"), bodyA__handle__, anchorA, bodyB__handle__, anchorB), false)!;
			GC.KeepAlive (bodyA);
			GC.KeepAlive (bodyB);
			return ret!;
		}
		...
		public static SCNPhysicsBallSocketJoint Create (SCNPhysicsBody body, SCNVector3 anchor)
		{
			...
			SCNPhysicsBallSocketJoint? ret;
			ret =  Runtime.GetNSObject<SCNPhysicsBallSocketJoint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_SCNVector3 (class_ptr, Selector.GetHandle ("jointWithBody:anchor:"), body__handle__, anchor), false)!;
			GC.KeepAlive (body);
			return ret!;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
