...
namespace AVFoundation {
	...
	public unsafe partial class AVSpeechSynthesizer : NSObject {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void WriteUtterance (AVSpeechUtterance utterance, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V7))]global::System.Action<AVAudioBuffer> bufferCallback)
		{
			var utterance__handle__ = utterance!.GetNonNullHandle (nameof (utterance));
			if (bufferCallback is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (bufferCallback));
			using var block_bufferCallback = Trampolines.SDActionArity1V7.CreateBlock (bufferCallback);
