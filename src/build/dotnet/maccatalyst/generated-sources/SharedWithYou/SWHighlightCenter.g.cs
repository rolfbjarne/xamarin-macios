...
namespace SharedWithYou {
	...
	public unsafe partial class SWHighlightCenter : NSObject {
		...
		public virtual void ClearNotices (SWCollaborationHighlight highlight)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("clearNoticesForHighlight:"), highlight__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("clearNoticesForHighlight:"), highlight__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual SWCollaborationHighlight? GetCollaborationHighlight (string collaborationIdentifier, out NSError? error)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<SWCollaborationHighlight> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (this.Handle, Selector.GetHandle ("collaborationHighlightForIdentifier:error:"), nscollaborationIdentifier, &errorValue), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<SWCollaborationHighlight> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("collaborationHighlightForIdentifier:error:"), nscollaborationIdentifier, &errorValue), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		[SupportedOSPlatform ("macos13.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetCollaborationHighlight (NSUrl url, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V150))]global::System.Action<SWCollaborationHighlight, NSError> completionHandler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("getCollaborationHighlightForURL:completionHandler:"), url__handle__, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (url);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetHighlight (NSUrl urL, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V151))]global::System.Action<SWHighlight, NSError> completionHandler)
		{
			var urL__handle__ = urL!.GetNonNullHandle (nameof (urL));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("getHighlightForURL:completionHandler:"), urL__handle__, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (urL);
		...
		[SupportedOSPlatform ("macos13.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetSignedIdentityProof (SWCollaborationHighlight collaborationHighlight, NSData data, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V152))]global::System.Action<global::SharedWithYouCore.SWSignedPersonIdentityProof, NSError> completionHandler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("getSignedIdentityProofForCollaborationHighlight:usingData:completionHandler:"), collaborationHighlight__handle__, data__handle__, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void PostNotice (ISWHighlightEvent @event)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("postNoticeForHighlightEvent:"), @event__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (@event);
		...
		public static string HighlightCollectionTitle {
			...
			get {
				string ret;
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("highlightCollectionTitle")), false)!;
				return ret;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual SWHighlight[] Highlights {
			...
			get {
				SWHighlight[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<SWHighlight>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("highlights")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<SWHighlight>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("highlights")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public static bool SystemCollaborationSupportAvailable {
			...
			get {
				byte ret;
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (class_ptr, Selector.GetHandle ("isSystemCollaborationSupportAvailable"));
				return ret != 0;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
