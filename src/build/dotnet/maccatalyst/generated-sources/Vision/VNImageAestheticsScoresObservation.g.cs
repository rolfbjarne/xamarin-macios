	...
	public unsafe partial class VNImageAestheticsScoresObservation : VNObservation {
		...
		public virtual bool IsUtility {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isUtility"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual float OverallScore {
			...
			get {
				float ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.float_objc_msgSend (this.Handle, Selector.GetHandle ("overallScore"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.float_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("overallScore"));
						GC.KeepAlive (this);
					}
				}
				return ret;
