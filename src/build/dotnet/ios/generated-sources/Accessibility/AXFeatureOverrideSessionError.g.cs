...
namespace Accessibility {
	...
	static public partial class AXFeatureOverrideSessionErrorExtensions {
		[Field ("AXFeatureOverrideSessionErrorDomain", "Accessibility")]
		static NSString? _domain;
		/// <summary>Returns the error domain associated with the Accessibility.AXFeatureOverrideSessionError value</summary>
		...
		{
			if (_domain is null)
				_domain = Dlfcn.GetStringConstant (Libraries.Accessibility.Handle, "AXFeatureOverrideSessionErrorDomain");
			return _domain;
		}
	}
}
