	...
	public class TemplateTest : TestBaseClass {
		...
		public void CreateAndBuildProjectTemplate (TemplateInfo info)
		{
			...
			if (info.Execute) {
				...
				ClassicAssert.IsTrue (CanExecute (info.Platform, runtimeIdentifiers), "Must be executable to execute!");
...
Environment.Exit (0);
		...
		";
			...
			ClassicAssert.AreNotEqual (modifiedMainContents, mainContents, "Failed to modify the main content");
