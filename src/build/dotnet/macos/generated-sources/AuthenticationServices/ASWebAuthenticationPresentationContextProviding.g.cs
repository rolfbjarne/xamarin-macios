...
namespace AuthenticationServices {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "GetPresentationAnchor", Selector = "presentationAnchorForWebAuthenticationSession:", ReturnType = typeof (NSWindow), ParameterType = new Type [] { typeof (AuthenticationServices.ASWebAuthenticationSession) }, ParameterByRef = new bool [] { false })]
	public partial interface IASWebAuthenticationPresentationContextProviding : INativeObject, IDisposable
	{
		...
		public virtual global::AppKit.NSWindow GetPresentationAnchor (ASWebAuthenticationSession session)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static global::AppKit.NSWindow _GetPresentationAnchor (IASWebAuthenticationPresentationContextProviding This, ASWebAuthenticationSession session)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			global::AppKit.NSWindow? ret;
			ret =  Runtime.GetNSObject<global::AppKit.NSWindow> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("presentationAnchorForWebAuthenticationSession:"), session__handle__), false)!;
			GC.KeepAlive (This);
	...
	internal unsafe sealed class ASWebAuthenticationPresentationContextProvidingWrapper : BaseWrapper, IASWebAuthenticationPresentationContextProviding {
		...
		[Export ("presentationAnchorForWebAuthenticationSession:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public global::AppKit.NSWindow GetPresentationAnchor (ASWebAuthenticationSession session)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			global::AppKit.NSWindow? ret;
			ret =  Runtime.GetNSObject<global::AppKit.NSWindow> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("presentationAnchorForWebAuthenticationSession:"), session__handle__), false)!;
