...
namespace UIKit {
	public partial class UICollectionView {
		...
		///   <para>It is very important that the type that you specify implements APublic constructor that takes a <see cref="CoreGraphics.CGRect" /> parameter, this is used to initialize the class from an object allocated by Objective-C.</para>
