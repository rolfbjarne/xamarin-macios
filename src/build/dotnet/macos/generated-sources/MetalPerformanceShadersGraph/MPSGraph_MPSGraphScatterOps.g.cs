...
namespace MetalPerformanceShadersGraph {
	...
	public unsafe static partial class MPSGraph_MPSGraphScatterOps  {
		...
		const string selScatterWithDataTensor_UpdatesTensor_IndicesTensor_Axis_Mode_Name_X = "scatterWithDataTensor:updatesTensor:indicesTensor:axis:mode:name:";
		static readonly NativeHandle selScatterWithDataTensor_UpdatesTensor_IndicesTensor_Axis_Mode_Name_XHandle = Selector.GetHandle ("scatterWithDataTensor:updatesTensor:indicesTensor:axis:mode:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selScatterWithUpdatesTensor_IndicesTensor_Shape_Axis_Mode_Name_X = "scatterWithUpdatesTensor:indicesTensor:shape:axis:mode:name:";
		static readonly NativeHandle selScatterWithUpdatesTensor_IndicesTensor_Shape_Axis_Mode_Name_XHandle = Selector.GetHandle ("scatterWithUpdatesTensor:indicesTensor:shape:axis:mode:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MPSGraphTensor Scatter (this MPSGraph This, MPSGraphTensor dataTensor, MPSGraphTensor updatesTensor, MPSGraphTensor indicesTensor, nint axis, MPSGraphScatterMode mode, string? name)
		{
			...
			var nsname = CFString.CreateNative (name);
			MPSGraphTensor? ret;
			ret =  Runtime.GetNSObject<MPSGraphTensor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_IntPtr_IntPtr_NativeHandle (This.Handle, selScatterWithDataTensor_UpdatesTensor_IndicesTensor_Axis_Mode_Name_XHandle, dataTensor__handle__, updatesTensor__handle__, indicesTensor__handle__, axis, (IntPtr) (long) mode, nsname), false)!;
			GC.KeepAlive (This);
