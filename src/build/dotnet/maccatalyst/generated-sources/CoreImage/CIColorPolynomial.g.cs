...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that modifies the source pixels by applying a set of cubic polynomials. </summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/color_polynomial.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIColorPolynomial : CIColorCrossPolynomial, ICIColorPolynomialProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorPolynomial" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIColorPolynomial () : base ("CIColorPolynomial")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorPolynomial (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorPolynomial (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorPolynomial (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIColorPolynomialProtocol protocol members 
