	...
	public unsafe partial class VNTrackOpticalFlowRequest : VNStatefulRequest {
		...
		public virtual VNTrackOpticalFlowRequestComputationAccuracy ComputationAccuracy {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (Vision.VNTrackOpticalFlowRequestComputationAccuracy) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selComputationAccuracyXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (Vision.VNTrackOpticalFlowRequestComputationAccuracy) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selComputationAccuracyXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
