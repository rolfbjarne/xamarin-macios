...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that produces a vintage look with exagerrated warm colors.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/photo_effect_transfer.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIPhotoEffectTransfer : CIPhotoEffect {
		/// <summary>Creates a new <see cref="CIPhotoEffectTransfer" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPhotoEffectTransfer () : base ("CIPhotoEffectTransfer")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPhotoEffectTransfer (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPhotoEffectTransfer (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPhotoEffectTransfer (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
