...
namespace AppKit {
	...
	public partial interface INSTextSelectionDataSource : INativeObject, IDisposable
	{
		...
		[DynamicDependencyAttribute ("EnumerateCaretOffsets(AppKit.INSTextLocation,AppKit.NSTextSelectionDataSourceEnumerateCaretOffsetsDelegate)")]
		[DynamicDependencyAttribute ("EnumerateContainerBoundaries(AppKit.INSTextLocation,System.Boolean,AppKit.NSTextSelectionDataSourceEnumerateContainerBoundariesDelegate)")]
		[DynamicDependencyAttribute ("EnumerateSubstrings(AppKit.INSTextLocation,Foundation.NSStringEnumerationOptions,AppKit.NSTextSelectionDataSourceEnumerateSubstringsDelegate)")]
		[DynamicDependencyAttribute ("GetBaseWritingDirection(AppKit.INSTextLocation)")]
		[DynamicDependencyAttribute ("GetLineFragmentRange(CoreGraphics.CGPoint,AppKit.INSTextLocation)")]
		[DynamicDependencyAttribute ("GetLocation(AppKit.INSTextLocation,System.IntPtr)")]
		[DynamicDependencyAttribute ("GetOffsetFromLocation(AppKit.INSTextLocation,AppKit.INSTextLocation)")]
		[DynamicDependencyAttribute ("GetTextLayoutOrientation(AppKit.INSTextLocation)")]
		[DynamicDependencyAttribute ("GetTextRange(AppKit.NSTextSelectionGranularity,AppKit.INSTextLocation)")]
...
namespace AppKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__AppKit_NSTextSelectionDataSource", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
	[UnsupportedOSPlatform ("tvos")]
