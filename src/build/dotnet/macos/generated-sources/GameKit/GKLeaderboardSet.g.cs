...
namespace GameKit {
	...
	public unsafe partial class GKLeaderboardSet : NSObject, INSCoding, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selLoadLeaderboardSetsWithCompletionHandler_X = "loadLeaderboardSetsWithCompletionHandler:";
		static readonly NativeHandle selLoadLeaderboardSetsWithCompletionHandler_XHandle = Selector.GetHandle ("loadLeaderboardSetsWithCompletionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selLoadLeaderboardsWithHandler_X = "loadLeaderboardsWithHandler:";
		static readonly NativeHandle selLoadLeaderboardsWithHandler_XHandle = Selector.GetHandle ("loadLeaderboardsWithHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public unsafe static void LoadLeaderboardSets ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGKLeaderboardSetsHandler))]GKLeaderboardSetsHandler? completionHandler)
		{
			...
			if (completionHandler is not null)
				block_ptr_completionHandler = &block_completionHandler;
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (class_ptr, selLoadLeaderboardSetsWithCompletionHandler_XHandle, (IntPtr) block_ptr_completionHandler);
		}
		/// <summary>To be added.</summary>
		/// <returns>
		...
		public unsafe virtual void LoadLeaderboardsWithCompletionHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGKLeaderboardsHandler))]GKLeaderboardsHandler handler)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selLoadLeaderboardsWithHandler_XHandle, (IntPtr) block_ptr_handler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selLoadLeaderboardsWithHandler_XHandle, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		}
