...
namespace AudioUnit {
	...
	public unsafe partial class AUParameterTree : AUParameterGroup, INSCoding, INSSecureCoding {
		...
		const string selCreateGroupFromTemplate_Identifier_Name_AddressOffset_X = "createGroupFromTemplate:identifier:name:addressOffset:";
		static readonly NativeHandle selCreateGroupFromTemplate_Identifier_Name_AddressOffset_XHandle = Selector.GetHandle ("createGroupFromTemplate:identifier:name:addressOffset:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCreateGroupTemplate_X = "createGroupTemplate:";
		static readonly NativeHandle selCreateGroupTemplate_XHandle = Selector.GetHandle ("createGroupTemplate:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCreateGroupWithIdentifier_Name_Children_X = "createGroupWithIdentifier:name:children:";
		static readonly NativeHandle selCreateGroupWithIdentifier_Name_Children_XHandle = Selector.GetHandle ("createGroupWithIdentifier:name:children:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCreateParameterWithIdentifier_Name_Address_Min_Max_Unit_UnitName_Flags_ValueStrings_DependentParameters_X = "createParameterWithIdentifier:name:address:min:max:unit:unitName:flags:valueStrings:dependentParameters:";
		static readonly NativeHandle selCreateParameterWithIdentifier_Name_Address_Min_Max_Unit_UnitName_Flags_ValueStrings_DependentParameters_XHandle = Selector.GetHandle ("createParameterWithIdentifier:name:address:min:max:unit:unitName:flags:valueStrings:dependentParameters:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCreateTreeWithChildren_X = "createTreeWithChildren:";
		static readonly NativeHandle selCreateTreeWithChildren_XHandle = Selector.GetHandle ("createTreeWithChildren:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selParameterWithAddress_X = "parameterWithAddress:";
		static readonly NativeHandle selParameterWithAddress_XHandle = Selector.GetHandle ("parameterWithAddress:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selParameterWithID_Scope_Element_X = "parameterWithID:scope:element:";
		static readonly NativeHandle selParameterWithID_Scope_Element_XHandle = Selector.GetHandle ("parameterWithID:scope:element:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static AUParameterGroup CreateGroup (string identifier, string name, AUParameterNode[] children)
		{
			...
			ret =  Runtime.GetNSObject<AUParameterGroup> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (class_ptr, selCreateGroupWithIdentifier_Name_Children_XHandle, nsidentifier, nsname, nsa_children.Handle), false)!;
		...
		public static AUParameterGroup CreateGroup (AUParameterGroup templateGroup, string identifier, string name, ulong addressOffset)
		{
			...
			var nsname = CFString.CreateNative (name);
			AUParameterGroup? ret;
			ret =  Runtime.GetNSObject<AUParameterGroup> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_UInt64 (class_ptr, selCreateGroupFromTemplate_Identifier_Name_AddressOffset_XHandle, templateGroup__handle__, nsidentifier, nsname, addressOffset), false)!;
		...
		public static AUParameterGroup CreateGroupTemplate (AUParameterNode[] children)
		{
			...
			using var nsa_children = NSArray.FromNSObjects (children);
			AUParameterGroup ret;
			ret =  Runtime.GetNSObject<AUParameterGroup> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selCreateGroupTemplate_XHandle, nsa_children.Handle), false)!;
			return ret;
		}
		...
		public static AUParameterTree CreateTree (AUParameterNode[] children)
		{
			...
			using var nsa_children = NSArray.FromNSObjects (children);
			AUParameterTree ret;
			ret =  Runtime.GetNSObject<AUParameterTree> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selCreateTreeWithChildren_XHandle, nsa_children.Handle), false)!;
			return ret;
		}
		...
		public virtual AUParameter? GetParameter (ulong address)
		{
			AUParameter ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<AUParameter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UInt64 (this.Handle, selParameterWithAddress_XHandle, address), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<AUParameter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_UInt64 (&__objc_super__, selParameterWithAddress_XHandle, address), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual AUParameter? GetParameter (uint paramID, uint scope, uint element)
		{
			AUParameter ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<AUParameter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UInt32_UInt32_UInt32 (this.Handle, selParameterWithID_Scope_Element_XHandle, paramID, scope, element), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<AUParameter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_UInt32_UInt32_UInt32 (&__objc_super__, selParameterWithID_Scope_Element_XHandle, paramID, scope, element), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
