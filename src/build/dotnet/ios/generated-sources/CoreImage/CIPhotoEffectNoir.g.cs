...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that produces a high-contrast black-and-white image.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CIPhotoEffectNoir filter with the input image
	...
	/// var output = photo_effect_noir.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/photo_effect_noir.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIPhotoEffectNoir : CIPhotoEffect {
		/// <summary>Creates a new <see cref="CIPhotoEffectNoir" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPhotoEffectNoir () : base ("CIPhotoEffectNoir")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPhotoEffectNoir (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPhotoEffectNoir (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPhotoEffectNoir (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
