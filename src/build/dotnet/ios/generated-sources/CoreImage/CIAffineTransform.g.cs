...
#nullable enable
namespace CoreImage {
	/// <summary>Performs an affine transform on an image.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 		</para><para><img href="~/xml/CoreImage/_images/AffineTransform.png" alt="Result of applying the filter." /></para><para>
	...
	/// 		</para></remarks>
	public partial class CIAffineTransform : CIAffineFilter {
		/// <summary>Creates a new <see cref="CIAffineTransform" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAffineTransform (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAffineTransform (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAffineTransform (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
