...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIVortexDistortion</c>.</summary>
	/// <remarks>
	...
	[Protocol (Name = "CIVortexDistortion", WrapperType = typeof (CIVortexDistortionProtocolWrapper))]
	...
	public partial interface ICIVortexDistortionProtocol : INativeObject, IDisposable, 
		CoreImage.ICIFilterProtocol
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIVortexDistortionProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICIVortexDistortionProtocol ()
		{
			GC.KeepAlive (null);
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CIImage _GetInputImage (ICIVortexDistortionProtocol This)
		{
			CIImage ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputImage (ICIVortexDistortionProtocol This, CIImage? value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CGPoint _GetInputCenter (ICIVortexDistortionProtocol This)
		{
			CGPoint ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputCenter (ICIVortexDistortionProtocol This, CGPoint value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static float _GetRadius (ICIVortexDistortionProtocol This)
		{
			float ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetRadius (ICIVortexDistortionProtocol This, float value)
		{
			global::ObjCRuntime.Messaging.void_objc_msgSend_float (This.Handle, Selector.GetHandle ("setRadius:"), value);
			GC.KeepAlive (This);
		}
		/// <summary>The angle, in degrees, through which to rotate.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[global::Foundation.RequiredMember]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static float _GetAngle (ICIVortexDistortionProtocol This)
		{
			float ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetAngle (ICIVortexDistortionProtocol This, float value)
		{
	...
	internal unsafe sealed class CIVortexDistortionProtocolWrapper : BaseWrapper, ICIVortexDistortionProtocol {
		public CIVortexDistortionProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIVortexDistortionProtocolWrapper))]
		static CIVortexDistortionProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets or sets an image to filter.</summary>
