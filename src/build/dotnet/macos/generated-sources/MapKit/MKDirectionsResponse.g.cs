...
namespace MapKit {
	...
	public unsafe partial class MKDirectionsResponse : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRoutesX = "routes";
		static readonly NativeHandle selRoutesXHandle = Selector.GetHandle ("routes");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual MKRoute[] Routes {
			...
			get {
				MKRoute[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<MKRoute>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selRoutesXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<MKRoute>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selRoutesXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
