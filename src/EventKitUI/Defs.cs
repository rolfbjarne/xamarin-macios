...
namespace EventKitUI {
	...
	public enum EKCalendarChooserSelectionStyle : long {
		/// <summary>Indicates single.</summary>
		Single,
		/// <summary>Indicates multiple.</summary>
		Multiple,
	}
	...
	public enum EKCalendarChooserDisplayStyle : long {
		/// <summary>Indicates all calendars.</summary>
		AllCalendars,
		/// <summary>Indicates writable calendars only.</summary>
