	...
	public unsafe partial class MTKMeshBuffer : NSObject, INSCopying, global::ModelIO.IMDLMeshBuffer, global::ModelIO.IMDLNamed {
		...
		public virtual global::Metal.IMTLBuffer Buffer {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetINativeObject<global::Metal.IMTLBuffer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selBufferXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetINativeObject<global::Metal.IMTLBuffer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selBufferXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
