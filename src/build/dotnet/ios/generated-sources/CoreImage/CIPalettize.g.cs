...
namespace CoreImage {
	...
	public partial class CIPalettize : CIFilter, ICIPalettizeProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIPalettize" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPalettize () : base ("CIPalettize")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPalettize (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPalettize (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPalettize (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIPalettizeProtocol protocol members 
