...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITileFilter" /> that applies 8-way reflected symmetry.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/eightfold_reflected_tile.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIEightfoldReflectedTile : CITileFilter, ICIEightfoldReflectedTileProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIEightfoldReflectedTile" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIEightfoldReflectedTile (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIEightfoldReflectedTile (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIEightfoldReflectedTile (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIEightfoldReflectedTileProtocol protocol members 
