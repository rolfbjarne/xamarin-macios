...
namespace WebKit {
	...
	public partial interface IWKDownloadDelegate : INativeObject, IDisposable
	{
		...
		public unsafe virtual void DecideDestination (WKDownload download, NSUrlResponse response, string suggestedFilename, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V61))]global::System.Action<NSUrl> completionHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _DecideDestination (IWKDownloadDelegate This, WKDownload download, NSUrlResponse response, string suggestedFilename, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V61))]global::System.Action<NSUrl> completionHandler)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void WillPerformHttpRedirection (WKDownload download, NSHttpUrlResponse response, NSUrlRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V282))]global::System.Action<WKDownloadRedirectPolicy> decisionHandler)
		{
			_WillPerformHttpRedirection (this, download, response, request, decisionHandler);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _WillPerformHttpRedirection (IWKDownloadDelegate This, WKDownload download, NSHttpUrlResponse response, NSUrlRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V282))]global::System.Action<WKDownloadRedirectPolicy> decisionHandler)
		{
			var download__handle__ = download!.GetNonNullHandle (nameof (download));
			var response__handle__ = response!.GetNonNullHandle (nameof (response));
			...
			using var block_decisionHandler = Trampolines.SDActionArity1V282.CreateBlock (decisionHandler);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DidReceiveAuthenticationChallenge (WKDownload download, NSUrlAuthenticationChallenge challenge, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V11))]global::System.Action<NSUrlSessionAuthChallengeDisposition, NSUrlCredential> completionHandler)
		{
			_DidReceiveAuthenticationChallenge (this, download, challenge, completionHandler);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _DidReceiveAuthenticationChallenge (IWKDownloadDelegate This, WKDownload download, NSUrlAuthenticationChallenge challenge, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V11))]global::System.Action<NSUrlSessionAuthChallengeDisposition, NSUrlCredential> completionHandler)
		{
			var download__handle__ = download!.GetNonNullHandle (nameof (download));
	...
	public unsafe static partial class WKDownloadDelegate_Extensions {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void WillPerformHttpRedirection (this IWKDownloadDelegate This, WKDownload download, NSHttpUrlResponse response, NSUrlRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V282))]global::System.Action<WKDownloadRedirectPolicy> decisionHandler)
		{
			var download__handle__ = download!.GetNonNullHandle (nameof (download));
			var response__handle__ = response!.GetNonNullHandle (nameof (response));
			var request__handle__ = request!.GetNonNullHandle (nameof (request));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void DidReceiveAuthenticationChallenge (this IWKDownloadDelegate This, WKDownload download, NSUrlAuthenticationChallenge challenge, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V11))]global::System.Action<NSUrlSessionAuthChallengeDisposition, NSUrlCredential> completionHandler)
		{
			var download__handle__ = download!.GetNonNullHandle (nameof (download));
			var challenge__handle__ = challenge!.GetNonNullHandle (nameof (challenge));
			if (completionHandler is null)
	...
	internal unsafe sealed class WKDownloadDelegateWrapper : BaseWrapper, IWKDownloadDelegate {
		...
		[Export ("download:decideDestinationUsingResponse:suggestedFilename:completionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void DecideDestination (WKDownload download, NSUrlResponse response, string suggestedFilename, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V61))]global::System.Action<NSUrl> completionHandler)
		{
			var download__handle__ = download!.GetNonNullHandle (nameof (download));
			var response__handle__ = response!.GetNonNullHandle (nameof (response));
			if (suggestedFilename is null)
...
namespace WebKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_iOS__WebKit_WKDownloadDelegate", false)]
	[Model]
	[SupportedOSPlatform ("ios14.5")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
