...
namespace UIKit {
	...
	public partial interface INSTextLayoutManagerDelegate : INativeObject, IDisposable
	{
		...
		[DynamicDependencyAttribute ("GetRenderingAttributes(UIKit.NSTextLayoutManager,Foundation.NSObject,UIKit.INSTextLocation,Foundation.NSDictionary{Foundation.NSString,Foundation.NSObject})")]
		[DynamicDependencyAttribute ("GetTextLayoutFragment(UIKit.NSTextLayoutManager,UIKit.INSTextLocation,UIKit.NSTextElement)")]
		[DynamicDependencyAttribute ("ShouldBreakLineBeforeLocation(UIKit.NSTextLayoutManager,UIKit.INSTextLocation,System.Boolean)")]
...
namespace UIKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_MacCatalyst__UIKit_NSTextLayoutManagerDelegate", false)]
	[Model]
	[SupportedOSPlatform ("tvos15.0")]
	[SupportedOSPlatform ("ios15.0")]
	[SupportedOSPlatform ("maccatalyst")]
