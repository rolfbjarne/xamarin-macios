...
namespace MonoTouchFixtures.ObjCRuntime {
	...
	public class BlocksTest {
		...
		public unsafe void SignatureA ()
		{
			...
			var boolIsB = true;
#endif
			ClassicAssert.AreEqual (boolIsB ? "v@?B" : "v@?c", GetBlockSignature (&block), $"Signature ARM64: {Runtime.IsARM64CallingConvention}");
		}
		...
		public unsafe void SignatureB ()
		{
			...
			ClassicAssert.AreEqual ("v@?@", GetBlockSignature (&block), "Signature");
		}
		...
		public unsafe void SignatureC ()
		{
			...
			ClassicAssert.AreEqual ("v@?^v^v", GetBlockSignature (&block), "Signature");
		}
		...
		public void TestSetupBlock ()
		{
			...
			using (var obj = new TestClass ()) {
				TestClass.OnCallback = ((IntPtr blockArgument, NativeHandle self, IntPtr argument) => {
					ClassicAssert.AreNotEqual (IntPtr.Zero, blockArgument, "block");
					ClassicAssert.AreEqual (obj.Handle, self, "self");
					ClassicAssert.AreEqual (argument, (IntPtr) 0x12345678, "argument");
				});
