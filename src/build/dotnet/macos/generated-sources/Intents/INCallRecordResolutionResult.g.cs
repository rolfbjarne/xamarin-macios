...
#nullable enable
namespace Intents {
	[Register("INCallRecordResolutionResult", true)]
	[UnsupportedOSPlatform ("tvos")]
	[SupportedOSPlatform ("ios14.0")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
	public unsafe partial class INCallRecordResolutionResult : INIntentResolutionResult {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("INCallRecordResolutionResult");
		...
		/// <summary>Creates a new <see cref="INCallRecordResolutionResult" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public INCallRecordResolutionResult () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected INCallRecordResolutionResult (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal INCallRecordResolutionResult (NativeHandle handle) : base (handle)
		{
		}
		...
		public static INCallRecordResolutionResult GetConfirmationRequired (INCallRecord? callRecordToConfirm)
		{
			...
			INCallRecordResolutionResult? ret;
			ret =  Runtime.GetNSObject<INCallRecordResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selConfirmationRequiredWithCallRecordToConfirm_XHandle, callRecordToConfirm__handle__), false)!;
			GC.KeepAlive (callRecordToConfirm);
			return ret!;
		}
		[Export ("confirmationRequiredWithItemToConfirm:forReason:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INCallRecordResolutionResult GetConfirmationRequired (NSObject itemToConfirm, nint reason)
		{
			var itemToConfirm__handle__ = itemToConfirm!.GetNonNullHandle (nameof (itemToConfirm));
			INCallRecordResolutionResult? ret;
			ret =  Runtime.GetNSObject<INCallRecordResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_IntPtr (class_ptr, selConfirmationRequiredWithItemToConfirm_ForReason_XHandle, itemToConfirm__handle__, reason), false)!;
		...
		public static INCallRecordResolutionResult GetDisambiguation (INCallRecord[] callRecordsToDisambiguate)
		{
			...
			INCallRecordResolutionResult ret;
			ret =  Runtime.GetNSObject<INCallRecordResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selDisambiguationWithCallRecordsToDisambiguate_XHandle, nsa_callRecordsToDisambiguate.Handle), false)!;
			return ret;
		}
		...
		public static INCallRecordResolutionResult GetSuccess (INCallRecord resolvedCallRecord)
		{
			...
			INCallRecordResolutionResult? ret;
			ret =  Runtime.GetNSObject<INCallRecordResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selSuccessWithResolvedCallRecord_XHandle, resolvedCallRecord__handle__), false)!;
			GC.KeepAlive (resolvedCallRecord);
			return ret!;
		}
		[Export ("unsupportedWithReason:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INCallRecordResolutionResult GetUnsupported (nint reason)
		{
			INCallRecordResolutionResult ret;
			ret =  Runtime.GetNSObject<INCallRecordResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr (class_ptr, selUnsupportedWithReason_XHandle, reason), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INCallRecordResolutionResult NeedsValue {
			[Export ("needsValue")]
			get {
				INCallRecordResolutionResult? ret;
				ret =  Runtime.GetNSObject<INCallRecordResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selNeedsValueXHandle), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INCallRecordResolutionResult NotRequired {
			[Export ("notRequired")]
			get {
				INCallRecordResolutionResult? ret;
				ret =  Runtime.GetNSObject<INCallRecordResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selNotRequiredXHandle), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INCallRecordResolutionResult Unsupported {
			[Export ("unsupported")]
			get {
				INCallRecordResolutionResult? ret;
				ret =  Runtime.GetNSObject<INCallRecordResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selUnsupportedXHandle), false)!;
				return ret!;
			}
		}
