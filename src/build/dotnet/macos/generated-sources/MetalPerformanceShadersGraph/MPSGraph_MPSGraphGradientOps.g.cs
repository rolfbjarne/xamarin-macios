...
namespace MetalPerformanceShadersGraph {
	...
	public unsafe static partial class MPSGraph_MPSGraphGradientOps  {
		...
		const string selGradientForPrimaryTensor_WithTensors_Name_X = "gradientForPrimaryTensor:withTensors:name:";
		static readonly NativeHandle selGradientForPrimaryTensor_WithTensors_Name_XHandle = Selector.GetHandle ("gradientForPrimaryTensor:withTensors:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static NSDictionary<MPSGraphTensor, MPSGraphTensor> Gradients (this MPSGraph This, MPSGraphTensor of, MPSGraphTensor[] with, string? name)
		{
			...
			ret =  Runtime.GetNSObject<NSDictionary<MPSGraphTensor, MPSGraphTensor>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (This.Handle, selGradientForPrimaryTensor_WithTensors_Name_XHandle, of__handle__, nsa_with.Handle, nsname), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (of);
