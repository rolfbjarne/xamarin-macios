	...
	public class UuidTest {
		...
		public void Equality_PartialEquals ()
		{
			...
			using (var u2 = CBUUID.FromBytes (guid)) {
				ClassicAssert.True (u1.Equals ((object) u2), "Equals-1a");
				ClassicAssert.True (u1.Equals ((NSObject) u2), "Equals-1b");
				ClassicAssert.True (u1.Equals ((CBUUID) u2), "Equals-1b");
			...
			using (var u2 = CBUUID.FromPartial (0x1234)) {
				ClassicAssert.True (u1.Equals ((object) u2), "Equals-2a");
				ClassicAssert.True (u1.Equals ((NSObject) u2), "Equals-2b");
				ClassicAssert.True (u1.Equals ((CBUUID) u2), "Equals-2b");
			...
			using (var u2 = CBUUID.FromBytes (new byte [] { 0x12, 0x34 })) {
				ClassicAssert.True (u1.Equals ((object) u2), "Equals-3a");
				ClassicAssert.True (u1.Equals ((NSObject) u2), "Equals-3b");
				ClassicAssert.True (u1.Equals ((CBUUID) u2), "Equals-3b");
