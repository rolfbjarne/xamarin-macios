...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSRnnImageInferenceLayer : MPSCnnKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeBidirectionalSequenceToCommandBuffer_SourceSequence_DestinationForwardImages_DestinationBackwardImages_X = "encodeBidirectionalSequenceToCommandBuffer:sourceSequence:destinationForwardImages:destinationBackwardImages:";
		static readonly NativeHandle selEncodeBidirectionalSequenceToCommandBuffer_SourceSequence_DestinationForwardImages_DestinationBackwardImages_XHandle = Selector.GetHandle ("encodeBidirectionalSequenceToCommandBuffer:sourceSequence:destinationForwardImages:destinationBackwardImages:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeSequenceToCommandBuffer_SourceImages_DestinationImages_RecurrentInputState_RecurrentOutputStates_X = "encodeSequenceToCommandBuffer:sourceImages:destinationImages:recurrentInputState:recurrentOutputStates:";
		static readonly NativeHandle selEncodeSequenceToCommandBuffer_SourceImages_DestinationImages_RecurrentInputState_RecurrentOutputStates_XHandle = Selector.GetHandle ("encodeSequenceToCommandBuffer:sourceImages:destinationImages:recurrentInputState:recurrentOutputStates:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual MPSRnnImageInferenceLayer Copy (NSZone? zone, global::Metal.IMTLDevice? device)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<MPSRnnImageInferenceLayer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selCopyWithZone_Device_XHandle, zone__handle__, device__handle__), true)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<MPSRnnImageInferenceLayer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selCopyWithZone_Device_XHandle, zone__handle__, device__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (zone);
		...
		public virtual void EncodeBidirectionalSequence (global::Metal.IMTLCommandBuffer commandBuffer, MPSImage[] sourceSequence, MPSImage[] destinationForwardImages, MPSImage[]? destinationBackwardImages)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeBidirectionalSequenceToCommandBuffer_SourceSequence_DestinationForwardImages_DestinationBackwardImages_XHandle, commandBuffer__handle__, nsa_sourceSequence.Handle, nsa_destinationForwardImages.Handle, nsa_destinationBackwardImages.GetHandle ());
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeBidirectionalSequenceToCommandBuffer_SourceSequence_DestinationForwardImages_DestinationBackwardImages_XHandle, commandBuffer__handle__, nsa_sourceSequence.Handle, nsa_destinationForwardImages.Handle, nsa_destinationBackwardImages.GetHandle ());
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void EncodeSequence (global::Metal.IMTLCommandBuffer commandBuffer, MPSImage[] sourceImages, MPSImage[] destinationImages, MPSRnnRecurrentImageState? recurrentInputState, NSMutableArray<MPSRnnRecurrentImageState>? recurrentOutputStates)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeSequenceToCommandBuffer_SourceImages_DestinationImages_RecurrentInputState_RecurrentOutputStates_XHandle, commandBuffer__handle__, nsa_sourceImages.Handle, nsa_destinationImages.Handle, recurrentInputState__handle__, recurrentOutputStates__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeSequenceToCommandBuffer_SourceImages_DestinationImages_RecurrentInputState_RecurrentOutputStates_XHandle, commandBuffer__handle__, nsa_sourceImages.Handle, nsa_destinationImages.Handle, recurrentInputState__handle__, recurrentOutputStates__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
