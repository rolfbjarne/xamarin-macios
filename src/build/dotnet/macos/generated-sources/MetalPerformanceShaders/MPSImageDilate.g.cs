...
namespace MetalPerformanceShaders {
	/// <summary>Finds the maximum value in a region, offset by a corresponding value in a mask.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/MetalPerformanceShaders/Reference/MPSImageDilate_ClassReference/index.html">Apple documentation for <c>MPSImageDilate</c></related>
	[Register("MPSImageDilate", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class MPSImageDilate : MPSUnaryImageKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithDevice_KernelWidth_KernelHeight_Values_X = "initWithDevice:kernelWidth:kernelHeight:values:";
		static readonly NativeHandle selInitWithDevice_KernelWidth_KernelHeight_Values_XHandle = Selector.GetHandle ("initWithDevice:kernelWidth:kernelHeight:values:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSImageDilate");
		...
		public MPSImageDilate (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected MPSImageDilate (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSImageDilate (NativeHandle handle) : base (handle)
		{
		}
		...
		[DesignatedInitializer]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSImageDilate (NSCoder aDecoder, global::Metal.IMTLDevice device)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal virtual nint InitWithDevice (global::Metal.IMTLDevice device, nuint kernelWidth, nuint kernelHeight, nint values)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_UIntPtr_UIntPtr_IntPtr (this.Handle, selInitWithDevice_KernelWidth_KernelHeight_Values_XHandle, device__handle__, kernelWidth, kernelHeight, values);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_UIntPtr_UIntPtr_IntPtr (&__objc_super__, selInitWithDevice_KernelWidth_KernelHeight_Values_XHandle, device__handle__, kernelWidth, kernelHeight, values);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
