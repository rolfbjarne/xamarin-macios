...
namespace UIKit {
	...
	public enum UIFocusSoundIdentifier : int {
		None = 0,
		Default = 1,
	}
	/// <summary>Extension methods for the <see cref="global::UIKit.UIFocusSoundIdentifier" /> enumeration.</summary>
	[UnsupportedOSPlatform ("ios")]
	[UnsupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("tvos")]
	...
	static public partial class UIFocusSoundIdentifierExtensions {
		...
		public static NSString? GetConstant (this UIFocusSoundIdentifier self)
		{
			...
			switch ((int) self) {
			case 0: // UIFocusSoundIdentifier.None
				ptr = UIFocusSoundIdentifierNone;
				break;
			case 1: // UIFocusSoundIdentifier.Default
				ptr = UIFocusSoundIdentifierDefault;
				break;
			}
			return (NSString?) Runtime.GetNSObject (ptr);
		}
		/// <summary>Retrieves the <see cref="global::UIKit.UIFocusSoundIdentifier" /> value named by <paramref name="constant" />.</summary>
		...
		/// <summary>Retrieves the <see cref="global::UIKit.UIFocusSoundIdentifier" /> value represented by the backing field value in <paramref name="handle" />.</summary>
		/// <param name="handle">The native handle with the name of the constant to retrieve.</param>
		public static UIFocusSoundIdentifier GetValue (NativeHandle handle)
		{
		...
		/// <summary>Retrieves the <see cref="global::UIKit.UIFocusSoundIdentifier" /> value represented by the backing field value in <paramref name="handle" />.</summary>
		/// <param name="handle">The native handle with the name of the constant to retrieve.</param>
		public static UIFocusSoundIdentifier? GetNullableValue (NativeHandle handle)
		{
			using var str = Runtime.GetNSObject<NSString> (handle);
			if (str is null)
				return null;
		...
		/// <summary>Converts an array of <see cref="global::UIKit.UIFocusSoundIdentifier" /> enum values into an array of their corresponding constants.</summary>
