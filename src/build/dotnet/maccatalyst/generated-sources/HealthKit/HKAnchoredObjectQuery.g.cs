...
namespace HealthKit {
	...
	public unsafe partial class HKAnchoredObjectQuery : HKQuery {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_UIntPtr_NativeHandle (this.Handle, Selector.GetHandle ("initWithType:predicate:anchor:limit:resultsHandler:"), type__handle__, predicate__handle__, anchor__handle__, limit, (IntPtr) block_ptr_handler), "initWithType:predicate:anchor:limit:resultsHandler:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_UIntPtr_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithType:predicate:anchor:limit:resultsHandler:"), type__handle__, predicate__handle__, anchor__handle__, limit, (IntPtr) block_ptr_handler), "initWithType:predicate:anchor:limit:resultsHandler:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (type);
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_IntPtr_NativeHandle (this.Handle, Selector.GetHandle ("initWithQueryDescriptors:anchor:limit:resultsHandler:"), nsa_queryDescriptors.Handle, anchor__handle__, limit, (IntPtr) block_ptr_resultsHandler), "initWithQueryDescriptors:anchor:limit:resultsHandler:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
		...
		public unsafe virtual HKAnchoredObjectUpdateHandler? UpdateHandler {
			...
			get {
				NativeHandle ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("updateHandler"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("updateHandler"));
						GC.KeepAlive (this);
					}
				}
			...
			set {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setUpdateHandler:"), (IntPtr) block_ptr_value);
						GC.KeepAlive (this);
					}
				}
			}
