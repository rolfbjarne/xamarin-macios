	...
	public unsafe partial class MPSGraphTensor : MPSGraphObject, INSCopying {
		...
		public virtual MPSGraphOperation Operation {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<MPSGraphOperation> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selOperationXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<MPSGraphOperation> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selOperationXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
