...
namespace Foundation {
	...
	public unsafe static partial class NSKeyValueSorting_NSOrderedSet  {
		...
		const string selSortedArrayUsingDescriptors_X = "sortedArrayUsingDescriptors:";
		static readonly NativeHandle selSortedArrayUsingDescriptors_XHandle = Selector.GetHandle ("sortedArrayUsingDescriptors:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static NSObject[] GetSortedArray (this NSOrderedSet This, NSSortDescriptor[] sortDescriptors)
		{
			...
			NSObject[] ret;
			ret = CFArray.ArrayFromHandle<NSObject>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (This.Handle, selSortedArrayUsingDescriptors_XHandle, nsa_sortDescriptors.Handle), false)!;
			GC.KeepAlive (This);
			return ret;
		}
