...
namespace Foundation {
	...
	public unsafe partial class NSFileCoordinator : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CoordinateAccess (NSFileAccessIntent[] intents, NSOperationQueue executionQueue, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> accessor)
		{
			if (intents is null)
			...
			using var block_accessor = Trampolines.SDActionArity1V20.CreateBlock (accessor);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CoordinateRead (NSUrl itemUrl, NSFileCoordinatorReadingOptions options, out NSError error, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V45))]global::System.Action<NSUrl> worker)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			using var block_worker = Trampolines.SDActionArity1V45.CreateBlock (worker);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CoordinateWrite (NSUrl url, NSFileCoordinatorWritingOptions options, out NSError error, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V45))]global::System.Action<NSUrl> worker)
		{
