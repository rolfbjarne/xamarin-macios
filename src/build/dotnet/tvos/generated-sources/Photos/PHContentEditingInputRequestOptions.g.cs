...
namespace Photos {
	...
	public unsafe partial class PHContentEditingInputRequestOptions : NSObject {
		...
		public unsafe virtual global::System.Func<PHAdjustmentData, bool> CanHandleAdjustmentData {
			[return: DelegateProxy (typeof (ObjCRuntime.Trampolines.SDFuncArity2V5))]
			[Export ("canHandleAdjustmentData", ArgumentSemantic.Copy)]
			get {
				NativeHandle ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("canHandleAdjustmentData"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("canHandleAdjustmentData"));
						GC.KeepAlive (this);
					}
				}
				return global::ObjCRuntime.Trampolines.NIDFuncArity2V5.Create (ret)!;
			}
			[param: BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity2V5))]
			[Export ("setCanHandleAdjustmentData:", ArgumentSemantic.Copy)]
			set {
				if (value is null)
					ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (value));
				using var block_value = Trampolines.SDFuncArity2V5.CreateBlock (value);
				BlockLiteral *block_ptr_value = &block_value;
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setCanHandleAdjustmentData:"), (IntPtr) block_ptr_value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setCanHandleAdjustmentData:"), (IntPtr) block_ptr_value);
						GC.KeepAlive (this);
					}
				}
			}
