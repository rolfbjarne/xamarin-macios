...
namespace Xamarin.MacDev.Tasks.Tests {
	...
	public class ResolveNativeReferencesTaskTest {
		...
		public void Xcode12_x (string targetFrameworkMoniker, bool isSimulator, string architecture, string expected)
		{
			...
			var result = ResolveNativeReferencesBase.TryResolveXCFramework (null, plist, "N/A", targetFrameworkMoniker, isSimulator, architecture, out var frameworkPath);
		...
		[TestCase (TargetFramework.Xamarin_WatchOS_1_0_String, true, "x86_64", "")]
		...
		public void BadInfoPlist ()
		{
			...
			var result = ResolveNativeReferencesBase.TryResolveXCFramework (null, plist, "N/A", TargetFramework.DotNet_iOS_String, false, "x86_64", out var frameworkPath);
