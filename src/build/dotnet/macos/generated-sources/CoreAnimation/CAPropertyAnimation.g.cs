...
namespace CoreAnimation {
	...
	public unsafe partial class CAPropertyAnimation : CAAnimation {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetValueFunction_X = "setValueFunction:";
		static readonly NativeHandle selSetValueFunction_XHandle = Selector.GetHandle ("setValueFunction:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selValueFunctionX = "valueFunction";
		static readonly NativeHandle selValueFunctionXHandle = Selector.GetHandle ("valueFunction");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static CAPropertyAnimation FromKeyPath (string? path)
		{
			...
			ret =  Runtime.GetNSObject<CAPropertyAnimation> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selAnimationWithKeyPath_XHandle, nspath), false)!;
		...
		public virtual CAValueFunction? ValueFunction {
			...
			get {
				CAValueFunction? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<CAValueFunction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selValueFunctionXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<CAValueFunction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selValueFunctionXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetValueFunction_XHandle, value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetValueFunction_XHandle, value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
