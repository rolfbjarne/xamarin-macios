...
namespace SceneKit {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "Prepare", Selector = "prepareObjects:withCompletionHandler:", ParameterType = new Type [] { typeof (NSObject[]), typeof (global::System.Action<bool>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V2) })]
	...
	public partial interface ISCNSceneRenderer : INativeObject, IDisposable
	{
		...
		internal static SCNVector3 _ProjectPoint (ISCNSceneRenderer This, SCNVector3 point)
		{
			...
			if (global::ObjCRuntime.Runtime.IsARM64CallingConvention) {
				...
				ret = global::ObjCRuntime.Messaging.SCNVector3_objc_msgSend_stret_SCNVector3 (This.Handle, Selector.GetHandle ("projectPoint:"), point);
				GC.KeepAlive (This);
			}
			return ret!;
		}
		...
		internal static SCNVector3 _UnprojectPoint (ISCNSceneRenderer This, SCNVector3 point)
		{
			...
			if (global::ObjCRuntime.Runtime.IsARM64CallingConvention) {
				...
				ret = global::ObjCRuntime.Messaging.SCNVector3_objc_msgSend_stret_SCNVector3 (This.Handle, Selector.GetHandle ("unprojectPoint:"), point);
				GC.KeepAlive (This);
			}
			return ret!;
		}
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _Prepare (ISCNSceneRenderer This, NSObject[] objects, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V2))]global::System.Action<bool>? completionHandler)
		{
			if (objects is null)
		...
		[DynamicDependencyAttribute ("CurrentTime")]
		...
		public virtual double CurrentTime {
			...
			set {
				_SetCurrentTime (this, value);
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static double _GetCurrentTime (ISCNSceneRenderer This)
		{
			double ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetCurrentTime (ISCNSceneRenderer This, double value)
		{
	...
	internal unsafe sealed class SCNSceneRendererWrapper : BaseWrapper, ISCNSceneRenderer {
		...
		[Export ("prepareObjects:withCompletionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void Prepare (NSObject[] objects, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V2))]global::System.Action<bool>? completionHandler)
		{
			if (objects is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (objects));
			using var nsa_objects = NSArray.FromNSObjects (objects);
...
namespace SceneKit {
	/// <summary>Implementation class of the <see cref="T:SceneKit.ISCNSceneRenderer" /> interface.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/SceneKit/Reference/SCNSceneRenderer_Protocol/index.html">Apple documentation for <c>SCNSceneRenderer</c></related>
	[Protocol()]
	[Register("Microsoft_macOS__SceneKit_SCNSceneRenderer", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
