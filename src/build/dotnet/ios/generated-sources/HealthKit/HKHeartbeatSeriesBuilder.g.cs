...
namespace HealthKit {
	...
	public unsafe partial class HKHeartbeatSeriesBuilder : HKSeriesBuilder {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void FinishSeries ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V111))]global::System.Action<HKHeartbeatSeriesSample, NSError> completion)
		{
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
