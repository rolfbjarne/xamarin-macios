...
namespace AVFoundation {
	...
	static public partial class AVAssetPlaybackConfigurationOptionExtensions {
		...
		[SupportedOSPlatform ("macos26.0")]
		[UnsupportedOSPlatform ("ios")]
		[Field ("AVAssetPlaybackConfigurationOptionAppleImmersiveVideo", "AVFoundation")]
		internal unsafe static IntPtr AVAssetPlaybackConfigurationOptionAppleImmersiveVideo {
			get {
				fixed (IntPtr *storage = &values [4])
					return Dlfcn.CachePointer (Libraries.AVFoundation.Handle, "AVAssetPlaybackConfigurationOptionAppleImmersiveVideo", storage);
			}
		}
		...
		public static NSString? GetConstant (this AVAssetPlaybackConfigurationOption self)
		{
			...
			case 3: // AVAssetPlaybackConfigurationOption.NonRectilinearProjection
				...
				break;
			case 4: // AVAssetPlaybackConfigurationOption.AppleImmersiveVideo
				ptr = AVAssetPlaybackConfigurationOptionAppleImmersiveVideo;
				break;
			}
		...
		public static AVAssetPlaybackConfigurationOption GetValue (NSString constant)
		{
			...
			if (constant.IsEqualTo (AVAssetPlaybackConfigurationOptionAppleImmersiveVideo))
				return AVAssetPlaybackConfigurationOption.AppleImmersiveVideo;
