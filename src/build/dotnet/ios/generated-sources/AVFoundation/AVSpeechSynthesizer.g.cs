...
namespace AVFoundation {
	...
	public unsafe partial class AVSpeechSynthesizer : NSObject {
		...
		public virtual bool ContinueSpeaking ()
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("continueSpeaking"));
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("continueSpeaking"));
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public virtual bool PauseSpeaking (AVSpeechBoundary boundary)
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("pauseSpeakingAtBoundary:"), (IntPtr) (long) boundary);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("pauseSpeakingAtBoundary:"), (IntPtr) (long) boundary);
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public unsafe static void RequestPersonalVoiceAuthorization ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAVSpeechSynthesizerRequestPersonalVoiceAuthorizationCallback))]AVSpeechSynthesizerRequestPersonalVoiceAuthorizationCallback handler)
		{
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("requestPersonalVoiceAuthorizationWithCompletionHandler:"), (IntPtr) block_ptr_handler);
		}
		[SupportedOSPlatform ("tvos17.0")]
		[SupportedOSPlatform ("macos14.0")]
		[SupportedOSPlatform ("ios17.0")]
		...
		public virtual void SpeakUtterance (AVSpeechUtterance utterance)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("speakUtterance:"), utterance__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("speakUtterance:"), utterance__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual bool StopSpeaking (AVSpeechBoundary boundary)
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("stopSpeakingAtBoundary:"), (IntPtr) (long) boundary);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("stopSpeakingAtBoundary:"), (IntPtr) (long) boundary);
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void WriteUtterance (AVSpeechUtterance utterance, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V13))]global::System.Action<AVAudioBuffer> bufferCallback)
		{
			var utterance__handle__ = utterance!.GetNonNullHandle (nameof (utterance));
			if (bufferCallback is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (bufferCallback));
			using var block_bufferCallback = Trampolines.SDActionArity1V13.CreateBlock (bufferCallback);
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("writeUtterance:toBufferCallback:"), utterance__handle__, (IntPtr) block_ptr_bufferCallback);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (utterance);
		...
		public unsafe virtual void WriteUtterance (AVSpeechUtterance utterance, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAVSpeechSynthesizerBufferCallback))]AVSpeechSynthesizerBufferCallback bufferCallback, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAVSpeechSynthesizerMarkerCallback))]AVSpeechSynthesizerMarkerCallback markerCallback)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("writeUtterance:toBufferCallback:toMarkerCallback:"), utterance__handle__, (IntPtr) block_ptr_bufferCallback, (IntPtr) block_ptr_markerCallback);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (utterance);
		...
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("maccatalyst")]
		public virtual bool MixToTelephonyUplink {
			[Export ("mixToTelephonyUplink")]
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("mixToTelephonyUplink"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("mixToTelephonyUplink"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
			}
			[Export ("setMixToTelephonyUplink:")]
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_bool (this.Handle, Selector.GetHandle ("setMixToTelephonyUplink:"), value ? (byte) 1 : (byte) 0);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, Selector.GetHandle ("setMixToTelephonyUplink:"), value ? (byte) 1 : (byte) 0);
						GC.KeepAlive (this);
					}
				}
			}
		...
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("tvos")]
		public virtual AVAudioSessionChannelDescription[]? OutputChannels {
			[Export ("outputChannels", ArgumentSemantic.Retain)]
			get {
				AVAudioSessionChannelDescription[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<AVAudioSessionChannelDescription>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("outputChannels")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<AVAudioSessionChannelDescription>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("outputChannels")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			}
			[Export ("setOutputChannels:", ArgumentSemantic.Retain)]
			set {
				using var nsa_value = value is null ? null : NSArray.FromNSObjects (value);
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setOutputChannels:"), nsa_value.GetHandle ());
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setOutputChannels:"), nsa_value.GetHandle ());
						GC.KeepAlive (this);
					}
				}
			}
		...
		public static AVSpeechSynthesisPersonalVoiceAuthorizationStatus PersonalVoiceAuthorizationStatus {
			...
			get {
				...
				ret = (AVSpeechSynthesisPersonalVoiceAuthorizationStatus) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("personalVoiceAuthorizationStatus"));
				return ret!;
			}
		}
		...
		public virtual bool Speaking {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("isSpeaking"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isSpeaking"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
