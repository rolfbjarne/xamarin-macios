...
namespace Contacts {
	...
	public unsafe partial class CNPostalAddressFormatter : NSFormatter {
		...
		const string selAttributedStringFromPostalAddress_Style_WithDefaultAttributes_X = "attributedStringFromPostalAddress:style:withDefaultAttributes:";
		static readonly NativeHandle selAttributedStringFromPostalAddress_Style_WithDefaultAttributes_XHandle = Selector.GetHandle ("attributedStringFromPostalAddress:style:withDefaultAttributes:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAttributedStringFromPostalAddress_WithDefaultAttributes_X = "attributedStringFromPostalAddress:withDefaultAttributes:";
		static readonly NativeHandle selAttributedStringFromPostalAddress_WithDefaultAttributes_XHandle = Selector.GetHandle ("attributedStringFromPostalAddress:withDefaultAttributes:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetStyle_X = "setStyle:";
		static readonly NativeHandle selSetStyle_XHandle = Selector.GetHandle ("setStyle:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selStringFromPostalAddress_X = "stringFromPostalAddress:";
		static readonly NativeHandle selStringFromPostalAddress_XHandle = Selector.GetHandle ("stringFromPostalAddress:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selStringFromPostalAddress_Style_X = "stringFromPostalAddress:style:";
		static readonly NativeHandle selStringFromPostalAddress_Style_XHandle = Selector.GetHandle ("stringFromPostalAddress:style:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static NSAttributedString GetAttributedStringFrom (CNPostalAddress postalAddress, CNPostalAddressFormatterStyle style, NSDictionary attributes)
		{
			...
			ret =  Runtime.GetNSObject<NSAttributedString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_IntPtr_NativeHandle (class_ptr, selAttributedStringFromPostalAddress_Style_WithDefaultAttributes_XHandle, postalAddress__handle__, (IntPtr) (long) style, attributes__handle__), false)!;
		...
		public virtual NSAttributedString GetAttributedStringFromPostalAddress (CNPostalAddress postalAddress, NSDictionary attributes)
		{
			...
			NSAttributedString? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSAttributedString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selAttributedStringFromPostalAddress_WithDefaultAttributes_XHandle, postalAddress__handle__, attributes__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSAttributedString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selAttributedStringFromPostalAddress_WithDefaultAttributes_XHandle, postalAddress__handle__, attributes__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (postalAddress);
		...
		public static string GetStringFrom (CNPostalAddress postalAddress, CNPostalAddressFormatterStyle style)
		{
			var postalAddress__handle__ = postalAddress!.GetNonNullHandle (nameof (postalAddress));
			string? ret;
			ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_IntPtr (class_ptr, selStringFromPostalAddress_Style_XHandle, postalAddress__handle__, (IntPtr) (long) style), false)!;
			GC.KeepAlive (postalAddress);
			return ret!;
		}
		...
		public virtual string GetStringFromPostalAddress (CNPostalAddress postalAddress)
		{
			...
			string? ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selStringFromPostalAddress_XHandle, postalAddress__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selStringFromPostalAddress_XHandle, postalAddress__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (postalAddress);
		...
		public virtual CNPostalAddressFormatterStyle Style {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (CNPostalAddressFormatterStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selStyleXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (CNPostalAddressFormatterStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selStyleXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
