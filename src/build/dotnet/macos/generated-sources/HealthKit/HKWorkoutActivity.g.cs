...
namespace HealthKit {
	...
	public unsafe partial class HKWorkoutActivity : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithWorkoutConfiguration_StartDate_EndDate_Metadata_X = "initWithWorkoutConfiguration:startDate:endDate:metadata:";
		static readonly NativeHandle selInitWithWorkoutConfiguration_StartDate_EndDate_Metadata_XHandle = Selector.GetHandle ("initWithWorkoutConfiguration:startDate:endDate:metadata:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selInitWithWorkoutConfiguration_StartDate_EndDate_Metadata_XHandle, workoutConfiguration__handle__, startDate__handle__, endDate__handle__, metadata__handle__), "initWithWorkoutConfiguration:startDate:endDate:metadata:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selInitWithWorkoutConfiguration_StartDate_EndDate_Metadata_XHandle, workoutConfiguration__handle__, startDate__handle__, endDate__handle__, metadata__handle__), "initWithWorkoutConfiguration:startDate:endDate:metadata:");
					GC.KeepAlive (this);
				}
			}
