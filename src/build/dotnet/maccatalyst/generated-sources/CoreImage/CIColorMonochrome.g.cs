...
#nullable enable
namespace CoreImage {
	/// <summary>The CIColorMonochrome CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/ColorMonochrome.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIColorMonochrome : CIFilter, ICIColorMonochromeProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorMonochrome" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIColorMonochrome () : base ("CIColorMonochrome")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorMonochrome (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorMonochrome (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorMonochrome (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIColorMonochromeProtocol protocol members 
