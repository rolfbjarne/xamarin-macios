...
namespace FileProvider {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "FetchThumbnails", Selector = "fetchThumbnailsForItemIdentifiers:requestedSize:perThumbnailCompletionHandler:completionHandler:", ReturnType = typeof (NSProgress), ParameterType = new Type [] { typeof (String[]), typeof (CGSize), typeof (NSFileProviderPerThumbnailCompletionHandler), typeof (global::System.Action<NSError>) }, ParameterByRef = new bool [] { false, false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDNSFileProviderPerThumbnailCompletionHandler), typeof (ObjCRuntime.Trampolines.NIDActionArity1V0) })]
