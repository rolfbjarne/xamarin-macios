...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITileFilter" /> that applies four translations to the source image.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/fourfold_translated_tile.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIFourfoldTranslatedTile : CITileFilter, ICIFourfoldTranslatedTileProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIFourfoldTranslatedTile" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIFourfoldTranslatedTile (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIFourfoldTranslatedTile (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIFourfoldTranslatedTile (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIFourfoldTranslatedTileProtocol protocol members 
