...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIBloom</c>.</summary>
	/// <remarks>
	...
	[Protocol (Name = "CIBloom", WrapperType = typeof (CIBloomProtocolWrapper))]
		...
		CoreImage.ICIFilterProtocol
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIBloomProtocolWrapper))]
	...
	internal unsafe sealed class CIBloomProtocolWrapper : BaseWrapper, ICIBloomProtocol {
		public CIBloomProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIBloomProtocolWrapper))]
		static CIBloomProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets or sets an image to filter.</summary>
