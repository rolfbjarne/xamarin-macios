...
namespace ARKit {
	#nullable enable
	public delegate void ARSessionCaptureHighResolutionFrame (ARKit.ARFrame? frame, NSError? error);
	public delegate void GetGeolocationCallback (CLLocationCoordinate2D coordinate, double altitude, NSError? error);
}
...
namespace AccessorySetupKit {
	#nullable enable
	public delegate void ASAccessorySessionCompletionHandler (NSError? error);
	public delegate void ASAccessorySessionFinishPickerDiscoveryHandler (NSError? error);
	public delegate void ASAccessorySessionUpdateAuthorizationHandler (NSError? error);
	public delegate void ASAccessorySessionUpdatePickerHandler (NSError? error);
}
namespace Accounts {
	#nullable enable
...
namespace BrowserEngineKit {
	#nullable enable
	public delegate void BEDownloadMonitorBeginMonitoringCallback (BrowserEngineKit.BEDownloadMonitorLocation? placeholderLocation, NSError? error);
	public delegate void BEDownloadMonitorResumeMonitoringCallback (NSError? error);
	public delegate void BEDownloadMonitorUseDownloadsFolderCallback (BrowserEngineKit.BEDownloadMonitorLocation? finalLocation);
	public delegate bool BEDragInteractionDelegateGetDragItemsCallback (UIDragItem[] items);
	public delegate void BELayerHierarchyHandleEncodeCallback (uint copiedPort, NSData data);
	public delegate void BELayerHierarchyHostingTransactionCoordinatorEncodeCallback (uint copiedPort, NSData data);
	...
	public delegate void BEWebContentFilterAllowUrlCallback (bool allowed, NSError? error);
	public delegate void BEWebContentFilterEvaluateUrlCallback (bool allowed, NSData? data);
	public delegate void BEWebContentProcessCreateCallback (BrowserEngineKit.BEWebContentProcess? proces, NSError? error);
}
namespace CarPlay {
	#nullable enable
	public delegate void CPBarButtonHandler (CarPlay.CPBarButton button);
	public delegate void CPListImageRowItemHandler (CarPlay.CPListImageRowItem item, IntPtr index, [BlockCallback] Action completionBlock);
	public delegate void CPMapTemplateDidRequestToInsertWaypointHandler (CarPlay.CPTravelEstimates travelEstimates);
	public delegate void CPSearchTemplateDelegateUpdateHandler (CarPlay.CPListItem[] searchResults);
	public delegate void CPSelectableListItemHandler (CarPlay.ICPSelectableListItem item, [BlockCallback] Action completionBlock);
}
namespace Cinematic {
	#nullable enable
...
namespace CoreTelephony {
	#nullable enable
	public delegate void CTCellularPlanProvisioningAddPlanCompletionHandler (CoreTelephony.CTCellularPlanProvisioningAddPlanResult result);
...
namespace CryptoTokenKit {
	#nullable enable
	public delegate void TKCreateNfcSlotCallback (CryptoTokenKit.TKSmartCardSlotNFCSession? session, NSError? error);
...
namespace NetworkExtension {
	...
	public delegate void NEHotspotConfigurationManagerJoinHotspotCallback (NSError? error);
...
namespace SafariServices {
	#nullable enable
	public delegate void SFAddToHomeScreenActivityItemGetHomeScreenWebAppInfoCallback (SafariServices.SFAddToHomeScreenInfo? appManifest);
	public delegate void SFAddToHomeScreenActivityItemGetWebAppManifestCallback (BrowserEngineKit.BEWebAppManifest? appManifest);
	...
	public delegate void SFSafariSettingsOpenExportBrowsingDataSettingsCompletionHandler (NSError? error);
	public delegate void SFSafariSettingsOpenExtensionsSettingsCompletionHandler (NSError? error);
}
namespace SafetyKit {
	#nullable enable
...
namespace SensitiveContentAnalysis {
	#nullable enable
	public delegate void SCVideoStreamAnalysisChangeHandler (SensitiveContentAnalysis.SCSensitivityAnalysis? analysis, NSError? error);
}
...
namespace UIKit {
	...
	public delegate void UICloudSharingControllerPreparationCompletionHandler (CloudKit.CKShare? share, CloudKit.CKContainer? container, NSError? error);
...
namespace WatchConnectivity {
	#nullable enable
	/// <summary>The reply handler for use with <see cref="M:WatchConnectivity.WCSessionDelegate.DidReceiveMessageData(WatchConnectivity.WCSession,Foundation.NSData)" />.</summary>
	...
	public delegate void WCSessionReplyHandler (global::Foundation.NSDictionary<NSString, NSObject> replyMessage);
}
namespace WebKit {
	#nullable enable
