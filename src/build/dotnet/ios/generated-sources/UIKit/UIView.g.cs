...
namespace UIKit {
	...
	public unsafe partial class UIView : UIResponder, INSCoding, IUIAccessibilityIdentification, IUIAppearance, IUIAppearanceContainer, IUICoordinateSpace, IUIDynamicItem, IUIFocusEnvironment, IUIFocusItem, IUIFocusItemContainer, IUILargeContentViewerItem, IUIPopoverPresentationControllerSourceItem, IUITraitChangeObservable, IUITraitEnvironment, global::CoreAnimation.ICALayerDelegate {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void Animate (double duration, nfloat bounce, nfloat velocity, double delay, UIViewAnimationOptions options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAction))]global::System.Action animations, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V4))]global::System.Action<bool>? completion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (animations is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (animations));
