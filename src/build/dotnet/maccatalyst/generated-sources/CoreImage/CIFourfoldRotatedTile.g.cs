...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITileFilter" /> that rotates the source image in 90-degree increments.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/fourfold_rotated_tile.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIFourfoldRotatedTile : CITileFilter, ICIFourfoldRotatedTileProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIFourfoldRotatedTile" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIFourfoldRotatedTile (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIFourfoldRotatedTile (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIFourfoldRotatedTile (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIFourfoldRotatedTileProtocol protocol members 
