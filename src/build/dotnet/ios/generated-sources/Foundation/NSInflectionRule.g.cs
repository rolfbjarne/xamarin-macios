	...
	public unsafe partial class NSInflectionRule : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		public static NSInflectionRule AutomaticRule {
			...
			get {
				...
				ret =  Runtime.GetNSObject<NSInflectionRule> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("automaticRule")), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static bool CanInflectPreferredLocalization {
			...
			get {
				byte ret;
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (class_ptr, Selector.GetHandle ("canInflectPreferredLocalization"));
				return ret != 0;
			}
		}
