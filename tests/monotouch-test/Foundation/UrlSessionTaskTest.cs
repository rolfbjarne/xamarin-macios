	...
	public class UrlSessionTaskTest {
		...
		public void NSUrlSessionDownloadTaskTest ()
		{
			...
			using (var ur = new NSUrlRequest ()) {
				...
				Asserts.IsInstanceOfType (typeof (NSUrlSessionDownloadTask), task, "task should be an instance of NSUrlSessionDownloadTask");
			}
			...
			using (var ur = new NSUrlRequest ()) {
				...
				Asserts.IsInstanceOfType (typeof (NSUrlSessionDownloadTask), task, "task should be an instance of NSUrlSessionDownloadTask 2");
			}
			...
			using (var ur = new NSUrl (NetworkResources.MicrosoftUrl)) {
				...
				Asserts.IsInstanceOfType (typeof (NSUrlSessionDownloadTask), task, "task should be an instance of NSUrlSessionDownloadTask 3");
			}
			...
			using (var ur = new NSUrl (NetworkResources.MicrosoftUrl)) {
				...
				Asserts.IsInstanceOfType (typeof (NSUrlSessionDownloadTask), task, "task should be an instance of NSUrlSessionDownloadTask 4");
			}
		}
		...
		public void NSUrlSessionDataTaskTest ()
		{
			...
			using (var ur = new NSUrlRequest ()) {
				...
				Assert.IsNotNull (task, "task should not be null");
				Asserts.IsInstanceOfType (typeof (NSUrlSessionDataTask), task, "task should be an instance of NSUrlSessionDataTask");
			}
			...
			using (var ur = new NSUrlRequest ()) {
				...
				Assert.IsNotNull (task, "task should not be null 2");
				Asserts.IsInstanceOfType (typeof (NSUrlSessionDataTask), task, "task should be an instance of NSUrlSessionDataTask 2");
			}
			...
			using (var ur = new NSUrl (NetworkResources.MicrosoftUrl)) {
				...
				Assert.IsNotNull (task, "task should not be null 3");
				Asserts.IsInstanceOfType (typeof (NSUrlSessionDataTask), task, "task should be an instance of NSUrlSessionDataTask 3");
			}
			...
			using (var ur = new NSUrl (NetworkResources.MicrosoftUrl)) {
				...
				Assert.IsNotNull (task, "task should not be null 4");
				Asserts.IsInstanceOfType (typeof (NSUrlSessionDataTask), task, "task should be an instance of NSUrlSessionDataTask 4");
			}
		}
		...
		public void NSUrlSessionUploadTaskTest ()
		{
			...
			using (var ur = new NSUrlRequest ()) {
				...
				Assert.IsNotNull (task, "task should not be null");
				Asserts.IsInstanceOfType (typeof (NSUrlSessionUploadTask), task, "task should be an instance of NSUrlSessionUploadTask");
			}
			...
			using (var ur = new NSUrlRequest ()) {
				...
				Assert.IsNotNull (task, "task should not be null 2");
				Asserts.IsInstanceOfType (typeof (NSUrlSessionUploadTask), task, "task should be an instance of NSUrlSessionUploadTask 2");
			}
			...
			using (var url = new NSUrl (NetworkResources.MicrosoftUrl)) {
				...
				Assert.IsNotNull (task, "task should not be null 3");
				Asserts.IsInstanceOfType (typeof (NSUrlSessionUploadTask), task, "task should be an instance of NSUrlSessionUploadTask 3");
			}
			...
			using (var url = new NSUrl (NetworkResources.MicrosoftUrl)) {
				...
				Assert.IsNotNull (task, "task should not be null 4");
				Asserts.IsInstanceOfType (typeof (NSUrlSessionUploadTask), task, "task should be an instance of NSUrlSessionUploadTask 4");
			}
			...
			using (var data = NSData.FromString ("Hola")) {
				...
				Asserts.IsInstanceOfType (typeof (NSUrlSessionUploadTask), task, "task should be an instance of NSUrlSessionUploadTask 5");
			}
		}
	}
}