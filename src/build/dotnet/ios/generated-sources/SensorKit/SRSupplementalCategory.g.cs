	...
	public unsafe partial class SRSupplementalCategory : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		public virtual global::SensorKit.SRDeviceUsageCategory Identifier {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = global::SensorKit.SRDeviceUsageCategoryExtensions.GetValue (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("identifier")));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::SensorKit.SRDeviceUsageCategoryExtensions.GetValue (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("identifier")));
						GC.KeepAlive (this);
					}
				}
				return ret!;
