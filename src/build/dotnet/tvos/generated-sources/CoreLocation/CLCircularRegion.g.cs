...
namespace CoreLocation {
	...
	public unsafe partial class CLCircularRegion : CLRegion {
		...
		/// <summary>Creates a new <see cref="CLCircularRegion" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public CLCircularRegion () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_CLLocationCoordinate2D_Double_NativeHandle (this.Handle, Selector.GetHandle ("initWithCenter:radius:identifier:"), center, radius, nsidentifier), "initWithCenter:radius:identifier:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_CLLocationCoordinate2D_Double_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithCenter:radius:identifier:"), center, radius, nsidentifier), "initWithCenter:radius:identifier:");
					GC.KeepAlive (this);
				}
			}
