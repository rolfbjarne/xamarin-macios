...
namespace MonoTouchFixtures.CoreGraphics {
	...
	public class CGBitmapParametersTest {
		...
		public void DefaultValuesTest ()
		{
			...
			Assert.AreEqual (0u, p.Width, "Width");
			Assert.AreEqual (0u, p.Height, "Height");
			Assert.AreEqual (0u, p.BytesPerPixel, "BytesPerPixel");
			Assert.AreEqual (0u, p.AlignedBytesPerRow, "AlignedBytesPerRow");
		...
		public void PropertySetGetTest ()
		{
			...
			Assert.AreEqual (123u, p.Width, "Width");
			Assert.AreEqual (456u, p.Height, "Height");
			Assert.AreEqual (4u, p.BytesPerPixel, "BytesPerPixel");
			Assert.AreEqual (512u, p.AlignedBytesPerRow, "AlignedBytesPerRow");
