...
namespace SpriteKit {
	...
	public unsafe partial class SKReferenceNode : SKNode {
		...
		public virtual void DidLoadReferenceNode (SKNode? node)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("didLoadReferenceNode:"), node__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("didLoadReferenceNode:"), node__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (node);
		...
		public static SKReferenceNode FromFile (string fileName)
		{
			...
			var nsfileName = CFString.CreateNative (fileName);
			SKReferenceNode? ret;
			ret =  Runtime.GetNSObject<SKReferenceNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("referenceNodeWithFileNamed:"), nsfileName), false)!;
			CFString.ReleaseNative (nsfileName);
			return ret!;
		}
		...
		public static SKReferenceNode FromUrl (NSUrl referenceUrl)
		{
			...
			SKReferenceNode? ret;
			ret =  Runtime.GetNSObject<SKReferenceNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("referenceNodeWithURL:"), referenceUrl__handle__), false)!;
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend (this.Handle, Selector.GetHandle ("resolveReferenceNode"));
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("resolveReferenceNode"));
					GC.KeepAlive (this);
				}
			}
		}
