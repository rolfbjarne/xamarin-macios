	...
	public unsafe partial class MLStateConstraint : NSObject, INSCoding, INSSecureCoding {
		...
		public virtual NSNumber[] BufferShape {
			...
			get {
				NSNumber[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<NSNumber>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selBufferShapeXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<NSNumber>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selBufferShapeXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
