...
#pragma warning restore
	...
	[Watch (11, 0), TV (18, 0), Mac (15, 0), iOS (18, 0), MacCatalyst (18, 0)]
	[BaseType (typeof (HKScoredAssessment))]
	[DisableDefaultCtor]
	...
	interface HKPhq9Assessment {
		...
		[Export ("assessmentWithDate:answers:")]
		NativeHandle Constructor (NSDate date, [BindAs (typeof (HKPhq9AssessmentAnswer []))] NSNumber [] answers);

		[Export ("assessmentWithDate:answers:metadata:")]
		NativeHandle Constructor (NSDate date, [BindAs (typeof (HKPhq9AssessmentAnswer []))] NSNumber [] answers, [NullAllowed] NSDictionary<NSString, NSObject> metadata);
	}
