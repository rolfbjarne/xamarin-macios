...
namespace MonoTouch.Tuner {
	...
	public class MonoTouchTypeMapStep : TypeMapStep {
		...
		void SetIsDirectBindingValue (TypeDefinition type)
		{
			...
			// optimize anything for those classes to not risk getting this wrong.
			// This means we must set the IsDirectBinding value to null for CIFilter and all its subclasses.
			// References:
