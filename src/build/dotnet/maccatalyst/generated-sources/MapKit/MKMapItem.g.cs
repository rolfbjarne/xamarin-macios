...
namespace MapKit {
	...
	public unsafe partial class MKMapItem : NSObject, INSCoding, INSItemProviderReading, INSItemProviderWriting, INSSecureCoding {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithLocation:address:"), location__handle__, address__handle__), "initWithLocation:address:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithLocation:address:"), location__handle__, address__handle__), "initWithLocation:address:");
					GC.KeepAlive (this);
				}
			}
		...
		public static MKMapItem MapItemForCurrentLocation ()
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			MKMapItem ret;
			ret =  Runtime.GetNSObject<MKMapItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("mapItemForCurrentLocation")), false)!;
			return ret;
		}
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void OpenInMaps (NSDictionary? launchOptions, global::UIKit.UIScene? fromScene, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError>? completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var launchOptions__handle__ = launchOptions.GetHandle ();
			var fromScene__handle__ = fromScene.GetHandle ();
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("openInMapsWithLaunchOptions:fromScene:completionHandler:"), launchOptions__handle__, fromScene__handle__, (IntPtr) block_ptr_completionHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("openInMapsWithLaunchOptions:fromScene:completionHandler:"), launchOptions__handle__, fromScene__handle__, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual Task OpenInMapsAsync (NSDictionary? launchOptions, global::UIKit.UIScene? fromScene)
		{
			var tcs = new TaskCompletionSource<bool> ();
			OpenInMaps(launchOptions, fromScene, (obj_) => {
				if (obj_ is not null)
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void OpenMaps (MKMapItem[] mapItems, NSDictionary? launchOptions, global::UIKit.UIScene? fromScene, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError>? completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (mapItems is null)
			...
			if (completionHandler is not null)
				block_ptr_completionHandler = &block_completionHandler;
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("openMapsWithItems:launchOptions:fromScene:completionHandler:"), nsa_mapItems.Handle, launchOptions__handle__, fromScene__handle__, (IntPtr) block_ptr_completionHandler);
			GC.KeepAlive (launchOptions);
			GC.KeepAlive (fromScene);
		}
		[SupportedOSPlatform ("ios13.2")]
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static Task OpenMapsAsync (MKMapItem[] mapItems, NSDictionary? launchOptions, global::UIKit.UIScene? fromScene)
		{
			var tcs = new TaskCompletionSource<bool> ();
			OpenMaps(mapItems, launchOptions, fromScene, (obj_) => {
				if (obj_ is not null)
					tcs.SetException (new NSErrorException(obj_));
				else
					tcs.SetResult (true);
		...
		internal virtual bool _OpenInMaps (NSDictionary? launchOptions)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("openInMapsWithLaunchOptions:"), launchOptions__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("openInMapsWithLaunchOptions:"), launchOptions__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (launchOptions);
		...
		internal static bool _OpenMaps (MKMapItem[] mapItems, NSDictionary? launchOptions)
		{
			...
			using var nsa_mapItems = NSArray.FromNSObjects (mapItems);
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("openMapsWithItems:launchOptions:"), nsa_mapItems.Handle, launchOptions__handle__);
			GC.KeepAlive (launchOptions);
			return ret != 0;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual MKAddress? Address {
			...
			get {
				...
				MKAddress? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<MKAddress> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("address")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<MKAddress> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("address")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual MKAddressRepresentations? AddressRepresentations {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<MKAddressRepresentations> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("addressRepresentations")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<MKAddressRepresentations> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("addressRepresentations")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual NSSet<MKMapItemIdentifier> AlternateIdentifiers {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSSet<MKMapItemIdentifier>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("alternateIdentifiers")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSSet<MKMapItemIdentifier>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("alternateIdentifiers")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual MKMapItemIdentifier? Identifier {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<MKMapItemIdentifier> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("identifier")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<MKMapItemIdentifier> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("identifier")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual bool IsCurrentLocation {
			...
			get {
				...
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("isCurrentLocation"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isCurrentLocation"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual string? PhoneNumber {
			...
			set {
				...
				var nsvalue = CFString.CreateNative (value);
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setPhoneNumber:"), nsvalue);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setPhoneNumber:"), nsvalue);
						GC.KeepAlive (this);
					}
				}
				CFString.ReleaseNative (nsvalue);
		...
		public virtual string? PointOfInterestCategory {
			...
			get {
				...
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("pointOfInterestCategory")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("pointOfInterestCategory")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				...
				var nsvalue = CFString.CreateNative (value);
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setPointOfInterestCategory:"), nsvalue);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setPointOfInterestCategory:"), nsvalue);
						GC.KeepAlive (this);
					}
				}
				CFString.ReleaseNative (nsvalue);
