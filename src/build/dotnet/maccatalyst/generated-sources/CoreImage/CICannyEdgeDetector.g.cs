...
namespace CoreImage {
	...
	public partial class CICannyEdgeDetector : CIFilter, ICICannyEdgeDetectorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CICannyEdgeDetector" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CICannyEdgeDetector () : base ("CICannyEdgeDetector")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CICannyEdgeDetector (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CICannyEdgeDetector (NSObjectFlag t) : base (t)
		{
		}
		...
		public CICannyEdgeDetector (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CICannyEdgeDetectorProtocol protocol members 
		...
		public float GaussianSigma {
			...
			get {
				return GetFloat ("inputGaussianSigma");
			}
			[Export ("setGaussianSigma:")]
			set {
				SetFloat ("inputGaussianSigma", value);
			}
		}
		[SupportedOSPlatform ("ios17.0")]
		[SupportedOSPlatform ("macos14.0")]
		...
		public float ThresholdHigh {
			...
			get {
				return GetFloat ("inputThresholdHigh");
			}
			[Export ("setThresholdHigh:")]
			set {
				SetFloat ("inputThresholdHigh", value);
			}
		}
		[SupportedOSPlatform ("ios17.0")]
		[SupportedOSPlatform ("macos14.0")]
		...
		public float ThresholdLow {
			[Export ("thresholdLow")]
			get {
				return GetFloat ("inputThresholdLow");
			}
			[Export ("setThresholdLow:")]
			set {
				SetFloat ("inputThresholdLow", value);
			}
		}
		[SupportedOSPlatform ("ios17.0")]
		[SupportedOSPlatform ("macos14.0")]
		...
		[SupportedOSPlatform ("maccatalyst17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public IntPtr HysteresisPasses {
			[Export ("hysteresisPasses")]
			get {
				return GetNInt ("inputHysteresisPasses");
			}
			[Export ("setHysteresisPasses:")]
			set {
				SetNInt ("inputHysteresisPasses", value);
			}
		}
