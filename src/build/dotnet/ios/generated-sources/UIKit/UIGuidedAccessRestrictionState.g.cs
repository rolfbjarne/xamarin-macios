...
#nullable enable
namespace UIKit {
	/// <summary>An enumeration whose values specify whether a Guided Access restriction is in an allow or deny state.</summary><remarks></remarks><altmember cref="UIKit.UIGuidedAccessRestriction.GetState" />
