...
namespace Metal {
	...
	public partial interface IMTLLibrary : INativeObject, IDisposable
	{
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CreateFunction (string name, MTLFunctionConstantValues constantValues, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V115))]global::System.Action<IMTLFunction, NSError> completionHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[SupportedOSPlatform ("maccatalyst")]
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _CreateFunction (IMTLLibrary This, string name, MTLFunctionConstantValues constantValues, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V115))]global::System.Action<IMTLFunction, NSError> completionHandler)
		{
			if (name is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (name));
			var constantValues__handle__ = constantValues!.GetNonNullHandle (nameof (constantValues));
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CreateFunction (MTLFunctionDescriptor descriptor, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V115))]global::System.Action<IMTLFunction, NSError> completionHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[SupportedOSPlatform ("ios14.0")]
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _CreateFunction (IMTLLibrary This, MTLFunctionDescriptor descriptor, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V115))]global::System.Action<IMTLFunction, NSError> completionHandler)
		{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CreateIntersectionFunction (MTLIntersectionFunctionDescriptor descriptor, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V115))]global::System.Action<IMTLFunction, NSError> completionHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[SupportedOSPlatform ("ios14.0")]
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _CreateIntersectionFunction (IMTLLibrary This, MTLIntersectionFunctionDescriptor descriptor, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V115))]global::System.Action<IMTLFunction, NSError> completionHandler)
		{
			var descriptor__handle__ = descriptor!.GetNonNullHandle (nameof (descriptor));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
	...
	public unsafe static partial class MTLLibrary_Extensions {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void CreateIntersectionFunction (this IMTLLibrary This, MTLIntersectionFunctionDescriptor descriptor, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V115))]global::System.Action<IMTLFunction, NSError> completionHandler)
		{
			var descriptor__handle__ = descriptor!.GetNonNullHandle (nameof (descriptor));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
