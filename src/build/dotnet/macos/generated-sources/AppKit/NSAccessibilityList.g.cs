...
namespace AppKit {
	...
	/// <summary>This interface represents the Objective-C protocol <c>NSAccessibilityList</c>.</summary>
	/// <remarks>
	...
	public partial interface INSAccessibilityList : INativeObject, IDisposable, 
		AppKit.INSAccessibilityElementProtocol
		, AppKit.INSAccessibilityGroup
		, AppKit.INSAccessibilityTable
	{
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSAccessibilityListWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static INSAccessibilityList ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class NSAccessibilityListWrapper : BaseWrapper, INSAccessibilityList {
		public NSAccessibilityListWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSAccessibilityListWrapper))]
		static NSAccessibilityListWrapper ()
		{
			GC.KeepAlive (null);
		}
