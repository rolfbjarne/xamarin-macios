...
namespace AppKit {
	...
	/// <summary>This interface represents the Objective-C protocol <c>NSAccessibilityImage</c>.</summary>
	/// <remarks>
	...
	public partial interface INSAccessibilityImage : INativeObject, IDisposable, 
		AppKit.INSAccessibilityElementProtocol
	{
		[DynamicDependencyAttribute ("AccessibilityLabel")]
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSAccessibilityImageWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static INSAccessibilityImage ()
		{
			GC.KeepAlive (null);
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static string _GetAccessibilityLabel (INSAccessibilityImage This)
		{
	...
	internal unsafe sealed class NSAccessibilityImageWrapper : BaseWrapper, INSAccessibilityImage {
		public NSAccessibilityImageWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSAccessibilityImageWrapper))]
		static NSAccessibilityImageWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>To be added.</summary><value>To be added.</value><remarks>To be added.</remarks>
