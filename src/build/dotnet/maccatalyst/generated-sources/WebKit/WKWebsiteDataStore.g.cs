...
namespace WebKit {
	...
	public unsafe partial class WKWebsiteDataStore : NSObject, INSCoding, INSSecureCoding {
		...
		[SupportedOSPlatform ("maccatalyst17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void FetchAllDataStoreIdentifiers ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V276))]global::System.Action<NSArray<NSUuid>> completionHandler)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void FetchDataRecordsOfTypes (NSSet<NSString> dataTypes, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V277))]global::System.Action<NSArray> completionHandler)
		{
			var dataTypes__handle__ = dataTypes!.GetNonNullHandle (nameof (dataTypes));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
		...
		[SupportedOSPlatform ("maccatalyst17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void Remove (NSUuid identifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError> completionHandler)
		{
			var identifier__handle__ = identifier!.GetNonNullHandle (nameof (identifier));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
