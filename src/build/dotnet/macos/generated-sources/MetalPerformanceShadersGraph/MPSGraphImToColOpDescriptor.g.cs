...
namespace MetalPerformanceShadersGraph {
	...
	public unsafe partial class MPSGraphImToColOpDescriptor : MPSGraphObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDescriptorWithKernelWidth_KernelHeight_StrideInX_StrideInY_DilationRateInX_DilationRateInY_DataLayout_X = "descriptorWithKernelWidth:kernelHeight:strideInX:strideInY:dilationRateInX:dilationRateInY:dataLayout:";
		static readonly NativeHandle selDescriptorWithKernelWidth_KernelHeight_StrideInX_StrideInY_DilationRateInX_DilationRateInY_DataLayout_XHandle = Selector.GetHandle ("descriptorWithKernelWidth:kernelHeight:strideInX:strideInY:dilationRateInX:dilationRateInY:dataLayout:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDescriptorWithKernelWidth_KernelHeight_StrideInX_StrideInY_DilationRateInX_DilationRateInY_PaddingLeft_PaddingRight_PaddingTop_PaddingBottom_DataLayout_X = "descriptorWithKernelWidth:kernelHeight:strideInX:strideInY:dilationRateInX:dilationRateInY:paddingLeft:paddingRight:paddingTop:paddingBottom:dataLayout:";
		static readonly NativeHandle selDescriptorWithKernelWidth_KernelHeight_StrideInX_StrideInY_DilationRateInX_DilationRateInY_PaddingLeft_PaddingRight_PaddingTop_PaddingBottom_DataLayout_XHandle = Selector.GetHandle ("descriptorWithKernelWidth:kernelHeight:strideInX:strideInY:dilationRateInX:dilationRateInY:paddingLeft:paddingRight:paddingTop:paddingBottom:dataLayout:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MPSGraphImToColOpDescriptor? Create (nuint kernelWidth, nuint kernelHeight, nuint strideInX, nuint strideInY, nuint dilationRateInX, nuint dilationRateInY, nuint paddingLeft, nuint paddingRight, nuint paddingTop, nuint paddingBottom, MPSGraphTensorNamedDataLayout dataLayout)
		{
			...
			ret =  Runtime.GetNSObject<MPSGraphImToColOpDescriptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr (class_ptr, selDescriptorWithKernelWidth_KernelHeight_StrideInX_StrideInY_DilationRateInX_DilationRateInY_PaddingLeft_PaddingRight_PaddingTop_PaddingBottom_DataLayout_XHandle, kernelWidth, kernelHeight, strideInX, strideInY, dilationRateInX, dilationRateInY, paddingLeft, paddingRight, paddingTop, paddingBottom, (UIntPtr) (ulong) dataLayout), false)!;
			return ret;
		}
		...
		{
			MPSGraphImToColOpDescriptor ret;
			ret =  Runtime.GetNSObject<MPSGraphImToColOpDescriptor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr_UIntPtr (class_ptr, selDescriptorWithKernelWidth_KernelHeight_StrideInX_StrideInY_DilationRateInX_DilationRateInY_DataLayout_XHandle, kernelWidth, kernelHeight, strideInX, strideInY, dilationRateInX, dilationRateInY, (UIntPtr) (ulong) dataLayout), false)!;
			return ret;
		}
