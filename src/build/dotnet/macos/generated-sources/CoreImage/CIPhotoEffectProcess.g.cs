...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that produces a vintage look with exagerrated cool colors.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CIPhotoEffectProcess filter with the input image
	...
	/// var output = photo_effect_process.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/photo_effect_process.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIPhotoEffectProcess : CIPhotoEffect {
		/// <summary>Creates a new <see cref="CIPhotoEffectProcess" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPhotoEffectProcess () : base ("CIPhotoEffectProcess")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPhotoEffectProcess (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPhotoEffectProcess (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPhotoEffectProcess (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
