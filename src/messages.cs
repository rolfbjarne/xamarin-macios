...
namespace Messages {
	...
	interface MSMessagesAppViewController : MSMessagesAppTranscriptPresentation {
		...
		///   <para tool="nullallowed">This parameter can be <see langword="null" />.</para>
		/// </param>
		/// <summary>Creates a new <see cref="Messages.MSMessagesAppViewController" /> with the specified nib name and bundle.</summary>
	...
	interface MSConversation {
		...
		[Async (XmlDocs = """
			<param name="sticker">The sticker to insert.</param>
		...
		[Async (XmlDocs = """
			...
			<param name="filename">An alternate filename, or <see langword="null" />.</param>
		...
		[Async (XmlDocs = """
			...
			<summary>Asynchronously sends the message.</summary>
		...
		[Async (XmlDocs = """
			<param name="sticker">The sticker to send.</param>
			<summary>Asynchronously sends the sticker.</summary>
		...
		[Async (XmlDocs = """
			...
			<summary>Asynchronously sends the text.</summary>
		...
		[Async (XmlDocs = """
			<param name="url">The file URL of the attachment to send.</param>
			<param name="filename">An alternate filename, or <see langword="null" />.</param>
			<summary>Asynchronously sends the attachment.</summary>
