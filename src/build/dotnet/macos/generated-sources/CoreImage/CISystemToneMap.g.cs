...
namespace CoreImage {
	...
	public partial class CISystemToneMap : CIFilter, ICISystemToneMapProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CISystemToneMap" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CISystemToneMap () : base ("CISystemToneMap")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISystemToneMap (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISystemToneMap (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISystemToneMap (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CISystemToneMapProtocol protocol members 
		...
		public float DisplayHeadroom {
			...
			get {
				return GetFloat ("inputDisplayHeadroom");
			}
			[Export ("setDisplayHeadroom:")]
			set {
				SetFloat ("inputDisplayHeadroom", value);
			}
		}
		[SupportedOSPlatform ("ios26.0")]
		[SupportedOSPlatform ("macos26.0")]
		...
		public NSString? WeakPreferredDynamicRange {
			...
			get {
				return Runtime.GetNSObject <NSString> (GetHandle ("inputPreferredDynamicRange"), false)!;
			}
			[Export ("setPreferredDynamicRange:", ArgumentSemantic.Retain)]
			set {
				SetValue ("inputPreferredDynamicRange", value);
			}
		}
