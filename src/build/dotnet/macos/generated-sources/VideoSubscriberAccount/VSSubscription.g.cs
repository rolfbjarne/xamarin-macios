...
namespace VideoSubscriberAccount {
	...
	[ObsoletedOSPlatform ("ios18.0", "Use the 'VSUserAccount' type instead.")]
	[ObsoletedOSPlatform ("tvos18.0", "Use the 'VSUserAccount' type instead.")]
	[ObsoletedOSPlatform ("macos15.0", "Use the 'VSUserAccount' type instead.")]
	[UnsupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class VSSubscription : NSObject {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAccessLevelX = "accessLevel";
		static readonly NativeHandle selAccessLevelXHandle = Selector.GetHandle ("accessLevel");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetAccessLevel_X = "setAccessLevel:";
		static readonly NativeHandle selSetAccessLevel_XHandle = Selector.GetHandle ("setAccessLevel:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("VSSubscription");
		...
		/// <summary>Creates a new <see cref="VSSubscription" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public VSSubscription () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected VSSubscription (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal VSSubscription (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual VSSubscriptionAccessLevel AccessLevel {
			...
			get {
				VSSubscriptionAccessLevel ret;
				if (IsDirectBinding) {
					ret = (VideoSubscriberAccount.VSSubscriptionAccessLevel) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selAccessLevelXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (VideoSubscriberAccount.VSSubscriptionAccessLevel) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selAccessLevelXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr (this.Handle, selSetAccessLevel_XHandle, (IntPtr) (long) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, selSetAccessLevel_XHandle, (IntPtr) (long) value);
						GC.KeepAlive (this);
					}
				}
			}
