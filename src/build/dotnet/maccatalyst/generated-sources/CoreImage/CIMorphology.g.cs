...
namespace CoreImage {
	...
	public abstract partial class CIMorphology : CIFilter {
		...
		protected internal CIMorphology (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMorphology (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMorphology (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIMorphology" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected  CIMorphology (string name) : base (CreateFilter (name))
		{
		}
