...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIFilter" /> that increases the contrast of edges in the image.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/unsharp_mask.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIUnsharpMask : CIFilter, ICIUnsharpMaskProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIUnsharpMask" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIUnsharpMask (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIUnsharpMask (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIUnsharpMask (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIUnsharpMaskProtocol protocol members 
		...
		/// <summary>Gets or sets the radius of the smallest feature to detect.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public float Radius {
			[Export ("radius")]
			get {
		...
		/// <summary>Gets or sets the intensity of the enhanced contrast.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
