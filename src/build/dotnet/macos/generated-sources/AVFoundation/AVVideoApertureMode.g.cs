...
namespace AVFoundation {
	...
	public enum AVVideoApertureMode : int {
	...
	/// <summary>Extension methods for the <see cref="global::AVFoundation.AVVideoApertureMode" /> enumeration.</summary>
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	static public partial class AVVideoApertureModeExtensions {
		...
		public static NSString? GetConstant (this AVVideoApertureMode self)
		{
			...
			switch ((int) self) {
			case 0: // AVVideoApertureMode.CleanAperture
				ptr = AVVideoApertureModeCleanAperture;
				break;
			case 1: // AVVideoApertureMode.ProductionAperture
				ptr = AVVideoApertureModeProductionAperture;
				break;
			case 2: // AVVideoApertureMode.EncodedPixels
				ptr = AVVideoApertureModeEncodedPixels;
				break;
			}
			return (NSString?) Runtime.GetNSObject (ptr);
		}
		/// <summary>Retrieves the <see cref="global::AVFoundation.AVVideoApertureMode" /> value named by <paramref name="constant" />.</summary>
		...
		/// <summary>Retrieves the <see cref="global::AVFoundation.AVVideoApertureMode" /> value represented by the backing field value in <paramref name="handle" />.</summary>
		/// <param name="handle">The native handle with the name of the constant to retrieve.</param>
		public static AVVideoApertureMode GetValue (NativeHandle handle)
		{
		...
		/// <summary>Retrieves the <see cref="global::AVFoundation.AVVideoApertureMode" /> value represented by the backing field value in <paramref name="handle" />.</summary>
		/// <param name="handle">The native handle with the name of the constant to retrieve.</param>
		public static AVVideoApertureMode? GetNullableValue (NativeHandle handle)
		{
			using var str = Runtime.GetNSObject<NSString> (handle);
			if (str is null)
				return null;
		...
		/// <summary>Converts an array of <see cref="global::AVFoundation.AVVideoApertureMode" /> enum values into an array of their corresponding constants.</summary>
		/// <param name="values">The array of enum values to convert.</param>
		internal static NSString?[]? ToConstantArray (this AVVideoApertureMode[]? values)
		{
			if (values is null)
				return null;
		...
		internal static AVVideoApertureMode[]? ToEnumArray (this NSString[]? values)
		{
			if (values is null)
				return null;
			var rv = new global::System.Collections.Generic.List<AVVideoApertureMode> ();
			for (var i = 0; i < values.Length; i++) {
				var value = values [i];
