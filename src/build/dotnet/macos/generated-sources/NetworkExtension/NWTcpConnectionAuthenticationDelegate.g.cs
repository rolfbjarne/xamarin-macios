...
namespace NetworkExtension {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "EvaluateTrust", Selector = "evaluateTrustForConnection:peerCertificateChain:completionHandler:", ParameterType = new Type [] { typeof (NWTcpConnection), typeof (NSArray), typeof (global::System.Action<global::Security.SecTrust>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V87) })]
	public partial interface INWTcpConnectionAuthenticationDelegate : INativeObject, IDisposable
	{
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _ProvideIdentity (INWTcpConnectionAuthenticationDelegate This, NWTcpConnection connection, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V123))]global::System.Action<global::Security.SecIdentity, NSArray> completion)
		{
			var connection__handle__ = connection!.GetNonNullHandle (nameof (connection));
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void EvaluateTrust (NWTcpConnection connection, NSArray peerCertificateChain, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V87))]global::System.Action<global::Security.SecTrust> completion)
		{
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _EvaluateTrust (INWTcpConnectionAuthenticationDelegate This, NWTcpConnection connection, NSArray peerCertificateChain, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V87))]global::System.Action<global::Security.SecTrust> completion)
		{
			var connection__handle__ = connection!.GetNonNullHandle (nameof (connection));
	...
	public unsafe static partial class NWTcpConnectionAuthenticationDelegate_Extensions {
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void EvaluateTrust (this INWTcpConnectionAuthenticationDelegate This, NWTcpConnection connection, NSArray peerCertificateChain, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V87))]global::System.Action<global::Security.SecTrust> completion)
		{
			var connection__handle__ = connection!.GetNonNullHandle (nameof (connection));
			var peerCertificateChain__handle__ = peerCertificateChain!.GetNonNullHandle (nameof (peerCertificateChain));
			if (completion is null)
...
namespace NetworkExtension {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__NetworkExtension_NWTcpConnectionAuthenticationDelegate", false)]
	[Model]
	[ObsoletedOSPlatform ("ios18.0", "Use 'Security.SecProtocolOptions' instead.")]
	[ObsoletedOSPlatform ("maccatalyst18.0", "Use 'Security.SecProtocolOptions' instead.")]
	[ObsoletedOSPlatform ("macos15.0", "Use 'Security.SecProtocolOptions' instead.")]
