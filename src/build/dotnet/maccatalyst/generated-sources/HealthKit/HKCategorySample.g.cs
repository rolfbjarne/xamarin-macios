...
namespace HealthKit {
	...
	public unsafe partial class HKCategorySample : HKSample {
		...
		public static HKCategorySample FromType (HKCategoryType type, nint value, NSDate startDate, NSDate endDate)
		{
			...
			var endDate__handle__ = endDate!.GetNonNullHandle (nameof (endDate));
			HKCategorySample? ret;
			ret =  Runtime.GetNSObject<HKCategorySample> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_IntPtr_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("categorySampleWithType:value:startDate:endDate:"), type__handle__, value, startDate__handle__, endDate__handle__), false)!;
			GC.KeepAlive (type);
			GC.KeepAlive (startDate);
			GC.KeepAlive (endDate);
			return ret!;
		...
		public virtual HKCategoryType CategoryType {
			...
			get {
				HKCategoryType? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKCategoryType> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("categoryType")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKCategoryType> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("categoryType")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual nint Value {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("value"));
						GC.KeepAlive (this);
					}
				}
				return ret;
