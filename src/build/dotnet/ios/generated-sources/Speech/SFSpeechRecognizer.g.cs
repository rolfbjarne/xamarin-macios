...
namespace Speech {
	...
	public unsafe partial class SFSpeechRecognizer : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual SFSpeechRecognitionTask GetRecognitionTask (SFSpeechRecognitionRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V162))]global::System.Action<SFSpeechRecognitionResult, NSError> resultHandler)
		{
			var request__handle__ = request!.GetNonNullHandle (nameof (request));
			if (resultHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (resultHandler));
			using var block_resultHandler = Trampolines.SDActionArity2V162.CreateBlock (resultHandler);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void RequestAuthorization ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V252))]global::System.Action<SFSpeechRecognizerAuthorizationStatus> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity1V252.CreateBlock (handler);
