...
namespace Foundation {
	...
	public unsafe partial class NSIso8601DateFormatter : NSFormatter, INSCoding, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selFormatOptionsX = "formatOptions";
		static readonly NativeHandle selFormatOptionsXHandle = Selector.GetHandle ("formatOptions");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithCoder_X = "initWithCoder:";
		static readonly NativeHandle selInitWithCoder_XHandle = Selector.GetHandle ("initWithCoder:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetFormatOptions_X = "setFormatOptions:";
		static readonly NativeHandle selSetFormatOptions_XHandle = Selector.GetHandle ("setFormatOptions:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selStringFromDate_TimeZone_FormatOptions_X = "stringFromDate:timeZone:formatOptions:";
		static readonly NativeHandle selStringFromDate_TimeZone_FormatOptions_XHandle = Selector.GetHandle ("stringFromDate:timeZone:formatOptions:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static string Format (NSDate date, NSTimeZone timeZone, NSIso8601DateFormatOptions formatOptions)
		{
			...
			string? ret;
			ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_UIntPtr (class_ptr, selStringFromDate_TimeZone_FormatOptions_XHandle, date__handle__, timeZone__handle__, (UIntPtr) (ulong) formatOptions), false)!;
			GC.KeepAlive (date);
		...
		public virtual NSDate? ToDate (string @string)
		{
			...
			NSDate? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selDateFromString_XHandle, nsstring), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selDateFromString_XHandle, nsstring), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual NSIso8601DateFormatOptions FormatOptions {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (NSIso8601DateFormatOptions) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selFormatOptionsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSIso8601DateFormatOptions) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selFormatOptionsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selSetFormatOptions_XHandle, (UIntPtr) (ulong) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selSetFormatOptions_XHandle, (UIntPtr) (ulong) value);
						GC.KeepAlive (this);
					}
				}
			}
