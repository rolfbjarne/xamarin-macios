...
namespace UIKit {
	...
	public unsafe partial class UITabBarController : UIViewController, IUITabBarDelegate {
		...
		public virtual void DidBeginCustomizingItems (UITabBar tabbar, UITabBarItem[] items)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("tabBar:didBeginCustomizingItems:"), tabbar__handle__, nsa_items.Handle);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (tabbar);
		...
		public virtual void DidEndCustomizingItems (UITabBar tabbar, UITabBarItem[] items, bool changed)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_bool (&__objc_super__, Selector.GetHandle ("tabBar:didEndCustomizingItems:changed:"), tabbar__handle__, nsa_items.Handle, changed ? (byte) 1 : (byte) 0);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (tabbar);
		...
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var bottomAccessory__handle__ = bottomAccessory.GetHandle ();
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_bool (this.Handle, Selector.GetHandle ("setBottomAccessory:animated:"), bottomAccessory__handle__, animated ? (byte) 1 : (byte) 0);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_bool (&__objc_super__, Selector.GetHandle ("setBottomAccessory:animated:"), bottomAccessory__handle__, animated ? (byte) 1 : (byte) 0);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (bottomAccessory);
		}
		...
		public virtual void WillBeginCustomizingItems (UITabBar tabbar, UITabBarItem[] items)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("tabBar:willBeginCustomizingItems:"), tabbar__handle__, nsa_items.Handle);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (tabbar);
		...
		public virtual void WillEndCustomizingItems (UITabBar tabbar, UITabBarItem[] items, bool changed)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_bool (&__objc_super__, Selector.GetHandle ("tabBar:willEndCustomizingItems:changed:"), tabbar__handle__, nsa_items.Handle, changed ? (byte) 1 : (byte) 0);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (tabbar);
		...
		[SupportedOSPlatform ("ios26.0")]
		[SupportedOSPlatform ("maccatalyst26.0")]
		public virtual UITabAccessory? BottomAccessory {
			[Export ("bottomAccessory", ArgumentSemantic.Retain)]
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				UITabAccessory? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<UITabAccessory> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("bottomAccessory")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<UITabAccessory> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("bottomAccessory")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			}
			[Export ("setBottomAccessory:", ArgumentSemantic.Retain)]
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				var value__handle__ = value.GetHandle ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setBottomAccessory:"), value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setBottomAccessory:"), value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
		...
		[SupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("ios")]
		public virtual UIViewController[]? CustomizableViewControllers {
			[Export ("customizableViewControllers", ArgumentSemantic.Copy)]
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				UIViewController[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<UIViewController>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("customizableViewControllers")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<UIViewController>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("customizableViewControllers")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			}
			[Export ("setCustomizableViewControllers:", ArgumentSemantic.Copy)]
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				using var nsa_value = value is null ? null : NSArray.FromNSObjects (value);
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setCustomizableViewControllers:"), nsa_value.GetHandle ());
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setCustomizableViewControllers:"), nsa_value.GetHandle ());
						GC.KeepAlive (this);
					}
				}
			}
		...
		[SupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("ios")]
		public virtual UINavigationController MoreNavigationController {
			[Export ("moreNavigationController")]
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				UINavigationController? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<UINavigationController> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("moreNavigationController")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<UINavigationController> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("moreNavigationController")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		[SupportedOSPlatform ("ios18.0")]
		[SupportedOSPlatform ("maccatalyst18.0")]
		public virtual UITabBarControllerSidebar Sidebar {
			[Export ("sidebar", ArgumentSemantic.Retain)]
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				UITabBarControllerSidebar? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<UITabBarControllerSidebar> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("sidebar")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<UITabBarControllerSidebar> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("sidebar")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual UIViewController[]? ViewControllers {
			...
			get {
				...
				#pragma warning disable 168
				var postget1 = SelectedViewController;
				#pragma warning restore 168
				return ret!;
			}
		...
		internal class _UITabBarControllerDelegate : NSObject, IUITabBarControllerDelegate { 
			...
			internal EventHandler<UITabBarAcceptItemsEventArgs>? acceptItemsFromDropSession;
			[Export ("tabBarController:tab:acceptItemsFromDropSession:")]
			public void AcceptItemsFromDropSession (UITabBarController tabBarController, UITab tab, IUIDropSession session)
			{
				var handler = acceptItemsFromDropSession;
				if (handler is not null){
					var args = new UITabBarAcceptItemsEventArgs (tab, session);
					handler (tabBarController, args);
				}
			}
			internal EventHandler? didBeginEditing;
			[Export ("tabBarControllerDidEndEditing:")]
			public void DidBeginEditing (UITabBarController tabBarController)
			{
				var handler = didBeginEditing;
				if (handler is not null){
					handler (tabBarController, EventArgs.Empty);
				}
			}
			...
			internal EventHandler<UITabBarDisplayOrderChangeEventArgs>? displayOrderDidChangeForGroup;
			...
			{
				var handler = displayOrderDidChangeForGroup;
				if (handler is not null){
					var args = new UITabBarDisplayOrderChangeEventArgs (group);
					handler (tabBarController, args);
				}
			}
			internal EventHandler<UITabBarCustomizeChangeEventArgs>? finishedCustomizingViewControllers;
			[Export ("tabBarController:didEndCustomizingViewControllers:changed:")]
			public void FinishedCustomizingViewControllers (UITabBarController tabBarController, UIViewController[] viewControllers, bool changed)
			{
				var handler = finishedCustomizingViewControllers;
				if (handler is not null){
					var args = new UITabBarCustomizeChangeEventArgs (viewControllers, changed);
					handler (tabBarController, args);
				}
			}
			...
			internal UITabBarGetDisplayedViewControllers? getDisplayedViewControllers;
			[Export ("tabBarController:displayedViewControllersForTab:proposedViewControllers:")]
			public UIViewController[] GetDisplayedViewControllers (UITabBarController tabBarController, UITab tab, UIViewController[] proposedViewControllers)
			{
				var handler = getDisplayedViewControllers;
				if (handler is not null)
					return handler (tabBarController, tab, proposedViewControllers);
				throw new You_Should_Not_Call_base_In_This_Method ();
			}
			...
			internal Func<UITabBarController,UITab,IUIDropSession,UIDropOperation>? getOperationForAcceptingItemsFromDropSession;
			[Export ("tabBarController:tab:operationForAcceptingItemsFromDropSession:")]
			public UIDropOperation GetOperationForAcceptingItemsFromDropSession (UITabBarController tabBarController, UITab tab, IUIDropSession session)
			{
				var handler = getOperationForAcceptingItemsFromDropSession;
				if (handler is not null)
					return handler (tabBarController, tab, session);
				throw new You_Should_Not_Call_base_In_This_Method ();
			}
			internal Func<UITabBarController,UIInterfaceOrientation>? getPreferredInterfaceOrientation;
			[Export ("tabBarControllerPreferredInterfaceOrientationForPresentation:")]
			public UIInterfaceOrientation GetPreferredInterfaceOrientation (UITabBarController tabBarController)
			{
				var handler = getPreferredInterfaceOrientation;
				if (handler is not null)
					return handler (tabBarController);
				throw new You_Should_Not_Call_base_In_This_Method ();
			}
			internal EventHandler<UITabBarCustomizeEventArgs>? onCustomizingViewControllers;
			[Export ("tabBarController:willBeginCustomizingViewControllers:")]
			public void OnCustomizingViewControllers (UITabBarController tabBarController, UIViewController[] viewControllers)
			{
				var handler = onCustomizingViewControllers;
				if (handler is not null){
					var args = new UITabBarCustomizeEventArgs (viewControllers);
					handler (tabBarController, args);
				}
			}
			internal EventHandler<UITabBarCustomizeChangeEventArgs>? onEndCustomizingViewControllers;
			[Export ("tabBarController:willEndCustomizingViewControllers:changed:")]
			public void OnEndCustomizingViewControllers (UITabBarController tabBarController, UIViewController[] viewControllers, bool changed)
			{
				var handler = onEndCustomizingViewControllers;
				if (handler is not null){
					var args = new UITabBarCustomizeChangeEventArgs (viewControllers, changed);
					handler (tabBarController, args);
				}
			...
			internal Func<UITabBarController,UIInterfaceOrientationMask>? supportedInterfaceOrientations;
			[Export ("tabBarControllerSupportedInterfaceOrientations:")]
			public UIInterfaceOrientationMask SupportedInterfaceOrientations (UITabBarController tabBarController)
			{
			...
			internal EventHandler<UITabBarTabVisibilityChangeEventArgs>? visibilityDidChangeForTabs;
			[Export ("tabBarController:visibilityDidChangeForTabs:")]
			public void VisibilityDidChangeForTabs (UITabBarController tabBarController, UITab[] tabs)
			{
				var handler = visibilityDidChangeForTabs;
				if (handler is not null){
					var args = new UITabBarTabVisibilityChangeEventArgs (tabs);
					handler (tabBarController, args);
				}
			}
			internal EventHandler? willBeginEditing;
			[Export ("tabBarControllerWillBeginEditing:")]
			public void WillBeginEditing (UITabBarController tabBarController)
			{
				var handler = willBeginEditing;
				if (handler is not null){
					handler (tabBarController, EventArgs.Empty);
				}
			}
			public override bool RespondsToSelector (Selector? sel)
			{
				...
				if (selHandle.Equals (Selector.GetHandle ("tabBarController:displayedViewControllersForTab:proposedViewControllers:")))
					return getDisplayedViewControllers is not null;
				...
				if (selHandle.Equals (Selector.GetHandle ("tabBarController:tab:operationForAcceptingItemsFromDropSession:")))
					return getOperationForAcceptingItemsFromDropSession is not null;
				if (selHandle.Equals (Selector.GetHandle ("tabBarControllerPreferredInterfaceOrientationForPresentation:")))
					return getPreferredInterfaceOrientation is not null;
				if (selHandle.Equals (Selector.GetHandle ("tabBarControllerSupportedInterfaceOrientations:")))
					return supportedInterfaceOrientations is not null;
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
		...
		public event EventHandler<UITabBarAcceptItemsEventArgs> AcceptItemsFromDropSession {
			add { EnsureUITabBarControllerDelegate ()!.acceptItemsFromDropSession += value; }
			remove { EnsureUITabBarControllerDelegate ()!.acceptItemsFromDropSession -= value; }
		}
		public event EventHandler DidBeginEditing {
			add { EnsureUITabBarControllerDelegate ()!.didBeginEditing += value; }
			remove { EnsureUITabBarControllerDelegate ()!.didBeginEditing -= value; }
		}
		...
		public event EventHandler<UITabBarDisplayOrderChangeEventArgs> DisplayOrderDidChangeForGroup {
			add { EnsureUITabBarControllerDelegate ()!.displayOrderDidChangeForGroup += value; }
			remove { EnsureUITabBarControllerDelegate ()!.displayOrderDidChangeForGroup -= value; }
		}
		...
		public event EventHandler<UITabBarCustomizeChangeEventArgs> FinishedCustomizingViewControllers {
			add { EnsureUITabBarControllerDelegate ()!.finishedCustomizingViewControllers += value; }
			remove { EnsureUITabBarControllerDelegate ()!.finishedCustomizingViewControllers -= value; }
		}
		...
		public UITabBarGetDisplayedViewControllers? GetDisplayedViewControllers {
			get { return EnsureUITabBarControllerDelegate ()!.getDisplayedViewControllers; }
			set { EnsureUITabBarControllerDelegate ()!.getDisplayedViewControllers = value; }
		}
		/// <summary>Delegate invoked by the object to get a value.</summary>
		/// <value>To be added.</value>
		/// <remarks>Developers assign a function, delegate or anonymous method to this property to return a value to the object.   If developers assign a value to this property, it this will reset the value for the WeakDelegate property to an internal handler that maps delegates to events.</remarks>
		...
		public Func<UITabBarController,UITab,IUIDropSession,UIDropOperation>? GetOperationForAcceptingItemsFromDropSession {
			get { return EnsureUITabBarControllerDelegate ()!.getOperationForAcceptingItemsFromDropSession; }
			set { EnsureUITabBarControllerDelegate ()!.getOperationForAcceptingItemsFromDropSession = value; }
		}
		/// <summary>Delegate invoked by the object to get a value.</summary>
		/// <value>To be added.</value>
		/// <remarks>Developers assign a function, delegate or anonymous method to this property to return a value to the object.   If developers assign a value to this property, it this will reset the value for the WeakDelegate property to an internal handler that maps delegates to events.</remarks>
		public Func<UITabBarController,UIInterfaceOrientation>? GetPreferredInterfaceOrientation {
			get { return EnsureUITabBarControllerDelegate ()!.getPreferredInterfaceOrientation; }
			set { EnsureUITabBarControllerDelegate ()!.getPreferredInterfaceOrientation = value; }
		}
		/// <summary>Event raised by the object.</summary>
		/// <remarks>If developers do not assign a value to this event, this will reset the value for the WeakDelegate property to an internal handler that maps delegates to events.</remarks>
		public event EventHandler<UITabBarCustomizeEventArgs> OnCustomizingViewControllers {
			add { EnsureUITabBarControllerDelegate ()!.onCustomizingViewControllers += value; }
			remove { EnsureUITabBarControllerDelegate ()!.onCustomizingViewControllers -= value; }
		}
		/// <summary>Event raised by the object.</summary>
		/// <remarks>If developers do not assign a value to this event, this will reset the value for the WeakDelegate property to an internal handler that maps delegates to events.</remarks>
		public event EventHandler<UITabBarCustomizeChangeEventArgs> OnEndCustomizingViewControllers {
			add { EnsureUITabBarControllerDelegate ()!.onEndCustomizingViewControllers += value; }
			remove { EnsureUITabBarControllerDelegate ()!.onEndCustomizingViewControllers -= value; }
		}
		...
		public Func<UITabBarController,UIInterfaceOrientationMask>? SupportedInterfaceOrientations {
			get { return EnsureUITabBarControllerDelegate ()!.supportedInterfaceOrientations; }
			set { EnsureUITabBarControllerDelegate ()!.supportedInterfaceOrientations = value; }
		}
		/// <summary>Event raised by the object.</summary>
		/// <remarks>If developers do not assign a value to this event, this will reset the value for the WeakDelegate property to an internal handler that maps delegates to events.</remarks>
		...
		public event EventHandler<UITabBarTabVisibilityChangeEventArgs> VisibilityDidChangeForTabs {
			add { EnsureUITabBarControllerDelegate ()!.visibilityDidChangeForTabs += value; }
			remove { EnsureUITabBarControllerDelegate ()!.visibilityDidChangeForTabs -= value; }
		}
		public event EventHandler WillBeginEditing {
			add { EnsureUITabBarControllerDelegate ()!.willBeginEditing += value; }
			remove { EnsureUITabBarControllerDelegate ()!.willBeginEditing -= value; }
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	...
	public partial class UITabBarAcceptItemsEventArgs : EventArgs {
		/// <summary>Create a new instance of the <see cref="UITabBarAcceptItemsEventArgs" /> with the specified event data.</summary>
		/// <param name="tab">The value for the <see cref="Tab" /> property.</param>
		/// <param name="session">The value for the <see cref="Session" /> property.</param>
	...
	/// <summary>Provides data for an event based on an Objective-C protocol method.</summary>
	public partial class UITabBarCustomizeChangeEventArgs : EventArgs {
		/// <summary>Create a new instance of the <see cref="UITabBarCustomizeChangeEventArgs" /> with the specified event data.</summary>
		/// <param name="viewControllers">The value for the <see cref="ViewControllers" /> property.</param>
		...
		public UIViewController[] ViewControllers { get; set; }
	}
	/// <summary>Provides data for an event based on an Objective-C protocol method.</summary>
	public partial class UITabBarCustomizeEventArgs : EventArgs {
		/// <summary>Create a new instance of the <see cref="UITabBarCustomizeEventArgs" /> with the specified event data.</summary>
		/// <param name="viewControllers">The value for the <see cref="ViewControllers" /> property.</param>
	...
	/// <summary>Provides data for an event based on an Objective-C protocol method.</summary>
	public partial class UITabBarDisplayOrderChangeEventArgs : EventArgs {
		/// <summary>Create a new instance of the <see cref="UITabBarDisplayOrderChangeEventArgs" /> with the specified event data.</summary>
	...
	/// <summary>Provides data for an event based on an Objective-C protocol method.</summary>
	public partial class UITabBarTabVisibilityChangeEventArgs : EventArgs {
		/// <summary>Create a new instance of the <see cref="UITabBarTabVisibilityChangeEventArgs" /> with the specified event data.</summary>
		/// <param name="tabs">The value for the <see cref="Tabs" /> property.</param>
