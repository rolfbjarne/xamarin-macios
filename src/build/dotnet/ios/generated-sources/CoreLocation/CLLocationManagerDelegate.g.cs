...
namespace CoreLocation {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidRangeBeacons", Selector = "locationManager:didRangeBeacons:inRegion:", ParameterType = new Type [] { typeof (CLLocationManager), typeof (CLBeacon[]), typeof (CLBeaconRegion) }, ParameterByRef = new bool [] { false, false, false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "RangingBeaconsDidFailForRegion", Selector = "locationManager:rangingBeaconsDidFailForRegion:withError:", ParameterType = new Type [] { typeof (CLLocationManager), typeof (CLBeaconRegion), typeof (NSError) }, ParameterByRef = new bool [] { false, false, false })]
	...
	public partial interface ICLLocationManagerDelegate : INativeObject, IDisposable
	{
		...
		/// <param name="manager">The <see cref="T:CoreLocation.CLLocationManager" /> for which <c>this</c> is the delegate object.</param><param name="beacons">The ranged <see cref="T:CoreLocation.CLBeacon" />s.</param><param name="region">To be added.</param><summary>Range information was generated for <paramref name="beacons" /> in <paramref name="region" />.</summary><remarks>To be added.</remarks>
		[global::Foundation.OptionalMember]
		[Export ("locationManager:didRangeBeacons:inRegion:")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("macos")]
		[ObsoletedOSPlatform ("ios13.0", "Use 'DidRangeBeaconsSatisfyingConstraint' instead.")]
		[SupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'DidRangeBeaconsSatisfyingConstraint' instead.")]
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void DidRangeBeacons (CLLocationManager manager, CLBeacon[] beacons, CLBeaconRegion region)
		{
			_DidRangeBeacons (this, manager, beacons, region);
		}
		/// <param name="manager">The <see cref="T:CoreLocation.CLLocationManager" /> for which <c>this</c> is the delegate object.</param><param name="beacons">The ranged <see cref="T:CoreLocation.CLBeacon" />s.</param><param name="region">To be added.</param><summary>Range information was generated for <paramref name="beacons" /> in <paramref name="region" />.</summary><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("macos")]
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _DidRangeBeacons (ICLLocationManagerDelegate This, CLLocationManager manager, CLBeacon[] beacons, CLBeaconRegion region)
		{
			var manager__handle__ = manager!.GetNonNullHandle (nameof (manager));
			if (beacons is null)
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("locationManager:didRangeBeacons:inRegion:"), manager__handle__, nsa_beacons.Handle, region__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (manager);
			GC.KeepAlive (region);
		}
		...
		/// <param name="manager">The <see cref="T:CoreLocation.CLLocationManager" /> for which <c>this</c> is the delegate object.</param><param name="region">To be added.</param><param name="error">To be added.</param><summary><paramref name="error" /> occurred while attempting to get range data from <paramref name="region" />.</summary><remarks>To be added.</remarks>
		[global::Foundation.OptionalMember]
		[Export ("locationManager:rangingBeaconsDidFailForRegion:withError:")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("macos")]
		[ObsoletedOSPlatform ("ios13.0", "Use 'DidFailRangingBeacons' instead.")]
		[SupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'DidFailRangingBeacons' instead.")]
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void RangingBeaconsDidFailForRegion (CLLocationManager manager, CLBeaconRegion region, NSError error)
		{
			_RangingBeaconsDidFailForRegion (this, manager, region, error);
		}
		/// <param name="manager">The <see cref="T:CoreLocation.CLLocationManager" /> for which <c>this</c> is the delegate object.</param><param name="region">To be added.</param><param name="error">To be added.</param><summary><paramref name="error" /> occurred while attempting to get range data from <paramref name="region" />.</summary><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("macos")]
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _RangingBeaconsDidFailForRegion (ICLLocationManagerDelegate This, CLLocationManager manager, CLBeaconRegion region, NSError error)
		{
			var manager__handle__ = manager!.GetNonNullHandle (nameof (manager));
			var region__handle__ = region!.GetNonNullHandle (nameof (region));
			var error__handle__ = error!.GetNonNullHandle (nameof (error));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("locationManager:rangingBeaconsDidFailForRegion:withError:"), manager__handle__, region__handle__, error__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (manager);
			GC.KeepAlive (region);
			GC.KeepAlive (error);
		...
		[DynamicDependencyAttribute ("DidRangeBeacons(CoreLocation.CLLocationManager,CoreLocation.CLBeacon[],CoreLocation.CLBeaconRegion)")]
		...
		[DynamicDependencyAttribute ("RangingBeaconsDidFailForRegion(CoreLocation.CLLocationManager,CoreLocation.CLBeaconRegion,Foundation.NSError)")]
	...
	public unsafe static partial class CLLocationManagerDelegate_Extensions {
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void DidRangeBeacons (this ICLLocationManagerDelegate This, CLLocationManager manager, CLBeacon[] beacons, CLBeaconRegion region)
		{
			var manager__handle__ = manager!.GetNonNullHandle (nameof (manager));
			if (beacons is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (beacons));
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void RangingBeaconsDidFailForRegion (this ICLLocationManagerDelegate This, CLLocationManager manager, CLBeaconRegion region, NSError error)
		{
			var manager__handle__ = manager!.GetNonNullHandle (nameof (manager));
			var region__handle__ = region!.GetNonNullHandle (nameof (region));
			var error__handle__ = error!.GetNonNullHandle (nameof (error));
...
namespace CoreLocation {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_iOS__CoreLocation_CLLocationManagerDelegate", false)]
	[Model]
