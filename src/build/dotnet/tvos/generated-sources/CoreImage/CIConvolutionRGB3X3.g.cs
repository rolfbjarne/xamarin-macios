...
namespace CoreImage {
	...
	public partial class CIConvolutionRGB3X3 : CIFilter, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIConvolutionRGB3X3" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIConvolutionRGB3X3 (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIConvolutionRGB3X3 (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIConvolutionRGB3X3 (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
