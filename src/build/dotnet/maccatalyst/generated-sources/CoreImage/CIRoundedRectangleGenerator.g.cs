...
namespace CoreImage {
	...
	public partial class CIRoundedRectangleGenerator : CIFilter, ICIRoundedRectangleGeneratorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIRoundedRectangleGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIRoundedRectangleGenerator () : base ("CIRoundedRectangleGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIRoundedRectangleGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIRoundedRectangleGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIRoundedRectangleGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIRoundedRectangleGeneratorProtocol protocol members 
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos13.0")]
		[SupportedOSPlatform ("maccatalyst")]
