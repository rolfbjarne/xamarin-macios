...
#nullable enable
namespace UIKit {
	[Register("UIBarButtonItemStateAppearance", true)]
	[SupportedOSPlatform ("tvos13.0")]
	[SupportedOSPlatform ("ios13.0")]
	[SupportedOSPlatform ("maccatalyst")]
	public unsafe partial class UIBarButtonItemStateAppearance : NSObject {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("UIBarButtonItemStateAppearance");
		...
		protected UIBarButtonItemStateAppearance (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal UIBarButtonItemStateAppearance (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual UIOffset BackgroundImagePositionAdjustment {
			[Export ("backgroundImagePositionAdjustment", ArgumentSemantic.Assign)]
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				UIOffset ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIOffset_objc_msgSend (this.Handle, Selector.GetHandle ("backgroundImagePositionAdjustment"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIOffset_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("backgroundImagePositionAdjustment"));
						GC.KeepAlive (this);
					}
				}
				return ret;
			}
			[Export ("setBackgroundImagePositionAdjustment:", ArgumentSemantic.Assign)]
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIOffset (this.Handle, Selector.GetHandle ("setBackgroundImagePositionAdjustment:"), value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIOffset (&__objc_super__, Selector.GetHandle ("setBackgroundImagePositionAdjustment:"), value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSDictionary<NSString, NSObject> TitleTextAttributes {
			[Export ("titleTextAttributes", ArgumentSemantic.Copy)]
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				NSDictionary<NSString, NSObject>? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDictionary<NSString, NSObject>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("titleTextAttributes")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDictionary<NSString, NSObject>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("titleTextAttributes")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
