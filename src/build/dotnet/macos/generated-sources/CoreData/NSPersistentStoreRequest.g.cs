...
#nullable enable
namespace CoreData {
	/// <summary>Criteria used to retrieve data from or save data in a persistent store.</summary><remarks>To be added.</remarks><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/CoreData/Reference/NSPersistentStoreRequest_Class/index.html">Apple documentation for <c>NSPersistentStoreRequest</c></related>
	[Register("NSPersistentStoreRequest", true)]
	public unsafe partial class NSPersistentStoreRequest : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selRequestTypeX = "requestType";
		static readonly NativeHandle selRequestTypeXHandle = Selector.GetHandle ("requestType");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSPersistentStoreRequest");
		...
		/// <summary>Creates a new <see cref="NSPersistentStoreRequest" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public NSPersistentStoreRequest () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSPersistentStoreRequest (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSPersistentStoreRequest (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual NSPersistentStoreRequestType RequestType {
			[Export ("requestType")]
			get {
				NSPersistentStoreRequestType ret;
				if (IsDirectBinding) {
					ret = (CoreData.NSPersistentStoreRequestType) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selRequestTypeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (CoreData.NSPersistentStoreRequestType) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selRequestTypeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
