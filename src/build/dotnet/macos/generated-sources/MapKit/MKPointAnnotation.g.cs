...
namespace MapKit {
	...
	public unsafe partial class MKPointAnnotation : MKShape, IMKGeoJsonObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithCoordinate_Title_Subtitle_X = "initWithCoordinate:title:subtitle:";
		static readonly NativeHandle selInitWithCoordinate_Title_Subtitle_XHandle = Selector.GetHandle ("initWithCoordinate:title:subtitle:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_CLLocationCoordinate2D_NativeHandle_NativeHandle (this.Handle, selInitWithCoordinate_Title_Subtitle_XHandle, coordinate, nstitle, nssubtitle), "initWithCoordinate:title:subtitle:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_CLLocationCoordinate2D_NativeHandle_NativeHandle (&__objc_super__, selInitWithCoordinate_Title_Subtitle_XHandle, coordinate, nstitle, nssubtitle), "initWithCoordinate:title:subtitle:");
					GC.KeepAlive (this);
				}
			}
