...
namespace CoreImage {
	...
	public abstract partial class CIMorphologyRectangle : CIFilter {
		...
		protected internal CIMorphologyRectangle (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMorphologyRectangle (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMorphologyRectangle (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIMorphologyRectangle" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected  CIMorphologyRectangle (string name) : base (CreateFilter (name))
		{
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
