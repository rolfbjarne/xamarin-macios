...
namespace ModelIO {
	...
	public unsafe partial class MDLMeshBufferData : NSObject, IMDLMeshBuffer, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithType_Length_X = "initWithType:length:";
		static readonly NativeHandle selInitWithType_Length_XHandle = Selector.GetHandle ("initWithType:length:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr_UIntPtr (this.Handle, selInitWithType_Length_XHandle, (UIntPtr) (ulong) type, length), "initWithType:length:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_UIntPtr_UIntPtr (&__objc_super__, selInitWithType_Length_XHandle, (UIntPtr) (ulong) type, length), "initWithType:length:");
					GC.KeepAlive (this);
				}
			}
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr_NativeHandle (this.Handle, selInitWithType_Data_XHandle, (UIntPtr) (ulong) type, data__handle__), "initWithType:data:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_UIntPtr_NativeHandle (&__objc_super__, selInitWithType_Data_XHandle, (UIntPtr) (ulong) type, data__handle__), "initWithType:data:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (data);
		...
		public virtual IMDLMeshBufferZone? Zone {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetINativeObject<IMDLMeshBufferZone> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selZoneXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetINativeObject<IMDLMeshBufferZone> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selZoneXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
