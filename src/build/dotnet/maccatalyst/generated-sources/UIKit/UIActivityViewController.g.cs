...
namespace UIKit {
	...
	public unsafe partial class UIActivityViewController : UIViewController {
		...
		public unsafe virtual global::System.Action<NSString, bool>? CompletionHandler {
			[return: DelegateProxy (typeof (ObjCRuntime.Trampolines.SDActionArity2V163))]
			...
			get {
				...
				return global::ObjCRuntime.Trampolines.NIDActionArity2V163.Create (ret)!;
			}
			[param: BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V163))]
			[Export ("setCompletionHandler:", ArgumentSemantic.Copy)]
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				using var block_value = Trampolines.SDActionArity2V163.CreateNullableBlock (value);
