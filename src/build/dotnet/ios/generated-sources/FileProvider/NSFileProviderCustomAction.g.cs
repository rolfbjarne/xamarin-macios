...
namespace FileProvider {
	...
	public partial interface INSFileProviderCustomAction : INativeObject, IDisposable
	{
		...
		public unsafe virtual NSProgress PerformAction (string actionIdentifier, string[] itemIdentifiers, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static NSProgress _PerformAction (INSFileProviderCustomAction This, string actionIdentifier, string[] itemIdentifiers, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
	...
	internal unsafe sealed class NSFileProviderCustomActionWrapper : BaseWrapper, INSFileProviderCustomAction {
		...
		[Export ("performActionWithIdentifier:onItemsWithIdentifiers:completionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe NSProgress PerformAction (string actionIdentifier, string[] itemIdentifiers, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> completionHandler)
		{
			if (actionIdentifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (actionIdentifier));
			if (itemIdentifiers is null)
