...
namespace Intents {
	...
	internal unsafe sealed class INMessagesDomainHandlingWrapper : BaseWrapper, IINMessagesDomainHandling {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void HandleSetMessageAttribute (INSetMessageAttributeIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V139))]global::System.Action<INSetMessageAttributeIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
