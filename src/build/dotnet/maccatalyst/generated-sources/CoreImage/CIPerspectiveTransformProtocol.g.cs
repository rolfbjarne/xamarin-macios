...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIPerspectiveTransform</c>.</summary>
	/// <remarks>
	...
	public partial interface ICIPerspectiveTransformProtocol : INativeObject, IDisposable, 
		CoreImage.ICIFilterProtocol
		, CoreImage.ICIFourCoordinateGeometryFilterProtocol
	{
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIPerspectiveTransformProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICIPerspectiveTransformProtocol ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class CIPerspectiveTransformProtocolWrapper : BaseWrapper, ICIPerspectiveTransformProtocol {
		public CIPerspectiveTransformProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIPerspectiveTransformProtocolWrapper))]
		static CIPerspectiveTransformProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
