...
namespace MonoTouchFixtures.CoreMedia {
	...
	public class CMTimeRangeTests {
		...
		public void InvalidRangeFieldTest ()
		{
			...
			ClassicAssert.NotNull (invalid, "CMTimeRange.InvalidRange Should Not be null");
			ClassicAssert.NotNull (invalid.Duration, "CMTimeRange.InvalidRange.Duration Should Not be null");
			ClassicAssert.NotNull (invalid.Start, "CMTimeRange.InvalidRange.Duration Should Not be null");
		...
		public void InvalidMappingFieldTest ()
		{
			...
			ClassicAssert.NotNull (invalid, "CMTimeRange.InvalidMapping Should Not be null");
			ClassicAssert.NotNull (invalid.Duration, "CMTimeRange.InvalidMapping.Duration Should Not be null");
			ClassicAssert.NotNull (invalid.Start, "CMTimeRange.InvalidMapping.Duration Should Not be null");
		...
		public void ZeroFieldTest ()
		{
			...
			ClassicAssert.NotNull (zero, "CMTimeRange.Zero Should Not be null");
			ClassicAssert.NotNull (zero.Duration, "CMTimeRange.Zero.Duration Should Not be null");
			ClassicAssert.NotNull (zero.Start, "CMTimeRange.Zero.Duration Should Not be null");
