...
namespace CoreImage {
	...
	public abstract partial class CIImageGenerator : CIFilter {
		...
		protected internal CIImageGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIImageGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIImageGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIImageGenerator" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected  CIImageGenerator (string name) : base (CreateFilter (name))
		{
		}
