...
namespace CoreImage {
	...
	public partial class CIAttributedTextImageGenerator : CIImageGenerator, ICIAttributedTextImageGeneratorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIAttributedTextImageGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIAttributedTextImageGenerator () : base ("CIAttributedTextImageGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAttributedTextImageGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAttributedTextImageGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAttributedTextImageGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIAttributedTextImageGeneratorProtocol protocol members 
		...
		public NSAttributedString Text {
			...
			get {
				return Runtime.GetNSObject <NSAttributedString> (GetHandle ("inputText"), false)!;
			}
		...
		public float Padding {
			[Export ("padding")]
			get {
				return GetFloat ("inputPadding");
			}
			[Export ("setPadding:")]
			set {
				SetFloat ("inputPadding", value);
			}
		}
