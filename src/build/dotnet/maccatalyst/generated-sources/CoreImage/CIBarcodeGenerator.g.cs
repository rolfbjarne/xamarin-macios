...
namespace CoreImage {
	...
	public partial class CIBarcodeGenerator : CIFilter, ICIBarcodeGeneratorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIBarcodeGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIBarcodeGenerator () : base ("CIBarcodeGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBarcodeGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBarcodeGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBarcodeGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CGImage OutputCGImageForQRCodeDescriptor {
			get {
				return Runtime.GetINativeObject <CGImage> (GetHandle ("outputCGImageForQRCodeDescriptor"), false)!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CGImage OutputCGImageForPdf417CodeDescriptor {
			get {
				return Runtime.GetINativeObject <CGImage> (GetHandle ("outputCGImageForPDF417CodeDescriptor"), false)!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CGImage OutputCGImageForDataMatrixCodeDescriptor {
			get {
				return Runtime.GetINativeObject <CGImage> (GetHandle ("outputCGImageForDataMatrixCodeDescriptor"), false)!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CGImage OutputCGImageForAztecCodeDescriptor {
			get {
				return Runtime.GetINativeObject <CGImage> (GetHandle ("outputCGImageForAztecCodeDescriptor"), false)!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		// CIBarcodeGeneratorProtocol protocol members 
		...
		public CIBarcodeDescriptor BarcodeDescriptor {
			...
			get {
				return Runtime.GetINativeObject <CIBarcodeDescriptor> (GetHandle ("inputBarcodeDescriptor"), false)!;
			}
