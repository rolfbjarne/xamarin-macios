...
namespace MapKit {
	...
	public unsafe partial class MKPolygon : MKMultiPoint, IMKGeoJsonObject, IMKOverlay {
		...
		{
			MKPolygon ret;
			ret =  Runtime.GetNSObject<MKPolygon> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("polygonWithCoordinates:count:"), coords, count), false)!;
			return ret;
		}
		...
		internal static MKPolygon _FromCoordinates (nint coords, nint count, MKPolygon[]? interiorPolygons)
		{
			...
			MKPolygon ret;
			ret =  Runtime.GetNSObject<MKPolygon> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr_NativeHandle (class_ptr, Selector.GetHandle ("polygonWithCoordinates:count:interiorPolygons:"), coords, count, nsa_interiorPolygons.GetHandle ()), false)!;
			return ret;
		}
		...
		{
			MKPolygon ret;
			ret =  Runtime.GetNSObject<MKPolygon> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("polygonWithPoints:count:"), points, count), false)!;
			return ret;
		}
		...
		internal static MKPolygon _FromPoints (nint points, nint count, MKPolygon[]? interiorPolygons)
		{
			using var nsa_interiorPolygons = interiorPolygons is null ? null : NSArray.FromNSObjects (interiorPolygons);
			MKPolygon ret;
			ret =  Runtime.GetNSObject<MKPolygon> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr_NativeHandle (class_ptr, Selector.GetHandle ("polygonWithPoints:count:interiorPolygons:"), points, count, nsa_interiorPolygons.GetHandle ()), false)!;
			return ret;
		}
		...
		public virtual MKPolygon[]? InteriorPolygons {
			...
			get {
				MKPolygon[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<MKPolygon>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("interiorPolygons")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<MKPolygon>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("interiorPolygons")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
