	...
	public unsafe partial class SCNMaterialProperty : NSObject, INSCoding, INSSecureCoding, ISCNAnimatable {
		...
		public virtual NSObject? BorderColor {
			...
			get {
				NSObject? ret;
				if (IsDirectBinding) {
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("borderColor")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("borderColor")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
