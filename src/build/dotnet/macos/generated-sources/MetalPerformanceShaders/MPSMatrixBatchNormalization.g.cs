...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSMatrixBatchNormalization : MPSMatrixUnaryKernel {
		...
		const string selComputeStatisticsX = "computeStatistics";
		static readonly NativeHandle selComputeStatisticsXHandle = Selector.GetHandle ("computeStatistics");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_InputMatrix_MeanVector_VarianceVector_GammaVector_BetaVector_ResultMatrix_X = "encodeToCommandBuffer:inputMatrix:meanVector:varianceVector:gammaVector:betaVector:resultMatrix:";
		static readonly NativeHandle selEncodeToCommandBuffer_InputMatrix_MeanVector_VarianceVector_GammaVector_BetaVector_ResultMatrix_XHandle = Selector.GetHandle ("encodeToCommandBuffer:inputMatrix:meanVector:varianceVector:gammaVector:betaVector:resultMatrix:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetComputeStatistics_X = "setComputeStatistics:";
		static readonly NativeHandle selSetComputeStatistics_XHandle = Selector.GetHandle ("setComputeStatistics:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual MPSMatrixBatchNormalization Copy (NSZone? zone, global::Metal.IMTLDevice? device)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<MPSMatrixBatchNormalization> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selCopyWithZone_Device_XHandle, zone__handle__, device__handle__), true)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<MPSMatrixBatchNormalization> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selCopyWithZone_Device_XHandle, zone__handle__, device__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (zone);
		...
		public virtual void Encode (global::Metal.IMTLCommandBuffer commandBuffer, MPSMatrix inputMatrix, MPSVector meanVector, MPSVector varianceVector, MPSVector? gammaVector, MPSVector? betaVector, MPSMatrix resultMatrix)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeToCommandBuffer_InputMatrix_MeanVector_VarianceVector_GammaVector_BetaVector_ResultMatrix_XHandle, commandBuffer__handle__, inputMatrix__handle__, meanVector__handle__, varianceVector__handle__, gammaVector__handle__, betaVector__handle__, resultMatrix__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeToCommandBuffer_InputMatrix_MeanVector_VarianceVector_GammaVector_BetaVector_ResultMatrix_XHandle, commandBuffer__handle__, inputMatrix__handle__, meanVector__handle__, varianceVector__handle__, gammaVector__handle__, betaVector__handle__, resultMatrix__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual bool ComputeStatistics {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selComputeStatisticsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selComputeStatisticsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_bool (this.Handle, selSetComputeStatistics_XHandle, value ? (byte) 1 : (byte) 0);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, selSetComputeStatistics_XHandle, value ? (byte) 1 : (byte) 0);
						GC.KeepAlive (this);
					}
				}
			}
