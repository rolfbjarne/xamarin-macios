		...
		public virtual CGAffineTransform CreateTransform (nuint width, nuint height)
		{
			...
			if (IsDirectBinding) {
				if (global::ObjCRuntime.Runtime.IsARM64CallingConvention) {
					ret = global::ObjCRuntime.Messaging.CGAffineTransform_objc_msgSend_UIntPtr_UIntPtr (this.Handle, Selector.GetHandle ("transformForImageWidth:height:"), width, height);
				} else {
					ret = global::ObjCRuntime.Messaging.CGAffineTransform_objc_msgSend_stret_UIntPtr_UIntPtr (this.Handle, Selector.GetHandle ("transformForImageWidth:height:"), width, height);
				}
			} else {
				if (global::ObjCRuntime.Runtime.IsARM64CallingConvention) {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.CGAffineTransform_objc_msgSendSuper_UIntPtr_UIntPtr (&__objc_super__, Selector.GetHandle ("transformForImageWidth:height:"), width, height);
						GC.KeepAlive (this);
					}
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.CGAffineTransform_objc_msgSendSuper_stret_UIntPtr_UIntPtr (&__objc_super__, Selector.GetHandle ("transformForImageWidth:height:"), width, height);
						GC.KeepAlive (this);
					}
				}
			}
