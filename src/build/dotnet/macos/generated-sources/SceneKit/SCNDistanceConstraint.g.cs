...
namespace SceneKit {
	...
	public unsafe partial class SCNDistanceConstraint : SCNConstraint {
		...
		const string selDistanceConstraintWithTarget_X = "distanceConstraintWithTarget:";
		static readonly NativeHandle selDistanceConstraintWithTarget_XHandle = Selector.GetHandle ("distanceConstraintWithTarget:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static SCNDistanceConstraint FromTarget (SCNNode? target)
		{
			...
			ret =  Runtime.GetNSObject<SCNDistanceConstraint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selDistanceConstraintWithTarget_XHandle, target__handle__), false)!;
			GC.KeepAlive (target);
			return ret!;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual nfloat MaximumDistance {
			...
			get {
				nfloat ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend (this.Handle, selMaximumDistanceXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSendSuper (&__objc_super__, selMaximumDistanceXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_nfloat (this.Handle, selSetMaximumDistance_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_nfloat (&__objc_super__, selSetMaximumDistance_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
