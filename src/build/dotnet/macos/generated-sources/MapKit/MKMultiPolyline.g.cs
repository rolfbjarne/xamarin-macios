...
namespace MapKit {
	...
	public unsafe partial class MKMultiPolyline : MKShape, IMKGeoJsonObject, IMKOverlay {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithPolylines_X = "initWithPolylines:";
		static readonly NativeHandle selInitWithPolylines_XHandle = Selector.GetHandle ("initWithPolylines:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPolylinesX = "polylines";
		static readonly NativeHandle selPolylinesXHandle = Selector.GetHandle ("polylines");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithPolylines_XHandle, nsa_polylines.Handle), "initWithPolylines:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithPolylines_XHandle, nsa_polylines.Handle), "initWithPolylines:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual MKPolyline[] Polylines {
			...
			get {
				MKPolyline[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<MKPolyline>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selPolylinesXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<MKPolyline>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selPolylinesXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
