...
namespace HealthKit {
	...
	public unsafe partial class HKVisionPrescription : HKSample, INSCoding, INSCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDateIssuedX = "dateIssued";
		static readonly NativeHandle selDateIssuedXHandle = Selector.GetHandle ("dateIssued");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPrescriptionTypeX = "prescriptionType";
		static readonly NativeHandle selPrescriptionTypeXHandle = Selector.GetHandle ("prescriptionType");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPrescriptionWithType_DateIssued_ExpirationDate_Device_Metadata_X = "prescriptionWithType:dateIssued:expirationDate:device:metadata:";
		static readonly NativeHandle selPrescriptionWithType_DateIssued_ExpirationDate_Device_Metadata_XHandle = Selector.GetHandle ("prescriptionWithType:dateIssued:expirationDate:device:metadata:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static HKVisionPrescription GetPrescription (HKVisionPrescriptionType type, NSDate dateIssued, NSDate? expirationDate, HKDevice? device, NSDictionary<NSString, NSObject>? metadata)
		{
			...
			HKVisionPrescription? ret;
			ret =  Runtime.GetNSObject<HKVisionPrescription> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr_NativeHandle_NativeHandle_NativeHandle_NativeHandle (class_ptr, selPrescriptionWithType_DateIssued_ExpirationDate_Device_Metadata_XHandle, (UIntPtr) (ulong) type, dateIssued__handle__, expirationDate__handle__, device__handle__, metadata__handle__), false)!;
		...
		public virtual NSDate DateIssued {
			...
			get {
				NSDate? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selDateIssuedXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selDateIssuedXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual HKVisionPrescriptionType PrescriptionType {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (HealthKit.HKVisionPrescriptionType) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selPrescriptionTypeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (HealthKit.HKVisionPrescriptionType) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selPrescriptionTypeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		/// <summary>Represents the value associated with the constant 'HKVisionPrescriptionTypeIdentifier'.</summary>
