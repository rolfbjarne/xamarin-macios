...
namespace GLKit {
	...
	/// 
	/// </para></remarks><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/GLkit/Reference/GLKTextureLoader_ClassRef/index.html">Apple documentation for <c>GLKTextureLoader</c></related>
	...
	public unsafe partial class GLKTextureLoader : NSObject {
		...
		const string selCubeMapWithContentsOfFile_Options_Error_X = "cubeMapWithContentsOfFile:options:error:";
		static readonly NativeHandle selCubeMapWithContentsOfFile_Options_Error_XHandle = Selector.GetHandle ("cubeMapWithContentsOfFile:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCubeMapWithContentsOfFile_Options_Queue_CompletionHandler_X = "cubeMapWithContentsOfFile:options:queue:completionHandler:";
		static readonly NativeHandle selCubeMapWithContentsOfFile_Options_Queue_CompletionHandler_XHandle = Selector.GetHandle ("cubeMapWithContentsOfFile:options:queue:completionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCubeMapWithContentsOfFiles_Options_Error_X = "cubeMapWithContentsOfFiles:options:error:";
		static readonly NativeHandle selCubeMapWithContentsOfFiles_Options_Error_XHandle = Selector.GetHandle ("cubeMapWithContentsOfFiles:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCubeMapWithContentsOfFiles_Options_Queue_CompletionHandler_X = "cubeMapWithContentsOfFiles:options:queue:completionHandler:";
		static readonly NativeHandle selCubeMapWithContentsOfFiles_Options_Queue_CompletionHandler_XHandle = Selector.GetHandle ("cubeMapWithContentsOfFiles:options:queue:completionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCubeMapWithContentsOfURL_Options_Error_X = "cubeMapWithContentsOfURL:options:error:";
		static readonly NativeHandle selCubeMapWithContentsOfURL_Options_Error_XHandle = Selector.GetHandle ("cubeMapWithContentsOfURL:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCubeMapWithContentsOfURL_Options_Queue_CompletionHandler_X = "cubeMapWithContentsOfURL:options:queue:completionHandler:";
		static readonly NativeHandle selCubeMapWithContentsOfURL_Options_Queue_CompletionHandler_XHandle = Selector.GetHandle ("cubeMapWithContentsOfURL:options:queue:completionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithShareContext_X = "initWithShareContext:";
		static readonly NativeHandle selInitWithShareContext_XHandle = Selector.GetHandle ("initWithShareContext:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextureWithCGImage_Options_Error_X = "textureWithCGImage:options:error:";
		static readonly NativeHandle selTextureWithCGImage_Options_Error_XHandle = Selector.GetHandle ("textureWithCGImage:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextureWithCGImage_Options_Queue_CompletionHandler_X = "textureWithCGImage:options:queue:completionHandler:";
		static readonly NativeHandle selTextureWithCGImage_Options_Queue_CompletionHandler_XHandle = Selector.GetHandle ("textureWithCGImage:options:queue:completionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextureWithContentsOfData_Options_Error_X = "textureWithContentsOfData:options:error:";
		static readonly NativeHandle selTextureWithContentsOfData_Options_Error_XHandle = Selector.GetHandle ("textureWithContentsOfData:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextureWithContentsOfData_Options_Queue_CompletionHandler_X = "textureWithContentsOfData:options:queue:completionHandler:";
		static readonly NativeHandle selTextureWithContentsOfData_Options_Queue_CompletionHandler_XHandle = Selector.GetHandle ("textureWithContentsOfData:options:queue:completionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextureWithContentsOfFile_Options_Error_X = "textureWithContentsOfFile:options:error:";
		static readonly NativeHandle selTextureWithContentsOfFile_Options_Error_XHandle = Selector.GetHandle ("textureWithContentsOfFile:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextureWithContentsOfFile_Options_Queue_CompletionHandler_X = "textureWithContentsOfFile:options:queue:completionHandler:";
		static readonly NativeHandle selTextureWithContentsOfFile_Options_Queue_CompletionHandler_XHandle = Selector.GetHandle ("textureWithContentsOfFile:options:queue:completionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextureWithContentsOfURL_Options_Error_X = "textureWithContentsOfURL:options:error:";
		static readonly NativeHandle selTextureWithContentsOfURL_Options_Error_XHandle = Selector.GetHandle ("textureWithContentsOfURL:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextureWithContentsOfURL_Options_Queue_CompletionHandler_X = "textureWithContentsOfURL:options:queue:completionHandler:";
		static readonly NativeHandle selTextureWithContentsOfURL_Options_Queue_CompletionHandler_XHandle = Selector.GetHandle ("textureWithContentsOfURL:options:queue:completionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextureWithName_ScaleFactor_Bundle_Options_Error_X = "textureWithName:scaleFactor:bundle:options:error:";
		static readonly NativeHandle selTextureWithName_ScaleFactor_Bundle_Options_Error_XHandle = Selector.GetHandle ("textureWithName:scaleFactor:bundle:options:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextureWithName_ScaleFactor_Bundle_Options_Queue_CompletionHandler_X = "textureWithName:scaleFactor:bundle:options:queue:completionHandler:";
		static readonly NativeHandle selTextureWithName_ScaleFactor_Bundle_Options_Queue_CompletionHandler_XHandle = Selector.GetHandle ("textureWithName:scaleFactor:bundle:options:queue:completionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <param name="context">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public GLKTextureLoader (global::AppKit.NSOpenGLContext context)
			: base (NSObjectFlag.Empty)
		{
			var context__handle__ = context!.GetNonNullHandle (nameof (context));
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithShareContext_XHandle, context__handle__), "initWithShareContext:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithShareContext_XHandle, context__handle__), "initWithShareContext:");
					GC.KeepAlive (this);
				}
			}
		...
		internal unsafe virtual void BeginLoadCubeMap (NSArray filePaths, NSDictionary? textureOperations, global::CoreFoundation.DispatchQueue? queue, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGLKTextureLoaderCallback))]GLKTextureLoaderCallback onComplete)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selCubeMapWithContentsOfFiles_Options_Queue_CompletionHandler_XHandle, filePaths__handle__, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selCubeMapWithContentsOfFiles_Options_Queue_CompletionHandler_XHandle, filePaths__handle__, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual void BeginLoadCubeMap (string fileName, NSDictionary? textureOperations, global::CoreFoundation.DispatchQueue? queue, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGLKTextureLoaderCallback))]GLKTextureLoaderCallback onComplete)
		{
			...
			BlockLiteral *block_ptr_onComplete = &block_onComplete;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selCubeMapWithContentsOfFile_Options_Queue_CompletionHandler_XHandle, nsfileName, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selCubeMapWithContentsOfFile_Options_Queue_CompletionHandler_XHandle, nsfileName, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (textureOperations);
		...
		public unsafe virtual void BeginLoadCubeMap (NSUrl filePath, NSDictionary? textureOperations, global::CoreFoundation.DispatchQueue? queue, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGLKTextureLoaderCallback))]GLKTextureLoaderCallback onComplete)
		{
			...
			BlockLiteral *block_ptr_onComplete = &block_onComplete;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selCubeMapWithContentsOfURL_Options_Queue_CompletionHandler_XHandle, filePath__handle__, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selCubeMapWithContentsOfURL_Options_Queue_CompletionHandler_XHandle, filePath__handle__, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual void BeginTextureLoad (string file, NSDictionary? textureOperations, global::CoreFoundation.DispatchQueue? queue, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGLKTextureLoaderCallback))]GLKTextureLoaderCallback onComplete)
		{
			...
			BlockLiteral *block_ptr_onComplete = &block_onComplete;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selTextureWithContentsOfFile_Options_Queue_CompletionHandler_XHandle, nsfile, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selTextureWithContentsOfFile_Options_Queue_CompletionHandler_XHandle, nsfile, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (textureOperations);
		...
		public unsafe virtual void BeginTextureLoad (NSUrl filePath, NSDictionary? textureOperations, global::CoreFoundation.DispatchQueue? queue, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGLKTextureLoaderCallback))]GLKTextureLoaderCallback onComplete)
		{
			...
			BlockLiteral *block_ptr_onComplete = &block_onComplete;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selTextureWithContentsOfURL_Options_Queue_CompletionHandler_XHandle, filePath__handle__, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selTextureWithContentsOfURL_Options_Queue_CompletionHandler_XHandle, filePath__handle__, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (filePath);
		...
		public unsafe virtual void BeginTextureLoad (NSData data, NSDictionary? textureOperations, global::CoreFoundation.DispatchQueue? queue, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGLKTextureLoaderCallback))]GLKTextureLoaderCallback onComplete)
		{
			...
			BlockLiteral *block_ptr_onComplete = &block_onComplete;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selTextureWithContentsOfData_Options_Queue_CompletionHandler_XHandle, data__handle__, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selTextureWithContentsOfData_Options_Queue_CompletionHandler_XHandle, data__handle__, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (data);
		...
		public unsafe virtual void BeginTextureLoad (CGImage image, NSDictionary? textureOperations, global::CoreFoundation.DispatchQueue? queue, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGLKTextureLoaderCallback))]GLKTextureLoaderCallback onComplete)
		{
			...
			BlockLiteral *block_ptr_onComplete = &block_onComplete;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selTextureWithCGImage_Options_Queue_CompletionHandler_XHandle, image.Handle, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selTextureWithCGImage_Options_Queue_CompletionHandler_XHandle, image.Handle, textureOperations__handle__, queue__handle__, (IntPtr) block_ptr_onComplete);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (image);
		...
		public unsafe virtual void BeginTextureLoad (string name, nfloat scaleFactor, NSBundle? bundle, NSDictionary<NSString, NSNumber>? options, global::CoreFoundation.DispatchQueue? queue, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGLKTextureLoaderCallback))]GLKTextureLoaderCallback block)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_nfloat_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selTextureWithName_ScaleFactor_Bundle_Options_Queue_CompletionHandler_XHandle, nsname, scaleFactor, bundle__handle__, options__handle__, queue__handle__, (IntPtr) block_ptr_block);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_nfloat_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selTextureWithName_ScaleFactor_Bundle_Options_Queue_CompletionHandler_XHandle, nsname, scaleFactor, bundle__handle__, options__handle__, queue__handle__, (IntPtr) block_ptr_block);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (bundle);
		...
		public unsafe static GLKTextureInfo? CubeMapFromFile (string path, NSDictionary? textureOperations, out NSError error)
		{
			...
			GLKTextureInfo? ret;
			ret =  Runtime.GetNSObject<GLKTextureInfo> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (class_ptr, selCubeMapWithContentsOfFile_Options_Error_XHandle, nspath, textureOperations__handle__, &errorValue), false)!;
			GC.KeepAlive (textureOperations);
		...
		internal unsafe static GLKTextureInfo? CubeMapFromFiles (NSArray paths, NSDictionary? textureOperations, out NSError error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			GLKTextureInfo? ret;
			ret =  Runtime.GetNSObject<GLKTextureInfo> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (class_ptr, selCubeMapWithContentsOfFiles_Options_Error_XHandle, paths__handle__, textureOperations__handle__, &errorValue), false)!;
			GC.KeepAlive (paths);
			GC.KeepAlive (textureOperations);
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		...
		public unsafe static GLKTextureInfo? CubeMapFromUrl (NSUrl url, NSDictionary? textureOperations, out NSError error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			GLKTextureInfo? ret;
			ret =  Runtime.GetNSObject<GLKTextureInfo> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (class_ptr, selCubeMapWithContentsOfURL_Options_Error_XHandle, url__handle__, textureOperations__handle__, &errorValue), false)!;
			GC.KeepAlive (url);
			GC.KeepAlive (textureOperations);
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		...
		public unsafe static GLKTextureInfo? FromData (NSData data, NSDictionary? textureOperations, out NSError error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			GLKTextureInfo? ret;
			ret =  Runtime.GetNSObject<GLKTextureInfo> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (class_ptr, selTextureWithContentsOfData_Options_Error_XHandle, data__handle__, textureOperations__handle__, &errorValue), false)!;
			GC.KeepAlive (data);
			GC.KeepAlive (textureOperations);
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		...
		public unsafe static GLKTextureInfo? FromFile (string path, NSDictionary? textureOperations, out NSError error)
		{
			...
			var nspath = CFString.CreateNative (path);
			GLKTextureInfo? ret;
			ret =  Runtime.GetNSObject<GLKTextureInfo> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (class_ptr, selTextureWithContentsOfFile_Options_Error_XHandle, nspath, textureOperations__handle__, &errorValue), false)!;
			GC.KeepAlive (textureOperations);
			CFString.ReleaseNative (nspath);
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
		...
		public unsafe static GLKTextureInfo? FromImage (CGImage cgImage, NSDictionary? textureOperations, out NSError error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			GLKTextureInfo? ret;
			ret =  Runtime.GetNSObject<GLKTextureInfo> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (class_ptr, selTextureWithCGImage_Options_Error_XHandle, cgImage.Handle, textureOperations__handle__, &errorValue), false)!;
		...
		public unsafe static GLKTextureInfo? FromName (string name, nfloat scaleFactor, NSBundle? bundle, NSDictionary<NSString, NSNumber>? options, out NSError outError)
		{
			...
			var nsname = CFString.CreateNative (name);
			GLKTextureInfo? ret;
			ret =  Runtime.GetNSObject<GLKTextureInfo> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_nfloat_NativeHandle_NativeHandle_ref_NativeHandle (class_ptr, selTextureWithName_ScaleFactor_Bundle_Options_Error_XHandle, nsname, scaleFactor, bundle__handle__, options__handle__, &outErrorValue), false)!;
			GC.KeepAlive (bundle);
			GC.KeepAlive (options);
			CFString.ReleaseNative (nsname);
		...
		public unsafe static GLKTextureInfo? FromUrl (NSUrl url, NSDictionary? textureOperations, out NSError error)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			GLKTextureInfo? ret;
			ret =  Runtime.GetNSObject<GLKTextureInfo> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (class_ptr, selTextureWithContentsOfURL_Options_Error_XHandle, url__handle__, textureOperations__handle__, &errorValue), false)!;
			GC.KeepAlive (url);
			GC.KeepAlive (textureOperations);
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			return ret!;
