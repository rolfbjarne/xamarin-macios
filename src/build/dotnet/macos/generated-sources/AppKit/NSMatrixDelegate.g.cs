...
namespace AppKit {
	...
	/// <summary>This interface represents the Objective-C protocol <c>NSMatrixDelegate</c>.</summary>
	/// <remarks>
	...
	public partial interface INSMatrixDelegate : INativeObject, IDisposable, 
		AppKit.INSControlTextEditingDelegate
	{
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSMatrixDelegateWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static INSMatrixDelegate ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class NSMatrixDelegateWrapper : BaseWrapper, INSMatrixDelegate {
		public NSMatrixDelegateWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSMatrixDelegateWrapper))]
		static NSMatrixDelegateWrapper ()
		{
			GC.KeepAlive (null);
		}
	}
...
namespace AppKit {
	/// <summary>
	///   <para>This is a class that implements the interface <see cref="INSMatrixDelegate" /> (for the protocol <c>NSMatrixDelegate</c>).</para>
	///   <para>Subclass this class to easily create a type that implements the protocol.</para>
	///   <para>An alternative is to create a subclass of <see cref="NSObject" /> and then implemented the interface <see cref="INSMatrixDelegate" />.</para>
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__AppKit_NSMatrixDelegate", false)]
	[Model]
	[UnsupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
	public unsafe partial class NSMatrixDelegate : NSObject, INSMatrixDelegate, INSControlTextEditingDelegate {
		/// <summary>Creates a new <see cref="NSMatrixDelegate" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public NSMatrixDelegate () : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSMatrixDelegate (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = false;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSMatrixDelegate (NativeHandle handle) : base (handle)
		{
			IsDirectBinding = false;
		}
