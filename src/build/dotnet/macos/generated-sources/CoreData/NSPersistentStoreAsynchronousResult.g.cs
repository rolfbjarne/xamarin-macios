...
#nullable enable
namespace CoreData {
	/// <summary>Class that represents the results of an asynchronous request that was made of a persistent data store.</summary><remarks>To be added.</remarks><related type="externalDocumentation" href="https://developer.apple.com/reference/CoreData/NSPersistentStoreAsynchronousResult">Apple documentation for <c>NSPersistentStoreAsynchronousResult</c></related>
	[Register("NSPersistentStoreAsynchronousResult", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class NSPersistentStoreAsynchronousResult : NSPersistentStoreResult {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selOperationErrorX = "operationError";
		static readonly NativeHandle selOperationErrorXHandle = Selector.GetHandle ("operationError");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selProgressX = "progress";
		static readonly NativeHandle selProgressXHandle = Selector.GetHandle ("progress");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSPersistentStoreAsynchronousResult");
		...
		/// <summary>Creates a new <see cref="NSPersistentStoreAsynchronousResult" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public NSPersistentStoreAsynchronousResult () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSPersistentStoreAsynchronousResult (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSPersistentStoreAsynchronousResult (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual NSError? OperationError {
			...
			get {
				NSError? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSError> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selOperationErrorXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSError> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selOperationErrorXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
