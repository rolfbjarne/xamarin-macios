...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIFilter" /> that blurs based on a black-and-white mask.</summary><remarks><para>The blur radius varies from 0 to <see cref="CoreImage.CIMaskedVariableBlur.Radius" />. In the mask image, pure black is 0 radius (no blur) and white is maximum radius (blurriest).</para></remarks>
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public partial class CIMaskedVariableBlur : CIFilter, ICIMaskedVariableBlurProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIMaskedVariableBlur" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIMaskedVariableBlur () : base ("CIMaskedVariableBlur")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMaskedVariableBlur (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMaskedVariableBlur (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMaskedVariableBlur (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIMaskedVariableBlurProtocol protocol members 
