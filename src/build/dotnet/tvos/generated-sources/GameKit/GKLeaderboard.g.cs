...
namespace GameKit {
	...
	public unsafe partial class GKLeaderboard : NSObject {
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void LoadLeaderboards ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V62))]global::System.Action<GKLeaderboard[], NSError>? completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			using var block_completionHandler = Trampolines.SDActionArity2V62.CreateNullableBlock (completionHandler);
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void SubmitScore (nint score, nuint context, GKPlayer player, string[] leaderboardIds, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V10))]global::System.Action<NSError> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void SubmitScore (nint score, nuint context, GKPlayer player, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V10))]global::System.Action<NSError> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var player__handle__ = player!.GetNonNullHandle (nameof (player));
			if (completionHandler is null)
