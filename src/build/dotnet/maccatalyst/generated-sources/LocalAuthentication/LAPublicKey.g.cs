...
namespace LocalAuthentication {
	...
	public unsafe partial class LAPublicKey : NSObject {
		...
		public virtual bool CanEncrypt (global::Security.SecKeyAlgorithm algorithm)
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_int (this.Handle, Selector.GetHandle ("canEncryptUsingSecKeyAlgorithm:"), (int)algorithm);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_int (&__objc_super__, Selector.GetHandle ("canEncryptUsingSecKeyAlgorithm:"), (int)algorithm);
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public virtual bool CanVerify (global::Security.SecKeyAlgorithm algorithm)
		{
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_int (this.Handle, Selector.GetHandle ("canVerifyUsingSecKeyAlgorithm:"), (int)algorithm);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_int (&__objc_super__, Selector.GetHandle ("canVerifyUsingSecKeyAlgorithm:"), (int)algorithm);
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public unsafe virtual void Encrypt (NSData data, global::Security.SecKeyAlgorithm algorithm, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDLAPublicKeyCompletionHandler))]LAPublicKeyCompletionHandler handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_int_NativeHandle (&__objc_super__, Selector.GetHandle ("encryptData:secKeyAlgorithm:completion:"), data__handle__, (int)algorithm, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (data);
		...
		public unsafe virtual void ExportBytes ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDLAPublicKeyCompletionHandler))]LAPublicKeyCompletionHandler handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("exportBytesWithCompletion:"), (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public unsafe virtual void Verify (NSData signedData, NSData signature, global::Security.SecKeyAlgorithm algorithm, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDLAPublicKeyVerifyDataCompletionHandler))]LAPublicKeyVerifyDataCompletionHandler handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_int_NativeHandle (&__objc_super__, Selector.GetHandle ("verifyData:signature:secKeyAlgorithm:completion:"), signedData__handle__, signature__handle__, (int)algorithm, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
