...
namespace CoreImage {
	...
	public partial class CIBokehBlur : CILinearBlur, ICIBokehBlurProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIBokehBlur" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIBokehBlur () : base ("CIBokehBlur")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBokehBlur (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBokehBlur (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBokehBlur (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIBokehBlurProtocol protocol members 
