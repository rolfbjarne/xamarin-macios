...
namespace WebKit {
	...
	public unsafe partial class DomHtmlHeadingElement : DomHtmlElement {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("DOMHTMLHeadingElement");
		...
		protected DomHtmlHeadingElement (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal DomHtmlHeadingElement (NativeHandle handle) : base (handle)
		{
		}
