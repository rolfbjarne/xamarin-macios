...
namespace UIKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "GetSelectionFollowsFocusForItem", Selector = "collectionView:selectionFollowsFocusForItemAtIndexPath:", ReturnType = typeof (bool), ParameterType = new Type [] { typeof (UICollectionView), typeof (NSIndexPath) }, ParameterByRef = new bool [] { false, false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ShouldSpringLoadItem", Selector = "collectionView:shouldSpringLoadItemAtIndexPath:withContext:", ReturnType = typeof (bool), ParameterType = new Type [] { typeof (UICollectionView), typeof (NSIndexPath), typeof (IUISpringLoadedInteractionContext) }, ParameterByRef = new bool [] { false, false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ShouldBeginMultipleSelectionInteraction", Selector = "collectionView:shouldBeginMultipleSelectionInteractionAtIndexPath:", ReturnType = typeof (bool), ParameterType = new Type [] { typeof (UICollectionView), typeof (NSIndexPath) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidBeginMultipleSelectionInteraction", Selector = "collectionView:didBeginMultipleSelectionInteractionAtIndexPath:", ParameterType = new Type [] { typeof (UICollectionView), typeof (NSIndexPath) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidEndMultipleSelectionInteraction", Selector = "collectionViewDidEndMultipleSelectionInteraction:", ParameterType = new Type [] { typeof (UICollectionView) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "GetContextMenuConfiguration", Selector = "collectionView:contextMenuConfigurationForItemAtIndexPath:point:", ReturnType = typeof (UIContextMenuConfiguration), ParameterType = new Type [] { typeof (UICollectionView), typeof (NSIndexPath), typeof (CGPoint) }, ParameterByRef = new bool [] { false, false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "GetPreviewForHighlightingContextMenu", Selector = "collectionView:previewForHighlightingContextMenuWithConfiguration:", ReturnType = typeof (UITargetedPreview), ParameterType = new Type [] { typeof (UICollectionView), typeof (UIContextMenuConfiguration) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "GetPreviewForDismissingContextMenu", Selector = "collectionView:previewForDismissingContextMenuWithConfiguration:", ReturnType = typeof (UITargetedPreview), ParameterType = new Type [] { typeof (UICollectionView), typeof (UIContextMenuConfiguration) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillPerformPreviewAction", Selector = "collectionView:willPerformPreviewActionForMenuWithConfiguration:animator:", ParameterType = new Type [] { typeof (UICollectionView), typeof (UIContextMenuConfiguration), typeof (IUIContextMenuInteractionCommitAnimating) }, ParameterByRef = new bool [] { false, false, false })]
		...
		UIKit.IUIScrollViewDelegate
	{
		...
		{
			return _GetSelectionFollowsFocusForItem (this, collectionView, indexPath);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios15.0")]
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static bool _GetSelectionFollowsFocusForItem (IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		{
			return _ShouldSpringLoadItem (this, collectionView, indexPath, context);
		}
		/// <param name="collectionView">The collection view that originated the request.</param><param name="indexPath">The index path to the item.</param><param name="context">The spring-loaded interaction context.</param><summary>Method that is called to indicate whether the identified item should springload in the specified context.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static bool _ShouldSpringLoadItem (IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath, IUISpringLoadedInteractionContext context)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		{
			return _ShouldBeginMultipleSelectionInteraction (this, collectionView, indexPath);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static bool _ShouldBeginMultipleSelectionInteraction (IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		{
			_DidBeginMultipleSelectionInteraction (this, collectionView, indexPath);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _DidBeginMultipleSelectionInteraction (IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		{
			_DidEndMultipleSelectionInteraction (this, collectionView);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _DidEndMultipleSelectionInteraction (IUICollectionViewDelegate This, UICollectionView collectionView)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
		...
		{
			return _GetContextMenuConfiguration (this, collectionView, indexPath, point);
		}
		[ObsoletedOSPlatform ("ios16.0")]
		[ObsoletedOSPlatform ("maccatalyst16.0")]
		[UnsupportedOSPlatform ("tvos")]
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static UIContextMenuConfiguration? _GetContextMenuConfiguration (IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath, CGPoint point)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		{
			return _GetPreviewForHighlightingContextMenu (this, collectionView, configuration);
		}
		[ObsoletedOSPlatform ("ios16.0")]
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios13.0")]
		...
		[ObsoletedOSPlatform ("maccatalyst16.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static UITargetedPreview? _GetPreviewForHighlightingContextMenu (IUICollectionViewDelegate This, UICollectionView collectionView, UIContextMenuConfiguration configuration)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
		...
		{
			return _GetPreviewForDismissingContextMenu (this, collectionView, configuration);
		}
		[ObsoletedOSPlatform ("ios16.0")]
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios13.0")]
		...
		[ObsoletedOSPlatform ("maccatalyst16.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static UITargetedPreview? _GetPreviewForDismissingContextMenu (IUICollectionViewDelegate This, UICollectionView collectionView, UIContextMenuConfiguration configuration)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var configuration__handle__ = configuration!.GetNonNullHandle (nameof (configuration));
		...
		{
			_WillPerformPreviewAction (this, collectionView, configuration, animator);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _WillPerformPreviewAction (IUICollectionViewDelegate This, UICollectionView collectionView, UIContextMenuConfiguration configuration, IUIContextMenuInteractionCommitAnimating animator)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var configuration__handle__ = configuration!.GetNonNullHandle (nameof (configuration));
		...
		{
			return _GetSceneActivationConfigurationForItem (this, collectionView, indexPath, point);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios15.0")]
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static UIWindowSceneActivationConfiguration? _GetSceneActivationConfigurationForItem (IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath, CGPoint point)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		[DynamicDependencyAttribute ("DidBeginMultipleSelectionInteraction(UIKit.UICollectionView,Foundation.NSIndexPath)")]
		[DynamicDependencyAttribute ("DidEndMultipleSelectionInteraction(UIKit.UICollectionView)")]
		...
		[DynamicDependencyAttribute ("GetPreviewForDismissingContextMenu(UIKit.UICollectionView,UIKit.UIContextMenuConfiguration)")]
		[DynamicDependencyAttribute ("GetPreviewForHighlightingContextMenu(UIKit.UICollectionView,UIKit.UIContextMenuConfiguration)")]
		[DynamicDependencyAttribute ("GetSceneActivationConfigurationForItem(UIKit.UICollectionView,Foundation.NSIndexPath,CoreGraphics.CGPoint)")]
		[DynamicDependencyAttribute ("GetSelectionFollowsFocusForItem(UIKit.UICollectionView,Foundation.NSIndexPath)")]
		...
		[DynamicDependencyAttribute ("ShouldBeginMultipleSelectionInteraction(UIKit.UICollectionView,Foundation.NSIndexPath)")]
		...
		[DynamicDependencyAttribute ("ShouldSpringLoadItem(UIKit.UICollectionView,Foundation.NSIndexPath,UIKit.IUISpringLoadedInteractionContext)")]
		...
		[DynamicDependencyAttribute ("WillPerformPreviewAction(UIKit.UICollectionView,UIKit.UIContextMenuConfiguration,UIKit.IUIContextMenuInteractionCommitAnimating)")]
	...
	public unsafe static partial class UICollectionViewDelegate_Extensions {
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static bool GetSelectionFollowsFocusForItem (this IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static bool ShouldSpringLoadItem (this IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath, IUISpringLoadedInteractionContext context)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static bool ShouldBeginMultipleSelectionInteraction (this IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void DidBeginMultipleSelectionInteraction (this IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static UIContextMenuConfiguration? GetContextMenuConfiguration (this IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath, CGPoint point)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static UIWindowSceneActivationConfiguration? GetSceneActivationConfigurationForItem (this IUICollectionViewDelegate This, UICollectionView collectionView, NSIndexPath indexPath, CGPoint point)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var collectionView__handle__ = collectionView!.GetNonNullHandle (nameof (collectionView));
			var indexPath__handle__ = indexPath!.GetNonNullHandle (nameof (indexPath));
...
namespace UIKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_MacCatalyst__UIKit_UICollectionViewDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("tvos")]
