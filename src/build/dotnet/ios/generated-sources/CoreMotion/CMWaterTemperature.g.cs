...
namespace CoreMotion {
	[Register("CMWaterTemperature", true)]
	[UnsupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("ios16.0")]
	[UnsupportedOSPlatform ("maccatalyst")]
	[UnsupportedOSPlatform ("tvos")]
	public unsafe partial class CMWaterTemperature : NSObject, INSCoding, INSCopying, INSSecureCoding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("CMWaterTemperature");
		...
		/// <summary>Creates a new <see cref="CMWaterTemperature" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public CMWaterTemperature () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		public CMWaterTemperature (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected CMWaterTemperature (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CMWaterTemperature (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSMeasurement<NSUnitTemperature> TemperatureUncertainty {
			[Export ("temperatureUncertainty")]
			get {
				NSMeasurement<NSUnitTemperature>? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSMeasurement<NSUnitTemperature>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("temperatureUncertainty")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSMeasurement<NSUnitTemperature>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("temperatureUncertainty")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
