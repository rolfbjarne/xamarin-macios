...
namespace MonoTouchFixtures.Vision {
	...
	public class VNGetCameraRelativePositionTest {
		...
		public void GetCameraRelativePositionTest ()
		{
			...
			ClassicAssert.Null (error, $"VNImageRequestHandler.Perform should not return an error {error}");
			...
			ClassicAssert.NotNull (observation, "VNImageRequestHandler.Perform should return a result.");
			...
			ClassicAssert.Null (observationError, $"GetCameraRelativePosition should not return an error {observationError}");
