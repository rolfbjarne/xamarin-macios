...
namespace GameController {
	...
	interface GCDevicePhysicalInputState {
		...
		[Abstract]
		[Export ("elements")]
		GCPhysicalInputElementCollection<NSString, IGCPhysicalInputElement> WeakElements { get; }

		[Abstract]
		[Export ("buttons")]
		GCPhysicalInputElementCollection<NSString, IGCButtonElement> WeakButtons { get; }

		[Abstract]
		[Export ("axes")]
		GCPhysicalInputElementCollection<NSString, IGCAxisElement> WeakAxes { get; }

		[Abstract]
		[Export ("switches")]
		GCPhysicalInputElementCollection<NSString, IGCSwitchElement> WeakSwitches { get; }

		[Abstract]
		[Export ("dpads")]
		GCPhysicalInputElementCollection<NSString, IGCDirectionPadElement> Dpads { get; }

		// TODO: strongly type above stuff.
...
#pragma warning restore
	...
	interface GCPhysicalInputSource
	{
		...
		// FIXME: strongly typed bindings for ElementAliases
		// @required @property (readonly, copy) NSSet<NSString<GCPhysicalInputElementName> *> * _Nonnull elementAliases;
