	...
	public unsafe partial class MKMapConfiguration : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		public virtual MKMapElevationStyle ElevationStyle {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (MapKit.MKMapElevationStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("elevationStyle"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MapKit.MKMapElevationStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("elevationStyle"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
