...
namespace CoreML {
	...
	public unsafe partial class MLModelCollection : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static NSProgress BeginAccessingModelCollection (string identifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V64))]global::System.Action<MLModelCollection, NSError> completionHandler)
		{
			...
			NSProgress? ret;
			ret =  Runtime.GetNSObject<NSProgress> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("beginAccessingModelCollectionWithIdentifier:completionHandler:"), nsidentifier, (IntPtr) block_ptr_completionHandler), false)!;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void EndAccessingModelCollection (string identifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V0))]global::System.Action<bool, NSError> completionHandler)
		{
			if (identifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (identifier));
			if (completionHandler is null)
			...
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("endAccessingModelCollectionWithIdentifier:completionHandler:"), nsidentifier, (IntPtr) block_ptr_completionHandler);
			CFString.ReleaseNative (nsidentifier);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual string DeploymentId {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("deploymentID")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("deploymentID")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual NSDictionary<NSString, MLModelCollectionEntry> Entries {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDictionary<NSString, MLModelCollectionEntry>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("entries")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDictionary<NSString, MLModelCollectionEntry>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("entries")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
