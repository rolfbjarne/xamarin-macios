...
namespace CoreImage {
	...
	public partial class CIAreaMaximumAlpha : CIReductionFilter, ICIAreaMaximumAlphaProtocol, ICIAreaReductionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIAreaMaximumAlpha" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIAreaMaximumAlpha () : base ("CIAreaMaximumAlpha")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAreaMaximumAlpha (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAreaMaximumAlpha (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAreaMaximumAlpha (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
