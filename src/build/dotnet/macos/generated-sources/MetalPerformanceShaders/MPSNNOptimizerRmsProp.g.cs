...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSNNOptimizerRmsProp : MPSNNOptimizer {
		...
		const string selDecayX = "decay";
		static readonly NativeHandle selDecayXHandle = Selector.GetHandle ("decay");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_BatchNormalizationGradientState_BatchNormalizationSourceState_InputSumOfSquaresVectors_ResultState_X = "encodeToCommandBuffer:batchNormalizationGradientState:batchNormalizationSourceState:inputSumOfSquaresVectors:resultState:";
		static readonly NativeHandle selEncodeToCommandBuffer_BatchNormalizationGradientState_BatchNormalizationSourceState_InputSumOfSquaresVectors_ResultState_XHandle = Selector.GetHandle ("encodeToCommandBuffer:batchNormalizationGradientState:batchNormalizationSourceState:inputSumOfSquaresVectors:resultState:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_BatchNormalizationState_InputSumOfSquaresVectors_ResultState_X = "encodeToCommandBuffer:batchNormalizationState:inputSumOfSquaresVectors:resultState:";
		static readonly NativeHandle selEncodeToCommandBuffer_BatchNormalizationState_InputSumOfSquaresVectors_ResultState_XHandle = Selector.GetHandle ("encodeToCommandBuffer:batchNormalizationState:inputSumOfSquaresVectors:resultState:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_ConvolutionGradientState_ConvolutionSourceState_InputSumOfSquaresVectors_ResultState_X = "encodeToCommandBuffer:convolutionGradientState:convolutionSourceState:inputSumOfSquaresVectors:resultState:";
		static readonly NativeHandle selEncodeToCommandBuffer_ConvolutionGradientState_ConvolutionSourceState_InputSumOfSquaresVectors_ResultState_XHandle = Selector.GetHandle ("encodeToCommandBuffer:convolutionGradientState:convolutionSourceState:inputSumOfSquaresVectors:resultState:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_InputGradientMatrix_InputValuesMatrix_InputSumOfSquaresMatrix_ResultValuesMatrix_X = "encodeToCommandBuffer:inputGradientMatrix:inputValuesMatrix:inputSumOfSquaresMatrix:resultValuesMatrix:";
		static readonly NativeHandle selEncodeToCommandBuffer_InputGradientMatrix_InputValuesMatrix_InputSumOfSquaresMatrix_ResultValuesMatrix_XHandle = Selector.GetHandle ("encodeToCommandBuffer:inputGradientMatrix:inputValuesMatrix:inputSumOfSquaresMatrix:resultValuesMatrix:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_InputGradientVector_InputValuesVector_InputSumOfSquaresVector_ResultValuesVector_X = "encodeToCommandBuffer:inputGradientVector:inputValuesVector:inputSumOfSquaresVector:resultValuesVector:";
		static readonly NativeHandle selEncodeToCommandBuffer_InputGradientVector_InputValuesVector_InputSumOfSquaresVector_ResultValuesVector_XHandle = Selector.GetHandle ("encodeToCommandBuffer:inputGradientVector:inputValuesVector:inputSumOfSquaresVector:resultValuesVector:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEpsilonX = "epsilon";
		static readonly NativeHandle selEpsilonXHandle = Selector.GetHandle ("epsilon");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithDevice_Decay_Epsilon_OptimizerDescriptor_X = "initWithDevice:decay:epsilon:optimizerDescriptor:";
		static readonly NativeHandle selInitWithDevice_Decay_Epsilon_OptimizerDescriptor_XHandle = Selector.GetHandle ("initWithDevice:decay:epsilon:optimizerDescriptor:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithDevice_LearningRate_X = "initWithDevice:learningRate:";
		static readonly NativeHandle selInitWithDevice_LearningRate_XHandle = Selector.GetHandle ("initWithDevice:learningRate:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_float (this.Handle, selInitWithDevice_LearningRate_XHandle, device__handle__, learningRate), "initWithDevice:learningRate:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_float (&__objc_super__, selInitWithDevice_LearningRate_XHandle, device__handle__, learningRate), "initWithDevice:learningRate:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_Double_float_NativeHandle (this.Handle, selInitWithDevice_Decay_Epsilon_OptimizerDescriptor_XHandle, device__handle__, decay, epsilon, optimizerDescriptor__handle__), "initWithDevice:decay:epsilon:optimizerDescriptor:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_Double_float_NativeHandle (&__objc_super__, selInitWithDevice_Decay_Epsilon_OptimizerDescriptor_XHandle, device__handle__, decay, epsilon, optimizerDescriptor__handle__), "initWithDevice:decay:epsilon:optimizerDescriptor:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual void Encode (global::Metal.IMTLCommandBuffer commandBuffer, MPSVector inputGradientVector, MPSVector inputValuesVector, MPSVector inputSumOfSquaresVector, MPSVector resultValuesVector)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeToCommandBuffer_InputGradientVector_InputValuesVector_InputSumOfSquaresVector_ResultValuesVector_XHandle, commandBuffer__handle__, inputGradientVector__handle__, inputValuesVector__handle__, inputSumOfSquaresVector__handle__, resultValuesVector__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeToCommandBuffer_InputGradientVector_InputValuesVector_InputSumOfSquaresVector_ResultValuesVector_XHandle, commandBuffer__handle__, inputGradientVector__handle__, inputValuesVector__handle__, inputSumOfSquaresVector__handle__, resultValuesVector__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void Encode (global::Metal.IMTLCommandBuffer commandBuffer, MPSCnnConvolutionGradientState convolutionGradientState, MPSCnnConvolutionWeightsAndBiasesState convolutionSourceState, NSArray<MPSVector>? inputSumOfSquaresVectors, MPSCnnConvolutionWeightsAndBiasesState resultState)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeToCommandBuffer_ConvolutionGradientState_ConvolutionSourceState_InputSumOfSquaresVectors_ResultState_XHandle, commandBuffer__handle__, convolutionGradientState__handle__, convolutionSourceState__handle__, inputSumOfSquaresVectors__handle__, resultState__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeToCommandBuffer_ConvolutionGradientState_ConvolutionSourceState_InputSumOfSquaresVectors_ResultState_XHandle, commandBuffer__handle__, convolutionGradientState__handle__, convolutionSourceState__handle__, inputSumOfSquaresVectors__handle__, resultState__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
		...
		public virtual void Encode (global::Metal.IMTLCommandBuffer commandBuffer, MPSCnnBatchNormalizationState batchNormalizationState, NSArray<MPSVector>? inputSumOfSquaresVectors, MPSCnnNormalizationGammaAndBetaState resultState)
		{
			...
			var resultState__handle__ = resultState!.GetNonNullHandle (nameof (resultState));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeToCommandBuffer_BatchNormalizationState_InputSumOfSquaresVectors_ResultState_XHandle, commandBuffer__handle__, batchNormalizationState__handle__, inputSumOfSquaresVectors__handle__, resultState__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeToCommandBuffer_BatchNormalizationState_InputSumOfSquaresVectors_ResultState_XHandle, commandBuffer__handle__, batchNormalizationState__handle__, inputSumOfSquaresVectors__handle__, resultState__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
		...
		public virtual void Encode (global::Metal.IMTLCommandBuffer commandBuffer, MPSCnnBatchNormalizationState batchNormalizationGradientState, MPSCnnBatchNormalizationState batchNormalizationSourceState, NSArray<MPSVector>? inputSumOfSquaresVectors, MPSCnnNormalizationGammaAndBetaState resultState)
		{
			...
			var resultState__handle__ = resultState!.GetNonNullHandle (nameof (resultState));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeToCommandBuffer_BatchNormalizationGradientState_BatchNormalizationSourceState_InputSumOfSquaresVectors_ResultState_XHandle, commandBuffer__handle__, batchNormalizationGradientState__handle__, batchNormalizationSourceState__handle__, inputSumOfSquaresVectors__handle__, resultState__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeToCommandBuffer_BatchNormalizationGradientState_BatchNormalizationSourceState_InputSumOfSquaresVectors_ResultState_XHandle, commandBuffer__handle__, batchNormalizationGradientState__handle__, batchNormalizationSourceState__handle__, inputSumOfSquaresVectors__handle__, resultState__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
		...
		public virtual void Encode (global::Metal.IMTLCommandBuffer commandBuffer, MPSMatrix inputGradientMatrix, MPSMatrix inputValuesMatrix, MPSMatrix inputSumOfSquaresMatrix, MPSMatrix resultValuesMatrix)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeToCommandBuffer_InputGradientMatrix_InputValuesMatrix_InputSumOfSquaresMatrix_ResultValuesMatrix_XHandle, commandBuffer__handle__, inputGradientMatrix__handle__, inputValuesMatrix__handle__, inputSumOfSquaresMatrix__handle__, resultValuesMatrix__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeToCommandBuffer_InputGradientMatrix_InputValuesMatrix_InputSumOfSquaresMatrix_ResultValuesMatrix_XHandle, commandBuffer__handle__, inputGradientMatrix__handle__, inputValuesMatrix__handle__, inputSumOfSquaresMatrix__handle__, resultValuesMatrix__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
		...
		public virtual double Decay {
			...
			get {
				double ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.Double_objc_msgSend (this.Handle, selDecayXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.Double_objc_msgSendSuper (&__objc_super__, selDecayXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
