...
#nullable enable
namespace CoreImage {
	/// <summary>Makes the pixels at the circumference of a circle spread out to the boundaries of the image.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/circle_splash_distortion.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CICircleSplashDistortion : CIDistortionFilter, ICICircleSplashDistortionProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CICircleSplashDistortion" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CICircleSplashDistortion (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CICircleSplashDistortion (NSObjectFlag t) : base (t)
		{
		}
		...
		public CICircleSplashDistortion (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CICircleSplashDistortionProtocol protocol members 
