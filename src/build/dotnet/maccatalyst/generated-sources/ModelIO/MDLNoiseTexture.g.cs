...
namespace ModelIO {
	...
	public unsafe partial class MDLNoiseTexture : MDLTexture {
			...
			: base (NSObjectFlag.Empty)
		{
			var nsname = CFString.CreateNative (name);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.xamarin_simd__NativeHandle_objc_msgSend_float_NativeHandle_NVector2i_int_IntPtr_bool (this.Handle, Selector.GetHandle ("initScalarNoiseWithSmoothness:name:textureDimensions:channelCount:channelEncoding:grayscale:"), smoothness, nsname, textureDimensions, channelCount, (IntPtr) (long) channelEncoding, grayscale ? (byte) 1 : (byte) 0), "initScalarNoiseWithSmoothness:name:textureDimensions:channelCount:channelEncoding:grayscale:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.xamarin_simd__NativeHandle_objc_msgSendSuper_float_NativeHandle_NVector2i_int_IntPtr_bool (&__objc_super__, Selector.GetHandle ("initScalarNoiseWithSmoothness:name:textureDimensions:channelCount:channelEncoding:grayscale:"), smoothness, nsname, textureDimensions, channelCount, (IntPtr) (long) channelEncoding, grayscale ? (byte) 1 : (byte) 0), "initScalarNoiseWithSmoothness:name:textureDimensions:channelCount:channelEncoding:grayscale:");
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nsname);
		...
		internal virtual nint _InitCellularNoiseWithFrequency (float frequency, string? name, NVector2i textureDimensions, MDLTextureChannelEncoding channelEncoding)
		{
			...
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.xamarin_simd__IntPtr_objc_msgSend_float_NativeHandle_NVector2i_IntPtr (this.Handle, Selector.GetHandle ("initCellularNoiseWithFrequency:name:textureDimensions:channelEncoding:"), frequency, nsname, textureDimensions, (IntPtr) (long) channelEncoding);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.xamarin_simd__IntPtr_objc_msgSendSuper_float_NativeHandle_NVector2i_IntPtr (&__objc_super__, Selector.GetHandle ("initCellularNoiseWithFrequency:name:textureDimensions:channelEncoding:"), frequency, nsname, textureDimensions, (IntPtr) (long) channelEncoding);
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nsname);
		...
		internal virtual nint _InitVectorNoiseWithSmoothness (float smoothness, string? name, NVector2i textureDimensions, MDLTextureChannelEncoding channelEncoding)
		{
			...
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.xamarin_simd__IntPtr_objc_msgSend_float_NativeHandle_NVector2i_IntPtr (this.Handle, Selector.GetHandle ("initVectorNoiseWithSmoothness:name:textureDimensions:channelEncoding:"), smoothness, nsname, textureDimensions, (IntPtr) (long) channelEncoding);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.xamarin_simd__IntPtr_objc_msgSendSuper_float_NativeHandle_NVector2i_IntPtr (&__objc_super__, Selector.GetHandle ("initVectorNoiseWithSmoothness:name:textureDimensions:channelEncoding:"), smoothness, nsname, textureDimensions, (IntPtr) (long) channelEncoding);
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nsname);
