...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSnnLocalCorrelation : MPSNNReduceBinary {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithDevice_WindowInX_WindowInY_StrideInX_StrideInY_X = "initWithDevice:windowInX:windowInY:strideInX:strideInY:";
		static readonly NativeHandle selInitWithDevice_WindowInX_WindowInY_StrideInX_StrideInY_XHandle = Selector.GetHandle ("initWithDevice:windowInX:windowInY:strideInX:strideInY:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetWindowInX_X = "setWindowInX:";
		static readonly NativeHandle selSetWindowInX_XHandle = Selector.GetHandle ("setWindowInX:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetWindowInY_X = "setWindowInY:";
		static readonly NativeHandle selSetWindowInY_XHandle = Selector.GetHandle ("setWindowInY:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selWindowInXX = "windowInX";
		static readonly NativeHandle selWindowInXXHandle = Selector.GetHandle ("windowInX");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selWindowInYX = "windowInY";
		static readonly NativeHandle selWindowInYXHandle = Selector.GetHandle ("windowInY");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual nuint WindowInX {
			...
			get {
				nuint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selWindowInXXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selWindowInXXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selSetWindowInX_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selSetWindowInX_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual nuint WindowInY {
			...
			get {
				nuint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selWindowInYXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selWindowInYXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selSetWindowInY_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selSetWindowInY_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
