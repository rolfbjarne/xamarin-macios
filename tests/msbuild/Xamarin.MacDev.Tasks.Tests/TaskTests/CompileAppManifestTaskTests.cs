...
namespace Xamarin.MacDev.Tasks {
	...
	public class CompileAppManifestTaskTests : TestBase {
		...
		public void MainMinimumOSVersions ()
		{
			...
			ClassicAssert.AreEqual ("14.0", plist.GetMinimumOSVersion (), "MinimumOSVersion");
		}
		...
		public void MultipleMinimumOSVersions ()
		{
			...
			var plist = PDictionary.FromFile (task.CompiledAppManifest!.ItemSpec)!;
			ClassicAssert.AreEqual ("13.0", plist.GetMinimumOSVersion (), "MinimumOSVersion");
		}
		...
		public void MultipleMinimumOSVersions_Overwrite (bool overwrite, string expectedMinimumOSVersion)
		{
			...
			var plist = PDictionary.FromFile (task.CompiledAppManifest!.ItemSpec)!;
			ClassicAssert.AreEqual (expectedMinimumOSVersion, plist.GetMinimumOSVersion (), "MinimumOSVersion");
		}
		...
		public void SupportedOSPlatformVersion ()
		{
			...
			var plist = PDictionary.FromFile (task.CompiledAppManifest!.ItemSpec)!;
			ClassicAssert.AreEqual ("11.0", plist.GetMinimumOSVersion (), "MinimumOSVersion");
		}
		...
		public void MacCatalystVersionCheck ()
		{
			...
			var plist = PDictionary.FromFile (task.CompiledAppManifest!.ItemSpec)!;
			ClassicAssert.AreEqual ("11.0", plist.GetMinimumSystemVersion (), "MinimumOSVersion");
		}
		...
		public void XcodeVariables (ApplePlatform platform, bool isSimulator, string expectedDTPlatformName)
		{
			...
			ClassicAssert.AreEqual (expectedDTPlatformName, plist.GetString ("DTPlatformName")?.Value, "Expected DTPlatformName");
		}
	}
}
