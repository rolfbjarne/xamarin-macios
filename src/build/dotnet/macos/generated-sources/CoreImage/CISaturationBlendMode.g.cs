...
#nullable enable
namespace CoreImage {
	/// <summary>The CISaturationBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 
	/// // Construct the SaturationBlend filter
	...
	/// var output = saturationBlend.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/SaturationBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CISaturationBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CISaturationBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISaturationBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISaturationBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISaturationBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
