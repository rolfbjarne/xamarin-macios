...
namespace NetworkExtension {
	...
	public unsafe partial class NWBonjourServiceEndpoint : NWEndpoint {
		...
		public static NWBonjourServiceEndpoint Create (string name, string type, string domain)
		{
			...
			ret =  Runtime.GetNSObject<NWBonjourServiceEndpoint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("endpointWithName:type:domain:"), nsname, nstype, nsdomain), false)!;
