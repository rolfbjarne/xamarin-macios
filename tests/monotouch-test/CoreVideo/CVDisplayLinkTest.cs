	...
	public class CVDisplayLinkTest {
		...
		public void CreateFromDisplayIdValidIdTest ()
		{
			...
			Assert.DoesNotThrow (() => {
				...
				ClassicAssert.NotNull (displayLink, "Not null");
				ClassicAssert.AreEqual (CGDisplay.MainDisplayID, displayLink.GetCurrentDisplay (), "DisplayId");
			}, "Throws");
		}
		...
		public void CreateFromDisplayWrongIdTest ()
		{
			...
			Assert.DoesNotThrow (() => {
				...
				ClassicAssert.Null (displayLink, "null");
			}, "Throws");
		}
		...
		public void GetCurrentDisplayTest ()
		{
			...
			Assert.DoesNotThrow (() => {
				using var displayLink = new CVDisplayLink ();
				ClassicAssert.AreEqual (CGDisplay.MainDisplayID, displayLink.GetCurrentDisplay ());
			});
		}
		...
		public void TryTranslateTimeValidTest ()
		{
			...
			if (displayLink.Start () == 0) {
				...
				ClassicAssert.True (displayLink.TryTranslateTime (timeStamp, ref outTime));
				displayLink.Stop ();
			}
		}
	}
