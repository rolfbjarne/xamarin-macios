...
namespace Foundation {
	...
	public unsafe partial class NSMutableCharacterSet : NSCharacterSet {
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NSRange (this.Handle, Selector.GetHandle ("addCharactersInRange:"), aRange);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NSRange (&__objc_super__, Selector.GetHandle ("addCharactersInRange:"), aRange);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void AddCharacters (NSString str)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("addCharactersInString:"), str__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("addCharactersInString:"), str__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (str);
		...
		public virtual void IntersectWith (NSCharacterSet otherSet)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("formIntersectionWithCharacterSet:"), otherSet__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("formIntersectionWithCharacterSet:"), otherSet__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NSRange (this.Handle, Selector.GetHandle ("removeCharactersInRange:"), aRange);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NSRange (&__objc_super__, Selector.GetHandle ("removeCharactersInRange:"), aRange);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void RemoveCharacters (NSString str)
		{
			var str__handle__ = str!.GetNonNullHandle (nameof (str));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("removeCharactersInString:"), str__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("removeCharactersInString:"), str__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (str);
		...
		public virtual void UnionWith (NSCharacterSet otherSet)
		{
			var otherSet__handle__ = otherSet!.GetNonNullHandle (nameof (otherSet));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("formUnionWithCharacterSet:"), otherSet__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("formUnionWithCharacterSet:"), otherSet__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (otherSet);
