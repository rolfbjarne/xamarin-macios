...
namespace CoreImage {
	...
	public partial class CIPersonSegmentation : CIFilter, ICIPersonSegmentationProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIPersonSegmentation" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPersonSegmentation (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPersonSegmentation (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPersonSegmentation (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		public UIntPtr QualityLevel {
			[Export ("qualityLevel")]
			get {
				return GetNUInt ("inputQualityLevel");
			}
			[Export ("setQualityLevel:")]
			set {
				SetNUInt ("inputQualityLevel", value);
			}
		}
