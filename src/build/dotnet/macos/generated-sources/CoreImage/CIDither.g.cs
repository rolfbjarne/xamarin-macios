...
namespace CoreImage {
	...
	public partial class CIDither : CIFilter, ICIDitherProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIDither" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIDither () : base ("CIDither")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIDither (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDither (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDither (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIDitherProtocol protocol members 
