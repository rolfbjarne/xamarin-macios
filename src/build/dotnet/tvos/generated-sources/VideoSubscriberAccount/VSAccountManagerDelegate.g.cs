...
namespace VideoSubscriberAccount {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "PresentViewController", Selector = "accountManager:presentViewController:", ParameterType = new Type [] { typeof (VideoSubscriberAccount.VSAccountManager), typeof (UIViewController) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DismissViewController", Selector = "accountManager:dismissViewController:", ParameterType = new Type [] { typeof (VideoSubscriberAccount.VSAccountManager), typeof (UIViewController) }, ParameterByRef = new bool [] { false, false })]
	...
	{
		/// <param name="accountManager">To be added.</param><param name="viewController">To be added.</param><summary>Developers override this to specify the <see cref="T:UIKit.UIViewController" /> to be shown when the <see cref="T:VideoSubscriberAccount.VSAccountManager" /> requires user interaction.</summary><remarks>To be added.</remarks>
		...
		public virtual void PresentViewController (VSAccountManager accountManager, global::UIKit.UIViewController viewController)
		{
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _PresentViewController (IVSAccountManagerDelegate This, VSAccountManager accountManager, global::UIKit.UIViewController viewController)
		{
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("accountManager:presentViewController:"), accountManager__handle__, viewController__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (accountManager);
			GC.KeepAlive (viewController);
		}
		/// <param name="accountManager">To be added.</param><param name="viewController">To be added.</param><summary>Called after the user has interacted with the <paramref name="viewController" />.</summary><remarks>To be added.</remarks>
		[global::Foundation.RequiredMember]
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void DismissViewController (VSAccountManager accountManager, global::UIKit.UIViewController viewController)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="accountManager">To be added.</param><param name="viewController">To be added.</param><summary>Called after the user has interacted with the <paramref name="viewController" />.</summary><remarks>To be added.</remarks>
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _DismissViewController (IVSAccountManagerDelegate This, VSAccountManager accountManager, global::UIKit.UIViewController viewController)
		{
			var accountManager__handle__ = accountManager!.GetNonNullHandle (nameof (accountManager));
			var viewController__handle__ = viewController!.GetNonNullHandle (nameof (viewController));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("accountManager:dismissViewController:"), accountManager__handle__, viewController__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (accountManager);
			GC.KeepAlive (viewController);
		}
		...
		[DynamicDependencyAttribute ("DismissViewController(VideoSubscriberAccount.VSAccountManager,UIKit.UIViewController)")]
		[DynamicDependencyAttribute ("PresentViewController(VideoSubscriberAccount.VSAccountManager,UIKit.UIViewController)")]
	...
	internal unsafe sealed class VSAccountManagerDelegateWrapper : BaseWrapper, IVSAccountManagerDelegate {
		...
		[Export ("accountManager:presentViewController:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public void PresentViewController (VSAccountManager accountManager, global::UIKit.UIViewController viewController)
		{
			var accountManager__handle__ = accountManager!.GetNonNullHandle (nameof (accountManager));
			var viewController__handle__ = viewController!.GetNonNullHandle (nameof (viewController));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("accountManager:presentViewController:"), accountManager__handle__, viewController__handle__);
		...
		[Export ("accountManager:dismissViewController:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public void DismissViewController (VSAccountManager accountManager, global::UIKit.UIViewController viewController)
		{
			var accountManager__handle__ = accountManager!.GetNonNullHandle (nameof (accountManager));
			var viewController__handle__ = viewController!.GetNonNullHandle (nameof (viewController));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("accountManager:dismissViewController:"), accountManager__handle__, viewController__handle__);
...
namespace VideoSubscriberAccount {
	/// <related type="externalDocumentation" href="https://developer.apple.com/documentation/videosubscriberaccount/vsaccountmanagerdelegate">Apple documentation for <c>VSAccountManagerDelegate</c></related>
	[Protocol()]
	[Register("Microsoft_tvOS__VideoSubscriberAccount_VSAccountManagerDelegate", false)]
	[Model]
	[UnsupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public unsafe abstract partial class VSAccountManagerDelegate : NSObject, IVSAccountManagerDelegate {
		/// <summary>Creates a new <see cref="VSAccountManagerDelegate" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		protected VSAccountManagerDelegate () : base (NSObjectFlag.Empty)
		{
