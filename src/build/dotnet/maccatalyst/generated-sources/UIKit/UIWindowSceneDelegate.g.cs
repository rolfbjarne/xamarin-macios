...
namespace UIKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidUpdateCoordinateSpace", Selector = "windowScene:didUpdateCoordinateSpace:interfaceOrientation:traitCollection:", ParameterType = new Type [] { typeof (UIWindowScene), typeof (IUICoordinateSpace), typeof (UIInterfaceOrientation), typeof (UITraitCollection) }, ParameterByRef = new bool [] { false, false, false, false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "PerformAction", Selector = "windowScene:performActionForShortcutItem:completionHandler:", ParameterType = new Type [] { typeof (UIWindowScene), typeof (UIApplicationShortcutItem), typeof (global::System.Action<bool>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V2) })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "UserDidAcceptCloudKitShare", Selector = "windowScene:userDidAcceptCloudKitShareWithMetadata:", ParameterType = new Type [] { typeof (UIWindowScene), typeof (CKShareMetadata) }, ParameterByRef = new bool [] { false, false })]
		...
		UIKit.IUISceneDelegate
	{
		...
		[ObsoletedOSPlatform ("ios26.0", "Use 'DidUpdateEffectiveGeometry' to be notified of the scene's geometry changes, or use traits whose values are inherited from the scene via the TraitCollection of views and view controllers instead.")]
		[ObsoletedOSPlatform ("maccatalyst26.0", "Use 'DidUpdateEffectiveGeometry' to be notified of the scene's geometry changes, or use traits whose values are inherited from the scene via the TraitCollection of views and view controllers instead.")]
		...
		{
			_DidUpdateCoordinateSpace (this, windowScene, previousCoordinateSpace, previousInterfaceOrientation, previousTraitCollection);
		}
		[ObsoletedOSPlatform ("ios26.0", "Use 'DidUpdateEffectiveGeometry' to be notified of the scene's geometry changes, or use traits whose values are inherited from the scene via the TraitCollection of views and view controllers instead.")]
		[ObsoletedOSPlatform ("maccatalyst26.0", "Use 'DidUpdateEffectiveGeometry' to be notified of the scene's geometry changes, or use traits whose values are inherited from the scene via the TraitCollection of views and view controllers instead.")]
		[UnsupportedOSPlatform ("tvos")]
		...
		[SupportedOSPlatform ("ios13.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _DidUpdateCoordinateSpace (IUIWindowSceneDelegate This, UIWindowScene windowScene, IUICoordinateSpace previousCoordinateSpace, UIInterfaceOrientation previousInterfaceOrientation, UITraitCollection previousTraitCollection)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var windowScene__handle__ = windowScene!.GetNonNullHandle (nameof (windowScene));
			var previousCoordinateSpace__handle__ = previousCoordinateSpace!.GetNonNullHandle (nameof (previousCoordinateSpace));
			var previousTraitCollection__handle__ = previousTraitCollection!.GetNonNullHandle (nameof (previousTraitCollection));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_IntPtr_NativeHandle (This.Handle, Selector.GetHandle ("windowScene:didUpdateCoordinateSpace:interfaceOrientation:traitCollection:"), windowScene__handle__, previousCoordinateSpace__handle__, (IntPtr) (long) previousInterfaceOrientation, previousTraitCollection__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (windowScene);
			GC.KeepAlive (previousCoordinateSpace);
		...
		[SupportedOSPlatform ("ios13.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void PerformAction (UIWindowScene windowScene, UIApplicationShortcutItem shortcutItem, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V2))]global::System.Action<bool> completionHandler)
		{
			_PerformAction (this, windowScene, shortcutItem, completionHandler);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("ios13.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _PerformAction (IUIWindowSceneDelegate This, UIWindowScene windowScene, UIApplicationShortcutItem shortcutItem, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V2))]global::System.Action<bool> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var windowScene__handle__ = windowScene!.GetNonNullHandle (nameof (windowScene));
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("windowScene:performActionForShortcutItem:completionHandler:"), windowScene__handle__, shortcutItem__handle__, (IntPtr) block_ptr_completionHandler);
			GC.KeepAlive (This);
			GC.KeepAlive (windowScene);
		...
		[DynamicDependencyAttribute ("DidUpdateCoordinateSpace(UIKit.UIWindowScene,UIKit.IUICoordinateSpace,UIKit.UIInterfaceOrientation,UIKit.UITraitCollection)")]
		...
		[DynamicDependencyAttribute ("PerformAction(UIKit.UIWindowScene,UIKit.UIApplicationShortcutItem,System.Action{System.Boolean})")]
	...
	public unsafe static partial class UIWindowSceneDelegate_Extensions {
		...
		[SupportedOSPlatform ("ios13.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void PerformAction (this IUIWindowSceneDelegate This, UIWindowScene windowScene, UIApplicationShortcutItem shortcutItem, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V2))]global::System.Action<bool> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var windowScene__handle__ = windowScene!.GetNonNullHandle (nameof (windowScene));
			var shortcutItem__handle__ = shortcutItem!.GetNonNullHandle (nameof (shortcutItem));
...
namespace UIKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_MacCatalyst__UIKit_UIWindowSceneDelegate", false)]
	[Model]
	[SupportedOSPlatform ("ios13.0")]
	[SupportedOSPlatform ("tvos13.0")]
	[SupportedOSPlatform ("maccatalyst")]
