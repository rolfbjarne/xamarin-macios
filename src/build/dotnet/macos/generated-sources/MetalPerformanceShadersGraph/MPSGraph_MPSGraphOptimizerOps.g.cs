...
namespace MetalPerformanceShadersGraph {
	...
	public unsafe static partial class MPSGraph_MPSGraphOptimizerOps  {
		...
		const string selAdamWithCurrentLearningRateTensor_Beta1Tensor_Beta2Tensor_EpsilonTensor_ValuesTensor_MomentumTensor_VelocityTensor_MaximumVelocityTensor_GradientTensor_Name_X = "adamWithCurrentLearningRateTensor:beta1Tensor:beta2Tensor:epsilonTensor:valuesTensor:momentumTensor:velocityTensor:maximumVelocityTensor:gradientTensor:name:";
		static readonly NativeHandle selAdamWithCurrentLearningRateTensor_Beta1Tensor_Beta2Tensor_EpsilonTensor_ValuesTensor_MomentumTensor_VelocityTensor_MaximumVelocityTensor_GradientTensor_Name_XHandle = Selector.GetHandle ("adamWithCurrentLearningRateTensor:beta1Tensor:beta2Tensor:epsilonTensor:valuesTensor:momentumTensor:velocityTensor:maximumVelocityTensor:gradientTensor:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAdamWithLearningRateTensor_Beta1Tensor_Beta2Tensor_EpsilonTensor_Beta1PowerTensor_Beta2PowerTensor_ValuesTensor_MomentumTensor_VelocityTensor_MaximumVelocityTensor_GradientTensor_Name_X = "adamWithLearningRateTensor:beta1Tensor:beta2Tensor:epsilonTensor:beta1PowerTensor:beta2PowerTensor:valuesTensor:momentumTensor:velocityTensor:maximumVelocityTensor:gradientTensor:name:";
		static readonly NativeHandle selAdamWithLearningRateTensor_Beta1Tensor_Beta2Tensor_EpsilonTensor_Beta1PowerTensor_Beta2PowerTensor_ValuesTensor_MomentumTensor_VelocityTensor_MaximumVelocityTensor_GradientTensor_Name_XHandle = Selector.GetHandle ("adamWithLearningRateTensor:beta1Tensor:beta2Tensor:epsilonTensor:beta1PowerTensor:beta2PowerTensor:valuesTensor:momentumTensor:velocityTensor:maximumVelocityTensor:gradientTensor:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selApplyStochasticGradientDescentWithLearningRateTensor_Variable_GradientTensor_Name_X = "applyStochasticGradientDescentWithLearningRateTensor:variable:gradientTensor:name:";
		static readonly NativeHandle selApplyStochasticGradientDescentWithLearningRateTensor_Variable_GradientTensor_Name_XHandle = Selector.GetHandle ("applyStochasticGradientDescentWithLearningRateTensor:variable:gradientTensor:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selStochasticGradientDescentWithLearningRateTensor_ValuesTensor_GradientTensor_Name_X = "stochasticGradientDescentWithLearningRateTensor:valuesTensor:gradientTensor:name:";
		static readonly NativeHandle selStochasticGradientDescentWithLearningRateTensor_ValuesTensor_GradientTensor_Name_XHandle = Selector.GetHandle ("stochasticGradientDescentWithLearningRateTensor:valuesTensor:gradientTensor:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MPSGraphTensor[] Adam (this MPSGraph This, MPSGraphTensor learningRateTensor, MPSGraphTensor beta1Tensor, MPSGraphTensor beta2Tensor, MPSGraphTensor epsilonTensor, MPSGraphTensor beta1PowerTensor, MPSGraphTensor beta2PowerTensor, MPSGraphTensor valuesTensor, MPSGraphTensor momentumTensor, MPSGraphTensor velocityTensor, MPSGraphTensor? maximumVelocityTensor, MPSGraphTensor gradientTensor, string? name)
		{
			...
			MPSGraphTensor[]? ret;
			ret = CFArray.ArrayFromHandle<MPSGraphTensor>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (This.Handle, selAdamWithLearningRateTensor_Beta1Tensor_Beta2Tensor_EpsilonTensor_Beta1PowerTensor_Beta2PowerTensor_ValuesTensor_MomentumTensor_VelocityTensor_MaximumVelocityTensor_GradientTensor_Name_XHandle, learningRateTensor__handle__, beta1Tensor__handle__, beta2Tensor__handle__, epsilonTensor__handle__, beta1PowerTensor__handle__, beta2PowerTensor__handle__, valuesTensor__handle__, momentumTensor__handle__, velocityTensor__handle__, maximumVelocityTensor__handle__, gradientTensor__handle__, nsname), false)!;
			GC.KeepAlive (This);
		...
		public static MPSGraphTensor[] Adam (this MPSGraph This, MPSGraphTensor currentLearningRateTensor, MPSGraphTensor beta1Tensor, MPSGraphTensor beta2Tensor, MPSGraphTensor epsilonTensor, MPSGraphTensor valuesTensor, MPSGraphTensor momentumTensor, MPSGraphTensor velocityTensor, MPSGraphTensor? maximumVelocityTensor, MPSGraphTensor gradientTensor, string? name)
		{
			...
			var nsname = CFString.CreateNative (name);
			MPSGraphTensor[]? ret;
			ret = CFArray.ArrayFromHandle<MPSGraphTensor>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (This.Handle, selAdamWithCurrentLearningRateTensor_Beta1Tensor_Beta2Tensor_EpsilonTensor_ValuesTensor_MomentumTensor_VelocityTensor_MaximumVelocityTensor_GradientTensor_Name_XHandle, currentLearningRateTensor__handle__, beta1Tensor__handle__, beta2Tensor__handle__, epsilonTensor__handle__, valuesTensor__handle__, momentumTensor__handle__, velocityTensor__handle__, maximumVelocityTensor__handle__, gradientTensor__handle__, nsname), false)!;
			GC.KeepAlive (This);
		...
		public static MPSGraphOperation ApplyStochasticGradientDescent (this MPSGraph This, MPSGraphTensor learningRate, MPSGraphVariableOp variable, MPSGraphTensor gradient, string? name)
		{
			...
			ret =  Runtime.GetNSObject<MPSGraphOperation> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (This.Handle, selApplyStochasticGradientDescentWithLearningRateTensor_Variable_GradientTensor_Name_XHandle, learningRate__handle__, variable__handle__, gradient__handle__, nsname), false)!;
			GC.KeepAlive (This);
		...
		public static MPSGraphTensor StochasticGradientDescent (this MPSGraph This, MPSGraphTensor learningRate, MPSGraphTensor values, MPSGraphTensor gradient, string? name)
		{
			...
			var nsname = CFString.CreateNative (name);
			MPSGraphTensor? ret;
			ret =  Runtime.GetNSObject<MPSGraphTensor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (This.Handle, selStochasticGradientDescentWithLearningRateTensor_ValuesTensor_GradientTensor_Name_XHandle, learningRate__handle__, values__handle__, gradient__handle__, nsname), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (learningRate);
			GC.KeepAlive (values);
			GC.KeepAlive (gradient);
