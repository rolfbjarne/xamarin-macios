...
namespace MapKit {
	...
	public unsafe partial class MKStandardMapConfiguration : MKMapConfiguration {
		...
		const string selEmphasisStyleX = "emphasisStyle";
		static readonly NativeHandle selEmphasisStyleXHandle = Selector.GetHandle ("emphasisStyle");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithElevationStyle_EmphasisStyle_X = "initWithElevationStyle:emphasisStyle:";
		static readonly NativeHandle selInitWithElevationStyle_EmphasisStyle_XHandle = Selector.GetHandle ("initWithElevationStyle:emphasisStyle:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithEmphasisStyle_X = "initWithEmphasisStyle:";
		static readonly NativeHandle selInitWithEmphasisStyle_XHandle = Selector.GetHandle ("initWithEmphasisStyle:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetEmphasisStyle_X = "setEmphasisStyle:";
		static readonly NativeHandle selSetEmphasisStyle_XHandle = Selector.GetHandle ("setEmphasisStyle:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>Creates a new <see cref="MKStandardMapConfiguration" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (this.Handle, selInitWithElevationStyle_EmphasisStyle_XHandle, (IntPtr) (long) elevationStyle, (IntPtr) (long) emphasisStyle), "initWithElevationStyle:emphasisStyle:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr_IntPtr (&__objc_super__, selInitWithElevationStyle_EmphasisStyle_XHandle, (IntPtr) (long) elevationStyle, (IntPtr) (long) emphasisStyle), "initWithElevationStyle:emphasisStyle:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		{
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr (this.Handle, selInitWithEmphasisStyle_XHandle, (IntPtr) (long) emphasisStyle), "initWithEmphasisStyle:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr (&__objc_super__, selInitWithEmphasisStyle_XHandle, (IntPtr) (long) emphasisStyle), "initWithEmphasisStyle:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual MKStandardMapEmphasisStyle EmphasisStyle {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (MapKit.MKStandardMapEmphasisStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selEmphasisStyleXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MapKit.MKStandardMapEmphasisStyle) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selEmphasisStyleXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
			}
			[Export ("setEmphasisStyle:", ArgumentSemantic.Assign)]
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr (this.Handle, selSetEmphasisStyle_XHandle, (IntPtr) (long) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, selSetEmphasisStyle_XHandle, (IntPtr) (long) value);
						GC.KeepAlive (this);
					}
				}
			}
