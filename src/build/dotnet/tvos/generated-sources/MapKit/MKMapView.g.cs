	...
	public unsafe partial class MKMapView : global::UIKit.UIView {
		...
		public virtual MKFeatureVisibility PitchButtonVisibility {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MapKit.MKFeatureVisibility) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("pitchButtonVisibility"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual MKUserTrackingMode UserTrackingMode {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (MapKit.MKUserTrackingMode) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("userTrackingMode"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MapKit.MKUserTrackingMode) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("userTrackingMode"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
