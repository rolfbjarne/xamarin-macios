...
namespace Foundation {
	...
	public unsafe partial class NSUrlSessionWebSocketMessage : NSObject {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSURLSessionWebSocketMessage");
		...
		protected NSUrlSessionWebSocketMessage (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSUrlSessionWebSocketMessage (NativeHandle handle) : base (handle)
		{
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("initWithString:"), nsstring), "initWithString:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithString:"), nsstring), "initWithString:");
					GC.KeepAlive (this);
				}
			}
		...
		public virtual NSUrlSessionWebSocketMessageType Type {
			[Export ("type")]
			get {
				NSUrlSessionWebSocketMessageType ret;
				if (IsDirectBinding) {
					ret = (NSUrlSessionWebSocketMessageType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("type"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSUrlSessionWebSocketMessageType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("type"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
