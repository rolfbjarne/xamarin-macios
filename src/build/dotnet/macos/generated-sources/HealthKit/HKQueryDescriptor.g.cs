...
namespace HealthKit {
	...
	public unsafe partial class HKQueryDescriptor : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithSampleType_Predicate_X = "initWithSampleType:predicate:";
		static readonly NativeHandle selInitWithSampleType_Predicate_XHandle = Selector.GetHandle ("initWithSampleType:predicate:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selInitWithSampleType_Predicate_XHandle, sampleType__handle__, predicate__handle__), "initWithSampleType:predicate:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selInitWithSampleType_Predicate_XHandle, sampleType__handle__, predicate__handle__), "initWithSampleType:predicate:");
					GC.KeepAlive (this);
				}
			}
