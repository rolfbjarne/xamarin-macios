...
namespace CoreImage {
	...
	public partial class CIVividLightBlendMode : CIFilter, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIVividLightBlendMode" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIVividLightBlendMode () : base ("CIVividLightBlendMode")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIVividLightBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIVividLightBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIVividLightBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
