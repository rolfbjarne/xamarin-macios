...
#nullable enable
namespace CoreImage {
	/// <summary>The CIStraightenFilter CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/Straighten.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIStraightenFilter : CIFilter, ICIStraightenProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIStraightenFilter" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIStraightenFilter () : base ("CIStraightenFilter")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIStraightenFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIStraightenFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIStraightenFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIStraightenProtocol protocol members 
