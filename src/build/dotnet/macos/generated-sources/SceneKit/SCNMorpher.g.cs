...
namespace SceneKit {
	...
	public unsafe partial class SCNMorpher : NSObject, INSCoding, INSSecureCoding, ISCNAnimatable {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetTargets_X = "setTargets:";
		static readonly NativeHandle selSetTargets_XHandle = Selector.GetHandle ("setTargets:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetUnifiesNormals_X = "setUnifiesNormals:";
		static readonly NativeHandle selSetUnifiesNormals_XHandle = Selector.GetHandle ("setUnifiesNormals:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetWeight_ForTargetAtIndex_X = "setWeight:forTargetAtIndex:";
		static readonly NativeHandle selSetWeight_ForTargetAtIndex_XHandle = Selector.GetHandle ("setWeight:forTargetAtIndex:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetWeight_ForTargetNamed_X = "setWeight:forTargetNamed:";
		static readonly NativeHandle selSetWeight_ForTargetNamed_XHandle = Selector.GetHandle ("setWeight:forTargetNamed:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetWeights_X = "setWeights:";
		static readonly NativeHandle selSetWeights_XHandle = Selector.GetHandle ("setWeights:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTargetsX = "targets";
		static readonly NativeHandle selTargetsXHandle = Selector.GetHandle ("targets");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selUnifiesNormalsX = "unifiesNormals";
		static readonly NativeHandle selUnifiesNormalsXHandle = Selector.GetHandle ("unifiesNormals");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selWeightForTargetAtIndex_X = "weightForTargetAtIndex:";
		static readonly NativeHandle selWeightForTargetAtIndex_XHandle = Selector.GetHandle ("weightForTargetAtIndex:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selWeightForTargetNamed_X = "weightForTargetNamed:";
		static readonly NativeHandle selWeightForTargetNamed_XHandle = Selector.GetHandle ("weightForTargetNamed:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual nfloat GetWeight (nuint targetIndex)
		{
			nfloat ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend_UIntPtr (this.Handle, selWeightForTargetAtIndex_XHandle, targetIndex);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSendSuper_UIntPtr (&__objc_super__, selWeightForTargetAtIndex_XHandle, targetIndex);
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual nfloat GetWeight (string targetName)
		{
			...
			nfloat ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend_NativeHandle (this.Handle, selWeightForTargetNamed_XHandle, nstargetName);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSendSuper_NativeHandle (&__objc_super__, selWeightForTargetNamed_XHandle, nstargetName);
					GC.KeepAlive (this);
				}
			}
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_nfloat_UIntPtr (this.Handle, selSetWeight_ForTargetAtIndex_XHandle, weight, targetIndex);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_nfloat_UIntPtr (&__objc_super__, selSetWeight_ForTargetAtIndex_XHandle, weight, targetIndex);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void SetWeight (nfloat weight, string targetName)
		{
			...
			var nstargetName = CFString.CreateNative (targetName);
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_nfloat_NativeHandle (this.Handle, selSetWeight_ForTargetNamed_XHandle, weight, nstargetName);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_nfloat_NativeHandle (&__objc_super__, selSetWeight_ForTargetNamed_XHandle, weight, nstargetName);
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nstargetName);
		...
		public virtual SCNMorpherCalculationMode CalculationMode {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (SCNMorpherCalculationMode) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selCalculationModeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (SCNMorpherCalculationMode) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selCalculationModeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr (this.Handle, selSetCalculationMode_XHandle, (IntPtr) (long) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, selSetCalculationMode_XHandle, (IntPtr) (long) value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual SCNGeometry[] Targets {
			...
			get {
				SCNGeometry[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<SCNGeometry>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selTargetsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<SCNGeometry>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selTargetsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetTargets_XHandle, nsa_value.Handle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetTargets_XHandle, nsa_value.Handle);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual bool UnifiesNormals {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selUnifiesNormalsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selUnifiesNormalsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_bool (this.Handle, selSetUnifiesNormals_XHandle, value ? (byte) 1 : (byte) 0);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, selSetUnifiesNormals_XHandle, value ? (byte) 1 : (byte) 0);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual NSNumber[] Weights {
			...
			get {
				NSNumber[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<NSNumber>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selWeightsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<NSNumber>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selWeightsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				using var nsa_value = NSArray.FromNSObjects (value);
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetWeights_XHandle, nsa_value.Handle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetWeights_XHandle, nsa_value.Handle);
						GC.KeepAlive (this);
					}
				}
			}
