...
namespace CoreImage {
	...
	public partial class CIBlendWithRedMask : CIBlendWithMask {
		/// <summary>Creates a new <see cref="CIBlendWithRedMask" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIBlendWithRedMask () : base ("CIBlendWithRedMask")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBlendWithRedMask (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBlendWithRedMask (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBlendWithRedMask (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
