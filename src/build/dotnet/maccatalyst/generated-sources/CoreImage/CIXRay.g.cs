...
namespace CoreImage {
	...
	public partial class CIXRay : CIFilter, ICIXRayProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIXRay" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIXRay () : base ("CIXRay")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIXRay (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIXRay (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIXRay (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIXRayProtocol protocol members 
