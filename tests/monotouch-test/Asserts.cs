...
public static class Asserts {
	...
	{
		ClassicAssert.AreEqual (expected, actual, $"{message} (M) expected: {expected} actual: {actual}");
	}
	...
	{
		ClassicAssert.AreEqual (expected, actual, delta, message);
	}

	public static void AreEqual (Vector2 expected, Vector2 actual, string message)
	{
		ClassicAssert.AreEqual (expected.X, actual.X, $"{message} (X) expected: {expected} actual: {actual}");
		ClassicAssert.AreEqual (expected.Y, actual.Y, $"{message} (Y) expected: {expected} actual: {actual}");
	}

	public static void AreEqual (Vector3 expected, Vector3 actual, string message)
	{

		ClassicAssert.AreEqual (expected.X, actual.X, 0.001, $"{message} (X) expected: {expected} actual: {actual}");
		ClassicAssert.AreEqual (expected.Y, actual.Y, 0.001, $"{message} (Y) expected: {expected} actual: {actual}");
		ClassicAssert.AreEqual (expected.Z, actual.Z, 0.001, $"{message} (Z) expected: {expected} actual: {actual}");
	}

	public static void AreEqual (Vector3 expected, Vector3 actual, float delta, string message)
	{
		ClassicAssert.AreEqual (expected.X, actual.X, delta, $"{message} (X) expected: {expected} actual: {actual}");
		ClassicAssert.AreEqual (expected.Y, actual.Y, delta, $"{message} (Y) expected: {expected} actual: {actual}");
		ClassicAssert.AreEqual (expected.Z, actual.Z, delta, $"{message} (Z) expected: {expected} actual: {actual}");
	}
	...
	public static void AreEqual (Vector4 expected, Vector4 actual, string message)
	{
		ClassicAssert.AreEqual (expected.X, actual.X, $"{message} (X) expected: {expected} actual: {actual}");
		ClassicAssert.AreEqual (expected.Y, actual.Y, $"{message} (Y) expected: {expected} actual: {actual}");
		ClassicAssert.AreEqual (expected.Z, actual.Z, $"{message} (Z) expected: {expected} actual: {actual}");
		ClassicAssert.AreEqual (expected.W, actual.W, $"{message} (W) expected: {expected} actual: {actual}");
	}
	...
	{
		ClassicAssert.AreEqual (expectedX, actual.X, $"{message} (X) expected: {new Vector4 (expectedX, expectedY, expectedZ, expectedW)} actual: {actual}");
		ClassicAssert.AreEqual (expectedY, actual.Y, $"{message} (Y) expected: {new Vector4 (expectedX, expectedY, expectedZ, expectedW)} actual: {actual}");
		ClassicAssert.AreEqual (expectedZ, actual.Z, $"{message} (Z) expected: {new Vector4 (expectedX, expectedY, expectedZ, expectedW)} actual: {actual}");
		ClassicAssert.AreEqual (expectedW, actual.W, $"{message} (W) expected: {new Vector4 (expectedX, expectedY, expectedZ, expectedW)} actual: {actual}");
	}
	...
	public static void AreEqual (Vector4 expected, Vector4 actual, float delta, string message)
	{
		...
		ClassicAssert.AreEqual (expected.Y, actual.Y, delta, $"{message} (Y) expected: {expected} actual: {actual}");
		ClassicAssert.AreEqual (expected.Z, actual.Z, delta, $"{message} (Z) expected: {expected} actual: {actual}");
		ClassicAssert.AreEqual (expected.W, actual.W, delta, $"{message} (W) expected: {expected} actual: {actual}");
	}
	...
	public static void AreEqual (Quaternion [] expected, Quaternion [] actual, string message)
	{
		...
		ClassicAssert.AreEqual (expected.Length, actual.Length, $"{message} array lengths");
	...
	{
		ClassicAssert.AreEqual (expected.HistogramForAlpha, actual.HistogramForAlpha, $"{message} HistogramForAlpha expected: {expected} actual: {actual}");
		...
		ClassicAssert.AreEqual (expected.NumberOfHistogramEntries, actual.NumberOfHistogramEntries, $"{message} NumberOfHistogramEntries expected: {expected} actual: {actual}");
	}
	...
	{
		ClassicAssert.AreEqual (expected.X, actual.X, 0.001, message + " (X)");
		ClassicAssert.AreEqual (expected.Y, actual.Y, 0.001, message + " (Y)");
	}

	public static void AreEqual (VectorDouble2 expected, VectorDouble2 actual, double delta, string message)
	{
		ClassicAssert.AreEqual (expected.X, actual.X, delta, message + " (X)");
		ClassicAssert.AreEqual (expected.Y, actual.Y, delta, message + " (Y)");
	}
