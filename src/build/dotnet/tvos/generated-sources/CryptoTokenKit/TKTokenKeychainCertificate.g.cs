	...
	public unsafe partial class TKTokenKeychainCertificate : TKTokenKeychainItem {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithCertificate:objectID:"), nsb_certificateRef.GetHandle (), objectId__handle__), "initWithCertificate:objectID:");
					GC.KeepAlive (this);
				}
			}
