...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITransitionFilter" /> that presents a starburst-like flash.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/flash_transition.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIFlashTransition : CITransitionFilter, ICIFlashTransitionProtocol, ICITransitionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIFlashTransition" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIFlashTransition (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIFlashTransition (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIFlashTransition (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIFlashTransitionProtocol protocol members 
