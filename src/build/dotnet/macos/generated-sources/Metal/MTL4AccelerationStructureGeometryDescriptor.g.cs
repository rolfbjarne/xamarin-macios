	...
	public unsafe partial class MTL4AccelerationStructureGeometryDescriptor : NSObject, INSCopying {
		...
		public virtual MTL4BufferRange PrimitiveDataBuffer {
			...
			get {
				MTL4BufferRange ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.MTL4BufferRange_objc_msgSend (this.Handle, selPrimitiveDataBufferXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.MTL4BufferRange_objc_msgSendSuper (&__objc_super__, selPrimitiveDataBufferXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_MTL4BufferRange (this.Handle, selSetPrimitiveDataBuffer_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_MTL4BufferRange (&__objc_super__, selSetPrimitiveDataBuffer_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
