...
namespace Foundation {
	...
	public unsafe partial class NSLengthFormatter : NSFormatter {
		...
		public virtual string StringFromMeters (double numberInMeters)
		{
			string ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_Double (this.Handle, Selector.GetHandle ("stringFromMeters:"), numberInMeters), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_Double (&__objc_super__, Selector.GetHandle ("stringFromMeters:"), numberInMeters), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public unsafe virtual string UnitStringFromMeters (double numberInMeters, ref NSLengthFormatterUnit unitp)
		{
			...
			string ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_Double_ref_NSLengthFormatterUnit (this.Handle, Selector.GetHandle ("unitStringFromMeters:usedUnit:"), numberInMeters, unitp__pointer), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_Double_ref_NSLengthFormatterUnit (&__objc_super__, Selector.GetHandle ("unitStringFromMeters:usedUnit:"), numberInMeters, unitp__pointer), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual bool ForPersonHeightUse {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("isForPersonHeightUse"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isForPersonHeightUse"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_bool (this.Handle, Selector.GetHandle ("setForPersonHeightUse:"), value ? (byte) 1 : (byte) 0);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, Selector.GetHandle ("setForPersonHeightUse:"), value ? (byte) 1 : (byte) 0);
						GC.KeepAlive (this);
					}
				}
			}
