...
namespace FileProvider {
	...
	public partial interface INSFileProviderServicing : INativeObject, IDisposable
	{
		...
		public unsafe virtual NSProgress GetSupportedServiceSources (string itemIdentifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V74))]global::System.Action<INSFileProviderServiceSource[], NSError> completionHandler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static NSProgress _GetSupportedServiceSources (INSFileProviderServicing This, string itemIdentifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V74))]global::System.Action<INSFileProviderServiceSource[], NSError> completionHandler)
		{
	...
	internal unsafe sealed class NSFileProviderServicingWrapper : BaseWrapper, INSFileProviderServicing {
		...
		[Export ("supportedServiceSourcesForItemIdentifier:completionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe NSProgress GetSupportedServiceSources (string itemIdentifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V74))]global::System.Action<INSFileProviderServiceSource[], NSError> completionHandler)
		{
			if (itemIdentifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (itemIdentifier));
			if (completionHandler is null)
