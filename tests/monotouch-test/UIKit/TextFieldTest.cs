	...
	public class TextFieldTest {
		...
		public void EmptySelection ()
		{
			using (var tf = new UITextField ()) {
				if (TestRuntime.CheckXcodeVersion (9, 0)) {
					ClassicAssert.IsNotNull (tf.SelectedTextRange, "SelectedTextRange 1");
				} else {
					ClassicAssert.IsNull (tf.SelectedTextRange, "SelectedTextRange");
				}
				if (TestRuntime.CheckXcodeVersion (13, 0)) {
					...
					ClassicAssert.IsNull (tf.TypingAttributes, "default");
				}
				...
				if (TestRuntime.CheckXcodeVersion (13, 0)) {
					...
					ClassicAssert.IsNull (tf.TypingAttributes, "empty not xcode 11");
				}
		...
		public void LeftRight ()
		{
			...
			using (UITextField tf = new UITextField ()) {
				ClassicAssert.IsNull (tf.LeftView, "LeftView");
				tf.LeftView = null;
				ClassicAssert.IsNull (tf.RightView, "RightView");
				tf.RightView = null;
			}
		}
