...
namespace UIKit {
	...
	public unsafe partial class NSTextLayoutManager : NSObject, INSCoding, INSSecureCoding, INSTextSelectionDataSource {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual INSTextLocation? EnumerateTextLayoutFragments (INSTextLocation? location, NSTextLayoutFragmentEnumerationOptions options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity2V9))]global::System.Func<NSTextLayoutFragment, bool> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var location__handle__ = location.GetHandle ();
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDFuncArity2V9.CreateBlock (handler);
			BlockLiteral *block_ptr_handler = &block_handler;
			INSTextLocation? ret;
			if (IsDirectBinding) {
		...
		public unsafe virtual global::System.Action<NSTextLayoutManager, NSTextLayoutFragment>? RenderingAttributesValidator {
			[return: DelegateProxy (typeof (ObjCRuntime.Trampolines.SDActionArity2V169))]
			...
			get {
				...
				return global::ObjCRuntime.Trampolines.NIDActionArity2V169.Create (ret)!;
			}
			[param: BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V169))]
			[Export ("setRenderingAttributesValidator:", ArgumentSemantic.Copy)]
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				using var block_value = Trampolines.SDActionArity2V169.CreateNullableBlock (value);
