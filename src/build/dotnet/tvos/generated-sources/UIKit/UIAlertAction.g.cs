...
namespace UIKit {
	...
	public unsafe partial class UIAlertAction : NSObject, INSCopying, IUIAccessibilityIdentification {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static UIAlertAction Create (string title, UIAlertActionStyle style, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V77))]global::System.Action<UIAlertAction>? handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (title is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (title));
			var nstitle = CFString.CreateNative (title);
			using var block_handler = Trampolines.SDActionArity1V77.CreateNullableBlock (handler);
