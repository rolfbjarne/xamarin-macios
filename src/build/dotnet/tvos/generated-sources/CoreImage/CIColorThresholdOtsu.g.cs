...
namespace CoreImage {
	...
	public partial class CIColorThresholdOtsu : CIFilter, ICIColorThresholdOtsuProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorThresholdOtsu" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorThresholdOtsu (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorThresholdOtsu (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorThresholdOtsu (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
