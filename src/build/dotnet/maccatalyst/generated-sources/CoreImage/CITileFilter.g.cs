...
namespace CoreImage {
	...
	public abstract partial class CITileFilter : CIFilter {
		...
		protected CITileFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CITileFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CITileFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CITileFilter" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected  CITileFilter (string name) : base (CreateFilter (name))
		{
		}
		/// <summary>Gets or sets the angle, in radians, of the tile pattern.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public float Angle {
			get {
		...
		/// <summary>Gets or sets the length of the sides of the tiles in the pattern.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public float Width {
			get {
