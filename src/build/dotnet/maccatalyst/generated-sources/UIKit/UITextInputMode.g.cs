...
#nullable enable
namespace UIKit {
	[Register("UITextInputMode", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class UITextInputMode : NSObject, INSCoding, INSSecureCoding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("UITextInputMode");
		...
		/// <summary>Creates a new <see cref="UITextInputMode" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public UITextInputMode () : base (NSObjectFlag.Empty)
		{
		...
		public UITextInputMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected UITextInputMode (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal UITextInputMode (NativeHandle handle) : base (handle)
		{
		}
		...
		public static UITextInputMode[] ActiveInputModes {
			...
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				UITextInputMode[]? ret;
				ret = CFArray.ArrayFromHandle<UITextInputMode>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("activeInputModes")), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static UITextInputMode? CurrentInputMode {
			...
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				UITextInputMode? ret;
				ret =  Runtime.GetNSObject<UITextInputMode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("currentInputMode")), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// void Callback (object sender, UITextInputMode.NSNotificationEventArgs args)
		/// {
		///     // Access strongly typed args
		///     Console.WriteLine ("Notification: {0}", args.Notification);
		/// }
		...
		///     UITextInputMode.CurrentInputModeDidChangeNotification, (notification) => { Console.WriteLine ("Received the notification CurrentInputModeDidChange", notification); }
		/// );
		///
		/// // Method style
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (UITextInputMode.CurrentInputModeDidChangeNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		[Field ("UITextInputCurrentInputModeDidChangeNotification",  "UIKit")]
		[Advice ("Use UITextInputMode.Notifications.ObserveCurrentInputModeDidChange helper method instead.")]
		...
		// Notifications
		//
		/// <summary>Notifications posted by the <see cref="global::UIKit.UITextInputMode" /> class.</summary>
		/// <remarks>
		///    <para>This class contains various helper methods that allow developers to observe events posted in the notification hub (<see cref="Foundation.NSNotificationCenter" />).</para>
		///    <para>The methods defined in this class post events that invoke the provided method or lambda with a <see cref="Foundation.NSNotificationEventArgs" /> parameter, which contains strongly typed properties for the notification arguments.</para>
		/// </remarks>
		public static partial class Notifications {
			/// <summary>Strongly typed notification for the <see cref="global::UIKit.UITextInputMode.CurrentInputModeDidChangeNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::UIKit.UITextInputMode.CurrentInputModeDidChangeNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
