...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIDistortionFilter" /> that distorts pixels around a circular area.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/hole_distortion.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIHoleDistortion : CIDistortionFilter, ICIHoleDistortionProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIHoleDistortion" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIHoleDistortion (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIHoleDistortion (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIHoleDistortion (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIHoleDistortionProtocol protocol members 
