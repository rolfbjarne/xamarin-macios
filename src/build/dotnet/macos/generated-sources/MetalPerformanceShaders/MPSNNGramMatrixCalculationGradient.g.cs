...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSNNGramMatrixCalculationGradient : MPSCnnGradientKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithDevice_Alpha_X = "initWithDevice:alpha:";
		static readonly NativeHandle selInitWithDevice_Alpha_XHandle = Selector.GetHandle ("initWithDevice:alpha:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_float (this.Handle, selInitWithDevice_Alpha_XHandle, device__handle__, alpha), "initWithDevice:alpha:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_float (&__objc_super__, selInitWithDevice_Alpha_XHandle, device__handle__, alpha), "initWithDevice:alpha:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
