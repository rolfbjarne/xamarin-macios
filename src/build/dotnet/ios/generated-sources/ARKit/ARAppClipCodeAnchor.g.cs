...
#nullable enable
namespace ARKit {
	[Register("ARAppClipCodeAnchor", true)]
	[SupportedOSPlatform ("ios14.3")]
	public unsafe partial class ARAppClipCodeAnchor : ARAnchor, IARTrackable {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("ARAppClipCodeAnchor");
		...
		public ARAppClipCodeAnchor (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected ARAppClipCodeAnchor (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal ARAppClipCodeAnchor (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual ARAppClipCodeUrlDecodingState UrlDecodingState {
			[Export ("urlDecodingState", ArgumentSemantic.Assign)]
			get {
				ARAppClipCodeUrlDecodingState ret;
				if (IsDirectBinding) {
					ret = (ARKit.ARAppClipCodeUrlDecodingState) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("urlDecodingState"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (ARKit.ARAppClipCodeUrlDecodingState) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("urlDecodingState"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
