...
namespace CoreImage {
	...
	public partial class CILabDeltaE : CIFilter, ICILabDeltaEProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CILabDeltaE" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CILabDeltaE () : base ("CILabDeltaE")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CILabDeltaE (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILabDeltaE (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILabDeltaE (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CILabDeltaEProtocol protocol members 
		...
		public CIImage? Image2 {
			...
			get {
				return (ValueForKey ("inputImage2") as CIImage)!;
			}
			[Export ("setImage2:", ArgumentSemantic.Retain)]
			set {
				SetValue ("inputImage2", value);
			}
		}
