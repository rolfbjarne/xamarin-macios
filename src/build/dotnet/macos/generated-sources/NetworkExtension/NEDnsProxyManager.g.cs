...
namespace NetworkExtension {
	...
	public unsafe partial class NEDnsProxyManager : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selProviderProtocolX = "providerProtocol";
		static readonly NativeHandle selProviderProtocolXHandle = Selector.GetHandle ("providerProtocol");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetProviderProtocol_X = "setProviderProtocol:";
		static readonly NativeHandle selSetProviderProtocol_XHandle = Selector.GetHandle ("setProviderProtocol:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual NEDnsProxyProviderProtocol? ProviderProtocol {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NEDnsProxyProviderProtocol> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selProviderProtocolXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NEDnsProxyProviderProtocol> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selProviderProtocolXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetProviderProtocol_XHandle, value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetProviderProtocol_XHandle, value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
		...
		public static NEDnsProxyManager SharedManager {
			...
			get {
				...
				ret =  Runtime.GetNSObject<NEDnsProxyManager> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selSharedManagerXHandle), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
