...
namespace FileProviderUI {
	...
	public unsafe partial class FPUIActionExtensionViewController : global::UIKit.UIViewController {
		...
		public virtual void Prepare (NSError error)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("prepareForError:"), error__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("prepareForError:"), error__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (error);
		...
		public virtual void Prepare (string actionIdentifier, NSString[] itemIdentifiers)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("prepareForActionWithIdentifier:itemIdentifiers:"), nsactionIdentifier, nsa_itemIdentifiers.Handle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("prepareForActionWithIdentifier:itemIdentifiers:"), nsactionIdentifier, nsa_itemIdentifiers.Handle);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual FPUIActionExtensionContext ExtensionContext {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<FPUIActionExtensionContext> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("extensionContext")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<FPUIActionExtensionContext> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("extensionContext")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
