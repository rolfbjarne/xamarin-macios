...
namespace HealthKit {
	...
	public unsafe partial class HKSample : HKObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selHasUndeterminedDurationX = "hasUndeterminedDuration";
		static readonly NativeHandle selHasUndeterminedDurationXHandle = Selector.GetHandle ("hasUndeterminedDuration");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual bool HasUndeterminedDuration {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selHasUndeterminedDurationXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selHasUndeterminedDurationXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
