...
namespace AVFoundation {
	...
	public unsafe partial class AVPlayerLayer : global::CoreAnimation.CALayer {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("AVPlayerLayer");
		...
		/// <summary>Creates a new <see cref="AVPlayerLayer" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public AVPlayerLayer () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		public AVPlayerLayer (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected AVPlayerLayer (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal AVPlayerLayer (NativeHandle handle) : base (handle)
		{
		}
		...
		{
			var player__handle__ = player.GetHandle ();
			AVPlayerLayer? ret;
			ret =  Runtime.GetNSObject<AVPlayerLayer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("playerLayerWithPlayer:"), player__handle__), false)!;
			GC.KeepAlive (player);
			return ret!;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void SetCaptionPreviewProfileId (string profileId, CGPoint position, string? text)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_CGPoint_NativeHandle (this.Handle, Selector.GetHandle ("setCaptionPreviewProfileID:position:text:"), nsprofileId, position, nstext);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_CGPoint_NativeHandle (&__objc_super__, Selector.GetHandle ("setCaptionPreviewProfileID:position:text:"), nsprofileId, position, nstext);
					GC.KeepAlive (this);
				}
			}
		...
		[SupportedOSPlatform ("ios26.4")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void StopShowingCaptionPreview ()
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend (this.Handle, Selector.GetHandle ("stopShowingCaptionPreview"));
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("stopShowingCaptionPreview"));
					GC.KeepAlive (this);
				}
			}
		}
		...
		/// <summary>Gets a Boolean value that tells whether the first frame is ready for display.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			get {
				...
				if (IsDirectBinding) {
					if (global::ObjCRuntime.Runtime.IsARM64CallingConvention) {
						ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSend (this.Handle, Selector.GetHandle ("videoRect"));
					} else {
						ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSend_stret (this.Handle, Selector.GetHandle ("videoRect"));
					}
				} else {
					if (global::ObjCRuntime.Runtime.IsARM64CallingConvention) {
						unsafe {
							var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
							ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("videoRect"));
							GC.KeepAlive (this);
						}
					} else {
						unsafe {
							var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
							ret = global::ObjCRuntime.Messaging.CGRect_objc_msgSendSuper_stret (&__objc_super__, Selector.GetHandle ("videoRect"));
							GC.KeepAlive (this);
						}
					}
				}
		...
		public virtual NSDictionary? WeakPixelBufferAttributes {
			...
			get {
				NSDictionary? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDictionary> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("pixelBufferAttributes")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDictionary> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("pixelBufferAttributes")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		/// <summary>Represents the value associated with the constant AVLayerVideoGravityResize</summary><value></value><remarks>To be added.</remarks>
		...
		/// <summary>Represents the value associated with the constant AVLayerVideoGravityResizeAspect</summary><value></value><remarks>To be added.</remarks>
		...
		/// <summary>Represents the value associated with the constant AVLayerVideoGravityResizeAspectFill</summary><value></value><remarks>To be added.</remarks>
