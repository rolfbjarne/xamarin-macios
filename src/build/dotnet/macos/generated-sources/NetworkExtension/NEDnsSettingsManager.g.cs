...
namespace NetworkExtension {
	...
	public unsafe partial class NEDnsSettingsManager : NSObject {
		...
		const string selDnsSettingsX = "dnsSettings";
		static readonly NativeHandle selDnsSettingsXHandle = Selector.GetHandle ("dnsSettings");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetDnsSettings_X = "setDnsSettings:";
		static readonly NativeHandle selSetDnsSettings_XHandle = Selector.GetHandle ("setDnsSettings:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual NEDnsSettings? DnsSettings {
			...
			get {
				NEDnsSettings? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NEDnsSettings> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selDnsSettingsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NEDnsSettings> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selDnsSettingsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetDnsSettings_XHandle, value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetDnsSettings_XHandle, value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
		...
		public static NEDnsSettingsManager SharedManager {
			...
			get {
				...
				ret =  Runtime.GetNSObject<NEDnsSettingsManager> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selSharedManagerXHandle), false)!;
				return ret!;
			}
		}
