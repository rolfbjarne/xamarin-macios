...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSKernel : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		public virtual MPSKernel CopyWithZone (NSZone? zone, global::Metal.IMTLDevice? device)
		{
			...
			MPSKernel? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<MPSKernel> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("copyWithZone:device:"), zone__handle__, device__handle__), true)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<MPSKernel> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("copyWithZone:device:"), zone__handle__, device__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (zone);
		...
		public virtual MPSKernelOptions Options {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (MetalPerformanceShaders.MPSKernelOptions) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("options"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MetalPerformanceShaders.MPSKernelOptions) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("options"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
