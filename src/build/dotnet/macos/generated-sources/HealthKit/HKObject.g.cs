...
namespace HealthKit {
	...
	public unsafe partial class HKObject : NSObject, INSCoding, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSourceRevisionX = "sourceRevision";
		static readonly NativeHandle selSourceRevisionXHandle = Selector.GetHandle ("sourceRevision");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual HKSourceRevision SourceRevision {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<HKSourceRevision> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selSourceRevisionXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<HKSourceRevision> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selSourceRevisionXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
