	...
	public class NSMutableArray1Test {
		...
		public void ContainsTest ()
		{
			...
			using (var arr = new NSMutableArray<NSString> (v, v)) {
				...
				ClassicAssert.IsTrue (arr.Contains (v), "Contains 1");
				ClassicAssert.IsFalse (arr.Contains (v2), "Contains 2");
			}
		}
		...
		public void IndexOfTest ()
		{
			...
			using (var arr = new NSMutableArray<NSString> (v1)) {
				...
				ClassicAssert.AreEqual ((nuint) 0, arr.IndexOf (v1), "IndexOf 1");
				ClassicAssert.AreEqual ((nuint) nint.MaxValue, arr.IndexOf (v2), "IndxOf 2"); // [NSArray indexOfObject:] returns NSNotFound = NSIntegerMax when object isn't found in the array
			}
		}
		...
		public void AddTest ()
		{
			...
			using (var arr = new NSMutableArray<NSString> (v1)) {
				ClassicAssert.AreEqual ((nuint) 1, arr.Count, "Count 1");
				Assert.Throws<ArgumentNullException> (() => arr.Add (null), "Add ANE");
				arr.Add (v2);
				ClassicAssert.AreEqual ((nuint) 2, arr.Count, "Count 2");
				ClassicAssert.AreSame (v2, arr [1], "idx[1]");
			}
		}
		...
		public void InsertTest ()
		{
			...
			using (var arr = new NSMutableArray<NSString> (v1, v3)) {
				ClassicAssert.AreEqual ((nuint) 2, arr.Count, "Insert 1");
				...
				arr.Insert (v2, 1);
				ClassicAssert.AreEqual ((nuint) 3, arr.Count, "Insert 2");
				ClassicAssert.AreSame (v1, arr [0], "[0]");
				ClassicAssert.AreSame (v2, arr [1], "[1]");
				ClassicAssert.AreSame (v3, arr [2], "[2]");
			}
		...
		public void ReplaceObjectTest ()
		{
			...
			using (var arr = new NSMutableArray<NSString> (v1, v3)) {
				ClassicAssert.AreEqual ((nuint) 2, arr.Count, "ReplaceObject 1");
				ClassicAssert.AreSame (v1, arr [0], "a [0]");
				ClassicAssert.AreSame (v3, arr [1], "a [1]");
				...
				ClassicAssert.AreEqual ((nuint) 2, arr.Count, "ReplaceObject 2");
				ClassicAssert.AreSame (v1, arr [0], "b [0]");
				ClassicAssert.AreSame (v2, arr [1], "b [1]");
			}
		}
		...
		public void AddObjectsTest ()
		{
			...
			using (var arr = new NSMutableArray<NSString> ()) {
				...
				ClassicAssert.AreEqual ((nuint) 0, arr.Count, "Count 1");

				Assert.Throws<ArgumentNullException> (() => arr.AddObjects (new NSString [] { null }), "AddObjects ANE 2");
				ClassicAssert.AreEqual ((nuint) 0, arr.Count, "Count 2");

				Assert.Throws<ArgumentNullException> (() => arr.AddObjects (new NSString [] { v1, null, v3 }), "AddObjects ANE 3");
				ClassicAssert.AreEqual ((nuint) 0, arr.Count, "Count 3");

				arr.AddObjects (v1, v2);
				ClassicAssert.AreEqual ((nuint) 2, arr.Count, "AddObjects 1");
				ClassicAssert.AreSame (v1, arr [0], "a [0]");
				ClassicAssert.AreSame (v2, arr [1], "a [1]");
			}
		}
		...
		public void InsertObjectsTest ()
		{
			...
			using (var arr = new NSMutableArray<NSString> (v1, v2)) {
				...
				ClassicAssert.AreEqual ((nuint) 2, arr.Count, "Count 1");
				...
				ClassicAssert.AreEqual ((nuint) 2, arr.Count, "Count 3");

				Assert.Throws<ArgumentNullException> (() => arr.InsertObjects (new NSString [] { v1 }, null), "InsertObjects ANE 4");
				ClassicAssert.AreEqual ((nuint) 2, arr.Count, "Count 4");

				arr.InsertObjects (new NSString [] { v3, v4 }, iset);

				ClassicAssert.AreEqual ((nuint) 4, arr.Count, "InsertObjects 1");
				ClassicAssert.AreSame (v1, arr [0], "a [0]");
				ClassicAssert.AreSame (v3, arr [1], "a [1]");
				ClassicAssert.AreSame (v4, arr [2], "a [2]");
				ClassicAssert.AreSame (v2, arr [3], "a [3]");
		...
		public void IndexerTest ()
		{
			...
			using (var arr = new NSMutableArray<NSString> (v1, v2)) {
				arr [1] = v3;
				ClassicAssert.AreEqual ((nuint) 2, arr.Count, "a 1");
				ClassicAssert.AreSame (v1, arr [0], "a [0]");
				ClassicAssert.AreSame (v3, arr [1], "a [1]");
		...
		public void IEnumerableTest ()
		{
			...
			using (var arr = new NSMutableArray<NSString> ()) {
				...
				ClassicAssert.AreEqual ((nuint) C, arr.Count, "Count 1");
				...
				foreach (NSString a in (IEnumerable) arr) {
					...
					ClassicAssert.AreEqual (lst.Count.ToString (), (string) a, "#" + lst.Count.ToString ());
					lst.Add (a);
				}
