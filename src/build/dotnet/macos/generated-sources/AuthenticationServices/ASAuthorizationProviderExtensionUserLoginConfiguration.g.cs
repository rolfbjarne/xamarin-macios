...
namespace AuthenticationServices {
	[Register("ASAuthorizationProviderExtensionUserLoginConfiguration", true)]
	[UnsupportedOSPlatform ("tvos")]
	[UnsupportedOSPlatform ("ios")]
	[UnsupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos14.0")]
	public unsafe partial class ASAuthorizationProviderExtensionUserLoginConfiguration : NSObject {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithLoginUserName_X = "initWithLoginUserName:";
		static readonly NativeHandle selInitWithLoginUserName_XHandle = Selector.GetHandle ("initWithLoginUserName:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("ASAuthorizationProviderExtensionUserLoginConfiguration");
		...
		protected ASAuthorizationProviderExtensionUserLoginConfiguration (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal ASAuthorizationProviderExtensionUserLoginConfiguration (NativeHandle handle) : base (handle)
		{
		}
		...
		{
			if (loginUserName is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (loginUserName));
			var nsloginUserName = CFString.CreateNative (loginUserName);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithLoginUserName_XHandle, nsloginUserName), "initWithLoginUserName:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithLoginUserName_XHandle, nsloginUserName), "initWithLoginUserName:");
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nsloginUserName);
		}
