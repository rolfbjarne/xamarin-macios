	...
	public partial class Application
	{
		...
		public string GetLibMono (AssemblyBuildTarget build_target)
		{
			...
			case AssemblyBuildTarget.Framework:
				return Path.Combine (Driver.GetProductFrameworksDirectory (this), "Mono.framework");
			default:
		...
		public string GetLibXamarin (AssemblyBuildTarget build_target)
		{
			...
			case AssemblyBuildTarget.Framework:
				return Path.Combine (Driver.GetProductFrameworksDirectory (this), EnableDebug ? "Xamarin-debug.framework" : "Xamarin.framework");
			default:
				throw ErrorHelper.CreateError (100, Errors.MT0100, build_target);
			}
		}
