...
namespace NetworkExtension {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ProvideIdentity", Selector = "provideIdentityForConnection:completionHandler:", ParameterType = new Type [] { typeof (NWTcpConnection), typeof (global::System.Action<global::Security.SecIdentity, NSArray>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity2V133) })]
	...
	public partial interface INWTcpConnectionAuthenticationDelegate : INativeObject, IDisposable
	{
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ProvideIdentity (NWTcpConnection connection, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V133))]global::System.Action<global::Security.SecIdentity, NSArray> completion)
		{
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _ProvideIdentity (INWTcpConnectionAuthenticationDelegate This, NWTcpConnection connection, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V133))]global::System.Action<global::Security.SecIdentity, NSArray> completion)
		{
			var connection__handle__ = connection!.GetNonNullHandle (nameof (connection));
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _EvaluateTrust (INWTcpConnectionAuthenticationDelegate This, NWTcpConnection connection, NSArray peerCertificateChain, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V211))]global::System.Action<global::Security.SecTrust> completion)
		{
			var connection__handle__ = connection!.GetNonNullHandle (nameof (connection));
	...
	public unsafe static partial class NWTcpConnectionAuthenticationDelegate_Extensions {
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void ProvideIdentity (this INWTcpConnectionAuthenticationDelegate This, NWTcpConnection connection, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V133))]global::System.Action<global::Security.SecIdentity, NSArray> completion)
		{
			var connection__handle__ = connection!.GetNonNullHandle (nameof (connection));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
...
namespace NetworkExtension {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_MacCatalyst__NetworkExtension_NWTcpConnectionAuthenticationDelegate", false)]
	[Model]
	[ObsoletedOSPlatform ("ios18.0", "Use 'Security.SecProtocolOptions' instead.")]
	[ObsoletedOSPlatform ("maccatalyst18.0", "Use 'Security.SecProtocolOptions' instead.")]
	[ObsoletedOSPlatform ("macos15.0", "Use 'Security.SecProtocolOptions' instead.")]
