...
namespace MapKit {
	...
	public unsafe partial class MKMultiPolygon : MKShape, IMKGeoJsonObject, IMKOverlay {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithPolygons_X = "initWithPolygons:";
		static readonly NativeHandle selInitWithPolygons_XHandle = Selector.GetHandle ("initWithPolygons:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPolygonsX = "polygons";
		static readonly NativeHandle selPolygonsXHandle = Selector.GetHandle ("polygons");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MKMultiPolygon");
		...
		/// <summary>Creates a new <see cref="MKMultiPolygon" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public MKMultiPolygon () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected MKMultiPolygon (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MKMultiPolygon (NativeHandle handle) : base (handle)
		{
		}
		...
		{
			if (polygons is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (polygons));
			using var nsa_polygons = NSArray.FromNSObjects (polygons);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithPolygons_XHandle, nsa_polygons.Handle), "initWithPolygons:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithPolygons_XHandle, nsa_polygons.Handle), "initWithPolygons:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual MKPolygon[] Polygons {
			...
			get {
				MKPolygon[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<MKPolygon>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selPolygonsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<MKPolygon>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selPolygonsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
