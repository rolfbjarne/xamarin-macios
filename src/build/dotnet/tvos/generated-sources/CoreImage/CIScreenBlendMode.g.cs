...
#nullable enable
namespace CoreImage {
	/// <summary>The CIScreenBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create CIImages from filters.
	...
	/// 
	/// // Construct the CIScreenBlend filter
	...
	/// };
	/// 
	/// var output = screenBlend.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/ScreenBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIScreenBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIScreenBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIScreenBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIScreenBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIScreenBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
