...
namespace CoreImage {
	public unsafe static partial class CIContext_CIDepthBlurEffect  {
		...
		const string selDepthBlurEffectFilterForImage_DisparityImage_PortraitEffectsMatte_HairSemanticSegmentation_GlassesMatte_GainMap_Orientation_Options_X = "depthBlurEffectFilterForImage:disparityImage:portraitEffectsMatte:hairSemanticSegmentation:glassesMatte:gainMap:orientation:options:";
		static readonly NativeHandle selDepthBlurEffectFilterForImage_DisparityImage_PortraitEffectsMatte_HairSemanticSegmentation_GlassesMatte_GainMap_Orientation_Options_XHandle = Selector.GetHandle ("depthBlurEffectFilterForImage:disparityImage:portraitEffectsMatte:hairSemanticSegmentation:glassesMatte:gainMap:orientation:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDepthBlurEffectFilterForImage_DisparityImage_PortraitEffectsMatte_HairSemanticSegmentation_Orientation_Options_X = "depthBlurEffectFilterForImage:disparityImage:portraitEffectsMatte:hairSemanticSegmentation:orientation:options:";
		static readonly NativeHandle selDepthBlurEffectFilterForImage_DisparityImage_PortraitEffectsMatte_HairSemanticSegmentation_Orientation_Options_XHandle = Selector.GetHandle ("depthBlurEffectFilterForImage:disparityImage:portraitEffectsMatte:hairSemanticSegmentation:orientation:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDepthBlurEffectFilterForImage_DisparityImage_PortraitEffectsMatte_Orientation_Options_X = "depthBlurEffectFilterForImage:disparityImage:portraitEffectsMatte:orientation:options:";
		static readonly NativeHandle selDepthBlurEffectFilterForImage_DisparityImage_PortraitEffectsMatte_Orientation_Options_XHandle = Selector.GetHandle ("depthBlurEffectFilterForImage:disparityImage:portraitEffectsMatte:orientation:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDepthBlurEffectFilterForImageData_Options_X = "depthBlurEffectFilterForImageData:options:";
		static readonly NativeHandle selDepthBlurEffectFilterForImageData_Options_XHandle = Selector.GetHandle ("depthBlurEffectFilterForImageData:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDepthBlurEffectFilterForImageURL_Options_X = "depthBlurEffectFilterForImageURL:options:";
		static readonly NativeHandle selDepthBlurEffectFilterForImageURL_Options_XHandle = Selector.GetHandle ("depthBlurEffectFilterForImageURL:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static CIFilter? GetDepthBlurEffectFilter (this CIContext This, NSUrl url, NSDictionary? options)
		{
			...
			CIFilter? ret;
			ret =  Runtime.GetNSObject<CIFilter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (This.Handle, selDepthBlurEffectFilterForImageURL_Options_XHandle, url__handle__, options__handle__), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (url);
		...
		public static CIFilter? GetDepthBlurEffectFilter (this CIContext This, NSData data, NSDictionary? options)
		{
			...
			var options__handle__ = options.GetHandle ();
			CIFilter? ret;
			ret =  Runtime.GetNSObject<CIFilter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (This.Handle, selDepthBlurEffectFilterForImageData_Options_XHandle, data__handle__, options__handle__), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (data);
			GC.KeepAlive (options);
			return ret!;
		...
		public static CIFilter? GetDepthBlurEffectFilter (this CIContext This, CIImage image, CIImage disparityImage, CIImage? portraitEffectsMatte, global::ImageIO.CGImagePropertyOrientation orientation, NSDictionary? options)
		{
			...
			var options__handle__ = options.GetHandle ();
			CIFilter? ret;
			ret =  Runtime.GetNSObject<CIFilter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_int_NativeHandle (This.Handle, selDepthBlurEffectFilterForImage_DisparityImage_PortraitEffectsMatte_Orientation_Options_XHandle, image__handle__, disparityImage__handle__, portraitEffectsMatte__handle__, (int)orientation, options__handle__), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (image);
		...
		public static CIFilter? GetDepthBlurEffectFilter (this CIContext This, CIImage image, CIImage disparityImage, CIImage? portraitEffectsMatte, CIImage? hairSemanticSegmentation, global::ImageIO.CGImagePropertyOrientation orientation, NSDictionary? options)
		{
			...
			var options__handle__ = options.GetHandle ();
			CIFilter? ret;
			ret =  Runtime.GetNSObject<CIFilter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_int_NativeHandle (This.Handle, selDepthBlurEffectFilterForImage_DisparityImage_PortraitEffectsMatte_HairSemanticSegmentation_Orientation_Options_XHandle, image__handle__, disparityImage__handle__, portraitEffectsMatte__handle__, hairSemanticSegmentation__handle__, (int)orientation, options__handle__), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (image);
			GC.KeepAlive (disparityImage);
			GC.KeepAlive (portraitEffectsMatte);
