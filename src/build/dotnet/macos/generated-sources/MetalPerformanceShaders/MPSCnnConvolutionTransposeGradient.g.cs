...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSCnnConvolutionTransposeGradient : MPSCnnGradientKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGradientOptionX = "gradientOption";
		static readonly NativeHandle selGradientOptionXHandle = Selector.GetHandle ("gradientOption");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetGradientOption_X = "setGradientOption:";
		static readonly NativeHandle selSetGradientOption_XHandle = Selector.GetHandle ("setGradientOption:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSourceGradientFeatureChannelsX = "sourceGradientFeatureChannels";
		static readonly NativeHandle selSourceGradientFeatureChannelsXHandle = Selector.GetHandle ("sourceGradientFeatureChannels");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSourceImageFeatureChannelsX = "sourceImageFeatureChannels";
		static readonly NativeHandle selSourceImageFeatureChannelsXHandle = Selector.GetHandle ("sourceImageFeatureChannels");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual MPSCnnConvolutionGradientOption GradientOption {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (MetalPerformanceShaders.MPSCnnConvolutionGradientOption) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selGradientOptionXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MetalPerformanceShaders.MPSCnnConvolutionGradientOption) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selGradientOptionXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selSetGradientOption_XHandle, (UIntPtr) (ulong) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selSetGradientOption_XHandle, (UIntPtr) (ulong) value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual nuint SourceGradientFeatureChannels {
			...
			get {
				nuint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selSourceGradientFeatureChannelsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selSourceGradientFeatureChannelsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual nuint SourceImageFeatureChannels {
			...
			get {
				nuint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selSourceImageFeatureChannelsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selSourceImageFeatureChannelsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
