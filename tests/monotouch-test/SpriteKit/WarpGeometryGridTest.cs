...
namespace MonoTouchFixtures.SpriteKit {
	...
	public class WarpGeometryGridTest {
		...
		public void SKWarpGeometryGridTest ()
		{
			...
			ClassicAssert.NotNull (grid, "new SKWarpGeometryGrid () should not return null");
		}
		...
		public void CreateTest ()
		{
			...
			ClassicAssert.NotNull (grid, "SKWarpGeometryGrid.Create should not return null");
		}
		...
		public void GetGridByReplacingSourcePositionsTest ()
		{
			...
			using (var grid = SKWarpGeometryGrid.GetGrid ()) {
				...
				ClassicAssert.NotNull (r, "GetGridByReplacingSourcePositions should not return null");
			}
		}
		...
		public void GetGridByReplacingDestPositionsTest ()
		{
			...
			using (var grid = SKWarpGeometryGrid.GetGrid ()) {
				...
				ClassicAssert.NotNull (r, "GetGridByReplacingDestPositions should not return null");
			}
		}
	}
}
