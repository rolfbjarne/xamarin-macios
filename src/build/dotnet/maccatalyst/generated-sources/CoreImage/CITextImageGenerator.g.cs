...
namespace CoreImage {
	...
	public partial class CITextImageGenerator : CIImageGenerator, ICITextImageGeneratorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CITextImageGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CITextImageGenerator () : base ("CITextImageGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CITextImageGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CITextImageGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CITextImageGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CITextImageGeneratorProtocol protocol members 
		...
		public string FontName {
			...
			get {
				var handle = GetHandle ("inputFontName");
				return CFString.FromHandle (handle)!;
			}
			[Export ("setFontName:", ArgumentSemantic.Retain)]
			set {
				SetString ("inputFontName", value);
			}
		}
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("macos")]
