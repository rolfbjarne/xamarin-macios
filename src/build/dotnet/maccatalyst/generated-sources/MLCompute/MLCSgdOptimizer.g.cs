...
namespace MLCompute {
	...
	public unsafe partial class MLCSgdOptimizer : MLCOptimizer, INSCopying {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MLCSGDOptimizer");
		...
		protected MLCSgdOptimizer (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MLCSgdOptimizer (NativeHandle handle) : base (handle)
		{
		}
		...
		public static MLCSgdOptimizer Create (MLCOptimizerDescriptor optimizerDescriptor)
		{
			...
			MLCSgdOptimizer? ret;
			ret =  Runtime.GetNSObject<MLCSgdOptimizer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("optimizerWithDescriptor:"), optimizerDescriptor__handle__), false)!;
		...
		public static MLCSgdOptimizer Create (MLCOptimizerDescriptor optimizerDescriptor, float momentumScale, bool usesNesterovMomentum)
		{
			var optimizerDescriptor__handle__ = optimizerDescriptor!.GetNonNullHandle (nameof (optimizerDescriptor));
			MLCSgdOptimizer? ret;
			ret =  Runtime.GetNSObject<MLCSgdOptimizer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_float_bool (class_ptr, Selector.GetHandle ("optimizerWithDescriptor:momentumScale:usesNesterovMomentum:"), optimizerDescriptor__handle__, momentumScale, usesNesterovMomentum ? (byte) 1 : (byte) 0), false)!;
			GC.KeepAlive (optimizerDescriptor);
			return ret!;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual bool UsesNesterovMomentum {
			[Export ("usesNesterovMomentum")]
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("usesNesterovMomentum"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("usesNesterovMomentum"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
