...
namespace CoreImage {
	...
	public unsafe partial class CISampler : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSamplerWithImage_X = "samplerWithImage:";
		static readonly NativeHandle selSamplerWithImage_XHandle = Selector.GetHandle ("samplerWithImage:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSamplerWithImage_Options_X = "samplerWithImage:options:";
		static readonly NativeHandle selSamplerWithImage_Options_XHandle = Selector.GetHandle ("samplerWithImage:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithImage_XHandle, sourceImage__handle__), "initWithImage:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithImage_XHandle, sourceImage__handle__), "initWithImage:");
					GC.KeepAlive (this);
				}
			}
		...
		public static CISampler FromImage (CIImage sourceImage)
		{
			var sourceImage__handle__ = sourceImage!.GetNonNullHandle (nameof (sourceImage));
			CISampler? ret;
			ret =  Runtime.GetNSObject<CISampler> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selSamplerWithImage_XHandle, sourceImage__handle__), false)!;
			GC.KeepAlive (sourceImage);
			return ret!;
		}
		...
		internal static CISampler FromImage (CIImage sourceImag, NSDictionary? options)
		{
			...
			var options__handle__ = options.GetHandle ();
			CISampler? ret;
			ret =  Runtime.GetNSObject<CISampler> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, selSamplerWithImage_Options_XHandle, sourceImag__handle__, options__handle__), false)!;
