...
#nullable enable
namespace ARKit {
	[Register("ARBodyAnchor", true)]
	[SupportedOSPlatform ("ios13.0")]
	public unsafe partial class ARBodyAnchor : ARAnchor, IARTrackable {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("ARBodyAnchor");
		...
		public ARBodyAnchor (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected ARBodyAnchor (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal ARBodyAnchor (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual ARSkeleton3D Skeleton {
			[Export ("skeleton", ArgumentSemantic.Retain)]
			get {
				ARSkeleton3D? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<ARSkeleton3D> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("skeleton")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<ARSkeleton3D> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("skeleton")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
