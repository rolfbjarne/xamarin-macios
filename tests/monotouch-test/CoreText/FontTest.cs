...
namespace MonoTouchFixtures.CoreText {
	...
	public class FontTest {
		...
		public void GetCascadeList ()
		{
			...
			using (var font = new CTFont ("HoeflerText-Regular", 10, CTFontOptions.Default)) {
				ClassicAssert.NotNull (font.GetDefaultCascadeList (null), "null");
			}
		}
		...
		public void GetLocalizedName ()
		{
			...
			using (var font = new CTFont ("HoeflerText-Regular", 10, CTFontOptions.Default)) {
				ClassicAssert.NotNull (font.GetLocalizedName (CTFontNameKey.Copyright), "1");
				...
				if (language == "en") {
					string str;
					ClassicAssert.NotNull (font.GetLocalizedName (CTFontNameKey.Full, out str), "2");
					ClassicAssert.NotNull (str, "out str");
				}
			}
		}
		...
		public void GetGlyphsForCharacters_35048 ()
		{
			...
			using (var ctfont = font.ToCTFont ((nfloat) 10.0)) {
				...
				ClassicAssert.True (ctfont.GetGlyphsForCharacters ("\ud83d\ude00".ToCharArray (), gid), "GetGlyphsForCharacters");
		...
		public void CTFontCopyNameForGlyph ()
		{
			...
			using (var font = CreateAppleColorEmojiFont ())
			using (var ctfont = font.ToCTFont ((nfloat) 10.0))
				ClassicAssert.Null (ctfont.GetGlyphName ('\ud83d'), "2");
		}
		...
		public void DrawImage ()
		{
			...
			ClassicAssert.AreEqual (1, provider.Count, "#Count");
		}
		...
		public void GetTypographicBoundsForAdaptiveImageProvider ()
		{
			...
			ClassicAssert.AreEqual (0, provider.Count, "#Count");
		}
		...
		public void GetVariationAxes ()
		{
			using (var font = new CTFont ("HoeflerText-Regular", 10)) {
				...
				ClassicAssert.IsNotNull (axes, "axes");
