...
namespace MonoTouchFixtures.Foundation {
	...
	public class NSArray1Test {
		...
		public void Ctor ()
		{
			...
			ClassicAssert.AreEqual ((nuint) 0, arr.Count, "NSArray Count");
		}
		...
		public void FromNSObjectsTest ()
		{
			...
			using (var arr = NSArray<NSString>.FromNSObjects (str1, str2, str3)) {
				ClassicAssert.AreEqual ((nuint) 3, arr.Count, "NSArray Count");
				ClassicAssert.AreSame (str1, arr [0], "NSArray indexer");
				ClassicAssert.AreSame (str2, arr [1], "NSArray indexer");
				ClassicAssert.AreSame (str3, arr [2], "NSArray indexer");
			}
		}
		...
		public void FromNSObjectsNullTest ()
		{
			...
			using (var arr = NSArray<NSString>.FromNSObjects (str1, str2, str3)) {
				ClassicAssert.AreEqual ((nuint) 3, arr.Count, "NSArray Count");
				ClassicAssert.AreSame (str1, arr [0], "NSArray indexer");
				ClassicAssert.IsNull (arr [1], "NSArray null indexer");
				ClassicAssert.AreSame (str3, arr [2], "NSArray indexer");
			}
		}
		...
		public void ToArray ()
		{
			using (var a = NSArray<NSString>.FromNSObjects ((NSString) "abc")) {
				...
				ClassicAssert.AreEqual (1, arr.Length, "Length");
				ClassicAssert.AreEqual ("abc", arr [0].ToString (), "Value");
				ClassicAssert.AreEqual ("abc", (string) element, "Value element");
			}
		}
		...
		public void FromIntPtrs_NativeHandle ()
		{
			...
			using (var arr = NSArray.FromIntPtrs (handles)) {
				ClassicAssert.AreEqual ((nuint) 3, arr.Count, "NSArray Count");
				ClassicAssert.AreEqual ("1", arr.GetItem<NSString> (0).ToString (), "NSArray item 0");
				ClassicAssert.AreEqual ("2", arr.GetItem<NSString> (1).ToString (), "NSArray item 1");
				ClassicAssert.AreEqual ("3", arr.GetItem<NSString> (2).ToString (), "NSArray item 2");
			}
		}
		...
		public void FromNSObjects_JaggedArray ()
		{
			...
			using (var arr = NSArray.FromNSObjects (jaggedArray)) {
				ClassicAssert.AreEqual ((nuint) 2, arr.Count, "Outer array count");
				var row0 = arr.GetItem<NSArray> (0);
				var row1 = arr.GetItem<NSArray> (1);
				ClassicAssert.AreEqual ((nuint) 2, row0.Count, "Row 0 count");
				ClassicAssert.AreEqual ((nuint) 2, row1.Count, "Row 1 count");
				ClassicAssert.AreEqual ("1", row0.GetItem<NSString> (0).ToString (), "Row 0, Item 0");
				ClassicAssert.AreEqual ("2", row0.GetItem<NSString> (1).ToString (), "Row 0, Item 1");
				ClassicAssert.AreEqual ("3", row1.GetItem<NSString> (0).ToString (), "Row 1, Item 0");
				ClassicAssert.AreEqual ("4", row1.GetItem<NSString> (1).ToString (), "Row 1, Item 1");
			}
		}
		...
		public void FromNSObjects_JaggedArray_Null ()
		{
			...
			ClassicAssert.IsNull (arr, "Should return null for null input");
		}
		...
		public void FromNSObjects_WithConverter ()
		{
			...
			using (var arr = NSArray.FromNSObjects<int> (x => NSNumber.FromInt32 (x), numbers)) {
				ClassicAssert.AreEqual ((nuint) 3, arr.Count, "Count");
				ClassicAssert.AreEqual (1, arr.GetItem<NSNumber> (0).Int32Value, "Item 0");
				ClassicAssert.AreEqual (2, arr.GetItem<NSNumber> (1).Int32Value, "Item 1");
				ClassicAssert.AreEqual (3, arr.GetItem<NSNumber> (2).Int32Value, "Item 2");
			}
		}
		...
		public void FromNSObjects_WithConverter_ReturnsNull ()
		{
			...
			try {
				...
				ClassicAssert.IsNotNull (item0, "Item 0 should not be null");
				ClassicAssert.AreEqual (1, item0.Int32Value, "Item 0");
			} catch (Exception ex) {
			...
			var count = arr.Count;
			ClassicAssert.AreEqual ((nuint) 3, count, "Should have 3 items including null");

			try {
				var item2 = arr.GetItem<NSNumber> (2);
				ClassicAssert.IsNotNull (item2, "Item 2 should not be null");
				ClassicAssert.AreEqual (3, item2.Int32Value, "Item 2");
			} catch (Exception ex) {
		...
		public void FromObjects_WithCount_ConvertsOnlyCount ()
		{
			...
			using (var arr = NSArray.FromObjects (2, items)) {
				...
				ClassicAssert.AreEqual ((nuint) 2, arr.Count, "Count should be 2");
			}
		}
		...
		public void FromNSObjects_CountFirst_WithNull ()
		{
			...
			using (var arr = NSArray.FromNSObjects<NSString> (3, items)) {
				ClassicAssert.AreEqual ((nuint) 3, arr.Count, "Count should include null");
				ClassicAssert.AreEqual (str1, arr.GetItem<NSString> (0), "Item 0");
				// Item 1 is null, but GetItem may not retrieve it properly
				// Just verify count is correct (3 items including the null)
				ClassicAssert.AreEqual (str3, arr.GetItem<NSString> (2), "Item 2");
			}
		}
		...
		public void FromNSObjects_CountFirst_Basic ()
		{
			...
			using (var arr = NSArray.FromNSObjects<NSString> (2, items)) {
				...
				ClassicAssert.AreEqual (str1, arr.GetItem<NSString> (0), "Item 0");
				ClassicAssert.AreEqual (str2, arr.GetItem<NSString> (1), "Item 1");
			}
		}
		...
		public void FromNSObjects_CountFirst_NullArray ()
		{
			...
			using (var arr = NSArray.FromNSObjects<NSString> (0, items)) {
				ClassicAssert.AreEqual ((nuint) 0, arr.Count, "Null array should create empty array");
			}
		}
		...
		public void FromObjects_BasicTypes ()
		{
			...
			using (var arr = NSArray.FromObjects (items)) {
				ClassicAssert.AreEqual ((nuint) 4, arr.Count, "Count");
				ClassicAssert.AreEqual (1, arr.GetItem<NSNumber> (0).Int32Value, "Item 0");
				ClassicAssert.AreEqual ("hello", arr.GetItem<NSString> (1).ToString (), "Item 1");
				ClassicAssert.AreEqual (3.14, arr.GetItem<NSNumber> (2).DoubleValue, 0.01, "Item 2");
				ClassicAssert.AreEqual (true, arr.GetItem<NSNumber> (3).BoolValue, "Item 3");
			}
		}
		...
		public void FromObjects_Null ()
		{
			object []? items = null;
			using (var arr = NSArray.FromObjects (items)) {
				ClassicAssert.AreEqual ((nuint) 0, arr.Count, "Should return empty array for null input");
			}
		}
		...
		public void FromObjects_WithCountZero ()
		{
			...
			using (var arr = NSArray.FromObjects (0, items)) {
				ClassicAssert.AreEqual ((nuint) 0, arr.Count, "Count should be 0");
			}
		}
		...
		public void FromObjects_WithCount_Null ()
		{
			using (var arr = NSArray.FromObjects (0, null)) {
				ClassicAssert.AreEqual ((nuint) 0, arr.Count, "Should return empty array");
			}
		}
		...
		public void EnumsFromHandle_ReturnsNullForZeroHandle ()
		{
			...
			ClassicAssert.IsNull (result, "null for zero handle");
		}
		...
		public void EnumsFromHandle_Roundtrip ()
		{
			...
			ClassicAssert.IsNotNull (actual, "not null");
		...
		public void GetDifferenceFromArrayTest ()
		{
			...
			ClassicAssert.NotNull (diff, "Not null");
		}
#endif
		...
		public void FromArrayOfArray ()
		{
			...
			ClassicAssert.AreEqual (2, result [0].Length, "inner1 length");
			ClassicAssert.AreEqual (1, result [1].Length, "inner2 length");
			ClassicAssert.AreEqual ("a", result [0] [0].ToString (), "inner1[0]");
			ClassicAssert.AreEqual ("b", result [0] [1].ToString (), "inner1[1]");
			ClassicAssert.AreEqual ("c", result [1] [0].ToString (), "inner2[0]");
		}
		...
		public void FromArrayOfArray_Null ()
		{
			...
			ClassicAssert.IsNull (result, "result");
		}
		...
		public void From_JaggedArray ()
		{
			...
			ClassicAssert.IsNotNull (arr, "arr");
			ClassicAssert.AreEqual ((nuint) 2, arr!.Count, "outer count");
			var row0 = arr.GetItem<NSArray> (0)!;
			var row1 = arr.GetItem<NSArray> (1)!;
			ClassicAssert.AreEqual ((nuint) 2, row0.Count, "row0 count");
			ClassicAssert.AreEqual ((nuint) 1, row1.Count, "row1 count");
		}
		...
		public void FromArrayOfArray_Roundtrip ()
		{
			...
			ClassicAssert.IsNotNull (native, "native");

			var roundtripped = NSArray.FromArrayOfArray (native);
			ClassicAssert.IsNotNull (roundtripped, "roundtripped");
			ClassicAssert.AreEqual (original.Length, roundtripped!.Length, "outer length");
			ClassicAssert.AreEqual (original [0].Length, roundtripped [0].Length, "inner0 length");
			ClassicAssert.AreEqual (original [1].Length, roundtripped [1].Length, "inner1 length");
			ClassicAssert.AreEqual ("1", roundtripped [0] [0].ToString (), "[0][0]");
			ClassicAssert.AreEqual ("2", roundtripped [0] [1].ToString (), "[0][1]");
			ClassicAssert.AreEqual ("3", roundtripped [1] [0].ToString (), "[1][0]");
		}
	}
}
