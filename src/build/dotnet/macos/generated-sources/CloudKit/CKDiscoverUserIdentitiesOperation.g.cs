...
namespace CloudKit {
	...
	public unsafe partial class CKDiscoverUserIdentitiesOperation : CKOperation {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDiscoverUserIdentitiesCompletionBlockX = "discoverUserIdentitiesCompletionBlock";
		static readonly NativeHandle selDiscoverUserIdentitiesCompletionBlockXHandle = Selector.GetHandle ("discoverUserIdentitiesCompletionBlock");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetDiscoverUserIdentitiesCompletionBlock_X = "setDiscoverUserIdentitiesCompletionBlock:";
		static readonly NativeHandle selSetDiscoverUserIdentitiesCompletionBlock_XHandle = Selector.GetHandle ("setDiscoverUserIdentitiesCompletionBlock:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("CKDiscoverUserIdentitiesOperation");
		...
		protected CKDiscoverUserIdentitiesOperation (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CKDiscoverUserIdentitiesOperation (NativeHandle handle) : base (handle)
		{
		}
		...
		public unsafe virtual global::System.Action<NSError>? Completed {
			...
			get {
				NativeHandle ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selDiscoverUserIdentitiesCompletionBlockXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selDiscoverUserIdentitiesCompletionBlockXHandle);
						GC.KeepAlive (this);
					}
				}
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetDiscoverUserIdentitiesCompletionBlock_XHandle, (IntPtr) block_ptr_value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetDiscoverUserIdentitiesCompletionBlock_XHandle, (IntPtr) block_ptr_value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual CKUserIdentityLookupInfo[] UserIdentityLookupInfos {
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetUserIdentityLookupInfos_XHandle, nsa_value.Handle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetUserIdentityLookupInfos_XHandle, nsa_value.Handle);
						GC.KeepAlive (this);
					}
				}
			}
