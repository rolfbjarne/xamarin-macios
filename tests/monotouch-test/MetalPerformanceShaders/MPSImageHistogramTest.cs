	...
	public class MPSImageHistogramTest {
		...
		public void Constructors ()
		{
			...
			using (var obj = new MPSImageHistogram (MTLDevice.SystemDefault, ref info)) {
				...
				ClassicAssert.AreEqual ((nint) (-1), crs.Size.Depth, "ClipRectSource.Size.Depth");
				ClassicAssert.AreEqual ((nint) (-1), crs.Size.Height, "ClipRectSource.Size.Height");
				ClassicAssert.AreEqual ((nint) (-1), crs.Size.Width, "ClipRectSource.Size.Width");
			}
		}
	}
}
