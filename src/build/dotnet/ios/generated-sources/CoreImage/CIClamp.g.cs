...
namespace CoreImage {
	...
	public partial class CIClamp : CIFilter {
		/// <summary>Creates a new <see cref="CIClamp" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIClamp () : base ("CIClamp")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIClamp (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIClamp (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIClamp (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>A vector whose values define the clamped rectangle within the <see cref="P:CoreImage.CIClamp.InputImage" />.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
