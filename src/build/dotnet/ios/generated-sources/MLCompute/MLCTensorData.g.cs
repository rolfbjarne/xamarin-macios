...
namespace MLCompute {
	...
	public unsafe partial class MLCTensorData : NSObject {
		...
		{
			MLCTensorData ret;
			ret =  Runtime.GetNSObject<MLCTensorData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_UIntPtr (class_ptr, Selector.GetHandle ("dataWithBytesNoCopy:length:"), bytes, length), false)!;
			return ret;
		}
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static MLCTensorData CreateFromBytesNoCopy (nint bytes, nuint length, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V82))]global::System.Action<nint, nuint> deallocator)
		{
			if (deallocator is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (deallocator));
			using var block_deallocator = Trampolines.SDActionArity2V82.CreateBlock (deallocator);
			BlockLiteral *block_ptr_deallocator = &block_deallocator;
			MLCTensorData ret;
			ret =  Runtime.GetNSObject<MLCTensorData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_UIntPtr_NativeHandle (class_ptr, Selector.GetHandle ("dataWithBytesNoCopy:length:deallocator:"), bytes, length, (IntPtr) block_ptr_deallocator), false)!;
			return ret;
		}
		...
		{
			MLCTensorData ret;
			ret =  Runtime.GetNSObject<MLCTensorData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_UIntPtr (class_ptr, Selector.GetHandle ("dataWithImmutableBytesNoCopy:length:"), bytes, length), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
