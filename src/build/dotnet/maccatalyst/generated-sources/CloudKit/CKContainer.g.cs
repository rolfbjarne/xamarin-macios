...
namespace CloudKit {
	...
	public unsafe partial class CKContainer : NSObject {
		...
		public unsafe virtual void DiscoverAllIdentities ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V37))]global::System.Action<CKUserIdentity[], NSError> completionHandler)
		{
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity2V37.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("discoverAllIdentitiesWithCompletionHandler:"), (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public unsafe virtual void DiscoverUserIdentity (CKRecordID userRecordID, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V38))]global::System.Action<CKUserIdentity, NSError> completionHandler)
		{
			...
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity2V38.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
		...
		public unsafe virtual void FetchAllLongLivedOperationIDs ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V39))]global::System.Action<NSDictionary<NSString, NSOperation>, NSError> completionHandler)
		{
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity2V39.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("fetchAllLongLivedOperationIDsWithCompletionHandler:"), (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public unsafe virtual void FetchLongLivedOperation (string[] operationID, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V39))]global::System.Action<NSDictionary<NSString, NSOperation>, NSError> completionHandler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("fetchLongLivedOperationWithID:completionHandler:"), nsa_operationID.Handle, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		}
