...
namespace CallKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "PerformSetTranslatingCallAction", Selector = "provider:performSetTranslatingCallAction:", ParameterType = new Type [] { typeof (CallKit.CXProvider), typeof (CallKit.CXSetTranslatingCallAction) }, ParameterByRef = new bool [] { false, false })]
	public partial interface ICXProviderDelegate : INativeObject, IDisposable
	{
		...
		{
			_PerformSetTranslatingCallAction (this, provider, action);
		}
		[SupportedOSPlatform ("ios26.0")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[UnsupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _PerformSetTranslatingCallAction (ICXProviderDelegate This, CXProvider provider, CXSetTranslatingCallAction action)
		{
			var provider__handle__ = provider!.GetNonNullHandle (nameof (provider));
			var action__handle__ = action!.GetNonNullHandle (nameof (action));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("provider:performSetTranslatingCallAction:"), provider__handle__, action__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (provider);
			GC.KeepAlive (action);
		}
		...
		[DynamicDependencyAttribute ("PerformSetTranslatingCallAction(CallKit.CXProvider,CallKit.CXSetTranslatingCallAction)")]
...
namespace CallKit {
	/// <related type="externalDocumentation" href="https://developer.apple.com/reference/CallKit/CXProviderDelegate">Apple documentation for <c>CXProviderDelegate</c></related>
	[Protocol()]
	[Register("Microsoft_iOS__CallKit_CXProviderDelegate", false)]
	[Model]
	[UnsupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
