...
namespace MediaPlayer {
	/// <summary>Enumerates values that indicate whether a command succeeded, failed, or cannot play the kind of media requested.</summary><remarks>To be added.</remarks>
