...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITransitionFilter" /> that mimics the effect of a photocopier.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/copy_machine_transition.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CICopyMachineTransition : CITransitionFilter {
		/// <summary>Creates a new <see cref="CICopyMachineTransition" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CICopyMachineTransition (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CICopyMachineTransition (NSObjectFlag t) : base (t)
		{
		}
		...
		public CICopyMachineTransition (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Gets or sets the color of the swipe.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>Gets or sets the width of the swipe.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public float Width {
			get {
