...
namespace CoreImage {
	...
	public partial class CIMix : CIFilter, ICIMixProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIMix" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIMix () : base ("CIMix")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMix (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMix (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMix (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIMixProtocol protocol members 
