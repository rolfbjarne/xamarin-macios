...
#nullable enable
namespace UIKit {
	/// <summary>An enumeration indicating the location of the spine around which the <see cref="T:UIKit.UIPageViewController" /> transitions occur.</summary><remarks>To be added.</remarks>
