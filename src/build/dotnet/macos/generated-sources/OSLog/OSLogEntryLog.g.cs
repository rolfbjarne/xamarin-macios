	...
	public unsafe partial class OSLogEntryLog : OSLogEntry, IOSLogEntryFromProcess, IOSLogEntryWithPayload {
		...
		public virtual OSLogEntryLogLevel Level {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (OSLog.OSLogEntryLogLevel) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selLevelXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (OSLog.OSLogEntryLogLevel) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selLevelXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
