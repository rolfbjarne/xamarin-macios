...
namespace AppKit {
	...
	public unsafe partial class NSButtonTouchBarItem : NSTouchBarItem {
		...
		public static NSButtonTouchBarItem Create ([BindAs (typeof (NSTouchBarItemIdentifier), OriginalType = typeof (NSString))] global::AppKit.NSTouchBarItemIdentifier identifier, string title, NSObject? target, Selector? action)
		{
			...
			ret =  Runtime.GetNSObject<NSButtonTouchBarItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("buttonTouchBarItemWithIdentifier:title:target:action:"), nsb_identifier.GetHandle (), nstitle, target__handle__, action__handle__), false)!;
			GC.KeepAlive (target);
			GC.KeepAlive (action);
		...
		public static NSButtonTouchBarItem Create ([BindAs (typeof (NSTouchBarItemIdentifier), OriginalType = typeof (NSString))] global::AppKit.NSTouchBarItemIdentifier identifier, NSImage image, NSObject? target, Selector? action)
		{
			...
			using var nsb_identifier = global::AppKit.NSTouchBarItemIdentifierExtensions.GetConstant (identifier);
			NSButtonTouchBarItem? ret;
			ret =  Runtime.GetNSObject<NSButtonTouchBarItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("buttonTouchBarItemWithIdentifier:image:target:action:"), nsb_identifier.GetHandle (), image__handle__, target__handle__, action__handle__), false)!;
			GC.KeepAlive (image);
			GC.KeepAlive (target);
			GC.KeepAlive (action);
			return ret!;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual global::UIKit.UIColor? BezelColor {
			[Export ("bezelColor", ArgumentSemantic.Copy)]
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				global::UIKit.UIColor? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<global::UIKit.UIColor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("bezelColor")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<global::UIKit.UIColor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("bezelColor")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				var value__handle__ = value.GetHandle ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setBezelColor:"), value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setBezelColor:"), value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
