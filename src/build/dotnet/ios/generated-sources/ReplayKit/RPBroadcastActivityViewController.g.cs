...
#nullable enable
namespace ReplayKit {
	/// <summary>Presents a user interface for choosing third-party broadcast services.</summary><remarks>The view controller displays the currently installed broadcast services.</remarks><related type="externalDocumentation" href="https://developer.apple.com/reference/ReplayKit/RPBroadcastActivityViewController">Apple documentation for <c>RPBroadcastActivityViewController</c></related>
	[Register("RPBroadcastActivityViewController", true)]
	[UnsupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class RPBroadcastActivityViewController : global::UIKit.UIViewController {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("RPBroadcastActivityViewController");
		...
		/// <summary>Creates a new <see cref="RPBroadcastActivityViewController" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public RPBroadcastActivityViewController () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		public RPBroadcastActivityViewController (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected RPBroadcastActivityViewController (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal RPBroadcastActivityViewController (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public RPBroadcastActivityViewController (string? nibName, NSBundle? bundle)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void LoadBroadcastActivityViewController ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V153))]global::System.Action<RPBroadcastActivityViewController, NSError> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity2V153.CreateBlock (handler);
		...
		///         </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static Task<RPBroadcastActivityViewController> LoadBroadcastActivityViewControllerAsync ()
		{
			var tcs = new TaskCompletionSource<RPBroadcastActivityViewController> ();
			LoadBroadcastActivityViewController((arg1_, arg2_) => {
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void LoadBroadcastActivityViewController (string? preferredExtension, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V153))]global::System.Action<RPBroadcastActivityViewController, NSError> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static Task<RPBroadcastActivityViewController> LoadBroadcastActivityViewControllerAsync (string? preferredExtension)
		{
			var tcs = new TaskCompletionSource<RPBroadcastActivityViewController> ();
			LoadBroadcastActivityViewController(preferredExtension, (arg1_, arg2_) => {
				if (arg2_ is not null)
					tcs.SetException (new NSErrorException(arg2_));
				else
					tcs.SetResult (arg1_!);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual IRPBroadcastActivityViewControllerDelegate? Delegate {
			[Export ("delegate", ArgumentSemantic.Weak)]
			get {
				IRPBroadcastActivityViewControllerDelegate? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetINativeObject<IRPBroadcastActivityViewControllerDelegate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("delegate")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetINativeObject<IRPBroadcastActivityViewControllerDelegate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("delegate")), false)!;
						GC.KeepAlive (this);
					}
				}
				MarkDirty ();
