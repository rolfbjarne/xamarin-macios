...
namespace AVFoundation {
	...
	public unsafe partial class AVSpeechSynthesisProviderRequest : NSObject, INSCoding, INSCopying, INSSecureCoding {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithSSMLRepresentation:voice:"), nsssmlRepresentation, voice__handle__), "initWithSSMLRepresentation:voice:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithSSMLRepresentation:voice:"), nsssmlRepresentation, voice__handle__), "initWithSSMLRepresentation:voice:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (voice);
		...
		public virtual string SsmlRepresentation {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("ssmlRepresentation")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("ssmlRepresentation")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual AVSpeechSynthesisProviderVoice Voice {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<AVSpeechSynthesisProviderVoice> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("voice")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<AVSpeechSynthesisProviderVoice> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("voice")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
