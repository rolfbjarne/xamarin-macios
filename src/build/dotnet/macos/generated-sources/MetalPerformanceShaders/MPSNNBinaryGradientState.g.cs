...
namespace MetalPerformanceShaders {
	[Register("MPSNNBinaryGradientState", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class MPSNNBinaryGradientState : MPSState {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSNNBinaryGradientState");
		...
		protected MPSNNBinaryGradientState (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSNNBinaryGradientState (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSNNBinaryGradientState (global::Metal.IMTLDevice device, nuint bufferSize)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSNNBinaryGradientState (global::Metal.IMTLDevice device, global::Metal.MTLTextureDescriptor descriptor)
			: base (NSObjectFlag.Empty)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSNNBinaryGradientState (global::Metal.IMTLResource? resource)
			: base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSNNBinaryGradientState (global::Metal.IMTLDevice device, MPSStateResourceList resourceList)
			: base (NSObjectFlag.Empty)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSNNBinaryGradientState (global::Metal.IMTLResource[]? resources)
			: base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static MPSNNBinaryGradientState CreateTemporaryState (global::Metal.IMTLCommandBuffer commandBuffer, nuint bufferSize)
		{
			var commandBuffer__handle__ = commandBuffer!.GetNonNullHandle (nameof (commandBuffer));
			MPSNNBinaryGradientState? ret;
			ret =  Runtime.GetNSObject<MPSNNBinaryGradientState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_UIntPtr (class_ptr, selTemporaryStateWithCommandBuffer_BufferSize_XHandle, commandBuffer__handle__, bufferSize), false)!;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static MPSNNBinaryGradientState CreateTemporaryState (global::Metal.IMTLCommandBuffer commandBuffer, global::Metal.MTLTextureDescriptor descriptor)
		{
			var commandBuffer__handle__ = commandBuffer!.GetNonNullHandle (nameof (commandBuffer));
			var descriptor__handle__ = descriptor!.GetNonNullHandle (nameof (descriptor));
			MPSNNBinaryGradientState? ret;
			ret =  Runtime.GetNSObject<MPSNNBinaryGradientState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, selTemporaryStateWithCommandBuffer_TextureDescriptor_XHandle, commandBuffer__handle__, descriptor__handle__), false)!;
			GC.KeepAlive (commandBuffer);
			GC.KeepAlive (descriptor);
			return ret!;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static MPSNNBinaryGradientState CreateTemporaryState (global::Metal.IMTLCommandBuffer commandBuffer)
		{
			var commandBuffer__handle__ = commandBuffer!.GetNonNullHandle (nameof (commandBuffer));
			MPSNNBinaryGradientState? ret;
			ret =  Runtime.GetNSObject<MPSNNBinaryGradientState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selTemporaryStateWithCommandBuffer_XHandle, commandBuffer__handle__), false)!;
			GC.KeepAlive (commandBuffer);
			return ret!;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static MPSNNBinaryGradientState CreateTemporaryState (global::Metal.IMTLCommandBuffer commandBuffer, MPSStateResourceList resourceList)
		{
			var commandBuffer__handle__ = commandBuffer!.GetNonNullHandle (nameof (commandBuffer));
			var resourceList__handle__ = resourceList!.GetNonNullHandle (nameof (resourceList));
			MPSNNBinaryGradientState? ret;
			ret =  Runtime.GetNSObject<MPSNNBinaryGradientState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, selTemporaryStateWithCommandBuffer_ResourceList_XHandle, commandBuffer__handle__, resourceList__handle__), false)!;
			GC.KeepAlive (commandBuffer);
			GC.KeepAlive (resourceList);
			return ret!;
		}
