...
namespace MonotouchTest.AudioUnitExtensionHost {
	static class ExtensionTestHost {
		...
		static extern void NativeNSLog (IntPtr format, IntPtr value);
		...
		static void Log (string message)
		{
			...
			using var format = new NSString ("ZZZZ %@");
			using var value = new NSString (message);
			NativeNSLog (format.Handle, value.Handle);
		}
