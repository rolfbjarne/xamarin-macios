...
namespace CoreImage {
	...
	public partial class CISunbeamsGenerator : CIFilter, ICISunbeamsGeneratorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CISunbeamsGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CISunbeamsGenerator () : base ("CISunbeamsGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISunbeamsGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISunbeamsGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISunbeamsGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CISunbeamsGeneratorProtocol protocol members 
		...
		public float SunRadius {
			[Export ("sunRadius")]
			get {
				return GetFloat ("inputSunRadius");
			}
			[Export ("setSunRadius:")]
			set {
				SetFloat ("inputSunRadius", value);
			}
		}
