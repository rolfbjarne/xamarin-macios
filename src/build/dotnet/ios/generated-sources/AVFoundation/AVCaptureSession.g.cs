...
namespace AVFoundation {
	...
	public unsafe partial class AVCaptureSession : NSObject {
		...
		[UnsupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("ios26.0")]
		public virtual bool ConfiguresApplicationAudioSessionForBluetoothHighQualityRecording {
			[Export ("configuresApplicationAudioSessionForBluetoothHighQualityRecording")]
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("configuresApplicationAudioSessionForBluetoothHighQualityRecording"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("configuresApplicationAudioSessionForBluetoothHighQualityRecording"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
			}
			[Export ("setConfiguresApplicationAudioSessionForBluetoothHighQualityRecording:")]
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_bool (this.Handle, Selector.GetHandle ("setConfiguresApplicationAudioSessionForBluetoothHighQualityRecording:"), value ? (byte) 1 : (byte) 0);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, Selector.GetHandle ("setConfiguresApplicationAudioSessionForBluetoothHighQualityRecording:"), value ? (byte) 1 : (byte) 0);
						GC.KeepAlive (this);
					}
				}
			}
