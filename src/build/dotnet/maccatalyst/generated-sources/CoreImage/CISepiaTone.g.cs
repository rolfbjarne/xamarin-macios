...
#nullable enable
namespace CoreImage {
	/// <summary>The CISepiaTone CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/SepiaTone.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CISepiaTone : CIFilter, ICISepiaToneProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CISepiaTone" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CISepiaTone () : base ("CISepiaTone")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISepiaTone (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISepiaTone (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISepiaTone (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CISepiaToneProtocol protocol members 
