...
namespace CoreAnimation {
	...
	public unsafe partial class CALayer : NSObject, ICAMediaTiming, INSCoding, INSSecureCoding {
		...
		public virtual void AddConstraint (CAConstraint c)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("addConstraint:"), c__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("addConstraint:"), c__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (c);
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_CGSize (this.Handle, Selector.GetHandle ("resizeWithOldSuperlayerSize:"), oldSuperlayerSize);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_CGSize (&__objc_super__, Selector.GetHandle ("resizeWithOldSuperlayerSize:"), oldSuperlayerSize);
					GC.KeepAlive (this);
				}
			}
		}
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_CGSize (this.Handle, Selector.GetHandle ("resizeSublayersWithOldSize:"), oldSize);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_CGSize (&__objc_super__, Selector.GetHandle ("resizeSublayersWithOldSize:"), oldSize);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual CAAutoresizingMask AutoresizingMask {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (CAAutoresizingMask) global::ObjCRuntime.Messaging.UInt32_objc_msgSend (this.Handle, Selector.GetHandle ("autoresizingMask"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (CAAutoresizingMask) global::ObjCRuntime.Messaging.UInt32_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("autoresizingMask"));
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UInt32 (this.Handle, Selector.GetHandle ("setAutoresizingMask:"), (UInt32)value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UInt32 (&__objc_super__, Selector.GetHandle ("setAutoresizingMask:"), (UInt32)value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual CAConstraint[]? Constraints {
			...
			get {
				CAConstraint[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<CAConstraint>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("constraints")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<CAConstraint>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("constraints")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual NSObject? LayoutManager {
			...
			get {
				NSObject? ret;
				if (IsDirectBinding) {
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("layoutManager")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("layoutManager")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
