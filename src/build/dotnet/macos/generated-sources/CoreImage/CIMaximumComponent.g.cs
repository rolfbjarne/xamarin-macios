...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIFilter" /> that creates a grayscale image from the maximum value of the RGB color values.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/maximum_component.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIMaximumComponent : CIFilter, ICIMaximumComponentProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIMaximumComponent" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMaximumComponent (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMaximumComponent (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMaximumComponent (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIMaximumComponentProtocol protocol members 
