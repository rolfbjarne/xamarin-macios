...
namespace Linker.Shared {
	...
	public class OptimizeGeneratedCodeTest {
		...
		public void IntPtrSizeOptimization ()
		{
			...
			bool classic = typeof (NSObject).Namespace.Contains (".");
			bool classic_or_sim = classic || Runtime.Arch == Arch.SIMULATOR;
			bool single_arch = !IsMainExecutableFat ();
