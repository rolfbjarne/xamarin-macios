...
namespace UIKit {
	...
	public unsafe partial class UIDocumentBrowserViewController : UIViewController, INSCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ImportDocument (NSUrl documentUrl, NSUrl neighbourUrl, UIDocumentBrowserImportMode importMode, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V61))]global::System.Action<NSUrl, NSError> completion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			...
			using var block_completion = Trampolines.SDActionArity2V61.CreateBlock (completion);
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RenameDocument (NSUrl documentUrl, string proposedName, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V61))]global::System.Action<NSUrl, NSError> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var documentUrl__handle__ = documentUrl!.GetNonNullHandle (nameof (documentUrl));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RevealDocument (NSUrl url, bool importIfNeeded, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V61))]global::System.Action<NSUrl, NSError>? completion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var url__handle__ = url!.GetNonNullHandle (nameof (url));
			using var block_completion = Trampolines.SDActionArity2V61.CreateNullableBlock (completion);
