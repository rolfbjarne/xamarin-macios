...
namespace GameController {
	...
	static public partial class GCInputButtonNameExtensions {
		...
		internal unsafe static IntPtr GCInputLeftPaddle {
			get {
				fixed (IntPtr *storage = &values [21])
					return Dlfcn.CachePointer (Libraries.GameController.Handle, "GCInputLeftPaddle", storage);
			}
		}
		[UnsupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos13.0")]
		...
		internal unsafe static IntPtr GCInputPedalAccelerator {
			get {
				fixed (IntPtr *storage = &values [22])
					return Dlfcn.CachePointer (Libraries.GameController.Handle, "GCInputPedalAccelerator", storage);
			}
		}
		[UnsupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos13.0")]
		...
		internal unsafe static IntPtr GCInputPedalBrake {
			get {
				fixed (IntPtr *storage = &values [23])
					return Dlfcn.CachePointer (Libraries.GameController.Handle, "GCInputPedalBrake", storage);
			}
		}
		[UnsupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos13.0")]
		...
		internal unsafe static IntPtr GCInputPedalClutch {
			get {
				fixed (IntPtr *storage = &values [24])
					return Dlfcn.CachePointer (Libraries.GameController.Handle, "GCInputPedalClutch", storage);
			}
		}
		[UnsupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos13.0")]
		...
		internal unsafe static IntPtr GCInputRightPaddle {
			get {
				fixed (IntPtr *storage = &values [25])
					return Dlfcn.CachePointer (Libraries.GameController.Handle, "GCInputRightPaddle", storage);
			}
		}
		[SupportedOSPlatform ("tvos26.4")]
		[SupportedOSPlatform ("macos26.4")]
		...
		public static NSString? GetConstant (this GCInputButtonName self)
		{
			...
			case 20: // GCInputButtonName.DualShockTouchpadButton
				...
				break;
			case 21: // GCInputButtonName.LeftPaddle
				ptr = GCInputLeftPaddle;
				break;
			case 22: // GCInputButtonName.PedalAccelerator
				ptr = GCInputPedalAccelerator;
				break;
			case 23: // GCInputButtonName.PedalBrake
				ptr = GCInputPedalBrake;
				break;
			case 24: // GCInputButtonName.PedalClutch
				ptr = GCInputPedalClutch;
				break;
			case 25: // GCInputButtonName.RightPaddle
				ptr = GCInputRightPaddle;
				break;
		...
		public static GCInputButtonName GetValue (NSString constant)
		{
			...
			if (constant.IsEqualTo (GCInputLeftPaddle))
				return GCInputButtonName.LeftPaddle;
			if (constant.IsEqualTo (GCInputPedalAccelerator))
				return GCInputButtonName.PedalAccelerator;
			if (constant.IsEqualTo (GCInputPedalBrake))
				return GCInputButtonName.PedalBrake;
			if (constant.IsEqualTo (GCInputPedalClutch))
				return GCInputButtonName.PedalClutch;
			if (constant.IsEqualTo (GCInputRightPaddle))
				return GCInputButtonName.RightPaddle;
