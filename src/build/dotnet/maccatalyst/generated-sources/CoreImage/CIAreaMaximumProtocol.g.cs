...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIAreaMaximum</c>.</summary>
	/// <remarks>
	...
	{
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIAreaMaximumProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICIAreaMaximumProtocol ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class CIAreaMaximumProtocolWrapper : BaseWrapper, ICIAreaMaximumProtocol {
		public CIAreaMaximumProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIAreaMaximumProtocolWrapper))]
		static CIAreaMaximumProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
