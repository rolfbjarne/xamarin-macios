	...
	public unsafe partial class INAnswerCallIntentResponse : INIntentResponse {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_IntPtr_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithCode:userActivity:"), (IntPtr) (long) code, userActivity__handle__), "initWithCode:userActivity:");
					GC.KeepAlive (this);
				}
			}
		...
		public virtual INAnswerCallIntentResponseCode Code {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (Intents.INAnswerCallIntentResponseCode) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("code"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
