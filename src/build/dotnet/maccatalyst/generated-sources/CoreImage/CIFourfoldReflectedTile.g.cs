...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITileFilter" /> that applies 4-way reflected symmetry.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/fourfold_reflected_tile.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIFourfoldReflectedTile : CITileFilter, ICIFourfoldReflectedTileProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIFourfoldReflectedTile" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIFourfoldReflectedTile (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIFourfoldReflectedTile (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIFourfoldReflectedTile (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIFourfoldReflectedTileProtocol protocol members 
