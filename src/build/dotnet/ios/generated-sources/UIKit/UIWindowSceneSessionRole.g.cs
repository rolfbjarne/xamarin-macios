...
namespace UIKit {
	...
	static public partial class UIWindowSceneSessionRoleExtensions {
		...
		internal unsafe static IntPtr CPTemplateApplicationSceneSessionRoleApplication {
			get {
				fixed (IntPtr *storage = &values [2])
					return Dlfcn.CachePointer (Libraries.CarPlay.Handle, "CPTemplateApplicationSceneSessionRoleApplication", storage);
			}
		}
		[SupportedOSPlatform ("tvos16.0")]
		[SupportedOSPlatform ("ios16.0")]
		...
		public static NSString? GetConstant (this UIWindowSceneSessionRole self)
		{
			...
			case 1: // UIWindowSceneSessionRole.ExternalDisplay
				...
				break;
			case 2: // UIWindowSceneSessionRole.CarTemplateApplication
				ptr = CPTemplateApplicationSceneSessionRoleApplication;
				break;
		...
		public static UIWindowSceneSessionRole GetValue (NSString constant)
		{
			...
			if (constant.IsEqualTo (CPTemplateApplicationSceneSessionRoleApplication))
				return UIWindowSceneSessionRole.CarTemplateApplication;
