...
namespace CoreImage {
	...
	public partial class CIBoxBlur : CIFilter, ICIBoxBlurProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIBoxBlur" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIBoxBlur () : base ("CIBoxBlur")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBoxBlur (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBoxBlur (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBoxBlur (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIBoxBlurProtocol protocol members 
