...
namespace AudioUnit {
	...
	public unsafe partial class AUAudioUnit : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void FromComponentDescription (AudioComponentDescription componentDescription, AudioComponentInstantiationOptions options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V25))]global::System.Action<AUAudioUnit, NSError> completionHandler)
		{
		...
		public virtual bool IsLoadedInProcess {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("isLoadedInProcess"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isLoadedInProcess"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
