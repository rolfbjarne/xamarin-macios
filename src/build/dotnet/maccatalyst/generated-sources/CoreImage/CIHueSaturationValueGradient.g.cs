...
namespace CoreImage {
	...
	public partial class CIHueSaturationValueGradient : CIFilter, ICIHueSaturationValueGradientProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIHueSaturationValueGradient" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIHueSaturationValueGradient () : base ("CIHueSaturationValueGradient")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIHueSaturationValueGradient (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIHueSaturationValueGradient (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIHueSaturationValueGradient (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIHueSaturationValueGradientProtocol protocol members 
