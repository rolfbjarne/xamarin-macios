...
namespace CoreML {
	...
	public unsafe partial class MLMultiArray : NSObject, INSCoding, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe MLMultiArray (nint dataPointer, NSNumber[] shape, MLMultiArrayDataType dataType, NSNumber[] strides, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V50))]global::System.Action<nint>? deallocator, out NSError error)
			: base (NSObjectFlag.Empty)
		{
			if (shape is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (shape));
			...
			using var nsa_shape = NSArray.FromNSObjects (shape);
			using var nsa_strides = NSArray.FromNSObjects (strides);
			using var block_deallocator = Trampolines.SDActionArity1V50.CreateNullableBlock (deallocator);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetBytes ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V66))]global::System.Action<nint, nint> handler)
		{
			if (handler is null)
		...
		public unsafe virtual void GetMutableBytes ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity3V4))]global::System.Action<nint, nint, NSArray<NSNumber>> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity3V4.CreateBlock (handler);
			BlockLiteral *block_ptr_handler = &block_handler;
			if (IsDirectBinding) {
