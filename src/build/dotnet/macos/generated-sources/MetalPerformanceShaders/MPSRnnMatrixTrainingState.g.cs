...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSRnnMatrixTrainingState : MPSState {
		...
		public new static MPSRnnMatrixTrainingState CreateTemporaryState (global::Metal.IMTLCommandBuffer commandBuffer, nuint bufferSize)
		{
			...
			ret =  Runtime.GetNSObject<MPSRnnMatrixTrainingState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_UIntPtr (class_ptr, selTemporaryStateWithCommandBuffer_BufferSize_XHandle, commandBuffer__handle__, bufferSize), false)!;
		...
		public new static MPSRnnMatrixTrainingState CreateTemporaryState (global::Metal.IMTLCommandBuffer commandBuffer, global::Metal.MTLTextureDescriptor descriptor)
		{
			...
			var descriptor__handle__ = descriptor!.GetNonNullHandle (nameof (descriptor));
			MPSRnnMatrixTrainingState? ret;
			ret =  Runtime.GetNSObject<MPSRnnMatrixTrainingState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, selTemporaryStateWithCommandBuffer_TextureDescriptor_XHandle, commandBuffer__handle__, descriptor__handle__), false)!;
			GC.KeepAlive (commandBuffer);
			GC.KeepAlive (descriptor);
			return ret!;
		}
		...
		public new static MPSRnnMatrixTrainingState CreateTemporaryState (global::Metal.IMTLCommandBuffer commandBuffer)
		{
			var commandBuffer__handle__ = commandBuffer!.GetNonNullHandle (nameof (commandBuffer));
			MPSRnnMatrixTrainingState? ret;
			ret =  Runtime.GetNSObject<MPSRnnMatrixTrainingState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selTemporaryStateWithCommandBuffer_XHandle, commandBuffer__handle__), false)!;
			GC.KeepAlive (commandBuffer);
			return ret!;
		}
		...
		public new static MPSRnnMatrixTrainingState CreateTemporaryState (global::Metal.IMTLCommandBuffer commandBuffer, MPSStateResourceList resourceList)
		{
			...
			var resourceList__handle__ = resourceList!.GetNonNullHandle (nameof (resourceList));
			MPSRnnMatrixTrainingState? ret;
			ret =  Runtime.GetNSObject<MPSRnnMatrixTrainingState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, selTemporaryStateWithCommandBuffer_ResourceList_XHandle, commandBuffer__handle__, resourceList__handle__), false)!;
			GC.KeepAlive (commandBuffer);
			GC.KeepAlive (resourceList);
			return ret!;
		}
