...
namespace CoreImage {
	...
	public abstract partial class CIScreenFilter : CIFilter {
		...
		protected CIScreenFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIScreenFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIScreenFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIScreenFilter" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected  CIScreenFilter (string name) : base (CreateFilter (name))
		{
		}
		/// <summary>Gets or sets the sharpness of the halftone pattern. 1 is sharp. 0 is maximally blurry.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>Gets or sets the size of the halftone pattern elements.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public float Width {
			get {
