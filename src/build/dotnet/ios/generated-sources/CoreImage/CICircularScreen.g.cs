...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIScreenFilter" /> that creates a circular bulls-eye-style halftone screen.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/cilcular_screen.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CICircularScreen : CIScreenFilter, ICICircularScreenProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CICircularScreen" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CICircularScreen (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CICircularScreen (NSObjectFlag t) : base (t)
		{
		}
		...
		public CICircularScreen (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CICircularScreenProtocol protocol members 
