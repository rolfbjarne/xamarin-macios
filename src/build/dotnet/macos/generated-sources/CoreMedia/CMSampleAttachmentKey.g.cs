...
namespace CoreMedia {
	...
	internal unsafe static partial class CMSampleAttachmentKey  {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _PostDecodeProcessingMetadataKey;
		/// <summary>Represents the value associated with the constant 'kCMSampleAttachmentKey_PostDecodeProcessingMetadata'.</summary>
		[Field ("kCMSampleAttachmentKey_PostDecodeProcessingMetadata",  "CoreMedia")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos15.0")]
		public static NSString PostDecodeProcessingMetadataKey {
			[UnsupportedOSPlatform ("tvos")]
			[UnsupportedOSPlatform ("ios")]
			[UnsupportedOSPlatform ("maccatalyst")]
			[SupportedOSPlatform ("macos15.0")]
			get {
				if (_PostDecodeProcessingMetadataKey is null)
					_PostDecodeProcessingMetadataKey = Dlfcn.GetStringConstant (Libraries.CoreMedia.Handle, "kCMSampleAttachmentKey_PostDecodeProcessingMetadata")!;
				return _PostDecodeProcessingMetadataKey;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
