...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSMatrixSum : MPSKernel {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_UIntPtr_UIntPtr_UIntPtr_bool (this.Handle, Selector.GetHandle ("initWithDevice:count:rows:columns:transpose:"), device__handle__, count, rows, columns, transpose ? (byte) 1 : (byte) 0), "initWithDevice:count:rows:columns:transpose:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_UIntPtr_UIntPtr_UIntPtr_bool (&__objc_super__, Selector.GetHandle ("initWithDevice:count:rows:columns:transpose:"), device__handle__, count, rows, columns, transpose ? (byte) 1 : (byte) 0), "initWithDevice:count:rows:columns:transpose:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual bool Transpose {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("transpose"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("transpose"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
