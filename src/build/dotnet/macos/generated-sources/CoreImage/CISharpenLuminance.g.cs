...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIFilter" /> that sharpens the image.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/sharpen_luminance.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CISharpenLuminance : CIFilter, ICISharpenLuminanceProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CISharpenLuminance" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISharpenLuminance (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISharpenLuminance (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISharpenLuminance (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CISharpenLuminanceProtocol protocol members 
