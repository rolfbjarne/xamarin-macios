...
namespace LocalAuthentication {
	...
	public unsafe partial class LASecret : NSObject {
		...
		public unsafe virtual void LoadData ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDLASecretCompletionHandler))]LASecretCompletionHandler handler)
		{
			...
			using var block_handler = Trampolines.SDLASecretCompletionHandler.CreateBlock (handler);
			...
			if (IsDirectBinding) {
				...
				unsafe {
					...
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("loadDataWithCompletion:"), (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		}
