...
namespace PencilKit {
	...
	public unsafe partial class PKInk : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public PKInk (NSString type, global::AppKit.NSColor color)
			: base (NSObjectFlag.Empty)
		{
			var type__handle__ = type!.GetNonNullHandle (nameof (type));
			var color__handle__ = color!.GetNonNullHandle (nameof (color));
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selInitWithInkType_Color_XHandle, type__handle__, color__handle__), "initWithInkType:color:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selInitWithInkType_Color_XHandle, type__handle__, color__handle__), "initWithInkType:color:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (type);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public PKInk (PKInkType type, global::AppKit.NSColor color)
		...
		public virtual NSString WeakInkType {
			...
			get {
				NSString? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selInkTypeXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selInkTypeXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
