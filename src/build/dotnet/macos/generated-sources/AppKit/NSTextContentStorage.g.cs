...
namespace AppKit {
	...
	public unsafe partial class NSTextContentStorage : NSTextContentManager, INSTextStorageObserving {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAttributedStringForTextElement_X = "attributedStringForTextElement:";
		static readonly NativeHandle selAttributedStringForTextElement_XHandle = Selector.GetHandle ("attributedStringForTextElement:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPerformEditingTransactionForTextStorage_UsingBlock_X = "performEditingTransactionForTextStorage:usingBlock:";
		static readonly NativeHandle selPerformEditingTransactionForTextStorage_UsingBlock_XHandle = Selector.GetHandle ("performEditingTransactionForTextStorage:usingBlock:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTextElementForAttributedString_X = "textElementForAttributedString:";
		static readonly NativeHandle selTextElementForAttributedString_XHandle = Selector.GetHandle ("textElementForAttributedString:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual NSAttributedString? GetAttributedString (NSTextElement textElement)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSAttributedString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selAttributedStringForTextElement_XHandle, textElement__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSAttributedString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selAttributedStringForTextElement_XHandle, textElement__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual NSTextElement? GetTextElement (NSAttributedString attributedString)
		{
			...
			NSTextElement? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSTextElement> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selTextElementForAttributedString_XHandle, attributedString__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSTextElement> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selTextElementForAttributedString_XHandle, attributedString__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual void PerformEditingTransaction (NSTextStorage textStorage, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAction))]global::System.Action transaction)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selPerformEditingTransactionForTextStorage_UsingBlock_XHandle, textStorage__handle__, (IntPtr) block_ptr_transaction);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selPerformEditingTransactionForTextStorage_UsingBlock_XHandle, textStorage__handle__, (IntPtr) block_ptr_transaction);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void ProcessEditing (NSTextStorage textStorage, NSTextStorageEditActions editMask, NSRange newCharRange, nint delta, NSRange invalidatedCharRange)
		{
			...
			var textStorage__handle__ = textStorage!.GetNonNullHandle (nameof (textStorage));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_UIntPtr_NSRange_IntPtr_NSRange (this.Handle, selProcessEditingForTextStorage_Edited_Range_ChangeInLength_InvalidatedRange_XHandle, textStorage__handle__, (UIntPtr) (ulong) editMask, newCharRange, delta, invalidatedCharRange);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_UIntPtr_NSRange_IntPtr_NSRange (&__objc_super__, selProcessEditingForTextStorage_Edited_Range_ChangeInLength_InvalidatedRange_XHandle, textStorage__handle__, (UIntPtr) (ulong) editMask, newCharRange, delta, invalidatedCharRange);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (textStorage);
