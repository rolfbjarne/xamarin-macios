...
namespace GameKit {
	...
	public unsafe partial class GKVoiceChat : NSObject {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void SetPlayerVoiceChatStateChangeHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V72))]global::System.Action<GKPlayer, GKVoiceChatPlayerState> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity2V72.CreateBlock (handler);
