...
namespace MapKit {
	...
	public unsafe partial class MKMapSnapshot : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selPointForCoordinate_X = "pointForCoordinate:";
		static readonly NativeHandle selPointForCoordinate_XHandle = Selector.GetHandle ("pointForCoordinate:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual CGPoint PointForCoordinate (global::CoreLocation.CLLocationCoordinate2D coordinate)
		{
			CGPoint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.CGPoint_objc_msgSend_CLLocationCoordinate2D (this.Handle, selPointForCoordinate_XHandle, coordinate);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.CGPoint_objc_msgSendSuper_CLLocationCoordinate2D (&__objc_super__, selPointForCoordinate_XHandle, coordinate);
					GC.KeepAlive (this);
				}
			}
			return ret;
