...
namespace MapKit {
	...
	public unsafe partial class MKLookAroundSnapshotter : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGetSnapshotWithCompletionHandler_X = "getSnapshotWithCompletionHandler:";
		static readonly NativeHandle selGetSnapshotWithCompletionHandler_XHandle = Selector.GetHandle ("getSnapshotWithCompletionHandler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithScene_Options_X = "initWithScene:options:";
		static readonly NativeHandle selInitWithScene_Options_XHandle = Selector.GetHandle ("initWithScene:options:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selInitWithScene_Options_XHandle, scene__handle__, options__handle__), "initWithScene:options:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selInitWithScene_Options_XHandle, scene__handle__, options__handle__), "initWithScene:options:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (scene);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetSnapshot ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V110))]global::System.Action<MKLookAroundSnapshot, NSError> completionHandler)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selGetSnapshotWithCompletionHandler_XHandle, (IntPtr) block_ptr_completionHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selGetSnapshotWithCompletionHandler_XHandle, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		}
