...
namespace TVServices {
	[Register("TVAppProfileDescriptor", true)]
	[ObsoletedOSPlatform ("tvos16.0", "Use runs-as-current-user-with-user-independent-keychain entitlement instead.")]
	[SupportedOSPlatform ("tvos13.0")]
	public unsafe partial class TVAppProfileDescriptor : NSObject, INSCoding, INSCopying, INSSecureCoding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("TVAppProfileDescriptor");
		...
		public TVAppProfileDescriptor (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected TVAppProfileDescriptor (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal TVAppProfileDescriptor (NativeHandle handle) : base (handle)
		{
		}
