...
namespace PdfKit {
	...
	public unsafe partial class PdfActionUrl : PdfAction {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("PDFActionURL");
		...
		/// <summary>Creates a new <see cref="PdfActionUrl" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public PdfActionUrl () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected PdfActionUrl (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal PdfActionUrl (NativeHandle handle) : base (handle)
		{
		}

		/// <param name="url">To be added.</param><summary>Creates a new URL PDF action with the specified URL.</summary><remarks>To be added.</remarks>
		[Export ("initWithURL:")]
		...
		/// <summary>Gets or sets the URL for the PDF action.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
