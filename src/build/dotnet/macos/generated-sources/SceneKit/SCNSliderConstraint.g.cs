...
namespace SceneKit {
	...
	public unsafe partial class SCNSliderConstraint : SCNConstraint {
		...
		const string selCollisionCategoryBitMaskX = "collisionCategoryBitMask";
		static readonly NativeHandle selCollisionCategoryBitMaskXHandle = Selector.GetHandle ("collisionCategoryBitMask");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetCollisionCategoryBitMask_X = "setCollisionCategoryBitMask:";
		static readonly NativeHandle selSetCollisionCategoryBitMask_XHandle = Selector.GetHandle ("setCollisionCategoryBitMask:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSliderConstraintX = "sliderConstraint";
		static readonly NativeHandle selSliderConstraintXHandle = Selector.GetHandle ("sliderConstraint");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static SCNSliderConstraint Create ()
		{
			...
			ret =  Runtime.GetNSObject<SCNSliderConstraint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selSliderConstraintXHandle), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual nuint CollisionCategoryBitMask {
			...
			get {
				nuint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selCollisionCategoryBitMaskXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selCollisionCategoryBitMaskXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selSetCollisionCategoryBitMask_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selSetCollisionCategoryBitMask_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
