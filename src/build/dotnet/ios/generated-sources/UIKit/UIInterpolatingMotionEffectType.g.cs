...
#nullable enable
namespace UIKit {
	/// <summary>An enumeration whose values specify the axis being monitored by a <see cref="T:UIKit.UIInterpolatingMotionEffect" />.</summary><remarks>To be added.</remarks>
