namespace ObjCRuntime {
	...
	public enum ArgumentSemantic : int {
		...
		None = -1,
		/// <summary>Assigning is merely APointer copy. This is identical to <see cref="ObjCRuntime.ArgumentSemantic.UnsafeUnretained" /></summary>
		Assign = 0,
		...
		Strong = Retain,
		/// <summary>Merely performs APointer copy in unmanaged code. This is identical to <see cref="ObjCRuntime.ArgumentSemantic.Assign" />.</summary>
