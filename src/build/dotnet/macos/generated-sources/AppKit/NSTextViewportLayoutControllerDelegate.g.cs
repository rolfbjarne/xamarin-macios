...
namespace AppKit {
	...
	public partial interface INSTextViewportLayoutControllerDelegate : INativeObject, IDisposable
	{
		...
		[DynamicDependencyAttribute ("ConfigureRenderingSurface(AppKit.NSTextViewportLayoutController,AppKit.NSTextLayoutFragment)")]
		[DynamicDependencyAttribute ("DidLayout(AppKit.NSTextViewportLayoutController)")]
		[DynamicDependencyAttribute ("GetViewportBounds(AppKit.NSTextViewportLayoutController)")]
		[DynamicDependencyAttribute ("WillLayout(AppKit.NSTextViewportLayoutController)")]
...
namespace AppKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__AppKit_NSTextViewportLayoutControllerDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
	[UnsupportedOSPlatform ("tvos")]
