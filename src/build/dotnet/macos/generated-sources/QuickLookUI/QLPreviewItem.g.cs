...
namespace QuickLookUI {
	...
	/// <summary>This interface represents the Objective-C protocol <c>QLPreviewItem</c>.</summary>
	/// <remarks>
	...
	{
		[DynamicDependencyAttribute ("PreviewItemDisplayState")]
		...
		public virtual NSObject PreviewItemDisplayState {
			...
			get {
				return _GetPreviewItemDisplayState (this);
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static NSObject _GetPreviewItemDisplayState (IQLPreviewItem This)
		{
			NSObject ret;
			ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (This.Handle, Selector.GetHandle ("previewItemDisplayState")), false)!;
			GC.KeepAlive (This);
			return ret;
		}
	}
...
namespace QuickLookUI {
	/// <summary>
	///   <para>This is a class that implements the interface <see cref="IQLPreviewItem" /> (for the protocol <c>QLPreviewItem</c>).</para>
	///   <para>Subclass this class to easily create a type that implements the protocol.</para>
	///   <para>An alternative is to create a subclass of <see cref="NSObject" /> and then implemented the interface <see cref="IQLPreviewItem" />.</para>
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__QuickLookUI_QLPreviewItem", false)]
	[Model]
