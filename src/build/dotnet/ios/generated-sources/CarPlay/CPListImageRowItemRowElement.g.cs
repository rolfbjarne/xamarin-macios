...
#nullable enable
namespace CarPlay {
	[Register("CPListImageRowItemRowElement", true)]
	[UnsupportedOSPlatform ("tvos")]
	[UnsupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("ios26.0")]
	[UnsupportedOSPlatform ("maccatalyst")]
	public unsafe partial class CPListImageRowItemRowElement : CPListImageRowItemElement {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("CPListImageRowItemRowElement");
		...
		protected CPListImageRowItemRowElement (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CPListImageRowItemRowElement (NativeHandle handle) : base (handle)
		{
		}

		[Export ("initWithImage:title:subtitle:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CPListImageRowItemRowElement (global::UIKit.UIImage image, string? title, string? subtitle)
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithImage:title:subtitle:"), image__handle__, nstitle, nssubtitle), "initWithImage:title:subtitle:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithImage:title:subtitle:"), image__handle__, nstitle, nssubtitle), "initWithImage:title:subtitle:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (image);
