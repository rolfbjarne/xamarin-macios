...
namespace CoreML {
	...
	public unsafe partial class MLNeuralEngineComputeDevice : NSObject, IMLComputeDeviceProtocol {
		...
		const string selTotalCoreCountX = "totalCoreCount";
		static readonly NativeHandle selTotalCoreCountXHandle = Selector.GetHandle ("totalCoreCount");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual nint TotalCoreCount {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selTotalCoreCountXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selTotalCoreCountXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
