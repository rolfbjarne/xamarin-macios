...
namespace AVFoundation {
	...
	public unsafe partial class AVCaptureSlider : AVCaptureControl {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_float_float (this.Handle, Selector.GetHandle ("initWithLocalizedTitle:symbolName:minValue:maxValue:"), nslocalizedTitle, nssymbolName, minValue, maxValue), "initWithLocalizedTitle:symbolName:minValue:maxValue:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_float_float (&__objc_super__, Selector.GetHandle ("initWithLocalizedTitle:symbolName:minValue:maxValue:"), nslocalizedTitle, nssymbolName, minValue, maxValue), "initWithLocalizedTitle:symbolName:minValue:maxValue:");
					GC.KeepAlive (this);
				}
			}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithLocalizedTitle:symbolName:values:"), nslocalizedTitle, nssymbolName, nsb_values.GetHandle ()), "initWithLocalizedTitle:symbolName:values:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithLocalizedTitle:symbolName:values:"), nslocalizedTitle, nssymbolName, nsb_values.GetHandle ()), "initWithLocalizedTitle:symbolName:values:");
					GC.KeepAlive (this);
				}
			}
			CFString.ReleaseNative (nslocalizedTitle);
		...
		public virtual string? LocalizedValueFormat {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("localizedValueFormat")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("localizedValueFormat")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				var nsvalue = CFString.CreateNative (value);
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setLocalizedValueFormat:"), nsvalue);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setLocalizedValueFormat:"), nsvalue);
						GC.KeepAlive (this);
					}
				}
				CFString.ReleaseNative (nsvalue);
		...
		public virtual float[] ProminentValues {
			...
			get {
				float[] ret;
				if (IsDirectBinding) {
					ret = NSArray.ArrayFromHandleFunc <float> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("prominentValues")), NSNumber.ToFloat, false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = NSArray.ArrayFromHandleFunc <float> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("prominentValues")), NSNumber.ToFloat, false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("setProminentValues:"), nsb_ProminentValues.GetHandle ());
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setProminentValues:"), nsb_ProminentValues.GetHandle ());
						GC.KeepAlive (this);
					}
				}
