...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSMatrixFullyConnected : MPSMatrixBinaryKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_InputMatrix_WeightMatrix_BiasVector_ResultMatrix_X = "encodeToCommandBuffer:inputMatrix:weightMatrix:biasVector:resultMatrix:";
		static readonly NativeHandle selEncodeToCommandBuffer_InputMatrix_WeightMatrix_BiasVector_ResultMatrix_XHandle = Selector.GetHandle ("encodeToCommandBuffer:inputMatrix:weightMatrix:biasVector:resultMatrix:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual MPSMatrixFullyConnected Copy (NSZone? zone, global::Metal.IMTLDevice? device)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<MPSMatrixFullyConnected> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selCopyWithZone_Device_XHandle, zone__handle__, device__handle__), true)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<MPSMatrixFullyConnected> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selCopyWithZone_Device_XHandle, zone__handle__, device__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (zone);
		...
		public virtual void EncodeToCommandBuffer (global::Metal.IMTLCommandBuffer commandBuffer, MPSMatrix inputMatrix, MPSMatrix weightMatrix, MPSVector? biasVector, MPSMatrix resultMatrix)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeToCommandBuffer_InputMatrix_WeightMatrix_BiasVector_ResultMatrix_XHandle, commandBuffer__handle__, inputMatrix__handle__, weightMatrix__handle__, biasVector__handle__, resultMatrix__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeToCommandBuffer_InputMatrix_WeightMatrix_BiasVector_ResultMatrix_XHandle, commandBuffer__handle__, inputMatrix__handle__, weightMatrix__handle__, biasVector__handle__, resultMatrix__handle__);
					GC.KeepAlive (this);
				}
			}
