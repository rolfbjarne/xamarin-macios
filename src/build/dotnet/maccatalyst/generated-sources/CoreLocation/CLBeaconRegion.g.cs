...
namespace CoreLocation {
	...
	public unsafe partial class CLBeaconRegion : CLRegion {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithBeaconIdentityConstraint:identifier:"), beaconIdentityConstraint__handle__, nsidentifier), "initWithBeaconIdentityConstraint:identifier:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithBeaconIdentityConstraint:identifier:"), beaconIdentityConstraint__handle__, nsidentifier), "initWithBeaconIdentityConstraint:identifier:");
					GC.KeepAlive (this);
				}
			}
		...
		public virtual NSMutableDictionary GetPeripheralData (NSNumber? measuredPower)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSMutableDictionary> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("peripheralDataWithMeasuredPower:"), measuredPower__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSMutableDictionary> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("peripheralDataWithMeasuredPower:"), measuredPower__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		internal virtual NativeHandle _InitWithProximityUuid (NSUuid proximityUuid, string identifier)
		{
			...
			NativeHandle ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithProximityUUID:identifier:"), proximityUuid__handle__, nsidentifier);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithProximityUUID:identifier:"), proximityUuid__handle__, nsidentifier);
					GC.KeepAlive (this);
				}
			}
		...
		internal virtual NativeHandle _InitWithProximityUuid (NSUuid proximityUuid, ushort major, string identifier)
		{
			...
			NativeHandle ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_UInt16_NativeHandle (this.Handle, Selector.GetHandle ("initWithProximityUUID:major:identifier:"), proximityUuid__handle__, major, nsidentifier);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_UInt16_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithProximityUUID:major:identifier:"), proximityUuid__handle__, major, nsidentifier);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (proximityUuid);
		...
		internal virtual NativeHandle _InitWithProximityUuid (NSUuid proximityUuid, ushort major, ushort minor, string identifier)
		{
			...
			NativeHandle ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_UInt16_UInt16_NativeHandle (this.Handle, Selector.GetHandle ("initWithProximityUUID:major:minor:identifier:"), proximityUuid__handle__, major, minor, nsidentifier);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_UInt16_UInt16_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithProximityUUID:major:minor:identifier:"), proximityUuid__handle__, major, minor, nsidentifier);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (proximityUuid);
		...
		internal virtual nint _InitWithUuid (NSUuid uuid, string identifier)
		{
			...
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithUUID:identifier:"), uuid__handle__, nsidentifier);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithUUID:identifier:"), uuid__handle__, nsidentifier);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (uuid);
		...
		internal virtual nint _InitWithUuid (NSUuid uuid, ushort major, string identifier)
		{
			...
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_UInt16_NativeHandle (this.Handle, Selector.GetHandle ("initWithUUID:major:identifier:"), uuid__handle__, major, nsidentifier);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_UInt16_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithUUID:major:identifier:"), uuid__handle__, major, nsidentifier);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (uuid);
		...
		internal virtual nint _InitWithUuid (NSUuid uuid, ushort major, ushort minor, string identifier)
		{
			...
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_UInt16_UInt16_NativeHandle (this.Handle, Selector.GetHandle ("initWithUUID:major:minor:identifier:"), uuid__handle__, major, minor, nsidentifier);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_UInt16_UInt16_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithUUID:major:minor:identifier:"), uuid__handle__, major, minor, nsidentifier);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (uuid);
		...
		public virtual CLBeaconIdentityConstraint BeaconIdentityConstraint {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<CLBeaconIdentityConstraint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("beaconIdentityConstraint")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<CLBeaconIdentityConstraint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("beaconIdentityConstraint")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual bool NotifyEntryStateOnDisplay {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("notifyEntryStateOnDisplay"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("notifyEntryStateOnDisplay"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_bool (this.Handle, Selector.GetHandle ("setNotifyEntryStateOnDisplay:"), value ? (byte) 1 : (byte) 0);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, Selector.GetHandle ("setNotifyEntryStateOnDisplay:"), value ? (byte) 1 : (byte) 0);
						GC.KeepAlive (this);
					}
				}
			}
		}
		/// <summary>The UUID associated with the iBeacon.</summary><value>To be added.</value><remarks><para>The UUID of an iBeacon instance will often be the same UUID used in other instances (for instance, a chain of stores might use a UUID associated with the chain, not with the specific store in which the user finds themselves ).</para></remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
