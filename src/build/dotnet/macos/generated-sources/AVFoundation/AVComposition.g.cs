...
namespace AVFoundation {
	...
	public unsafe partial class AVComposition : AVAsset, INSCopying, INSMutableCopying {
		...
		const string selURLAssetInitializationOptionsX = "URLAssetInitializationOptions";
		static readonly NativeHandle selURLAssetInitializationOptionsXHandle = Selector.GetHandle ("URLAssetInitializationOptions");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public new virtual AVCompositionTrack[] Tracks {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<AVCompositionTrack>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selTracksXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<AVCompositionTrack>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selTracksXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual NSDictionary<NSString, NSObject> UrlAssetInitializationOptions {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDictionary<NSString, NSObject>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selURLAssetInitializationOptionsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDictionary<NSString, NSObject>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selURLAssetInitializationOptionsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
