	...
	public class SKTransformNodeTest {
		...
		public void EulerAngles ()
		{
			...
			using (var obj = new SKTransformNode ()) {
				...
				ClassicAssert.AreEqual (-2.14159298f, obj.EulerAngles.X, 0.000001f, "#x1");
				ClassicAssert.AreEqual (1.14159274f, obj.EulerAngles.Y, 0.000001f, "#y1");
				ClassicAssert.AreEqual (-0.141592711f, obj.EulerAngles.Z, 0.000001f, "#z1");
			}
		}
		...
		public void RotationMatrix ()
		{
			using (var obj = new SKTransformNode ()) {
				...
				ClassicAssert.AreEqual ((nfloat) (Math.PI / 2), obj.XRotation, 0.000001f, "XRotation b");
				ClassicAssert.AreEqual (0, obj.YRotation, 0.000001f, "YRotation b"); // Setting YRotation changes RotationMatrix, but setting RotationMatrix doesn't change YRotation.
			}
		}
