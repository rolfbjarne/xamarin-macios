...
#nullable enable
namespace CarPlay {
	/// <summary><see cref="T:CarPlay.CPTemplate" /> subclass for displaying the voice control indicator.</summary>
	[Register("CPVoiceControlTemplate", true)]
	[UnsupportedOSPlatform ("tvos")]
	[UnsupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("ios")]
	public unsafe partial class CPVoiceControlTemplate : CPTemplate, ICPBarButtonProviding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("CPVoiceControlTemplate");
		...
		public CPVoiceControlTemplate (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected CPVoiceControlTemplate (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CPVoiceControlTemplate (NativeHandle handle) : base (handle)
		{
		}
		...
		{
			if (voiceControlStates is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (voiceControlStates));
			using var nsa_voiceControlStates = NSArray.FromNSObjects (voiceControlStates);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("initWithVoiceControlStates:"), nsa_voiceControlStates.Handle), "initWithVoiceControlStates:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithVoiceControlStates:"), nsa_voiceControlStates.Handle), "initWithVoiceControlStates:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void ActivateVoiceControlState (string identifier)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("activateVoiceControlStateWithIdentifier:"), nsidentifier);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("activateVoiceControlStateWithIdentifier:"), nsidentifier);
					GC.KeepAlive (this);
				}
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual string? ActiveStateIdentifier {
			[Export ("activeStateIdentifier")]
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("activeStateIdentifier")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("activeStateIdentifier")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual CPVoiceControlState[] VoiceControlStates {
			[Export ("voiceControlStates", ArgumentSemantic.Copy)]
			get {
				CPVoiceControlState[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<CPVoiceControlState>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("voiceControlStates")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<CPVoiceControlState>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("voiceControlStates")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
