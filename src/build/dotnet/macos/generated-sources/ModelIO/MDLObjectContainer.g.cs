	...
	public unsafe partial class MDLObjectContainer : NSObject, IMDLComponent, IMDLObjectContainerComponent {
		...
		public virtual MDLObject[] Objects {
			...
			get {
				MDLObject[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<MDLObject>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selObjectsXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<MDLObject>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selObjectsXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
