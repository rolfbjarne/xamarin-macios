...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSCnnSpatialNormalizationNode : MPSCnnNormalizationNode {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithSource_KernelSize_X = "initWithSource:kernelSize:";
		static readonly NativeHandle selInitWithSource_KernelSize_XHandle = Selector.GetHandle ("initWithSource:kernelSize:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNodeWithSource_KernelSize_X = "nodeWithSource:kernelSize:";
		static readonly NativeHandle selNodeWithSource_KernelSize_XHandle = Selector.GetHandle ("nodeWithSource:kernelSize:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSCNNSpatialNormalizationNode");
		...
		protected MPSCnnSpatialNormalizationNode (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSCnnSpatialNormalizationNode (NativeHandle handle) : base (handle)
		{
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_UIntPtr (this.Handle, selInitWithSource_KernelSize_XHandle, sourceNode__handle__, kernelSize), "initWithSource:kernelSize:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_UIntPtr (&__objc_super__, selInitWithSource_KernelSize_XHandle, sourceNode__handle__, kernelSize), "initWithSource:kernelSize:");
					GC.KeepAlive (this);
				}
			}
		...
		{
			var sourceNode__handle__ = sourceNode!.GetNonNullHandle (nameof (sourceNode));
			MPSCnnSpatialNormalizationNode? ret;
			ret =  Runtime.GetNSObject<MPSCnnSpatialNormalizationNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_UIntPtr (class_ptr, selNodeWithSource_KernelSize_XHandle, sourceNode__handle__, kernelSize), false)!;
			GC.KeepAlive (sourceNode);
			return ret!;
		}
