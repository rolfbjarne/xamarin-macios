...
namespace AuthenticationServices {
	...
	public unsafe partial class ASCredentialIdentityStore : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetCredentialIdentityStoreState ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V19))]global::System.Action<ASCredentialIdentityStoreState> completion)
		{
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
			using var block_completion = Trampolines.SDActionArity1V19.CreateBlock (completion);
			BlockLiteral *block_ptr_completion = &block_completion;
			if (IsDirectBinding) {
