...
namespace MetalPerformanceShaders {
	/// <summary>A fully connected layer.</summary><related type="externalDocumentation" href="https://developer.apple.com/reference/MetalPerformanceShaders/MPSCNNFullyConnected">Apple documentation for <c>MPSCNNFullyConnected</c></related>
	[Register("MPSCNNFullyConnected", true)]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public unsafe partial class MPSCnnFullyConnected : MPSCnnConvolution {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSCNNFullyConnected");
		...
		public MPSCnnFullyConnected (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected MPSCnnFullyConnected (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSCnnFullyConnected (NativeHandle handle) : base (handle)
		{
		}
		...
		[DesignatedInitializer]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSCnnFullyConnected (NSCoder aDecoder, global::Metal.IMTLDevice device)
		...
		[DesignatedInitializer]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSCnnFullyConnected (global::Metal.IMTLDevice device, IMPSCnnConvolutionDataSource weights)
			: base (NSObjectFlag.Empty)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal virtual nint InitWithDevice (global::Metal.IMTLDevice device, MPSCnnConvolutionDescriptor fullyConnectedDescriptor, nint kernelWeights, nint biasTerms, MPSCnnConvolutionFlags flags)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
			var fullyConnectedDescriptor__handle__ = fullyConnectedDescriptor!.GetNonNullHandle (nameof (fullyConnectedDescriptor));
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_NativeHandle_IntPtr_IntPtr_UIntPtr (this.Handle, selInitWithDevice_ConvolutionDescriptor_KernelWeights_BiasTerms_Flags_XHandle, device__handle__, fullyConnectedDescriptor__handle__, kernelWeights, biasTerms, (UIntPtr) (ulong) flags);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_NativeHandle_IntPtr_IntPtr_UIntPtr (&__objc_super__, selInitWithDevice_ConvolutionDescriptor_KernelWeights_BiasTerms_Flags_XHandle, device__handle__, fullyConnectedDescriptor__handle__, kernelWeights, biasTerms, (UIntPtr) (ulong) flags);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
			GC.KeepAlive (fullyConnectedDescriptor);
			return ret!;
		}
