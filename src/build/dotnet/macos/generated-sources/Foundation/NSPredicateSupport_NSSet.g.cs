...
namespace Foundation {
	...
	public unsafe static partial class NSPredicateSupport_NSSet  {
		...
		const string selFilteredSetUsingPredicate_X = "filteredSetUsingPredicate:";
		static readonly NativeHandle selFilteredSetUsingPredicate_XHandle = Selector.GetHandle ("filteredSetUsingPredicate:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static NSSet FilterUsingPredicate (this NSSet This, NSPredicate predicate)
		{
			...
			NSSet? ret;
			ret =  Runtime.GetNSObject<NSSet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (This.Handle, selFilteredSetUsingPredicate_XHandle, predicate__handle__), false)!;
			GC.KeepAlive (This);
