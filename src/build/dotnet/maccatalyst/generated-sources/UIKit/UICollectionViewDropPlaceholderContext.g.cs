...
namespace UIKit {
		...
		UIKit.IUIDragAnimating
	{
		...
		public unsafe virtual bool CommitInsertion ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V242))]global::System.Action<NSIndexPath> dataSourceUpdates)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="dataSourceUpdates">Handler to run as the placeholder is replaced. Takes the index path where the content should drop.</param><summary>Replaces the placeholder cell with dropped content.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static bool _CommitInsertion (IUICollectionViewDropPlaceholderContext This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V242))]global::System.Action<NSIndexPath> dataSourceUpdates)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (dataSourceUpdates is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (dataSourceUpdates));
			using var block_dataSourceUpdates = Trampolines.SDActionArity1V242.CreateBlock (dataSourceUpdates);
