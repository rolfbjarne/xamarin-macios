...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITransitionFilter" /> that reveals the background image via a series of irregularly shaped holes.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 
	/// // Create a CIModTransition filter with the input image
	/// var mod_transition = new CIModTransition ()
	/// {
	/// 	Image = heron,
	/// 	TargetImage = clouds,
	/// 	Time = 0.5f
	...
	/// var output = mod_transition.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/mod_transition.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIModTransition : CITransitionFilter, ICIModTransitionProtocol, ICITransitionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIModTransition" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIModTransition (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIModTransition (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIModTransition (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIModTransitionProtocol protocol members 
		...
		// CITransitionFilterProtocol protocol members 
