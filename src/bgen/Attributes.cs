...
#if !XAMCORE_5_0
	// We don't generate extension methods required members by default,
	// but we might have to in order to keep backwards compatibility
	// for members that switched from optional to required (because we used to generate
	// the extension method because the member was optional).
