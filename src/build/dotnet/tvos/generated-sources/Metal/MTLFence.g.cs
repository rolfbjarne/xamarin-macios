...
namespace Metal {
	...
	/// <summary>This interface represents the Objective-C protocol <c>MTLFence</c>.</summary>
	/// <remarks>
	...
	public partial interface IMTLFence : INativeObject, IDisposable
	{
		[DynamicDependencyAttribute ("Device")]
		[DynamicDependencyAttribute ("Label")]
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (MTLFenceWrapper))]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static IMTLDevice _GetDevice (IMTLFence This)
		{
			IMTLDevice ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static string _GetLabel (IMTLFence This)
		{
			string ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetLabel (IMTLFence This, string? value)
		{
	...
	internal unsafe sealed class MTLFenceWrapper : BaseWrapper, IMTLFence {
		public MTLFenceWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (MTLFenceWrapper))]
		static MTLFenceWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>To be added.</summary><value>To be added.</value><remarks>To be added.</remarks>
