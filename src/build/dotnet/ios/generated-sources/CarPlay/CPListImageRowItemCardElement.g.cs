...
#nullable enable
namespace CarPlay {
	[Register("CPListImageRowItemCardElement", true)]
	[UnsupportedOSPlatform ("tvos")]
	[UnsupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("ios26.0")]
	[UnsupportedOSPlatform ("maccatalyst")]
	public unsafe partial class CPListImageRowItemCardElement : CPListImageRowItemElement, INSCoding, INSSecureCoding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("CPListImageRowItemCardElement");
		...
		public CPListImageRowItemCardElement (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected CPListImageRowItemCardElement (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CPListImageRowItemCardElement (NativeHandle handle) : base (handle)
		{
		}

		[Export ("initWithImage:showsImageFullHeight:title:subtitle:tintColor:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CPListImageRowItemCardElement (global::UIKit.UIImage image, bool showsImageFullHeight, string? title, string? subtitle, global::UIKit.UIColor? tintColor)
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_bool_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithImage:showsImageFullHeight:title:subtitle:tintColor:"), image__handle__, showsImageFullHeight ? (byte) 1 : (byte) 0, nstitle, nssubtitle, tintColor__handle__), "initWithImage:showsImageFullHeight:title:subtitle:tintColor:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_bool_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithImage:showsImageFullHeight:title:subtitle:tintColor:"), image__handle__, showsImageFullHeight ? (byte) 1 : (byte) 0, nstitle, nssubtitle, tintColor__handle__), "initWithImage:showsImageFullHeight:title:subtitle:tintColor:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (image);
		...
		[UnsupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CPListImageRowItemCardElement (CPThumbnailImage thumbnail, string? title, string? subtitle, global::UIKit.UIColor? tintColor)
			: base (NSObjectFlag.Empty)
		{
			...
			var nssubtitle = CFString.CreateNative (subtitle);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithThumbnail:title:subtitle:tintColor:"), thumbnail__handle__, nstitle, nssubtitle, tintColor__handle__), "initWithThumbnail:title:subtitle:tintColor:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithThumbnail:title:subtitle:tintColor:"), thumbnail__handle__, nstitle, nssubtitle, tintColor__handle__), "initWithThumbnail:title:subtitle:tintColor:");
					GC.KeepAlive (this);
				}
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static CGSize MaximumFullHeightImageSize {
			[Export ("maximumFullHeightImageSize")]
			get {
				CGSize ret;
				ret = global::ObjCRuntime.Messaging.CGSize_objc_msgSend (class_ptr, Selector.GetHandle ("maximumFullHeightImageSize"));
				return ret;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual bool ShowsImageFullHeight {
			[Export ("showsImageFullHeight")]
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("showsImageFullHeight"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("showsImageFullHeight"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual global::UIKit.UIColor? TintColor {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<global::UIKit.UIColor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("tintColor")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<global::UIKit.UIColor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("tintColor")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
