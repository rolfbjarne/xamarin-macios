...
namespace GameKit {
	...
	public unsafe partial class GKAchievementDescription : NSObject, INSCoding, INSSecureCoding {
		...
		const string selAchievedDescriptionX = "achievedDescription";
		static readonly NativeHandle selAchievedDescriptionXHandle = Selector.GetHandle ("achievedDescription");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selIncompleteAchievementImageX = "incompleteAchievementImage";
		static readonly NativeHandle selIncompleteAchievementImageXHandle = Selector.GetHandle ("incompleteAchievementImage");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selIsReplayableX = "isReplayable";
		static readonly NativeHandle selIsReplayableXHandle = Selector.GetHandle ("isReplayable");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selMaximumPointsX = "maximumPoints";
		static readonly NativeHandle selMaximumPointsXHandle = Selector.GetHandle ("maximumPoints");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selUnachievedDescriptionX = "unachievedDescription";
		static readonly NativeHandle selUnachievedDescriptionXHandle = Selector.GetHandle ("unachievedDescription");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public unsafe static void LoadAchievementDescriptions ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGKAchievementDescriptionHandler))]GKAchievementDescriptionHandler? handler)
		{
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (class_ptr, selLoadAchievementDescriptionsWithCompletionHandler_XHandle, (IntPtr) block_ptr_handler);
		}
		...
		public unsafe virtual void LoadImage ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDGKImageLoadedHandler))]GKImageLoadedHandler? imageLoadedHandler)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selLoadImageWithCompletionHandler_XHandle, (IntPtr) block_ptr_imageLoadedHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selLoadImageWithCompletionHandler_XHandle, (IntPtr) block_ptr_imageLoadedHandler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual string? AchievedDescription {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selAchievedDescriptionXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selAchievedDescriptionXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos")]
		public static global::AppKit.NSImage IncompleteAchievementImage {
			[Export ("incompleteAchievementImage")]
			get {
				global::AppKit.NSImage? ret;
				ret =  Runtime.GetNSObject<global::AppKit.NSImage> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selIncompleteAchievementImageXHandle), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual nint MaximumPoints {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selMaximumPointsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selMaximumPointsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos")]
		public static global::AppKit.NSImage PlaceholderCompletedAchievementImage {
			[Export ("placeholderCompletedAchievementImage")]
			get {
				global::AppKit.NSImage? ret;
				ret =  Runtime.GetNSObject<global::AppKit.NSImage> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selPlaceholderCompletedAchievementImageXHandle), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual NSNumber? RarityPercent {
			...
			get {
				NSNumber? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSNumber> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selRarityPercentXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSNumber> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selRarityPercentXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual bool Replayable {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selIsReplayableXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selIsReplayableXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual string? UnachievedDescription {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selUnachievedDescriptionXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selUnachievedDescriptionXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
