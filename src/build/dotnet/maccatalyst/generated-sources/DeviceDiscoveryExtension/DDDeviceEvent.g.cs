	...
	public unsafe partial class DDDeviceEvent : NSObject {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					...
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithEventType:device:"), (IntPtr) (long) type, device__handle__), "initWithEventType:device:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual DDDevice Device {
			...
			get {
				DDDevice? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<DDDevice> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("device")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<DDDevice> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("device")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual DDEventType EventType {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (DeviceDiscoveryExtension.DDEventType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("eventType"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
