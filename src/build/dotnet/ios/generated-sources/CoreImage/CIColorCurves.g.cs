...
namespace CoreImage {
	...
	public partial class CIColorCurves : CIFilter, ICIColorCurvesProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorCurves" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIColorCurves () : base ("CIColorCurves")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorCurves (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorCurves (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorCurves (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIColorCurvesProtocol protocol members 
		...
		public NSData CurvesData {
			...
			get {
				return Runtime.GetNSObject <NSData> (GetHandle ("inputCurvesData"), false)!;
			}
