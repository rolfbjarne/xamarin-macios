...
namespace CoreImage {
	...
	public partial class CIConvolutionRGB7X7 : CIFilter, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIConvolutionRGB7X7" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIConvolutionRGB7X7 (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIConvolutionRGB7X7 (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIConvolutionRGB7X7 (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
