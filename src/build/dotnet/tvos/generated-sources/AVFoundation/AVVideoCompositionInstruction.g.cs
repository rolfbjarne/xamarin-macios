	...
	public unsafe partial class AVVideoCompositionInstruction : NSObject, INSCoding, INSCopying, INSMutableCopying, INSSecureCoding {
		...
		public virtual bool ContainsTweening {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("containsTweening"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("containsTweening"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual int PassthroughTrackID {
			...
			get {
				int ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.int_objc_msgSend (this.Handle, Selector.GetHandle ("passthroughTrackID"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.int_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("passthroughTrackID"));
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual NSNumber[]? RequiredSourceTrackIDs {
			...
			get {
				NSNumber[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<NSNumber>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("requiredSourceTrackIDs")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<NSNumber>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("requiredSourceTrackIDs")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
