...
namespace Foundation {
	...
	public unsafe partial class NSArray : NSObject, INSCoding, INSCopying, INSMutableCopying, INSSecureCoding, global::CloudKit.ICKRecordValue {
		...
		public virtual void AddObserver (NSObject observer, NSIndexSet indexes, string keyPath, NSKeyValueObservingOptions options, nint context)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_UIntPtr_IntPtr (this.Handle, Selector.GetHandle ("addObserver:toObjectsAtIndexes:forKeyPath:options:context:"), observer__handle__, indexes__handle__, nskeyPath, (UIntPtr) (ulong) options, context);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_UIntPtr_IntPtr (&__objc_super__, Selector.GetHandle ("addObserver:toObjectsAtIndexes:forKeyPath:options:context:"), observer__handle__, indexes__handle__, nskeyPath, (UIntPtr) (ulong) options, context);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual bool Contains (NSObject anObject)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("containsObject:"), anObject__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("containsObject:"), anObject__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual NSArray Filter (NSPredicate predicate)
		{
			...
			NSArray? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSArray> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("filteredArrayUsingPredicate:"), predicate__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSArray> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("filteredArrayUsingPredicate:"), predicate__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public static NSArray FromFile (string path)
		{
			...
			NSArray? ret;
			ret =  Runtime.GetNSObject<NSArray> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("arrayWithContentsOfFile:"), nspath), false)!;
		...
		{
			nint ret;
			ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("arrayWithObjects:count:"), array, count);
			return ret;
		}
		...
		public unsafe static NSArray? FromUrl (NSUrl url, out NSError error)
		{
			...
			NSArray? ret;
			ret =  Runtime.GetNSObject<NSArray> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (class_ptr, Selector.GetHandle ("arrayWithContentsOfURL:error:"), url__handle__, &errorValue), false)!;
			GC.KeepAlive (url);
		...
		public virtual nuint IndexOf (NSObject anObject)
		{
			...
			nuint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("indexOfObject:"), anObject__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("indexOfObject:"), anObject__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (anObject);
		...
		public virtual void RemoveObserver (NSObject observer, NSIndexSet indexes, string keyPath, nint context)
		{
			...
			var nskeyPath = CFString.CreateNative (keyPath);
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_IntPtr (this.Handle, Selector.GetHandle ("removeObserver:fromObjectsAtIndexes:forKeyPath:context:"), observer__handle__, indexes__handle__, nskeyPath, context);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_IntPtr (&__objc_super__, Selector.GetHandle ("removeObserver:fromObjectsAtIndexes:forKeyPath:context:"), observer__handle__, indexes__handle__, nskeyPath, context);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (observer);
		...
		public virtual void RemoveObserver (NSObject observer, NSIndexSet indexes, string keyPath)
		{
			...
			var nskeyPath = CFString.CreateNative (keyPath);
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("removeObserver:fromObjectsAtIndexes:forKeyPath:"), observer__handle__, indexes__handle__, nskeyPath);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("removeObserver:fromObjectsAtIndexes:forKeyPath:"), observer__handle__, indexes__handle__, nskeyPath);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (observer);
		...
		public unsafe virtual NSArray Sort ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDNSComparator))]NSComparator cmptr)
		{
			...
			NSArray ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSArray> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("sortedArrayUsingComparator:"), (IntPtr) block_ptr_cmptr), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSArray> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("sortedArrayUsingComparator:"), (IntPtr) block_ptr_cmptr), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual NativeHandle ValueAt (nuint idx)
		{
			NativeHandle ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr (this.Handle, Selector.GetHandle ("objectAtIndex:"), idx);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_UIntPtr (&__objc_super__, Selector.GetHandle ("objectAtIndex:"), idx);
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		{
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("containsObject:"), anObject);
			return ret != 0;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			nuint ret;
			ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("indexOfObject:"), anObject);
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
