...
namespace CoreImage {
	...
	public partial class CICoreMLModelFilter : CIFilter {
		/// <summary>Creates a new <see cref="CICoreMLModelFilter" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CICoreMLModelFilter () : base ("CICoreMLModelFilter")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CICoreMLModelFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CICoreMLModelFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CICoreMLModelFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		public MLModel Model {
			get {
				return Runtime.GetNSObject <MLModel> (GetHandle ("inputModel"), false)!;
			}
			set {
