...
namespace CoreImage {
	...
	public partial class CIOpTile : CITileFilter, ICIOpTileProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIOpTile" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIOpTile () : base ("CIOpTile")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIOpTile (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIOpTile (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIOpTile (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIOpTileProtocol protocol members 
