...
namespace UIKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "InsertInputSuggestion", Selector = "textField:insertInputSuggestion:", ParameterType = new Type [] { typeof (UITextField), typeof (UIInputSuggestion) }, ParameterByRef = new bool [] { false, false })]
	...
	public partial interface IUITextFieldDelegate : INativeObject, IDisposable
	{
		...
		[global::Foundation.OptionalMember]
		[Export ("textField:insertInputSuggestion:")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("ios18.4")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void InsertInputSuggestion (UITextField textField, UIInputSuggestion inputSuggestion)
		{
			_InsertInputSuggestion (this, textField, inputSuggestion);
		}
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("ios18.4")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _InsertInputSuggestion (IUITextFieldDelegate This, UITextField textField, UIInputSuggestion inputSuggestion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var textField__handle__ = textField!.GetNonNullHandle (nameof (textField));
			var inputSuggestion__handle__ = inputSuggestion!.GetNonNullHandle (nameof (inputSuggestion));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("textField:insertInputSuggestion:"), textField__handle__, inputSuggestion__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (textField);
		...
		[DynamicDependencyAttribute ("InsertInputSuggestion(UIKit.UITextField,UIKit.UIInputSuggestion)")]
	...
	public unsafe static partial class UITextFieldDelegate_Extensions {
		...
		[SupportedOSPlatform ("ios18.4")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void InsertInputSuggestion (this IUITextFieldDelegate This, UITextField textField, UIInputSuggestion inputSuggestion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var textField__handle__ = textField!.GetNonNullHandle (nameof (textField));
			var inputSuggestion__handle__ = inputSuggestion!.GetNonNullHandle (nameof (inputSuggestion));
...
namespace UIKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_iOS__UIKit_UITextFieldDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("tvos")]
