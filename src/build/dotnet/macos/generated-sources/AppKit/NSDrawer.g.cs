...
namespace AppKit {
	...
	public unsafe partial class NSDrawer : NSResponder, INSAccessibility, INSAccessibilityElementProtocol {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selClose_X = "close:";
		static readonly NativeHandle selClose_XHandle = Selector.GetHandle ("close:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEdgeX = "edge";
		static readonly NativeHandle selEdgeXHandle = Selector.GetHandle ("edge");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithContentSize_PreferredEdge_X = "initWithContentSize:preferredEdge:";
		static readonly NativeHandle selInitWithContentSize_PreferredEdge_XHandle = Selector.GetHandle ("initWithContentSize:preferredEdge:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selLeadingOffsetX = "leadingOffset";
		static readonly NativeHandle selLeadingOffsetXHandle = Selector.GetHandle ("leadingOffset");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selMaxContentSizeX = "maxContentSize";
		static readonly NativeHandle selMaxContentSizeXHandle = Selector.GetHandle ("maxContentSize");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selOpen_X = "open:";
		static readonly NativeHandle selOpen_XHandle = Selector.GetHandle ("open:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selOpenOnEdge_X = "openOnEdge:";
		static readonly NativeHandle selOpenOnEdge_XHandle = Selector.GetHandle ("openOnEdge:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetContentSize_X = "setContentSize:";
		static readonly NativeHandle selSetContentSize_XHandle = Selector.GetHandle ("setContentSize:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetLeadingOffset_X = "setLeadingOffset:";
		static readonly NativeHandle selSetLeadingOffset_XHandle = Selector.GetHandle ("setLeadingOffset:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetMaxContentSize_X = "setMaxContentSize:";
		static readonly NativeHandle selSetMaxContentSize_XHandle = Selector.GetHandle ("setMaxContentSize:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetMinContentSize_X = "setMinContentSize:";
		static readonly NativeHandle selSetMinContentSize_XHandle = Selector.GetHandle ("setMinContentSize:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetTrailingOffset_X = "setTrailingOffset:";
		static readonly NativeHandle selSetTrailingOffset_XHandle = Selector.GetHandle ("setTrailingOffset:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selStateX = "state";
		static readonly NativeHandle selStateXHandle = Selector.GetHandle ("state");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selToggle_X = "toggle:";
		static readonly NativeHandle selToggle_XHandle = Selector.GetHandle ("toggle:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTrailingOffsetX = "trailingOffset";
		static readonly NativeHandle selTrailingOffsetXHandle = Selector.GetHandle ("trailingOffset");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSDrawer");
		...
		/// <summary>Creates a new <see cref="NSDrawer" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public NSDrawer () : base (NSObjectFlag.Empty)
		{
		...
		public NSDrawer (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected NSDrawer (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSDrawer (NativeHandle handle) : base (handle)
		{
		}
			...
			: base (NSObjectFlag.Empty)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_CGSize_UIntPtr (this.Handle, selInitWithContentSize_PreferredEdge_XHandle, contentSize, (UIntPtr) (ulong) edge), "initWithContentSize:preferredEdge:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_CGSize_UIntPtr (&__objc_super__, selInitWithContentSize_PreferredEdge_XHandle, contentSize, (UIntPtr) (ulong) edge), "initWithContentSize:preferredEdge:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		[UnsupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("macos12.0", "Use 'NSSplitViewController' instead.")]
		...
		public virtual void Close (NSObject sender)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selClose_XHandle, sender__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selClose_XHandle, sender__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (sender);
		...
		public virtual void Open (NSObject sender)
		{
			...
			var sender__handle__ = sender!.GetNonNullHandle (nameof (sender));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selOpen_XHandle, sender__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selOpen_XHandle, sender__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (sender);
		...
		public virtual void OpenOnEdge (NSRectEdge edge)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selOpenOnEdge_XHandle, (UIntPtr) (ulong) edge);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selOpenOnEdge_XHandle, (UIntPtr) (ulong) edge);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void Toggle (NSObject sender)
		{
			...
			var sender__handle__ = sender!.GetNonNullHandle (nameof (sender));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selToggle_XHandle, sender__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selToggle_XHandle, sender__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (sender);
		...
		public virtual CGSize ContentSize {
			...
			set {
				global::AppKit.NSApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_CGSize (this.Handle, selSetContentSize_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_CGSize (&__objc_super__, selSetContentSize_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual NSRectEdge Edge {
			...
			get {
				...
				NSRectEdge ret;
				if (IsDirectBinding) {
					ret = (NSRectEdge) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selEdgeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSRectEdge) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selEdgeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual nfloat LeadingOffset {
			...
			get {
				...
				nfloat ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend (this.Handle, selLeadingOffsetXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSendSuper (&__objc_super__, selLeadingOffsetXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				global::AppKit.NSApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_nfloat (this.Handle, selSetLeadingOffset_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_nfloat (&__objc_super__, selSetLeadingOffset_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual CGSize MaxContentSize {
			...
			get {
				...
				CGSize ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.CGSize_objc_msgSend (this.Handle, selMaxContentSizeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.CGSize_objc_msgSendSuper (&__objc_super__, selMaxContentSizeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				global::AppKit.NSApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_CGSize (this.Handle, selSetMaxContentSize_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_CGSize (&__objc_super__, selSetMaxContentSize_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual CGSize MinContentSize {
			...
			set {
				global::AppKit.NSApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_CGSize (this.Handle, selSetMinContentSize_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_CGSize (&__objc_super__, selSetMinContentSize_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual NSWindow ParentWindow {
			...
			get {
				...
				NSWindow? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSWindow> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selParentWindowXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSWindow> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selParentWindowXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual NSDrawerState State {
			...
			get {
				...
				NSDrawerState ret;
				if (IsDirectBinding) {
					ret = (NSDrawerState) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selStateXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (NSDrawerState) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selStateXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual nfloat TrailingOffset {
			...
			get {
				...
				nfloat ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend (this.Handle, selTrailingOffsetXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSendSuper (&__objc_super__, selTrailingOffsetXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				global::AppKit.NSApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_nfloat (this.Handle, selSetTrailingOffset_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_nfloat (&__objc_super__, selSetTrailingOffset_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveAnnouncementRequested ((sender, args) => {
		...
		/// void Callback (object sender, NSDrawer.NSNotificationEventArgs args)
		/// {
		///     // Access strongly typed args
		///     Console.WriteLine ("Notification: {0}", args.Notification);
		/// }
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveAnnouncementRequested (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		///     NSDrawer.AnnouncementRequestedNotification, (notification) => { Console.WriteLine ("Received the notification AnnouncementRequested", notification); }
		/// );
		///
		/// // Method style
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.AnnouncementRequestedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveApplicationActivated ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveApplicationActivated (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.ApplicationActivatedNotification, (notification) => { Console.WriteLine ("Received the notification ApplicationActivated", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.ApplicationActivatedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveApplicationDeactivated ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveApplicationDeactivated (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.ApplicationDeactivatedNotification, (notification) => { Console.WriteLine ("Received the notification ApplicationDeactivated", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.ApplicationDeactivatedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveApplicationHidden ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveApplicationHidden (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.ApplicationHiddenNotification, (notification) => { Console.WriteLine ("Received the notification ApplicationHidden", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.ApplicationHiddenNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveApplicationShown ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveApplicationShown (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.ApplicationShownNotification, (notification) => { Console.WriteLine ("Received the notification ApplicationShown", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.ApplicationShownNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveAutocorrectionOccurred ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveAutocorrectionOccurred (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.AutocorrectionOccurredNotification, (notification) => { Console.WriteLine ("Received the notification AutocorrectionOccurred", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.AutocorrectionOccurredNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[Advice ("Use NSDrawer.Notifications.ObserveAutocorrectionOccurred helper method instead.")]
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveCreated ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveCreated (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.CreatedNotification, (notification) => { Console.WriteLine ("Received the notification Created", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.CreatedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _DidCloseNotification;
		/// <summary>Notification constant for DidClose</summary>
		/// <value><see cref="NSString" /> constant, should be used as a token to <see cref="NSNotificationCenter" />.</value>
		/// <remarks>
		///   <para>
		///     This constant can be used with <see cref="NSNotificationCenter" /> to register a listener for this notification.
		...
		///   </para>
		///   <para>
		///     To subscribe to this notification, developers can use the convenience <see cref="Notifications.ObserveDidClose(NSObject,EventHandler{NSNotificationEventArgs})" />
		///     or <see cref="Notifications.ObserveDidClose(EventHandler{NSNotificationEventArgs})" /> methods,
		///     which offers strongly typed access to the parameters of the notification.
		///   </para>
		///   <para>
		///     The following example shows how to use the strongly typed <see cref="Notifications" /> class, to take the guesswork
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveDidClose ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveDidClose (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.DidCloseNotification, (notification) => { Console.WriteLine ("Received the notification DidClose", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		/// {
		///     Console.WriteLine ("Received the notification DidClose", notification);
		/// }
		///
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.DidCloseNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		public static NSString DidCloseNotification {
			...
			[SupportedOSPlatform ("macos")]
			get {
				if (_DidCloseNotification is null)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _DidOpenNotification;
		/// <summary>Notification constant for DidOpen</summary>
		/// <value><see cref="NSString" /> constant, should be used as a token to <see cref="NSNotificationCenter" />.</value>
		/// <remarks>
		///   <para>
		///     This constant can be used with <see cref="NSNotificationCenter" /> to register a listener for this notification.
		...
		///   </para>
		///   <para>
		///     To subscribe to this notification, developers can use the convenience <see cref="Notifications.ObserveDidOpen(NSObject,EventHandler{NSNotificationEventArgs})" />
		///     or <see cref="Notifications.ObserveDidOpen(EventHandler{NSNotificationEventArgs})" /> methods,
		///     which offers strongly typed access to the parameters of the notification.
		///   </para>
		///   <para>
		///     The following example shows how to use the strongly typed <see cref="Notifications" /> class, to take the guesswork
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveDidOpen ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveDidOpen (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.DidOpenNotification, (notification) => { Console.WriteLine ("Received the notification DidOpen", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		/// {
		///     Console.WriteLine ("Received the notification DidOpen", notification);
		/// }
		///
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.DidOpenNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		public static NSString DidOpenNotification {
			...
			[SupportedOSPlatform ("macos")]
			get {
				if (_DidOpenNotification is null)
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveDraggingDestinationDragAccepted ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveDraggingDestinationDragAccepted (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.DraggingDestinationDragAcceptedNotification, (notification) => { Console.WriteLine ("Received the notification DraggingDestinationDragAccepted", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.DraggingDestinationDragAcceptedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[Advice ("Use NSDrawer.Notifications.ObserveDraggingDestinationDragAccepted helper method instead.")]
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveDraggingDestinationDragNotAccepted ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveDraggingDestinationDragNotAccepted (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.DraggingDestinationDragNotAcceptedNotification, (notification) => { Console.WriteLine ("Received the notification DraggingDestinationDragNotAccepted", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.DraggingDestinationDragNotAcceptedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[Advice ("Use NSDrawer.Notifications.ObserveDraggingDestinationDragNotAccepted helper method instead.")]
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveDraggingDestinationDropAllowed ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveDraggingDestinationDropAllowed (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.DraggingDestinationDropAllowedNotification, (notification) => { Console.WriteLine ("Received the notification DraggingDestinationDropAllowed", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.DraggingDestinationDropAllowedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[Advice ("Use NSDrawer.Notifications.ObserveDraggingDestinationDropAllowed helper method instead.")]
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveDraggingDestinationDropNotAllowed ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveDraggingDestinationDropNotAllowed (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.DraggingDestinationDropNotAllowedNotification, (notification) => { Console.WriteLine ("Received the notification DraggingDestinationDropNotAllowed", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.DraggingDestinationDropNotAllowedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[Advice ("Use NSDrawer.Notifications.ObserveDraggingDestinationDropNotAllowed helper method instead.")]
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveDraggingSourceDragBegan ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveDraggingSourceDragBegan (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.DraggingSourceDragBeganNotification, (notification) => { Console.WriteLine ("Received the notification DraggingSourceDragBegan", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.DraggingSourceDragBeganNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[Advice ("Use NSDrawer.Notifications.ObserveDraggingSourceDragBegan helper method instead.")]
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveDraggingSourceDragEnded ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveDraggingSourceDragEnded (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.DraggingSourceDragEndedNotification, (notification) => { Console.WriteLine ("Received the notification DraggingSourceDragEnded", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.DraggingSourceDragEndedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[Advice ("Use NSDrawer.Notifications.ObserveDraggingSourceDragEnded helper method instead.")]
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveDrawerCreated ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveDrawerCreated (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.DrawerCreatedNotification, (notification) => { Console.WriteLine ("Received the notification DrawerCreated", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.DrawerCreatedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveFocusedWindowChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveFocusedWindowChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.FocusedWindowChangedNotification, (notification) => { Console.WriteLine ("Received the notification FocusedWindowChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.FocusedWindowChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveHelpTagCreated ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveHelpTagCreated (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.HelpTagCreatedNotification, (notification) => { Console.WriteLine ("Received the notification HelpTagCreated", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.HelpTagCreatedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveLayoutChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveLayoutChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.LayoutChangedNotification, (notification) => { Console.WriteLine ("Received the notification LayoutChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.LayoutChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveMainWindowChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveMainWindowChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.MainWindowChangedNotification, (notification) => { Console.WriteLine ("Received the notification MainWindowChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.MainWindowChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveMoved ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveMoved (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.MovedNotification, (notification) => { Console.WriteLine ("Received the notification Moved", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.MovedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveResized ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveResized (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.ResizedNotification, (notification) => { Console.WriteLine ("Received the notification Resized", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.ResizedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveRowCollapsed ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveRowCollapsed (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.RowCollapsedNotification, (notification) => { Console.WriteLine ("Received the notification RowCollapsed", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.RowCollapsedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveRowCountChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveRowCountChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.RowCountChangedNotification, (notification) => { Console.WriteLine ("Received the notification RowCountChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.RowCountChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveRowExpanded ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveRowExpanded (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.RowExpandedNotification, (notification) => { Console.WriteLine ("Received the notification RowExpanded", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.RowExpandedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveSelectedCellsChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveSelectedCellsChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.SelectedCellsChangedNotification, (notification) => { Console.WriteLine ("Received the notification SelectedCellsChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.SelectedCellsChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveSelectedChildrenChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveSelectedChildrenChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.SelectedChildrenChangedNotification, (notification) => { Console.WriteLine ("Received the notification SelectedChildrenChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.SelectedChildrenChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveSelectedChildrenMoved ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveSelectedChildrenMoved (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.SelectedChildrenMovedNotification, (notification) => { Console.WriteLine ("Received the notification SelectedChildrenMoved", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.SelectedChildrenMovedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveSelectedColumnsChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveSelectedColumnsChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.SelectedColumnsChangedNotification, (notification) => { Console.WriteLine ("Received the notification SelectedColumnsChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.SelectedColumnsChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveSelectedRowsChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveSelectedRowsChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.SelectedRowsChangedNotification, (notification) => { Console.WriteLine ("Received the notification SelectedRowsChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.SelectedRowsChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveSelectedTextChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveSelectedTextChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.SelectedTextChangedNotification, (notification) => { Console.WriteLine ("Received the notification SelectedTextChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.SelectedTextChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveSheetCreated ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveSheetCreated (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.SheetCreatedNotification, (notification) => { Console.WriteLine ("Received the notification SheetCreated", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.SheetCreatedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveTextInputMarkingSessionBegan ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveTextInputMarkingSessionBegan (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.TextInputMarkingSessionBeganNotification, (notification) => { Console.WriteLine ("Received the notification TextInputMarkingSessionBegan", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.TextInputMarkingSessionBeganNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[Advice ("Use NSDrawer.Notifications.ObserveTextInputMarkingSessionBegan helper method instead.")]
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveTextInputMarkingSessionEnded ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveTextInputMarkingSessionEnded (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.TextInputMarkingSessionEndedNotification, (notification) => { Console.WriteLine ("Received the notification TextInputMarkingSessionEnded", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.TextInputMarkingSessionEndedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[Advice ("Use NSDrawer.Notifications.ObserveTextInputMarkingSessionEnded helper method instead.")]
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveTitleChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveTitleChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.TitleChangedNotification, (notification) => { Console.WriteLine ("Received the notification TitleChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.TitleChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveUIElementDestroyed ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveUIElementDestroyed (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.UIElementDestroyedNotification, (notification) => { Console.WriteLine ("Received the notification UIElementDestroyed", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.UIElementDestroyedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveUIElementFocusedChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveUIElementFocusedChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.UIElementFocusedChangedNotification, (notification) => { Console.WriteLine ("Received the notification UIElementFocusedChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.UIElementFocusedChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveUnitsChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveUnitsChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.UnitsChangedNotification, (notification) => { Console.WriteLine ("Received the notification UnitsChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.UnitsChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveValueChanged ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveValueChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.ValueChangedNotification, (notification) => { Console.WriteLine ("Received the notification ValueChanged", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.ValueChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _WillCloseNotification;
		/// <summary>Notification constant for WillClose</summary>
		/// <value><see cref="NSString" /> constant, should be used as a token to <see cref="NSNotificationCenter" />.</value>
		/// <remarks>
		///   <para>
		///     This constant can be used with <see cref="NSNotificationCenter" /> to register a listener for this notification.
		...
		///   </para>
		///   <para>
		///     To subscribe to this notification, developers can use the convenience <see cref="Notifications.ObserveWillClose(NSObject,EventHandler{NSNotificationEventArgs})" />
		///     or <see cref="Notifications.ObserveWillClose(EventHandler{NSNotificationEventArgs})" /> methods,
		///     which offers strongly typed access to the parameters of the notification.
		///   </para>
		///   <para>
		///     The following example shows how to use the strongly typed <see cref="Notifications" /> class, to take the guesswork
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveWillClose ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveWillClose (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.WillCloseNotification, (notification) => { Console.WriteLine ("Received the notification WillClose", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		/// {
		///     Console.WriteLine ("Received the notification WillClose", notification);
		/// }
		///
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.WillCloseNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		public static NSString WillCloseNotification {
			...
			[SupportedOSPlatform ("macos")]
			get {
				if (_WillCloseNotification is null)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _WillOpenNotification;
		/// <summary>Notification constant for WillOpen</summary>
		/// <value><see cref="NSString" /> constant, should be used as a token to <see cref="NSNotificationCenter" />.</value>
		/// <remarks>
		///   <para>
		///     This constant can be used with <see cref="NSNotificationCenter" /> to register a listener for this notification.
		...
		///   </para>
		///   <para>
		///     To subscribe to this notification, developers can use the convenience <see cref="Notifications.ObserveWillOpen(NSObject,EventHandler{NSNotificationEventArgs})" />
		///     or <see cref="Notifications.ObserveWillOpen(EventHandler{NSNotificationEventArgs})" /> methods,
		///     which offers strongly typed access to the parameters of the notification.
		///   </para>
		///   <para>
		///     The following example shows how to use the strongly typed <see cref="Notifications" /> class, to take the guesswork
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveWillOpen ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveWillOpen (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.WillOpenNotification, (notification) => { Console.WriteLine ("Received the notification WillOpen", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		/// {
		///     Console.WriteLine ("Received the notification WillOpen", notification);
		/// }
		///
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.WillOpenNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		public static NSString WillOpenNotification {
			...
			[SupportedOSPlatform ("macos")]
			get {
				if (_WillOpenNotification is null)
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveWindowCreated ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveWindowCreated (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.WindowCreatedNotification, (notification) => { Console.WriteLine ("Received the notification WindowCreated", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.WindowCreatedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveWindowDeminiaturized ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveWindowDeminiaturized (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.WindowDeminiaturizedNotification, (notification) => { Console.WriteLine ("Received the notification WindowDeminiaturized", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.WindowDeminiaturizedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveWindowMiniaturized ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveWindowMiniaturized (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.WindowMiniaturizedNotification, (notification) => { Console.WriteLine ("Received the notification WindowMiniaturized", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.WindowMiniaturizedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveWindowMoved ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveWindowMoved (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.WindowMovedNotification, (notification) => { Console.WriteLine ("Received the notification WindowMoved", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.WindowMovedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		///
		/// // listening
		/// notification = NSDrawer.Notifications.ObserveWindowResized ((sender, args) => {
		/// /* Access strongly typed args */
		/// Console.WriteLine ("Notification: {0}", args.Notification);
		/// });
		///
		...
		/// void Setup ()
		/// {
		///     notification = NSDrawer.Notifications.ObserveWindowResized (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		/// // Lambda style
		/// NSNotificationCenter.DefaultCenter.AddObserver (
		///     NSDrawer.WindowResizedNotification, (notification) => { Console.WriteLine ("Received the notification WindowResized", notification); }
		/// );
		///
		/// // Method style
		/// void Callback (NSNotification notification)
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (NSDrawer.WindowResizedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		{
			get { return typeof (_NSDrawerDelegate); }
		}
		internal virtual _NSDrawerDelegate CreateInternalEventDelegateType ()
		{
			return (_NSDrawerDelegate)(new _NSDrawerDelegate());
		}
		internal _NSDrawerDelegate EnsureNSDrawerDelegate ()
		{
			if (WeakDelegate is not null)
				NSApplication.EnsureEventAndDelegateAreNotMismatched (WeakDelegate, GetInternalEventDelegateType);
			var del = Delegate as _NSDrawerDelegate;
			if (del is null){
				del = (_NSDrawerDelegate)CreateInternalEventDelegateType ();
				Delegate = (INSDrawerDelegate)del;
			}
			return del;
		}
		#pragma warning disable 672
		[Register]
		internal class _NSDrawerDelegate : NSObject, INSDrawerDelegate { 
			public _NSDrawerDelegate () { IsDirectBinding = false; }
			[DynamicDependency (DynamicallyAccessedMemberTypes.PublicMethods, typeof (_NSDrawerDelegate))]
			static _NSDrawerDelegate ()
			{
				GC.KeepAlive (null);
			}
			...
			{
				var handler = drawerWillResizeContents;
				if (handler is not null)
					return handler (sender, toSize);
		...
		public event EventHandler DrawerDidClose {
			add { EnsureNSDrawerDelegate ()!.drawerDidClose += value; }
			remove { EnsureNSDrawerDelegate ()!.drawerDidClose -= value; }
		}
		/// <summary>To be added.</summary>
		/// <remarks>To be added.</remarks>
		public event EventHandler DrawerDidOpen {
			add { EnsureNSDrawerDelegate ()!.drawerDidOpen += value; }
			remove { EnsureNSDrawerDelegate ()!.drawerDidOpen -= value; }
		}
		/// <summary>To be added.</summary>
		/// <value>To be added.</value>
		/// <remarks>To be added.</remarks>
		public DrawerShouldCloseDelegate? DrawerShouldClose {
			get { return EnsureNSDrawerDelegate ()!.drawerShouldClose; }
			set { EnsureNSDrawerDelegate ()!.drawerShouldClose = value; }
		}
		/// <summary>To be added.</summary>
		/// <value>To be added.</value>
		/// <remarks>To be added.</remarks>
		public DrawerShouldOpenDelegate? DrawerShouldOpen {
			get { return EnsureNSDrawerDelegate ()!.drawerShouldOpen; }
			set { EnsureNSDrawerDelegate ()!.drawerShouldOpen = value; }
		}
		/// <summary>To be added.</summary>
		/// <remarks>To be added.</remarks>
		public event EventHandler DrawerWillClose {
			add { EnsureNSDrawerDelegate ()!.drawerWillClose += value; }
			remove { EnsureNSDrawerDelegate ()!.drawerWillClose -= value; }
		}
		/// <summary>To be added.</summary>
		/// <remarks>To be added.</remarks>
		public event EventHandler DrawerWillOpen {
			add { EnsureNSDrawerDelegate ()!.drawerWillOpen += value; }
			remove { EnsureNSDrawerDelegate ()!.drawerWillOpen -= value; }
		}
		/// <summary>To be added.</summary>
		/// <value>To be added.</value>
		/// <remarks>To be added.</remarks>
		public DrawerWillResizeContentsDelegate? DrawerWillResizeContents {
			get { return EnsureNSDrawerDelegate ()!.drawerWillResizeContents; }
			set { EnsureNSDrawerDelegate ()!.drawerWillResizeContents = value; }
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		// Notifications
		//
		/// <summary>Notifications posted by the <see cref="global::AppKit.NSDrawer" /> class.</summary>
		/// <remarks>
		///    <para>This class contains various helper methods that allow developers to observe events posted in the notification hub (<see cref="Foundation.NSNotificationCenter" />).</para>
		///    <para>The methods defined in this class post events that invoke the provided method or lambda with a <see cref="Foundation.NSNotificationEventArgs" /> parameter, which contains strongly typed properties for the notification arguments.</para>
		/// </remarks>
		public static partial class Notifications {
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.AnnouncementRequestedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.AnnouncementRequestedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveAnnouncementRequested ((notification) => {
			...
			/// var token = NSDrawer.Notifications.ObserveAnnouncementRequested (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.ApplicationActivatedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.ApplicationActivatedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveApplicationActivated ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveApplicationActivated (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.ApplicationDeactivatedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.ApplicationDeactivatedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveApplicationDeactivated ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveApplicationDeactivated (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.ApplicationHiddenNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.ApplicationHiddenNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveApplicationHidden ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveApplicationHidden (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.ApplicationShownNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.ApplicationShownNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveApplicationShown ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveApplicationShown (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.AutocorrectionOccurredNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.AutocorrectionOccurredNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveAutocorrectionOccurred ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveAutocorrectionOccurred (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.CreatedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.CreatedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveCreated ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveCreated (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.DidCloseNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.DidCloseNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveDidClose ((notification) => {
			...
			{
				return NSNotificationCenter.DefaultCenter.AddObserver (DidCloseNotification, notification => handler (null, new NSNotificationEventArgs (notification)));
			}
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.DidCloseNotification" /> constant.</summary>
			/// <param name="objectToObserve">The specific object to observe.</param>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveDidClose (objectToObserve, (notification) => {
			...
			{
				return NSNotificationCenter.DefaultCenter.AddObserver (DidCloseNotification, notification => handler (null, new NSNotificationEventArgs (notification)), objectToObserve);
			}
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.DidOpenNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.DidOpenNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveDidOpen ((notification) => {
			///   Console.WriteLine ("Observed DidOpenNotification!");
			/// };
			/// 
			/// // Stop listening for notifications
			/// token.Dispose ();
			...
			{
				return NSNotificationCenter.DefaultCenter.AddObserver (DidOpenNotification, notification => handler (null, new NSNotificationEventArgs (notification)));
			}
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.DidOpenNotification" /> constant.</summary>
			/// <param name="objectToObserve">The specific object to observe.</param>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveDidOpen (objectToObserve, (notification) => {
			///   Console.WriteLine ($"Observed DidOpenNotification for {nameof (objectToObserve)}!");
			/// };
			/// 
			/// // Stop listening for notifications
			/// token.Dispose ();
			...
			{
				return NSNotificationCenter.DefaultCenter.AddObserver (DidOpenNotification, notification => handler (null, new NSNotificationEventArgs (notification)), objectToObserve);
			}
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.DraggingDestinationDragAcceptedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.DraggingDestinationDragAcceptedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveDraggingDestinationDragAccepted ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveDraggingDestinationDragAccepted (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.DraggingDestinationDragNotAcceptedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.DraggingDestinationDragNotAcceptedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveDraggingDestinationDragNotAccepted ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveDraggingDestinationDragNotAccepted (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.DraggingDestinationDropAllowedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.DraggingDestinationDropAllowedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveDraggingDestinationDropAllowed ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveDraggingDestinationDropAllowed (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.DraggingDestinationDropNotAllowedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.DraggingDestinationDropNotAllowedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveDraggingDestinationDropNotAllowed ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveDraggingDestinationDropNotAllowed (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.DraggingSourceDragBeganNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.DraggingSourceDragBeganNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveDraggingSourceDragBegan ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveDraggingSourceDragBegan (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.DraggingSourceDragEndedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.DraggingSourceDragEndedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveDraggingSourceDragEnded ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveDraggingSourceDragEnded (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.DrawerCreatedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.DrawerCreatedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveDrawerCreated ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveDrawerCreated (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.FocusedWindowChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.FocusedWindowChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveFocusedWindowChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveFocusedWindowChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.HelpTagCreatedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.HelpTagCreatedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveHelpTagCreated ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveHelpTagCreated (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.LayoutChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.LayoutChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveLayoutChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveLayoutChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.MainWindowChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.MainWindowChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveMainWindowChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveMainWindowChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.MovedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.MovedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveMoved ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveMoved (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.ResizedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.ResizedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveResized ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveResized (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.RowCollapsedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.RowCollapsedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveRowCollapsed ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveRowCollapsed (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.RowCountChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.RowCountChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveRowCountChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveRowCountChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.RowExpandedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.RowExpandedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveRowExpanded ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveRowExpanded (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.SelectedCellsChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.SelectedCellsChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveSelectedCellsChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveSelectedCellsChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.SelectedChildrenChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.SelectedChildrenChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveSelectedChildrenChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveSelectedChildrenChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.SelectedChildrenMovedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.SelectedChildrenMovedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveSelectedChildrenMoved ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveSelectedChildrenMoved (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.SelectedColumnsChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.SelectedColumnsChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveSelectedColumnsChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveSelectedColumnsChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.SelectedRowsChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.SelectedRowsChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveSelectedRowsChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveSelectedRowsChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.SelectedTextChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.SelectedTextChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveSelectedTextChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveSelectedTextChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.SheetCreatedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.SheetCreatedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveSheetCreated ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveSheetCreated (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.TextInputMarkingSessionBeganNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.TextInputMarkingSessionBeganNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveTextInputMarkingSessionBegan ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveTextInputMarkingSessionBegan (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.TextInputMarkingSessionEndedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.TextInputMarkingSessionEndedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveTextInputMarkingSessionEnded ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveTextInputMarkingSessionEnded (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.TitleChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.TitleChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveTitleChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveTitleChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.UIElementDestroyedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.UIElementDestroyedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveUIElementDestroyed ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveUIElementDestroyed (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.UIElementFocusedChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.UIElementFocusedChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveUIElementFocusedChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveUIElementFocusedChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.UnitsChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.UnitsChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveUnitsChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveUnitsChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.ValueChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.ValueChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveValueChanged ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveValueChanged (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.WillCloseNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.WillCloseNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveWillClose ((notification) => {
			...
			{
				return NSNotificationCenter.DefaultCenter.AddObserver (WillCloseNotification, notification => handler (null, new NSNotificationEventArgs (notification)));
			}
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.WillCloseNotification" /> constant.</summary>
			/// <param name="objectToObserve">The specific object to observe.</param>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveWillClose (objectToObserve, (notification) => {
			...
			{
				return NSNotificationCenter.DefaultCenter.AddObserver (WillCloseNotification, notification => handler (null, new NSNotificationEventArgs (notification)), objectToObserve);
			}
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.WillOpenNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.WillOpenNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveWillOpen ((notification) => {
			///   Console.WriteLine ("Observed WillOpenNotification!");
			/// };
			/// 
			/// // Stop listening for notifications
			/// token.Dispose ();
			...
			{
				return NSNotificationCenter.DefaultCenter.AddObserver (WillOpenNotification, notification => handler (null, new NSNotificationEventArgs (notification)));
			}
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.WillOpenNotification" /> constant.</summary>
			/// <param name="objectToObserve">The specific object to observe.</param>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveWillOpen (objectToObserve, (notification) => {
			///   Console.WriteLine ($"Observed WillOpenNotification for {nameof (objectToObserve)}!");
			/// };
			/// 
			/// // Stop listening for notifications
			/// token.Dispose ();
			...
			{
				return NSNotificationCenter.DefaultCenter.AddObserver (WillOpenNotification, notification => handler (null, new NSNotificationEventArgs (notification)), objectToObserve);
			}
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.WindowCreatedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.WindowCreatedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveWindowCreated ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveWindowCreated (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.WindowDeminiaturizedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.WindowDeminiaturizedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveWindowDeminiaturized ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveWindowDeminiaturized (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.WindowMiniaturizedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.WindowMiniaturizedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveWindowMiniaturized ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveWindowMiniaturized (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.WindowMovedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.WindowMovedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveWindowMoved ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveWindowMoved (objectToObserve, (notification) => {
			...
			/// <summary>Strongly typed notification for the <see cref="global::AppKit.NSDrawer.WindowResizedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::AppKit.NSDrawer.WindowResizedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = NSDrawer.Notifications.ObserveWindowResized ((notification) => {
			...
			///     <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for a single object
			/// var token = NSDrawer.Notifications.ObserveWindowResized (objectToObserve, (notification) => {
