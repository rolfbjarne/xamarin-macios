...
namespace Accounts {
	...
	public unsafe partial class ACAccountType : NSObject, INSCoding, INSSecureCoding {
		...
		const string selAccessGrantedX = "accessGranted";
		static readonly NativeHandle selAccessGrantedXHandle = Selector.GetHandle ("accessGranted");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAccountTypeDescriptionX = "accountTypeDescription";
		static readonly NativeHandle selAccountTypeDescriptionXHandle = Selector.GetHandle ("accountTypeDescription");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual bool AccessGranted {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selAccessGrantedXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selAccessGrantedXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual string Description {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selAccountTypeDescriptionXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selAccountTypeDescriptionXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
