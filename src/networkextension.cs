...
// FIXME TODO: Remove this when AccessorySetupKit is bound
...
namespace NetworkExtension {
	...
	interface NEAppProxyFlow {
		[Deprecated (PlatformName.iOS, 18, 0, message: "Use the overload that takes a 'Network.NWEndpoint' instead.")]
		[Deprecated (PlatformName.MacCatalyst, 18, 0, message: "Use the overload that takes a 'Network.NWEndpoint' instead.")]
		[Deprecated (PlatformName.MacOSX, 15, 0, message: "Use the overload that takes a 'Network.NWEndpoint' instead.")]
		...
		[Export ("openWithLocalEndpoint:completionHandler:")]
		void OpenWithLocalEndpoint ([NullAllowed] Network.NWEndpoint localEndpoint, NEAppProxyFlowOpenCallback completionHandler);
	}
	...
	delegate void NDatagramWriteResult ([NullAllowed] NSError error);
	...
	interface NEAppProxyUdpFlow {
		...
		void WriteDatagramsAndFlowEndpoints (NSData [] datagrams, Network.NWEndpoint [] flowEndpoints, NDatagramWriteResult completionHandler);
	...
	interface NEFilterManager {
		...
		[NoWatch, NoTV, NoMacCatalyst, NoiOS, MacCatalyst (18, 0)]
		[Export ("disableEncryptedDNSSettings", ArgumentSemantic.Assign)]
		bool DisableEncryptedDnsSettings { get; }
	}
	...
	interface NENetworkRule : NSSecureCoding, NSCopying {
		...
		[NoWatch, NoTV, Mac (15, 0), NoiOS, NoMacCatalyst]
		[Export ("initWithRemoteNetworkEndpoint:remotePrefix:localNetwork:localPrefix:protocol:direction:")]
