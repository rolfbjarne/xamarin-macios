...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIAreaMaximumAlpha</c>.</summary>
	/// <remarks>
	...
	{
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIAreaMaximumAlphaProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICIAreaMaximumAlphaProtocol ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class CIAreaMaximumAlphaProtocolWrapper : BaseWrapper, ICIAreaMaximumAlphaProtocol {
		public CIAreaMaximumAlphaProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIAreaMaximumAlphaProtocolWrapper))]
		static CIAreaMaximumAlphaProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
