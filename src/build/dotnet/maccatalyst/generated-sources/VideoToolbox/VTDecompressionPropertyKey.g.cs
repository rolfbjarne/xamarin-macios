...
namespace VideoToolbox {
	...
	public unsafe static partial class VTDecompressionPropertyKey  {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _RequestedMvHevcVideoLayerIds;
		/// <summary>Represents the value associated with the constant 'kVTDecompressionPropertyKey_RequestedMVHEVCVideoLayerIDs'.</summary>
		[Field ("kVTDecompressionPropertyKey_RequestedMVHEVCVideoLayerIDs",  "VideoToolbox")]
		[SupportedOSPlatform ("ios17.0")]
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("macos14.0")]
		[SupportedOSPlatform ("maccatalyst17.0")]
		public static NSString RequestedMvHevcVideoLayerIds {
			[SupportedOSPlatform ("ios17.0")]
			[UnsupportedOSPlatform ("tvos")]
			[SupportedOSPlatform ("macos14.0")]
			[SupportedOSPlatform ("maccatalyst17.0")]
			get {
				if (_RequestedMvHevcVideoLayerIds is null)
					_RequestedMvHevcVideoLayerIds = Dlfcn.GetStringConstant (Libraries.VideoToolbox.Handle, "kVTDecompressionPropertyKey_RequestedMVHEVCVideoLayerIDs")!;
				return _RequestedMvHevcVideoLayerIds;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
