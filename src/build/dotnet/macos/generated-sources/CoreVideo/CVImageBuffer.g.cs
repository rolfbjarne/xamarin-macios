...
namespace CoreVideo {
	...
	public unsafe partial class CVImageBuffer  {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _PostDecodeProcessingFrameMetadataKey;
		/// <summary>Represents the value associated with the constant 'kCVImageBufferPostDecodeProcessingFrameMetadataKey'.</summary>
		[Field ("kCVImageBufferPostDecodeProcessingFrameMetadataKey",  "CoreVideo")]
		[SupportedOSPlatform ("macos15.0")]
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		public static NSString PostDecodeProcessingFrameMetadataKey {
			[SupportedOSPlatform ("macos15.0")]
			[UnsupportedOSPlatform ("ios")]
			[UnsupportedOSPlatform ("tvos")]
			[UnsupportedOSPlatform ("maccatalyst")]
			get {
				if (_PostDecodeProcessingFrameMetadataKey is null)
					_PostDecodeProcessingFrameMetadataKey = Dlfcn.GetStringConstant (Libraries.CoreVideo.Handle, "kCVImageBufferPostDecodeProcessingFrameMetadataKey")!;
				return _PostDecodeProcessingFrameMetadataKey;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _PostDecodeProcessingSequenceMetadataKey;
		/// <summary>Represents the value associated with the constant 'kCVImageBufferPostDecodeProcessingSequenceMetadataKey'.</summary>
		[Field ("kCVImageBufferPostDecodeProcessingSequenceMetadataKey",  "CoreVideo")]
		[SupportedOSPlatform ("macos15.0")]
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		public static NSString PostDecodeProcessingSequenceMetadataKey {
			[SupportedOSPlatform ("macos15.0")]
			[UnsupportedOSPlatform ("ios")]
			[UnsupportedOSPlatform ("tvos")]
			[UnsupportedOSPlatform ("maccatalyst")]
			get {
				if (_PostDecodeProcessingSequenceMetadataKey is null)
					_PostDecodeProcessingSequenceMetadataKey = Dlfcn.GetStringConstant (Libraries.CoreVideo.Handle, "kCVImageBufferPostDecodeProcessingSequenceMetadataKey")!;
				return _PostDecodeProcessingSequenceMetadataKey;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
