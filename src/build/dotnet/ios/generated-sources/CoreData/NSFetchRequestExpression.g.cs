...
namespace CoreData {
	...
	public unsafe partial class NSFetchRequestExpression : NSExpression {
		...
		public static NSFetchRequestExpression FromFetch (NSExpression fetch, NSExpression context, bool countOnly)
		{
			...
			ret =  Runtime.GetNSObject<NSFetchRequestExpression> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_bool (class_ptr, Selector.GetHandle ("expressionForFetch:context:countOnly:"), fetch__handle__, context__handle__, countOnly ? (byte) 1 : (byte) 0), false)!;
			GC.KeepAlive (fetch);
		...
		public virtual NSExpression Context {
			...
			get {
				NSExpression? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSExpression> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("contextExpression")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSExpression> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("contextExpression")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual bool IsCountOnly {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("isCountOnlyRequest"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("isCountOnlyRequest"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
		...
		public virtual NSExpression Request {
			...
			get {
				NSExpression? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSExpression> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("requestExpression")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSExpression> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("requestExpression")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
