...
namespace Vision {
	...
	public unsafe partial class VNDetectFaceLandmarksRequest : VNImageBasedRequest, IVNFaceObservationAccepting {
		...
		{
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_UIntPtr_UIntPtr (class_ptr, Selector.GetHandle ("revision:supportsConstellation:"), (UIntPtr) (ulong) revision, (UIntPtr) (ulong) constellation);
			return ret != 0;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[SupportedOSPlatform ("tvos13.0")]
		...
		public virtual VNRequestFaceLandmarksConstellation Constellation {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (Vision.VNRequestFaceLandmarksConstellation) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("constellation"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (Vision.VNRequestFaceLandmarksConstellation) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("constellation"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, Selector.GetHandle ("setConstellation:"), (UIntPtr) (ulong) value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, Selector.GetHandle ("setConstellation:"), (UIntPtr) (ulong) value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public static VNDetectFaceLandmarksRequestRevision CurrentRevision {
			...
			get {
				...
				ret = (Vision.VNDetectFaceLandmarksRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("currentRevision"));
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static VNDetectFaceLandmarksRequestRevision DefaultRevision {
			...
			get {
				VNDetectFaceLandmarksRequestRevision ret;
				ret = (Vision.VNDetectFaceLandmarksRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("defaultRevision"));
				return ret!;
			}
		}
		...
		public virtual VNFaceObservation[]? InputFaceObservations {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<VNFaceObservation>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("inputFaceObservations")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("setInputFaceObservations:"), nsa_value.GetHandle ());
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual VNFaceObservation[]? Results {
			...
			get {
				VNFaceObservation[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<VNFaceObservation>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("results")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<VNFaceObservation>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("results")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual VNDetectFaceLandmarksRequestRevision Revision {
			...
			get {
				VNDetectFaceLandmarksRequestRevision ret;
				if (IsDirectBinding) {
					ret = (Vision.VNDetectFaceLandmarksRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("revision"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (Vision.VNDetectFaceLandmarksRequestRevision) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("revision"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
