...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIBlendWithMask" /> that uses a mask image to blend foreground and background images.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/clouds.jpg" alt="Photograph of clouds and sunbeams." /></para><para><img href="~/xml/CoreImage/_images/flower.png" alt="Photograph of a sunflower." /></para><para><img href="~/xml/CoreImage/_images/XamarinAlpha.png" alt="Image with alpha channel" /></para><para>
	/// Produces the following output:
	/// </para><para><img href="~/xml/CoreImage/_images/blend_with_alpha_mask.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIBlendWithAlphaMask : CIBlendWithMask {
		/// <summary>Creates a new <see cref="CIBlendWithAlphaMask" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIBlendWithAlphaMask () : base ("CIBlendWithAlphaMask")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBlendWithAlphaMask (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBlendWithAlphaMask (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBlendWithAlphaMask (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
