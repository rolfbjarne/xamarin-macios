...
namespace FileProvider {
	...
	/// <summary>This interface represents the Objective-C protocol <c>NSFileProviderTestingIngestion</c>.</summary>
	/// <remarks>
	...
	[Protocol (Name = "NSFileProviderTestingIngestion", WrapperType = typeof (NSFileProviderTestingIngestionWrapper))]
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "Item", Selector = "item", PropertyType = typeof (INSFileProviderItem), GetterSelector = "item", ArgumentSemantic = ArgumentSemantic.None)]
	public partial interface INSFileProviderTestingIngestion : INativeObject, IDisposable, 
		FileProvider.INSFileProviderTestingOperation
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSFileProviderTestingIngestionWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static INSFileProviderTestingIngestion ()
		{
			GC.KeepAlive (null);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static NSFileProviderTestingOperationSide _GetSide (INSFileProviderTestingIngestion This)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static string _GetItemIdentifier (INSFileProviderTestingIngestion This)
		{
			string ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[global::Foundation.RequiredMember]
		public virtual INSFileProviderItem? Item {
			[Export ("item")]
			get {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static INSFileProviderItem _GetItem (INSFileProviderTestingIngestion This)
		{
			INSFileProviderItem ret;
			ret =  Runtime.GetINativeObject<INSFileProviderItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (This.Handle, Selector.GetHandle ("item")), false)!;
			GC.KeepAlive (This);
			return ret;
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class NSFileProviderTestingIngestionWrapper : BaseWrapper, INSFileProviderTestingIngestion {
		public NSFileProviderTestingIngestionWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSFileProviderTestingIngestionWrapper))]
		static NSFileProviderTestingIngestionWrapper ()
		{
			GC.KeepAlive (null);
		}
		[Export ("asIngestion")]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public INSFileProviderItem? Item {
			[Export ("item")]
			get {
				INSFileProviderItem ret;
				ret =  Runtime.GetINativeObject<INSFileProviderItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("item")), false)!;
