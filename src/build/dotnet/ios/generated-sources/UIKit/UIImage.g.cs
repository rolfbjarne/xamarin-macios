...
namespace UIKit {
	...
	public unsafe partial class UIImage : NSObject, INSCoding, INSItemProviderReading, INSItemProviderWriting, INSSecureCoding, IUIAccessibilityIdentification, IUIItemProviderPresentationSizeProviding {
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void PrepareForDisplay ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V133))]global::System.Action<UIImage> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void PrepareThumbnail (CGSize OfSize, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V133))]global::System.Action<UIImage> completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
