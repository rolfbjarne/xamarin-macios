...
namespace Foundation {
	...
	public unsafe partial class NSUrlSessionUploadTask : NSUrlSessionDataTask {
		...
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSURLSessionUploadTask");
		...
		protected NSUrlSessionUploadTask (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSUrlSessionUploadTask (NativeHandle handle) : base (handle)
		{
		}

		[Export ("init")]
		[ObsoletedOSPlatform ("macos10.15", "Use 'NSURLSession.CreateUploadTask' instead.")]
		[ObsoletedOSPlatform ("ios13.0", "Use 'NSURLSession.CreateUploadTask' instead.")]
		[ObsoletedOSPlatform ("tvos13.0", "Use 'NSURLSession.CreateUploadTask' instead.")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'NSURLSession.CreateUploadTask' instead.")]
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("maccatalyst")]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CancelByProducingResumeData ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V60))]global::System.Action<NSData> completionHandler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("cancelByProducingResumeData:"), (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		/// <summary>Represents the value associated with the constant 'NSURLSessionUploadTaskResumeData'.</summary>
