...
namespace GameController {
	...
	/// <summary>This interface represents the Objective-C protocol <c>GCAxisInput</c>.</summary>
	/// <remarks>
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "ValueDidChangeHandler", Selector = "valueDidChangeHandler", PropertyType = typeof (global::System.Action<global::GameController.IGCPhysicalInputElement, global::GameController.IGCAxisInput, float>), GetterSelector = "valueDidChangeHandler", SetterSelector = "setValueDidChangeHandler:", ArgumentSemantic = ArgumentSemantic.Copy, ParameterBlockProxy = new Type [] { typeof (ObjCRuntime.Trampolines.NIDActionArity3V7) }, ReturnTypeDelegateProxy = typeof (ObjCRuntime.Trampolines.SDActionArity3V7))]
	...
	public partial interface IGCAxisInput : INativeObject, IDisposable
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (GCAxisInputWrapper))]
		...
		public unsafe virtual global::System.Action<IGCPhysicalInputElement, IGCAxisInput, float>? ValueDidChangeHandler {
		...
		[return: DelegateProxy (typeof (ObjCRuntime.Trampolines.SDActionArity3V7))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static global::System.Action<IGCPhysicalInputElement, IGCAxisInput, float> _GetValueDidChangeHandler (IGCAxisInput This)
		{
			NativeHandle ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _SetValueDidChangeHandler (IGCAxisInput This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity3V7))]global::System.Action<IGCPhysicalInputElement, IGCAxisInput, float>? value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static float _GetValue (IGCAxisInput This)
		{
			float ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static bool _GetAnalog (IGCAxisInput This)
		{
			byte ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static bool _GetCanWrap (IGCAxisInput This)
		{
			byte ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static double _GetLastValueTimestamp (IGCAxisInput This)
		{
			double ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static double _GetLastValueLatency (IGCAxisInput This)
		{
			double ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static NSSet<IGCPhysicalInputSource> _GetSources (IGCAxisInput This)
		{
	...
	internal unsafe sealed class GCAxisInputWrapper : BaseWrapper, IGCAxisInput {
		public GCAxisInputWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (GCAxisInputWrapper))]
		static GCAxisInputWrapper ()
		{
			GC.KeepAlive (null);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
