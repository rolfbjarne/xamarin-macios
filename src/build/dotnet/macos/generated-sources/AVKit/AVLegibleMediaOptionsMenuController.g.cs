...
#nullable enable
namespace AVKit {
	[Register("AVLegibleMediaOptionsMenuController", true)]
	[UnsupportedOSPlatform ("tvos")]
	[SupportedOSPlatform ("macos26.4")]
	[SupportedOSPlatform ("ios26.4")]
	[SupportedOSPlatform ("maccatalyst26.4")]
	public unsafe partial class AVLegibleMediaOptionsMenuController : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selMenuStateX = "menuState";
		static readonly NativeHandle selMenuStateXHandle = Selector.GetHandle ("menuState");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selMenuWithContents_X = "menuWithContents:";
		static readonly NativeHandle selMenuWithContents_XHandle = Selector.GetHandle ("menuWithContents:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("AVLegibleMediaOptionsMenuController");
		...
		protected AVLegibleMediaOptionsMenuController (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal AVLegibleMediaOptionsMenuController (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public AVLegibleMediaOptionsMenuController (global::AVFoundation.AVPlayer player)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSObject? BuildMenu (AVLegibleMediaOptionsMenuContents contents)
		{
			NSObject ret;
			if (IsDirectBinding) {
				ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr (this.Handle, selMenuWithContents_XHandle, (IntPtr) (long) contents), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr (&__objc_super__, selMenuWithContents_XHandle, (IntPtr) (long) contents), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public IAVLegibleMediaOptionsMenuControllerDelegate? Delegate {
			get {
				return (WeakDelegate as IAVLegibleMediaOptionsMenuControllerDelegate)!;
			}
			set {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual AVLegibleMediaOptionsMenuState MenuState {
			[Export ("menuState")]
			get {
				AVLegibleMediaOptionsMenuState ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.AVLegibleMediaOptionsMenuState_objc_msgSend (this.Handle, selMenuStateXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.AVLegibleMediaOptionsMenuState_objc_msgSendSuper (&__objc_super__, selMenuStateXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
