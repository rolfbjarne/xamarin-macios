...
namespace UIKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillPresentEditMenu", Selector = "textField:willPresentEditMenuWithAnimator:", ParameterType = new Type [] { typeof (UITextField), typeof (IUIEditMenuInteractionAnimating) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillDismissEditMenu", Selector = "textField:willDismissEditMenuWithAnimator:", ParameterType = new Type [] { typeof (UITextField), typeof (IUIEditMenuInteractionAnimating) }, ParameterByRef = new bool [] { false, false })]
	...
	public partial interface IUITextFieldDelegate : INativeObject, IDisposable
	{
		...
		{
			_WillPresentEditMenu (this, textField, animator);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios16.0")]
		[SupportedOSPlatform ("maccatalyst16.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _WillPresentEditMenu (IUITextFieldDelegate This, UITextField textField, IUIEditMenuInteractionAnimating animator)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var textField__handle__ = textField!.GetNonNullHandle (nameof (textField));
			var animator__handle__ = animator!.GetNonNullHandle (nameof (animator));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("textField:willPresentEditMenuWithAnimator:"), textField__handle__, animator__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (textField);
		...
		{
			_WillDismissEditMenu (this, textField, animator);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios16.0")]
		[SupportedOSPlatform ("maccatalyst16.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _WillDismissEditMenu (IUITextFieldDelegate This, UITextField textField, IUIEditMenuInteractionAnimating animator)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var textField__handle__ = textField!.GetNonNullHandle (nameof (textField));
			var animator__handle__ = animator!.GetNonNullHandle (nameof (animator));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("textField:willDismissEditMenuWithAnimator:"), textField__handle__, animator__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (textField);
			GC.KeepAlive (animator);
		}
		...
		[DynamicDependencyAttribute ("WillDismissEditMenu(UIKit.UITextField,UIKit.IUIEditMenuInteractionAnimating)")]
		[DynamicDependencyAttribute ("WillPresentEditMenu(UIKit.UITextField,UIKit.IUIEditMenuInteractionAnimating)")]
...
namespace UIKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_MacCatalyst__UIKit_UITextFieldDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("tvos")]
