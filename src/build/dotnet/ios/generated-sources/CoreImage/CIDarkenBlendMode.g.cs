...
#nullable enable
namespace CoreImage {
	/// <summary>The CIDarkenBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/DarkenBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIDarkenBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIDarkenBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIDarkenBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDarkenBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDarkenBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
