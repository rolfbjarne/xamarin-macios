...
namespace Foundation {
		...
		Foundation.INSUrlSessionDelegate
	{
		...
		public unsafe virtual void WillPerformHttpRedirection (NSUrlSession session, NSUrlSessionTask task, NSHttpUrlResponse response, NSUrlRequest newRequest, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V39))]global::System.Action<NSUrlRequest> completionHandler)
		{
			_WillPerformHttpRedirection (this, session, task, response, newRequest, completionHandler);
		}
		/// <param name="session">To be added.</param><param name="task">To be added.</param><param name="response">To be added.</param><param name="newRequest">To be added.</param><param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _WillPerformHttpRedirection (INSUrlSessionTaskDelegate This, NSUrlSession session, NSUrlSessionTask task, NSHttpUrlResponse response, NSUrlRequest newRequest, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V39))]global::System.Action<NSUrlRequest> completionHandler)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DidReceiveChallenge (NSUrlSession session, NSUrlSessionTask task, NSUrlAuthenticationChallenge challenge, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V21))]global::System.Action<NSUrlSessionAuthChallengeDisposition, NSUrlCredential> completionHandler)
		{
			_DidReceiveChallenge (this, session, task, challenge, completionHandler);
		}
		/// <param name="session">To be added.</param><param name="task">To be added.</param><param name="challenge">To be added.</param><param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _DidReceiveChallenge (INSUrlSessionTaskDelegate This, NSUrlSession session, NSUrlSessionTask task, NSUrlAuthenticationChallenge challenge, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V21))]global::System.Action<NSUrlSessionAuthChallengeDisposition, NSUrlCredential> completionHandler)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			var task__handle__ = task!.GetNonNullHandle (nameof (task));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void NeedNewBodyStream (NSUrlSession session, NSUrlSessionTask task, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V40))]global::System.Action<NSInputStream> completionHandler)
		{
			_NeedNewBodyStream (this, session, task, completionHandler);
		}
		/// <param name="session">To be added.</param><param name="task">To be added.</param><param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _NeedNewBodyStream (INSUrlSessionTaskDelegate This, NSUrlSession session, NSUrlSessionTask task, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V40))]global::System.Action<NSInputStream> completionHandler)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			var task__handle__ = task!.GetNonNullHandle (nameof (task));
			if (completionHandler is null)
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void WillBeginDelayedRequest (NSUrlSession session, NSUrlSessionTask task, NSUrlRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V54))]global::System.Action<NSUrlSessionDelayedRequestDisposition, NSUrlRequest> completionHandler)
		{
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _WillBeginDelayedRequest (INSUrlSessionTaskDelegate This, NSUrlSession session, NSUrlSessionTask task, NSUrlRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V54))]global::System.Action<NSUrlSessionDelayedRequestDisposition, NSUrlRequest> completionHandler)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			var task__handle__ = task!.GetNonNullHandle (nameof (task));
		...
		[SupportedOSPlatform ("maccatalyst17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void NeedNewBodyStream (NSUrlSession session, NSUrlSessionTask task, long offset, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V40))]global::System.Action<NSInputStream> completionHandler)
		{
		...
		[SupportedOSPlatform ("maccatalyst17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _NeedNewBodyStream (INSUrlSessionTaskDelegate This, NSUrlSession session, NSUrlSessionTask task, long offset, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V40))]global::System.Action<NSInputStream> completionHandler)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			var task__handle__ = task!.GetNonNullHandle (nameof (task));
			if (completionHandler is null)
	...
	public unsafe static partial class NSUrlSessionTaskDelegate_Extensions {
		/// <param name="session">To be added.</param><param name="task">To be added.</param><param name="response">To be added.</param><param name="newRequest">To be added.</param><param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void WillPerformHttpRedirection (this INSUrlSessionTaskDelegate This, NSUrlSession session, NSUrlSessionTask task, NSHttpUrlResponse response, NSUrlRequest newRequest, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V39))]global::System.Action<NSUrlRequest> completionHandler)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			var task__handle__ = task!.GetNonNullHandle (nameof (task));
			var response__handle__ = response!.GetNonNullHandle (nameof (response));
		...
		/// <param name="session">To be added.</param><param name="task">To be added.</param><param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void NeedNewBodyStream (this INSUrlSessionTaskDelegate This, NSUrlSession session, NSUrlSessionTask task, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V40))]global::System.Action<NSInputStream> completionHandler)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			var task__handle__ = task!.GetNonNullHandle (nameof (task));
			if (completionHandler is null)
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void WillBeginDelayedRequest (this INSUrlSessionTaskDelegate This, NSUrlSession session, NSUrlSessionTask task, NSUrlRequest request, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V54))]global::System.Action<NSUrlSessionDelayedRequestDisposition, NSUrlRequest> completionHandler)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			var task__handle__ = task!.GetNonNullHandle (nameof (task));
			var request__handle__ = request!.GetNonNullHandle (nameof (request));
		...
		[SupportedOSPlatform ("maccatalyst17.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void NeedNewBodyStream (this INSUrlSessionTaskDelegate This, NSUrlSession session, NSUrlSessionTask task, long offset, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V40))]global::System.Action<NSInputStream> completionHandler)
		{
			var session__handle__ = session!.GetNonNullHandle (nameof (session));
			var task__handle__ = task!.GetNonNullHandle (nameof (task));
			if (completionHandler is null)
...
namespace Foundation {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_tvOS__Foundation_NSUrlSessionTaskDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
