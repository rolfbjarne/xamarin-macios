...
namespace CoreImage {
	...
	public partial class CIConvolutionRGB9Vertical : CIFilter, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIConvolutionRGB9Vertical" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIConvolutionRGB9Vertical (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIConvolutionRGB9Vertical (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIConvolutionRGB9Vertical (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
