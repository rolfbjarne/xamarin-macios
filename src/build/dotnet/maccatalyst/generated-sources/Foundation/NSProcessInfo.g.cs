...
namespace Foundation {
	...
	public unsafe partial class NSProcessInfo : NSObject {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void PerformExpiringActivity (string reason, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V2))]global::System.Action<bool> block)
		{
			if (reason is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (reason));
			if (block is null)
			...
			var nsreason = CFString.CreateNative (reason);
			using var block_block = Trampolines.SDActionArity1V2.CreateBlock (block);
