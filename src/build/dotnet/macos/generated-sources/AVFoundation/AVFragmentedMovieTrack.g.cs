...
namespace AVFoundation {
	...
	public unsafe partial class AVFragmentedMovieTrack : AVMovieTrack {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _TotalSampleDataLengthDidChangeNotification;
		/// <summary>Represents the value associated with the constant 'AVFragmentedMovieTrackTotalSampleDataLengthDidChangeNotification'.</summary>
		[Field ("AVFragmentedMovieTrackTotalSampleDataLengthDidChangeNotification",  "AVFoundation")]
		[UnsupportedOSPlatform ("ios")]
		[ObsoletedOSPlatform ("macos10.11", "Use either 'AVFragmentedMovieTrackTimeRangeDidChangeNotification' or 'AVFragmentedMovieTrackSegmentsDidChangeNotification' instead. In either case, you can assume that the sender's 'TotalSampleDataLength' has changed.")]
		...
		public static NSString TotalSampleDataLengthDidChangeNotification {
			...
			[SupportedOSPlatform ("macos")]
			get {
				if (_TotalSampleDataLengthDidChangeNotification is null)
