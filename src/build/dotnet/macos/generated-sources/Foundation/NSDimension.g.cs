...
namespace Foundation {
	...
	public unsafe partial class NSDimension : NSUnit, INSCoding, INSSecureCoding {
		...
		const string selConverterX = "converter";
		static readonly NativeHandle selConverterXHandle = Selector.GetHandle ("converter");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual NSUnitConverter Converter {
			...
			get {
				NSUnitConverter? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSUnitConverter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selConverterXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSUnitConverter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selConverterXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
