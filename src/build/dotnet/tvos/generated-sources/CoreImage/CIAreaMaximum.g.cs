...
namespace CoreImage {
	...
	public partial class CIAreaMaximum : CIReductionFilter, ICIAreaMaximumProtocol, ICIAreaReductionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIAreaMaximum" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIAreaMaximum () : base ("CIAreaMaximum")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAreaMaximum (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAreaMaximum (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAreaMaximum (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIAreaMaximum" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public  CIAreaMaximum (string name) : base (CreateFilter (name))
		{
		}
