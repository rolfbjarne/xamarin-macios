...
namespace Contacts {
	...
	public unsafe partial class CNPostalAddress : NSObject, INSCoding, INSCopying, INSMutableCopying, INSSecureCoding {
		...
		public static string LocalizeProperty (NSString property)
		{
			...
			string? ret;
			ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selLocalizedStringForKey_XHandle, property__handle__), false)!;
