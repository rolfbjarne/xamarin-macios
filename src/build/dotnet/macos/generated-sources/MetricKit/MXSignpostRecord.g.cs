	...
	public unsafe partial class MXSignpostRecord : NSObject, INSCoding, INSSecureCoding {
		...
		public virtual NSDate BeginTimeStamp {
			...
			get {
				NSDate? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selBeginTimeStampXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selBeginTimeStampXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual NSMeasurement<NSUnitDuration>? Duration {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSMeasurement<NSUnitDuration>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selDurationXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSMeasurement<NSUnitDuration>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selDurationXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual NSDate? EndTimeStamp {
			...
			get {
				NSDate? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selEndTimeStampXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDate> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selEndTimeStampXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual bool IsInterval {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, selIsIntervalXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selIsIntervalXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
