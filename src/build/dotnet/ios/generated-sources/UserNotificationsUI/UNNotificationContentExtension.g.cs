...
namespace UserNotificationsUI {
	...
	[ProtocolMember (IsRequired = false, IsProperty = true, IsStatic = false, Name = "MediaPlayPauseButtonTintColor", Selector = "mediaPlayPauseButtonTintColor", PropertyType = typeof (UIColor), GetterSelector = "mediaPlayPauseButtonTintColor", ArgumentSemantic = ArgumentSemantic.Copy)]
	public partial interface IUNNotificationContentExtension : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DidReceiveNotificationResponse (global::UserNotifications.UNNotificationResponse response, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V281))]global::System.Action<UNNotificationContentExtensionResponseOption> completion)
		{
			_DidReceiveNotificationResponse (this, response, completion);
		}
		/// <param name="response">To be added.</param><param name="completion">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _DidReceiveNotificationResponse (IUNNotificationContentExtension This, global::UserNotifications.UNNotificationResponse response, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V281))]global::System.Action<UNNotificationContentExtensionResponseOption> completion)
		{
			var response__handle__ = response!.GetNonNullHandle (nameof (response));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
			using var block_completion = Trampolines.SDActionArity1V281.CreateBlock (completion);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[global::Foundation.OptionalMember]
		public virtual global::UIKit.UIColor MediaPlayPauseButtonTintColor {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static global::UIKit.UIColor _GetMediaPlayPauseButtonTintColor (IUNNotificationContentExtension This)
		{
			global::UIKit.UIColor ret;
			ret =  Runtime.GetNSObject<global::UIKit.UIColor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (This.Handle, Selector.GetHandle ("mediaPlayPauseButtonTintColor")), false)!;
			GC.KeepAlive (This);
			return ret;
		}
	}
	...
	public unsafe static partial class UNNotificationContentExtension_Extensions {
		/// <param name="response">To be added.</param><param name="completion">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void DidReceiveNotificationResponse (this IUNNotificationContentExtension This, global::UserNotifications.UNNotificationResponse response, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V281))]global::System.Action<UNNotificationContentExtensionResponseOption> completion)
		{
			var response__handle__ = response!.GetNonNullHandle (nameof (response));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
		...
		/// <summary>Returns the tint color of the playback button.</summary><returns>The tint color of the playback button.</returns>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static global::UIKit.UIColor GetMediaPlayPauseButtonTintColor (this IUNNotificationContentExtension This)
		{
			global::UIKit.UIColor ret;
			ret =  Runtime.GetNSObject<global::UIKit.UIColor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (This.Handle, Selector.GetHandle ("mediaPlayPauseButtonTintColor")), false)!;
			GC.KeepAlive (This);
