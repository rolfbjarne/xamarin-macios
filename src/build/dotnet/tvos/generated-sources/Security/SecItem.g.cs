...
namespace Security {
	internal unsafe static partial class SecItem  {
		...
		/// <summary>Represents the value associated with the constant 'kSecUseUserIndependentKeychain'.</summary>
		[Field ("kSecUseUserIndependentKeychain",  "Security")]
		[SupportedOSPlatform ("tvos17.0")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[UnsupportedOSPlatform ("macos")]
		[UnsupportedOSPlatform ("ios")]
		public static nint UseUserIndependentKeychain {
			[SupportedOSPlatform ("tvos17.0")]
			[UnsupportedOSPlatform ("maccatalyst")]
			[UnsupportedOSPlatform ("macos")]
			[UnsupportedOSPlatform ("ios")]
			get {
				return Dlfcn.GetIntPtr (Libraries.Security.Handle, "kSecUseUserIndependentKeychain");
			}
		}
