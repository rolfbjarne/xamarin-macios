	...
	public unsafe partial class NSParagraphStyle : NSObject, INSCoding, INSCopying, INSMutableCopying, INSSecureCoding {
		...
		public virtual UITextAlignment Alignment {
			...
			get {
				UITextAlignment ret;
				if (IsDirectBinding) {
					ret = UITextAlignmentExtensions.ToManaged ((nint) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("alignment")));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = UITextAlignmentExtensions.ToManaged ((nint) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("alignment")));
						GC.KeepAlive (this);
					}
				}
				return ret!;
