	...
	public class SBApplicationTest {
		...
		public void TestGetApplicationFromBundleIdentifier ()
		{
			...
			using (var app4 = SBApplication.GetApplication<MySBApp> (unknownBundle)) {
				ClassicAssert.IsNotNull (app1, "SBApplication from known bundle is null");
				ClassicAssert.IsNotNull (app2, "MySBApp from known bundle is null");
				ClassicAssert.IsNull (app3, "SBApplication from unknown bundle is non-null");
				ClassicAssert.IsNull (app4, "MySBApp from unknown bundle is non-null");
			}
		}
		...
		public void TestGetApplicationFromUrl ()
		{
			...
			using (var app2 = SBApplication.GetApplication<MySBApp> (knownUrl)) {
				ClassicAssert.IsNotNull (app1, "SBApplication from known URL is null");
				ClassicAssert.IsNotNull (app2, "MySBApp from known URL is null");
			}
		}
		...
		public void TestGetApplicationFromPid ()
		{
			...
			using (var app4 = SBApplication.GetApplication<MySBApp> (unknownPid)) {
				ClassicAssert.IsNotNull (app1, "SBApplication from known pid is null");
				ClassicAssert.IsNotNull (app2, "MySBApp from known pid is null");
				ClassicAssert.IsNotNull (app3, "SBApplication from unknown pid is null");
				ClassicAssert.IsNotNull (app4, "MySBApp from unknown pid is null");
			}
		}
	}
}
