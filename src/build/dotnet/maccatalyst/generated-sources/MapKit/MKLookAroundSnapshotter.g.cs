	...
	public unsafe partial class MKLookAroundSnapshotter : NSObject {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					...
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithScene:options:"), scene__handle__, options__handle__), "initWithScene:options:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (scene);
		...
		public unsafe virtual void GetSnapshot ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V116))]global::System.Action<MKLookAroundSnapshot, NSError> completionHandler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("getSnapshotWithCompletionHandler:"), (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
		}
