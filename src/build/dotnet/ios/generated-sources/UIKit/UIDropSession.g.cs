...
namespace UIKit {
		...
		, UIKit.IUIDragDropSession
	{
		...
		public unsafe virtual NSProgress LoadObjects (Class itemProviderReadingClass, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V263))]global::System.Action<INSItemProviderReading[]> completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="itemProviderReadingClass">The class of objects to load.</param><param name="completion">Handler to run after the objects are loaded.</param><summary>When implemented by the developer, instantiates every object in the drop session that has the type that is specified by the <paramref ame="itemProviderReadingClass" /> parameter.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static NSProgress _LoadObjects (IUIDropSession This, Class itemProviderReadingClass, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V263))]global::System.Action<INSItemProviderReading[]> completion)
		{
			...
			using var block_completion = Trampolines.SDActionArity1V263.CreateBlock (completion);
	...
	internal unsafe sealed class UIDropSessionWrapper : BaseWrapper, IUIDropSession {
		...
		[Export ("loadObjectsOfClass:completion:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe NSProgress LoadObjects (Class itemProviderReadingClass, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V263))]global::System.Action<INSItemProviderReading[]> completion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var itemProviderReadingClass__handle__ = itemProviderReadingClass!.GetNonNullHandle (nameof (itemProviderReadingClass));
			if (completion is null)
