...
namespace CoreImage {
	...
	public partial class CIMedianFilter : CIFilter, ICIMedianProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIMedianFilter" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIMedianFilter () : base ("CIMedianFilter")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMedianFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMedianFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMedianFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIMedianProtocol protocol members 
