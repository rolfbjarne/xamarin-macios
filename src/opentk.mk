...
$(IOS_DESTDIR)$(MONOTOUCH_PREFIX)/lib/mono/Xamarin.iOS/OpenTK-1.0%: $(MACIOS_BINARIES)/iOS/OpenTK-1.0%
	$(Q) $(CP) $< $@

# Xamarin.TVOS

$(IOS_DESTDIR)$(MONOTOUCH_PREFIX)/lib/mono/Xamarin.TVOS/OpenTK-1.0%: $(MACIOS_BINARIES)/tvos/OpenTK-1.0%
	$(Q) $(CP) $< $@

# Xamarin.Mac

$(MAC_DESTDIR)$(MAC_FRAMEWORK_CURRENT_DIR)/lib/%: $(MACIOS_BINARIES)/macos/%
	$(Q) mkdir -p $(dir $@)
	$(Q) $(CP) $^ $@
...
MAC_TARGETS += \
	...
	$(MAC_DESTDIR)$(MAC_FRAMEWORK_CURRENT_DIR)/lib/x86_64/mobile/OpenTK.pdb        \
	...
	$(MAC_DESTDIR)$(MAC_FRAMEWORK_CURRENT_DIR)/lib/x86_64/full/OpenTK.pdb          \
