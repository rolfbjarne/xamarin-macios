...
namespace AVFoundation {
	...
	public unsafe partial class AVMediaSelection : NSObject, INSCopying, INSMutableCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selMediaSelectionCriteriaCanBeAppliedAutomaticallyToMediaSelectionGroup_X = "mediaSelectionCriteriaCanBeAppliedAutomaticallyToMediaSelectionGroup:";
		static readonly NativeHandle selMediaSelectionCriteriaCanBeAppliedAutomaticallyToMediaSelectionGroup_XHandle = Selector.GetHandle ("mediaSelectionCriteriaCanBeAppliedAutomaticallyToMediaSelectionGroup:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual bool CriteriaCanBeAppliedAutomaticallyToMediaSelectionGroup (AVMediaSelectionGroup mediaSelectionGroup)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (this.Handle, selMediaSelectionCriteriaCanBeAppliedAutomaticallyToMediaSelectionGroup_XHandle, mediaSelectionGroup__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, selMediaSelectionCriteriaCanBeAppliedAutomaticallyToMediaSelectionGroup_XHandle, mediaSelectionGroup__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual AVMediaSelectionOption? GetSelectedMediaOption (AVMediaSelectionGroup mediaSelectionGroup)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<AVMediaSelectionOption> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selSelectedMediaOptionInMediaSelectionGroup_XHandle, mediaSelectionGroup__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<AVMediaSelectionOption> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selSelectedMediaOptionInMediaSelectionGroup_XHandle, mediaSelectionGroup__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (mediaSelectionGroup);
