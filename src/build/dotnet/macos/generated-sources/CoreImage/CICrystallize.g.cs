...
namespace CoreImage {
	...
	public partial class CICrystallize : CIFilter, ICICrystallizeProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CICrystallize" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CICrystallize () : base ("CICrystallize")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CICrystallize (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CICrystallize (NSObjectFlag t) : base (t)
		{
		}
		...
		public CICrystallize (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CICrystallizeProtocol protocol members 
