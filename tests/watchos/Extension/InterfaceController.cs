...
namespace monotouchtestWatchKitExtension
{
	...
	public partial class InterfaceController : WKInterfaceController
	{
		...
		void LoadTests ()
		{
			...
			runner.Filter = new NotFilter (new CategoryExpression ("MobileNotWorking,NotOnMac,NotWorking,ValueAdd,CAS,InetAccess,NotWorkingInterpreter,WatchOSNotWorking").Filter);
