...
namespace MonoTouchFixtures.ARKit {
	...
	public class ARPlaneGeometryTest {
		...
		public void VerticesTest ()
		{
			...
			ClassicAssert.AreEqual (new VectorFloat3 (1, 2, 3), vertices [0], "Vertex 1");
			ClassicAssert.AreEqual (new VectorFloat3 (4, 5, 6), vertices [1], "Vertex 2");
		}
		...
		public void TextureCoordinatesTest ()
		{
			...
			ClassicAssert.AreEqual (new VectorFloat2 (1, 2), textureCoordinates [0], "Texture Coordinates 1");
			ClassicAssert.AreEqual (new VectorFloat2 (3, 4), textureCoordinates [1], "Texture Coordinates 2");
		}
		...
		{
			var face = new ARPlaneGeometryPoker ();
			ClassicAssert.AreEqual (new short [] { 1, 2, 3, 4, 5, 6 }, face.GetTriangleIndices ());
		}
		...
		public void BoundaryVerticesTest ()
		{
			...
			ClassicAssert.AreEqual (new VectorFloat3 (1, 2, 3), boundaryVertices [0], "Boundary Vertex 1");
			ClassicAssert.AreEqual (new VectorFloat3 (4, 5, 6), boundaryVertices [1], "Boundary Vertex 2");
		}
	}
}
