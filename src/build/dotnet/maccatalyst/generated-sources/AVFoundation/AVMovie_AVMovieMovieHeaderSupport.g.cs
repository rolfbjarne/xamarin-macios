...
namespace AVFoundation {
	...
	public unsafe static partial class AVMovie_AVMovieMovieHeaderSupport  {
		...
		public unsafe static NSData? GetMovieHeader (this AVMovie This, string fileType, out NSError? outError)
		{
			...
			NSData? ret;
			ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_ref_NativeHandle (This.Handle, Selector.GetHandle ("movieHeaderWithFileType:error:"), nsfileType, &outErrorValue), false)!;
			GC.KeepAlive (This);
		...
		public static bool IsCompatibleWithFileType (this AVMovie This, string fileType)
		{
			...
			var nsfileType = CFString.CreateNative (fileType);
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("isCompatibleWithFileType:"), nsfileType);
			GC.KeepAlive (This);
			CFString.ReleaseNative (nsfileType);
			return ret != 0;
		}
		...
		public unsafe static bool WriteMovieHeader (this AVMovie This, NSUrl URL, string fileType, AVMovieWritingOptions options, out NSError? outError)
		{
			...
			var nsfileType = CFString.CreateNative (fileType);
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle_UIntPtr_ref_NativeHandle (This.Handle, Selector.GetHandle ("writeMovieHeaderToURL:fileType:options:error:"), URL__handle__, nsfileType, (UIntPtr) (ulong) options, &outErrorValue);
			GC.KeepAlive (This);
			GC.KeepAlive (URL);
			CFString.ReleaseNative (nsfileType);
			outError = Runtime.GetNSObject<NSError> (outErrorValue)!;
