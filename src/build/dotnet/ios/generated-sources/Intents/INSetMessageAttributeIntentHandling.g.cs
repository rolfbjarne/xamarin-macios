...
namespace Intents {
	...
	public partial interface IINSetMessageAttributeIntentHandling : INativeObject, IDisposable
	{
		...
		public unsafe virtual void HandleSetMessageAttribute (INSetMessageAttributeIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V139))]global::System.Action<INSetMessageAttributeIntentResponse> completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="intent">Specifies the user's intention.</param><param name="completion">Completion method that must be called by the override.</param><summary>Developers must override this method and invoke the <see cref="T:System.Action`1" /> with an <see cref="T:Intents.INSetMessageAttributeIntentResponse" /> appropriate to the <see cref="T:Intents.INSetMessageAttributeIntent" /> <paramref name="intent" />.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _HandleSetMessageAttribute (IINSetMessageAttributeIntentHandling This, INSetMessageAttributeIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V139))]global::System.Action<INSetMessageAttributeIntentResponse> completion)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void Confirm (INSetMessageAttributeIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V139))]global::System.Action<INSetMessageAttributeIntentResponse> completion)
		{
			_Confirm (this, intent, completion);
		}
		/// <param name="intent">Specifies the user's intention.</param><param name="completion">Completion method that must be called by the override.</param><summary>Developers may override this method to customize the confirmation of the setting of a message attribute.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _Confirm (IINSetMessageAttributeIntentHandling This, INSetMessageAttributeIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V139))]global::System.Action<INSetMessageAttributeIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ResolveAttribute (INSetMessageAttributeIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V198))]global::System.Action<INMessageAttributeResolutionResult> completion)
		{
			_ResolveAttribute (this, intent, completion);
		}
		/// <param name="intent">Specifies the user's intention.</param><param name="completion">Completion method that must be called by the override.</param><summary>Developers may override this method to customize the resolution of a message attribute.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _ResolveAttribute (IINSetMessageAttributeIntentHandling This, INSetMessageAttributeIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V198))]global::System.Action<INMessageAttributeResolutionResult> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
	...
	public unsafe static partial class INSetMessageAttributeIntentHandling_Extensions {
		/// <param name="intent">Specifies the user's intention.</param><param name="completion">Completion method that must be called by the override.</param><summary>Developers may override this method to customize the confirmation of the setting of a message attribute.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void Confirm (this IINSetMessageAttributeIntentHandling This, INSetMessageAttributeIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V139))]global::System.Action<INSetMessageAttributeIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
		...
		/// <param name="intent">Specifies the user's intention.</param><param name="completion">Completion method that must be called by the override.</param><summary>Developers may override this method to customize the resolution of a message attribute.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void ResolveAttribute (this IINSetMessageAttributeIntentHandling This, INSetMessageAttributeIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V198))]global::System.Action<INMessageAttributeResolutionResult> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
