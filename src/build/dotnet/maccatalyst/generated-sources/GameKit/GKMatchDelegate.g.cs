...
namespace GameKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DataReceived", Selector = "match:didReceiveData:fromPlayer:", ParameterType = new Type [] { typeof (GameKit.GKMatch), typeof (NSData), typeof (string) }, ParameterByRef = new bool [] { false, false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "StateChanged", Selector = "match:player:didChangeState:", ParameterType = new Type [] { typeof (GameKit.GKMatch), typeof (string), typeof (GameKit.GKPlayerConnectionState) }, ParameterByRef = new bool [] { false, false, false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ShouldReinvitePlayer", Selector = "match:shouldReinvitePlayer:", ReturnType = typeof (bool), ParameterType = new Type [] { typeof (GameKit.GKMatch), typeof (string) }, ParameterByRef = new bool [] { false, false })]
	...
	{
		/// <param name="match">To be added.</param><param name="data">To be added.</param><param name="playerId">To be added.</param><summary>Developers should not use this deprecated method. Developers should use 'DataReceivedFromPlayer (GKMatch,NSData,GKPlayer)' instead.</summary><remarks>To be added.</remarks>
		[global::Foundation.OptionalMember]
		[Export ("match:didReceiveData:fromPlayer:")]
		[UnsupportedOSPlatform ("tvos")]
		[ObsoletedOSPlatform ("ios8.0", "Use 'DataReceivedFromPlayer (GKMatch,NSData,GKPlayer)' instead.")]
		[ObsoletedOSPlatform ("macos10.10", "Use 'DataReceivedFromPlayer (GKMatch,NSData,GKPlayer)' instead.")]
		[SupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'DataReceivedFromPlayer (GKMatch,NSData,GKPlayer)' instead.")]
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void DataReceived (GKMatch match, NSData data, string playerId)
		{
			_DataReceived (this, match, data, playerId);
		}
		/// <param name="match">To be added.</param><param name="data">To be added.</param><param name="playerId">To be added.</param><summary>Developers should not use this deprecated method. Developers should use 'DataReceivedFromPlayer (GKMatch,NSData,GKPlayer)' instead.</summary><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("tvos")]
		[ObsoletedOSPlatform ("ios8.0", "Use 'DataReceivedFromPlayer (GKMatch,NSData,GKPlayer)' instead.")]
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _DataReceived (IGKMatchDelegate This, GKMatch match, NSData data, string playerId)
		{
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("match:didReceiveData:fromPlayer:"), match__handle__, data__handle__, nsplayerId);
			GC.KeepAlive (This);
			GC.KeepAlive (match);
			GC.KeepAlive (data);
			CFString.ReleaseNative (nsplayerId);
		}
		/// <param name="match">To be added.</param><param name="playerId">To be added.</param><param name="state">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[global::Foundation.OptionalMember]
		[Export ("match:player:didChangeState:")]
		[UnsupportedOSPlatform ("tvos")]
		[ObsoletedOSPlatform ("ios8.0", "Use 'StateChangedForPlayer (GKMatch,GKPlayer,GKPlayerConnectionState)' instead.")]
		[ObsoletedOSPlatform ("macos10.8", "Use 'StateChangedForPlayer (GKMatch,GKPlayer,GKPlayerConnectionState)' instead.")]
		[SupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'StateChangedForPlayer (GKMatch,GKPlayer,GKPlayerConnectionState)' instead.")]
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void StateChanged (GKMatch match, string playerId, GKPlayerConnectionState state)
		{
			_StateChanged (this, match, playerId, state);
		}
		/// <param name="match">To be added.</param><param name="playerId">To be added.</param><param name="state">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("tvos")]
		[ObsoletedOSPlatform ("ios8.0", "Use 'StateChangedForPlayer (GKMatch,GKPlayer,GKPlayerConnectionState)' instead.")]
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _StateChanged (IGKMatchDelegate This, GKMatch match, string playerId, GKPlayerConnectionState state)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var match__handle__ = match!.GetNonNullHandle (nameof (match));
			if (playerId is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (playerId));
			var nsplayerId = CFString.CreateNative (playerId);
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_IntPtr (This.Handle, Selector.GetHandle ("match:player:didChangeState:"), match__handle__, nsplayerId, (IntPtr) (long) state);
			GC.KeepAlive (This);
			GC.KeepAlive (match);
			CFString.ReleaseNative (nsplayerId);
		}
		...
		/// <param name="match">To be added.</param><param name="playerId">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[global::Foundation.OptionalMember]
		[Export ("match:shouldReinvitePlayer:")]
		[UnsupportedOSPlatform ("tvos")]
		[ObsoletedOSPlatform ("ios8.0", "Use 'ShouldReinviteDisconnectedPlayer' instead.")]
		[ObsoletedOSPlatform ("macos10.10", "Use 'ShouldReinviteDisconnectedPlayer' instead.")]
		[SupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'ShouldReinviteDisconnectedPlayer' instead.")]
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual bool ShouldReinvitePlayer (GKMatch match, string playerId)
		{
			return _ShouldReinvitePlayer (this, match, playerId);
		}
		/// <param name="match">To be added.</param><param name="playerId">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("tvos")]
		[ObsoletedOSPlatform ("ios8.0", "Use 'ShouldReinviteDisconnectedPlayer' instead.")]
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static bool _ShouldReinvitePlayer (IGKMatchDelegate This, GKMatch match, string playerId)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var match__handle__ = match!.GetNonNullHandle (nameof (match));
			if (playerId is null)
			...
			var nsplayerId = CFString.CreateNative (playerId);
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("match:shouldReinvitePlayer:"), match__handle__, nsplayerId);
			GC.KeepAlive (This);
			GC.KeepAlive (match);
			CFString.ReleaseNative (nsplayerId);
			return ret != 0;
		...
		[DynamicDependencyAttribute ("DataReceived(GameKit.GKMatch,Foundation.NSData,System.String)")]
		...
		[DynamicDependencyAttribute ("ShouldReinvitePlayer(GameKit.GKMatch,System.String)")]
		[DynamicDependencyAttribute ("StateChanged(GameKit.GKMatch,System.String,GameKit.GKPlayerConnectionState)")]
...
namespace GameKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_MacCatalyst__GameKit_GKMatchDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
