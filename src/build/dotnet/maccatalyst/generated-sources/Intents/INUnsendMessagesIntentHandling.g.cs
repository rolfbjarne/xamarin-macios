...
namespace Intents {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "HandleUnsendMessages", Selector = "handleUnsendMessages:completion:", ParameterType = new Type [] { typeof (Intents.INUnsendMessagesIntent), typeof (global::System.Action<global::Intents.INUnsendMessagesIntentResponse>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V198) })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ConfirmUnsendMessages", Selector = "confirmUnsendMessages:completion:", ParameterType = new Type [] { typeof (Intents.INUnsendMessagesIntent), typeof (global::System.Action<global::Intents.INUnsendMessagesIntentResponse>) }, ParameterByRef = new bool [] { false, false }, ParameterBlockProxy = new Type? [] { null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V198) })]
	public partial interface IINUnsendMessagesIntentHandling : INativeObject, IDisposable
	{
		...
		public unsafe virtual void HandleUnsendMessages (INUnsendMessagesIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V198))]global::System.Action<INUnsendMessagesIntentResponse> completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _HandleUnsendMessages (IINUnsendMessagesIntentHandling This, INUnsendMessagesIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V198))]global::System.Action<INUnsendMessagesIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
			using var block_completion = Trampolines.SDActionArity1V198.CreateBlock (completion);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ConfirmUnsendMessages (INUnsendMessagesIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V198))]global::System.Action<INUnsendMessagesIntentResponse> completion)
		{
			_ConfirmUnsendMessages (this, intent, completion);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _ConfirmUnsendMessages (IINUnsendMessagesIntentHandling This, INUnsendMessagesIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V198))]global::System.Action<INUnsendMessagesIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
	...
	public unsafe static partial class INUnsendMessagesIntentHandling_Extensions {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void ConfirmUnsendMessages (this IINUnsendMessagesIntentHandling This, INUnsendMessagesIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V198))]global::System.Action<INUnsendMessagesIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
	...
	internal unsafe sealed class INUnsendMessagesIntentHandlingWrapper : BaseWrapper, IINUnsendMessagesIntentHandling {
		...
		[Export ("handleUnsendMessages:completion:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void HandleUnsendMessages (INUnsendMessagesIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V198))]global::System.Action<INUnsendMessagesIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
