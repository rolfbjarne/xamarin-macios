...
namespace GameKit {
	...
	public unsafe partial class GKNotificationBanner : NSObject {
		...
		public unsafe static void Show (string? title, string? message, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAction))]global::System.Action? onCompleted)
		{
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("showBannerWithTitle:message:completionHandler:"), nstitle, nsmessage, (IntPtr) block_ptr_onCompleted);
		...
		public unsafe static void Show (string? title, string? message, double durationSeconds, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAction))]global::System.Action? completionHandler)
		{
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_Double_NativeHandle (class_ptr, Selector.GetHandle ("showBannerWithTitle:message:duration:completionHandler:"), nstitle, nsmessage, durationSeconds, (IntPtr) block_ptr_completionHandler);
			CFString.ReleaseNative (nstitle);
			CFString.ReleaseNative (nsmessage);
		}
