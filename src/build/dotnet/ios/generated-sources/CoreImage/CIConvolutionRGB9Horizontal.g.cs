...
namespace CoreImage {
	...
	public partial class CIConvolutionRGB9Horizontal : CIFilter, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIConvolutionRGB9Horizontal" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIConvolutionRGB9Horizontal (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIConvolutionRGB9Horizontal (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIConvolutionRGB9Horizontal (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
