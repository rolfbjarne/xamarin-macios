...
namespace AppKit {
	...
	/// <summary>This interface represents the Objective-C protocol <c>NSMenuItemValidation</c>.</summary>
	/// <remarks>
	...
	public partial interface INSMenuItemValidation : INativeObject, IDisposable
	{
		...
		/// <param name="menuItem">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static bool _ValidateMenuItem (INSMenuItemValidation This, NSMenuItem menuItem)
		{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSMenuItemValidationWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static INSMenuItemValidation ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class NSMenuItemValidationWrapper : BaseWrapper, INSMenuItemValidation {
		public NSMenuItemValidationWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSMenuItemValidationWrapper))]
		static NSMenuItemValidationWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <param name="menuItem">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
