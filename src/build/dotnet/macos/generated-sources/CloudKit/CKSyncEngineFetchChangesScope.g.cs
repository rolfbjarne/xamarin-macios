...
namespace CloudKit {
	...
	public unsafe partial class CKSyncEngineFetchChangesScope : NSObject, INSCopying {
		...
		const string selContainsZoneID_X = "containsZoneID:";
		static readonly NativeHandle selContainsZoneID_XHandle = Selector.GetHandle ("containsZoneID:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual bool Contains (CKRecordZoneID zoneId)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (this.Handle, selContainsZoneID_XHandle, zoneId__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, selContainsZoneID_XHandle, zoneId__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (zoneId);
		...
		internal virtual NativeHandle _InitWithExcludedZoneIds (NSSet<CKRecordZoneID> zoneIds)
		{
			...
			NativeHandle ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithExcludedZoneIDs_XHandle, zoneIds__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithExcludedZoneIDs_XHandle, zoneIds__handle__);
					GC.KeepAlive (this);
				}
			}
