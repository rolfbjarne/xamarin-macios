...
namespace Accounts {
	...
	public unsafe partial class ACAccountStore : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RenewCredentials (ACAccount account, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V23))]global::System.Action<ACAccountCredentialRenewResult, NSError> completionHandler)
		{
			var account__handle__ = account!.GetNonNullHandle (nameof (account));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
