...
namespace MetalPerformanceShadersGraph {
	...
	public unsafe static partial class MPSGraph_MPSGraphMatrixInverseOps  {
		...
		const string selInverseOfTensor_Name_X = "inverseOfTensor:name:";
		static readonly NativeHandle selInverseOfTensor_Name_XHandle = Selector.GetHandle ("inverseOfTensor:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static MPSGraphTensor Inverse (this MPSGraph This, MPSGraphTensor inputTensor, string? name)
		{
			...
			MPSGraphTensor? ret;
			ret =  Runtime.GetNSObject<MPSGraphTensor> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (This.Handle, selInverseOfTensor_Name_XHandle, inputTensor__handle__, nsname), false)!;
			GC.KeepAlive (This);
