...
namespace MonoTouchFixtures.CoreGraphics {
	...
	public class CGEventTests {
		...
		public void CreateTap ()
		{
			...
			ClassicAssert.IsFalse (tapCalled, "tap was mistakenly called.");
		}
		...
		public void Constructor_CGEventSourceStateID_0 ()
		{
			...
			ClassicAssert.AreEqual ("At least one wheel must be provided", ex.Message, "Message");
		}
		...
		public void Constructor_CGEventSourceStateID_1 ()
		{
			...
			ClassicAssert.AreEqual (CGEventType.ScrollWheel, evt.EventType, "EventType");
			ClassicAssert.AreEqual (0, evt.Timestamp, "Timestamp");
		...
		public void Constructor_CGEventSourceStateID_4 ()
		{
			...
			ClassicAssert.AreEqual ("Only one to three wheels are supported on this constructor", ex.Message, "Message");
		}
		...
		{
			var pid = Process.GetCurrentProcess ().Id;
			ClassicAssert.AreEqual (0, GetProcessForPID (pid, out var psn), "GetProcessForPID");
			using var evt = new CGEvent (null, (ushort) 1, true);
			unsafe {
				IntPtr* psnPtr = &psn;
		...
		public void ToData ()
		{
			...
			ClassicAssert.NotNull (data, "data");
