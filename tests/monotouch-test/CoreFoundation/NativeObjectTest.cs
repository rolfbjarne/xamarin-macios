	...
	public class NativeObjectTest {
		...
		public void Equals ()
		{
			...
			using (var x = new FakeNativeObject ((IntPtr) 42, true)) {
				ClassicAssert.False (x.Equals (x), "self");
				ClassicAssert.True (x.Equals (null), "null");
			}
			...
			using (var n2 = new NativeObjectPoker ((IntPtr) 42))
				ClassicAssert.True (n1.Equals (n2), "1");
		}
		...
		public void GetHashCodeValue ()
		{
			...
			using (var n = new NativeObjectPoker ((IntPtr) 42)) {
				ClassicAssert.AreNotEqual (n.GetHashCode (), RuntimeHelpers.GetHashCode (n), "GetHashCode-old");
				ClassicAssert.AreEqual (n.GetHashCode (), n.Handle.GetHashCode (), "GetHashCode-net");
			}
		}
	}
}
