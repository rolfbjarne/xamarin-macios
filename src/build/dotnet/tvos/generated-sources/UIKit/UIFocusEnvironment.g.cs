...
namespace UIKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "GetSoundIdentifier", Selector = "soundIdentifierForFocusUpdateInContext:", ReturnType = typeof (NSString), ParameterType = new Type [] { typeof (UIFocusUpdateContext) }, ParameterByRef = new bool [] { false })]
	...
	public partial interface IUIFocusEnvironment : INativeObject, IDisposable
	{
		...
		{
			return _GetSoundIdentifier (this, context);
		}
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[UnsupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static NSString? _GetSoundIdentifier (IUIFocusEnvironment This, UIFocusUpdateContext context)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var context__handle__ = context!.GetNonNullHandle (nameof (context));
			NSString? ret;
		...
		[DynamicDependencyAttribute ("GetSoundIdentifier(UIKit.UIFocusUpdateContext)")]
	...
	public unsafe static partial class UIFocusEnvironment_Extensions {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static NSString? GetSoundIdentifier (this IUIFocusEnvironment This, UIFocusUpdateContext context)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var context__handle__ = context!.GetNonNullHandle (nameof (context));
			NSString? ret;
