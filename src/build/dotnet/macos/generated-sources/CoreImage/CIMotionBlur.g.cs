...
namespace CoreImage {
	...
	public partial class CIMotionBlur : CILinearBlur, ICIMotionBlurProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIMotionBlur" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIMotionBlur () : base ("CIMotionBlur")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMotionBlur (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMotionBlur (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMotionBlur (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIMotionBlurProtocol protocol members 
