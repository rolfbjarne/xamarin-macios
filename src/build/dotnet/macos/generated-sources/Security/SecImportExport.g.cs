...
namespace Security {
	public unsafe partial class SecImportExport  {
		...
		static NSString? _Access;
		/// <summary>Represents the value associated with the constant 'kSecImportExportAccess'.</summary>
		[Field ("kSecImportExportAccess",  "Security")]
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		public static NSString Access {
			[UnsupportedOSPlatform ("ios")]
			[UnsupportedOSPlatform ("tvos")]
			[UnsupportedOSPlatform ("maccatalyst")]
			[SupportedOSPlatform ("macos")]
			get {
				if (_Access is null)
					_Access = Dlfcn.GetStringConstant (Libraries.Security.Handle, "kSecImportExportAccess")!;
				return _Access;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _Keychain;
		/// <summary>Represents the value associated with the constant 'kSecImportExportKeychain'.</summary>
		[Field ("kSecImportExportKeychain",  "Security")]
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		public static NSString Keychain {
			[UnsupportedOSPlatform ("ios")]
			[UnsupportedOSPlatform ("tvos")]
			[UnsupportedOSPlatform ("maccatalyst")]
			[SupportedOSPlatform ("macos")]
			get {
				if (_Keychain is null)
					_Keychain = Dlfcn.GetStringConstant (Libraries.Security.Handle, "kSecImportExportKeychain")!;
				return _Keychain;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
