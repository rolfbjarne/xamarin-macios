...
namespace CoreImage {
	...
	public partial class CIKMeans : CIReductionFilter, ICIKMeansProtocol, ICIAreaReductionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIKMeans" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIKMeans () : base ("CIKMeans")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIKMeans (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIKMeans (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIKMeans (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		public float InputPasses {
			[Export ("passes")]
			get {
				return GetFloat ("inputPasses");
			}
			[Export ("setPasses:")]
			set {
				SetFloat ("inputPasses", value);
			}
		}
		[SupportedOSPlatform ("ios14.0")]
		[SupportedOSPlatform ("macos")]
