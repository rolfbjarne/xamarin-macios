...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSMatrixFullyConnectedGradient : MPSMatrixBinaryKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeGradientForDataToCommandBuffer_GradientMatrix_WeightMatrix_ResultGradientForDataMatrix_X = "encodeGradientForDataToCommandBuffer:gradientMatrix:weightMatrix:resultGradientForDataMatrix:";
		static readonly NativeHandle selEncodeGradientForDataToCommandBuffer_GradientMatrix_WeightMatrix_ResultGradientForDataMatrix_XHandle = Selector.GetHandle ("encodeGradientForDataToCommandBuffer:gradientMatrix:weightMatrix:resultGradientForDataMatrix:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeGradientForWeightsAndBiasToCommandBuffer_GradientMatrix_InputMatrix_ResultGradientForWeightMatrix_ResultGradientForBiasVector_X = "encodeGradientForWeightsAndBiasToCommandBuffer:gradientMatrix:inputMatrix:resultGradientForWeightMatrix:resultGradientForBiasVector:";
		static readonly NativeHandle selEncodeGradientForWeightsAndBiasToCommandBuffer_GradientMatrix_InputMatrix_ResultGradientForWeightMatrix_ResultGradientForBiasVector_XHandle = Selector.GetHandle ("encodeGradientForWeightsAndBiasToCommandBuffer:gradientMatrix:inputMatrix:resultGradientForWeightMatrix:resultGradientForBiasVector:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetSourceOutputFeatureChannels_X = "setSourceOutputFeatureChannels:";
		static readonly NativeHandle selSetSourceOutputFeatureChannels_XHandle = Selector.GetHandle ("setSourceOutputFeatureChannels:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSourceOutputFeatureChannelsX = "sourceOutputFeatureChannels";
		static readonly NativeHandle selSourceOutputFeatureChannelsXHandle = Selector.GetHandle ("sourceOutputFeatureChannels");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSMatrixFullyConnectedGradient");
		...
		public MPSMatrixFullyConnectedGradient (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected MPSMatrixFullyConnectedGradient (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSMatrixFullyConnectedGradient (NativeHandle handle) : base (handle)
		{
		}
		...
		[DesignatedInitializer]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSMatrixFullyConnectedGradient (global::Metal.IMTLDevice device)
		...
		[DesignatedInitializer]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSMatrixFullyConnectedGradient (NSCoder aDecoder, global::Metal.IMTLDevice device)
			: base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual MPSMatrixFullyConnectedGradient Copy (NSZone? zone, global::Metal.IMTLDevice? device)
		{
			var zone__handle__ = zone.GetHandle ();
			var device__handle__ = device.GetHandle ();
			MPSMatrixFullyConnectedGradient? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<MPSMatrixFullyConnectedGradient> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selCopyWithZone_Device_XHandle, zone__handle__, device__handle__), true)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<MPSMatrixFullyConnectedGradient> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selCopyWithZone_Device_XHandle, zone__handle__, device__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (zone);
		...
		/// <param name="commandBuffer">To be added.</param><param name="gradientMatrix">To be added.</param><param name="weightMatrix">To be added.</param><param name="resultGradientForDataMatrix">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[Export ("encodeGradientForDataToCommandBuffer:gradientMatrix:weightMatrix:resultGradientForDataMatrix:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void EncodeGradientForData (global::Metal.IMTLCommandBuffer commandBuffer, MPSMatrix gradientMatrix, MPSMatrix weightMatrix, MPSMatrix resultGradientForDataMatrix)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeGradientForDataToCommandBuffer_GradientMatrix_WeightMatrix_ResultGradientForDataMatrix_XHandle, commandBuffer__handle__, gradientMatrix__handle__, weightMatrix__handle__, resultGradientForDataMatrix__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeGradientForDataToCommandBuffer_GradientMatrix_WeightMatrix_ResultGradientForDataMatrix_XHandle, commandBuffer__handle__, gradientMatrix__handle__, weightMatrix__handle__, resultGradientForDataMatrix__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		/// <param name="commandBuffer">To be added.</param><param name="gradientMatrix">To be added.</param><param name="inputMatrix">To be added.</param><param name="resultGradientForWeightMatrix">To be added.</param><param name="resultGradientForBiasVector">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void EncodeGradientForWeightsAndBias (global::Metal.IMTLCommandBuffer commandBuffer, MPSMatrix gradientMatrix, MPSMatrix inputMatrix, MPSMatrix resultGradientForWeightMatrix, MPSVector? resultGradientForBiasVector)
		{
			var commandBuffer__handle__ = commandBuffer!.GetNonNullHandle (nameof (commandBuffer));
			var gradientMatrix__handle__ = gradientMatrix!.GetNonNullHandle (nameof (gradientMatrix));
			var inputMatrix__handle__ = inputMatrix!.GetNonNullHandle (nameof (inputMatrix));
			var resultGradientForWeightMatrix__handle__ = resultGradientForWeightMatrix!.GetNonNullHandle (nameof (resultGradientForWeightMatrix));
			var resultGradientForBiasVector__handle__ = resultGradientForBiasVector.GetHandle ();
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeGradientForWeightsAndBiasToCommandBuffer_GradientMatrix_InputMatrix_ResultGradientForWeightMatrix_ResultGradientForBiasVector_XHandle, commandBuffer__handle__, gradientMatrix__handle__, inputMatrix__handle__, resultGradientForWeightMatrix__handle__, resultGradientForBiasVector__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeGradientForWeightsAndBiasToCommandBuffer_GradientMatrix_InputMatrix_ResultGradientForWeightMatrix_ResultGradientForBiasVector_XHandle, commandBuffer__handle__, gradientMatrix__handle__, inputMatrix__handle__, resultGradientForWeightMatrix__handle__, resultGradientForBiasVector__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
			...
			GC.KeepAlive (resultGradientForWeightMatrix);
			GC.KeepAlive (resultGradientForBiasVector);
		}
		...
		public virtual nuint SourceOutputFeatureChannels {
			...
			get {
				nuint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selSourceOutputFeatureChannelsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selSourceOutputFeatureChannelsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_UIntPtr (this.Handle, selSetSourceOutputFeatureChannels_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_UIntPtr (&__objc_super__, selSetSourceOutputFeatureChannels_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
