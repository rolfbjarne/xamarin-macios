...
namespace CoreSpotlight {
	[Register("CSImportExtension", true)]
	[UnsupportedOSPlatform ("tvos")]
	[SupportedOSPlatform ("ios15.0")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
	public unsafe partial class CSImportExtension : NSObject, INSExtensionRequestHandling {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selUpdateAttributes_ForFileAtURL_Error_X = "updateAttributes:forFileAtURL:error:";
		static readonly NativeHandle selUpdateAttributes_ForFileAtURL_Error_XHandle = Selector.GetHandle ("updateAttributes:forFileAtURL:error:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("CSImportExtension");
		...
		/// <summary>Creates a new <see cref="CSImportExtension" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		protected CSImportExtension () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected CSImportExtension (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CSImportExtension (NativeHandle handle) : base (handle)
		{
		}
		...
		public unsafe virtual bool Update (CSSearchableItemAttributeSet attributes, NSUrl contentUrl, out NSError? error)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (this.Handle, selUpdateAttributes_ForFileAtURL_Error_XHandle, attributes__handle__, contentUrl__handle__, &errorValue);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle_NativeHandle_ref_NativeHandle (&__objc_super__, selUpdateAttributes_ForFileAtURL_Error_XHandle, attributes__handle__, contentUrl__handle__, &errorValue);
					GC.KeepAlive (this);
				}
			}
