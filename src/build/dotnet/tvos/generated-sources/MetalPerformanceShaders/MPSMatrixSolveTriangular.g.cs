...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSMatrixSolveTriangular : MPSMatrixBinaryKernel {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSMatrixSolveTriangular");
		...
		public MPSMatrixSolveTriangular (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected MPSMatrixSolveTriangular (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSMatrixSolveTriangular (NativeHandle handle) : base (handle)
		{
		}

		/// <param name="device">To be added.</param><param name="right">To be added.</param><param name="upper">To be added.</param><param name="transpose">To be added.</param><param name="unit">To be added.</param><param name="order">To be added.</param><param name="numberOfRightHandSides">To be added.</param><param name="alpha">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[Export ("initWithDevice:right:upper:transpose:unit:order:numberOfRightHandSides:alpha:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSMatrixSolveTriangular (global::Metal.IMTLDevice device, bool right, bool upper, bool transpose, bool unit, nuint order, nuint numberOfRightHandSides, double alpha)
			: base (NSObjectFlag.Empty)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_bool_bool_bool_bool_UIntPtr_UIntPtr_Double (this.Handle, Selector.GetHandle ("initWithDevice:right:upper:transpose:unit:order:numberOfRightHandSides:alpha:"), device__handle__, right ? (byte) 1 : (byte) 0, upper ? (byte) 1 : (byte) 0, transpose ? (byte) 1 : (byte) 0, unit ? (byte) 1 : (byte) 0, order, numberOfRightHandSides, alpha), "initWithDevice:right:upper:transpose:unit:order:numberOfRightHandSides:alpha:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_bool_bool_bool_bool_UIntPtr_UIntPtr_Double (&__objc_super__, Selector.GetHandle ("initWithDevice:right:upper:transpose:unit:order:numberOfRightHandSides:alpha:"), device__handle__, right ? (byte) 1 : (byte) 0, upper ? (byte) 1 : (byte) 0, transpose ? (byte) 1 : (byte) 0, unit ? (byte) 1 : (byte) 0, order, numberOfRightHandSides, alpha), "initWithDevice:right:upper:transpose:unit:order:numberOfRightHandSides:alpha:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		[DesignatedInitializer]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSMatrixSolveTriangular (global::Metal.IMTLDevice device)
			: base (NSObjectFlag.Empty)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
			if (IsDirectBinding) {
		...
		[DesignatedInitializer]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MPSMatrixSolveTriangular (NSCoder aDecoder, global::Metal.IMTLDevice device)
			: base (NSObjectFlag.Empty)
		{
