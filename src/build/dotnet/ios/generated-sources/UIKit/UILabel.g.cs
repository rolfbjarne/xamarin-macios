...
namespace UIKit {
	...
	public unsafe partial class UILabel : UIView, IUIContentSizeCategoryAdjusting, IUILetterformAwareAdjusting {
		...
		[ObsoletedOSPlatform ("ios7.0", "Use 'NSKernAttributeName' instead.")]
		[SupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'NSKernAttributeName' instead.")]
		[SupportedOSPlatform ("ios")]
		public virtual bool AdjustsLetterSpacingToFitWidth {
			...
			get {
				...
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("adjustsLetterSpacingToFitWidth"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("adjustsLetterSpacingToFitWidth"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
			}
			[Export ("setAdjustsLetterSpacingToFitWidth:")]
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_bool (this.Handle, Selector.GetHandle ("setAdjustsLetterSpacingToFitWidth:"), value ? (byte) 1 : (byte) 0);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, Selector.GetHandle ("setAdjustsLetterSpacingToFitWidth:"), value ? (byte) 1 : (byte) 0);
						GC.KeepAlive (this);
					}
				}
			}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[UnsupportedOSPlatform ("tvos")]
		[ObsoletedOSPlatform ("ios6.0", "Use 'MinimumScaleFactor' instead.")]
		[SupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'MinimumScaleFactor' instead.")]
		[SupportedOSPlatform ("ios")]
