	...
	public class GKStateTests {
		...
		public void Concrete ()
		{
			...
			using (var s2 = new InvalidState ()) {
				ClassicAssert.True (s2.IsValidNextState (s2), "self");
				ClassicAssert.True (s2.IsValidNextState (s1), "different");
			}
		}
	}
