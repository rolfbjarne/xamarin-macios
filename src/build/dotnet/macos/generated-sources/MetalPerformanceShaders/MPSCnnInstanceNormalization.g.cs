...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSCnnInstanceNormalization : MPSCnnKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithDevice_DataSource_X = "initWithDevice:dataSource:";
		static readonly NativeHandle selInitWithDevice_DataSource_XHandle = Selector.GetHandle ("initWithDevice:dataSource:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selReloadDataSource_X = "reloadDataSource:";
		static readonly NativeHandle selReloadDataSource_XHandle = Selector.GetHandle ("reloadDataSource:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selReloadGammaAndBetaFromDataSourceX = "reloadGammaAndBetaFromDataSource";
		static readonly NativeHandle selReloadGammaAndBetaFromDataSourceXHandle = Selector.GetHandle ("reloadGammaAndBetaFromDataSource");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selReloadGammaAndBetaWithCommandBuffer_GammaAndBetaState_X = "reloadGammaAndBetaWithCommandBuffer:gammaAndBetaState:";
		static readonly NativeHandle selReloadGammaAndBetaWithCommandBuffer_GammaAndBetaState_XHandle = Selector.GetHandle ("reloadGammaAndBetaWithCommandBuffer:gammaAndBetaState:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selInitWithDevice_DataSource_XHandle, device__handle__, dataSource__handle__), "initWithDevice:dataSource:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selInitWithDevice_DataSource_XHandle, device__handle__, dataSource__handle__), "initWithDevice:dataSource:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual MPSCnnInstanceNormalizationGradientState? GetResultState (MPSImage sourceImage, NSArray<MPSState>? sourceStates, MPSImage destinationImage)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<MPSCnnInstanceNormalizationGradientState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selResultStateForSourceImage_SourceStates_DestinationImage_XHandle, sourceImage__handle__, sourceStates__handle__, destinationImage__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual MPSCnnInstanceNormalizationGradientState? GetTemporaryResultState (global::Metal.IMTLCommandBuffer commandBuffer, MPSImage sourceImage, NSArray<MPSState>? sourceStates, MPSImage destinationImage)
		{
			...
			MPSCnnInstanceNormalizationGradientState? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<MPSCnnInstanceNormalizationGradientState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selTemporaryResultStateForCommandBuffer_SourceImage_SourceStates_DestinationImage_XHandle, commandBuffer__handle__, sourceImage__handle__, sourceStates__handle__, destinationImage__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
		...
		public virtual void ReloadDataSource (IMPSCnnInstanceNormalizationDataSource dataSource)
		{
			var dataSource__handle__ = dataSource!.GetNonNullHandle (nameof (dataSource));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selReloadDataSource_XHandle, dataSource__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selReloadDataSource_XHandle, dataSource__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (dataSource);
		...
		public virtual void ReloadGammaAndBeta (global::Metal.IMTLCommandBuffer commandBuffer, MPSCnnNormalizationGammaAndBetaState gammaAndBetaState)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selReloadGammaAndBetaWithCommandBuffer_GammaAndBetaState_XHandle, commandBuffer__handle__, gammaAndBetaState__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selReloadGammaAndBetaWithCommandBuffer_GammaAndBetaState_XHandle, commandBuffer__handle__, gammaAndBetaState__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend (this.Handle, selReloadGammaAndBetaFromDataSourceXHandle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, selReloadGammaAndBetaFromDataSourceXHandle);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual IMPSCnnInstanceNormalizationDataSource DataSource {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetINativeObject<IMPSCnnInstanceNormalizationDataSource> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selDataSourceXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetINativeObject<IMPSCnnInstanceNormalizationDataSource> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selDataSourceXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
