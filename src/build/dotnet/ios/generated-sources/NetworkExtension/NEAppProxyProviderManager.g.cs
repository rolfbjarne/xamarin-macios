...
namespace NetworkExtension {
	/// <summary>Configures and controls network tunnels received from an App Proxy Provider extension.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/NetworkExtension/Reference/NEAppProxyProviderManagerClassRef/index.html">Apple documentation for <c>NEAppProxyProviderManager</c></related>
	[Register("NEAppProxyProviderManager", true)]
	[UnsupportedOSPlatform ("tvos")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	public unsafe partial class NEAppProxyProviderManager : NETunnelProviderManager {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NEAppProxyProviderManager");
		...
		protected NEAppProxyProviderManager (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NEAppProxyProviderManager (NativeHandle handle) : base (handle)
		{
		}

		/// <param name="completionHandler">To be added.</param><summary>Loads all proxy configurations for the app that were previously saved in the Network Extensions prefrences and runs <paramref name="completionHandler" /> when the operation is complete.</summary><remarks>To be added.</remarks>
		[Export ("loadAllFromPreferencesWithCompletionHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void LoadAllFromPreferences ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V138))]global::System.Action<NSArray, NSError> completionHandler)
		{
