...
namespace AppKit {
	...
	/// <summary>A delegate object that exposes events for <see cref="T:AppKit.NSLayoutManager" />s.</summary><related type="externalDocumentation" href="https://developer.apple.com/documentation/uikit/nslayoutmanagerdelegate">Apple documentation for <c>NSLayoutManagerDelegate</c></related>
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ShouldUseTemporaryAttributes", Selector = "layoutManager:shouldUseTemporaryAttributes:forDrawingToScreen:atCharacterIndex:effectiveRange:", ReturnType = typeof (global::Foundation.NSDictionary<NSString, NSObject>), ParameterType = new Type [] { typeof (NSLayoutManager), typeof (global::Foundation.NSDictionary<NSString, NSObject>), typeof (bool), typeof (UIntPtr), typeof (NSRange) }, ParameterByRef = new bool [] { false, false, false, false, true })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ShouldGenerateGlyphs", Selector = "layoutManager:shouldGenerateGlyphs:properties:characterIndexes:font:forGlyphRange:", ReturnType = typeof (UIntPtr), ParameterType = new Type [] { typeof (NSLayoutManager), typeof (IntPtr), typeof (IntPtr), typeof (IntPtr), typeof (NSFont), typeof (NSRange) }, ParameterByRef = new bool [] { false, false, false, false, false, false })]
	...
	public partial interface INSLayoutManagerDelegate : INativeObject, IDisposable
	{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual NSDictionary<NSString, NSObject>? ShouldUseTemporaryAttributes (NSLayoutManager layoutManager, NSDictionary<NSString, NSObject> temporaryAttributes, bool drawingToScreen, nuint characterIndex, ref NSRange effectiveCharacterRange)
		{
			return _ShouldUseTemporaryAttributes (this, layoutManager, temporaryAttributes, drawingToScreen, characterIndex, ref effectiveCharacterRange);
		}
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static NSDictionary<NSString, NSObject>? _ShouldUseTemporaryAttributes (INSLayoutManagerDelegate This, NSLayoutManager layoutManager, NSDictionary<NSString, NSObject> temporaryAttributes, bool drawingToScreen, nuint characterIndex, ref NSRange effectiveCharacterRange)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			var layoutManager__handle__ = layoutManager!.GetNonNullHandle (nameof (layoutManager));
			var temporaryAttributes__handle__ = temporaryAttributes!.GetNonNullHandle (nameof (temporaryAttributes));
			fixed (NSRange* effectiveCharacterRange__pointer = &effectiveCharacterRange) {
			NSDictionary<NSString, NSObject>? ret;
			ret =  Runtime.GetNSObject<NSDictionary<NSString, NSObject>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_bool_UIntPtr_ref_NSRange (This.Handle, Selector.GetHandle ("layoutManager:shouldUseTemporaryAttributes:forDrawingToScreen:atCharacterIndex:effectiveRange:"), layoutManager__handle__, temporaryAttributes__handle__, drawingToScreen ? (byte) 1 : (byte) 0, characterIndex, effectiveCharacterRange__pointer), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (layoutManager);
			GC.KeepAlive (temporaryAttributes);
			return ret!;
			}
		}
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual nuint ShouldGenerateGlyphs (NSLayoutManager layoutManager, nint glyphBuffer, nint properties, nint characterIndexes, NSFont font, NSRange glyphRange)
		{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static nuint _ShouldGenerateGlyphs (INSLayoutManagerDelegate This, NSLayoutManager layoutManager, nint glyphBuffer, nint properties, nint characterIndexes, NSFont font, NSRange glyphRange)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			var layoutManager__handle__ = layoutManager!.GetNonNullHandle (nameof (layoutManager));
		...
		[DynamicDependencyAttribute ("DidChangeGeometry(AppKit.NSLayoutManager,AppKit.NSTextContainer,CoreGraphics.CGSize)")]
		[DynamicDependencyAttribute ("DidCompleteLayout(AppKit.NSLayoutManager,AppKit.NSTextContainer,System.Boolean)")]
		[DynamicDependencyAttribute ("DidInvalidatedLayout(AppKit.NSLayoutManager)")]
		[DynamicDependencyAttribute ("GetBoundingBox(AppKit.NSLayoutManager,System.UIntPtr,AppKit.NSTextContainer,CoreGraphics.CGRect,CoreGraphics.CGPoint,System.UIntPtr)")]
		[DynamicDependencyAttribute ("GetLineSpacingAfterGlyph(AppKit.NSLayoutManager,System.UIntPtr,CoreGraphics.CGRect)")]
		[DynamicDependencyAttribute ("GetParagraphSpacingAfterGlyph(AppKit.NSLayoutManager,System.UIntPtr,CoreGraphics.CGRect)")]
		[DynamicDependencyAttribute ("GetParagraphSpacingBeforeGlyph(AppKit.NSLayoutManager,System.UIntPtr,CoreGraphics.CGRect)")]
		[DynamicDependencyAttribute ("ShouldBreakLineByHyphenatingBeforeCharacter(AppKit.NSLayoutManager,System.UIntPtr)")]
		[DynamicDependencyAttribute ("ShouldBreakLineByWordBeforeCharacter(AppKit.NSLayoutManager,System.UIntPtr)")]
		[DynamicDependencyAttribute ("ShouldGenerateGlyphs(AppKit.NSLayoutManager,System.IntPtr,System.IntPtr,System.IntPtr,AppKit.NSFont,Foundation.NSRange)")]
		[DynamicDependencyAttribute ("ShouldSetLineFragmentRect(AppKit.NSLayoutManager,CoreGraphics.CGRect@,CoreGraphics.CGRect@,System.Runtime.InteropServices.NFloat@,AppKit.NSTextContainer,Foundation.NSRange)")]
		[DynamicDependencyAttribute ("ShouldUseAction(AppKit.NSLayoutManager,AppKit.NSControlCharacterAction,System.UIntPtr)")]
		[DynamicDependencyAttribute ("ShouldUseTemporaryAttributes(AppKit.NSLayoutManager,Foundation.NSDictionary{Foundation.NSString,Foundation.NSObject},System.Boolean,System.UIntPtr,Foundation.NSRange@)")]
	...
	public unsafe static partial class NSLayoutManagerDelegate_Extensions {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static NSDictionary<NSString, NSObject>? ShouldUseTemporaryAttributes (this INSLayoutManagerDelegate This, NSLayoutManager layoutManager, NSDictionary<NSString, NSObject> temporaryAttributes, bool drawingToScreen, nuint characterIndex, ref NSRange effectiveCharacterRange)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			var layoutManager__handle__ = layoutManager!.GetNonNullHandle (nameof (layoutManager));
			var temporaryAttributes__handle__ = temporaryAttributes!.GetNonNullHandle (nameof (temporaryAttributes));
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static nuint ShouldGenerateGlyphs (this INSLayoutManagerDelegate This, NSLayoutManager layoutManager, nint glyphBuffer, nint properties, nint characterIndexes, NSFont font, NSRange glyphRange)
		{
			global::AppKit.NSApplication.EnsureUIThread ();
			var layoutManager__handle__ = layoutManager!.GetNonNullHandle (nameof (layoutManager));
			var font__handle__ = font!.GetNonNullHandle (nameof (font));
...
namespace AppKit {
	/// <summary>A delegate object that exposes events for <see cref="T:AppKit.NSLayoutManager" />s.</summary><related type="externalDocumentation" href="https://developer.apple.com/documentation/uikit/nslayoutmanagerdelegate">Apple documentation for <c>NSLayoutManagerDelegate</c></related>
	[Protocol()]
	[Register("Microsoft_macOS__AppKit_NSLayoutManagerDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos")]
