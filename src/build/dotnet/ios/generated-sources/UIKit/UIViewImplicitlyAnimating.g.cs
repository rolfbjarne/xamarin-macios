...
namespace UIKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AddCompletion", Selector = "addCompletion:", ParameterType = new Type [] { typeof (global::System.Action<global::UIKit.UIViewAnimatingPosition>) }, ParameterByRef = new bool [] { false }, ParameterBlockProxy = new Type? [] { typeof (ObjCRuntime.Trampolines.NIDActionArity1V260) })]
		...
		UIKit.IUIViewAnimating
	{
		...
		/// <param name="completion">To be added.</param><summary>Adds the <paramref name="completion" /> to run when the animation(s) end.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _AddCompletion (IUIViewImplicitlyAnimating This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V260))]global::System.Action<UIViewAnimatingPosition> completion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
	...
	public unsafe static partial class UIViewImplicitlyAnimating_Extensions {
		...
		/// <param name="completion">To be added.</param><summary>Adds the <paramref name="completion" /> to run when the animation(s) end.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void AddCompletion (this IUIViewImplicitlyAnimating This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V260))]global::System.Action<UIViewAnimatingPosition> completion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
