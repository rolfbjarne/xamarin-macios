...
#nullable enable
namespace FSKit {
	[Register("FSGenericURLResource", true)]
	[SupportedOSPlatform ("macos26.0")]
	[Experimental ("APL0002")]
	public unsafe partial class FSGenericUrlResource : FSResource {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("FSGenericURLResource");
		...
		protected FSGenericUrlResource (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal FSGenericUrlResource (NativeHandle handle) : base (handle)
		{
		}

		[Export ("initWithURL:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public FSGenericUrlResource (NSUrl url)
