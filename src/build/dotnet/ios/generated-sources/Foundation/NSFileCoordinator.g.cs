...
namespace Foundation {
	...
	public unsafe partial class NSFileCoordinator : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CoordinateAccess (NSFileAccessIntent[] intents, NSOperationQueue executionQueue, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError> accessor)
		{
			if (intents is null)
			...
			using var block_accessor = Trampolines.SDActionArity1V0.CreateBlock (accessor);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CoordinateRead (NSUrl itemUrl, NSFileCoordinatorReadingOptions options, out NSError error, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V61))]global::System.Action<NSUrl> worker)
		{
			...
			NativeHandle errorValue = IntPtr.Zero;
			using var block_worker = Trampolines.SDActionArity1V61.CreateBlock (worker);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CoordinateWrite (NSUrl url, NSFileCoordinatorWritingOptions options, out NSError error, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V61))]global::System.Action<NSUrl> worker)
		{
		...
		public virtual void ItemUbiquityAttributesChanged (NSUrl url, NSSet<NSString> attributes)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("itemAtURL:didChangeUbiquityAttributes:"), url__handle__, attributes__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("itemAtURL:didChangeUbiquityAttributes:"), url__handle__, attributes__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (url);
