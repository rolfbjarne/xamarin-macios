	...
	public class PopoverControllerTest {
		...
		public void Defaults ()
		{
			...
			using (var pc = new UIPopoverController (vc)) {
				...
				ClassicAssert.Null (pc.PassthroughViews, "PassthroughViews");
				...
				ClassicAssert.False (pc.PopoverVisible, "PopoverVisible");
				ClassicAssert.Null (pc.ShouldDismiss, "ShouldDismiss");
			}
		}
		...
		public void PopoverBackgroundViewType ()
		{
			...
			using (var vc = new UIViewController ())
			using (var pc = new UIPopoverController (vc)) {
				ClassicAssert.Null (pc.PopoverBackgroundViewType, "PopoverBackgroundViewType");
