...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIDistortionFilter" /> that creates a tight spiraling distortion suggestive of a vortex.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage heron = CIImage.FromCGImage (UIImage.FromFile ("heron.jpg").CGImage);
	/// 
	/// // Create a CIVortexDistortion filter with the input image
	/// var vortex_distortion = new CIVortexDistortion () {
	/// 	Image = heron
	/// };
	/// 
	/// // Get the altered image from the filter
	/// var output = vortex_distortion.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/vortex_distortion.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIVortexDistortion : CIDistortionFilter, ICIVortexDistortionProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIVortexDistortion" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIVortexDistortion (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIVortexDistortion (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIVortexDistortion (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIVortexDistortionProtocol protocol members 
