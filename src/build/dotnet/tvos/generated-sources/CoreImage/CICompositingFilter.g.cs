...
namespace CoreImage {
	...
	public abstract partial class CICompositingFilter : CIFilter {
		...
		protected CICompositingFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CICompositingFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CICompositingFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CICompositingFilter" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected  CICompositingFilter (string name) : base (CreateFilter (name))
		{
		}
		...
		/// <summary>The background image to use.</summary><value></value><remarks>This is the background image used by the filter.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
