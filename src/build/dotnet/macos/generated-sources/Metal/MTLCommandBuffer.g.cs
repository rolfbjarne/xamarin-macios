...
namespace Metal {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "AddScheduledHandler", Selector = "addScheduledHandler:", ParameterType = new Type [] { typeof (global::System.Action<global::Metal.IMTLCommandBuffer>) }, ParameterByRef = new bool [] { false }, ParameterBlockProxy = new Type? [] { typeof (ObjCRuntime.Trampolines.NIDActionArity1V83) })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "WaitUntilScheduled", Selector = "waitUntilScheduled")]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "AddCompletedHandler", Selector = "addCompletedHandler:", ParameterType = new Type [] { typeof (global::System.Action<global::Metal.IMTLCommandBuffer>) }, ParameterByRef = new bool [] { false }, ParameterBlockProxy = new Type? [] { typeof (ObjCRuntime.Trampolines.NIDActionArity1V83) })]
	...
	public partial interface IMTLCommandBuffer : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void AddScheduledHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V83))]global::System.Action<IMTLCommandBuffer> block)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="block">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _AddScheduledHandler (IMTLCommandBuffer This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V83))]global::System.Action<IMTLCommandBuffer> block)
		{
			if (block is null)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void AddCompletedHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V83))]global::System.Action<IMTLCommandBuffer> block)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="block">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _AddCompletedHandler (IMTLCommandBuffer This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V83))]global::System.Action<IMTLCommandBuffer> block)
		{
			if (block is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (block));
			using var block_block = Trampolines.SDActionArity1V83.CreateBlock (block);
	...
	internal unsafe sealed class MTLCommandBufferWrapper : BaseWrapper, IMTLCommandBuffer {
		...
		[Export ("addScheduledHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void AddScheduledHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V83))]global::System.Action<IMTLCommandBuffer> block)
		{
			if (block is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (block));
			using var block_block = Trampolines.SDActionArity1V83.CreateBlock (block);
		...
		[Export ("addCompletedHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void AddCompletedHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V83))]global::System.Action<IMTLCommandBuffer> block)
		{
			if (block is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (block));
			using var block_block = Trampolines.SDActionArity1V83.CreateBlock (block);
