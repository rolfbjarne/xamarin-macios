...
namespace OSLog {
	...
	public unsafe partial class OSLogEntryActivity : OSLogEntry, IOSLogEntryFromProcess {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selParentActivityIdentifierX = "parentActivityIdentifier";
		static readonly NativeHandle selParentActivityIdentifierXHandle = Selector.GetHandle ("parentActivityIdentifier");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual ulong ParentActivityIdentifier {
			...
			get {
				ulong ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UInt64_objc_msgSend (this.Handle, selParentActivityIdentifierXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UInt64_objc_msgSendSuper (&__objc_super__, selParentActivityIdentifierXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
