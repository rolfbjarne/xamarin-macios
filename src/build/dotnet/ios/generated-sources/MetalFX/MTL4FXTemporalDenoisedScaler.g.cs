...
namespace MetalFX {
	...
	/// <summary>This interface represents the Objective-C protocol <c>MTL4FXTemporalDenoisedScaler</c>.</summary>
	/// <remarks>
	...
	[Protocol (Name = "MTL4FXTemporalDenoisedScaler", WrapperType = typeof (MTL4FXTemporalDenoisedScalerWrapper), BackwardsCompatibleCodeGeneration = false)]
	...
	public partial interface IMTL4FXTemporalDenoisedScaler : INativeObject, IDisposable, 
		MetalFX.IMTLFXFrameInterpolatableScaler
		, MetalFX.IMTLFXTemporalDenoisedScalerBase
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _Encode (IMTL4FXTemporalDenoisedScaler This, global::Metal.IMTL4CommandBuffer commandBuffer)
		{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (MTL4FXTemporalDenoisedScalerWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static IMTL4FXTemporalDenoisedScaler ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class MTL4FXTemporalDenoisedScalerWrapper : BaseWrapper, IMTL4FXTemporalDenoisedScaler {
		public MTL4FXTemporalDenoisedScalerWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (MTL4FXTemporalDenoisedScalerWrapper))]
		static MTL4FXTemporalDenoisedScalerWrapper ()
		{
			GC.KeepAlive (null);
		}
		[Export ("encodeToCommandBuffer:")]
