...
namespace MapKit {
	...
	public unsafe partial class MKMapCamera : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		public static MKMapCamera CameraLookingAt (MKMapItem mapItem, CGSize viewSize, bool allowPitch)
		{
			...
			MKMapCamera? ret;
			ret =  Runtime.GetNSObject<MKMapCamera> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_CGSize_bool (class_ptr, Selector.GetHandle ("cameraLookingAtMapItem:forViewSize:allowPitch:"), mapItem__handle__, viewSize, allowPitch ? (byte) 1 : (byte) 0), false)!;
		...
		public static MKMapCamera CameraLookingAtCenterCoordinate (global::CoreLocation.CLLocationCoordinate2D centerCoordinate, global::CoreLocation.CLLocationCoordinate2D eyeCoordinate, double eyeAltitude)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			MKMapCamera ret;
			ret =  Runtime.GetNSObject<MKMapCamera> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_CLLocationCoordinate2D_CLLocationCoordinate2D_Double (class_ptr, Selector.GetHandle ("cameraLookingAtCenterCoordinate:fromEyeCoordinate:eyeAltitude:"), centerCoordinate, eyeCoordinate, eyeAltitude), false)!;
			return ret;
		}
		...
		public static MKMapCamera CameraLookingAtCenterCoordinate (global::CoreLocation.CLLocationCoordinate2D centerCoordinate, double locationDistance, nfloat pitch, double locationDirectionHeading)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			MKMapCamera ret;
			ret =  Runtime.GetNSObject<MKMapCamera> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_CLLocationCoordinate2D_Double_nfloat_Double (class_ptr, Selector.GetHandle ("cameraLookingAtCenterCoordinate:fromDistance:pitch:heading:"), centerCoordinate, locationDistance, pitch, locationDirectionHeading), false)!;
			return ret;
		}
		...
		public virtual double Altitude {
			...
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_Double (this.Handle, Selector.GetHandle ("setAltitude:"), value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_Double (&__objc_super__, Selector.GetHandle ("setAltitude:"), value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public static MKMapCamera Camera {
			...
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				MKMapCamera? ret;
				ret =  Runtime.GetNSObject<MKMapCamera> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("camera")), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual double CenterCoordinateDistance {
			...
			get {
				...
				double ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.Double_objc_msgSend (this.Handle, Selector.GetHandle ("centerCoordinateDistance"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.Double_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("centerCoordinateDistance"));
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_Double (this.Handle, Selector.GetHandle ("setCenterCoordinateDistance:"), value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_Double (&__objc_super__, Selector.GetHandle ("setCenterCoordinateDistance:"), value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual double Heading {
			...
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_Double (this.Handle, Selector.GetHandle ("setHeading:"), value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_Double (&__objc_super__, Selector.GetHandle ("setHeading:"), value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual nfloat Pitch {
			...
			get {
				...
				nfloat ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend (this.Handle, Selector.GetHandle ("pitch"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("pitch"));
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				global::UIKit.UIApplication.EnsureUIThread ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_nfloat (this.Handle, Selector.GetHandle ("setPitch:"), value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_nfloat (&__objc_super__, Selector.GetHandle ("setPitch:"), value);
						GC.KeepAlive (this);
					}
				}
			}
