...
namespace FileProvider {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "CurrentSyncAnchor", Selector = "currentSyncAnchorWithCompletionHandler:", ParameterType = new Type [] { typeof (global::System.Action<NSData>) }, ParameterByRef = new bool [] { false }, ParameterBlockProxy = new Type? [] { typeof (ObjCRuntime.Trampolines.NIDActionArity1V60) })]
	public partial interface INSFileProviderEnumerator : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void CurrentSyncAnchor ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V60))]global::System.Action<NSData> completionHandler)
		{
			_CurrentSyncAnchor (this, completionHandler);
		}
		/// <param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _CurrentSyncAnchor (INSFileProviderEnumerator This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V60))]global::System.Action<NSData> completionHandler)
		{
	...
	public unsafe static partial class NSFileProviderEnumerator_Extensions {
		...
		/// <param name="completionHandler">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void CurrentSyncAnchor (this INSFileProviderEnumerator This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V60))]global::System.Action<NSData> completionHandler)
		{
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity1V60.CreateBlock (completionHandler);
