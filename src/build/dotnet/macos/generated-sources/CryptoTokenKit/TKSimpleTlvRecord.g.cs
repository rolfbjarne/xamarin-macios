...
namespace CryptoTokenKit {
	...
	public unsafe partial class TKSimpleTlvRecord : TKTlvRecord {
		...
		const string selInitWithTag_Value_X = "initWithTag:value:";
		static readonly NativeHandle selInitWithTag_Value_XHandle = Selector.GetHandle ("initWithTag:value:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_byte_NativeHandle (this.Handle, selInitWithTag_Value_XHandle, tag, value__handle__), "initWithTag:value:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_byte_NativeHandle (&__objc_super__, selInitWithTag_Value_XHandle, tag, value__handle__), "initWithTag:value:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (value);
