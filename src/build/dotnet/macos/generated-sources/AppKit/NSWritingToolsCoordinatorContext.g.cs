...
#nullable enable
namespace AppKit {
	[Register("NSWritingToolsCoordinatorContext", true)]
	[UnsupportedOSPlatform ("tvos")]
	[SupportedOSPlatform ("maccatalyst18.2")]
	[SupportedOSPlatform ("macos15.2")]
	[UnsupportedOSPlatform ("ios")]
	public unsafe partial class NSWritingToolsCoordinatorContext : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selResolvedRangeX = "resolvedRange";
		static readonly NativeHandle selResolvedRangeXHandle = Selector.GetHandle ("resolvedRange");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("NSWritingToolsCoordinatorContext");
		...
		protected NSWritingToolsCoordinatorContext (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal NSWritingToolsCoordinatorContext (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public NSWritingToolsCoordinatorContext (NSAttributedString attributedString, NSRange range)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSRange ResolvedRange {
			[Export ("resolvedRange")]
			get {
				global::AppKit.NSApplication.EnsureUIThread ();
				NSRange ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.NSRange_objc_msgSend (this.Handle, selResolvedRangeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.NSRange_objc_msgSendSuper (&__objc_super__, selResolvedRangeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
