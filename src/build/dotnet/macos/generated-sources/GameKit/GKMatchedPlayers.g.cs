...
namespace GameKit {
	...
	public unsafe partial class GKMatchedPlayers : NSObject {
		...
		const string selPlayerPropertiesX = "playerProperties";
		static readonly NativeHandle selPlayerPropertiesXHandle = Selector.GetHandle ("playerProperties");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual NSDictionary<GKPlayer, NSDictionary<NSString, NSObject>>? PlayerProperties {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDictionary<GKPlayer, NSDictionary<NSString, NSObject>>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selPlayerPropertiesXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDictionary<GKPlayer, NSDictionary<NSString, NSObject>>> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selPlayerPropertiesXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
