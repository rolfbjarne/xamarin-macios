...
namespace WebKit {
	...
	public unsafe partial class DomHtmlHtmlElement : DomHtmlElement {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("DOMHTMLHtmlElement");
		...
		protected DomHtmlHtmlElement (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal DomHtmlHtmlElement (NativeHandle handle) : base (handle)
		{
		}
