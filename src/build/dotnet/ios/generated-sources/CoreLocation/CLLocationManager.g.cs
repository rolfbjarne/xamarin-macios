...
namespace CoreLocation {
	...
	public unsafe partial class CLLocationManager : NSObject {
		...
		/// <param name="distance">A distance, in meters, after which location updates should be delivered.</param><param name="timeout">A time, in seconds, after which location updates should be delivered.</param><summary>Suggests that location updates are deferred until either <paramref name="distance" /> has been traveled or <paramref name="timeout" /> has passed.</summary><remarks><para>Application developers must implement <see cref="T:CoreLocation.CLLocationManagerDelegate" /> and assign the <see cref="P:CoreLocation.CLLocationManager.Delegate" /> property prior to calling this method, or they will receive a runtime exception.</para><para>Application developers who require GPS-accurate location information when their application is in the background, but do not need that information in near-real-time should use this method to defer delivery. Deferred delivery consumes significantly less power.</para><para>This method is only a request. Location updates may occur even if the application is in deferred mode. If updates occur when the application is in deferred mode, the application will stay in deferred mode.</para><para>If the application is in the foreground, location updates are not delayed.</para><para>
		/// This method requires GPS hardware to be available, <see cref="P:CoreLocation.CLLocationManager.DistanceFilter" /> to be
		/// <see cref="P:CoreLocation.CLLocationDistance.FilterNone" />, and <see cref="P:CoreLocation.CLLocationManager.DesiredAccuracy" /> be
		/// either <see cref="P:CoreLocation.CLLocation.AccuracyBest" /> or <see cref="P:CoreLocation.CLLocation.AccurracyBestForNavigation" />.
		/// </para></remarks>
		[Export ("allowDeferredLocationUpdatesUntilTraveled:timeout:")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("macos")]
		[ObsoletedOSPlatform ("ios13.0", "Not used anymore. Call will not have any effect.")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Not used anymore. Call will not have any effect.")]
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void AllowDeferredLocationUpdatesUntil (double distance, double timeout)
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_Double_Double (this.Handle, Selector.GetHandle ("allowDeferredLocationUpdatesUntilTraveled:timeout:"), distance, timeout);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_Double_Double (&__objc_super__, Selector.GetHandle ("allowDeferredLocationUpdatesUntilTraveled:timeout:"), distance, timeout);
					GC.KeepAlive (this);
				}
			}
		}
		/// <summary>Turns off deferred background location updates.</summary><remarks>To be added.</remarks><altmember cref="M:CoreLocation.CLLocationManager.AllowDeferredLocationUpdatesUntil(System.Double,System.Double)" />
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend (this.Handle, Selector.GetHandle ("disallowDeferredLocationUpdates"));
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("disallowDeferredLocationUpdates"));
					GC.KeepAlive (this);
				}
			}
		}
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RequestTemporaryFullAccuracyAuthorization (string purposeKey, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<NSError>? completion)
		{
		...
		{
			using var block_completion = Trampolines.SDActionArity2V19.CreateNullableBlock (completion);
			BlockLiteral *block_ptr_completion = null;
			if (completion is not null)
				block_ptr_completion = &block_completion;
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("startMonitoringLocationPushesWithCompletion:"), (IntPtr) block_ptr_completion);
					GC.KeepAlive (this);
				}
			}
		}
		...
		[SupportedOSPlatform ("ios15.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual Task<NSData> StartMonitoringLocationPushesAsync ()
		{
			var tcs = new TaskCompletionSource<NSData> ();
			StartMonitoringLocationPushes((arg1_, arg2_) => {
		...
		public virtual void StartRangingBeacons (CLBeaconRegion region)
		{
			var region__handle__ = region!.GetNonNullHandle (nameof (region));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("startRangingBeaconsInRegion:"), region__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("startRangingBeaconsInRegion:"), region__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (region);
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend (this.Handle, Selector.GetHandle ("stopMonitoringLocationPushes"));
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("stopMonitoringLocationPushes"));
					GC.KeepAlive (this);
				}
			}
		}
		...
		/// <param name="region">To be added.</param><summary>Stops tracking beacons in the <paramref name="region" />.</summary><remarks>To be added.</remarks>
		[Export ("stopRangingBeaconsInRegion:")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("macos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("ios13.0", "Use 'StopRangingBeacons(CLBeaconIdentityConstraint)' instead.")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'StopRangingBeacons(CLBeaconIdentityConstraint)' instead.")]
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void StopRangingBeacons (CLBeaconRegion region)
		{
			var region__handle__ = region!.GetNonNullHandle (nameof (region));
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("stopRangingBeaconsInRegion:"), region__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("stopRangingBeaconsInRegion:"), region__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (region);
