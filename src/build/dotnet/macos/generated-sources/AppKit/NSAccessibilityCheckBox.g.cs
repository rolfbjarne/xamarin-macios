...
namespace AppKit {
	...
	/// <summary>This interface represents the Objective-C protocol <c>NSAccessibilityCheckBox</c>.</summary>
	/// <remarks>
	...
	public partial interface INSAccessibilityCheckBox : INativeObject, IDisposable, 
		AppKit.INSAccessibilityButton
		, AppKit.INSAccessibilityElementProtocol
	{
		[DynamicDependencyAttribute ("AccessibilityValue")]
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSAccessibilityCheckBoxWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static INSAccessibilityCheckBox ()
		{
			GC.KeepAlive (null);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static NSNumber _GetAccessibilityValue (INSAccessibilityCheckBox This)
		{
	...
	internal unsafe sealed class NSAccessibilityCheckBoxWrapper : BaseWrapper, INSAccessibilityCheckBox {
		public NSAccessibilityCheckBoxWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSAccessibilityCheckBoxWrapper))]
		static NSAccessibilityCheckBoxWrapper ()
		{
			GC.KeepAlive (null);
		}
