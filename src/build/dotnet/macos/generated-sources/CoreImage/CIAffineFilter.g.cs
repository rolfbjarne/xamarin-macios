...
namespace CoreImage {
	...
	public abstract partial class CIAffineFilter : CIFilter, ICIFilterProtocol {
		...
		protected CIAffineFilter (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAffineFilter (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAffineFilter (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIAffineFilter" /> with the specified name.</summary>
