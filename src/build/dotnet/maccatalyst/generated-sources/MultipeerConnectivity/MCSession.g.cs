...
namespace MultipeerConnectivity {
	...
	public unsafe partial class MCSession : NSObject {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("initWithPeer:"), myPeerID__handle__), "initWithPeer:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithPeer:"), myPeerID__handle__), "initWithPeer:");
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void CancelConnectPeer (MCPeerID peerID)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("cancelConnectPeer:"), peerID__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("cancelConnectPeer:"), peerID__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (peerID);
		...
		public virtual void ConnectPeer (MCPeerID peerID, NSData data)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("connectPeer:withNearbyConnectionData:"), peerID__handle__, data__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("connectPeer:withNearbyConnectionData:"), peerID__handle__, data__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (peerID);
		...
		public unsafe virtual void NearbyConnectionDataForPeer (MCPeerID peerID, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMCSessionNearbyConnectionDataForPeerCompletionHandler))]MCSessionNearbyConnectionDataForPeerCompletionHandler completionHandler)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("nearbyConnectionDataForPeer:withCompletionHandler:"), peerID__handle__, (IntPtr) block_ptr_completionHandler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("nearbyConnectionDataForPeer:withCompletionHandler:"), peerID__handle__, (IntPtr) block_ptr_completionHandler);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (peerID);
		...
		public unsafe virtual bool SendData (NSData data, MCPeerID[] peerIDs, MCSessionSendDataMode mode, out NSError error)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_NativeHandle_IntPtr_ref_NativeHandle (this.Handle, Selector.GetHandle ("sendData:toPeers:withMode:error:"), data__handle__, nsa_peerIDs.Handle, (IntPtr) (long) mode, &errorValue);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle_NativeHandle_IntPtr_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("sendData:toPeers:withMode:error:"), data__handle__, nsa_peerIDs.Handle, (IntPtr) (long) mode, &errorValue);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (data);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual NSProgress? SendResource (NSUrl resourceUrl, string resourceName, MCPeerID peerID, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<NSError>? completionHandler)
		{
			...
			NSProgress? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSProgress> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("sendResourceAtURL:withName:toPeer:withCompletionHandler:"), resourceUrl__handle__, nsresourceName, peerID__handle__, (IntPtr) block_ptr_completionHandler), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSProgress> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("sendResourceAtURL:withName:toPeer:withCompletionHandler:"), resourceUrl__handle__, nsresourceName, peerID__handle__, (IntPtr) block_ptr_completionHandler), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual NSOutputStream? StartStream (string streamName, MCPeerID peerID, out NSError error)
		{
			...
			NSOutputStream? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSOutputStream> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_ref_NativeHandle (this.Handle, Selector.GetHandle ("startStreamWithName:toPeer:error:"), nsstreamName, peerID__handle__, &errorValue), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSOutputStream> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("startStreamWithName:toPeer:error:"), nsstreamName, peerID__handle__, &errorValue), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (peerID);
		...
		internal virtual nint _Init (MCPeerID myPeerID, NSArray? identity, MCEncryptionPreference encryptionPreference)
		{
			...
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_NativeHandle_IntPtr (this.Handle, Selector.GetHandle ("initWithPeer:securityIdentity:encryptionPreference:"), myPeerID__handle__, identity__handle__, (IntPtr) (long) encryptionPreference);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_NativeHandle_IntPtr (&__objc_super__, Selector.GetHandle ("initWithPeer:securityIdentity:encryptionPreference:"), myPeerID__handle__, identity__handle__, (IntPtr) (long) encryptionPreference);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (myPeerID);
		...
		public virtual MCPeerID[] ConnectedPeers {
			...
			get {
				MCPeerID[]? ret;
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<MCPeerID>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("connectedPeers")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<MCPeerID>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("connectedPeers")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual MCEncryptionPreference EncryptionPreference {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (MultipeerConnectivity.MCEncryptionPreference) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("encryptionPreference"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MultipeerConnectivity.MCEncryptionPreference) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("encryptionPreference"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual NSArray? SecurityIdentity {
			...
			get {
				NSArray? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSArray> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("securityIdentity")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSArray> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("securityIdentity")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
