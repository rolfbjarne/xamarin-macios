...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSnnLossGradient : MPSCnnBinaryKernel {
		...
		public virtual MPSImage[] EncodeBatch (global::Metal.IMTLCommandBuffer commandBuffer, MPSImage[] sourceGradients, MPSImage[] sourceImages, MPSImage[] labels, MPSImage[]? weights, MPSState[]? sourceStates)
		{
			...
			MPSImage[]? ret;
			if (IsDirectBinding) {
				ret = CFArray.ArrayFromHandle<MPSImage>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("encodeBatchToCommandBuffer:sourceGradients:sourceImages:labels:weights:sourceStates:"), commandBuffer__handle__, nsa_sourceGradients.Handle, nsa_sourceImages.Handle, nsa_labels.Handle, nsa_weights.GetHandle (), nsa_sourceStates.GetHandle ()), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFArray.ArrayFromHandle<MPSImage>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("encodeBatchToCommandBuffer:sourceGradients:sourceImages:labels:weights:sourceStates:"), commandBuffer__handle__, nsa_sourceGradients.Handle, nsa_sourceImages.Handle, nsa_labels.Handle, nsa_weights.GetHandle (), nsa_sourceStates.GetHandle ()), false)!;
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void EncodeBatch (global::Metal.IMTLCommandBuffer commandBuffer, MPSImage[] sourceGradients, MPSImage[] sourceImages, MPSImage[] labels, MPSImage[]? weights, MPSState[]? sourceStates, MPSImage[] destinationGradients)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("encodeBatchToCommandBuffer:sourceGradients:sourceImages:labels:weights:sourceStates:destinationGradients:"), commandBuffer__handle__, nsa_sourceGradients.Handle, nsa_sourceImages.Handle, nsa_labels.Handle, nsa_weights.GetHandle (), nsa_sourceStates.GetHandle (), nsa_destinationGradients.Handle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("encodeBatchToCommandBuffer:sourceGradients:sourceImages:labels:weights:sourceStates:destinationGradients:"), commandBuffer__handle__, nsa_sourceGradients.Handle, nsa_sourceImages.Handle, nsa_labels.Handle, nsa_weights.GetHandle (), nsa_sourceStates.GetHandle (), nsa_destinationGradients.Handle);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
		...
		public virtual bool ComputeLabelGradients {
			...
			get {
				byte ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSend (this.Handle, Selector.GetHandle ("computeLabelGradients"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("computeLabelGradients"));
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_bool (this.Handle, Selector.GetHandle ("setComputeLabelGradients:"), value ? (byte) 1 : (byte) 0);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, Selector.GetHandle ("setComputeLabelGradients:"), value ? (byte) 1 : (byte) 0);
						GC.KeepAlive (this);
					}
				}
			}
