...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CICrystallize</c>.</summary>
	/// <remarks>
	...
	[Protocol (Name = "CICrystallize", WrapperType = typeof (CICrystallizeProtocolWrapper))]
	...
	public partial interface ICICrystallizeProtocol : INativeObject, IDisposable, 
		CoreImage.ICIFilterProtocol
	{
		[DynamicDependencyAttribute ("InputCenter")]
		[DynamicDependencyAttribute ("InputImage")]
		[DynamicDependencyAttribute ("Radius")]
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CICrystallizeProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICICrystallizeProtocol ()
		{
			GC.KeepAlive (null);
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CIImage _GetInputImage (ICICrystallizeProtocol This)
		{
			CIImage ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputImage (ICICrystallizeProtocol This, CIImage? value)
		{
		...
		/// <summary>Gets or sets the radius of the crystallization effect.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[global::Foundation.RequiredMember]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static float _GetRadius (ICICrystallizeProtocol This)
		{
			float ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetRadius (ICICrystallizeProtocol This, float value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CGPoint _GetInputCenter (ICICrystallizeProtocol This)
		{
			CGPoint ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputCenter (ICICrystallizeProtocol This, CGPoint value)
		{
	...
	internal unsafe sealed class CICrystallizeProtocolWrapper : BaseWrapper, ICICrystallizeProtocol {
		public CICrystallizeProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CICrystallizeProtocolWrapper))]
		static CICrystallizeProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets or sets an image to filter.</summary>
