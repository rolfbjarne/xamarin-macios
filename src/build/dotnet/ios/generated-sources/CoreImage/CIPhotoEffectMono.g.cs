...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that produces a low-contrast black-and-white image.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CIPhotoEffectMono filter with the input image
	...
	/// var output = photo_effect_mono.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/photo_effect_mono.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIPhotoEffectMono : CIPhotoEffect {
		/// <summary>Creates a new <see cref="CIPhotoEffectMono" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPhotoEffectMono () : base ("CIPhotoEffectMono")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPhotoEffectMono (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPhotoEffectMono (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPhotoEffectMono (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
