...
namespace QuickLookUI {
	[Register("QLPreviewReplyAttachment", true)]
	[UnsupportedOSPlatform ("tvos")]
	[SupportedOSPlatform ("macos")]
	[UnsupportedOSPlatform ("ios")]
	[UnsupportedOSPlatform ("maccatalyst")]
	public unsafe partial class QLPreviewReplyAttachment : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithData_ContentType_X = "initWithData:contentType:";
		static readonly NativeHandle selInitWithData_ContentType_XHandle = Selector.GetHandle ("initWithData:contentType:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("QLPreviewReplyAttachment");
		...
		protected QLPreviewReplyAttachment (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal QLPreviewReplyAttachment (NativeHandle handle) : base (handle)
		{
		}

		[Export ("initWithData:contentType:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public QLPreviewReplyAttachment (NSData data, global::UniformTypeIdentifiers.UTType contentType)
			: base (NSObjectFlag.Empty)
		{
			var data__handle__ = data!.GetNonNullHandle (nameof (data));
			var contentType__handle__ = contentType!.GetNonNullHandle (nameof (contentType));
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selInitWithData_ContentType_XHandle, data__handle__, contentType__handle__), "initWithData:contentType:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selInitWithData_ContentType_XHandle, data__handle__, contentType__handle__), "initWithData:contentType:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (data);
