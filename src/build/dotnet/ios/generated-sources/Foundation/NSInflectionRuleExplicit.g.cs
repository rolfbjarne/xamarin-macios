	...
	public unsafe partial class NSInflectionRuleExplicit : NSInflectionRule {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithMorphology:"), morphology__handle__), "initWithMorphology:");
					GC.KeepAlive (this);
				}
			}
		...
		public virtual NSMorphology Morphology {
			...
			get {
				NSMorphology? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSMorphology> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("morphology")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSMorphology> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("morphology")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
