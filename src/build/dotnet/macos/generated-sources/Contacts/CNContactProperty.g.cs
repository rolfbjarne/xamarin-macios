	...
	public unsafe partial class CNContactProperty : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		public virtual CNContact Contact {
			...
			get {
				CNContact? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<CNContact> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selContactXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<CNContact> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selContactXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
