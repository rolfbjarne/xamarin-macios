...
namespace IntentsUI {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "Configure", Selector = "configureWithInteraction:context:completion:", ParameterType = new Type [] { typeof (Intents.INInteraction), typeof (IntentsUI.INUIHostedViewContext), typeof (global::System.Action<CGSize>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDActionArity1V202) })]
	...
	public partial interface IINUIHostedViewControlling : INativeObject, IDisposable
	{
		...
		public unsafe virtual void Configure (global::Intents.INInteraction interaction, INUIHostedViewContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V202))]global::System.Action<CGSize> completion)
		{
			_Configure (this, interaction, context, completion);
		}
		/// <param name="interaction">To be added.</param><param name="context">To be added.</param><param name="completion">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _Configure (IINUIHostedViewControlling This, global::Intents.INInteraction interaction, INUIHostedViewContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V202))]global::System.Action<CGSize> completion)
		{
			var interaction__handle__ = interaction!.GetNonNullHandle (nameof (interaction));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
			using var block_completion = Trampolines.SDActionArity1V202.CreateBlock (completion);
	...
	public unsafe static partial class INUIHostedViewControlling_Extensions {
		/// <param name="interaction">To be added.</param><param name="context">To be added.</param><param name="completion">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void Configure (this IINUIHostedViewControlling This, global::Intents.INInteraction interaction, INUIHostedViewContext context, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V202))]global::System.Action<CGSize> completion)
		{
			var interaction__handle__ = interaction!.GetNonNullHandle (nameof (interaction));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
