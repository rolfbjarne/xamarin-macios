...
namespace Metal {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "AddPresentedHandler", Selector = "addPresentedHandler:", ParameterType = new Type [] { typeof (global::System.Action<global::Metal.IMTLDrawable>) }, ParameterByRef = new bool [] { false }, ParameterBlockProxy = new Type? [] { typeof (ObjCRuntime.Trampolines.NIDActionArity1V20) })]
	...
	public partial interface IMTLDrawable : INativeObject, IDisposable
	{
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void AddPresentedHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<IMTLDrawable> block)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <summary>Causes the provided <paramref name="block" /> to be run after the drawable is displayed.</summary><param name="block">The code that will be called after the drawable is displayed.</param>
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _AddPresentedHandler (IMTLDrawable This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<IMTLDrawable> block)
		{
			if (block is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (block));
			using var block_block = Trampolines.SDActionArity1V20.CreateBlock (block);
	...
	internal unsafe sealed class MTLDrawableWrapper : BaseWrapper, IMTLDrawable {
		...
		[Export ("addPresentedHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void AddPresentedHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V20))]global::System.Action<IMTLDrawable> block)
		{
			if (block is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (block));
			using var block_block = Trampolines.SDActionArity1V20.CreateBlock (block);
...
namespace Metal {
	/// <summary>Interface definition for objects that can receive rendering commands.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/Metal/Reference/MTLDrawable_Ref/index.html">Apple documentation for <c>MTLDrawable</c></related>
	[Protocol()]
	[Register("Microsoft_tvOS__Metal_MTLDrawable", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
