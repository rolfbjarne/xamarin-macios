...
#nullable enable
namespace CoreImage {
	/// <summary>The CIVignette CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create a CIImage from a file.
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Construct the Vignette filter
	...
	/// var output = vignette.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/Vignette.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIVignette : CIFilter, ICIVignetteProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIVignette" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIVignette () : base ("CIVignette")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIVignette (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIVignette (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIVignette (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIVignetteProtocol protocol members 
