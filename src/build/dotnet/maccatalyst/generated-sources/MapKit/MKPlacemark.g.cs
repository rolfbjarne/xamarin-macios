...
namespace MapKit {
	...
	public unsafe partial class MKPlacemark : global::CoreLocation.CLPlacemark, IMKAnnotation, INSCopying {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_CLLocationCoordinate2D_NativeHandle (this.Handle, Selector.GetHandle ("initWithCoordinate:addressDictionary:"), coordinate, addressDictionary__handle__), "initWithCoordinate:addressDictionary:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_CLLocationCoordinate2D_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithCoordinate:addressDictionary:"), coordinate, addressDictionary__handle__), "initWithCoordinate:addressDictionary:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (addressDictionary);
		}
		/// <param name="coordinate">To be added.</param><param name="addressDictionary">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public MKPlacemark (global::CoreLocation.CLLocationCoordinate2D coordinate, MKPlacemarkAddress addressDictionary)
			: this (coordinate, addressDictionary.GetDictionary ())
		{
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_CLLocationCoordinate2D_NativeHandle (this.Handle, Selector.GetHandle ("initWithCoordinate:postalAddress:"), coordinate, postalAddress__handle__), "initWithCoordinate:postalAddress:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_CLLocationCoordinate2D_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithCoordinate:postalAddress:"), coordinate, postalAddress__handle__), "initWithCoordinate:postalAddress:");
					GC.KeepAlive (this);
				}
			}
