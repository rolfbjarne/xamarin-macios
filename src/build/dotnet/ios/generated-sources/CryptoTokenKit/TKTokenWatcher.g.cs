...
namespace CryptoTokenKit {
	...
	public unsafe partial class TKTokenWatcher : NSObject {
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe TKTokenWatcher ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V58))]global::System.Action<NSString> insertionHandler)
			: base (NSObjectFlag.Empty)
		{
			if (insertionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (insertionHandler));
			using var block_insertionHandler = Trampolines.SDActionArity1V58.CreateBlock (insertionHandler);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void AddRemovalHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V58))]global::System.Action<NSString> removalHandler, string tokenId)
		{
			...
			using var block_removalHandler = Trampolines.SDActionArity1V58.CreateBlock (removalHandler);
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void SetInsertionHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V58))]global::System.Action<NSString> insertionHandler)
		{
			if (insertionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (insertionHandler));
			using var block_insertionHandler = Trampolines.SDActionArity1V58.CreateBlock (insertionHandler);
