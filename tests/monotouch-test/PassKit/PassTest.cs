	...
	public class PassTest {
		...
		public void Defaults ()
		{
			...
			using (PKPass pass = new PKPass ()) {
				ClassicAssert.Null (pass.AuthenticationToken, "AuthenticationToken");
#if !__MACCATALYST__ // PKPass.Icon doesn't work: https://github.com/xamarin/maccore/issues/2347
				ClassicAssert.NotNull (pass.Icon, "Icon");
#endif
				ClassicAssert.Null (pass.LocalizedDescription, "LocalizedDescription");
				Assert.That (string.IsNullOrEmpty (pass.LocalizedName), Is.False, "LocalizedName");
				ClassicAssert.Null (pass.OrganizationName, "OrganizationName");
				ClassicAssert.Null (pass.PassTypeIdentifier, "PassTypeIdentifier");
				ClassicAssert.Null (pass.PassUrl, "PassUrl");
				ClassicAssert.Null (pass.RelevantDate, "RelevantDate");
				ClassicAssert.Null (pass.SerialNumber, "SerialNumber");
				ClassicAssert.Null (pass.WebServiceUrl, "WebServiceUrl");
			}
		}
