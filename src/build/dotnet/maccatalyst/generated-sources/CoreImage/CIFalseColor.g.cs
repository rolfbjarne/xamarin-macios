...
#nullable enable
namespace CoreImage {
	/// <summary>The CIFalseColor CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/FalseColor.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIFalseColor : CIFilter, ICIFalseColorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIFalseColor" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIFalseColor () : base ("CIFalseColor")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIFalseColor (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIFalseColor (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIFalseColor (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIFalseColorProtocol protocol members 
