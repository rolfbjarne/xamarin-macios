...
#if NET
	/// <summary>The state of a <see cref="GameController.GCExtendedGamepad" />. Produced by <see cref="GameController.GCExtendedGamepadSnapshot.TryGetSnapShotData(Foundation.NSData,GameController.GCExtendedGamepadSnapShotDataV100@)" />.</summary>
