...
namespace Foundation {
	/// <summary>An enumeration whose values specify the state of a response.</summary><remarks>An instance of this class is passed as an argument to the completion handler of the <see cref="M:Foundation.NSUrlSessionDataDelegate.DidReceiveResponse(Foundation.NSUrlSession,Foundation.NSUrlSessionDataTask,Foundation.NSUrlResponse,System.Action{Foundation.NSUrlSessionResponseDisposition})" /> method.</remarks>
	[Native]
