...
#nullable enable
namespace CoreImage {
	/// <summary>The CIColorCube CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/color_cube.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIColorCube : CIFilter, ICIColorCubeProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorCube" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIColorCube () : base ("CIColorCube")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorCube (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorCube (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorCube (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CIColorCube" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public  CIColorCube (string name) : base (CreateFilter (name))
		{
		}
		// CIColorCubeProtocol protocol members 
