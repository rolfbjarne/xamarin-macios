	...
	public unsafe partial class PhaseSoundAsset : PhaseAsset {
		...
		public virtual PhaseAssetType Type {
			...
			get {
				PhaseAssetType ret;
				if (IsDirectBinding) {
					ret = (Phase.PhaseAssetType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selTypeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (Phase.PhaseAssetType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selTypeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
