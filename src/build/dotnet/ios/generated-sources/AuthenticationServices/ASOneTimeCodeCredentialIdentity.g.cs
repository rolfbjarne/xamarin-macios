...
namespace AuthenticationServices {
	...
	public unsafe partial class ASOneTimeCodeCredentialIdentity : NSObject, IASCredentialIdentity, INSCoding, INSCopying, INSSecureCoding {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithServiceIdentifier:label:recordIdentifier:"), serviceIdentifier__handle__, nslabel, nsrecordIdentifier), "initWithServiceIdentifier:label:recordIdentifier:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithServiceIdentifier:label:recordIdentifier:"), serviceIdentifier__handle__, nslabel, nsrecordIdentifier), "initWithServiceIdentifier:label:recordIdentifier:");
					GC.KeepAlive (this);
				}
			}
