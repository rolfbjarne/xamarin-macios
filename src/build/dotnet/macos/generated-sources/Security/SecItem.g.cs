...
namespace Security {
	internal unsafe static partial class SecItem  {
		...
		/// <summary>Represents the value associated with the constant 'kSecMatchSubjectEndsWith'.</summary>
		[Field ("kSecMatchSubjectEndsWith",  "Security")]
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		public static nint MatchSubjectEndsWith {
			[UnsupportedOSPlatform ("ios")]
			[UnsupportedOSPlatform ("tvos")]
			[UnsupportedOSPlatform ("maccatalyst")]
			[SupportedOSPlatform ("macos")]
			get {
				return Dlfcn.GetIntPtr (Libraries.Security.Handle, "kSecMatchSubjectEndsWith");
			}
		}
		/// <summary>Represents the value associated with the constant 'kSecMatchSubjectStartsWith'.</summary>
		[Field ("kSecMatchSubjectStartsWith",  "Security")]
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		public static nint MatchSubjectStartsWith {
			[UnsupportedOSPlatform ("ios")]
			[UnsupportedOSPlatform ("tvos")]
			[UnsupportedOSPlatform ("maccatalyst")]
			[SupportedOSPlatform ("macos")]
			get {
				return Dlfcn.GetIntPtr (Libraries.Security.Handle, "kSecMatchSubjectStartsWith");
			}
		}
		/// <summary>Represents the value associated with the constant 'kSecMatchSubjectWholeString'.</summary>
		[Field ("kSecMatchSubjectWholeString",  "Security")]
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		public static nint MatchSubjectWholeString {
			[UnsupportedOSPlatform ("ios")]
			[UnsupportedOSPlatform ("tvos")]
			[UnsupportedOSPlatform ("maccatalyst")]
			[SupportedOSPlatform ("macos")]
			get {
				return Dlfcn.GetIntPtr (Libraries.Security.Handle, "kSecMatchSubjectWholeString");
			}
		}
