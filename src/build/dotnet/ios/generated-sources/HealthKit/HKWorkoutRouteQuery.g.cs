...
namespace HealthKit {
	...
	public unsafe partial class HKWorkoutRouteQuery : HKQuery {
		...
		static readonly NativeHandle class_ptr = Class.GetHandle ("HKWorkoutRouteQuery");
		...
		/// <summary>Creates a new <see cref="HKWorkoutRouteQuery" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public HKWorkoutRouteQuery () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected HKWorkoutRouteQuery (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal HKWorkoutRouteQuery (NativeHandle handle) : base (handle)
		{
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			using var block_dataHandler = Trampolines.SDHKWorkoutRouteBuilderDataHandler.CreateBlock (dataHandler);
			BlockLiteral *block_ptr_dataHandler = &block_dataHandler;
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithRoute:dataHandler:"), workoutRoute__handle__, (IntPtr) block_ptr_dataHandler), "initWithRoute:dataHandler:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithRoute:dataHandler:"), workoutRoute__handle__, (IntPtr) block_ptr_dataHandler), "initWithRoute:dataHandler:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (workoutRoute);
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (dataHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (dataHandler));
			using var block_dataHandler = Trampolines.SDHKWorkoutRouteQueryDataHandler.CreateBlock (dataHandler);
			BlockLiteral *block_ptr_dataHandler = &block_dataHandler;
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithRoute:dateInterval:dataHandler:"), workoutRoute__handle__, dateInterval__handle__, (IntPtr) block_ptr_dataHandler), "initWithRoute:dateInterval:dataHandler:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (workoutRoute);
