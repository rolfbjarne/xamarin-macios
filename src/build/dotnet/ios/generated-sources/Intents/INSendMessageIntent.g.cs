...
namespace Intents {
	...
	public unsafe partial class INSendMessageIntent : INIntent, global::UserNotifications.IUNNotificationContentProviding {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			var nsserviceName = CFString.CreateNative (serviceName);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithRecipients:content:speakableGroupName:conversationIdentifier:serviceName:sender:"), nsa_recipients.GetHandle (), nscontent, speakableGroupName__handle__, nsconversationIdentifier, nsserviceName, sender__handle__), "initWithRecipients:content:speakableGroupName:conversationIdentifier:serviceName:sender:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithRecipients:content:speakableGroupName:conversationIdentifier:serviceName:sender:"), nsa_recipients.GetHandle (), nscontent, speakableGroupName__handle__, nsconversationIdentifier, nsserviceName, sender__handle__), "initWithRecipients:content:speakableGroupName:conversationIdentifier:serviceName:sender:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (speakableGroupName);
			...
			: base (NSObjectFlag.Empty)
		{
			...
			var nsserviceName = CFString.CreateNative (serviceName);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithRecipients:content:groupName:serviceName:sender:"), nsa_recipients.GetHandle (), nscontent, nsgroupName, nsserviceName, sender__handle__), "initWithRecipients:content:groupName:serviceName:sender:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithRecipients:content:groupName:serviceName:sender:"), nsa_recipients.GetHandle (), nscontent, nsgroupName, nsserviceName, sender__handle__), "initWithRecipients:content:groupName:serviceName:sender:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (sender);
		...
		public virtual INSendMessageAttachment[]? Attachments {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<INSendMessageAttachment>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("attachments")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<INSendMessageAttachment>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("attachments")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual string? ConversationIdentifier {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("conversationIdentifier")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("conversationIdentifier")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual string? GroupName {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("groupName")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("groupName")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual INOutgoingMessageType OutgoingMessageType {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (Intents.INOutgoingMessageType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("outgoingMessageType"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (Intents.INOutgoingMessageType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("outgoingMessageType"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual INPerson? Sender {
			...
			get {
				INPerson? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<INPerson> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("sender")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<INPerson> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("sender")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual INSpeakableString? SpeakableGroupName {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<INSpeakableString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("speakableGroupName")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<INSpeakableString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("speakableGroupName")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
