...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIFilter" /> that dulls the highlights of the source image.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/gloom.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIGloom : CIFilter, ICIGloomProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIGloom" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIGloom (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIGloom (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIGloom (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIGloomProtocol protocol members 
