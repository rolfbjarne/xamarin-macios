...
namespace CoreImage {
	...
	public partial class CIDisplacementDistortion : CIFilter, ICIDisplacementDistortionProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIDisplacementDistortion" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIDisplacementDistortion () : base ("CIDisplacementDistortion")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIDisplacementDistortion (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDisplacementDistortion (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDisplacementDistortion (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		public CIImage? DisplacementImage {
			...
			set {
				SetValue ("inputDisplacementImage", value);
			}
		}
