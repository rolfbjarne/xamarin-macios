...
namespace CoreImage {
	...
	public unsafe partial class CIFilter : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		public static string CategoryLocalizedName (string category)
		{
			...
			string? ret;
			ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("localizedNameForCategory:"), nscategory), false)!;
		...
		public static CIFilter CreateRawFilter (NSUrl url, NSDictionary options)
		{
			...
			CIFilter? ret;
			ret =  Runtime.GetNSObject<CIFilter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("filterWithImageURL:options:"), url__handle__, options__handle__), false)!;
			GC.KeepAlive (url);
		...
		public static CIFilter CreateRawFilter (NSData data, NSDictionary options)
		{
			...
			var options__handle__ = options!.GetNonNullHandle (nameof (options));
			CIFilter? ret;
			ret =  Runtime.GetNSObject<CIFilter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("filterWithImageData:options:"), data__handle__, options__handle__), false)!;
			GC.KeepAlive (data);
			GC.KeepAlive (options);
			return ret!;
		}
		...
		public static CIFilter CreateRawFilter (global::CoreVideo.CVPixelBuffer pixelBuffer, NSDictionary properties, NSDictionary options)
		{
			...
			var options__handle__ = options!.GetNonNullHandle (nameof (options));
			CIFilter? ret;
			ret =  Runtime.GetNSObject<CIFilter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("filterWithCVPixelBuffer:properties:options:"), pixelBuffer__handle__, properties__handle__, options__handle__), false)!;
		...
		public static string? FilterLocalizedDescription (string filterName)
		{
			...
			string? ret;
			ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("localizedDescriptionForFilterName:"), nsfilterName), false)!;
		...
		public static string? FilterLocalizedName (string filterName)
		{
			...
			var nsfilterName = CFString.CreateNative (filterName);
			string? ret;
			ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("localizedNameForFilterName:"), nsfilterName), false)!;
			CFString.ReleaseNative (nsfilterName);
			return ret!;
		}
		...
		public static NSUrl? FilterLocalizedReferenceDocumentation (string filterName)
		{
			...
			var nsfilterName = CFString.CreateNative (filterName);
			NSUrl? ret;
			ret =  Runtime.GetNSObject<NSUrl> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("localizedReferenceDocumentationForFilterName:"), nsfilterName), false)!;
			CFString.ReleaseNative (nsfilterName);
			return ret!;
		}
		...
		public static string[] FilterNamesInCategory (string? category)
		{
			var nscategory = CFString.CreateNative (category);
			string[]? ret;
			ret = CFArray.StringArrayFromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("filterNamesInCategory:"), nscategory), false)!;
			CFString.ReleaseNative (nscategory);
			return ret!;
		}
		...
		public static CIFilter? FromName (string name)
		{
			...
			CIFilter? ret;
			ret =  Runtime.GetNSObject<CIFilter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("filterWithName:"), nsname), false)!;
			CFString.ReleaseNative (nsname);
			return ret!;
		}
		/// <param name="xmpData">To be added.</param><param name="extent">To be added.</param><param name="error">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		...
		public unsafe static CIFilter[] FromSerializedXMP (NSData xmpData, CGRect extent, out NSError error)
		{
			...
			CIFilter[]? ret;
			ret = CFArray.ArrayFromHandle<CIFilter>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_CGRect_ref_NativeHandle (class_ptr, Selector.GetHandle ("filterArrayFromSerializedXMP:inputImageExtent:error:"), xmpData__handle__, extent, &errorValue), false)!;
			GC.KeepAlive (xmpData);
		...
		public static CIFilter? GetFilter (string name, NSDictionary? inputParameters)
		{
			...
			var nsname = CFString.CreateNative (name);
			CIFilter? ret;
			ret =  Runtime.GetNSObject<CIFilter> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("filterWithName:withInputParameters:"), nsname, inputParameters__handle__), false)!;
		...
		public static void RegisterFilterName (string name, ICIFilterConstructor constructorObject, NSDictionary<NSString, NSObject> classAttributes)
		{
			...
			var nsname = CFString.CreateNative (name);
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("registerFilterName:constructor:classAttributes:"), nsname, constructorObject__handle__, classAttributes__handle__);
			GC.KeepAlive (constructorObject);
			GC.KeepAlive (classAttributes);
			CFString.ReleaseNative (nsname);
		}
		/// <param name="filters">To be added.</param><param name="extent">To be added.</param><summary>Returns a list of filters for an extent as serialized XMP data.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static NSData? SerializedXMP (CIFilter[] filters, CGRect extent)
		{
			if (filters is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (filters));
			using var nsa_filters = NSArray.FromNSObjects (filters);
			NSData ret;
			ret =  Runtime.GetNSObject<NSData> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_CGRect (class_ptr, Selector.GetHandle ("serializedXMPFromFilters:inputImageExtent:"), nsa_filters.Handle, extent), false)!;
			return ret;
		}
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend (this.Handle, Selector.GetHandle ("setDefaults"));
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("setDefaults"));
					GC.KeepAlive (this);
				}
			}
		}
		...
		internal virtual void SetValueForKey (NSObject? value, nint key)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_IntPtr (this.Handle, Selector.GetHandle ("setValue:forKey:"), value__handle__, key);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_IntPtr (&__objc_super__, Selector.GetHandle ("setValue:forKey:"), value__handle__, key);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (value);
		...
		internal virtual NSObject? ValueForKey (nint key)
		{
			NSObject ret;
			if (IsDirectBinding) {
				ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("valueForKey:"), key), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("valueForKey:"), key), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		internal static string[] _FilterNamesInCategories (string[]? categories)
		{
			...
			string[] ret;
			ret = CFArray.StringArrayFromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("filterNamesInCategories:"), nsa_categories.GetHandle ()), false)!;
			return ret;
		}
		...
		public virtual NSDictionary Attributes {
			...
			get {
				NSDictionary? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDictionary> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("attributes")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDictionary> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("attributes")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public static CIBlurredRectangleGenerator BlurredRectangleGeneratorFilter {
			...
			get {
				...
				ret =  Runtime.GetNSObject<CIBlurredRectangleGenerator> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("blurredRectangleGeneratorFilter")), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static CICannyEdgeDetector CannyEdgeDetectorFilter {
			...
			get {
				...
				ret =  Runtime.GetNSObject<CICannyEdgeDetector> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("cannyEdgeDetectorFilter")), false)!;
				return ret!;
			}
		}
		...
		public virtual string[] InputKeys {
			...
			get {
				string[] ret;
				if (IsDirectBinding) {
					ret = CFArray.StringArrayFromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("inputKeys")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.StringArrayFromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("inputKeys")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual string[] OutputKeys {
			...
			get {
				string[] ret;
				if (IsDirectBinding) {
					ret = CFArray.StringArrayFromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("outputKeys")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.StringArrayFromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("outputKeys")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public static CIRoundedRectangleStrokeGenerator RoundedRectangleStrokeGeneratorFilter {
			...
			get {
				...
				ret =  Runtime.GetNSObject<CIRoundedRectangleStrokeGenerator> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("roundedRectangleStrokeGeneratorFilter")), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static CISobelGradients SobelGradientsFilter {
			...
			get {
				...
				ret =  Runtime.GetNSObject<CISobelGradients> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("sobelGradientsFilter")), false)!;
				return ret!;
			}
		}
	} /* class CIFilter */
