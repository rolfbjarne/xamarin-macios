...
public class InlineDlfcnMethodsStep : ConfigurationAwareMarkHandler {
	...
	AssemblyDefinition? linkerCurrentAssembly;
	bool strictMode;
	...
	protected override void Process (MethodDefinition method)
	{
		...
		var methodAssembly = method.Module.Assembly;

		if (linkerCurrentAssembly != methodAssembly) {
			if (linkerCurrentAssembly is not null)
				abr.ClearCurrentAssembly ();
			abr.SetCurrentAssembly (methodAssembly);
			linkerCurrentAssembly = methodAssembly;
		}
