...
namespace AVFoundation {
	...
	public unsafe partial class AVAudioPlayerNode : AVAudioNode, IAVAudio3DMixing, IAVAudioMixing, IAVAudioStereoMixing {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ScheduleBuffer (AVAudioPcmBuffer buffer, AVAudioPlayerNodeCompletionCallbackType callbackType, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V3))]global::System.Action<AVAudioPlayerNodeCompletionCallbackType>? completionHandler)
		{
			var buffer__handle__ = buffer!.GetNonNullHandle (nameof (buffer));
			using var block_completionHandler = Trampolines.SDActionArity1V3.CreateNullableBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = null;
			if (completionHandler is not null)
				block_ptr_completionHandler = &block_completionHandler;
			if (IsDirectBinding) {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ScheduleFile (AVAudioFile file, AVAudioTime? when, AVAudioPlayerNodeCompletionCallbackType callbackType, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V3))]global::System.Action<AVAudioPlayerNodeCompletionCallbackType>? completionHandler)
		{
			var file__handle__ = file!.GetNonNullHandle (nameof (file));
			var when__handle__ = when.GetHandle ();
			using var block_completionHandler = Trampolines.SDActionArity1V3.CreateNullableBlock (completionHandler);
