...
#nullable enable
namespace CoreImage {
	/// <summary>The CIMultiplyCompositing CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 
	/// // Construct the MultiplyComposite filter
	...
	/// var output = multiComposite.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/MultiplyComposite.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIMultiplyCompositing : CICompositingFilter {
		/// <summary>Creates a new <see cref="CIMultiplyCompositing" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMultiplyCompositing (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMultiplyCompositing (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMultiplyCompositing (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
