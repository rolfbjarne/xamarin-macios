...
namespace MetalPerformanceShadersGraph {
	public unsafe static partial class MPSGraph_MPSGraphSampleGrid  {
		...
		const string selSampleGridWithSourceTensor_CoordinateTensor_Layout_NormalizeCoordinates_RelativeCoordinates_AlignCorners_PaddingMode_NearestRoundingMode_ConstantValue_Name_X = "sampleGridWithSourceTensor:coordinateTensor:layout:normalizeCoordinates:relativeCoordinates:alignCorners:paddingMode:nearestRoundingMode:constantValue:name:";
		static readonly NativeHandle selSampleGridWithSourceTensor_CoordinateTensor_Layout_NormalizeCoordinates_RelativeCoordinates_AlignCorners_PaddingMode_NearestRoundingMode_ConstantValue_Name_XHandle = Selector.GetHandle ("sampleGridWithSourceTensor:coordinateTensor:layout:normalizeCoordinates:relativeCoordinates:alignCorners:paddingMode:nearestRoundingMode:constantValue:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSampleGridWithSourceTensor_CoordinateTensor_Layout_NormalizeCoordinates_RelativeCoordinates_AlignCorners_PaddingMode_SamplingMode_ConstantValue_Name_X = "sampleGridWithSourceTensor:coordinateTensor:layout:normalizeCoordinates:relativeCoordinates:alignCorners:paddingMode:samplingMode:constantValue:name:";
		static readonly NativeHandle selSampleGridWithSourceTensor_CoordinateTensor_Layout_NormalizeCoordinates_RelativeCoordinates_AlignCorners_PaddingMode_SamplingMode_ConstantValue_Name_XHandle = Selector.GetHandle ("sampleGridWithSourceTensor:coordinateTensor:layout:normalizeCoordinates:relativeCoordinates:alignCorners:paddingMode:samplingMode:constantValue:name:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
