...
#nullable enable
namespace CoreImage {
	/// <summary>Generates an Aztec code for the specified <see cref="CoreImage.CIAztecCodeGenerator.Message" />.</summary><remarks><para>The Aztec code is defined at <format type="text/html"><a href="https://www.iso.org/iso/iso_catalogue/catalogue_tc/catalogue_detail.htm?csnumber=41548">www.iso.org/iso/iso_catalogue/catalogue_tc/catalogue_detail.htm?csnumber=41548</a></format>.</para></remarks>
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("tvos")]
	public partial class CIAztecCodeGenerator : CICodeGenerator, ICIAztecCodeGeneratorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIAztecCodeGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIAztecCodeGenerator () : base ("CIAztecCodeGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAztecCodeGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAztecCodeGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAztecCodeGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIAztecCodeGeneratorProtocol protocol members 
