...
namespace CoreImage {
	...
	public partial class CICameraCalibrationLensCorrection : CIFilter {
		/// <summary>Creates a new <see cref="CICameraCalibrationLensCorrection" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CICameraCalibrationLensCorrection () : base ("CICameraCalibrationLensCorrection")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CICameraCalibrationLensCorrection (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CICameraCalibrationLensCorrection (NSObjectFlag t) : base (t)
		{
		}
		...
		public CICameraCalibrationLensCorrection (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		public AVCameraCalibrationData AVCameraCalibrationData {
			get {
				return Runtime.GetNSObject <AVCameraCalibrationData> (GetHandle ("inputAVCameraCalibrationData"), false)!;
			}
			set {
