...
namespace Metal {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "CreateRemoteBuffer", Selector = "newRemoteBufferViewForDevice:", ReturnType = typeof (IMTLBuffer), ParameterType = new Type [] { typeof (IMTLDevice) }, ParameterByRef = new bool [] { false })]
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "RemoteStorageBuffer", Selector = "remoteStorageBuffer", PropertyType = typeof (IMTLBuffer), GetterSelector = "remoteStorageBuffer", ArgumentSemantic = ArgumentSemantic.None)]
		...
		, Metal.IMTLResource
	{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static IMTLBuffer? _CreateRemoteBuffer (IMTLBuffer This, IMTLDevice device)
		{
		...
		[DynamicDependencyAttribute ("CreateRemoteBuffer(Metal.IMTLDevice)")]
		...
		[DynamicDependencyAttribute ("RemoteStorageBuffer")]
		...
		[SupportedOSPlatform ("macos")]
		[global::Foundation.RequiredMember]
		public virtual IMTLBuffer? RemoteStorageBuffer {
			[Export ("remoteStorageBuffer")]
			get {
				return _GetRemoteStorageBuffer (this);
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static IMTLBuffer _GetRemoteStorageBuffer (IMTLBuffer This)
		{
			IMTLBuffer ret;
			ret =  Runtime.GetINativeObject<IMTLBuffer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (This.Handle, Selector.GetHandle ("remoteStorageBuffer")), false)!;
			GC.KeepAlive (This);
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	...
	internal unsafe sealed class MTLBufferWrapper : BaseWrapper, IMTLBuffer {
		...
		[return: ReleaseAttribute ()]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public IMTLBuffer? CreateRemoteBuffer (IMTLDevice device)
		{
			var device__handle__ = device!.GetNonNullHandle (nameof (device));
			IMTLBuffer? ret;
			ret =  Runtime.GetINativeObject<IMTLBuffer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("newRemoteBufferViewForDevice:"), device__handle__), true)!;
		...
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("macos")]
		public IMTLBuffer? RemoteStorageBuffer {
			[Export ("remoteStorageBuffer")]
			get {
				IMTLBuffer ret;
				ret =  Runtime.GetINativeObject<IMTLBuffer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("remoteStorageBuffer")), false)!;
