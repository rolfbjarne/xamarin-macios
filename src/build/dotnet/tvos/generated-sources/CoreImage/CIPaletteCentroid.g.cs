...
namespace CoreImage {
	...
	public partial class CIPaletteCentroid : CIFilter, ICIPaletteCentroidProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIPaletteCentroid" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPaletteCentroid () : base ("CIPaletteCentroid")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPaletteCentroid (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPaletteCentroid (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPaletteCentroid (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIPaletteCentroidProtocol protocol members 
		...
		public CIImage? PaletteImage {
			...
			get {
				return (ValueForKey ("inputPaletteImage") as CIImage)!;
			}
			[Export ("setPaletteImage:", ArgumentSemantic.Retain)]
			set {
				SetValue ("inputPaletteImage", value);
			}
		}
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("macos")]
