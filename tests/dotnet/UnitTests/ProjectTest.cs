			...
			if (bundleOriginalResources) {
				...
				case DuplicatedResourcesScenarios.FirstLibraryAndSecondLibrary:
					expectedWarnings = new ExpectedBuildMessage [] {
						...
						new ExpectedBuildMessage ($"tests/dotnet/AppWithDuplicatedResources/{platform.AsString ()}/obj/{config}/{Configuration.DotNetTfm}-{platform.AsString ().ToLower ()}{runtimeIdentifierInfix}unpack/LibraryWithResources/ImageAsset/Images.xcassets", $"The image set name \"Image\" is used by multiple image sets."),
						new ExpectedBuildMessage ($"tests/dotnet/AppWithDuplicatedResources/{platform.AsString ()}/obj/{config}/{Configuration.DotNetTfm}-{platform.AsString ().ToLower ()}{runtimeIdentifierInfix}unpack/LibraryWithResources/ImageAsset/Images.xcassets", $"The image set name \"Image\" is used by multiple image sets."),
					};
					break;
				case DuplicatedResourcesScenarios.FirstLibraryAndExecutable:
