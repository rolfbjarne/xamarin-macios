	...
	public class PathTest {
		...
		public void EllipseFromRect ()
		{
			...
			using (CGPath p = CGPath.EllipseFromRect (rect, matrix)) {
				ClassicAssert.IsNotNull (p, "non-null");
			}
		}
		...
		public void MoveToPoint ()
		{
			...
			using (CGPath p2 = new CGPath ()) {
				ClassicAssert.IsTrue (p1.IsEmpty, "IsEmpty-1");
				p1.MoveToPoint (0, 0);
				p2.MoveToPoint (matrix, 0, 0);
				ClassicAssert.IsFalse (p1.IsEmpty, "IsEmpty-2");
		...
		public void AddPath ()
		{
			...
			using (CGPath p2 = new CGPath ()) {
				p1.MoveToPoint (0, 0);
				p2.AddPath (p1);
				ClassicAssert.IsFalse (p2.IsEmpty, "IsEmpty");
			}
		}
		...
		public void Normalizing ()
		{
			...
			using (CGPath p1 = new CGPath ()) {
				p1.MoveToPoint (0, 0);
				p1.AddLineToPoint (1, 1);
				ClassicAssert.IsNotNull (p1.CreateByNormalizing (false));
				ClassicAssert.IsNotNull (p1.CreateByNormalizing (true));
			}
		}
		...
		public void Union ()
		{
			...
			using (CGPath p1 = new CGPath ()) {
				...
				using (CGPath p2 = new CGPath ()) {
					...
					ClassicAssert.IsNotNull (p1.CreateByUnioningPath (p2, false));
					ClassicAssert.IsNotNull (p1.CreateByUnioningPath (p2, true));
				}
			}
		}
		...
		public void Intersecting ()
		{
			...
			using (CGPath p1 = new CGPath ()) {
				...
				using (CGPath p2 = new CGPath ()) {
					p2.MoveToPoint (2, 2);
					p2.AddLineToPoint (0, 0);
					ClassicAssert.IsNotNull (p1.CreateByIntersectingPath (p2, false));
					ClassicAssert.IsNotNull (p1.CreateByIntersectingPath (p2, true));
				}
			}
		}
		...
		public void Subtracting ()
		{
			...
			using (CGPath p1 = new CGPath ()) {
				...
				using (CGPath p2 = new CGPath ()) {
					p2.MoveToPoint (2, 2);
					p2.AddLineToPoint (0, 0);
					ClassicAssert.IsNotNull (p1.CreateBySubtractingPath (p2, false));
					ClassicAssert.IsNotNull (p1.CreateBySubtractingPath (p2, true));
				}
			}
		}
		...
		public void SymmetricDifference ()
		{
			...
			using (CGPath p1 = new CGPath ()) {
				...
				using (CGPath p2 = new CGPath ()) {
					p2.MoveToPoint (2, 2);
					p2.AddLineToPoint (0, 0);
					ClassicAssert.IsNotNull (p1.CreateBySymmetricDifferenceOfPath (p2, false));
					ClassicAssert.IsNotNull (p1.CreateBySymmetricDifferenceOfPath (p2, true));
				}
			}
		}
		...
		public void LineBySubtracting ()
		{
			...
			using (CGPath p1 = new CGPath ()) {
				...
				using (CGPath p2 = new CGPath ()) {
					p2.MoveToPoint (2, 2);
					p2.AddLineToPoint (0, 0);
					ClassicAssert.IsNotNull (p1.CreateLineBySubtractingPath (p2, false));
					ClassicAssert.IsNotNull (p1.CreateLineBySubtractingPath (p2, true));
				}
			}
		}
		...
		public void LineByIntersecting ()
		{
			...
			using (CGPath p1 = new CGPath ()) {
				...
				using (CGPath p2 = new CGPath ()) {
					p2.MoveToPoint (2, 2);
					p2.AddLineToPoint (0, 0);
					ClassicAssert.IsNotNull (p1.CreateLineByIntersectingPath (p2, false));
					ClassicAssert.IsNotNull (p1.CreateLineByIntersectingPath (p2, true));
				}
			}
		}
		...
		public void GetSeparateComponents ()
		{
			...
			using (CGPath p1 = new CGPath ()) {
				p1.MoveToPoint (0, 0);
				p1.AddLineToPoint (1, 1);
				ClassicAssert.AreEqual (0, p1.GetSeparateComponents (true).Length);
				ClassicAssert.AreEqual (0, p1.GetSeparateComponents (false).Length);
			}
		}
		...
		public void CreateByFlattening ()
		{
			...
			using (CGPath p1 = new CGPath ()) {
				p1.MoveToPoint (0, 0);
				p1.AddLineToPoint (1, 1);
				ClassicAssert.IsNotNull (p1.CreateByFlattening (new nfloat (0.5)));
			}
		}
		...
		public void DoesIntersect ()
		{
			...
			using (CGPath p1 = new CGPath ()) {
				...
				using (CGPath p2 = new CGPath ()) {
					...
					ClassicAssert.IsFalse (p1.DoesIntersect (p2, false));
					ClassicAssert.IsFalse (p1.DoesIntersect (p2, false));
				}
			}
		}
		...
		public void Bug40230 ()
		{
			...
			using (var path = CGPath.FromRoundedRect (rect, 1, 1)) {
				ClassicAssert.IsNotNull (path, "path");
			}
		}
		...
		public void IncreaseRetainCountMakeMutable ()
		{
			...
			using (CGPath p1 = new CGPath ()) {
				...
				using (var copy = p1.Copy ()) {
					...
					ClassicAssert.AreEqual (count, newRetainCount, "Ref count should not have changed.");
					ClassicAssert.AreEqual ((nint) 1, count, "Original count.");
					ClassicAssert.AreEqual ((nint) 1, newRetainCount, "New count");
				}
			}
		}
	}
