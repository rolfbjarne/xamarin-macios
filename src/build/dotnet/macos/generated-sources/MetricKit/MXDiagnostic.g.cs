	...
	public unsafe partial class MXDiagnostic : NSObject, INSCoding, INSSecureCoding {
		...
		public virtual MXSignpostRecord[]? SignpostData {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = CFArray.ArrayFromHandle<MXSignpostRecord>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selSignpostDataXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFArray.ArrayFromHandle<MXSignpostRecord>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selSignpostDataXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
