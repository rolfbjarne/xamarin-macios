...
namespace SceneKit {
	...
	public unsafe partial class SCNAction : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		[Export ("runBlock:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static SCNAction Run ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V72))]global::System.Action<SCNNode> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity1V72.CreateBlock (handler);
			BlockLiteral *block_ptr_handler = &block_handler;
			SCNAction ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static SCNAction Run ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V72))]global::System.Action<SCNNode> handler, global::CoreFoundation.DispatchQueue queue)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
		...
		public unsafe virtual global::System.Func<float, float>? TimingFunction {
			[return: DelegateProxy (typeof (ObjCRuntime.Trampolines.SDFuncArity2V6))]
			...
			get {
				...
				return global::ObjCRuntime.Trampolines.NIDFuncArity2V6.Create (ret)!;
			}
			[param: BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity2V6))]
			[Export ("setTimingFunction:", ArgumentSemantic.Assign)]
			set {
				using var block_value = Trampolines.SDFuncArity2V6.CreateNullableBlock (value);
