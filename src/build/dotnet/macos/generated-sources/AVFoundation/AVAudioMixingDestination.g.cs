...
namespace AVFoundation {
	...
	public unsafe partial class AVAudioMixingDestination : NSObject, IAVAudio3DMixing, IAVAudioMixing, IAVAudioStereoMixing {
		...
		const string selConnectionPointX = "connectionPoint";
		static readonly NativeHandle selConnectionPointXHandle = Selector.GetHandle ("connectionPoint");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual AVAudioConnectionPoint ConnectionPoint {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<AVAudioConnectionPoint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selConnectionPointXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<AVAudioConnectionPoint> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selConnectionPointXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
