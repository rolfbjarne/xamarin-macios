...
namespace CoreImage {
	...
	public partial class CIAreaAverage : CIReductionFilter {
		/// <summary>Creates a new <see cref="CIAreaAverage" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIAreaAverage () : base ("CIAreaAverage")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAreaAverage (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAreaAverage (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAreaAverage (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
