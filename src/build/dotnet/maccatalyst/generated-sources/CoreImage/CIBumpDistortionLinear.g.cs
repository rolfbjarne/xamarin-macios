...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that distorts the image around a convex or concave line.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/bump_distortion_linear.png" alt="Result of applying the filter." /></para></remarks>
	public partial class CIBumpDistortionLinear : CIDistortionFilter, ICIBumpDistortionLinearProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIBumpDistortionLinear" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIBumpDistortionLinear () : base ("CIBumpDistortionLinear")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBumpDistortionLinear (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBumpDistortionLinear (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBumpDistortionLinear (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIBumpDistortionLinearProtocol protocol members 
