...
namespace WebKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "InsertInputSuggestion", Selector = "webView:insertInputSuggestion:", ParameterType = new Type [] { typeof (WebKit.WKWebView), typeof (UIInputSuggestion) }, ParameterByRef = new bool [] { false, false })]
	public partial interface IWKUIDelegate : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RunJavaScriptConfirmPanel (WKWebView webView, string message, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V4))]global::System.Action<bool> completionHandler)
		{
			_RunJavaScriptConfirmPanel (this, webView, message, frame, completionHandler);
		}
		/// <param name="webView">To be added.</param><param name="message">To be added.</param><param name="frame">To be added.</param><param name="completionHandler">To be added.</param><summary>Shows a JavaScript confirmation dialog to the user.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _RunJavaScriptConfirmPanel (IWKUIDelegate This, WKWebView webView, string message, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V4))]global::System.Action<bool> completionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			if (message is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (message));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RunJavaScriptTextInputPanel (WKWebView webView, string prompt, string? defaultText, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V72))]global::System.Action<string> completionHandler)
		{
		...
		[EditorBrowsable (EditorBrowsableState.Never)]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _RunJavaScriptTextInputPanel (IWKUIDelegate This, WKWebView webView, string prompt, string? defaultText, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V72))]global::System.Action<string> completionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			if (prompt is null)
			...
			using var block_completionHandler = Trampolines.SDActionArity1V72.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RunOpenPanel (WKWebView webView, WKOpenPanelParameters parameters, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V262))]global::System.Action<NSUrl[]> completionHandler)
		{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _RunOpenPanel (IWKUIDelegate This, WKWebView webView, WKOpenPanelParameters parameters, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V262))]global::System.Action<NSUrl[]> completionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			...
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity1V262.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
		...
		[UnsupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void SetContextMenuConfiguration (WKWebView webView, WKContextMenuElementInfo elementInfo, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V286))]global::System.Action<global::UIKit.UIContextMenuConfiguration> completionHandler)
		{
		...
		[UnsupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _SetContextMenuConfiguration (IWKUIDelegate This, WKWebView webView, WKContextMenuElementInfo elementInfo, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V286))]global::System.Action<global::UIKit.UIContextMenuConfiguration> completionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var elementInfo__handle__ = elementInfo!.GetNonNullHandle (nameof (elementInfo));
			if (completionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completionHandler));
			using var block_completionHandler = Trampolines.SDActionArity1V286.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RequestDeviceOrientationAndMotionPermission (WKWebView webView, WKSecurityOrigin origin, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V287))]global::System.Action<WKPermissionDecision> decisionHandler)
		{
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _RequestDeviceOrientationAndMotionPermission (IWKUIDelegate This, WKWebView webView, WKSecurityOrigin origin, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V287))]global::System.Action<WKPermissionDecision> decisionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			...
			using var block_decisionHandler = Trampolines.SDActionArity1V287.CreateBlock (decisionHandler);
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RequestMediaCapturePermission (WKWebView webView, WKSecurityOrigin origin, WKFrameInfo frame, WKMediaCaptureType type, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V287))]global::System.Action<WKPermissionDecision> decisionHandler)
		{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _RequestMediaCapturePermission (IWKUIDelegate This, WKWebView webView, WKSecurityOrigin origin, WKFrameInfo frame, WKMediaCaptureType type, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V287))]global::System.Action<WKPermissionDecision> decisionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var origin__handle__ = origin!.GetNonNullHandle (nameof (origin));
			var frame__handle__ = frame!.GetNonNullHandle (nameof (frame));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ShowLockDownMode (WKWebView webView, string firstUseMessage, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V288))]global::System.Action<WKDialogResult> completionHandler)
		{
		...
		[SupportedOSPlatform ("maccatalyst16.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _ShowLockDownMode (IWKUIDelegate This, WKWebView webView, string firstUseMessage, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V288))]global::System.Action<WKDialogResult> completionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			...
			using var block_completionHandler = Trampolines.SDActionArity1V288.CreateBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = &block_completionHandler;
		...
		[UnsupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void InsertInputSuggestion (WKWebView webView, global::UIKit.UIInputSuggestion inputSuggestion)
		{
			_InsertInputSuggestion (this, webView, inputSuggestion);
		}
		[UnsupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("ios26.0")]
		[UnsupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _InsertInputSuggestion (IWKUIDelegate This, WKWebView webView, global::UIKit.UIInputSuggestion inputSuggestion)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var inputSuggestion__handle__ = inputSuggestion!.GetNonNullHandle (nameof (inputSuggestion));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("webView:insertInputSuggestion:"), webView__handle__, inputSuggestion__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (webView);
		...
		[DynamicDependencyAttribute ("InsertInputSuggestion(WebKit.WKWebView,UIKit.UIInputSuggestion)")]
	...
	public unsafe static partial class WKUIDelegate_Extensions {
		...
		/// <param name="webView">To be added.</param><param name="message">To be added.</param><param name="frame">To be added.</param><param name="completionHandler">To be added.</param><summary>Shows a JavaScript confirmation dialog to the user.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void RunJavaScriptConfirmPanel (this IWKUIDelegate This, WKWebView webView, string message, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V4))]global::System.Action<bool> completionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			if (message is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (message));
		...
		[EditorBrowsable (EditorBrowsableState.Never)]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void RunJavaScriptTextInputPanel (this IWKUIDelegate This, WKWebView webView, string prompt, string? defaultText, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V72))]global::System.Action<string> completionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			if (prompt is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (prompt));
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void RunOpenPanel (this IWKUIDelegate This, WKWebView webView, WKOpenPanelParameters parameters, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V262))]global::System.Action<NSUrl[]> completionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var parameters__handle__ = parameters!.GetNonNullHandle (nameof (parameters));
			var frame__handle__ = frame!.GetNonNullHandle (nameof (frame));
		...
		[UnsupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void SetContextMenuConfiguration (this IWKUIDelegate This, WKWebView webView, WKContextMenuElementInfo elementInfo, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V286))]global::System.Action<global::UIKit.UIContextMenuConfiguration> completionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var elementInfo__handle__ = elementInfo!.GetNonNullHandle (nameof (elementInfo));
			if (completionHandler is null)
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void RequestDeviceOrientationAndMotionPermission (this IWKUIDelegate This, WKWebView webView, WKSecurityOrigin origin, WKFrameInfo frame, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V287))]global::System.Action<WKPermissionDecision> decisionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var origin__handle__ = origin!.GetNonNullHandle (nameof (origin));
			var frame__handle__ = frame!.GetNonNullHandle (nameof (frame));
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void RequestMediaCapturePermission (this IWKUIDelegate This, WKWebView webView, WKSecurityOrigin origin, WKFrameInfo frame, WKMediaCaptureType type, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V287))]global::System.Action<WKPermissionDecision> decisionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var origin__handle__ = origin!.GetNonNullHandle (nameof (origin));
			var frame__handle__ = frame!.GetNonNullHandle (nameof (frame));
		...
		[SupportedOSPlatform ("maccatalyst16.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void ShowLockDownMode (this IWKUIDelegate This, WKWebView webView, string firstUseMessage, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V288))]global::System.Action<WKDialogResult> completionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			if (firstUseMessage is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (firstUseMessage));
		...
		[UnsupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void InsertInputSuggestion (this IWKUIDelegate This, WKWebView webView, global::UIKit.UIInputSuggestion inputSuggestion)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var inputSuggestion__handle__ = inputSuggestion!.GetNonNullHandle (nameof (inputSuggestion));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("webView:insertInputSuggestion:"), webView__handle__, inputSuggestion__handle__);
...
namespace WebKit {
	/// <summary>A delegate object that allows presenting native UI elements on behalf of a Web page.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/WebKit/Reference/WKUIDelegate_Ref/index.html">Apple documentation for <c>WKUIDelegate</c></related>
	[Protocol()]
	[Register("Microsoft_iOS__WebKit_WKUIDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
