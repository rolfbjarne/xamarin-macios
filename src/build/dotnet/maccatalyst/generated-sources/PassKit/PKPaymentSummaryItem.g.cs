...
namespace PassKit {
	...
	public unsafe partial class PKPaymentSummaryItem : NSObject {
		...
		public static PKPaymentSummaryItem Create (string label, NSDecimalNumber amount)
		{
			...
			ret =  Runtime.GetNSObject<PKPaymentSummaryItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("summaryItemWithLabel:amount:"), nslabel, amount__handle__), false)!;
			GC.KeepAlive (amount);
		...
		public static PKPaymentSummaryItem Create (string label, NSDecimalNumber amount, PKPaymentSummaryItemType type)
		{
			...
			var nslabel = CFString.CreateNative (label);
			PKPaymentSummaryItem? ret;
			ret =  Runtime.GetNSObject<PKPaymentSummaryItem> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_UIntPtr (class_ptr, Selector.GetHandle ("summaryItemWithLabel:amount:type:"), nslabel, amount__handle__, (UIntPtr) (ulong) type), false)!;
			GC.KeepAlive (amount);
			CFString.ReleaseNative (nslabel);
			return ret!;
		}
		...
		public virtual PKPaymentSummaryItemType Type {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (PassKit.PKPaymentSummaryItemType) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("type"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (PassKit.PKPaymentSummaryItemType) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("type"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
