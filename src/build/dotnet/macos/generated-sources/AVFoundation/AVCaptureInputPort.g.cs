	...
	public unsafe partial class AVCaptureInputPort : NSObject {
		...
		public virtual AVCaptureInput Input {
			...
			get {
				AVCaptureInput? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<AVCaptureInput> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selInputXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<AVCaptureInput> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selInputXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
