...
namespace WebKit {
	...
	public unsafe partial class DomStyleSheet : DomObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selOwnerNodeX = "ownerNode";
		static readonly NativeHandle selOwnerNodeXHandle = Selector.GetHandle ("ownerNode");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selParentStyleSheetX = "parentStyleSheet";
		static readonly NativeHandle selParentStyleSheetXHandle = Selector.GetHandle ("parentStyleSheet");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("DOMStyleSheet");
		...
		protected DomStyleSheet (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal DomStyleSheet (NativeHandle handle) : base (handle)
		{
		}
		...
		public virtual DomNode OwnerNode {
			...
			get {
				DomNode? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<DomNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selOwnerNodeXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<DomNode> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selOwnerNodeXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual DomStyleSheet ParentStyleSheet {
			...
			get {
				DomStyleSheet? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<DomStyleSheet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selParentStyleSheetXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<DomStyleSheet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selParentStyleSheetXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
