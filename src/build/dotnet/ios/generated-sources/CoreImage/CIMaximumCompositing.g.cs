...
#nullable enable
namespace CoreImage {
	/// <summary>The CIMaximumCompositing CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/MaxComposite.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIMaximumCompositing : CICompositingFilter {
		/// <summary>Creates a new <see cref="CIMaximumCompositing" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMaximumCompositing (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMaximumCompositing (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMaximumCompositing (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
