...
#nullable enable
namespace CoreImage {
	public abstract partial class CILinearBlur : CIFilter {
		...
		protected internal CILinearBlur (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILinearBlur (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILinearBlur (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		/// <summary>Creates a new <see cref="CILinearBlur" /> with the specified name.</summary>
		/// <param name="name">The name of the filter to create.</param>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected  CILinearBlur (string name) : base (CreateFilter (name))
		{
		}
