...
#nullable enable
namespace SceneKit {
	[Register("SCNLayer", true)]
	[UnsupportedOSPlatform ("ios")]
	[UnsupportedOSPlatform ("tvos")]
	[UnsupportedOSPlatform ("maccatalyst")]
	[ObsoletedOSPlatform ("macos10.14", "Please use Metal instead of OpenGL API.")]
	[SupportedOSPlatform ("macos")]
	public unsafe partial class SCNLayer : global::CoreAnimation.CAOpenGLLayer, ISCNSceneRenderer, ISCNTechniqueSupport {
		...
		/// <summary>Creates a new <see cref="SCNLayer" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public SCNLayer () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		public SCNLayer (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected SCNLayer (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal SCNLayer (NativeHandle handle) : base (handle)
		{
		}
		...
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("macos12.0", "Please use Metal instead of OpenGL API.")]
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
