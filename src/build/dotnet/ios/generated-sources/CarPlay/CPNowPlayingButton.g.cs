...
#nullable enable
namespace CarPlay {
	[Register("CPNowPlayingButton", true)]
	[UnsupportedOSPlatform ("tvos")]
	[UnsupportedOSPlatform ("macos")]
	[SupportedOSPlatform ("ios14.0")]
	public unsafe partial class CPNowPlayingButton : NSObject, INSCoding, INSSecureCoding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("CPNowPlayingButton");
		...
		public CPNowPlayingButton (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected CPNowPlayingButton (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CPNowPlayingButton (NativeHandle handle) : base (handle)
		{
		}

		[Export ("initWithHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe CPNowPlayingButton ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V36))]global::System.Action<CPNowPlayingButton>? handler)
		...
		/// <summary>Represents the value associated with the constant 'CPNowPlayingButtonMaximumImageSize'.</summary>
		[Field ("CPNowPlayingButtonMaximumImageSize",  "CarPlay")]
		public static CGSize MaximumImageSize {
			get {
				return Dlfcn.GetCGSize (Libraries.CarPlay.Handle, "CPNowPlayingButtonMaximumImageSize");
			}
		}
