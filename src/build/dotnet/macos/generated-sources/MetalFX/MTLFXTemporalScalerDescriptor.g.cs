...
namespace MetalFX {
	...
	public unsafe partial class MTLFXTemporalScalerDescriptor : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNewTemporalScalerWithDevice_Compiler_X = "newTemporalScalerWithDevice:compiler:";
		static readonly NativeHandle selNewTemporalScalerWithDevice_Compiler_XHandle = Selector.GetHandle ("newTemporalScalerWithDevice:compiler:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual IMTLFXTemporalScaler? Create (global::Metal.IMTLDevice device)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMTLFXTemporalScaler> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selNewTemporalScalerWithDevice_XHandle, device__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual IMTL4FXTemporalScaler? Create (global::Metal.IMTLDevice device, global::Metal.IMTL4Compiler compiler)
		{
			...
			if (IsDirectBinding) {
				ret =  Runtime.GetINativeObject<IMTL4FXTemporalScaler> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selNewTemporalScalerWithDevice_Compiler_XHandle, device__handle__, compiler__handle__), true)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetINativeObject<IMTL4FXTemporalScaler> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selNewTemporalScalerWithDevice_Compiler_XHandle, device__handle__, compiler__handle__), true)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual float InputContentMaxScale {
			...
			get {
				float ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.float_objc_msgSend (this.Handle, selInputContentMaxScaleXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.float_objc_msgSendSuper (&__objc_super__, selInputContentMaxScaleXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_float (&__objc_super__, selSetInputContentMaxScale_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual float InputContentMinScale {
			...
			get {
				float ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.float_objc_msgSend (this.Handle, selInputContentMinScaleXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.float_objc_msgSendSuper (&__objc_super__, selInputContentMinScaleXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_float (&__objc_super__, selSetInputContentMinScale_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
		...
		public virtual bool InputContentPropertiesEnabled {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper (&__objc_super__, selIsInputContentPropertiesEnabledXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret != 0;
			...
			set {
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_bool (&__objc_super__, selSetInputContentPropertiesEnabled_XHandle, value ? (byte) 1 : (byte) 0);
						GC.KeepAlive (this);
					}
				}
			}
