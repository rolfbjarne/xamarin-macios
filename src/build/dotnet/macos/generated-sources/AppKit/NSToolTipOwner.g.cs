...
namespace AppKit {
	...
	/// <summary>This interface represents the Objective-C protocol <c>NSToolTipOwner</c>.</summary>
	/// <remarks>
	...
	public partial interface INSToolTipOwner : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static string _GetStringForToolTip (INSToolTipOwner This, NSView view, nint tag, CGPoint point, nint data)
		{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSToolTipOwnerWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static INSToolTipOwner ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class NSToolTipOwnerWrapper : BaseWrapper, INSToolTipOwner {
		public NSToolTipOwnerWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (NSToolTipOwnerWrapper))]
		static NSToolTipOwnerWrapper ()
		{
			GC.KeepAlive (null);
		}
		[Export ("view:stringForToolTip:point:userData:")]
