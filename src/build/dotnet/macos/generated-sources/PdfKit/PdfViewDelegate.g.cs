...
namespace PdfKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillChangeScaleFactor", Selector = "PDFViewWillChangeScaleFactor:toScale:", ReturnType = typeof (NFloat), ParameterType = new Type [] { typeof (PdfKit.PdfView), typeof (NFloat) }, ParameterByRef = new bool [] { false, false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "TitleOfPrintJob", Selector = "PDFViewPrintJobTitle:", ReturnType = typeof (string), ParameterType = new Type [] { typeof (PdfKit.PdfView) }, ParameterByRef = new bool [] { false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "PerformPrint", Selector = "PDFViewPerformPrint:", ParameterType = new Type [] { typeof (PdfKit.PdfView) }, ParameterByRef = new bool [] { false })]
	...
	{
		/// <param name="sender">To be added.</param><param name="scale">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		...
		{
			return _WillChangeScaleFactor (this, sender, scale);
		}
		/// <param name="sender">To be added.</param><param name="scale">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("maccatalyst")]
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static nfloat _WillChangeScaleFactor (IPdfViewDelegate This, PdfView sender, nfloat scale)
		{
			var sender__handle__ = sender!.GetNonNullHandle (nameof (sender));
			nfloat ret;
			ret = global::ObjCRuntime.Messaging.nfloat_objc_msgSend_NativeHandle_nfloat (This.Handle, Selector.GetHandle ("PDFViewWillChangeScaleFactor:toScale:"), sender__handle__, scale);
			GC.KeepAlive (This);
			GC.KeepAlive (sender);
			return ret!;
		}
		...
		{
			return _TitleOfPrintJob (this, sender);
		}
		/// <param name="sender">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("ios")]
		[UnsupportedOSPlatform ("maccatalyst")]
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static string _TitleOfPrintJob (IPdfViewDelegate This, PdfView sender)
		{
			var sender__handle__ = sender!.GetNonNullHandle (nameof (sender));
			string? ret;
			ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("PDFViewPrintJobTitle:"), sender__handle__), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (sender);
			return ret!;
		}
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _PerformPrint (IPdfViewDelegate This, PdfView sender)
		{
			var sender__handle__ = sender!.GetNonNullHandle (nameof (sender));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("PDFViewPerformPrint:"), sender__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (sender);
		}
		...
		[DynamicDependencyAttribute ("PerformPrint(PdfKit.PdfView)")]
		[DynamicDependencyAttribute ("TitleOfPrintJob(PdfKit.PdfView)")]
		[DynamicDependencyAttribute ("WillChangeScaleFactor(PdfKit.PdfView,System.Runtime.InteropServices.NFloat)")]
...
namespace PdfKit {
	...
	[Register("Microsoft_macOS__PdfKit_PdfViewDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("tvos18.2")]
	[SupportedOSPlatform ("ios")]
