...
namespace UIKit {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "EnumerateTextElements", Selector = "enumerateTextElementsFromLocation:options:usingBlock:", ReturnType = typeof (INSTextLocation), ParameterType = new Type [] { typeof (INSTextLocation), typeof (NSTextContentManagerEnumerationOptions), typeof (global::System.Func<global::UIKit.NSTextElement, bool>) }, ParameterByRef = new bool [] { false, false, false }, ParameterBlockProxy = new Type? [] { null, null, typeof (ObjCRuntime.Trampolines.NIDFuncArity2V7) })]
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "Synchronize", Selector = "synchronizeToBackingStore:", ParameterType = new Type [] { typeof (global::System.Action<NSError>) }, ParameterByRef = new bool [] { false }, ParameterBlockProxy = new Type? [] { typeof (ObjCRuntime.Trampolines.NIDActionArity1V10) })]
	...
	public partial interface INSTextElementProvider : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static INSTextLocation? _EnumerateTextElements (INSTextElementProvider This, INSTextLocation? textLocation, NSTextContentManagerEnumerationOptions options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity2V7))]global::System.Func<NSTextElement, bool> handler)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _Synchronize (INSTextElementProvider This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V10))]global::System.Action<NSError>? completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
	...
	internal unsafe sealed class NSTextElementProviderWrapper : BaseWrapper, INSTextElementProvider {
		...
		[Export ("enumerateTextElementsFromLocation:options:usingBlock:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe INSTextLocation? EnumerateTextElements (INSTextLocation? textLocation, NSTextContentManagerEnumerationOptions options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity2V7))]global::System.Func<NSTextElement, bool> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var textLocation__handle__ = textLocation.GetHandle ();
			if (handler is null)
		...
		[Export ("synchronizeToBackingStore:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void Synchronize ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V10))]global::System.Action<NSError>? completionHandler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			using var block_completionHandler = Trampolines.SDActionArity1V10.CreateNullableBlock (completionHandler);
			BlockLiteral *block_ptr_completionHandler = null;
