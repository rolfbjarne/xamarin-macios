...
namespace ModelIO {
	...
	public unsafe partial class MDLMatrix4x4Array : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetDouble4x4Array_Count_X = "setDouble4x4Array:count:";
		static readonly NativeHandle selSetDouble4x4Array_Count_XHandle = Selector.GetHandle ("setDouble4x4Array:count:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetFloat4x4Array_Count_X = "setFloat4x4Array:count:";
		static readonly NativeHandle selSetFloat4x4Array_Count_XHandle = Selector.GetHandle ("setFloat4x4Array:count:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MDLMatrix4x4Array");
		...
		protected MDLMatrix4x4Array (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MDLMatrix4x4Array (NativeHandle handle) : base (handle)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal virtual void _SetDouble4x4Array (nint valuesArray, nuint count)
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr_UIntPtr (this.Handle, selSetDouble4x4Array_Count_XHandle, valuesArray, count);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr_UIntPtr (&__objc_super__, selSetDouble4x4Array_Count_XHandle, valuesArray, count);
					GC.KeepAlive (this);
				}
			}
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal virtual void _SetFloat4x4Array (nint valuesArray, nuint count)
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr_UIntPtr (this.Handle, selSetFloat4x4Array_Count_XHandle, valuesArray, count);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr_UIntPtr (&__objc_super__, selSetFloat4x4Array_Count_XHandle, valuesArray, count);
					GC.KeepAlive (this);
				}
			}
		}
