...
namespace Xamarin.MacDev.Tasks {
	...
	public abstract class XamarinTask : Task {
		...
		protected static async System.Threading.Tasks.Task<Execution> ExecuteAsync (TaskLoggingHelper log, string fileName, IList<string> arguments, string sdkDevPath = null, Dictionary<string, string> environment = null, bool mergeOutput = true, bool showErrorIfFailure = true, string workingDirectory = null)
		{
		...
		protected static ReportErrorCallback GetFileCopierReportErrorCallback (TaskLoggingHelper log)
		{
		...
		protected static void FileCopierReportErrorCallback (TaskLoggingHelper log, int code, string format, params object [] arguments)
		{
		...
		protected static LogCallback GetFileCopierLogCallback (TaskLoggingHelper log)
		{
