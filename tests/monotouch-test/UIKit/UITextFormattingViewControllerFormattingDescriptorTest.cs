	...
	public class UITextFormattingViewControllerFormattingDescriptorTest {
		...
		public void SetProperties ()
		{
			...
			Assert.Multiple (() => {
				...
				ClassicAssert.AreEqual (2, weakTestAlignments.Length, "WeakTextAlignments.Length");
				...
				ClassicAssert.AreEqual (textAlignments, obj.TextAlignments, "TextAlignments");
				...
				ClassicAssert.AreEqual (2, weakTextLists.Length, "WeakTextLists.Length");
				...
				ClassicAssert.AreEqual (textLists, obj.TextLists, "TextLists");
				...
				ClassicAssert.AreEqual (2, weakHighlights.Length, "WeakHighlights.Length");
				...
				ClassicAssert.AreEqual (highlights, obj.Highlights, "Highlights");
			});
		}
		...
		{
			using (UIWindow w = new UIWindow ()) {
				ClassicAssert.False (w.IsKeyWindow, "IsKeyWindow");
			}
		}
