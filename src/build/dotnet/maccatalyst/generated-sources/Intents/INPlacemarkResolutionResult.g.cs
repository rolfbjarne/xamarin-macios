...
namespace Intents {
	...
	public unsafe partial class INPlacemarkResolutionResult : INIntentResolutionResult {
		...
		public static INPlacemarkResolutionResult GetConfirmationRequired (global::CoreLocation.CLPlacemark? placemarkToConfirm)
		{
			...
			ret =  Runtime.GetNSObject<INPlacemarkResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("confirmationRequiredWithPlacemarkToConfirm:"), placemarkToConfirm__handle__), false)!;
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INPlacemarkResolutionResult GetConfirmationRequired (NSObject itemToConfirm, nint reason)
		{
			var itemToConfirm__handle__ = itemToConfirm!.GetNonNullHandle (nameof (itemToConfirm));
			INPlacemarkResolutionResult? ret;
			ret =  Runtime.GetNSObject<INPlacemarkResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_IntPtr (class_ptr, Selector.GetHandle ("confirmationRequiredWithItemToConfirm:forReason:"), itemToConfirm__handle__, reason), false)!;
		...
		public static INPlacemarkResolutionResult GetDisambiguation (global::CoreLocation.CLPlacemark[] placemarksToDisambiguate)
		{
			...
			INPlacemarkResolutionResult ret;
			ret =  Runtime.GetNSObject<INPlacemarkResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("disambiguationWithPlacemarksToDisambiguate:"), nsa_placemarksToDisambiguate.Handle), false)!;
			return ret;
		}
		...
		public static INPlacemarkResolutionResult GetSuccess (global::CoreLocation.CLPlacemark resolvedPlacemark)
		{
			...
			INPlacemarkResolutionResult? ret;
			ret =  Runtime.GetNSObject<INPlacemarkResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("successWithResolvedPlacemark:"), resolvedPlacemark__handle__), false)!;
		...
		[UnsupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INPlacemarkResolutionResult GetUnsupported (nint reason)
		{
			INPlacemarkResolutionResult ret;
			ret =  Runtime.GetNSObject<INPlacemarkResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("unsupportedWithReason:"), reason), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INPlacemarkResolutionResult NeedsValue {
			...
			get {
				INPlacemarkResolutionResult? ret;
				ret =  Runtime.GetNSObject<INPlacemarkResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("needsValue")), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INPlacemarkResolutionResult NotRequired {
			...
			get {
				INPlacemarkResolutionResult? ret;
				ret =  Runtime.GetNSObject<INPlacemarkResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("notRequired")), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public new static INPlacemarkResolutionResult Unsupported {
			...
			get {
				INPlacemarkResolutionResult? ret;
				ret =  Runtime.GetNSObject<INPlacemarkResolutionResult> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, Selector.GetHandle ("unsupported")), false)!;
				return ret!;
			}
		}
