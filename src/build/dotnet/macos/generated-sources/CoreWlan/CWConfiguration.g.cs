...
namespace CoreWlan {
	...
	public unsafe partial class CWConfiguration : NSObject, INSCoding, INSCopying, INSMutableCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selConfigurationWithConfiguration_X = "configurationWithConfiguration:";
		static readonly NativeHandle selConfigurationWithConfiguration_XHandle = Selector.GetHandle ("configurationWithConfiguration:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selIsEqualToConfiguration_X = "isEqualToConfiguration:";
		static readonly NativeHandle selIsEqualToConfiguration_XHandle = Selector.GetHandle ("isEqualToConfiguration:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("CWConfiguration");
		...
		/// <summary>Creates a new <see cref="CWConfiguration" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected CWConfiguration (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CWConfiguration (NativeHandle handle) : base (handle)
		{
		}
		...
		{
			CWConfiguration ret;
			ret =  Runtime.GetNSObject<CWConfiguration> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selConfigurationXHandle), false)!;
			return ret;
		}
		...
		public static CWConfiguration Create (CWConfiguration configuration)
		{
			var configuration__handle__ = configuration!.GetNonNullHandle (nameof (configuration));
			CWConfiguration? ret;
			ret =  Runtime.GetNSObject<CWConfiguration> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selConfigurationWithConfiguration_XHandle, configuration__handle__), false)!;
			GC.KeepAlive (configuration);
			return ret!;
		}
		...
		/// <param name="configuration">To be added.</param><summary>To be added.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		...
		public virtual bool IsEqualToConfiguration (CWConfiguration configuration)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (this.Handle, selIsEqualToConfiguration_XHandle, configuration__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, selIsEqualToConfiguration_XHandle, configuration__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (configuration);
		...
		internal virtual NSOrderedSet _NetworkProfiles {
			...
			get {
				NSOrderedSet? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSOrderedSet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selNetworkProfilesXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSOrderedSet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selNetworkProfilesXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
