...
namespace CoreImage {
	...
	public partial class CICircularWrap : CIFilter, ICICircularWrapProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CICircularWrap" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CICircularWrap () : base ("CICircularWrap")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CICircularWrap (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CICircularWrap (NSObjectFlag t) : base (t)
		{
		}
		...
		public CICircularWrap (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
