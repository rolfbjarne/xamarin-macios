	...
	public unsafe partial class LARight : NSObject {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithRequirement:"), requirement__handle__), "initWithRequirement:");
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual void Authorize (string localizedReason, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDLARightAuthorizeCompletionHandler))]LARightAuthorizeCompletionHandler handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("authorizeWithLocalizedReason:completion:"), nslocalizedReason, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		...
		[SupportedOSPlatform ("macos13.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void Authorize (string localizedReason, global::UIKit.UIWindow presentationContext, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDLARightAuthorizeCompletionHandler))]LARightAuthorizeCompletionHandler handler)
		{
			if (localizedReason is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (localizedReason));
			...
			BlockLiteral *block_ptr_handler = &block_handler;
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("authorizeWithLocalizedReason:inPresentationContext:completion:"), nslocalizedReason, presentationContext__handle__, (IntPtr) block_ptr_handler);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("authorizeWithLocalizedReason:inPresentationContext:completion:"), nslocalizedReason, presentationContext__handle__, (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		...
		[SupportedOSPlatform ("macos13.0")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual Task AuthorizeAsync (string localizedReason, global::UIKit.UIWindow presentationContext)
		{
			var tcs = new TaskCompletionSource<bool> ();
		...
		public unsafe virtual void CheckCanAuthorize ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDLARightAuthorizeCompletionHandler))]LARightAuthorizeCompletionHandler handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("checkCanAuthorizeWithCompletion:"), (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public unsafe virtual void Deauthorize ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDAction))]global::System.Action handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("deauthorizeWithCompletion:"), (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual LARightState State {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (LocalAuthentication.LARightState) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("state"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
