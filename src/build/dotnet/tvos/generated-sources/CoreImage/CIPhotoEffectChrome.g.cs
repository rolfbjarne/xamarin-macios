...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that exaggerates color of the image producing a vintage look.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/photo_effect_chrome.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIPhotoEffectChrome : CIPhotoEffect {
		/// <summary>Creates a new <see cref="CIPhotoEffectChrome" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPhotoEffectChrome () : base ("CIPhotoEffectChrome")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPhotoEffectChrome (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPhotoEffectChrome (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPhotoEffectChrome (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
