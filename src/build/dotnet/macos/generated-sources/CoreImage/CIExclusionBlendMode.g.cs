...
#nullable enable
namespace CoreImage {
	/// <summary>The CIExclusionBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/ExclusionBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIExclusionBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIExclusionBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIExclusionBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIExclusionBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIExclusionBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
