...
namespace HomeKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidReceiveAddAccessoryRequest", Selector = "homeManager:didReceiveAddAccessoryRequest:", ParameterType = new Type [] { typeof (HomeKit.HMHomeManager), typeof (HomeKit.HMAddAccessoryRequest) }, ParameterByRef = new bool [] { false, false })]
	...
	public partial interface IHMHomeManagerDelegate : INativeObject, IDisposable
	{
		...
		[ObsoletedOSPlatform ("ios15.0", "This method is no longer supported.")]
		[ObsoletedOSPlatform ("maccatalyst15.0", "This method is no longer supported.")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void DidReceiveAddAccessoryRequest (HMHomeManager manager, HMAddAccessoryRequest request)
		{
			_DidReceiveAddAccessoryRequest (this, manager, request);
		}
		[SupportedOSPlatform ("ios13.0")]
		[UnsupportedOSPlatform ("tvos")]
		[UnsupportedOSPlatform ("macos")]
		...
		[ObsoletedOSPlatform ("maccatalyst15.0", "This method is no longer supported.")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _DidReceiveAddAccessoryRequest (IHMHomeManagerDelegate This, HMHomeManager manager, HMAddAccessoryRequest request)
		{
			var manager__handle__ = manager!.GetNonNullHandle (nameof (manager));
			var request__handle__ = request!.GetNonNullHandle (nameof (request));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("homeManager:didReceiveAddAccessoryRequest:"), manager__handle__, request__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (manager);
		...
		[DynamicDependencyAttribute ("DidReceiveAddAccessoryRequest(HomeKit.HMHomeManager,HomeKit.HMAddAccessoryRequest)")]
...
namespace HomeKit {
	/// <summary>Delegate object for <see cref="T:HomeKit.HMHomeManager" /> objects, provides methods that can be overridden to react to <see cref="T:HomeKit.HMHome" />s being added, removed, or set as the primary home.</summary><remarks>To be added.</remarks><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/HomeKit/Reference/HMHomeManagerDelegate_Protocol/index.html">Apple documentation for <c>HMHomeManagerDelegate</c></related>
	[Protocol()]
	[Register("Microsoft_iOS__HomeKit_HMHomeManagerDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("tvos")]
