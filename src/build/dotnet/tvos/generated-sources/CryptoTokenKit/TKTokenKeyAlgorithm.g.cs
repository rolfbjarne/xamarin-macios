	...
	public unsafe partial class TKTokenKeyAlgorithm : NSObject {
		...
		public virtual bool IsAlgorithm ([BindAs (typeof (global::Security.SecKeyAlgorithm), OriginalType = typeof (NSString))] global::Security.SecKeyAlgorithm algorithm)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					...
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("isAlgorithm:"), nsb_algorithm.GetHandle ());
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
		...
		public virtual bool SupportsAlgorithm ([BindAs (typeof (global::Security.SecKeyAlgorithm), OriginalType = typeof (NSString))] global::Security.SecKeyAlgorithm algorithm)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("supportsAlgorithm:"), nsb_algorithm.GetHandle ());
					GC.KeepAlive (this);
				}
			}
			return ret != 0;
