...
namespace PassKit {
	...
	public unsafe partial class PKPaymentAuthorizationViewController : global::UIKit.UIViewController {
		...
		internal class _PKPaymentAuthorizationViewControllerDelegate : NSObject, IPKPaymentAuthorizationViewControllerDelegate { 
			...
			internal EventHandler<PKPaymentShippingAddressSelectedEventArgs>? didSelectShippingAddress;
			[Export ("paymentAuthorizationViewController:didSelectShippingAddress:completion:")]
			public void DidSelectShippingAddress (PassKit.PKPaymentAuthorizationViewController controller, ABRecord address, PassKit.PKPaymentShippingAddressSelected completion)
			{
				var handler = didSelectShippingAddress;
				if (handler is not null){
					var args = new PKPaymentShippingAddressSelectedEventArgs (address, completion);
					handler (controller, args);
				}
			}
		...
		/// <summary>Event raised by the object.</summary>
		/// <remarks>If developers do not assign a value to this event, this will reset the value for the Delegate property to an internal handler that maps delegates to events.</remarks>
		public event EventHandler<PKPaymentShippingAddressSelectedEventArgs> DidSelectShippingAddress {
			add { EnsurePKPaymentAuthorizationViewControllerDelegate ()!.didSelectShippingAddress += value; }
			remove { EnsurePKPaymentAuthorizationViewControllerDelegate ()!.didSelectShippingAddress -= value; }
		}
		/// <summary>Event raised by the object.</summary>
		/// <remarks>If developers do not assign a value to this event, this will reset the value for the Delegate property to an internal handler that maps delegates to events.</remarks>
	...
	/// <summary>Provides data for an event based on an Objective-C protocol method.</summary>
	public partial class PKPaymentShippingAddressSelectedEventArgs : EventArgs {
		/// <summary>Create a new instance of the <see cref="PKPaymentShippingAddressSelectedEventArgs" /> with the specified event data.</summary>
		/// <param name="address">The value for the <see cref="Address" /> property.</param>
		/// <param name="completion">The value for the <see cref="Completion" /> property.</param>
		public PKPaymentShippingAddressSelectedEventArgs (ABRecord address, PassKit.PKPaymentShippingAddressSelected completion)
		{
			this.Address = address;
			this.Completion = completion;
		}
		public ABRecord Address { get; set; }
		public PassKit.PKPaymentShippingAddressSelected Completion { get; set; }
	}
	/// <summary>Provides data for an event based on an Objective-C protocol method.</summary>
