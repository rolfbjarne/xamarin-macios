...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIAffineFilter" /> that extends the border pixels to the post-transform boundaries.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 		</para><para><img href="~/xml/CoreImage/_images/affine_clamp.png" alt="Result of applying the filter." /></para><para>
	...
	/// 		</para></remarks>
	public partial class CIAffineClamp : CIAffineFilter, ICIAffineClampProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIAffineClamp" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIAffineClamp (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIAffineClamp (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIAffineClamp (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIAffineClampProtocol protocol members 
