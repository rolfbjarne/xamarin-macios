...
namespace StoreKit {
	...
	public unsafe partial class SKDownload : NSObject {
		...
		const string selContentIdentifierX = "contentIdentifier";
		static readonly NativeHandle selContentIdentifierXHandle = Selector.GetHandle ("contentIdentifier");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selContentURLForProductID_X = "contentURLForProductID:";
		static readonly NativeHandle selContentURLForProductID_XHandle = Selector.GetHandle ("contentURLForProductID:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDeleteContentForProductID_X = "deleteContentForProductID:";
		static readonly NativeHandle selDeleteContentForProductID_XHandle = Selector.GetHandle ("deleteContentForProductID:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selErrorX = "error";
		static readonly NativeHandle selErrorXHandle = Selector.GetHandle ("error");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selExpectedContentLengthX = "expectedContentLength";
		static readonly NativeHandle selExpectedContentLengthXHandle = Selector.GetHandle ("expectedContentLength");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selTimeRemainingX = "timeRemaining";
		static readonly NativeHandle selTimeRemainingXHandle = Selector.GetHandle ("timeRemaining");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static void DeleteContentForProduct (string productId)
		{
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (class_ptr, selDeleteContentForProductID_XHandle, nsproductId);
		...
		public static NSUrl? GetContentUrlForProduct (string productId)
		{
			...
			var nsproductId = CFString.CreateNative (productId);
			NSUrl? ret;
			ret =  Runtime.GetNSObject<NSUrl> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selContentURLForProductID_XHandle, nsproductId), false)!;
			CFString.ReleaseNative (nsproductId);
			return ret!;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual string ContentIdentifier {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selContentIdentifierXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selContentIdentifierXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		[ObsoletedOSPlatform ("macos10.15", "Use 'ExpectedContentLength' instead.")]
		[ObsoletedOSPlatform ("ios16.0")]
		[ObsoletedOSPlatform ("tvos16.0")]
		[ObsoletedOSPlatform ("maccatalyst16.0")]
		[SupportedOSPlatform ("macos")]
		public virtual NSNumber ContentLength {
			...
			get {
				NSNumber? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSNumber> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selContentLengthXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSNumber> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selContentLengthXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual long ExpectedContentLength {
			...
			get {
				long ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.Int64_objc_msgSend (this.Handle, selExpectedContentLengthXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.Int64_objc_msgSendSuper (&__objc_super__, selExpectedContentLengthXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual SKDownloadState State {
			...
			get {
				SKDownloadState ret;
				if (IsDirectBinding) {
					ret = (StoreKit.SKDownloadState) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, selStateXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (StoreKit.SKDownloadState) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, selStateXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual double TimeRemaining {
			...
			get {
				double ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.Double_objc_msgSend (this.Handle, selTimeRemainingXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.Double_objc_msgSendSuper (&__objc_super__, selTimeRemainingXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual SKPaymentTransaction Transaction {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<SKPaymentTransaction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selTransactionXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<SKPaymentTransaction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selTransactionXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
