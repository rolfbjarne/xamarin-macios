...
namespace AVFoundation {
	...
	public unsafe partial class AVAssetExportSession : NSObject {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void DetermineCompatibilityOfExportPreset (string presetName, AVAsset asset, string? outputFileType, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V4))]global::System.Action<bool> isCompatibleResult)
		{
			if (presetName is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (presetName));
			var asset__handle__ = asset!.GetNonNullHandle (nameof (asset));
			...
			using var block_isCompatibleResult = Trampolines.SDActionArity1V4.CreateBlock (isCompatibleResult);
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DetermineCompatibleFileTypes ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V5))]global::System.Action<string[]> compatibleFileTypesHandler)
		{
			...
			using var block_compatibleFileTypesHandler = Trampolines.SDActionArity1V5.CreateBlock (compatibleFileTypesHandler);
		...
		public unsafe virtual void EstimateOutputFileLength ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V14))]global::System.Action<long, NSError> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity2V14.CreateBlock (handler);
			BlockLiteral *block_ptr_handler = &block_handler;
			if (IsDirectBinding) {
