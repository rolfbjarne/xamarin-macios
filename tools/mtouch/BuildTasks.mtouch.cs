...
namespace Xamarin.Bundler
{
	...
	public class NativeLinkTask : BuildTask
	{
		...
		protected override async Task ExecuteAsync ()
		{
			...
			var code = await Driver.RunCommandAsync (Driver.CompilerPath, CompilerFlags.ToString (), null, output);
	...
	public class CompileTask : BuildTask
	{
		...
		public static void GetSimulatorCompilerFlags (CompilerFlags flags, bool is_assembler, Application app, string language = null)
		{
			...
			if (Driver.SDKVersion == new Version ())
				throw ErrorHelper.CreateError (25, "No SDK version was provided. Please add --sdk=X.Y to specify which iOS SDK should be used to build your application.");
