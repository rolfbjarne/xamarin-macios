...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIFilter" /> that pixelates the original image.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CIPixellate filter with the input image
	/// var pixellate = new CIPixellate () {
	/// 	Image = flower,
	/// };
	/// 
	/// // Get the altered image from the filter
	/// var output = pixellate.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/pixellate.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIPixellate : CIFilter, ICIPixellateProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIPixellate" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPixellate (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPixellate (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPixellate (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIPixellateProtocol protocol members 
