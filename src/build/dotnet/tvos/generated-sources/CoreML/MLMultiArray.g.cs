...
namespace CoreML {
	...
	public unsafe partial class MLMultiArray : NSObject, INSCoding, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe MLMultiArray (nint dataPointer, NSNumber[] shape, MLMultiArrayDataType dataType, NSNumber[] strides, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V25))]global::System.Action<nint>? deallocator, out NSError error)
			: base (NSObjectFlag.Empty)
		{
			if (shape is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (shape));
			...
			using var nsa_shape = NSArray.FromNSObjects (shape);
			using var nsa_strides = NSArray.FromNSObjects (strides);
			using var block_deallocator = Trampolines.SDActionArity1V25.CreateNullableBlock (deallocator);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetBytes ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V49))]global::System.Action<nint, nint> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity2V49.CreateBlock (handler);
