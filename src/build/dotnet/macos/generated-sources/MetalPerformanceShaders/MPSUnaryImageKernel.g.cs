...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSUnaryImageKernel : MPSKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_InPlaceTexture_FallbackCopyAllocator_X = "encodeToCommandBuffer:inPlaceTexture:fallbackCopyAllocator:";
		static readonly NativeHandle selEncodeToCommandBuffer_InPlaceTexture_FallbackCopyAllocator_XHandle = Selector.GetHandle ("encodeToCommandBuffer:inPlaceTexture:fallbackCopyAllocator:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_SourceTexture_DestinationTexture_X = "encodeToCommandBuffer:sourceTexture:destinationTexture:";
		static readonly NativeHandle selEncodeToCommandBuffer_SourceTexture_DestinationTexture_XHandle = Selector.GetHandle ("encodeToCommandBuffer:sourceTexture:destinationTexture:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public unsafe virtual bool EncodeToCommandBuffer (global::Metal.IMTLCommandBuffer commandBuffer, out NSObject texture, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMPSCopyAllocator))]MPSCopyAllocator? copyAllocator)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_ref_NativeHandle_NativeHandle (this.Handle, selEncodeToCommandBuffer_InPlaceTexture_FallbackCopyAllocator_XHandle, commandBuffer__handle__, &textureValue, (IntPtr) block_ptr_copyAllocator);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle_ref_NativeHandle_NativeHandle (&__objc_super__, selEncodeToCommandBuffer_InPlaceTexture_FallbackCopyAllocator_XHandle, commandBuffer__handle__, &textureValue, (IntPtr) block_ptr_copyAllocator);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void EncodeToCommandBuffer (global::Metal.IMTLCommandBuffer commandBuffer, global::Metal.IMTLTexture sourceTexture, global::Metal.IMTLTexture destinationTexture)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeToCommandBuffer_SourceTexture_DestinationTexture_XHandle, commandBuffer__handle__, sourceTexture__handle__, destinationTexture__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeToCommandBuffer_SourceTexture_DestinationTexture_XHandle, commandBuffer__handle__, sourceTexture__handle__, destinationTexture__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
