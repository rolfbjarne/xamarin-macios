...
namespace WebKit {
	...
	public partial interface IWKNavigationDelegate : INativeObject, IDisposable
	{
		...
		public unsafe virtual void DecidePolicy (WKWebView webView, WKNavigationAction navigationAction, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V129))]global::System.Action<WKNavigationActionPolicy> decisionHandler)
		{
			_DecidePolicy (this, webView, navigationAction, decisionHandler);
		}
		/// <param name="webView">To be added.</param><param name="navigationAction">To be added.</param><param name="decisionHandler">To be added.</param><summary>Assigns an action to be taken after the specified <paramref name="navigationAction" /> has been either canceled or allowed.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _DecidePolicy (IWKNavigationDelegate This, WKWebView webView, WKNavigationAction navigationAction, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V129))]global::System.Action<WKNavigationActionPolicy> decisionHandler)
		{
			...
			using var block_decisionHandler = Trampolines.SDActionArity1V129.CreateBlock (decisionHandler);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DecidePolicy (WKWebView webView, WKNavigationResponse navigationResponse, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V130))]global::System.Action<WKNavigationResponsePolicy> decisionHandler)
		{
			_DecidePolicy (this, webView, navigationResponse, decisionHandler);
		}
		/// <param name="webView">To be added.</param><param name="navigationResponse">To be added.</param><param name="decisionHandler">To be added.</param><summary>Assigns an action to be taken after the specified <paramref name="navigationResponse" /> has been either canceled or allowed.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _DecidePolicy (IWKNavigationDelegate This, WKWebView webView, WKNavigationResponse navigationResponse, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V130))]global::System.Action<WKNavigationResponsePolicy> decisionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var navigationResponse__handle__ = navigationResponse!.GetNonNullHandle (nameof (navigationResponse));
			if (decisionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (decisionHandler));
			using var block_decisionHandler = Trampolines.SDActionArity1V130.CreateBlock (decisionHandler);
			BlockLiteral *block_ptr_decisionHandler = &block_decisionHandler;
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void DecidePolicy (WKWebView webView, WKNavigationAction navigationAction, WKWebpagePreferences preferences, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V153))]global::System.Action<WKNavigationActionPolicy, WKWebpagePreferences> decisionHandler)
		{
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _DecidePolicy (IWKNavigationDelegate This, WKWebView webView, WKNavigationAction navigationAction, WKWebpagePreferences preferences, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V153))]global::System.Action<WKNavigationActionPolicy, WKWebpagePreferences> decisionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var navigationAction__handle__ = navigationAction!.GetNonNullHandle (nameof (navigationAction));
			...
			if (decisionHandler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (decisionHandler));
			using var block_decisionHandler = Trampolines.SDActionArity2V153.CreateBlock (decisionHandler);
			BlockLiteral *block_ptr_decisionHandler = &block_decisionHandler;
	...
	public unsafe static partial class WKNavigationDelegate_Extensions {
		/// <param name="webView">To be added.</param><param name="navigationAction">To be added.</param><param name="decisionHandler">To be added.</param><summary>Assigns an action to be taken after the specified <paramref name="navigationAction" /> has been either canceled or allowed.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void DecidePolicy (this IWKNavigationDelegate This, WKWebView webView, WKNavigationAction navigationAction, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V129))]global::System.Action<WKNavigationActionPolicy> decisionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var navigationAction__handle__ = navigationAction!.GetNonNullHandle (nameof (navigationAction));
			if (decisionHandler is null)
		...
		/// <param name="webView">To be added.</param><param name="navigationResponse">To be added.</param><param name="decisionHandler">To be added.</param><summary>Assigns an action to be taken after the specified <paramref name="navigationResponse" /> has been either canceled or allowed.</summary><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void DecidePolicy (this IWKNavigationDelegate This, WKWebView webView, WKNavigationResponse navigationResponse, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V130))]global::System.Action<WKNavigationResponsePolicy> decisionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var navigationResponse__handle__ = navigationResponse!.GetNonNullHandle (nameof (navigationResponse));
			if (decisionHandler is null)
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void DecidePolicy (this IWKNavigationDelegate This, WKWebView webView, WKNavigationAction navigationAction, WKWebpagePreferences preferences, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V153))]global::System.Action<WKNavigationActionPolicy, WKWebpagePreferences> decisionHandler)
		{
			var webView__handle__ = webView!.GetNonNullHandle (nameof (webView));
			var navigationAction__handle__ = navigationAction!.GetNonNullHandle (nameof (navigationAction));
			var preferences__handle__ = preferences!.GetNonNullHandle (nameof (preferences));
...
namespace WebKit {
	/// <summary>Delegate object for <see cref="T:WebKit.WKNavigation" /> objects, provides methods relating to navigation and load policies.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/WebKit/Reference/WKNavigationDelegate_Ref/index.html">Apple documentation for <c>WKNavigationDelegate</c></related>
	[Protocol()]
	[Register("Microsoft_macOS__WebKit_WKNavigationDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
