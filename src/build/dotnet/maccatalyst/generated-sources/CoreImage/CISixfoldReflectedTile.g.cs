...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CITileFilter" /> that applies 6-way reflected symmetry.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CISixfoldReflectedTile filter with the input image
	/// var sixfold_reflected_tile = new CISixfoldReflectedTile () {
	/// 	Image = flower
	/// };
	/// 
	/// // Get the altered image from the filter
	/// var output = new CICrop {
	/// 	Image = sixfold_reflected_tile.OutputImage,
	...
	/// </para><para><img href="~/xml/CoreImage/_images/sixfold_reflected_tile.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CISixfoldReflectedTile : CITileFilter, ICISixfoldReflectedTileProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CISixfoldReflectedTile" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISixfoldReflectedTile (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISixfoldReflectedTile (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISixfoldReflectedTile (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CISixfoldReflectedTileProtocol protocol members 
