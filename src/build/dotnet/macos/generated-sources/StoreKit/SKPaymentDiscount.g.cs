...
namespace StoreKit {
	...
	public unsafe partial class SKPaymentDiscount : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithIdentifier_KeyIdentifier_Nonce_Signature_Timestamp_X = "initWithIdentifier:keyIdentifier:nonce:signature:timestamp:";
		static readonly NativeHandle selInitWithIdentifier_KeyIdentifier_Nonce_Signature_Timestamp_XHandle = Selector.GetHandle ("initWithIdentifier:keyIdentifier:nonce:signature:timestamp:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selInitWithIdentifier_KeyIdentifier_Nonce_Signature_Timestamp_XHandle, nsidentifier, nskeyIdentifier, nonce__handle__, nssignature, timestamp__handle__), "initWithIdentifier:keyIdentifier:nonce:signature:timestamp:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selInitWithIdentifier_KeyIdentifier_Nonce_Signature_Timestamp_XHandle, nsidentifier, nskeyIdentifier, nonce__handle__, nssignature, timestamp__handle__), "initWithIdentifier:keyIdentifier:nonce:signature:timestamp:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (nonce);
		...
		public virtual NSUuid Nonce {
			...
			get {
				NSUuid? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSUuid> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selNonceXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSUuid> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selNonceXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual string Signature {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selSignatureXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selSignatureXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual NSNumber Timestamp {
			...
			get {
				NSNumber? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSNumber> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selTimestampXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSNumber> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selTimestampXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
