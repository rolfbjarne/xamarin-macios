...
namespace CryptoTokenKit {
	...
	public unsafe partial class TKTokenAuthOperation : NSObject, INSCoding, INSSecureCoding {
		...
		public unsafe virtual bool Finish (out NSError? error)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_ref_NativeHandle (this.Handle, selFinishWithError_XHandle, &errorValue);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_ref_NativeHandle (&__objc_super__, selFinishWithError_XHandle, &errorValue);
					GC.KeepAlive (this);
				}
			}
