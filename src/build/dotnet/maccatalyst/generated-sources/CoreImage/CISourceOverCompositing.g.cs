...
#nullable enable
namespace CoreImage {
	/// <summary>The CISourceOverCompositing CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/SourceOver.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CISourceOverCompositing : CICompositingFilter {
		/// <summary>Creates a new <see cref="CISourceOverCompositing" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISourceOverCompositing (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISourceOverCompositing (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISourceOverCompositing (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
