...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIAreaReductionFilter</c>.</summary>
	/// <remarks>
		...
		CoreImage.ICIFilterProtocol
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIAreaReductionFilterProtocolWrapper))]
	...
	internal unsafe sealed class CIAreaReductionFilterProtocolWrapper : BaseWrapper, ICIAreaReductionFilterProtocol {
		public CIAreaReductionFilterProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIAreaReductionFilterProtocolWrapper))]
		static CIAreaReductionFilterProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets or sets an image to filter.</summary>
