...
#nullable enable
namespace HealthKit {
	/// <summary>A provider of health data, such as a particular sensor or application.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/HealthKit/Reference/HKSource_Class/index.html">Apple documentation for <c>HKSource</c></related>
	...
	public unsafe partial class HKSource : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selDefaultSourceX = "defaultSource";
		static readonly NativeHandle selDefaultSourceXHandle = Selector.GetHandle ("defaultSource");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("HKSource");
		...
		public HKSource (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected HKSource (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal HKSource (NativeHandle handle) : base (handle)
		{
		}
		...
		public static HKSource GetDefaultSource {
			...
			get {
				HKSource? ret;
				ret =  Runtime.GetNSObject<HKSource> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selDefaultSourceXHandle), false)!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
