...
namespace CoreImage {
	...
	public partial class CIKaleidoscope : CIFilter, ICIKaleidoscopeProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIKaleidoscope" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIKaleidoscope () : base ("CIKaleidoscope")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIKaleidoscope (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIKaleidoscope (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIKaleidoscope (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIKaleidoscopeProtocol protocol members 
