...
#nullable enable
namespace CoreImage {
	/// <summary>The CISourceInCompositing CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// 
	/// // Construct the SourceInComposite filter        
	...
	/// var output = sourceComposite.OutputImage;
	/// 	
	...
	/// </para><para><img href="~/xml/CoreImage/_images/SourceIn.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CISourceInCompositing : CICompositingFilter {
		/// <summary>Creates a new <see cref="CISourceInCompositing" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CISourceInCompositing (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CISourceInCompositing (NSObjectFlag t) : base (t)
		{
		}
		...
		public CISourceInCompositing (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
