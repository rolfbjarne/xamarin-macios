...
namespace AVFoundation {
	...
	public unsafe static partial class AVComposition_AVCompositionTrackInspection  {
		...
		public static AVCompositionTrack? GetTrack (this AVComposition This, int trackID)
		{
			...
			ret =  Runtime.GetNSObject<AVCompositionTrack> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_int (This.Handle, selTrackWithTrackID_XHandle, trackID), false)!;
			GC.KeepAlive (This);
			return ret;
		}
		...
		public static AVCompositionTrack[] GetTracks (this AVComposition This, string mediaType)
		{
			...
			AVCompositionTrack[]? ret;
			ret = CFArray.ArrayFromHandle<AVCompositionTrack>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (This.Handle, selTracksWithMediaType_XHandle, nsmediaType), false)!;
			GC.KeepAlive (This);
		...
		public static AVCompositionTrack[] GetTracksWithMediaCharacteristic (this AVComposition This, string mediaCharacteristic)
		{
			...
			AVCompositionTrack[]? ret;
			ret = CFArray.ArrayFromHandle<AVCompositionTrack>(global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (This.Handle, selTracksWithMediaCharacteristic_XHandle, nsmediaCharacteristic), false)!;
			GC.KeepAlive (This);
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void LoadTrack (this AVComposition This, int trackId, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V15))]global::System.Action<AVMutableCompositionTrack, NSError> completionHandler)
		{
