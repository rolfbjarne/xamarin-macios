...
namespace MediaAccessibility {
	...
	public unsafe static partial class MAAudibleMedia  {
		...
		///
		/// // listening
		/// notification = MAAudibleMedia.Notifications.ObserveSettingsChanged ((sender, args) => {
		...
		/// void Callback (object sender, MAAudibleMedia.NSNotificationEventArgs args)
		/// {
		///     // Access strongly typed args
		///     Console.WriteLine ("Notification: {0}", args.Notification);
		/// }
		...
		/// void Setup ()
		/// {
		///     notification = MAAudibleMedia.Notifications.ObserveSettingsChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		///     MAAudibleMedia.SettingsChangedNotification, (notification) => { Console.WriteLine ("Received the notification SettingsChanged", notification); }
		/// );
		///
		/// // Method style
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (MAAudibleMedia.SettingsChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		// Notifications
		//
		/// <summary>Notifications posted by the <see cref="global::MediaAccessibility.MAAudibleMedia" /> class.</summary>
		/// <remarks>
		///    <para>This class contains various helper methods that allow developers to observe events posted in the notification hub (<see cref="Foundation.NSNotificationCenter" />).</para>
		///    <para>The methods defined in this class post events that invoke the provided method or lambda with a <see cref="Foundation.NSNotificationEventArgs" /> parameter, which contains strongly typed properties for the notification arguments.</para>
		/// </remarks>
		public static partial class Notifications {
			/// <summary>Strongly typed notification for the <see cref="global::MediaAccessibility.MAAudibleMedia.SettingsChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::MediaAccessibility.MAAudibleMedia.SettingsChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = MAAudibleMedia.Notifications.ObserveSettingsChanged ((notification) => {
			...
			/// var token = MAAudibleMedia.Notifications.ObserveSettingsChanged (objectToObserve, (notification) => {
