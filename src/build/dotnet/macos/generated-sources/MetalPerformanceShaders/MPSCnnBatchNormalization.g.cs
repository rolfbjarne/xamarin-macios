...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSCnnBatchNormalization : MPSCnnKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeBatchToCommandBuffer_SourceImages_BatchNormalizationState_DestinationImages_X = "encodeBatchToCommandBuffer:sourceImages:batchNormalizationState:destinationImages:";
		static readonly NativeHandle selEncodeBatchToCommandBuffer_SourceImages_BatchNormalizationState_DestinationImages_XHandle = Selector.GetHandle ("encodeBatchToCommandBuffer:sourceImages:batchNormalizationState:destinationImages:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_SourceImage_BatchNormalizationState_DestinationImage_X = "encodeToCommandBuffer:sourceImage:batchNormalizationState:destinationImage:";
		static readonly NativeHandle selEncodeToCommandBuffer_SourceImage_BatchNormalizationState_DestinationImage_XHandle = Selector.GetHandle ("encodeToCommandBuffer:sourceImage:batchNormalizationState:destinationImage:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithDevice_DataSource_FusedNeuronDescriptor_X = "initWithDevice:dataSource:fusedNeuronDescriptor:";
		static readonly NativeHandle selInitWithDevice_DataSource_FusedNeuronDescriptor_XHandle = Selector.GetHandle ("initWithDevice:dataSource:fusedNeuronDescriptor:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selNumberOfFeatureChannelsX = "numberOfFeatureChannels";
		static readonly NativeHandle selNumberOfFeatureChannelsXHandle = Selector.GetHandle ("numberOfFeatureChannels");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selReloadMeanAndVarianceFromDataSourceX = "reloadMeanAndVarianceFromDataSource";
		static readonly NativeHandle selReloadMeanAndVarianceFromDataSourceXHandle = Selector.GetHandle ("reloadMeanAndVarianceFromDataSource");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selReloadMeanAndVarianceWithCommandBuffer_MeanAndVarianceState_X = "reloadMeanAndVarianceWithCommandBuffer:meanAndVarianceState:";
		static readonly NativeHandle selReloadMeanAndVarianceWithCommandBuffer_MeanAndVarianceState_XHandle = Selector.GetHandle ("reloadMeanAndVarianceWithCommandBuffer:meanAndVarianceState:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (this.Handle, selInitWithDevice_DataSource_FusedNeuronDescriptor_XHandle, device__handle__, dataSource__handle__, fusedNeuronDescriptor__handle__), "initWithDevice:dataSource:fusedNeuronDescriptor:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selInitWithDevice_DataSource_FusedNeuronDescriptor_XHandle, device__handle__, dataSource__handle__, fusedNeuronDescriptor__handle__), "initWithDevice:dataSource:fusedNeuronDescriptor:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual void Encode (global::Metal.IMTLCommandBuffer commandBuffer, MPSImage sourceImage, MPSCnnBatchNormalizationState batchNormalizationState, MPSImage destinationImage)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeToCommandBuffer_SourceImage_BatchNormalizationState_DestinationImage_XHandle, commandBuffer__handle__, sourceImage__handle__, batchNormalizationState__handle__, destinationImage__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeToCommandBuffer_SourceImage_BatchNormalizationState_DestinationImage_XHandle, commandBuffer__handle__, sourceImage__handle__, batchNormalizationState__handle__, destinationImage__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual void EncodeBatch (global::Metal.IMTLCommandBuffer commandBuffer, NSArray<MPSImage> sourceImages, MPSCnnBatchNormalizationState batchNormalizationState, NSArray<MPSImage> destinationImages)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeBatchToCommandBuffer_SourceImages_BatchNormalizationState_DestinationImages_XHandle, commandBuffer__handle__, sourceImages__handle__, batchNormalizationState__handle__, destinationImages__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeBatchToCommandBuffer_SourceImages_BatchNormalizationState_DestinationImages_XHandle, commandBuffer__handle__, sourceImages__handle__, batchNormalizationState__handle__, destinationImages__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
		...
		public virtual MPSCnnBatchNormalizationState? GetResultState (MPSImage sourceImage, NSArray<MPSState>? sourceStates, MPSImage destinationImage)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<MPSCnnBatchNormalizationState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selResultStateForSourceImage_SourceStates_DestinationImage_XHandle, sourceImage__handle__, sourceStates__handle__, destinationImage__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (sourceImage);
		...
		public virtual MPSCnnBatchNormalizationState? GetTemporaryResultState (global::Metal.IMTLCommandBuffer commandBuffer, MPSImage sourceImage, NSArray<MPSState>? sourceStates, MPSImage destinationImage)
		{
			...
			MPSCnnBatchNormalizationState? ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<MPSCnnBatchNormalizationState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selTemporaryResultStateForCommandBuffer_SourceImage_SourceStates_DestinationImage_XHandle, commandBuffer__handle__, sourceImage__handle__, sourceStates__handle__, destinationImage__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
		...
		public virtual void ReloadMeanAndVariance (global::Metal.IMTLCommandBuffer commandBuffer, MPSCnnNormalizationMeanAndVarianceState meanAndVarianceState)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selReloadMeanAndVarianceWithCommandBuffer_MeanAndVarianceState_XHandle, commandBuffer__handle__, meanAndVarianceState__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selReloadMeanAndVarianceWithCommandBuffer_MeanAndVarianceState_XHandle, commandBuffer__handle__, meanAndVarianceState__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend (this.Handle, selReloadMeanAndVarianceFromDataSourceXHandle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper (&__objc_super__, selReloadMeanAndVarianceFromDataSourceXHandle);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual IMPSCnnBatchNormalizationDataSource DataSource {
			...
			get {
				...
				if (IsDirectBinding) {
					ret =  Runtime.GetINativeObject<IMPSCnnBatchNormalizationDataSource> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selDataSourceXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetINativeObject<IMPSCnnBatchNormalizationDataSource> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selDataSourceXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual nuint NumberOfFeatureChannels {
			...
			get {
				nuint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selNumberOfFeatureChannelsXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selNumberOfFeatureChannelsXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
