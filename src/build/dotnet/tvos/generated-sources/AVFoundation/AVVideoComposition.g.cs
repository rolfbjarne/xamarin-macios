...
namespace AVFoundation {
	...
	public unsafe partial class AVVideoComposition : NSObject, INSCopying, INSMutableCopying {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static AVVideoComposition CreateVideoComposition (AVAsset asset, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V6))]global::System.Action<AVAsynchronousCIImageFilteringRequest> applier)
		{
			var asset__handle__ = asset!.GetNonNullHandle (nameof (asset));
			if (applier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (applier));
