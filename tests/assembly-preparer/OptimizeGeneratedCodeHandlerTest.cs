...
public class OptimizeGeneratedCodeHandlerTests : BaseClass {
	...
	public void RemoveEnsureUIThread (ApplePlatform platform)
	{
	...
	[TestCase (ApplePlatform.TVOS)]
	[TestCase (ApplePlatform.MacOSX)]
	public void KeepEnsureUIThreadWhenOptimizationDisabled (ApplePlatform platform)
	{
		var ensureUIThreadCall = platform == ApplePlatform.MacOSX
			? "AppKit.NSApplication.EnsureUIThread ();"
			: "UIKit.UIApplication.EnsureUIThread ();";
	...
	[TestCase (ApplePlatform.TVOS)]
	[TestCase (ApplePlatform.MacOSX)]
	public void OptimizeProtocolInterfaceStaticConstructor (ApplePlatform platform)
	{
		var code = @"
		using System;
		using Foundation;
	...
	[TestCase (ApplePlatform.TVOS)]
	[TestCase (ApplePlatform.MacOSX)]
	public void KeepProtocolStaticConstructorWhenOptimizationDisabled (ApplePlatform platform)
	{
		var code = @"
		using System;
		using Foundation;
	...
	[TestCase (ApplePlatform.TVOS)]
	[TestCase (ApplePlatform.MacOSX)]
	public void NoOptimizationWithoutBindingAttributes (ApplePlatform platform)
	{
		var ensureUIThreadCall = platform == ApplePlatform.MacOSX
			? "AppKit.NSApplication.EnsureUIThread ();"
			: "UIKit.UIApplication.EnsureUIThread ();";
	...
	[TestCase (ApplePlatform.TVOS)]
	[TestCase (ApplePlatform.MacOSX)]
	public void DeadCodeElimination (ApplePlatform platform)
	{
		var code = @"
		using System;
		using Foundation;
