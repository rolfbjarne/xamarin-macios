...
namespace Metal {
		...
		Metal.IMTLCommandEncoder
	{
		...
		{
			_Update (this, texture, mode, regions, mipLevels, slices, numRegions);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			_Update (this, texture, mode, region, mipLevel, slice);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			_Update (this, texture, mode, indirectBuffer, indirectBufferOffset);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			_MoveTextureMappings (this, sourceTexture, sourceSlice, sourceLevel, sourceOrigin, sourceSize, destinationTexture, destinationSlice, destinationLevel, destinationOrigin);
		}
		[SupportedOSPlatform ("macos13.0")]
		[SupportedOSPlatform ("ios16.0")]
		[SupportedOSPlatform ("tvos16.0")]
