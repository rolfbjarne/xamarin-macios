...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIFilter" /> that creates an edge-flow effect.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/bloom.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIBloom : CIFilter, ICIBloomProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIBloom" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIBloom (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIBloom (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIBloom (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIBloomProtocol protocol members 
		...
		/// <summary>Gets or sets the radius of the center of the bloom.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public float Radius {
			[Export ("radius")]
			get {
		...
		/// <summary>Gets or sets the intensity of the bloom.</summary><value>To be added.</value><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
