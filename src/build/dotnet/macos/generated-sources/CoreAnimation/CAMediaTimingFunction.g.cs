...
namespace CoreAnimation {
	...
	public unsafe partial class CAMediaTimingFunction : NSObject, INSCoding, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selFunctionWithControlPoints____X = "functionWithControlPoints::::";
		static readonly NativeHandle selFunctionWithControlPoints____XHandle = Selector.GetHandle ("functionWithControlPoints::::");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selFunctionWithName_X = "functionWithName:";
		static readonly NativeHandle selFunctionWithName_XHandle = Selector.GetHandle ("functionWithName:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selGetControlPointAtIndex_Values_X = "getControlPointAtIndex:values:";
		static readonly NativeHandle selGetControlPointAtIndex_Values_XHandle = Selector.GetHandle ("getControlPointAtIndex:values:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithCoder_X = "initWithCoder:";
		static readonly NativeHandle selInitWithCoder_XHandle = Selector.GetHandle ("initWithCoder:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithControlPoints____X = "initWithControlPoints::::";
		static readonly NativeHandle selInitWithControlPoints____XHandle = Selector.GetHandle ("initWithControlPoints::::");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_float_float_float_float (this.Handle, selInitWithControlPoints____XHandle, c1x, c1y, c2x, c2y), "initWithControlPoints::::");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_float_float_float_float (&__objc_super__, selInitWithControlPoints____XHandle, c1x, c1y, c2x, c2y), "initWithControlPoints::::");
					GC.KeepAlive (this);
				}
			}
		}
		...
		public static CAMediaTimingFunction FromControlPoints (float c1x, float c1y, float c2x, float c2y)
		{
			...
			ret =  Runtime.GetNSObject<CAMediaTimingFunction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_float_float_float_float (class_ptr, selFunctionWithControlPoints____XHandle, c1x, c1y, c2x, c2y), false)!;
			return ret;
		}
		...
		public static CAMediaTimingFunction FromName (NSString name)
		{
			...
			CAMediaTimingFunction? ret;
			ret =  Runtime.GetNSObject<CAMediaTimingFunction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selFunctionWithName_XHandle, name__handle__), false)!;
			GC.KeepAlive (name);
			return ret!;
		}
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr_IntPtr (this.Handle, selGetControlPointAtIndex_Values_XHandle, idx, point);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr_IntPtr (&__objc_super__, selGetControlPointAtIndex_Values_XHandle, idx, point);
					GC.KeepAlive (this);
				}
			}
		}
