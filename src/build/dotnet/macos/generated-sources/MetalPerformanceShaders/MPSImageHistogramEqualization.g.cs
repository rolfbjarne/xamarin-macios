...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSImageHistogramEqualization : MPSUnaryImageKernel {
		...
		const string selEncodeTransformToCommandBuffer_SourceTexture_Histogram_HistogramOffset_X = "encodeTransformToCommandBuffer:sourceTexture:histogram:histogramOffset:";
		static readonly NativeHandle selEncodeTransformToCommandBuffer_SourceTexture_Histogram_HistogramOffset_XHandle = Selector.GetHandle ("encodeTransformToCommandBuffer:sourceTexture:histogram:histogramOffset:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual void EncodeTransformToCommandBuffer (global::Metal.IMTLCommandBuffer commandBuffer, global::Metal.IMTLTexture source, global::Metal.IMTLBuffer histogram, nuint histogramOffset)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_UIntPtr (this.Handle, selEncodeTransformToCommandBuffer_SourceTexture_Histogram_HistogramOffset_XHandle, commandBuffer__handle__, source__handle__, histogram__handle__, histogramOffset);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_UIntPtr (&__objc_super__, selEncodeTransformToCommandBuffer_SourceTexture_Histogram_HistogramOffset_XHandle, commandBuffer__handle__, source__handle__, histogram__handle__, histogramOffset);
					GC.KeepAlive (this);
				}
			}
