...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIBlendWithMask</c>.</summary>
	/// <remarks>
		...
		CoreImage.ICIFilterProtocol
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIBlendWithMaskProtocolWrapper))]
	...
	internal unsafe sealed class CIBlendWithMaskProtocolWrapper : BaseWrapper, ICIBlendWithMaskProtocol {
		public CIBlendWithMaskProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIBlendWithMaskProtocolWrapper))]
		static CIBlendWithMaskProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets or sets an image to filter.</summary>
