...
#nullable enable
namespace UIKit {
	[Register("UISliderTick", true)]
	[UnsupportedOSPlatform ("tvos")]
	[SupportedOSPlatform ("ios26.0")]
	[SupportedOSPlatform ("maccatalyst26.0")]
	public unsafe partial class UISliderTick : NSObject, INSCoding, INSCopying {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("UISliderTick");
		...
		public UISliderTick (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected UISliderTick (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal UISliderTick (NativeHandle handle) : base (handle)
		{
		}
		...
		public static UISliderTick Create (float position, string? title, UIImage? image)
		{
			...
			UISliderTick? ret;
			ret =  Runtime.GetNSObject<UISliderTick> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_float_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("tickWithPosition:title:image:"), position, nstitle, image__handle__), false)!;
			GC.KeepAlive (image);
		...
		public virtual float Position {
			...
			get {
				...
				float ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.float_objc_msgSend (this.Handle, Selector.GetHandle ("position"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.float_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("position"));
						GC.KeepAlive (this);
					}
				}
				return ret;
