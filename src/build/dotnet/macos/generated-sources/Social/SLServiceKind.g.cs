...
namespace Social {
	...
	static public partial class SLServiceKindExtensions {
		...
		internal unsafe static IntPtr SLServiceTypeLinkedIn {
			get {
				fixed (IntPtr *storage = &values [4])
					return Dlfcn.CachePointer (Libraries.Social.Handle, "SLServiceTypeLinkedIn", storage);
			}
		}
		...
		public static NSString? GetConstant (this SLServiceKind self)
		{
			...
			case 3: // SLServiceKind.TencentWeibo
				...
				break;
			case 4: // SLServiceKind.LinkedIn
				ptr = SLServiceTypeLinkedIn;
				break;
			}
		...
		public static SLServiceKind GetValue (NSString constant)
		{
			...
			if (constant.IsEqualTo (SLServiceTypeLinkedIn))
				return SLServiceKind.LinkedIn;
