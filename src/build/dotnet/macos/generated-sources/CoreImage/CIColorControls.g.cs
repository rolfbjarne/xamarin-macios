...
#nullable enable
namespace CoreImage {
	/// <summary>The CIColorControls CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/ColorControls.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIColorControls : CIFilter, ICIColorControlsProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorControls" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIColorControls () : base ("CIColorControls")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorControls (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorControls (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorControls (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIColorControlsProtocol protocol members 
