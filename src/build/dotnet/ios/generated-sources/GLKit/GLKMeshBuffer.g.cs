	...
	public unsafe partial class GLKMeshBuffer : NSObject, INSCopying, global::ModelIO.IMDLMeshBuffer {
		...
		public virtual uint GlBufferName {
			...
			get {
				uint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UInt32_objc_msgSend (this.Handle, Selector.GetHandle ("glBufferName"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UInt32_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("glBufferName"));
						GC.KeepAlive (this);
					}
				}
				return ret;
