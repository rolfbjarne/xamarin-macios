...
namespace UIKit {
	...
	public unsafe partial class UICommand : UIMenuElement, IUIMenuLeaf {
		...
		public UICommand (NSCoder coder) : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected UICommand (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal UICommand (NativeHandle handle) : base (handle)
		{
		}

		[Export ("commandWithTitle:image:action:propertyList:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static UICommand Create (string title, UIImage? image, Selector action, NSObject? propertyList)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (title is null)
			...
			UICommand? ret;
			ret =  Runtime.GetNSObject<UICommand> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("commandWithTitle:image:action:propertyList:"), nstitle, image__handle__, action.Handle, propertyList__handle__), false)!;
			GC.KeepAlive (image);
			GC.KeepAlive (action);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static UICommand Create (string title, UIImage? image, Selector action, NSObject? propertyList, UICommandAlternate[] alternates)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (title is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (title));
			...
			UICommand? ret;
			ret =  Runtime.GetNSObject<UICommand> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("commandWithTitle:image:action:propertyList:alternates:"), nstitle, image__handle__, action.Handle, propertyList__handle__, nsa_alternates.Handle), false)!;
			GC.KeepAlive (image);
			GC.KeepAlive (action);
			GC.KeepAlive (propertyList);
			CFString.ReleaseNative (nstitle);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static NSString? _UICommandTagShare;
		/// <summary>Represents the value associated with the constant 'UICommandTagShare'.</summary>
		[Field ("UICommandTagShare",  "UIKit")]
		public static NSString UICommandTagShare {
			get {
				if (_UICommandTagShare is null)
					_UICommandTagShare = Dlfcn.GetStringConstant (Libraries.UIKit.Handle, "UICommandTagShare")!;
				return _UICommandTagShare;
			}
		}
	} /* class UICommand */
}
