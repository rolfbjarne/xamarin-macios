...
namespace UIKit {
	...
	public unsafe static partial class UIStringDrawing  {
		...
		public static CGSize DrawString (this NSString This, CGRect rect, UIFont font, UILineBreakMode mode, UITextAlignment alignment)
		{
			var font__handle__ = font!.GetNonNullHandle (nameof (font));
			CGSize ret;
			ret = global::ObjCRuntime.Messaging.CGSize_objc_msgSend_CGRect_NativeHandle_IntPtr_IntPtr (This.Handle, Selector.GetHandle ("drawInRect:withFont:lineBreakMode:alignment:"), rect, font__handle__, (IntPtr) (long) mode, (IntPtr) UITextAlignmentExtensions.ToNative (alignment));
			GC.KeepAlive (This);
			GC.KeepAlive (font);
			return ret!;
		}
