...
namespace Intents {
	...
	public partial interface IINSearchForMediaIntentHandling : INativeObject, IDisposable
	{
		...
		public unsafe virtual void HandleSearch (INSearchForMediaIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V161))]global::System.Action<INSearchForMediaIntentResponse> completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _HandleSearch (IINSearchForMediaIntentHandling This, INSearchForMediaIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V161))]global::System.Action<INSearchForMediaIntentResponse> completion)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void Confirm (INSearchForMediaIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V161))]global::System.Action<INSearchForMediaIntentResponse> completion)
		{
			_Confirm (this, intent, completion);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _Confirm (IINSearchForMediaIntentHandling This, INSearchForMediaIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V161))]global::System.Action<INSearchForMediaIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ResolveMediaItems (INSearchForMediaIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V162))]global::System.Action<INSearchForMediaMediaItemResolutionResult[]> completion)
		{
			_ResolveMediaItems (this, intent, completion);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _ResolveMediaItems (IINSearchForMediaIntentHandling This, INSearchForMediaIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V162))]global::System.Action<INSearchForMediaMediaItemResolutionResult[]> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
			using var block_completion = Trampolines.SDActionArity1V162.CreateBlock (completion);
			BlockLiteral *block_ptr_completion = &block_completion;
	...
	public unsafe static partial class INSearchForMediaIntentHandling_Extensions {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void Confirm (this IINSearchForMediaIntentHandling This, INSearchForMediaIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V161))]global::System.Action<INSearchForMediaIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void ResolveMediaItems (this IINSearchForMediaIntentHandling This, INSearchForMediaIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V162))]global::System.Action<INSearchForMediaMediaItemResolutionResult[]> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
	...
	internal unsafe sealed class INSearchForMediaIntentHandlingWrapper : BaseWrapper, IINSearchForMediaIntentHandling {
		...
		[Export ("handleSearchForMedia:completion:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void HandleSearch (INSearchForMediaIntent intent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V161))]global::System.Action<INSearchForMediaIntentResponse> completion)
		{
			var intent__handle__ = intent!.GetNonNullHandle (nameof (intent));
			if (completion is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (completion));
