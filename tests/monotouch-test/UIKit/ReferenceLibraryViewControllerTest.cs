...
namespace MonoTouchFixtures.UIKit {
	...
	public class ReferenceLibraryViewControllerTest {
		...
		public void DictionaryHasDefinitionForTerm ()
		{
			...
			ClassicAssert.True (UIReferenceLibraryViewController.DictionaryHasDefinitionForTerm ("Mono"), "Mono");
			ClassicAssert.False (UIReferenceLibraryViewController.DictionaryHasDefinitionForTerm ("zozo"), "zozo");
		}
	}
}
