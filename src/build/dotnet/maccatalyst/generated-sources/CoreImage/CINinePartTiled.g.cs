...
namespace CoreImage {
	...
	public partial class CINinePartTiled : CIFilter, ICINinePartTiledProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CINinePartTiled" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CINinePartTiled () : base ("CINinePartTiled")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CINinePartTiled (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CINinePartTiled (NSObjectFlag t) : base (t)
		{
		}
		...
		public CINinePartTiled (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
