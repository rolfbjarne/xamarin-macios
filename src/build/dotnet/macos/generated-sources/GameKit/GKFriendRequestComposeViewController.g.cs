...
namespace GameKit {
	...
	public unsafe partial class GKFriendRequestComposeViewController : global::AppKit.NSViewController, IGKViewController {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAddRecipientPlayers_X = "addRecipientPlayers:";
		static readonly NativeHandle selAddRecipientPlayers_XHandle = Selector.GetHandle ("addRecipientPlayers:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAddRecipientsWithEmailAddresses_X = "addRecipientsWithEmailAddresses:";
		static readonly NativeHandle selAddRecipientsWithEmailAddresses_XHandle = Selector.GetHandle ("addRecipientsWithEmailAddresses:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selAddRecipientsWithPlayerIDs_X = "addRecipientsWithPlayerIDs:";
		static readonly NativeHandle selAddRecipientsWithPlayerIDs_XHandle = Selector.GetHandle ("addRecipientsWithPlayerIDs:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selComposeViewDelegateX = "composeViewDelegate";
		static readonly NativeHandle selComposeViewDelegateXHandle = Selector.GetHandle ("composeViewDelegate");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selMaxNumberOfRecipientsX = "maxNumberOfRecipients";
		static readonly NativeHandle selMaxNumberOfRecipientsXHandle = Selector.GetHandle ("maxNumberOfRecipients");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetComposeViewDelegate_X = "setComposeViewDelegate:";
		static readonly NativeHandle selSetComposeViewDelegate_XHandle = Selector.GetHandle ("setComposeViewDelegate:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual void AddRecipientPlayers (GKPlayer[] players)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selAddRecipientPlayers_XHandle, nsa_players.Handle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selAddRecipientPlayers_XHandle, nsa_players.Handle);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void AddRecipientsFromEmails (string[] emailAddresses)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selAddRecipientsWithEmailAddresses_XHandle, nsa_emailAddresses.Handle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selAddRecipientsWithEmailAddresses_XHandle, nsa_emailAddresses.Handle);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void AddRecipientsFromPlayerIDs (string[] playerIDs)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selAddRecipientsWithPlayerIDs_XHandle, nsa_playerIDs.Handle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selAddRecipientsWithPlayerIDs_XHandle, nsa_playerIDs.Handle);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual void SetMessage (string? message)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetMessage_XHandle, nsmessage);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetMessage_XHandle, nsmessage);
					GC.KeepAlive (this);
				}
			}
		...
		public static nint MaxNumberOfRecipients {
			...
			get {
				nint ret;
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (class_ptr, selMaxNumberOfRecipientsXHandle);
				return ret;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual NSObject? WeakComposeViewDelegate {
			...
			get {
				NSObject? ret;
				if (IsDirectBinding) {
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selComposeViewDelegateXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selComposeViewDelegateXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				MarkDirty ();
			...
			set {
				...
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetComposeViewDelegate_XHandle, value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetComposeViewDelegate_XHandle, value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
