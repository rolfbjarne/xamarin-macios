...
namespace CoreMidi {
	...
	public unsafe partial class MidiNetworkHost : NSObject {
		...
		public static MidiNetworkHost Create (string hostName, NSNetService netService)
		{
			...
			MidiNetworkHost? ret;
			ret =  Runtime.GetNSObject<MidiNetworkHost> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("hostWithName:netService:"), nshostName, netService__handle__), false)!;
		...
		public static MidiNetworkHost Create (string hostName, string netServiceName, string netServiceDomain)
		{
			...
			MidiNetworkHost? ret;
			ret =  Runtime.GetNSObject<MidiNetworkHost> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle (class_ptr, Selector.GetHandle ("hostWithName:netServiceName:netServiceDomain:"), nshostName, nsnetServiceName, nsnetServiceDomain), false)!;
			CFString.ReleaseNative (nshostName);
		...
		public static MidiNetworkHost Create (string hostName, string address, nint port)
		{
			...
			MidiNetworkHost? ret;
			ret =  Runtime.GetNSObject<MidiNetworkHost> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_IntPtr (class_ptr, Selector.GetHandle ("hostWithName:address:port:"), nshostName, nsaddress, port), false)!;
			CFString.ReleaseNative (nshostName);
		...
		public virtual bool HasSameAddressAs (MidiNetworkHost other)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("hasSameAddressAs:"), other__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("hasSameAddressAs:"), other__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (other);
		...
		public virtual string? NetServiceDomain {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("netServiceDomain")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("netServiceDomain")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual string? NetServiceName {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("netServiceName")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("netServiceName")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
