...
namespace MapKit {
	...
	public unsafe partial class MKImageryMapConfiguration : MKMapConfiguration {
		...
		/// <summary>Creates a new <see cref="MKImageryMapConfiguration" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("initWithElevationStyle:"), (IntPtr) (long) elevationStyle), "initWithElevationStyle:");
					GC.KeepAlive (this);
				}
			}
		}
