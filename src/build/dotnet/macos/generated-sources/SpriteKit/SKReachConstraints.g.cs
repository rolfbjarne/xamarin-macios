...
namespace SpriteKit {
	...
	public unsafe partial class SKReachConstraints : NSObject, INSCoding, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithLowerAngleLimit_UpperAngleLimit_X = "initWithLowerAngleLimit:upperAngleLimit:";
		static readonly NativeHandle selInitWithLowerAngleLimit_UpperAngleLimit_XHandle = Selector.GetHandle ("initWithLowerAngleLimit:upperAngleLimit:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_nfloat_nfloat (this.Handle, selInitWithLowerAngleLimit_UpperAngleLimit_XHandle, lowerAngleLimit, upperAngleLimit), "initWithLowerAngleLimit:upperAngleLimit:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_nfloat_nfloat (&__objc_super__, selInitWithLowerAngleLimit_UpperAngleLimit_XHandle, lowerAngleLimit, upperAngleLimit), "initWithLowerAngleLimit:upperAngleLimit:");
					GC.KeepAlive (this);
				}
			}
		}
