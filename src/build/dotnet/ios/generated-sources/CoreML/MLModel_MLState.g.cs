...
namespace CoreML {
	...
	public unsafe static partial class MLModel_MLState  {
		...
		{
			MLState? ret;
			ret =  Runtime.GetNSObject<MLState> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (This.Handle, Selector.GetHandle ("newState")), true)!;
			GC.KeepAlive (This);
			return ret!;
		}
		...
		public unsafe static IMLFeatureProvider? GetPrediction (this MLModel This, IMLFeatureProvider inputFeatures, MLState state, MLPredictionOptions options, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMLStateGetPredictionCompletionHandler))]MLStateGetPredictionCompletionHandler completionHandler)
		{
			...
			IMLFeatureProvider? ret;
			ret =  Runtime.GetINativeObject<IMLFeatureProvider> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("predictionFromFeatures:usingState:options:completionHandler:"), inputFeatures__handle__, state__handle__, options__handle__, (IntPtr) block_ptr_completionHandler), false)!;
			GC.KeepAlive (This);
			GC.KeepAlive (inputFeatures);
			GC.KeepAlive (state);
			GC.KeepAlive (options);
