...
namespace Foundation {
	...
	public unsafe partial class NSData : NSObject, INSCoding, INSCopying, INSMutableCopying, INSSecureCoding, global::CloudKit.ICKRecordValue {
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe NSData (nint bytes, nuint length, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V75))]global::System.Action<nint, nuint>? deallocator)
			: base (NSObjectFlag.Empty)
		{
			using var block_deallocator = Trampolines.SDActionArity2V75.CreateNullableBlock (deallocator);
