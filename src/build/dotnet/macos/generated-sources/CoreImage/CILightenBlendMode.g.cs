...
#nullable enable
namespace CoreImage {
	/// <summary>The CILightenBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/LightenBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CILightenBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CILightenBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CILightenBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CILightenBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CILightenBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
