...
namespace AppKit {
	...
	public unsafe partial class NSTextParagraph : NSTextElement {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selParagraphContentRangeX = "paragraphContentRange";
		static readonly NativeHandle selParagraphContentRangeXHandle = Selector.GetHandle ("paragraphContentRange");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selParagraphSeparatorRangeX = "paragraphSeparatorRange";
		static readonly NativeHandle selParagraphSeparatorRangeXHandle = Selector.GetHandle ("paragraphSeparatorRange");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual NSTextRange? ParagraphContentRange {
			...
			get {
				...
				NSTextRange? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSTextRange> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selParagraphContentRangeXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSTextRange> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selParagraphContentRangeXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		public virtual NSTextRange? ParagraphSeparatorRange {
			...
			get {
				...
				NSTextRange? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSTextRange> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selParagraphSeparatorRangeXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSTextRange> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selParagraphSeparatorRangeXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
