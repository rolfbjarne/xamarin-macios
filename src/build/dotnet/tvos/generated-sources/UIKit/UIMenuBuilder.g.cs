...
namespace UIKit {
	...
	public partial interface IUIMenuBuilder : INativeObject, IDisposable
	{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void ReplaceChildrenOfMenu (string parentIdentifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity2V11))]global::System.Func<UIMenuElement[], UIMenuElement[]> childrenBlock)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _ReplaceChildrenOfMenu (IUIMenuBuilder This, string parentIdentifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity2V11))]global::System.Func<UIMenuElement[], UIMenuElement[]> childrenBlock)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			...
			using var block_childrenBlock = Trampolines.SDFuncArity2V11.CreateBlock (childrenBlock);
	...
	internal unsafe sealed class UIMenuBuilderWrapper : BaseWrapper, IUIMenuBuilder {
		...
		[Export ("replaceChildrenOfMenuForIdentifier:fromChildrenBlock:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void ReplaceChildrenOfMenu (string parentIdentifier, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDFuncArity2V11))]global::System.Func<UIMenuElement[], UIMenuElement[]> childrenBlock)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (parentIdentifier is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (parentIdentifier));
