...
namespace WebKit {
	...
	public unsafe partial class WebHistoryItem : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithURLString_Title_LastVisitedTimeInterval_X = "initWithURLString:title:lastVisitedTimeInterval:";
		static readonly NativeHandle selInitWithURLString_Title_LastVisitedTimeInterval_XHandle = Selector.GetHandle ("initWithURLString:title:lastVisitedTimeInterval:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selLastVisitedTimeIntervalX = "lastVisitedTimeInterval";
		static readonly NativeHandle selLastVisitedTimeIntervalXHandle = Selector.GetHandle ("lastVisitedTimeInterval");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selOriginalURLStringX = "originalURLString";
		static readonly NativeHandle selOriginalURLStringXHandle = Selector.GetHandle ("originalURLString");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("WebHistoryItem");
		...
		/// <summary>Creates a new <see cref="WebHistoryItem" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public WebHistoryItem () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected WebHistoryItem (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal WebHistoryItem (NativeHandle handle) : base (handle)
		{
		}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_Double (this.Handle, selInitWithURLString_Title_LastVisitedTimeInterval_XHandle, nsurlString, nstitle, lastVisitedTimeInterval), "initWithURLString:title:lastVisitedTimeInterval:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_Double (&__objc_super__, selInitWithURLString_Title_LastVisitedTimeInterval_XHandle, nsurlString, nstitle, lastVisitedTimeInterval), "initWithURLString:title:lastVisitedTimeInterval:");
					GC.KeepAlive (this);
				}
			}
		...
		public virtual double LastVisitedTimeInterval {
			...
			get {
				double ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.Double_objc_msgSend (this.Handle, selLastVisitedTimeIntervalXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.Double_objc_msgSendSuper (&__objc_super__, selLastVisitedTimeIntervalXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual string OriginalUrlString {
			...
			get {
				string ret;
				if (IsDirectBinding) {
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selOriginalURLStringXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selOriginalURLStringXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		///
		/// // listening
		/// notification = WebHistoryItem.Notifications.ObserveChanged ((sender, args) => {
		...
		/// void Callback (object sender, WebHistoryItem.NSNotificationEventArgs args)
		/// {
		///     // Access strongly typed args
		///     Console.WriteLine ("Notification: {0}", args.Notification);
		/// }
		...
		/// void Setup ()
		/// {
		///     notification = WebHistoryItem.Notifications.ObserveChanged (Callback);
		/// }
		///
		/// void Teardown ()
		/// {
		...
		///     WebHistoryItem.ChangedNotification, (notification) => { Console.WriteLine ("Received the notification Changed", notification); }
		/// );
		///
		/// // Method style
		...
		/// void Setup ()
		/// {
		///     NSNotificationCenter.DefaultCenter.AddObserver (WebHistoryItem.ChangedNotification, Callback);
		/// }
		/// ]]></code>
		///   </example>
		/// </remarks>
		...
		// Notifications
		//
		/// <summary>Notifications posted by the <see cref="global::WebKit.WebHistoryItem" /> class.</summary>
		/// <remarks>
		///    <para>This class contains various helper methods that allow developers to observe events posted in the notification hub (<see cref="Foundation.NSNotificationCenter" />).</para>
		///    <para>The methods defined in this class post events that invoke the provided method or lambda with a <see cref="Foundation.NSNotificationEventArgs" /> parameter, which contains strongly typed properties for the notification arguments.</para>
		/// </remarks>
		public static partial class Notifications {
			/// <summary>Strongly typed notification for the <see cref="global::WebKit.WebHistoryItem.ChangedNotification" /> constant.</summary>
			/// <param name="handler">The handler that responds to the notification when it occurs.</param>
			/// <returns>Token object that can be used to stop receiving notifications by either disposing it or passing it to <see cref="Foundation.NSNotificationCenter.RemoveObservers(System.Collections.Generic.IEnumerable{Foundation.NSObject})" />.</returns>
			/// <remarks>
			///   <para>This method can be used to subscribe to <see cref="global::WebKit.WebHistoryItem.ChangedNotification" /> notifications.</para>
			///   <example>
			///   <code lang="csharp lang-csharp"><![CDATA[
			/// // Listen to all notifications posted for any object
			/// var token = WebHistoryItem.Notifications.ObserveChanged ((notification) => {
			...
			/// var token = WebHistoryItem.Notifications.ObserveChanged (objectToObserve, (notification) => {
