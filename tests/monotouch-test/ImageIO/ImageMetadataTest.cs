		...
		public void Defaults ()
		{
			...
			using (var tag = new CGImageMetadataTag (nspace, prefix, name, CGImageMetadataType.Default, true)) {
				...
				using (var meta = new CGImageMetadata (mutable.CreateXMPData ())) {
					...
					ClassicAssert.Null (meta.CopyTagMatchingImageProperty (CGImageProperties.ExifDictionary, CGImageProperties.ExifDateTimeOriginal), "CopyTagMatchingImageProperty");
				}
			}
		}
	}
