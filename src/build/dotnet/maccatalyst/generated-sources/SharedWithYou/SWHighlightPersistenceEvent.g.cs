	...
	public unsafe partial class SWHighlightPersistenceEvent : NSObject, INSCoding, INSCopying, INSSecureCoding, ISWHighlightEvent {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_IntPtr (&__objc_super__, Selector.GetHandle ("initWithHighlight:trigger:"), highlight__handle__, (IntPtr) (long) trigger), "initWithHighlight:trigger:");
					GC.KeepAlive (this);
				}
			}
		...
		public virtual SWHighlightPersistenceEventTrigger PersistenceEventTrigger {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (SharedWithYou.SWHighlightPersistenceEventTrigger) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("persistenceEventTrigger"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
