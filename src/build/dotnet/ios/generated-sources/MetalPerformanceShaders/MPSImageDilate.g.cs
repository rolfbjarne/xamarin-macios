...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSImageDilate : MPSUnaryImageKernel {
		...
		internal virtual nint InitWithDevice (global::Metal.IMTLDevice device, nuint kernelWidth, nuint kernelHeight, nint values)
		{
			...
			nint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_UIntPtr_UIntPtr_IntPtr (this.Handle, Selector.GetHandle ("initWithDevice:kernelWidth:kernelHeight:values:"), device__handle__, kernelWidth, kernelHeight, values);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_UIntPtr_UIntPtr_IntPtr (&__objc_super__, Selector.GetHandle ("initWithDevice:kernelWidth:kernelHeight:values:"), device__handle__, kernelWidth, kernelHeight, values);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
