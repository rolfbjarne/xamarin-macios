...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that constrains the color values between the range specified.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/color_clamp.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIColorClamp : CIFilter, ICIColorClampProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIColorClamp" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIColorClamp () : base ("CIColorClamp")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIColorClamp (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIColorClamp (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIColorClamp (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIColorClampProtocol protocol members 
