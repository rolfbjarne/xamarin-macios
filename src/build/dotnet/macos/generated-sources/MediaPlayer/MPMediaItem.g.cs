...
namespace MediaPlayer {
	...
	public unsafe partial class MPMediaItem : NSObject, INSCoding, INSSecureCoding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCanFilterByProperty_X = "canFilterByProperty:";
		static readonly NativeHandle selCanFilterByProperty_XHandle = Selector.GetHandle ("canFilterByProperty:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static bool CanFilterByProperty (NSString property)
		{
			...
			byte ret;
			ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle (class_ptr, selCanFilterByProperty_XHandle, property__handle__);
		...
		public unsafe virtual void EnumerateValues (NSSet propertiesToEnumerate, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDMPMediaItemEnumerator))]MPMediaItemEnumerator enumerator)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, selEnumerateValuesForProperties_UsingBlock_XHandle, propertiesToEnumerate__handle__, (IntPtr) block_ptr_enumerator);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, selEnumerateValuesForProperties_UsingBlock_XHandle, propertiesToEnumerate__handle__, (IntPtr) block_ptr_enumerator);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual NSObject? ValueForProperty (NSString property)
		{
			...
			NSObject? ret;
			if (IsDirectBinding) {
				ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selValueForProperty_XHandle, property__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = Runtime.GetNSObject (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selValueForProperty_XHandle, property__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (property);
		...
		/// <summary>Represents the value associated with the constant 'MPMediaItemPropertyPlaybackStoreID'.</summary>
		[EditorBrowsable (EditorBrowsableState.Never)]
