...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIDistortionFilter" /> that rotates pixels around a point.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CITwirlDistortion filter with the input image
	...
	/// 	Image = twirl_distortion.OutputImage,
	/// 	Scale = .5f
	/// }.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/twirl_distortion.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CITwirlDistortion : CIDistortionFilter, ICITwirlDistortionProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CITwirlDistortion" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CITwirlDistortion (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CITwirlDistortion (NSObjectFlag t) : base (t)
		{
		}
		...
		public CITwirlDistortion (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CITwirlDistortionProtocol protocol members 
