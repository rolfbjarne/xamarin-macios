...
namespace CoreImage {
	...
	public partial class CIRippleTransition : CITransitionFilter, ICIRippleTransitionProtocol, ICITransitionFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIRippleTransition" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIRippleTransition (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIRippleTransition (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIRippleTransition (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIRippleTransitionProtocol protocol members 
