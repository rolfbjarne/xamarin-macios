...
namespace UIKit {
	...
	public unsafe partial class UIWindowSceneDragInteraction : NSObject, IUIInteraction {
		...
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios17.0")]
		public virtual UIGestureRecognizer GestureForFailureRelationships {
			[Export ("gestureForFailureRelationships")]
			get {
				global::UIKit.UIApplication.EnsureUIThread ();
				UIGestureRecognizer? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<UIGestureRecognizer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("gestureForFailureRelationships")), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<UIGestureRecognizer> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("gestureForFailureRelationships")), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
