...
namespace Foundation {
	...
	public unsafe partial class NSIndexPath : NSObject, INSCoding, INSCopying, INSSecureCoding {
		...
		{
			NSIndexPath ret;
			ret =  Runtime.GetNSObject<NSIndexPath> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr (class_ptr, Selector.GetHandle ("indexPathWithIndex:"), index), false)!;
			return ret;
		}
		...
		{
			NSIndexPath ret;
			ret =  Runtime.GetNSObject<NSIndexPath> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("indexPathForItem:inSection:"), item, section), false)!;
			return ret;
		}
		/// <summary>Returns an index-path object initialized with the given row and section details.</summary><param name="row">The row index within the corresponding <paramref name="section" /> of a <see cref="T:UIKit.UITableView" />.</param><param name="section">The index of the section in the <see cref="T:UIKit.UITableView" /> that contains the <paramref name="row" />.</param><returns>An <see cref="T:Foundation.NSIndexPath" /> object, or <see langword="null" /> if it could not be created.</returns>
		...
		{
			NSIndexPath ret;
			ret =  Runtime.GetNSObject<NSIndexPath> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("indexPathForRow:inSection:"), row, section), false)!;
			return ret;
		}
		...
		public virtual nuint IndexAtPosition (nint position)
		{
			nuint ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("indexAtPosition:"), position);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("indexAtPosition:"), position);
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual NSIndexPath IndexPathByAddingIndex (nuint index)
		{
			NSIndexPath ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSIndexPath> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_UIntPtr (this.Handle, Selector.GetHandle ("indexPathByAddingIndex:"), index), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSIndexPath> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_UIntPtr (&__objc_super__, Selector.GetHandle ("indexPathByAddingIndex:"), index), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual NSIndexPath IndexPathByRemovingLastIndex ()
		{
			NSIndexPath ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSIndexPath> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("indexPathByRemovingLastIndex")), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSIndexPath> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("indexPathByRemovingLastIndex")), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		{
			NSIndexPath ret;
			ret =  Runtime.GetNSObject<NSIndexPath> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("indexPathWithIndexes:length:"), indexes, len), false)!;
			return ret;
		}
		[Export ("getIndexes:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("getIndexes:"), target);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("getIndexes:"), target);
					GC.KeepAlive (this);
				}
			}
		}
		...
		{
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_IntPtr_NSRange (this.Handle, Selector.GetHandle ("getIndexes:range:"), target, positionRange);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_IntPtr_NSRange (&__objc_super__, Selector.GetHandle ("getIndexes:range:"), target, positionRange);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual nint Item {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("item"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("item"));
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("tvos")]
		public virtual nint LongSection {
			[Export ("section")]
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("section"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("section"));
						GC.KeepAlive (this);
					}
				}
				return ret;
