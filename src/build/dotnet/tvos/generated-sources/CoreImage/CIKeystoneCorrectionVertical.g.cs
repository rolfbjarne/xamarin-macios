...
namespace CoreImage {
	...
	public partial class CIKeystoneCorrectionVertical : CIKeystoneCorrection, ICIKeystoneCorrectionVerticalProtocol, ICIFourCoordinateGeometryFilterProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIKeystoneCorrectionVertical" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIKeystoneCorrectionVertical () : base ("CIKeystoneCorrectionVertical")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIKeystoneCorrectionVertical (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIKeystoneCorrectionVertical (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIKeystoneCorrectionVertical (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIKeystoneCorrectionVerticalProtocol protocol members 
		[SupportedOSPlatform ("ios13.0")]
		[SupportedOSPlatform ("macos")]
		[SupportedOSPlatform ("tvos13.0")]
		[SupportedOSPlatform ("maccatalyst")]
