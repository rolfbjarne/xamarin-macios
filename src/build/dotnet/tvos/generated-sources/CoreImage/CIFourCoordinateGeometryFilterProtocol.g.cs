...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIFourCoordinateGeometryFilter</c>.</summary>
	/// <remarks>
	...
	public partial interface ICIFourCoordinateGeometryFilterProtocol : INativeObject, IDisposable, 
		CoreImage.ICIFilterProtocol
	{
		...
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIFourCoordinateGeometryFilterProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICIFourCoordinateGeometryFilterProtocol ()
		{
			GC.KeepAlive (null);
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CIImage _GetInputImage (ICIFourCoordinateGeometryFilterProtocol This)
		{
			CIImage ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputImage (ICIFourCoordinateGeometryFilterProtocol This, CIImage? value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CGPoint _GetInputTopLeft (ICIFourCoordinateGeometryFilterProtocol This)
		{
			CGPoint ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputTopLeft (ICIFourCoordinateGeometryFilterProtocol This, CGPoint value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CGPoint _GetInputTopRight (ICIFourCoordinateGeometryFilterProtocol This)
		{
			CGPoint ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputTopRight (ICIFourCoordinateGeometryFilterProtocol This, CGPoint value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CGPoint _GetInputBottomRight (ICIFourCoordinateGeometryFilterProtocol This)
		{
			CGPoint ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputBottomRight (ICIFourCoordinateGeometryFilterProtocol This, CGPoint value)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static CGPoint _GetInputBottomLeft (ICIFourCoordinateGeometryFilterProtocol This)
		{
			CGPoint ret;
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _SetInputBottomLeft (ICIFourCoordinateGeometryFilterProtocol This, CGPoint value)
		{
	...
	internal unsafe sealed class CIFourCoordinateGeometryFilterProtocolWrapper : BaseWrapper, ICIFourCoordinateGeometryFilterProtocol {
		public CIFourCoordinateGeometryFilterProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIFourCoordinateGeometryFilterProtocolWrapper))]
		static CIFourCoordinateGeometryFilterProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
		/// <summary>Gets or sets an image to filter.</summary>
