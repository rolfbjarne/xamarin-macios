...
namespace CoreImage {
	...
	/// <summary>This interface represents the Objective-C protocol <c>CIAreaMinMax</c>.</summary>
	/// <remarks>
	...
	{
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.Interfaces | DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIAreaMinMaxProtocolWrapper))]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static ICIAreaMinMaxProtocol ()
		{
			GC.KeepAlive (null);
		}
	}
	#pragma warning restore CS1573
	internal unsafe sealed class CIAreaMinMaxProtocolWrapper : BaseWrapper, ICIAreaMinMaxProtocol {
		public CIAreaMinMaxProtocolWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
		[DynamicDependencyAttribute (DynamicallyAccessedMemberTypes.PublicConstructors, typeof (CIAreaMinMaxProtocolWrapper))]
		static CIAreaMinMaxProtocolWrapper ()
		{
			GC.KeepAlive (null);
		}
