...
namespace UIKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ShowWritingTools", Selector = "showWritingTools:", ParameterType = new Type [] { typeof (NSObject) }, ParameterByRef = new bool [] { false })]
	...
	public partial interface IUIResponderStandardEditActions : INativeObject, IDisposable
	{
		...
		{
			_ShowWritingTools (this, sender);
		}
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("ios18.2")]
		[SupportedOSPlatform ("maccatalyst18.2")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _ShowWritingTools (IUIResponderStandardEditActions This, NSObject? sender)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var sender__handle__ = sender.GetHandle ();
		...
		[DynamicDependencyAttribute ("ShowWritingTools(Foundation.NSObject)")]
	...
	public unsafe static partial class UIResponderStandardEditActions_Extensions {
		...
		[SupportedOSPlatform ("maccatalyst18.2")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void ShowWritingTools (this IUIResponderStandardEditActions This, NSObject? sender)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var sender__handle__ = sender.GetHandle ();
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("showWritingTools:"), sender__handle__);
