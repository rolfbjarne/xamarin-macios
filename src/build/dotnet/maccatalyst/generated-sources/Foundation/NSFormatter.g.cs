...
namespace Foundation {
	...
	public unsafe partial class NSFormatter : NSObject, INSCoding, INSCopying {
		...
		public virtual string EditingStringFor (NSObject value)
		{
			...
			string? ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("editingStringForObjectValue:"), value__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("editingStringForObjectValue:"), value__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (value);
		...
		internal NSAttributedString GetAttributedString (NSObject obj, NSDictionary defaultAttributes)
		{
			...
			ret =  Runtime.GetNSObject<NSAttributedString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("attributedStringForObjectValue:withDefaultAttributes:"), obj__handle__, defaultAttributes__handle__), false)!;
			GC.KeepAlive (obj);
		...
		public virtual NSAttributedString GetAttributedString (NSObject obj, NSDictionary<NSString, NSObject> defaultAttributes)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSAttributedString> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("attributedStringForObjectValue:withDefaultAttributes:"), obj__handle__, defaultAttributes__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (obj);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public NSAttributedString GetAttributedString (NSObject obj, global::UIKit.UIStringAttributes defaultAttributes)
		{
		...
		public unsafe virtual bool IsPartialStringValid (string partialString, out string? newString, out NSString? error)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_NativeHandle_ref_NativeHandle_ref_NativeHandle (this.Handle, Selector.GetHandle ("isPartialStringValid:newEditingString:errorDescription:"), nspartialString, &newStringValue, &errorValue);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_NativeHandle_ref_NativeHandle_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("isPartialStringValid:newEditingString:errorDescription:"), nspartialString, &newStringValue, &errorValue);
					GC.KeepAlive (this);
				}
			}
		...
		public unsafe virtual bool IsPartialStringValid (ref string partialString, out NSRange proposedSelRange, string origString, NSRange origSelRange, out string? error)
		{
			...
			byte ret;
			if (IsDirectBinding) {
				ret = global::ObjCRuntime.Messaging.bool_objc_msgSend_ref_NativeHandle_out_NSRange_NativeHandle_NSRange_ref_NativeHandle (this.Handle, Selector.GetHandle ("isPartialStringValid:proposedSelectedRange:originalString:originalSelectedRange:errorDescription:"), &partialStringValue, proposedSelRange__pointer, nsorigString, origSelRange, &errorValue);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = global::ObjCRuntime.Messaging.bool_objc_msgSendSuper_ref_NativeHandle_out_NSRange_NativeHandle_NSRange_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("isPartialStringValid:proposedSelectedRange:originalString:originalSelectedRange:errorDescription:"), &partialStringValue, proposedSelRange__pointer, nsorigString, origSelRange, &errorValue);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual string StringFor (NSObject? value)
		{
			...
			string? ret;
			if (IsDirectBinding) {
				ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("stringForObjectValue:"), value__handle__), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret = CFString.FromHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("stringForObjectValue:"), value__handle__), false)!;
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (value);
