...
namespace MapKit {
	...
	public unsafe partial class MKCircle : MKShape, IMKOverlay {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCircleWithCenterCoordinate_Radius_X = "circleWithCenterCoordinate:radius:";
		static readonly NativeHandle selCircleWithCenterCoordinate_Radius_XHandle = Selector.GetHandle ("circleWithCenterCoordinate:radius:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selCircleWithMapRect_X = "circleWithMapRect:";
		static readonly NativeHandle selCircleWithMapRect_XHandle = Selector.GetHandle ("circleWithMapRect:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		{
			MKCircle ret;
			ret =  Runtime.GetNSObject<MKCircle> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_CLLocationCoordinate2D_Double (class_ptr, selCircleWithCenterCoordinate_Radius_XHandle, withcenterCoordinate, radius), false)!;
			return ret;
		}
		...
		{
			MKCircle ret;
			ret =  Runtime.GetNSObject<MKCircle> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_MKMapRect (class_ptr, selCircleWithMapRect_XHandle, mapRect), false)!;
			return ret;
		}
