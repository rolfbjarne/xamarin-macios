...
namespace CoreML {
	...
	public unsafe partial class MLMultiArray : NSObject, INSCoding, INSSecureCoding {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_IntPtr_ref_NativeHandle (this.Handle, Selector.GetHandle ("initWithShape:dataType:error:"), nsa_shape.Handle, (IntPtr) (long) dataType, &errorValue), "initWithShape:dataType:error:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_IntPtr_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithShape:dataType:error:"), nsa_shape.Handle, (IntPtr) (long) dataType, &errorValue), "initWithShape:dataType:error:");
					GC.KeepAlive (this);
				}
			}
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_IntPtr_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithShape:dataType:strides:"), nsa_shape.Handle, (IntPtr) (long) dataType, nsa_strides.Handle), "initWithShape:dataType:strides:");
					GC.KeepAlive (this);
				}
			}
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe MLMultiArray (nint dataPointer, NSNumber[] shape, MLMultiArrayDataType dataType, NSNumber[] strides, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V35))]global::System.Action<nint>? deallocator, out NSError error)
			: base (NSObjectFlag.Empty)
		{
			if (shape is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (shape));
			...
			using var nsa_shape = NSArray.FromNSObjects (shape);
			using var nsa_strides = NSArray.FromNSObjects (strides);
			using var block_deallocator = Trampolines.SDActionArity1V35.CreateNullableBlock (deallocator);
			BlockLiteral *block_ptr_deallocator = null;
			if (deallocator is not null)
				block_ptr_deallocator = &block_deallocator;
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr_NativeHandle_IntPtr_NativeHandle_NativeHandle_ref_NativeHandle (this.Handle, Selector.GetHandle ("initWithDataPointer:shape:dataType:strides:deallocator:error:"), dataPointer, nsa_shape.Handle, (IntPtr) (long) dataType, nsa_strides.Handle, (IntPtr) block_ptr_deallocator, &errorValue), "initWithDataPointer:shape:dataType:strides:deallocator:error:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr_NativeHandle_IntPtr_NativeHandle_NativeHandle_ref_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithDataPointer:shape:dataType:strides:deallocator:error:"), dataPointer, nsa_shape.Handle, (IntPtr) (long) dataType, nsa_strides.Handle, (IntPtr) block_ptr_deallocator, &errorValue), "initWithDataPointer:shape:dataType:strides:deallocator:error:");
					GC.KeepAlive (this);
				}
			}
			error = Runtime.GetNSObject<NSError> (errorValue)!;
			...
			: base (NSObjectFlag.Empty)
		{
			...
			using var nsa_shape = NSArray.FromNSObjects (shape);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.IntPtr_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithPixelBuffer:shape:"), pixelBuffer__handle__, nsa_shape.Handle), "initWithPixelBuffer:shape:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("initWithPixelBuffer:shape:"), pixelBuffer__handle__, nsa_shape.Handle), "initWithPixelBuffer:shape:");
					GC.KeepAlive (this);
				}
			}
		...
		public static MLMultiArray Concat (MLMultiArray[] multiArrays, nint axis, MLMultiArrayDataType dataType)
		{
			...
			MLMultiArray ret;
			ret =  Runtime.GetNSObject<MLMultiArray> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("multiArrayByConcatenatingMultiArrays:alongAxis:dataType:"), nsa_multiArrays.Handle, axis, (IntPtr) (long) dataType), false)!;
			return ret;
		}
		...
		public unsafe virtual void GetBytes ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V64))]global::System.Action<nint, nint> handler)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("getBytesWithHandler:"), (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public unsafe virtual void GetMutableBytes ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity3V3))]global::System.Action<nint, nint, NSArray<NSNumber>> handler)
		{
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity3V3.CreateBlock (handler);
			BlockLiteral *block_ptr_handler = &block_handler;
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("getMutableBytesWithHandler:"), (IntPtr) block_ptr_handler);
					GC.KeepAlive (this);
				}
			}
		}
		...
		public virtual NSNumber GetObject (nint idx)
		{
			NSNumber ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSNumber> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("objectAtIndexedSubscript:"), idx), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSNumber> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_IntPtr (&__objc_super__, Selector.GetHandle ("objectAtIndexedSubscript:"), idx), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		public virtual NSNumber GetObject (NSNumber[] key)
		{
			...
			NSNumber ret;
			if (IsDirectBinding) {
				ret =  Runtime.GetNSObject<NSNumber> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, Selector.GetHandle ("objectForKeyedSubscript:"), nsa_key.Handle), false)!;
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					ret =  Runtime.GetNSObject<NSNumber> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("objectForKeyedSubscript:"), nsa_key.Handle), false)!;
					GC.KeepAlive (this);
				}
			}
			return ret;
		...
		{
			NSNumber ret;
			ret =  Runtime.GetNSObject<NSNumber> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_IntPtr (this.Handle, Selector.GetHandle ("objectForKeyedSubscript:"), key), false)!;
			return ret;
		}
		...
		public virtual void SetObject (NSNumber obj, nint idx)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_IntPtr (this.Handle, Selector.GetHandle ("setObject:atIndexedSubscript:"), obj__handle__, idx);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_IntPtr (&__objc_super__, Selector.GetHandle ("setObject:atIndexedSubscript:"), obj__handle__, idx);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (obj);
		...
		public virtual void SetObject (NSNumber obj, NSNumber[] key)
		{
			...
			using var nsa_key = NSArray.FromNSObjects (key);
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("setObject:forKeyedSubscript:"), obj__handle__, nsa_key.Handle);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (&__objc_super__, Selector.GetHandle ("setObject:forKeyedSubscript:"), obj__handle__, nsa_key.Handle);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (obj);
		...
		public virtual void TransferToMultiArray (MLMultiArray destinationMultiArray)
		{
			...
			if (IsDirectBinding) {
				...
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, Selector.GetHandle ("transferToMultiArray:"), destinationMultiArray__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		public virtual nint DataPointer {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("dataPointer"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("dataPointer"));
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		public virtual MLMultiArrayDataType DataType {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (MLMultiArrayDataType) (long) global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("dataType"));
						GC.KeepAlive (this);
					}
				}
				return ret!;
		...
		internal virtual nint _Shape {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("shape"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("shape"));
						GC.KeepAlive (this);
					}
				}
				return ret;
		...
		internal virtual nint _Strides {
			...
			get {
				nint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSend (this.Handle, Selector.GetHandle ("strides"));
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.IntPtr_objc_msgSendSuper (&__objc_super__, Selector.GetHandle ("strides"));
						GC.KeepAlive (this);
					}
				}
				return ret;
