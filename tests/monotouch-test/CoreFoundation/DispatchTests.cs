...
namespace MonoTouchFixtures.CoreFoundation {
	...
	public class DispatchTests {
		...
		public void GetGlobalQueue_Priority ()
		{
			...
			ClassicAssert.True (DispatchQueue.GetGlobalQueue (DispatchQueuePriority.Default).Label.StartsWith ("com.apple.root."), "Default");
			ClassicAssert.True (DispatchQueue.GetGlobalQueue (DispatchQueuePriority.Low).Label.StartsWith ("com.apple.root."), "Low");
			ClassicAssert.True (DispatchQueue.GetGlobalQueue (DispatchQueuePriority.High).Label.StartsWith ("com.apple.root."), "High");
		}
		...
		public void GetGlobalQueue_QualityOfService ()
		{
			...
			// values changes in OS versions (and even in arch) but we only want to make sure we get a valid string so the prefix is enough
			ClassicAssert.True (DispatchQueue.GetGlobalQueue (DispatchQualityOfService.Default).Label.StartsWith ("com.apple.root."), "Default");
			ClassicAssert.True (DispatchQueue.GetGlobalQueue (DispatchQualityOfService.Utility).Label.StartsWith ("com.apple.root."), "Low");
			ClassicAssert.True (DispatchQueue.GetGlobalQueue (DispatchQualityOfService.UserInitiated).Label.StartsWith ("com.apple.root."), "High");
		}
