...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSCnnArithmetic : MPSCnnBinaryKernel {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selBiasX = "bias";
		static readonly NativeHandle selBiasXHandle = Selector.GetHandle ("bias");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeBatchToCommandBuffer_PrimaryImages_SecondaryImages_DestinationStates_DestinationImages_X = "encodeBatchToCommandBuffer:primaryImages:secondaryImages:destinationStates:destinationImages:";
		static readonly NativeHandle selEncodeBatchToCommandBuffer_PrimaryImages_SecondaryImages_DestinationStates_DestinationImages_XHandle = Selector.GetHandle ("encodeBatchToCommandBuffer:primaryImages:secondaryImages:destinationStates:destinationImages:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selEncodeToCommandBuffer_PrimaryImage_SecondaryImage_DestinationState_DestinationImage_X = "encodeToCommandBuffer:primaryImage:secondaryImage:destinationState:destinationImage:";
		static readonly NativeHandle selEncodeToCommandBuffer_PrimaryImage_SecondaryImage_DestinationState_DestinationImage_XHandle = Selector.GetHandle ("encodeToCommandBuffer:primaryImage:secondaryImage:destinationState:destinationImage:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("MPSCNNArithmetic");
		...
		public MPSCnnArithmetic (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected MPSCnnArithmetic (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal MPSCnnArithmetic (NativeHandle handle) : base (handle)
		{
		}

		/// <param name="commandBuffer">To be added.</param><param name="primaryImage">To be added.</param><param name="secondaryImage">To be added.</param><param name="destinationState">To be added.</param><param name="destinationImage">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[Export ("encodeToCommandBuffer:primaryImage:secondaryImage:destinationState:destinationImage:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void Encode (global::Metal.IMTLCommandBuffer commandBuffer, MPSImage primaryImage, MPSImage secondaryImage, MPSCnnArithmeticGradientState destinationState, MPSImage destinationImage)
		{
			...
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeToCommandBuffer_PrimaryImage_SecondaryImage_DestinationState_DestinationImage_XHandle, commandBuffer__handle__, primaryImage__handle__, secondaryImage__handle__, destinationState__handle__, destinationImage__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeToCommandBuffer_PrimaryImage_SecondaryImage_DestinationState_DestinationImage_XHandle, commandBuffer__handle__, primaryImage__handle__, secondaryImage__handle__, destinationState__handle__, destinationImage__handle__);
					GC.KeepAlive (this);
				}
			}
		...
		/// <param name="commandBuffer">To be added.</param><param name="primaryImages">To be added.</param><param name="secondaryImages">To be added.</param><param name="destinationStates">To be added.</param><param name="destinationImages">To be added.</param><summary>To be added.</summary><remarks>To be added.</remarks>
		[Export ("encodeBatchToCommandBuffer:primaryImages:secondaryImages:destinationStates:destinationImages:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void EncodeBatch (global::Metal.IMTLCommandBuffer commandBuffer, NSArray<MPSImage> primaryImages, NSArray<MPSImage> secondaryImages, MPSCnnArithmeticGradientState[] destinationStates, NSArray<MPSImage> destinationImages)
		{
			var commandBuffer__handle__ = commandBuffer!.GetNonNullHandle (nameof (commandBuffer));
			...
			if (destinationStates is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (destinationStates));
			var destinationImages__handle__ = destinationImages!.GetNonNullHandle (nameof (destinationImages));
			using var nsa_destinationStates = NSArray.FromNSObjects (destinationStates);
			if (IsDirectBinding) {
				global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (this.Handle, selEncodeBatchToCommandBuffer_PrimaryImages_SecondaryImages_DestinationStates_DestinationImages_XHandle, commandBuffer__handle__, primaryImages__handle__, secondaryImages__handle__, nsa_destinationStates.Handle, destinationImages__handle__);
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle_NativeHandle_NativeHandle (&__objc_super__, selEncodeBatchToCommandBuffer_PrimaryImages_SecondaryImages_DestinationStates_DestinationImages_XHandle, commandBuffer__handle__, primaryImages__handle__, secondaryImages__handle__, nsa_destinationStates.Handle, destinationImages__handle__);
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (commandBuffer);
