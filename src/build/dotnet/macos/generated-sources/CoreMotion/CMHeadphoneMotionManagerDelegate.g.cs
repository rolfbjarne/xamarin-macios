...
namespace CoreMotion {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidConnect", Selector = "headphoneMotionManagerDidConnect:", ParameterType = new Type [] { typeof (CoreMotion.CMHeadphoneMotionManager) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidDisconnect", Selector = "headphoneMotionManagerDidDisconnect:", ParameterType = new Type [] { typeof (CoreMotion.CMHeadphoneMotionManager) }, ParameterByRef = new bool [] { false })]
...
namespace CoreMotion {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__CoreMotion_CMHeadphoneMotionManagerDelegate", false)]
	[Model]
	[SupportedOSPlatform ("ios14.0")]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("macos13.0")]
