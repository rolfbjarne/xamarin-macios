...
namespace ModelIO {
	...
	public unsafe partial class MDLNormalMapTexture : MDLTexture {
		...
		const string selInitByGeneratingNormalMapWithTexture_Name_Smoothness_Contrast_X = "initByGeneratingNormalMapWithTexture:name:smoothness:contrast:";
		static readonly NativeHandle selInitByGeneratingNormalMapWithTexture_Name_Smoothness_Contrast_XHandle = Selector.GetHandle ("initByGeneratingNormalMapWithTexture:name:smoothness:contrast:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			var nsname = CFString.CreateNative (name);
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle_float_float (this.Handle, selInitByGeneratingNormalMapWithTexture_Name_Smoothness_Contrast_XHandle, sourceTexture__handle__, nsname, smoothness, contrast), "initByGeneratingNormalMapWithTexture:name:smoothness:contrast:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle_float_float (&__objc_super__, selInitByGeneratingNormalMapWithTexture_Name_Smoothness_Contrast_XHandle, sourceTexture__handle__, nsname, smoothness, contrast), "initByGeneratingNormalMapWithTexture:name:smoothness:contrast:");
					GC.KeepAlive (this);
				}
			}
