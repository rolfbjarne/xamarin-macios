...
namespace GameKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidFindPlayers", Selector = "matchmakerViewController:didFindPlayers:", ParameterType = new Type [] { typeof (GameKit.GKMatchmakerViewController), typeof (String[]) }, ParameterByRef = new bool [] { false, false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ReceivedAcceptFromHostedPlayer", Selector = "matchmakerViewController:didReceiveAcceptFromHostedPlayer:", ParameterType = new Type [] { typeof (GameKit.GKMatchmakerViewController), typeof (string) }, ParameterByRef = new bool [] { false, false })]
	...
	public partial interface IGKMatchmakerViewControllerDelegate : INativeObject, IDisposable
	{
		...
		/// <param name="viewController">To be added.</param><param name="playerIDs">To be added.</param><summary>Developers should not use this deprecated method. Developers should use 'DidFindHostedPlayers' instead.</summary><remarks>To be added.</remarks>
		[global::Foundation.OptionalMember]
		[Export ("matchmakerViewController:didFindPlayers:")]
		[UnsupportedOSPlatform ("tvos")]
		[ObsoletedOSPlatform ("ios8.0", "Use 'DidFindHostedPlayers' instead.")]
		[ObsoletedOSPlatform ("macos10.10", "Use 'DidFindHostedPlayers' instead.")]
		[SupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'DidFindHostedPlayers' instead.")]
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void DidFindPlayers (GKMatchmakerViewController viewController, string[] playerIDs)
		{
			_DidFindPlayers (this, viewController, playerIDs);
		}
		/// <param name="viewController">To be added.</param><param name="playerIDs">To be added.</param><summary>Developers should not use this deprecated method. Developers should use 'DidFindHostedPlayers' instead.</summary><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("tvos")]
		[ObsoletedOSPlatform ("ios8.0", "Use 'DidFindHostedPlayers' instead.")]
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _DidFindPlayers (IGKMatchmakerViewControllerDelegate This, GKMatchmakerViewController viewController, string[] playerIDs)
		{
			var viewController__handle__ = viewController!.GetNonNullHandle (nameof (viewController));
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("matchmakerViewController:didFindPlayers:"), viewController__handle__, nsa_playerIDs.Handle);
			GC.KeepAlive (This);
			GC.KeepAlive (viewController);
		}
		...
		/// <param name="viewController">To be added.</param><param name="playerID">To be added.</param><summary>Developers should not use this deprecated method. Developers should use 'HostedPlayerDidAccept' instead.</summary><remarks>To be added.</remarks>
		[global::Foundation.OptionalMember]
		[Export ("matchmakerViewController:didReceiveAcceptFromHostedPlayer:")]
		[UnsupportedOSPlatform ("tvos")]
		[ObsoletedOSPlatform ("ios8.0", "Use 'HostedPlayerDidAccept' instead.")]
		[ObsoletedOSPlatform ("macos10.10", "Use 'HostedPlayerDidAccept' instead.")]
		[SupportedOSPlatform ("maccatalyst")]
		[ObsoletedOSPlatform ("maccatalyst13.1", "Use 'HostedPlayerDidAccept' instead.")]
		[SupportedOSPlatform ("ios")]
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void ReceivedAcceptFromHostedPlayer (GKMatchmakerViewController viewController, string playerID)
		{
			_ReceivedAcceptFromHostedPlayer (this, viewController, playerID);
		}
		/// <param name="viewController">To be added.</param><param name="playerID">To be added.</param><summary>Developers should not use this deprecated method. Developers should use 'HostedPlayerDidAccept' instead.</summary><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("tvos")]
		[ObsoletedOSPlatform ("ios8.0", "Use 'HostedPlayerDidAccept' instead.")]
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _ReceivedAcceptFromHostedPlayer (IGKMatchmakerViewControllerDelegate This, GKMatchmakerViewController viewController, string playerID)
		{
			var viewController__handle__ = viewController!.GetNonNullHandle (nameof (viewController));
			if (playerID is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (playerID));
			var nsplayerID = CFString.CreateNative (playerID);
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("matchmakerViewController:didReceiveAcceptFromHostedPlayer:"), viewController__handle__, nsplayerID);
			GC.KeepAlive (This);
			GC.KeepAlive (viewController);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetMatchProperties (GKMatchmakerViewController viewController, GKPlayer recipient, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V65))]global::System.Action<NSDictionary<NSString, NSObject>> completionHandler)
		{
		...
		[SupportedOSPlatform ("maccatalyst17.2")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _GetMatchProperties (IGKMatchmakerViewControllerDelegate This, GKMatchmakerViewController viewController, GKPlayer recipient, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V65))]global::System.Action<NSDictionary<NSString, NSObject>> completionHandler)
		{
			var viewController__handle__ = viewController!.GetNonNullHandle (nameof (viewController));
		...
		[DynamicDependencyAttribute ("DidFindPlayers(GameKit.GKMatchmakerViewController,System.String[])")]
		...
		[DynamicDependencyAttribute ("ReceivedAcceptFromHostedPlayer(GameKit.GKMatchmakerViewController,System.String)")]
	...
	public unsafe static partial class GKMatchmakerViewControllerDelegate_Extensions {
		...
		[SupportedOSPlatform ("macos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void DidFindPlayers (this IGKMatchmakerViewControllerDelegate This, GKMatchmakerViewController viewController, string[] playerIDs)
		{
			var viewController__handle__ = viewController!.GetNonNullHandle (nameof (viewController));
			if (playerIDs is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (playerIDs));
		...
		[SupportedOSPlatform ("maccatalyst17.2")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static void GetMatchProperties (this IGKMatchmakerViewControllerDelegate This, GKMatchmakerViewController viewController, GKPlayer recipient, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V65))]global::System.Action<NSDictionary<NSString, NSObject>> completionHandler)
		{
			var viewController__handle__ = viewController!.GetNonNullHandle (nameof (viewController));
			var recipient__handle__ = recipient!.GetNonNullHandle (nameof (recipient));
			if (completionHandler is null)
...
namespace GameKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_macOS__GameKit_GKMatchmakerViewControllerDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("macos")]
