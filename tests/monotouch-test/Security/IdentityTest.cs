	...
	public class IdentityTest {
		...
		public void Identity ()
		{
			using (SecIdentity id = GetIdentity ()) {
				ClassicAssert.NotNull (id.PrivateKey, "PrivateKey");
				ClassicAssert.NotNull (id.Certificate, "Certificate");
			}
		}
		...
		public void AccessCertificates ()
		{
			...
			using (var i2 = new SecIdentity2 (i1, i1.Certificate)) {
				int call = 0;
				ClassicAssert.True (i2.AccessCertificates ((c) => {
		...
		public void Certificates ()
		{
			...
			ClassicAssert.IsNotNull (certs, "Certificates");
