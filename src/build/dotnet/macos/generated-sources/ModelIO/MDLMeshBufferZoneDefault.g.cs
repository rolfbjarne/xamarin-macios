	...
	public unsafe partial class MDLMeshBufferZoneDefault : NSObject, IMDLMeshBufferZone {
		...
		public virtual nuint Capacity {
			...
			get {
				nuint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selCapacityXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selCapacityXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
