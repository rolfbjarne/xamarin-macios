...
#nullable enable
namespace CoreImage {
	/// <summary>A filter that produces a black-and-white image with minimal contrast changes.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	/// // Create the CIImage from a file
	/// CIImage flower = CIImage.FromCGImage (UIImage.FromFile ("flower.png").CGImage);
	/// 
	/// // Create a CIPhotoEffectTonal filter with the input image
	...
	/// var output = photo_effect_tonal.OutputImage;
	/// 
	...
	/// </para><para><img href="~/xml/CoreImage/_images/photo_effect_tonal.png" alt="Result of applying the filter." /></para><para>
	...
	public partial class CIPhotoEffectTonal : CIPhotoEffect {
		/// <summary>Creates a new <see cref="CIPhotoEffectTonal" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIPhotoEffectTonal () : base ("CIPhotoEffectTonal")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIPhotoEffectTonal (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIPhotoEffectTonal (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIPhotoEffectTonal (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
