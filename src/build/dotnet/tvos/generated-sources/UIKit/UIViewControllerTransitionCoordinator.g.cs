...
namespace UIKit {
		...
		UIKit.IUIViewControllerTransitionCoordinatorContext
	{
		...
		public unsafe virtual bool AnimateAlongsideTransition ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext> animate, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext>? completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="animate">To be added.</param><param name="completion">To be added.</param><summary>Runs the <paramref name="animate" /> animation simultaneously with the animated view controller transition, and runs <paramref name="completion" /> when it is finished.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static bool _AnimateAlongsideTransition (IUIViewControllerTransitionCoordinator This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext> animate, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext>? completion)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (animate is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (animate));
			using var block_animate = Trampolines.SDActionArity1V86.CreateBlock (animate);
			BlockLiteral *block_ptr_animate = &block_animate;
			using var block_completion = Trampolines.SDActionArity1V86.CreateNullableBlock (completion);
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual bool AnimateAlongsideTransitionInView (UIView view, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext> animation, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext>? completion)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="view">To be added.</param><param name="animation">To be added.</param><param name="completion">To be added.</param><summary>Runs the <paramref name="animation" /> animation inside of <paramref name="view" />, and runs <paramref name="completion" /> when it is finished.</summary><returns>To be added.</returns><remarks>To be added.</remarks>
		...
		internal unsafe static bool _AnimateAlongsideTransitionInView (IUIViewControllerTransitionCoordinator This, UIView view, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext> animation, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext>? completion)
		{
			...
			using var block_animation = Trampolines.SDActionArity1V86.CreateBlock (animation);
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void NotifyWhenInteractionEndsUsingBlock ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext> handler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <param name="handler">To be added.</param><summary>Developers should not use this deprecated method. Developers should use 'NotifyWhenInteractionChanges' instead.</summary><remarks>To be added.</remarks>
		...
		[SupportedOSPlatform ("maccatalyst")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _NotifyWhenInteractionEndsUsingBlock (IUIViewControllerTransitionCoordinator This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
			using var block_handler = Trampolines.SDActionArity1V86.CreateBlock (handler);
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void NotifyWhenInteractionChanges ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext> handler)
		{
			throw new You_Should_Not_Call_base_In_This_Method ();
		}
		/// <summary>Registers <paramref name="handler" /> to be called when the transition changes from interactive to non-interactive or vice versa.</summary>
		...
		[SupportedOSPlatform ("tvos")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal unsafe static void _NotifyWhenInteractionChanges (IUIViewControllerTransitionCoordinator This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
	...
	internal unsafe sealed class UIViewControllerTransitionCoordinatorWrapper : BaseWrapper, IUIViewControllerTransitionCoordinator {
		...
		[Export ("notifyWhenInteractionEndsUsingBlock:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void NotifyWhenInteractionEndsUsingBlock ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
		...
		[Export ("notifyWhenInteractionChangesUsingBlock:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe void NotifyWhenInteractionChanges ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V86))]global::System.Action<IUIViewControllerTransitionCoordinatorContext> handler)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			if (handler is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (handler));
