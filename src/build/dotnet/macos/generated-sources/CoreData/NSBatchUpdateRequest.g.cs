...
namespace CoreData {
	...
	public unsafe partial class NSBatchUpdateRequest : NSPersistentStoreRequest {
		...
		const string selBatchUpdateRequestWithEntityName_X = "batchUpdateRequestWithEntityName:";
		static readonly NativeHandle selBatchUpdateRequestWithEntityName_XHandle = Selector.GetHandle ("batchUpdateRequestWithEntityName:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithEntity_X = "initWithEntity:";
		static readonly NativeHandle selInitWithEntity_XHandle = Selector.GetHandle ("initWithEntity:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selSetPropertiesToUpdate_X = "setPropertiesToUpdate:";
		static readonly NativeHandle selSetPropertiesToUpdate_XHandle = Selector.GetHandle ("setPropertiesToUpdate:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (this.Handle, selInitWithEntity_XHandle, entity__handle__), "initWithEntity:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle (&__objc_super__, selInitWithEntity_XHandle, entity__handle__), "initWithEntity:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (entity);
		...
		public static NSBatchUpdateRequest BatchUpdateRequestWithEntityName (string entityName)
		{
			...
			ret =  Runtime.GetNSObject<NSBatchUpdateRequest> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selBatchUpdateRequestWithEntityName_XHandle, nsentityName), false)!;
			CFString.ReleaseNative (nsentityName);
			return ret!;
		}
		...
		public virtual NSDictionary? PropertiesToUpdate {
			...
			get {
				NSDictionary? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDictionary> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (this.Handle, selPropertiesToUpdateXHandle), false)!;
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret =  Runtime.GetNSObject<NSDictionary> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper (&__objc_super__, selPropertiesToUpdateXHandle), false)!;
						GC.KeepAlive (this);
					}
				}
				return ret!;
			...
			set {
				var value__handle__ = value.GetHandle ();
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (this.Handle, selSetPropertiesToUpdate_XHandle, value__handle__);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_NativeHandle (&__objc_super__, selSetPropertiesToUpdate_XHandle, value__handle__);
						GC.KeepAlive (this);
					}
				}
				GC.KeepAlive (value);
		...
		public virtual NSBatchUpdateRequestResultType ResultType {
			...
			get {
				...
				if (IsDirectBinding) {
					ret = (CoreData.NSBatchUpdateRequestResultType) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selResultTypeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = (CoreData.NSBatchUpdateRequestResultType) (ulong) global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selResultTypeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret!;
