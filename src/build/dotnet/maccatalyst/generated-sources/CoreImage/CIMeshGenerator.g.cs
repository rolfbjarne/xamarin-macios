...
namespace CoreImage {
	...
	public partial class CIMeshGenerator : CIFilter, ICIMeshGeneratorProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIMeshGenerator" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIMeshGenerator () : base ("CIMeshGenerator")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIMeshGenerator (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIMeshGenerator (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIMeshGenerator (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIMeshGeneratorProtocol protocol members 
		...
		public CIVector[] Mesh {
			...
			get {
				var handle = GetHandle ("inputMesh");
				return CFArray.ArrayFromHandle<CIVector> (handle)!;
			}
			...
			set {
				if (value is null) {
					...
					var ptr = CFArray.Create (value);
					SetHandle ("inputMesh", ptr);
