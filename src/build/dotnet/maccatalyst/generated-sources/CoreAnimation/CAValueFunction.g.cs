...
namespace CoreAnimation {
	/// <summary>Class used to apply functions to property values during an animation.</summary><related type="externalDocumentation" href="https://developer.apple.com/library/ios/documentation/GraphicsImaging/Reference/CAValueFunction_class/index.html">Apple documentation for <c>CAValueFunction</c></related>
	[Register("CAValueFunction", true)]
	public unsafe partial class CAValueFunction : NSObject, INSCoding, INSSecureCoding {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("CAValueFunction");
		...
		/// <summary>Creates a new <see cref="CAValueFunction" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected CAValueFunction (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CAValueFunction (NativeHandle handle) : base (handle)
		{
		}
		...
		public static CAValueFunction? FromName (string name)
		{
			...
			CAValueFunction? ret;
			ret =  Runtime.GetNSObject<CAValueFunction> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, Selector.GetHandle ("functionWithName:"), nsname), false)!;
		...
		/// <summary>Represents the value associated with the constant kCAValueFunctionRotateX</summary><value></value><remarks>To be added.</remarks>
		...
		/// <summary>Represents the value associated with the constant kCAValueFunctionRotateY</summary><value></value><remarks>To be added.</remarks>
		...
		/// <summary>Represents the value associated with the constant kCAValueFunctionRotateZ</summary><value></value><remarks>To be added.</remarks>
		...
		/// <summary>Represents the value associated with the constant kCAValueFunctionScale</summary><value></value><remarks>To be added.</remarks>
		...
		/// <summary>Represents the value associated with the constant kCAValueFunctionScaleX</summary><value></value><remarks>To be added.</remarks>
		...
		/// <summary>Represents the value associated with the constant kCAValueFunctionScaleY</summary><value></value><remarks>To be added.</remarks>
		...
		/// <summary>Represents the value associated with the constant kCAValueFunctionScaleZ</summary><value></value><remarks>To be added.</remarks>
		...
		/// <summary>Represents the value associated with the constant kCAValueFunctionTranslate</summary><value></value><remarks>To be added.</remarks>
		...
		/// <summary>Represents the value associated with the constant kCAValueFunctionTranslateX</summary><value></value><remarks>To be added.</remarks>
		[Field ("kCAValueFunctionTranslateX",  "CoreAnimation")]
		public static NSString TranslateX {
			get {
				if (_TranslateX is null)
		...
		/// <summary>Represents the value associated with the constant kCAValueFunctionTranslateY</summary><value></value><remarks>To be added.</remarks>
		[Field ("kCAValueFunctionTranslateY",  "CoreAnimation")]
		public static NSString TranslateY {
			get {
				if (_TranslateY is null)
		...
		/// <summary>Represents the value associated with the constant kCAValueFunctionTranslateZ</summary><value></value><remarks>To be added.</remarks>
		[Field ("kCAValueFunctionTranslateZ",  "CoreAnimation")]
		public static NSString TranslateZ {
			get {
				if (_TranslateZ is null)
