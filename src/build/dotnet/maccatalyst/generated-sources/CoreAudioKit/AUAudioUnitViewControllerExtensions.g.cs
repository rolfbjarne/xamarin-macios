...
namespace CoreAudioKit {
	...
	public unsafe static partial class AUAudioUnitViewControllerExtensions  {
		...
		public static NSIndexSet GetSupportedViewConfigurations (this global::AudioUnit.AUAudioUnit This, AUAudioUnitViewConfiguration[] availableViewConfigurations)
		{
			...
			NSIndexSet ret;
			ret =  Runtime.GetNSObject<NSIndexSet> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("supportedViewConfigurations:"), nsa_availableViewConfigurations.Handle), false)!;
			GC.KeepAlive (This);
			return ret;
		}
		...
		public static void SelectViewConfiguration (this global::AudioUnit.AUAudioUnit This, AUAudioUnitViewConfiguration viewConfiguration)
		{
			...
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("selectViewConfiguration:"), viewConfiguration__handle__);
			GC.KeepAlive (This);
