...
namespace MetalPerformanceShaders {
	...
	public unsafe partial class MPSCnnCrossChannelNormalization : MPSCnnKernel {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selInitWithDevice_KernelSize_X = "initWithDevice:kernelSize:";
		static readonly NativeHandle selInitWithDevice_KernelSize_XHandle = Selector.GetHandle ("initWithDevice:kernelSize:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selKernelSizeX = "kernelSize";
		static readonly NativeHandle selKernelSizeXHandle = Selector.GetHandle ("kernelSize");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			...
			: base (NSObjectFlag.Empty)
		{
			...
			if (IsDirectBinding) {
				InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle_UIntPtr (this.Handle, selInitWithDevice_KernelSize_XHandle, device__handle__, kernelSize), "initWithDevice:kernelSize:");
			} else {
				unsafe {
					var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
					InitializeHandle (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_UIntPtr (&__objc_super__, selInitWithDevice_KernelSize_XHandle, device__handle__, kernelSize), "initWithDevice:kernelSize:");
					GC.KeepAlive (this);
				}
			}
			GC.KeepAlive (device);
		...
		public virtual nuint KernelSize {
			...
			get {
				nuint ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSend (this.Handle, selKernelSizeXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.UIntPtr_objc_msgSendSuper (&__objc_super__, selKernelSizeXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
