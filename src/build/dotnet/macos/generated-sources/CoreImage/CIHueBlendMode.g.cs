...
#nullable enable
namespace CoreImage {
	/// <summary>The CIHueBlendMode CoreImage filter</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/HueBlend.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIHueBlendMode : CIBlendFilter {
		/// <summary>Creates a new <see cref="CIHueBlendMode" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIHueBlendMode (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIHueBlendMode (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIHueBlendMode (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
