...
#nullable enable
namespace CoreImage {
	/// <summary>A <see cref="T:CoreImage.CIScreenFilter" /> that screens with a halftone dot pattern.</summary><remarks><para>The following example shows this filter in use</para><example><code lang="csharp lang-csharp"><![CDATA[
	...
	/// </para><para><img href="~/xml/CoreImage/_images/dot_screen.png" alt="Result of applying the filter." /></para><para>
	...
	/// </para></remarks>
	public partial class CIDotScreen : CIScreenFilter, ICIDotScreenProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIDotScreen" /> with default values.</summary>
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIDotScreen (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIDotScreen (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIDotScreen (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIDotScreenProtocol protocol members 
