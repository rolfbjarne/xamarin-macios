...
namespace Accessibility {
	...
	public unsafe partial class AXDataPointValue : NSObject, INSCopying {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selValueWithCategory_X = "valueWithCategory:";
		static readonly NativeHandle selValueWithCategory_XHandle = Selector.GetHandle ("valueWithCategory:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selValueWithNumber_X = "valueWithNumber:";
		static readonly NativeHandle selValueWithNumber_XHandle = Selector.GetHandle ("valueWithNumber:");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("AXDataPointValue");
		...
		protected AXDataPointValue (NSObjectFlag t) : base (t)
		{
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal AXDataPointValue (NativeHandle handle) : base (handle)
		{
		}
		...
		public static AXDataPointValue CreateValueWithCategory (string category)
		{
			...
			ret =  Runtime.GetNSObject<AXDataPointValue> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_NativeHandle (class_ptr, selValueWithCategory_XHandle, nscategory), false)!;
		...
		{
			AXDataPointValue ret;
			ret =  Runtime.GetNSObject<AXDataPointValue> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend_Double (class_ptr, selValueWithNumber_XHandle, number), false)!;
			return ret;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual double Number {
			...
			get {
				double ret;
				if (IsDirectBinding) {
					ret = global::ObjCRuntime.Messaging.Double_objc_msgSend (this.Handle, selNumberXHandle);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						ret = global::ObjCRuntime.Messaging.Double_objc_msgSendSuper (&__objc_super__, selNumberXHandle);
						GC.KeepAlive (this);
					}
				}
				return ret;
			...
			set {
				if (IsDirectBinding) {
					global::ObjCRuntime.Messaging.void_objc_msgSend_Double (this.Handle, selSetNumber_XHandle, value);
				} else {
					unsafe {
						var __objc_super__ = new global::ObjCRuntime.ObjCSuper (this);
						global::ObjCRuntime.Messaging.void_objc_msgSendSuper_Double (&__objc_super__, selSetNumber_XHandle, value);
						GC.KeepAlive (this);
					}
				}
			}
