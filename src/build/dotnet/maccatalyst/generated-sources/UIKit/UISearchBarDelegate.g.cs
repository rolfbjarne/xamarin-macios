...
namespace UIKit {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "BookmarkButtonClicked", Selector = "searchBarBookmarkButtonClicked:", ParameterType = new Type [] { typeof (UISearchBar) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "CancelButtonClicked", Selector = "searchBarCancelButtonClicked:", ParameterType = new Type [] { typeof (UISearchBar) }, ParameterByRef = new bool [] { false })]
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "ListButtonClicked", Selector = "searchBarResultsListButtonClicked:", ParameterType = new Type [] { typeof (UISearchBar) }, ParameterByRef = new bool [] { false })]
		...
		UIKit.IUIBarPositioningDelegate
	{
		...
		/// <param name="searchBar">To be added.</param><summary>Indicates that the bookmark button was tapped.</summary><remarks>To be added.</remarks>
		[global::Foundation.OptionalMember]
		...
		{
			_BookmarkButtonClicked (this, searchBar);
		}
		/// <param name="searchBar">To be added.</param><summary>Indicates that the bookmark button was tapped.</summary><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _BookmarkButtonClicked (IUISearchBarDelegate This, UISearchBar searchBar)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var searchBar__handle__ = searchBar!.GetNonNullHandle (nameof (searchBar));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("searchBarBookmarkButtonClicked:"), searchBar__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (searchBar);
		}
		/// <param name="searchBar">To be added.</param><summary>Indicates that the cancel button was tapped.</summary><remarks>To be added.</remarks>
		[global::Foundation.OptionalMember]
		...
		{
			_CancelButtonClicked (this, searchBar);
		}
		/// <param name="searchBar">To be added.</param><summary>Indicates that the cancel button was tapped.</summary><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _CancelButtonClicked (IUISearchBarDelegate This, UISearchBar searchBar)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var searchBar__handle__ = searchBar!.GetNonNullHandle (nameof (searchBar));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("searchBarCancelButtonClicked:"), searchBar__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (searchBar);
		}
		...
		/// <param name="searchBar">To be added.</param><summary>Indicates that the list button was tapped.</summary><remarks>To be added.</remarks>
		[global::Foundation.OptionalMember]
		...
		{
			_ListButtonClicked (this, searchBar);
		}
		/// <param name="searchBar">To be added.</param><summary>Indicates that the list button was tapped.</summary><remarks>To be added.</remarks>
		[UnsupportedOSPlatform ("tvos")]
		[SupportedOSPlatform ("maccatalyst")]
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		internal static void _ListButtonClicked (IUISearchBarDelegate This, UISearchBar searchBar)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var searchBar__handle__ = searchBar!.GetNonNullHandle (nameof (searchBar));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("searchBarResultsListButtonClicked:"), searchBar__handle__);
			GC.KeepAlive (This);
			GC.KeepAlive (searchBar);
		}
		[global::Foundation.OptionalMember]
		...
		[DynamicDependencyAttribute ("BookmarkButtonClicked(UIKit.UISearchBar)")]
		[DynamicDependencyAttribute ("CancelButtonClicked(UIKit.UISearchBar)")]
		[DynamicDependencyAttribute ("ListButtonClicked(UIKit.UISearchBar)")]
	...
	public unsafe static partial class UISearchBarDelegate_Extensions {
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void BookmarkButtonClicked (this IUISearchBarDelegate This, UISearchBar searchBar)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var searchBar__handle__ = searchBar!.GetNonNullHandle (nameof (searchBar));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("searchBarBookmarkButtonClicked:"), searchBar__handle__);
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void CancelButtonClicked (this IUISearchBarDelegate This, UISearchBar searchBar)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var searchBar__handle__ = searchBar!.GetNonNullHandle (nameof (searchBar));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("searchBarCancelButtonClicked:"), searchBar__handle__);
		...
		[SupportedOSPlatform ("ios")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void ListButtonClicked (this IUISearchBarDelegate This, UISearchBar searchBar)
		{
			global::UIKit.UIApplication.EnsureUIThread ();
			var searchBar__handle__ = searchBar!.GetNonNullHandle (nameof (searchBar));
			global::ObjCRuntime.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("searchBarResultsListButtonClicked:"), searchBar__handle__);
...
namespace UIKit {
	...
	/// </summary>
	[Protocol()]
	[Register("Microsoft_MacCatalyst__UIKit_UISearchBarDelegate", false)]
	[Model]
	[SupportedOSPlatform ("maccatalyst")]
	[SupportedOSPlatform ("ios")]
	[SupportedOSPlatform ("tvos")]
