...
namespace CoreImage {
	...
	public partial class CIEdges : CIFilter, ICIEdgesProtocol, ICIFilterProtocol {
		/// <summary>Creates a new <see cref="CIEdges" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public CIEdges () : base ("CIEdges")
		{
		}
		...
		/// </remarks>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		protected internal CIEdges (NativeHandle handle) : base (handle)
		{
		}
		...
		protected CIEdges (NSObjectFlag t) : base (t)
		{
		}
		...
		public CIEdges (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (coder is null)
		...
		// CIEdgesProtocol protocol members 
