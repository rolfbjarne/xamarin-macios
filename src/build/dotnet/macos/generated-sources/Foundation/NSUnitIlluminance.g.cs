...
namespace Foundation {
	...
	public unsafe partial class NSUnitIlluminance : NSDimension, INSCoding, INSSecureCoding {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		const string selLuxX = "lux";
		static readonly NativeHandle selLuxXHandle = Selector.GetHandle ("lux");
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public static NSUnitIlluminance Lux {
			...
			get {
				...
				ret =  Runtime.GetNSObject<NSUnitIlluminance> (global::ObjCRuntime.Messaging.NativeHandle_objc_msgSend (class_ptr, selLuxXHandle), false)!;
				return ret!;
			}
		}
