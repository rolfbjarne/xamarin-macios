...
namespace Xamarin.MacDev.Tasks {
	...
	public class PostTrimmingProcessing : XamarinTask {
		...
		List<string> FilterOutIgnoredSymbols (HashSet<string> survivingSymbols, bool filterObjetiveCClasses)
		{
		...
		void GenerateInlinedClassGetHandleNativeCode (List<string> items)
		{
			...
			var classes = FilterOutIgnoredSymbols (ReadUniqueLinesFromFiles (SurvivingClassesFiles), filterObjetiveCClasses: true);
		...
		{
			var survivingSymbols = FilterOutIgnoredSymbols (ReadUniqueLinesFromFiles (SurvivingNativeSymbolsFiles), filterObjetiveCClasses: false);
